---
name: building-ui
description: Expo Router UI implementation guide. Use for Expo-specific components, navigation setup, native tabs, and implementation patterns. Use when this capability is needed.
metadata:
  author: 0xabrar
---
