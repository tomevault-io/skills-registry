...
description: Bộ kỹ năng Office (DOCX/PPTX/XLSX/PDF) và Design Toolkit tích hợp từ file người dùng cung cấp. Use when this capability is needed.
metadata:
  author: 0xAstroAlpha
---
...
---
> Source: [0xAstroAlpha/office-design-toolkit](https://github.com/0xAstroAlpha/office-design-toolkit) — distributed by [TomeVault](https://tomevault.io).
