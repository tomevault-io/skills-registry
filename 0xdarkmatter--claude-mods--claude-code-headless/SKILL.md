...
description: Run Claude Code programmatically without interactive UI. Triggers on: headless, CLI automation, --print, output-format, stream-json, CI/CD, scripting. Use when this capability is needed.
metadata:
  author: 0xdarkmatter
---
