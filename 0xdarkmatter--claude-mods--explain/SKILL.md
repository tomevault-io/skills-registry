---
name: explain
description: Deep explanation of complex code, files, or concepts. Routes to expert agents, uses structural search, generates mermaid diagrams. Triggers on: explain, deep dive, how does X work, architecture, data flow. Use when this capability is needed.
metadata:
  author: 0xdarkmatter
---
