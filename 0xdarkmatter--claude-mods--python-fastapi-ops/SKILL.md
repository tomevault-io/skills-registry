...
description: FastAPI web framework patterns. Triggers on: fastapi, api endpoint, dependency injection, pydantic model, openapi, swagger, starlette, async api, rest api, uvicorn. Use when this capability is needed.
metadata:
  author: 0xDarkMatter
---
