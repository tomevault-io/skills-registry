---
name: setperms
description: Set tool permissions for Claude Code. Configures allowed commands, rules, and preferences in .claude/ directory. Triggers on: setperms, init tools, configure permissions, setup project, set permissions, init claude. Use when this capability is needed.
metadata:
  author: 0xdarkmatter
---
