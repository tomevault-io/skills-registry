---
name: skillify
description: Capture this session's repeatable process into a reusable skill. Call at end of a process you want to automate. Use when this capability is needed.
metadata:
  author: 0xMH
---
...
---
> Source: [0xMH/claude-skillify](https://github.com/0xMH/claude-skillify) — distributed by [TomeVault](https://tomevault.io).
