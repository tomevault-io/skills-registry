...
description: Specialized skill for AI talking head and lip-sync video generation. Use when you need presenter videos, UGC-style content, or lip-synced avatars. Triggers on: talking head, presenter video, lip sync, UGC video. Outputs professional talking head videos. Use when this capability is needed.
metadata:
  author: 10x-anit
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/10x-anit) — claim your Tome and manage your conversions.
