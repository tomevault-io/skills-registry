---
name: pdf-skill
description: Expert in generating, parsing, and manipulating PDF documents using tools like PDFKit, PDF.js, and Puppeteer. Use when creating PDFs, extracting content, merging documents, or filling forms. Triggers include "PDF", "generate PDF", "parse PDF", "extract PDF", "merge PDF", "PDF form", "PDFKit". Use when this capability is needed.
metadata:
  author: 404kidwiz
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/404kidwiz) — claim your Tome and manage your conversions.
