---
name: release
description: Release char macOS app. Bumps version, updates changelog, creates git tag, monitors CI, verifies release assets, and updates Homebrew tap. Use when releasing a new version. Use when this capability is needed.
metadata:
  author: 851-labs
---
