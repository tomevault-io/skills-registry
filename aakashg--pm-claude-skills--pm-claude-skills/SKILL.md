...
description: Activate when the user asks to "write a status update", "weekly update", "stakeholder update", "write a project update", or "status report". Use when this capability is needed.
metadata:
  author: aakashg
---
...
---
> Source: [aakashg/pm-claude-skills](https://github.com/aakashg/pm-claude-skills) — distributed by [TomeVault](https://tomevault.io).
