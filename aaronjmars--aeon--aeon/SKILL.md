...
description: Digest of the most interesting new posts on [REPLACE: TOPIC] from RSS feeds and the open web Use when this capability is needed.
metadata:
  author: aaronjmars
---
...
---
> Source: [aaronjmars/aeon](https://github.com/aaronjmars/aeon) — distributed by [TomeVault](https://tomevault.io).
