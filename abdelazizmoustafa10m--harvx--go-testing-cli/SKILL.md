---
name: go-testing-cli
description: Testing patterns for Go CLI tools - command tests, golden tests, table-driven tests, filesystem tests, benchmarks, and fuzz tests. Use when writing or reviewing tests for Harvx. Use when this capability is needed.
metadata:
