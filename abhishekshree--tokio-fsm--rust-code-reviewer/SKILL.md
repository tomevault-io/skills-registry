...
description: Expert Rust code reviewer. Reviews Rust code for quality, safety, idioms, performance, maintainability, readability, and API ergonomics. Use when this capability is needed.
metadata:
  author: abhishekshree
---
...
---
> Source: [abhishekshree/tokio-fsm](https://github.com/abhishekshree/tokio-fsm) — distributed by [TomeVault](https://tomevault.io).
