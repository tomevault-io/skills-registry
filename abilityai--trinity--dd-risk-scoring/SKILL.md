...
description: Calculate weighted risk scores from specialist agent reports. Use when synthesizing multiple due diligence reports into an overall investment risk assessment. Use when this capability is needed.
metadata:
  author: abilityai
---
