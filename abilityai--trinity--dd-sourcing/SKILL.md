---
name: dd-sourcing
description: Document sources properly for due diligence reports. Use when citing any external data, ensuring full traceability and auditability of findings. Use when this capability is needed.
metadata:
  author: abilityai
---
