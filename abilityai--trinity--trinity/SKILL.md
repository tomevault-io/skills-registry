...
description: Standard output format for due diligence analysis reports. Use when producing your final analysis to ensure consistency across all specialist agents. Use when this capability is needed.
metadata:
  author: Abilityai
---
...
---
> Source: [Abilityai/trinity](https://github.com/Abilityai/trinity) — distributed by [TomeVault](https://tomevault.io).
