---
name: planning-tasks
description: 承認済みの設計書（DESIGN.md）からTDD準拠のTODO.mdを作成します。analyzing-requirementsスキルで設計が完了・承認された後に使用します。developingスキルで実装できる形式のタスクリストを生成します。 Use when this capability is needed.
metadata:
  author: ac2393921
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ac2393921) — claim your Tome and manage your conversions.
