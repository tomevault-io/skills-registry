...
description: Execute AI coding CLI tools (Claude Code / Gemini CLI / qodercli) on behalf of Workers. Use when a Worker sends a coding-request: message, asking Manager to run coding operations in their workspace. Use when this capability is needed.
metadata:
  author: AcademicAngels
---
...
---
> Source: [AcademicAngels/Uranus](https://github.com/AcademicAngels/Uranus) — distributed by [TomeVault](https://tomevault.io).
