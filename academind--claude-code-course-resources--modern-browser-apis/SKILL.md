...
description: Utilize built-in browser APIs (like Popover API, View Transitions etc) instead of building features manually via JavaScript Use when this capability is needed.
metadata:
  author: academind
---
