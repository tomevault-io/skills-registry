---
name: git-workflow
description: Git workflow patterns for the ACDC Digital monorepo including commit conventions, branching strategy, and common operations. Use when committing code, managing branches, or resolving git issues. Use when this capability is needed.
metadata:
  author: acdc-digital
---
