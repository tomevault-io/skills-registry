---
name: internal-comms
description: Use when working with a set of resources to help write all kinds of internal communications for the University of Hawaiʻi at Mānoa and the Shidler College of Business. Claude should use this skill whenever asked to write internal communications (course announcements, department updates, 3P updates, college newsletters, FAQs, project updates, committee reports, faculty/staff memos, etc.).
metadata:
...
4. **Apply UH Mānoa branding** — use a professional, institutional tone consistent with university communications
