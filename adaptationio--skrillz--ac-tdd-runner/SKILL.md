---
name: ac-tdd-runner
description: Run TDD cycle for feature implementation. Use when implementing features with RED-GREEN-REFACTOR, running test-driven development, automating TDD workflow, or ensuring test-first development. Use when this capability is needed.
metadata:
  author: adaptationio
---
