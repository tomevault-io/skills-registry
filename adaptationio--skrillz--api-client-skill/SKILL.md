---
name: api-client
description: REST API client builder with authentication, error handling, retry logic, and request management. Supports OAuth, JWT, API keys. Use when building API integrations, creating API clients, or working with REST services. Use when this capability is needed.
metadata:
  author: adaptationio
---
