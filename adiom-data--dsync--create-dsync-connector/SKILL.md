...
description: Create a new dsync connector with test suite. Use when adding support for a new data source/sink type (e.g., file, S3, database). Use when this capability is needed.
metadata:
  author: adiom-data
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/adiom-data) — claim your Tome and manage your conversions.
