---
name: session-export
description: Update GitHub PR or GitLab MR descriptions with AI session export summaries. Use when user asks to add session summary to PR/MR, document AI assistance in PR/MR, or export conversation summary to PR/MR description. Use when this capability is needed.
metadata:
  author: adityazxxx
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/adityazxxx) — claim your Tome and manage your conversions.
