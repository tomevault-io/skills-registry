---
name: code-review
description: Review a SolTechnology.Core change against the Tale Code philosophy, ClaudeCodingGuide rules, module conventions, and existing per-module review templates. Use when this capability is needed.
metadata:
  author: AdrianStrugala
---
...
---
> Source: [AdrianStrugala/SolTechnology.Core](https://github.com/AdrianStrugala/SolTechnology.Core) — distributed by [TomeVault](https://tomevault.io).
