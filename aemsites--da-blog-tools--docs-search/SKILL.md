...
description: Searches the aem.live documentation for information on features of the platform. Use this skill when you need more information about a feature, want guidance on how to implement a feature, and using existing tools you have to search the web isn't turning up relevant results. Use when this capability is needed.
metadata:
  author: aemsites
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/aemsites) — claim your Tome and manage your conversions.
