---
name: axolotl-schema
description: Schema-first development, @resolver directive, models generation, resolver boilerplate scaffolding, CLI commands, and inspect tool Use when this capability is needed.
metadata:
  author: aexol-studio
---
