---
name: zeus-graphql
description: Zeus type-safe GraphQL client with React Query integration - useQuery/useMutation + Zeus queryFn, selectors, cache invalidation, API layer architecture Use when this capability is needed.
metadata:
  author: aexol-studio
---
