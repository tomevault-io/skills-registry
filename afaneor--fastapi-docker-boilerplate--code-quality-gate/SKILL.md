...
description: Automated code quality checks before commits. Use before committing code, when finishing a feature, or when user mentions "ready to commit" or "quality check". Use when this capability is needed.
metadata:
  author: afaneor
---
