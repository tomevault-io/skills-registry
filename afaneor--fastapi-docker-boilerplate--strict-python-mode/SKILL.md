...
description: Enforces type hints, docstrings, and Python best practices. Use when writing or refactoring Python code, creating new functions, or when user mentions "production-ready" or "type-safe" code. Use when this capability is needed.
metadata:
  author: afaneor
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/afaneor) — claim your Tome and manage your conversions.
