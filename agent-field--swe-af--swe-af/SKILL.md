---
name: swe-af
description: Autonomous engineering team runtime — one API call spins up coordinated AI agents to scope, build, and ship software. Use when this capability is needed.
metadata:
  author: Agent-Field
---
...
---
> Source: [Agent-Field/SWE-AF](https://github.com/Agent-Field/SWE-AF) — distributed by [TomeVault](https://tomevault.io).
