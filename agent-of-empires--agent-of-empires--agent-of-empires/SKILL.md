---
name: aoe
description: Manage AI coding agent sessions via Agent of Empires (aoe) Use when this capability is needed.
metadata:
...
---
> Source: [agent-of-empires/agent-of-empires](https://github.com/agent-of-empires/agent-of-empires) — distributed by [TomeVault](https://tomevault.io).
