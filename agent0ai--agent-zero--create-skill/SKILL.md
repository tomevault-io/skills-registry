---
name: create-skill
description: Wizard for creating new Agent Zero skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills. Use when this capability is needed.
metadata:
  author: agent0ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/agent0ai) — claim your Tome and manage your conversions.
