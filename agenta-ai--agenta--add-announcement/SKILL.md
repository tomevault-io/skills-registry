...
description: Helps add announcement cards to the sidebar banner system. Use when adding changelog entries, feature announcements, updates, or promotional banners to the Agenta sidebar. Handles both simple changelog entries and complex custom banners. Use when this capability is needed.
metadata:
  author: agenta-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/agenta-ai) — claim your Tome and manage your conversions.
