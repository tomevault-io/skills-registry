...
description: Update the API reference documentation by downloading the latest OpenAPI spec from production and regenerating the Docusaurus API docs Use when this capability is needed.
metadata:
  author: agenta-ai
---
