...
description: Add email capabilities to AI agents using popular frameworks. Provides pre-built tools for TypeScript and Python frameworks including Vercel AI SDK, LangChain, Clawdbot, OpenAI Agents SDK, and LiveKit Agents. Use when integrating AgentMail with agent frameworks that need email send/receive tools. Use when this capability is needed.
metadata:
  author: agentmail-to
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/agentmail-to) — claim your Tome and manage your conversions.
