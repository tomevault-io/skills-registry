...
description: View Transitions API patterns - same-document transitions, cross-document MPA transitions, shared element animations, pseudo-element styling, accessibility Use when this capability is needed.
metadata:
  author: agents-inc
---
