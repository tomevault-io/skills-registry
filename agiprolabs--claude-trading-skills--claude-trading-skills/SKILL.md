...
description: Walk-forward validation framework for trading strategies and ML models with time-series-aware splits, overfit detection, and regime-aware validation Use when this capability is needed.
metadata:
  author: agiprolabs
---
...
---
> Source: [agiprolabs/claude-trading-skills](https://github.com/agiprolabs/claude-trading-skills) — distributed by [TomeVault](https://tomevault.io).
