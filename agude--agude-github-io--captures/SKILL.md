---
name: captures
description: Generate Liquid capture blocks from rough notes. Use when starting a book review to turn voice-transcribed notes into template variables for books, authors, and series mentioned. Use when this capability is needed.
metadata:
  author: agude
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/agude) — claim your Tome and manage your conversions.
