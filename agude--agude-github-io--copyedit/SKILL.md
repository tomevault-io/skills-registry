---
name: copyedit
description: Edit blog posts and book reviews. Use `/copyedit grammar` for spelling/grammar only, or `/copyedit polish` for fuller editing. Preserves the author's voice and style. Use when this capability is needed.
metadata:
  author: agude
---
