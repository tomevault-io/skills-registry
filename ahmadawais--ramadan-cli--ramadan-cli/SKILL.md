---
name: ramadan-cli
description: Spec reference: `skills/spec.md` Use when this capability is needed.
metadata:
  author: ahmadawais
---
...
---
> Source: [ahmadawais/ramadan-cli](https://github.com/ahmadawais/ramadan-cli) — distributed by [TomeVault](https://tomevault.io).
