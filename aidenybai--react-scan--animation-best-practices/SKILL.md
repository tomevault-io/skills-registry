...
description: CSS and UI animation patterns for responsive, polished interfaces. Use when implementing hover effects, tooltips, button feedback, transitions, or fixing animation issues like flicker and shakiness. Use when this capability is needed.
metadata:
  author: aidenybai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/aidenybai) — claim your Tome and manage your conversions.
