---
name: wilma
description: Access Finland's Wilma school system from AI agents. Fetch schedules, homework, exams, grades, messages, and news via the wilma CLI. Start with `wilma summary --json` for a full daily briefing, or drill into specific data with individual commands. Use when this capability is needed.
metadata:
  author: aikarjal
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/aikarjal) — claim your Tome and manage your conversions.
