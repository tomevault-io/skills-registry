---
name: adr-log
description: Document architecture decisions with ADR (Architecture Decision Records). Use when making significant technical decisions, choosing between alternatives, or when onboarding needs context on past decisions. Use when this capability is needed.
metadata:
  author: aiskillstore
---
