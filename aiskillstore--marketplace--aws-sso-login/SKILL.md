---
name: aws-sso-login
description: Authenticate to AWS using Single Sign-On (SSO). Use when AWS CLI operations require SSO authentication or when SSO session has expired. Use when this capability is needed.
metadata:
  author: aiskillstore
---
