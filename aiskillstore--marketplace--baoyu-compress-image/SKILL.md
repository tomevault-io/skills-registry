...
description: Cross-platform image compression skill. Converts images to WebP by default with PNG-to-PNG support. Uses system tools (sips, cwebp, ImageMagick) with Sharp fallback. Use when this capability is needed.
metadata:
  author: aiskillstore
---
