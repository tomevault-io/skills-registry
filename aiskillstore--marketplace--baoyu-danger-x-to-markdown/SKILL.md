...
description: Convert X (Twitter) tweet or article URL to markdown. Uses reverse-engineered X API (private). Requires user consent before use. Use when this capability is needed.
metadata:
  author: aiskillstore
---
