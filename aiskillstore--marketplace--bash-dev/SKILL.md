---
name: bash-dev
description: Bash scripting development standards, error handling, and best practices. Activated when working with .sh files or Bash scripts. Use when this capability is needed.
metadata:
  author: aiskillstore
---
