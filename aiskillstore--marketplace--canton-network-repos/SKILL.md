...
description: Canton Network open-source ecosystem guide covering DAML SDK, Canton runtime, and Splice applications. Use when working with Canton Network, DAML smart contracts, or building decentralized applications. Use when this capability is needed.
metadata:
  author: aiskillstore
---
