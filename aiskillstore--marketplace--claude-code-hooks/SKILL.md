...
description: Claude Code hook system for pre/post tool execution. Triggers on: hooks, PreToolUse, PostToolUse, hook script, tool validation, audit logging. Use when this capability is needed.
metadata:
  author: aiskillstore
---
