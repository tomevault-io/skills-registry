...
description: Create, manage, and optimize LXC containers in Proxmox. Control container lifecycle, manage resources, and coordinate container deployments across nodes. Use when this capability is needed.
metadata:
  author: aiskillstore
---
