...
description: Docker and Kubernetes patterns. Triggers on: Dockerfile, docker-compose, kubernetes, k8s, helm, pod, deployment, service, ingress, container, image. Use when this capability is needed.
metadata:
  author: aiskillstore
---
