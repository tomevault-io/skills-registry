---
name: delon-chart
description: @delon/chart skill - G2Plot enterprise charting components with @delon/chart. For ng-events construction site progress tracking system. Use when this capability is needed.
metadata:
  author: aiskillstore
---
