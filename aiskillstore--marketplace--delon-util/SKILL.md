---
name: delon-util
description: @delon/util skill - Utility functions library for array, string, date, number manipulation. For ng-events construction site progress tracking system. Use when this capability is needed.
metadata:
  author: aiskillstore
---
