...
description: Triage FiftyOne GitHub issues by validating status, categorizing resolution, and generating standardized responses. Use when reviewing issues to determine if fixed, won't fix, not reproducible, no longer relevant, or still valid. Use when this capability is needed.
metadata:
  author: aiskillstore
---
