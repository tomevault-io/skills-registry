---
name: file-search
description: Modern file and content search using fd, ripgrep (rg), and fzf. Triggers on: fd, ripgrep, rg, find files, search code, fzf, fuzzy find, search codebase. Use when this capability is needed.
metadata:
  author: aiskillstore
---
