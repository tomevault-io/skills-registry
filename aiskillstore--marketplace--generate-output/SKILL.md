...
description: Create the deliverable (code, documentation, tests, content) following the user's standards and best practices. Use after validation passes to actually build the work product. Use when this capability is needed.
metadata:
  author: aiskillstore
---
