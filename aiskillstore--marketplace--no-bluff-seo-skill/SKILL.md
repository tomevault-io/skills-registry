...
description: Enforce the No-Bluff SEO/GEO protocol using DataForSEO and SEMRush. Use when generating or modifying any SEO-related copy, claims, or structured data for Synthex or client sites. Use when this capability is needed.
metadata:
  author: aiskillstore
---
