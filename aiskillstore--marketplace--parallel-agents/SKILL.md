...
description: Dispatch multiple agents to work on independent problems concurrently. Use when facing 3+ independent failures or tasks. Use when this capability is needed.
metadata:
  author: aiskillstore
---
