...
description: Python type hints and type safety patterns. Triggers on: type hints, typing, TypeVar, Generic, Protocol, mypy, pyright, type annotation, overload, TypedDict. Use when this capability is needed.
metadata:
  author: aiskillstore
---
