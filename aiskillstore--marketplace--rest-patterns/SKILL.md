---
name: rest-patterns
description: Quick reference for RESTful API design patterns, HTTP semantics, caching, and rate limiting. Triggers on: rest api, http methods, status codes, api design, endpoint design, api versioning, rate limiting, caching headers. Use when this capability is needed.
metadata:
  author: aiskillstore
---
