...
description: Execute plans using fresh subagent per task with code review between tasks. Use for high-quality iterative implementation. Use when this capability is needed.
metadata:
  author: aiskillstore
---
