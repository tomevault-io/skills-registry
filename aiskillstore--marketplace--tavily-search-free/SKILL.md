...
description: Use Tavily Search API for optimized, real-time web search results for RAG. A pre-configured, cost-effective search tool. Use when this capability is needed.
metadata:
  author: aiskillstore
---
