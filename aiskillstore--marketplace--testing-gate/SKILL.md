---
name: testing-gate
description: Gate 6 - Verify tests exist and cover critical paths. Issues result in WARNINGS (encourages tests, doesn't block). Use when this capability is needed.
metadata:
  author: aiskillstore
---
