---
name: vercel
description: Deploy and manage Vercel projects, domains, environment variables, and serverless functions using the `vercel` CLI. Use when this capability is needed.
metadata:
  author: aiskillstore
---
