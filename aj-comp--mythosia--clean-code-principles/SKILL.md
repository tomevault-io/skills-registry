...
description: Enforce clean code principles when writing or reviewing code. Use when writing new functions, refactoring existing code, or reviewing code for readability and maintainability. Covers guard clauses, modularization, naming conventions, and more. Use when this capability is needed.
metadata:
  author: aj-comp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/aj-comp) — claim your Tome and manage your conversions.
