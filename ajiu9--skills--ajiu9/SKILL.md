---
name: ajiu9
description: Ajiu9's opinionated tooling and conventions for JavaScript/TypeScript projects. Use when setting up new projects, configuring ESLint/Prettier alternatives, monorepos, library publishing, or when the user mentions Ajiu9's preferences. Use when this capability is needed.
metadata:
  author: ajiu9
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ajiu9) — claim your Tome and manage your conversions.
