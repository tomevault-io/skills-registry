...
description: Safely execute SQL queries against a user database without risking SQL injection or other security vulnerabilities. Use when this capability is needed.
metadata:
  author: Akash504-ai
---
...
---
> Source: [Akash504-ai/supabase](https://github.com/Akash504-ai/supabase) — distributed by [TomeVault](https://tomevault.io).
