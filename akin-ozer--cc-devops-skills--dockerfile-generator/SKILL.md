...
description: Create, generate, or write Dockerfiles and multi-stage Docker images. Containerize apps. Use when this capability is needed.
metadata:
  author: akin-ozer
---
...
---
> Source: [akin-ozer/cc-devops-skills](https://github.com/akin-ozer/cc-devops-skills) — distributed by [TomeVault](https://tomevault.io).
