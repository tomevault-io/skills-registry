...
description: Generate/create/scaffold Terragrunt HCL files — root.hcl, terragrunt.hcl, child modules, stacks, multi-env layouts. Use when this capability is needed.
metadata:
  author: akin-ozer
---
