---
name: topics
description: Mine insights from comments and historical data to recommend the next worthwhile topics. Trigger words: 'topics', 'topic', '選題', '寫什麼'. Use when this capability is needed.
metadata:
