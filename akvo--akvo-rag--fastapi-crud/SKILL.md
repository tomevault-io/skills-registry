---
name: fastapi-crud
description: Step-by-step guide for adding new CRUD endpoints to the FastAPI backend. Use when creating new API resources with router, Pydantic schemas, service layer, and tests. Use when this capability is needed.
metadata:
  author: akvo
---
...
---
> Source: [akvo/akvo-rag](https://github.com/akvo/akvo-rag) — distributed by [TomeVault](https://tomevault.io).
