...
description: Create promotional TikTok-style short videos for projects. Analyzes your codebase to understand what the project does, then generates a Remotion-based video in either portrait (9x16) or landscape (16x9) format. Use when this capability is needed.
metadata:
  author: alentodorov
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/alentodorov) — claim your Tome and manage your conversions.
