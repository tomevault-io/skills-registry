---
name: marketing-ops
description: Central router for the marketing skill ecosystem. Use when unsure which marketing skill to use, when orchestrating a multi-skill campaign, or when coordinating across content, SEO, CRO, channels, and analytics. Also use when the user mentions 'marketing help,' 'campaign plan,' 'what should I do next,' 'marketing priorities,' or 'coordinate marketing. Use when this capability is needed.
metadata:
  author: AlexBramall
---
...
| "AI search," "AI visibility," "Perplexity," "AEO" | **ai-seo** | Not seo-audit (that's traditional SEO) |
...
---
> Source: [AlexBramall/claude-code-skills](https://github.com/AlexBramall/claude-code-skills) — distributed by [TomeVault](https://tomevault.io).
