...
description: 42 marketing agent skills and plugins for Claude Code, Codex, Cursor, OpenClaw, and 6 more coding agents. 7 pods: content, SEO, CRO, channels, growth, intelligence, sales. Foundation context + orchestration router. 27 Python tools (stdlib-only). Use when this capability is needed.
metadata:
  author: AlexBramall
---
