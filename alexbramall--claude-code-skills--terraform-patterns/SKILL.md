...
description: Terraform infrastructure-as-code agent skill and plugin for Claude Code, Codex, Cursor, OpenClaw. Covers module design patterns, state management strategies, provider configuration, security hardening, policy-as-code with Sentinel/OPA, and CI/CD plan/apply workflows. Use when: user wants to design Terraform modules, manage state backends, review Terraform security, implement multi-region deployments, or follow IaC best practices. Use when this capability is needed.
metadata:
  author: AlexBramall
---
...
### One-liner (any tool)
```bash
git clone https://github.com/alexbramall/claude-skills.git
