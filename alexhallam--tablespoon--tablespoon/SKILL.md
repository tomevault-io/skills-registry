---
name: tablespoon
description: One of the primary purposes of this package is to generate forecast methods as benchmarks. Use when this capability is needed.
metadata:
  author: alexhallam
---
# Skill Score
...
---
> Source: [alexhallam/tablespoon](https://github.com/alexhallam/tablespoon) — distributed by [TomeVault](https://tomevault.io).
