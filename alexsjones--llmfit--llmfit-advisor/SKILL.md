---
name: llmfit-advisor
description: Detect local hardware (RAM, CPU, GPU/VRAM) and recommend the best-fit local LLM models with optimal quantization, speed estimates, and fit scoring. Use when this capability is needed.
metadata:
  author: alexsjones
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/alexsjones) — claim your Tome and manage your conversions.
