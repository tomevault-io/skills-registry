---
name: notebooklm
description: Deep research and slide presentation generator using NotebookLM MCP. Performs deep research on topics, then generates professional slide presentations with white background and Arial font based on research sources. Use when this capability is needed.
metadata:
  author: alfredang
---
