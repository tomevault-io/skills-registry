...
description: TDD iteration loops using Claude Code Stop hooks - runs tests after each response, feeds failures back automatically Use when this capability is needed.
metadata:
  author: alinaqi
---
