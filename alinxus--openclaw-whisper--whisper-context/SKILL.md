...
description: Official Whisper Context skill for OpenClaw. Cuts context tokens via delta compression + caching, and adds long-term memory across sessions. Use when this capability is needed.
metadata:
  author: alinxus
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/alinxus) — claim your Tome and manage your conversions.
