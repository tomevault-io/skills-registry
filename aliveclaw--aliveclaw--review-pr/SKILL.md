---
name: review-pr
description: Review-only GitHub pull request analysis with the gh CLI. Use when asked to review a PR, provide structured feedback, or assess readiness to land. Do not merge, push, or make code changes you intend to keep. Use when this capability is needed.
metadata:
  author: aliveclaw
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/aliveclaw) — claim your Tome and manage your conversions.
