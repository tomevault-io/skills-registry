---
name: mise
description: Figure out if a tool can be installed via mise (across all backends) and install it. Use when this capability is needed.
metadata:
  author: aljohri
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/aljohri) — claim your Tome and manage your conversions.
