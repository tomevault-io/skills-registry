---
name: error-tracking
description: Error tracking and logging with Sentry. Setup guides for Next.js, React, and React Native. Covers error boundaries, custom tagging, source maps, and alerting. Use when this capability is needed.
metadata:
  author: alkalisummer
---
