---
name: nextjs
description: Next.js 15+ App Router patterns including Server Components, Streaming SSR, Server Actions, routing patterns, caching strategies, and file structure conventions. Use when building Next.js applications with App Router. Use when this capability is needed.
metadata:
  author: alkalisummer
---
