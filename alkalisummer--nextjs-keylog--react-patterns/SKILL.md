---
name: react-patterns
description: React component patterns for building scalable and maintainable UI. Use when designing component architecture, sharing logic between components, managing complex state, or refactoring React applications. Use when this capability is needed.
metadata:
  author: alkalisummer
---
