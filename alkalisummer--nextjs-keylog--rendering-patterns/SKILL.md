...
description: Web rendering strategies for modern applications including CSR, SSR, SSG, ISR, and streaming. Use when architecting web applications, choosing rendering methods for Next.js/Remix, or optimizing for SEO and performance. Use when this capability is needed.
metadata:
  author: alkalisummer
---
