---
name: artifact-linker
description: name: hugging-face-dataset-viewer Use when this capability is needed.
metadata:
  author: allenai
---
---
...
---
> Source: [allenai/artifact-linker](https://github.com/allenai/artifact-linker) — distributed by [TomeVault](https://tomevault.io).
