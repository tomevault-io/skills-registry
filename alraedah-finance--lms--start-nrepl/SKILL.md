---
name: start-nrepl
description: Start an nREPL server in the background. Use this when the user needs a REPL running for code evaluation, testing, or interactive development. Use when this capability is needed.
metadata:
  author: alraedah-finance
---
...
1. If it exists, read it and look for a section about starting the REPL or nREPL
...
1. Check if `deps.edn` exists and contains an nREPL alias (`:dev`, `:nrepl`, etc.)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/alraedah-finance) — claim your Tome and manage your conversions.
