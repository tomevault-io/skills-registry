...
description: Run export partition tests in the s3 test suite. Use when the user wants to run export partition tests, test ALTER TABLE EXPORT PARTITION ID functionality, or test exporting MergeTree partitions to S3. Use when this capability is needed.
metadata:
  author: altinity
---
