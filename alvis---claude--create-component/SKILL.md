...
description: Create well-structured, reusable React components with TypeScript. Use when building new UI components, following React best practices, or scaffolding component files with tests. Use when this capability is needed.
metadata:
  author: alvis
---
