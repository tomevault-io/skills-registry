---
name: example-skill
description: Performs thorough code reviews following best practices. Use when reviewing pull requests, checking code quality, or ensuring coding standards compliance. Use when this capability is needed.
metadata:
