...
description: Generates high-quality, tailored resumes optimized for specific job descriptions while maintaining factual integrity. Builds resumes around the holistic person by surfacing undocumented experiences through conversational discovery.
metadata:
  author: amanattar
---
---
...
---
> Source: [amanattar/resume-tailoring-skill](https://github.com/amanattar/resume-tailoring-skill) — distributed by [TomeVault](https://tomevault.io).
