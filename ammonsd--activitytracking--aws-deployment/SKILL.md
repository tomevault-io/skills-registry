---
name: aws-deployment
description: Guides AWS ECS deployment workflows including CloudFormation stack management, ECS service updates, RDS configuration, S3 setup, and SES email configuration Use when this capability is needed.
metadata:
  author: ammonsd
---
