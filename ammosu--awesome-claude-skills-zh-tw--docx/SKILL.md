---
name: docx
description: 全方位的文件建立、編輯和分析功能，支援追蹤修訂、註解、格式保留和文字擷取。當 Claude 需要處理專業文件（.docx 檔案）時使用，包括：(1) 建立新文件、(2) 修改或編輯內容、(3) 處理追蹤修訂、(4) 新增註解，或任何其他文件相關任務 Use when this capability is needed.
metadata:
  author: ammosu
---
