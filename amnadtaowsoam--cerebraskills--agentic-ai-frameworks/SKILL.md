...
## Skill Composition
* **Depends on**: None (standalone framework)
* **Compatible with**: [rag-advanced](../rag-advanced/SKILL.md) (Knowledge retrieval), [llm-finetuning-alignment](../llm-finetuning-alignment/SKILL.md) (Model customization)
* **Conflicts with**: None
* **Related Skills**: [ai-workflow-orchestration](../ai-workflow-orchestration/SKILL.md), [knowledge-graph-integration](../knowledge-graph-integration/SKILL.md)
