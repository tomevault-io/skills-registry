...
## Anti-patterns
1. **High Cardinality Metrics**: Too many label combinations causing performance issues
2. **Silent Monitoring**: Monitoring without alerting
3. **Over-Monitoring**: Tracking everything without focus
4. **Ignoring Context**: Metrics without dimensional context
5. **Alert Fatigue**: Too many low-priority alerts
6. **No Retention Policy**: Unlimited log/metric storage
