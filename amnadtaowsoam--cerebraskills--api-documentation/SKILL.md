...
description: API documentation is critical for enabling developers to effectively Use when this capability is needed.
metadata:
...
- **Better Developer Experience**: Interactive documentation with try-it-out features improves developer satisfaction
...
* **Entry Conditions**:
  ...
  - Documentation tool selected (Swagger UI, Redoc, etc.)
...
* **Compatible with**: [technical-writing](./technical-writing/SKILL.md), [system-architecture-docs](./system-architecture-docs/SKILL.md)
* **Conflicts with**: None (generic documentation skill)
* **Related Skills**: [user-guides](./user-guides/SKILL.md), [runbooks](./runbooks/SKILL.md)
