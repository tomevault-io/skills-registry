...
description: App distribution covers process of submitting, testing, and releasing Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [Mobile CI/CD](31-mobile-development/mobile-ci-cd/SKILL.md), [App Testing](16-testing/)
* **Compatible with**: [Deep Linking](31-mobile-development/deep-linking/SKILL.md), [Push Notifications](31-mobile-development/push-notifications/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [App Store Optimization](19-seo-optimization/), [Release Engineering](59-release-engineering/)
