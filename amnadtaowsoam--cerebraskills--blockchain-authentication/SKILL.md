...
description: Web3 authentication uses cryptographic signatures to verify user identity Use when this capability is needed.
metadata:
...
* **Conflicts with**: None
* **Related Skills**: [wallet-connection](35-blockchain-web3/wallet-connection/SKILL.md), [smart-contracts](35-blockchain-web3/smart-contracts/SKILL.md)
