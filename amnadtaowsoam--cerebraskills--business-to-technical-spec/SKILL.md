...
## Agent Directives
1. **Gathering Phase**: Always gather requirements from multiple sources
2. **Analysis Phase**: Always analyze requirements for quality and completeness
3. **Validation Phase**: Always validate requirements against thresholds
4. **Generation Phase**: Always use standard templates for specifications
5. **Review Phase**: Always require review and approval before publishing
