...
description: Code commentary (comments) should explain "why" code exists, not "what Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [technical-writing](./technical-writing/SKILL.md), [api-documentation](./api-documentation/SKILL.md)
* **Compatible with**: [system-architecture-docs](./system-architecture-docs/SkILL.md), [runbooks](./runbooks/SKILL.md)
* **Conflicts with**: None (generic documentation skill)
* **Related Skills**: [code-review-culture](../27-team-collaboration/code-review-culture/SKILL.md), [knowledge-sharing](../27-team-collaboration/knowledge-sharing/SKILL.md)
