---
name: code-review
description: Code review is a systematic examination of source code intended to find Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [technical-debt-management](../00-meta-skills/technical-debt-management/SKILL.md), [refactoring-strategies](../refactoring-strategies/SKILL.md)
* **Compatible with**: [api-design](../api-design/SKILL.md), [architectural-reviews](../00-meta-skills/architectural-reviews/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [python-standards](../python-standards/SKILL.md), [typescript-standards](../typescript-standards/SKILL.md), [git-workflow](../git-workflow/SKILL.md)
