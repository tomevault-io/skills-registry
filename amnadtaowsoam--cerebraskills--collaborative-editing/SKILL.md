...
## Skill Composition
* **Depends on**: WebSocket Patterns (`34-real-time-features/websocket-patterns/`), Presence Detection (`34-real-time-features/presence-detection/`)
* **Compatible with**: Live Notifications (`34-real-time-features/live-notifications/`), Real-time Dashboard (`34-real-time-features/real-time-dashboard/`)
* **Conflicts with**: None
* **Related Skills**: [presence-detection](34-real-time-features/presence-detection/SKILL.md), [server-sent-events](34-real-time-features/server-sent-events/SKILL.md)
