...
description: Data augmentation is a technique used to artificially increase size and Use when this capability is needed.
metadata:
...
## Assumptions
- Data can be meaningfully augmented
- Augmentation parameters are task-appropriate
- Sufficient compute resources for augmentation
