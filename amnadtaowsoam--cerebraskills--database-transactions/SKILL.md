...
description: Database transactions are fundamental to maintaining data integrity and Use when this capability is needed.
metadata:
...
- **Error Recovery**: Enables rollback of failed operations
- **Business Logic**: Supports complex business transactions
- **Compliance**: Required for financial and regulatory compliance
...
## Assumptions
- Database supports transactions (ACID compliant)
- Application can handle retry logic
- Network is stable enough for transaction completion
