...
## Skill Composition
* **Depends on**: IoT Protocols (`36-iot-integration/iot-protocols/`), IoT Security (`36-iot-integration/iot-security/`)
...
* **Conflicts with**: None
* **Related Skills**: [iot-protocols](36-iot-integration/iot-protocols/SKILL.md), [iot-security](36-iot-integration/iot-security/SKILL.md)
