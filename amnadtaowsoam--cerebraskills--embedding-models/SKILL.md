...
## Anti-patterns
1. **No Normalization**: Embeddings without normalization break similarity
2. **Wrong Distance Metric**: Using Euclidean when cosine is appropriate
3. **Ignoring Batch Size**: Processing one item at a time is inefficient
4. **No Caching**: Re-computing same embeddings wastes resources
5. **Wrong Model Choice**: Using large models for simple tasks
6. **Ignoring Drift**: Not monitoring embedding quality over time
