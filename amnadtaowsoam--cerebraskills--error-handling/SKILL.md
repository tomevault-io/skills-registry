---
name: error-handling
description: Error Handling is a critical component of backend development that enables Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [api-design](../../01-foundations/api-design/SKILL.md), [middleware](../middleware/SKILL.md)
* **Compatible with**: [validation](../validation/SKILL.md), [express-rest](../express-rest/SKILL.md), [fastapi-patterns](../fastapi-patterns/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [monitoring-observability](../../14-monitoring-observability/SKILL.md), [testing](../../16-testing/SKILL.md)
