---
name: express-rest
description: Express.js is a minimal and flexible Node.js web application framework Use when this capability is needed.
metadata:
...
* **Conflicts with**: [fastapi-patterns](../fastapi-patterns/SKILL.md) (alternative framework)
