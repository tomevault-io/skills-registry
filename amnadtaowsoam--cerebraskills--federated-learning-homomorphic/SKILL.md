...
description: This skill covers the implementation of privacy-preserving machine learning Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [model-serving-inference](../../78-inference-model-serving/high-performance-inference/SKILL.md), [mlflow-patterns](../../77-mlops-data-engineering/mlflow-patterns/SKILL.md)
* **Compatible with**: [drift-detection-retraining](../../77-mlops-data-engineering/drift-detection-retraining/SKILL.md), [pii-policy-enforcement](../../70-data-platform-governance/pii-policy-enforcement/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [llm-security-redteaming](../../61-ai-production/llm-security-redteaming/SKILL.md)
