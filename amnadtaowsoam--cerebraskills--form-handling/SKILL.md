---
name: form-handling
description: Form handling is a critical aspect of web applications that collect Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [react-best-practices](../react-best-practices/SKILL.md), [typescript-standards](../typescript-standards/SKILL.md)
* **Compatible with**: [state-management](../state-management/SKILL.md), [api-design](../api-design/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [error-boundaries-react](../error-boundaries-react/SKILL.md), [validation](../03-backend-api/validation/SKILL.md)
