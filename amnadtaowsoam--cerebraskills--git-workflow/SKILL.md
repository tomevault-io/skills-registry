---
name: git-workflow
description: Git workflow encompasses practices, patterns, and strategies for using Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [code-review](../code-review/SKILL.md)
* **Compatible with**: [api-design](../api-design/SKILL.md), [technical-debt-management](../00-meta-skills/technical-debt-management/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [refactoring-strategies](../refactoring-strategies/SKILL.md), [python-standards](../python-standards/SKILL.md), [typescript-standards](../typescript-standards/SKILL.md)
