...
description: Policy for enforcing code quality standards through automated checks: Use when this capability is needed.
metadata:
...
- **Consistency**: Code style is same across team
...
## Skill Composition
* **Depends on**: [definition-of-done](./definition-of-done/SKILL.md)
