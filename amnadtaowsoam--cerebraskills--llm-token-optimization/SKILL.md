...
description: This skill provides techniques for optimizing token usage in LLM applications. Use when this capability is needed.
metadata:
...
* **Related Skills**: 
  - [42-cost-engineering/llm-cost-optimization](42-cost-engineering/llm-cost-optimization/SKILL.md) - Main skill with comprehensive LLM cost coverage
  - [42-cost-engineering/cost-observability](42-cost-engineering/cost-observability/SKILL.md) - Cost monitoring
  - [44-ai-governance/model-risk-management](44-ai-governance/model-risk-management/SKILL.md) - AI risk management
