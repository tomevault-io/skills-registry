...
description: MLflow is an open-source platform for managing complete ML lifecycle, Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [Model Registry and Versioning](../77-mlops-data-engineering/model-registry-versioning/SKILL.md)
* **Compatible with**: [Feature Store Implementation](../77-mlops-data-engineering/feature-store-implementation/SKILL.md), [Drift Detection and Retraining](../77-mlops-data-engineering/drift-detection-retraining/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [Model Registry and Versioning](../77-mlops-data-engineering/model-registry-versioning/SKILL.md), [Drift Detection and Retraining](../77-mlops-data-engineering/drift-detection-retraining/SKILL.md)
