---
name: mui-material
description: Material-UI (MUI) is a comprehensive React component library implementing Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [react-best-practices](../react-best-practices/SKILL.md)
* **Compatible with**: [form-handling](../form-handling/SKILL.md), [nextjs-patterns](../nextjs-patterns/SKILL.md)
* **Conflicts with**: [shadcn-ui](../shadcn-ui/SKILL.md) (alternative UI library)
* **Related Skills**: [tailwind-patterns](../tailwind-patterns/SKILL.md), [state-management](../../05-state-management/SKILL.md)
