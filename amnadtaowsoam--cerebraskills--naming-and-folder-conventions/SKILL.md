---
name: naming-and-folder-conventions
description: Naming conventions for files, folders, variables, and functions that Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [codebase-learning](../codebase-learning/SKILL.md)
* **Compatible with**: [docs-indexing-strategy](../docs-indexing-strategy/SKILL.md), [repo-map-ssot](../repo-map-ssot/SKILL.md)
* **Conflicts with**: None
