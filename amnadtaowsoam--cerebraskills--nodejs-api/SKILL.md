---
name: nodejs-api
description: Node.js REST API is a RESTful API built with Node.js and Express.js framework, Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [error-handling](../error-handling/SKILL.md), [middleware](../middleware/SKILL.md)
* **Compatible with**: [express-rest](../express-rest/SKILL.md), [validation](../validation/SKILL.md)
* **Conflicts with**: None
