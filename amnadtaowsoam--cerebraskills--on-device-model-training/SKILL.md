...
* **Compatible with**: [hybrid-inference-architecture](../hybrid-inference-architecture/SKILL.md), [edge-ai-development-workflow](../edge-ai-development-workflow/SKILL.md)
* **Conflicts with**: None
