...
description: Product Discovery & Validation enables systematic user research, prototype Use when this capability is needed.
metadata:
...
## Assumptions
- Target users can be recruited for research
- Users are willing to provide honest feedback
- Market data is available and accurate
- Prototypes can be created quickly

## Compatibility
- Works with PostgreSQL, MySQL, MongoDB for research data
- Compatible with Typeform, SurveyMonkey, Google Forms for surveys
- Integrates with Google Analytics, Mixpanel, Amplitude for analytics
