...
description: SCIM (System for Cross-domain Identity Management) 2.0 is a standard Use when this capability is needed.
metadata:
...
* **Conflicts with**: None
* **Related Skills**: [SSO (SAML & OIDC)](file://50-enterprise-integrations/sso-saml-oidc/SKILL.md), [Enterprise RBAC Models](file://50-enterprise-integrations/enterprise-rbac-models/SKILL.md)
