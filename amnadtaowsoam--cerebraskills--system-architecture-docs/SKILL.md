---
name: system-architecture-docs
description: System architecture documentation describes structure, behavior, and Use when this capability is needed.
metadata:
...
* **Conflicts with**: None
* **Related Skills**: [technical-writing](../21-documentation/technical-writing/SKILL.md), [decision-records](../00-meta-skills/decision-records/SKILL.md), [runbooks](../21-documentation/runbooks/SKILL.md)
