...
description: Technical debt is the implied cost of additional rework caused by choosing Use when this capability is needed.
metadata:
...
## Skill Composition
* **Depends on**: [architectural-reviews](../architectural-reviews/SKILL.md), [code-review](../01-foundations/code-review/SKILL.md)
* **Compatible with**: [refactoring-strategies](../01-foundations/refactoring-strategies/SKILL.md), [system-thinking](../system-thinking/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [risk-assessment](../risk-assessment/SKILL.md), [decision-records](../decision-records/SKILL.md)
