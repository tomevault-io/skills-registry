...
## Skill Composition
* **Depends on**: [edge-model-compression](../edge-model-compression/SKILL.md) (Model optimization techniques)
* **Compatible with**: [hybrid-inference-architecture](../hybrid-inference-architecture/SKILL.md), [on-device-model-training](../on-device-model-training/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [edge-ai-development-workflow](../edge-ai-development-workflow/SKILL.md), [model-optimization-quantization](../../78-inference-model-serving/model-optimization-quantization/SKILL.md)
