---
name: aidoc
description: 记录 AI 对话产出的知识到 aidoc 仓库。当用户说"记录到 aidoc"、"存到 aidoc"、"保存这个知识点"时使用此 skill。只在用户消息中明确提到 "aidoc" 关键词时才触发，不要自行决定记录。 Use when this capability is needed.
metadata:
  author: amosbird
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/amosbird) — claim your Tome and manage your conversions.
