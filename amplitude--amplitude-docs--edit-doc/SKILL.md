---
name: edit-doc
description: This skill should be used when the user asks to "apply style rules", "fix style issues", "edit this doc", "make this follow Amplitude style", "clean up this document", or wants systematic style corrections applied to existing Amplitude documentation. Use when this capability is needed.
metadata:
  author: amplitude
---
