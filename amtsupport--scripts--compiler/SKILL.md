---
name: compiler
description: .NET Compiler for PowerShell code, combines all required files from imports into a single output with post-processors. Use when this capability is needed.
metadata:
  author: amtsupport
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/amtsupport) — claim your Tome and manage your conversions.
