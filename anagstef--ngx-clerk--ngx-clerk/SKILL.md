---
name: ngx-clerk
description: You are migrating an Angular application from ngx-clerk v0.x (Clerk Core 2 / ClerkJS v5) to ngx-clerk v1.0 (Clerk Core 3 / ClerkJS v6). Use when this capability is needed.
metadata:
  author: anagstef
---
...
---
> Source: [anagstef/ngx-clerk](https://github.com/anagstef/ngx-clerk) — distributed by [TomeVault](https://tomevault.io).
