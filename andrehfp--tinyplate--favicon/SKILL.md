---
name: favicon
description: Generate favicons and app icons for Next.js projects. Creates all required sizes, formats, and configures metadata. Use when this capability is needed.
metadata:
  author: andrehfp
---
