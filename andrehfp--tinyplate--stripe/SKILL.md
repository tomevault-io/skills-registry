---
name: stripe
description: Help with Stripe payment integration in Next.js projects. Use when implementing checkout flows, subscriptions, webhooks, customer portal, or debugging payment issues. Covers Stripe SDK usage, webhook verification, and subscription management. Use when this capability is needed.
metadata:
  author: andrehfp
---
