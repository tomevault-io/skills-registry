...
description: Guide for adjusting speedy_utils LLM inference style, including chat templating, <think> prefixes, stop sequences, and boxed-answer handling. Use when this capability is needed.
metadata:
  author: anhvth
---
