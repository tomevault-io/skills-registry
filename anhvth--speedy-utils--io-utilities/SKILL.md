---
name: io-utilities
description: Guide for using IO utilities in speedy_utils, including fast JSONL reading, multi-format loading, and file serialization. Use when this capability is needed.
metadata:
  author: anhvth
---
