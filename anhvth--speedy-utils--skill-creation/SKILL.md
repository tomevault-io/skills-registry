---
name: skill-creation
description: Guide for creating new Agent Skills with proper structure, frontmatter, bundled assets, and validation. Includes templates, best practices, and examples for building reusable skill resources. Use when this capability is needed.
metadata:
  author: anhvth
---
