---
name: add-project
description: Automatically add a GitHub project to the Current Projects section. Fetches repo info, generates an emoji and one-line description, then updates README. Use when the user provides a GitHub URL. Use when this capability is needed.
metadata:
  author: ankurkakroo2
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ankurkakroo2) — claim your Tome and manage your conversions.
