...
description: Multi-cloud Terraform module management skills for GitHub Copilot - automate provider upgrades, testing, CI/CD, and releases across AWS, GCP, Azure, and DigitalOcean modules at scale Use when this capability is needed.
metadata:
  author: anmolnagpal
---
...
---
> Source: [anmolnagpal/terraform-ai-skills](https://github.com/anmolnagpal/terraform-ai-skills) — distributed by [TomeVault](https://tomevault.io).
