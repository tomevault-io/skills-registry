...
description: Multi-agent coordination patterns for OpenCode swarm workflows. Use when working on complex tasks that benefit from parallelization, when coordinating multiple agents, or when managing task decomposition. Do NOT use for simple single-agent tasks. Use when this capability is needed.
metadata:
  author: anthonyshew
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/anthonyshew) — claim your Tome and manage your conversions.
