...
description: Create GitHub issues using GitHub CLI with support for templates, labels, assignees, milestones, and draft issues. Use when the user asks to create a GitHub issue, file a bug report, submit a feature request, or open an issue in a GitHub repository. Use when this capability is needed.
metadata:
  author: antinomyhq
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/antinomyhq) — claim your Tome and manage your conversions.
