...
|-------|-----------|-----------|
| Composition API | `~/.cursor/skills/vue-expert/references/composition-api.md` | ref, reactive, computed, watch, lifecycle |
| Components | `~/.cursor/skills/vue-expert/references/components.md` | Props, emits, slots, provide/inject |
| State Management | `~/.cursor/skills/vue-expert/references/state-management.md` | Pinia stores, actions, getters |
| Nuxt 3 | `~/.cursor/skills/vue-expert/references/nuxt.md` | SSR, file-based routing, useFetch, Fastify, hydration |
| TypeScript | `~/.cursor/skills/vue-expert/references/typescript.md` | Typing props, generic components, type safety |
| Mobile & Hybrid | `~/.cursor/skills/vue-expert/references/mobile-hybrid.md` | Quasar, Capacitor, PWA, service worker, mobile |
| Build Tooling | `~/.cursor/skills/vue-expert/references/build-tooling.md` | Vite config, sourcemaps, optimization, bundling |
...
---
> Source: [anton-dovnar/cursor](https://github.com/anton-dovnar/cursor) — distributed by [TomeVault](https://tomevault.io).
