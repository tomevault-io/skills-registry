...
description: Core patterns for data fetching, state management, and user preferences. Use when implementing new features that require getting data from Our APIs, Morpho API, on-chain states or managing shared state. Use when this capability is needed.
metadata:
  author: antoncoding
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/antoncoding) — claim your Tome and manage your conversions.
