...
description: Architecture patterns for organizing feature modules in the codebase. Use when creating new files, brand new features or pages. Use when this capability is needed.
metadata:
  author: antoncoding
---
