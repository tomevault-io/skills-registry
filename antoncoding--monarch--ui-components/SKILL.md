---
name: ui-components
description: Core component library and design system patterns. Use when building UI, building new components, new page, using design tokens, or working with the component library. Use when this capability is needed.
metadata:
  author: antoncoding
---
