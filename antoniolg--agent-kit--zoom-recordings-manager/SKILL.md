...
description: List, download, and delete Zoom recordings via the API (OAuth). Use when you need to manage recordings at scale. Use when this capability is needed.
metadata:
  author: antoniolg
---
