...
description: Context-aware guidance for maintaining and improving CLAUDE.md files. Use when editing CLAUDE.md, discussing documentation structure for AI assistants, or optimizing project instructions. Use when this capability is needed.
metadata:
  author: anyproto
---
