...
description: Context-aware routing to code generation workflows including SwiftGen, Sourcery, Feature Flags, and Protobuf. Use when running make generate, adding feature flags, or working with generated files. Use when this capability is needed.
metadata:
  author: anyproto
---
