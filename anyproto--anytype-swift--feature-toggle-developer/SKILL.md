...
description: Guides systematic removal of feature toggles from the codebase with automated cleanup detection. Use when removing feature flags, enabling toggles permanently, or cleaning up unused code after toggle removal. Use when this capability is needed.
metadata:
  author: anyproto
---
