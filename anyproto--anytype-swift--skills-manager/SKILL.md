---
name: skills-manager
description: Context-aware routing to skills and hooks management. Use when troubleshooting skill activation, fine-tuning keywords, or managing the automated documentation system. Use when this capability is needed.
metadata:
  author: anyproto
---
