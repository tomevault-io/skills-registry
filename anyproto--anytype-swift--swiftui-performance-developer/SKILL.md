...
description: Audit and improve SwiftUI runtime performance through code review and Instruments guidance. Use for diagnosing slow rendering, janky scrolling, excessive view updates, or layout thrash in SwiftUI apps. Use when this capability is needed.
metadata:
  author: anyproto
---
