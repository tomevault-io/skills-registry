...
description: Smart router to testing patterns and practices. Use when writing unit tests, creating mocks, testing edge cases, or working with Swift Testing and XCTest frameworks. Use when this capability is needed.
metadata:
  author: anyproto
---
