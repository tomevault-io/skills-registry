---
name: qa-engineer
description: Analyze code changes and generate Playwright E2E tests in anytype-desktop-suite. Run after implementing features or modifying editor/component behavior to ensure new functionality has test coverage. Use when this capability is needed.
metadata:
  author: anyproto
---
