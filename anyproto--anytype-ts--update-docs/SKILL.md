---
name: update-docs
description: Update README documentation in the folder of changed components/abstractions to reflect code changes — keeps docs lean, precise, and in sync Use when this capability is needed.
metadata:
  author: anyproto
---
