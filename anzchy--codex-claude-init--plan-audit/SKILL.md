---
name: plan-audit
description: Audit an implementation against a plan. Use when a user asks to check for gaps, logic errors, or missing tests relative to a plan or Work Items. Use when this capability is needed.
metadata:
  author: anzchy
---
