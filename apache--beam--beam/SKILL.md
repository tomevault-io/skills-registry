...
description: End-to-end guide on developing new Apache Beam I/O connectors correctly, including core IO transforms, SchemaTransforms, URN proto definitions, Managed API integration, cross-language expansion service, and testing. Use when this capability is needed.
metadata:
  author: apache
---
...
---
> Source: [apache/beam](https://github.com/apache/beam) — distributed by [TomeVault](https://tomevault.io).
