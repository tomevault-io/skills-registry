---
name: new-plugin
description: Develop a new SkyWalking Java agent plugin — instrumentation, interceptor, tracing/meter, tests, and all boilerplate Use when this capability is needed.
metadata:
  author: apache
---
...
---
> Source: [apache/skywalking-java](https://github.com/apache/skywalking-java) — distributed by [TomeVault](https://tomevault.io).
