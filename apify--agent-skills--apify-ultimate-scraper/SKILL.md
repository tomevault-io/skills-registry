...
description: Universal AI-powered web scraper for any platform. Scrape data from Instagram, Facebook, TikTok, YouTube, Google Maps, Google Search, Google Trends, Booking.com, and TripAdvisor. Use for lead generation, brand monitoring, competitor analysis, influencer discovery, trend research, content analytics, audience analysis, or any data extraction task. Use when this capability is needed.
metadata:
  author: apify
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/apify) — claim your Tome and manage your conversions.
