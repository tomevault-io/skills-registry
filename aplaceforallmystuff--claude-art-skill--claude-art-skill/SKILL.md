---
name: art
description: Complete visual content system for Claude Code. Default aesthetic - light backgrounds, teal/burnt orange accents, hand-drawn sketch style. Use when this capability is needed.
metadata:
...
---
> Source: [aplaceforallmystuff/claude-art-skill](https://github.com/aplaceforallmystuff/claude-art-skill) — distributed by [TomeVault](https://tomevault.io).
