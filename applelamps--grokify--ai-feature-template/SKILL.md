...
description: Create new AI-powered features using xAI Grok. Use when user mentions "new AI feature", "add Grok", "create prompt", "AI analysis", or "generate with AI". Use when this capability is needed.
metadata:
  author: applelamps
---
