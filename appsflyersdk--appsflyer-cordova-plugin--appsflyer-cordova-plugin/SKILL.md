...
description: Performs a simple version-bump release of the AppsFlyer Cordova plugin (no public API changes). Use when the user wants to release a new Cordova plugin version that only updates SDK dependencies (Android, iOS) and plugin version. Use when this capability is needed.
metadata:
  author: AppsFlyerSDK
---
...
---
> Source: [AppsFlyerSDK/appsflyer-cordova-plugin](https://github.com/AppsFlyerSDK/appsflyer-cordova-plugin) — distributed by [TomeVault](https://tomevault.io).
