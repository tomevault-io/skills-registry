---
name: myvibe-publish
description: Publish static HTML, ZIP archive, or directory to MyVibe. Use this skill when user wants to publish web content to MyVibe. Use when this capability is needed.
metadata:
  author: arcblock
---
