---
name: sp
description: Guide for sp.h, a single-header C standard library replacement. You must use this guide when using or discussing sp.h in any capacity. Use when this capability is needed.
metadata:
  author: aresbit
---
