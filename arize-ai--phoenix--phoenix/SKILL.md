---
name: arize-phoenix
description: Open-source AI observability platform for tracing, evaluating, and improving LLM applications with OpenTelemetry integration Use when this capability is needed.
metadata:
  author: arize-ai
---
