---
name: cmsis-stream
description: This skill must be used to create new components for CMSIS Stream. It generates the Python description and C++ wrapper for a component. Use when this capability is needed.
metadata:
  author: ARM-software
---
...
---
> Source: [ARM-software/CMSIS-Stream](https://github.com/ARM-software/CMSIS-Stream) — distributed by [TomeVault](https://tomevault.io).
