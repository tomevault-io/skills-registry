---
name: bump-sources
description: Use only when explicitly asked to bump pinned sources in pytorch-aarch64/versions.sh and handle follow-on patch issues in pytorch-aarch64/get-source.sh. Canonical procedure is in this directory's README. Use when this capability is needed.
metadata:
  author: ARM-software
---
...
---
> Source: [ARM-software/Tool-Solutions](https://github.com/ARM-software/Tool-Solutions) — distributed by [TomeVault](https://tomevault.io).
