---
name: client
description: Manage client relationships. USE WHEN user asks about clients, follow-ups, client emails, or who needs attention. Use when this capability is needed.
metadata:
  author: artemxtech
---
