---
name: query
description: Query data from this vault. USE WHEN user asks about projects, clients, tasks, daily notes. Use grep to extract frontmatter - do NOT read full files. Use when this capability is needed.
metadata:
  author: artemxtech
---
