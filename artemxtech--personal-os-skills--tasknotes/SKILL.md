---
name: tasknotes
description: Manage tasks in Obsidian via TaskNotes plugin API. Use when user wants to create tasks, list tasks, query by status or project, update task status, delete tasks, or check what they need to do. Use when this capability is needed.
metadata:
  author: artemxtech
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/artemxtech) — claim your Tome and manage your conversions.
