...
description: Production-grade Kubernetes guidance (KubeShark). Activates for any task involving Kubernetes manifests, Helm charts, Kustomize overlays, RBAC, NetworkPolicies, or cluster operations. Enforces a failure-mode workflow with Conditional Reference Retrieval. Use when this capability is needed.
metadata:
  author: ArthurVardevanyan
---
