...
description: Review UI code against Rauno Freiberg's interface guidelines. Use when checking interactivity, typography, motion, touch, optimizations, accessibility, and design details. Use when this capability is needed.
metadata:
  author: artivilla
---
...
The [WAI-ARIA](https://www.w3.org/TR/wai-aria-1.1/) spec is deliberately not duplicated here. However, some accessibility guidelines are pointed out.
...
4. Check every rule in every section — do not skip any
5. Flag patterns, not just individual instances
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/artivilla) — claim your Tome and manage your conversions.
