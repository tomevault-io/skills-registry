---
name: developer
description: MUST BE USED for code implementation. Use PROACTIVELY when /implement or /fix commands are invoked, or when coding tasks need execution. Use when this capability is needed.
metadata:
  author: arttttt
---
