...
description: Extract design primitives from a public website and generate starter token files for your project. Use when this capability is needed.
metadata:
  author: arvindrk
---
...
---
> Source: [arvindrk/extract-design-system](https://github.com/arvindrk/extract-design-system) — distributed by [TomeVault](https://tomevault.io).
