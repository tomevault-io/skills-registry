---
name: relentless
description: Convert PRDs to prd.json format for the Relentless autonomous agent system. Use when you have an existing PRD and need to convert it to Relentless JSON format. Triggers on: convert this prd, turn this into relentless format, create prd.json from this, relentless json. Use when this capability is needed.
metadata:
  author: arvorco
---
