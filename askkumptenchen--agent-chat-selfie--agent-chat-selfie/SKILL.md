---
name: chat-selfie
description: Give your AI Agent a face and a heart. Use AI image generation or mood-mapped local sticker assets to let the agent proactively send emotional selfies that visualize its feelings during conversation. Use when this capability is needed.
metadata:
  author: AskKumptenchen
---
...
---
> Source: [AskKumptenchen/agent-chat-selfie](https://github.com/AskKumptenchen/agent-chat-selfie) — distributed by [TomeVault](https://tomevault.io).
