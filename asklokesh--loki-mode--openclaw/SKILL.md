---
name: loki-mode
description: Launch Loki Mode autonomous SDLC agent. Handles PRD-to-deployment with minimal human intervention. Invoke for multi-phase development tasks, bug fixing campaigns, or full product builds. Use when this capability is needed.
metadata:
  author: asklokesh
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/asklokesh) — claim your Tome and manage your conversions.
