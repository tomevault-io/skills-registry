...
description: This skill provides foundational context that all other skills build upon. It should be studied first before exploring: Use when this capability is needed.
metadata:
  author: asmayaseen
---
---
