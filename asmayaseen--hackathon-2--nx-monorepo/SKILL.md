---
name: nx-monorepo
description: This skill provides expert-level capabilities for Nx monorepo management. Nx is the standard build orchestrator for this AI-native platform due to its official MCP server integration. Use when this capability is needed.
metadata:
  author: asmayaseen
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/asmayaseen) — claim your Tome and manage your conversions.
