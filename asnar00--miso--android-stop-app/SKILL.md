...
description: Stop the Android app running on connected device. Cleanly terminates the app using force-stop. Use when stopping the app for debugging, testing, or cleanup. Use when this capability is needed.
metadata:
  author: asnar00
---
