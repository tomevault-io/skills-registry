---
name: pr-review
description: Review GitHub Pull Requests. When given a PR URL, fetches diff and comments using gh command, then performs objective and critical code review. Use when this capability is needed.
metadata:
  author: asonas
---
