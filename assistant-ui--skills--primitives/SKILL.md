---
name: primitives
description: Guide for assistant-ui UI primitives - ThreadPrimitive, ComposerPrimitive, MessagePrimitive. Use when customizing chat UI components. Use when this capability is needed.
metadata:
  author: assistant-ui
---
