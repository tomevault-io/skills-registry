---
name: runtime
description: Guide for assistant-ui runtime system and state management. Use when working with runtimes, accessing state, or managing thread/message data. Use when this capability is needed.
metadata:
  author: assistant-ui
---
