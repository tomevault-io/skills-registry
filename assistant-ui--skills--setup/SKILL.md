---
name: setup
description: Setup and configure assistant-ui in a project. Use when installing packages, configuring runtimes, setting up chat UI, or troubleshooting setup issues. Use when this capability is needed.
metadata:
  author: assistant-ui
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/assistant-ui) — claim your Tome and manage your conversions.
