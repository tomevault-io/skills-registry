---
name: update
description: Update assistant-ui and AI SDK to latest versions. Detects current versions, identifies breaking changes, and executes migrations. Use when this capability is needed.
metadata:
  author: assistant-ui
---
