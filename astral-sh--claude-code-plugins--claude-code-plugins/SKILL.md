---
name: ruff
description: Ruff is an extremely fast Python linter and code formatter. It replaces Flake8, Use when this capability is needed.
metadata:
  author: astral-sh
---
...
---
> Source: [astral-sh/claude-code-plugins](https://github.com/astral-sh/claude-code-plugins) — distributed by [TomeVault](https://tomevault.io).
