...
description: Apply microservices for independent deployment and per-service scaling. Use when bounded contexts are clear. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
