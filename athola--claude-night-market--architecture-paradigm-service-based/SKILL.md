...
description: Design coarse-grained service architecture for deployment independence without microservices complexity and overhead. Use when this capability is needed.
metadata:
  author: athola
---
