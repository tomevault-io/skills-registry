...
description: Analyze and optimize context window usage with MECW principles, memory tiering, session routing, and subagent coordination. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
