---
name: damage-control
description: Recover from broken agent state including crash recovery, context overflow, merge conflicts, and corrupted worktrees. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
