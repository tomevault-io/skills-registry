...
description: Guidance on when to ask clarifying questions vs proceed with standard approaches. Reduces unnecessary interaction rounds. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
