---
name: doc-updates
description: Update documentation after code changes with quality gates, slop detection, consolidation, and accuracy verification. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
