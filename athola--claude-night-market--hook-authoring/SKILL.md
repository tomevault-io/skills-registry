---
name: hook-authoring
description: Guide for creating Claude Code hooks with security-first design. Use for validation, logging, and policy enforcement. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
...
---
> Source: [athola/claude-night-market](https://github.com/athola/claude-night-market) — distributed by [TomeVault](https://tomevault.io).
