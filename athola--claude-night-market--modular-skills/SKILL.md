---
name: modular-skills
description: Build composable skill modules with hub-and-spoke loading. Use when: token budget is tight, complexity is high. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
