---
name: pr-prep
description: Prepare pull requests by running quality gates, drafting descriptions, and validating tests before submission. Use when this capability is needed.
metadata:
  author: athola
---
