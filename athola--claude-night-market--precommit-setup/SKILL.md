...
description: Configure pre-commit hooks for linting, type checking, formatting, and testing to enforce quality gates on every commit. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
