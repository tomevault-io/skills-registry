---
name: spec-writing
description: Create clear, testable specifications from feature descriptions with user stories, acceptance criteria, and success metrics. Use when this capability is needed.
metadata:
  author: athola
---
# Spec Writing
