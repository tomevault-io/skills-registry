...
description: Test skills via RED/GREEN/REFACTOR TDD with fresh subagents. Use when: validating skill behavior, preventing priming bias. Use when this capability is needed.
metadata:
  author: athola
---
