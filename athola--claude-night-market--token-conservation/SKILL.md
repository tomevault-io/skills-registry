...
description: Enforce token quota management at session start with conservation rules, delegation checks, and compression review. Use when this capability is needed.
metadata:
  author: athola
---
