---
name: war-room
description: Convene a multi-LLM expert panel to pressure-test high-stakes decisions and build consensus through structured deliberation. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
