...
description: Detect workflow failures and inefficient patterns, then create GitHub issues for improvement via /fix-workflow. Use when this capability is needed.
metadata:
  author: athola
---
## Table of Contents
