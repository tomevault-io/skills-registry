---
name: imagen
description: Gera imagens a partir de prompts de texto usando o modelo de geração de imagens do Google Gemini, salvando automaticamente o arquivo PNG no projeto para uso em frontend, documentação ou assets visuais. Use when this capability is needed.
metadata:
