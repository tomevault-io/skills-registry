---
name: update-api
description: Parse Telegram Bot API docs and rebuild generated Ruby types and endpoints Use when this capability is needed.
metadata:
  author: atipugin
---
...
---
> Source: [atipugin/telegram-bot-ruby](https://github.com/atipugin/telegram-bot-ruby) — distributed by [TomeVault](https://tomevault.io).
