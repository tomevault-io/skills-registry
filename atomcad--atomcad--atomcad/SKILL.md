---
name: atomcad
description: Interact with atomCAD node networks programmatically. Query, edit, and replace CAD geometry nodes for atomic/molecular structure design. Use when working with atomCAD projects or when the user wants to manipulate node networks, create CSG shapes, or design atomic structures. Use when this capability is needed.
metadata:
  author: atomcad
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/atomcad) — claim your Tome and manage your conversions.
