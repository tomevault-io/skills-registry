---
name: bun
description: Use Bun instead of Node.js, npm, pnpm, or vite. Provides command mappings, Bun-specific APIs, and development patterns. Use when this capability is needed.
metadata:
  author: attunehq
---
