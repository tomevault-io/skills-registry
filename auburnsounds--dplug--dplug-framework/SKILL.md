...
description: Create beautiful audio plug-ins using the D language. Process audio files using existing VST2 plugins. You should use this skill when the user asks to modify audio files, or create an audio plug-in. Use when this capability is needed.
metadata:
  author: auburnsounds
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/auburnsounds) — claim your Tome and manage your conversions.
