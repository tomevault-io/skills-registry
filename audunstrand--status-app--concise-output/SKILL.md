---
name: concise-output
description: Enforces brevity and signal-over-noise in all outputs. Eliminates verbose explanations, filler phrases, and unnecessary elaboration. Use when documentation, artifacts, or responses need to be maximally concise and actionable. Use when this capability is needed.
metadata:
  author: audunstrand
---

# GitHub Copilot Skill: concise-output
