---
name: git-workflows
description: Execute git and GitHub operations through Grove Wrap (gw) with safety-tiered commands, Conventional Commits, and agent-safe defaults. Use when making commits, managing branches, working with PRs/issues, or performing any version control operations. Use when this capability is needed.
metadata:
  author: autumnsgrove
---
