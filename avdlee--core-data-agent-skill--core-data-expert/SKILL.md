...
description: Expert Core Data guidance (iOS/macOS): stack setup, fetch requests & NSFetchedResultsController, saving/merge conflicts, threading & Swift Concurrency, batch operations & persistent history, migrations, performance, and NSPersistentCloudKitContainer/CloudKit sync. Use when this capability is needed.
metadata:
  author: avdlee
---
# Core Data Expert
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/avdlee) — claim your Tome and manage your conversions.
