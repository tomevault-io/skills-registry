---
name: prbot
description: PR review bot. Use "/prbot review" to critically review the current PR and generate REVIEW.md with feedback. Use "/prbot" or "/prbot resolve" to fix issues in REVIEW.md and delete it when complete. Use "/prbot summarize" to summarize PR changes and related tests. Use when this capability is needed.
metadata:
