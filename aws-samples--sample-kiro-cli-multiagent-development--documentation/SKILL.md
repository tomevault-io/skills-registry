---
name: documentation
description: Technical documentation patterns including READMEs, API docs, runbooks, and architecture decision records. Use when writing documentation, creating runbooks, or documenting system architecture. Use when this capability is needed.
metadata:
  author: aws-samples
---
