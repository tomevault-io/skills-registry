---
name: git-workflow
description: Git operations, branching strategies, commit conventions, and repository management. Use when working with version control, creating branches, writing commits, or resolving merge conflicts. Use when this capability is needed.
metadata:
  author: aws-samples
---
