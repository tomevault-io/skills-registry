...
description: Test and prototype code in a sandboxed environment. Use for debugging, verifying logic, or installing packages. Use when this capability is needed.
metadata:
  author: aws-samples
---
