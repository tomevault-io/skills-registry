...
description: Supervisor-side orchestration patterns for assign, handoff, and idle inbox delivery in CAO Use when this capability is needed.
metadata:
  author: awslabs
---
...
---
> Source: [awslabs/cli-agent-orchestrator](https://github.com/awslabs/cli-agent-orchestrator) — distributed by [TomeVault](https://tomevault.io).
