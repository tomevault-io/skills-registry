...
description: Domain-driven modeling patterns for Axone contracts. Use when introducing domain concepts, encoding invariants, or deciding boundaries between domain, handlers, services, gateways, queries, and state. Use when this capability is needed.
metadata:
...
---
> Source: [axone-protocol/contracts](https://github.com/axone-protocol/contracts) — distributed by [TomeVault](https://tomevault.io).
