...
description: Analyze any text content including meeting notes, emails, book excerpts, or generic text files. Use when the user wants to analyze content that doesn't fit YouTube, article, or paper categories, or mentions notes, documents, or generic analysis. Use when this capability is needed.
metadata:
  author: az9713
---
