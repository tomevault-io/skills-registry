---
name: fix-sync-sdk
description: **WORKFLOW SKILL** - Update TypeSpec project, regenerate SDK, to fix error on SDK project. USE FOR: "fix sdk lib <project-name>". Use when this capability is needed.
metadata:
  author: azure
---
