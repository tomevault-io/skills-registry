...
description: **WORKFLOW SKILL** - Build the emitter with dev dependencies, and validate end-to-end tests. USE FOR: "validate dev build". Use when this capability is needed.
metadata:
  author: azure
---
