...
description: Analyze and resolve APIView review feedback on Azure SDK PRs. **UTILITY SKILL**. USE FOR: APIView comments, API review feedback, SDK API surface changes. DO NOT USE FOR: general code review, non-APIView feedback. INVOKES: azure-sdk-mcp:azsdk_apiview_get_comments, azure-sdk-mcp:azsdk_customized_code_update. Use when this capability is needed.
metadata:
  author: Azure
---
...
---
> Source: [Azure/azure-sdk-for-android](https://github.com/Azure/azure-sdk-for-android) — distributed by [TomeVault](https://tomevault.io).
