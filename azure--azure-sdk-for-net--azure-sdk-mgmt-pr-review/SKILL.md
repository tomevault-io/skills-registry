...
description: Review Azure SDK management-plane pull requests, check naming conventions, API compatibility, and code quality. Use when this capability is needed.
metadata:
  author: azure
---
