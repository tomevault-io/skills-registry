...
description: Fetches aggregated trace metrics (token usage, latency, trace counts, quality evaluations) from MLflow tracking servers. Triggers on requests to show metrics, analyze token usage, view LLM costs, check usage trends, or query trace statistics. Use when this capability is needed.
metadata:
  author: b-step62
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/b-step62) — claim your Tome and manage your conversions.
