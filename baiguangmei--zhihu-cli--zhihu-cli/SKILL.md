---
name: zhihu-cli
description: 知乎 CLI (pyzhihu-cli)：搜索、热榜、问题/回答/评论、推荐 Feed、用户资料、发想法/提问/文章、删自己的内容、点赞关注、收藏与通知。Agent 代执行 zhihu 命令，Cookie 仅存本地。 Use when this capability is needed.
metadata:
  author: BAIGUANGMEI
---
...
---
> Source: [BAIGUANGMEI/zhihu-cli](https://github.com/BAIGUANGMEI/zhihu-cli) — distributed by [TomeVault](https://tomevault.io).
