---
name: golang-context
description: Idiomatic context.Context usage in Golang — creation, propagation, cancellation, timeouts, deadlines, context values, and cross-service tracing. Apply when working with context.Context in any Go code. Use when this capability is needed.
metadata:
  author: bang-abilive
---
