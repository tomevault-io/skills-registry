...
description: Flutterプロジェクトのpubspec.yamlパッケージを更新するスキル。一括更新または指定パッケージ更新に対応。メジャーバージョン更新時は確認を挟み、更新前にpub.dev/GitHubでchangelogを確認して変更内容を報告する。$ARGUMENTSにパッケージ名を指定するか、--allで全パッケージ更新。 Use when this capability is needed.
metadata:
  author: bannzai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bannzai) — claim your Tome and manage your conversions.
