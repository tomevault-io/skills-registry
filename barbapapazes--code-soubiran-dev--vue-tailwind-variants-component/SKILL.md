...
description: Create Vue single-file components that use tailwind-variants (`tv`), including Nuxt UI-style modal/slideover/full components, `ui` slot overrides, and the correct `tv` import behavior. Use when generating Vue components, deciding whether to import `tv` from `tailwind-variants`, or following the Barbapapazes snippet structure. Use when this capability is needed.
metadata:
  author: Barbapapazes
---
...
---
> Source: [Barbapapazes/code.soubiran.dev](https://github.com/Barbapapazes/code.soubiran.dev) — distributed by [TomeVault](https://tomevault.io).
