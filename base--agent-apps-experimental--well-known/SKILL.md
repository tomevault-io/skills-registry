...
description: Use when working with a working demo of the agent-first framework with fishnet-auth reverse CAPTCHA authentication.
metadata:
  author: base
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/base) — claim your Tome and manage your conversions.
