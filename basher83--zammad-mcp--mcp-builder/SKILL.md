...
Agents have constrained context windows - make every token count. Return high-signal information, not exhaustive data dumps. Provide "concise" vs "detailed" response format options. Default to human-readable identifiers over technical codes (names over IDs). Consider the agent's context budget as a scarce resource.

**Actionable Error Messages:**
Error messages should guide agents toward solutions with specific suggestions and next steps. Suggest specific next steps: "Try using filter='active_only' to reduce results". Make errors educational, not just diagnostic. Help agents learn proper tool usage through clear feedback.

**Use Evaluation-Driven Development:**
Create realistic evaluation scenarios early. Let agent feedback drive tool improvements. Prototype quickly and iterate based on actual agent performance.
...
**Understand the API:**
Review the service's API documentation to identify key endpoints, authentication requirements, and data models. Use web search and WebFetch as needed. Read through **ALL** available API documentation:
