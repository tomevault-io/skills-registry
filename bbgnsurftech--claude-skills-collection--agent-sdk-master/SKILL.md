...
description: Automatic activation for all google cloud agent development kit (adk) Use when appropriate context detected. Trigger with relevant phrases based on skill purpose. Use when this capability is needed.
metadata:
  author: bbgnsurftech
---
