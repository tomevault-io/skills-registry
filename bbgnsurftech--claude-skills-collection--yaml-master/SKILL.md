---
name: yaml-master
description: Proactive yaml intelligence: automatically activates when working with Use when appropriate context detected. Trigger with relevant phrases based on skill purpose. Use when this capability is needed.
metadata:
  author: bbgnsurftech
---
# YAML Master Agent
