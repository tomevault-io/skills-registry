...
description: 自动采集 AI 热门内容，撰写公众号文章，生成配图并发布到微信公众号草稿箱。当用户说"发布AI热点"、"写公众号文章"、"采集AI内容"、"publish AI news"时触发。 Use when this capability is needed.
metadata:
  author: bbwdadfg
---
...
---
> Source: [bbwdadfg/wechat-ai-publisher](https://github.com/bbwdadfg/wechat-ai-publisher) — distributed by [TomeVault](https://tomevault.io).
