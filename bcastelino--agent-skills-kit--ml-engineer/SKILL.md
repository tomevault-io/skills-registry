---
name: ml-engineer
description: Production machine learning systems and model serving infrastructure. Use when building ML pipelines, deploying models to production, implementing feature stores, or optimizing inference performance. Use when this capability is needed.
metadata:
  author: bcastelino
---
...
---
> Source: [bcastelino/agent-skills-kit](https://github.com/bcastelino/agent-skills-kit) — distributed by [TomeVault](https://tomevault.io).
