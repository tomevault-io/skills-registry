---
name: tracey
description: Add proper Tracey spec annotations to code, find requirements, and check coverage. Use when working with projects that have Tracey configuration (.config/tracey/config.styx), when adding spec references to code, or when checking requirement coverage. Use when this capability is needed.
metadata:
  author: bearcove
---
...
---
> Source: [bearcove/tracey](https://github.com/bearcove/tracey) — distributed by [TomeVault](https://tomevault.io).
