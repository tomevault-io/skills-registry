...
description: Autonomous agent-based web search fallback for when WebSearch API fails or hits limits Use when this capability is needed.
metadata:
  author: bejranonda
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bejranonda) — claim your Tome and manage your conversions.
