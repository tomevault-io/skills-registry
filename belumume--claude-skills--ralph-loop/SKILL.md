---
name: ralph-loop
description: Activate autonomous Ralph Wiggum loop mode for iterative task completion. Use when you have a well-defined task with clear completion criteria that benefits from persistent, autonomous execution. Use when this capability is needed.
metadata:
  author: belumume
---
