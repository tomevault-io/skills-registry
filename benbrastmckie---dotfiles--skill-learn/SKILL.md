---
name: skill-learn
description: Scan codebase for FIX:/NOTE:/TODO: tags and create structured tasks with interactive selection. Invoke for /learn command. Use when this capability is needed.
metadata:
