...
description: Conduct Neovim configuration research using plugin docs and codebase exploration. Invoke for neovim research tasks. Use when this capability is needed.
metadata:
