---
name: git-commit
description: Create git commits following GitMoji convention used in this project. Use when committing changes with appropriate emoji prefixes. Reference gitmoji.dev for emoji guide. Use when this capability is needed.
metadata:
