---
name: doc-elisp
description: Create or update documentation for an Emacs Lisp package following the Denote manual style. Use when the user wants to document any Elisp package (not just extras). Use when this capability is needed.
metadata:
  author: benthamite
---
