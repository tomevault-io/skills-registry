---
name: doc-extras
description: Create or update documentation for all Emacs extras packages following the Denote manual style. Use when the user wants to ensure all extras packages are thoroughly documented and up to date. Use when this capability is needed.
metadata:
  author: benthamite
---
