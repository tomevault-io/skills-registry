...
description: Dotfiles worktree structure and documentation instructions for 'extras-' modules. Use when working with dotfiles or Emacs files. Use when this capability is needed.
metadata:
  author: benthamite
---
