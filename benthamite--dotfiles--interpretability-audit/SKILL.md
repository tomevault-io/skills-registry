...
description: Audit a codebase for intent transparency and readability. Use when the user wants to check if code is understandable, if intentions are clear, or if there are obscurities a reader would struggle with. Use when this capability is needed.
metadata:
  author: benthamite
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/benthamite) — claim your Tome and manage your conversions.
