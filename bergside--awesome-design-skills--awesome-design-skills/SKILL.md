---
name: glassmorphism
description: Frosted glass effect with translucent layers, subtle blur, and luminous borders for depth and modern elegance. Use when this capability is needed.
metadata:
  author: bergside
---
...
---
> Source: [bergside/awesome-design-skills](https://github.com/bergside/awesome-design-skills) — distributed by [TomeVault](https://tomevault.io).
