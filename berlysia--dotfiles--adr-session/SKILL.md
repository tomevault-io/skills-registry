---
name: adr-session
description: Start or resume an ADR session. Without number: show status overview and recommend next actionable ADR. With number: provide phase-specific guidance. Trigger: /adr-session, /adr-session NNN, /adr-session new Use when this capability is needed.
metadata:
  author: berlysia
---
