---
name: approach-check
description: Ask Claude to state its planned approach before writing code, for user approval. Use for medium-complexity tasks where Plan Mode is too heavy but wrong-approach risk exists. Use when this capability is needed.
metadata:
  author: berlysia
---
