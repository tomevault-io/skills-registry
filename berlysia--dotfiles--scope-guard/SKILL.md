---
name: scope-guard
description: Analyze task scope and recommend execution strategy (sub-agent, multi-session, or scope cut). Orchestrates existing skills like /decompose, /task-enrich, and /task-handoff. Use when this capability is needed.
metadata:
  author: berlysia
---
