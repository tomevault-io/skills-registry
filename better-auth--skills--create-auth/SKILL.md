...
description: Scaffold and implement authentication in TypeScript/JavaScript apps using Better Auth. Detect frameworks, configure database adapters, set up route handlers, add OAuth providers, and create auth UI pages. Use when users want to add login, sign-up, or authentication to a new or existing project with Better Auth. Use when this capability is needed.
metadata:
  author: better-auth
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/better-auth) — claim your Tome and manage your conversions.
