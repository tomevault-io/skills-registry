...
description: Orchestrate parallel debug agents to investigate UAT gaps and find root causes. Spawns debug agents per gap, collects diagnoses, updates UAT.md. Use when this capability is needed.
metadata:
  author: bhanukushwah
---
