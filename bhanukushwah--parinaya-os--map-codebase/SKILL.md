---
name: map-codebase
description: Orchestrate parallel codebase mapper agents to analyze codebase and produce structured documents in .gsd/codebase/ with 7 structured documents. Use when this capability is needed.
metadata:
  author: bhanukushwah
---
