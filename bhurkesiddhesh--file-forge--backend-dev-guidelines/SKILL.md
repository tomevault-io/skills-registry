...
description: Opinionated backend development standards for Node.js + Express + TypeScript microservices. Covers layered architecture, BaseController pattern, dependency injection, Prisma repositories, Zod validation, unifiedConfig, Sentry error tracking, async safety, and testing discipline. Use when this capability is needed.
metadata:
  author: BhurkeSiddhesh
---
...
---
> Source: [BhurkeSiddhesh/File-Forge](https://github.com/BhurkeSiddhesh/File-Forge) — distributed by [TomeVault](https://tomevault.io).
