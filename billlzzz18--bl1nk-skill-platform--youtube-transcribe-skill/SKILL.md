...
description: Extract subtitles/transcripts from a YouTube video URL and save as a local file. Use when you need to extract subtitles from a YouTube video. Use when this capability is needed.
metadata:
  author: billlzzz18
---
