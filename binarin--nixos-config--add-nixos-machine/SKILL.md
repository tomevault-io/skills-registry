...
description: Guides the process of adding new NixOS machine configurations following the dendritic pattern. Use when creating new NixOS machines (qemu-guest, lxc, bare-metal). Handles inventory setup, hostId generation, and module creation. Use when this capability is needed.
metadata:
  author: binarin
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/binarin) — claim your Tome and manage your conversions.
