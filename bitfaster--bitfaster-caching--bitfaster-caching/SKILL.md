---
name: bench-fast
description: Run a benchmark with minimal iterations to generate assembly code via BenchmarkDotNet's DisassemblyDiagnoser. Use to generate one big assembly code file per benchmark. Use when this capability is needed.
metadata:
  author: bitfaster
---
...
---
> Source: [bitfaster/BitFaster.Caching](https://github.com/bitfaster/BitFaster.Caching) — distributed by [TomeVault](https://tomevault.io).
