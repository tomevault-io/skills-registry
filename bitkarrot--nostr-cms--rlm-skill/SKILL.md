---
name: rlm
description: Process large codebases (>100 files) using the Recursive Language Model pattern. Treats code as an external environment, using parallel background agents to map-reduce complex tasks without context rot. Use when this capability is needed.
metadata:
  author: bitkarrot
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bitkarrot) — claim your Tome and manage your conversions.
