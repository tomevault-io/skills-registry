...
description: This skill should be used when the user asks to "triage security findings", "fix a Checkmarx finding", "review SonarCloud results", "dismiss a false positive", "check code scanning alerts", or needs to work with GitHub Advanced Security alerts, scanner annotations on PRs, or Grype vulnerability results. Use when this capability is needed.
metadata:
  author: bitwarden
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bitwarden) — claim your Tome and manage your conversions.
