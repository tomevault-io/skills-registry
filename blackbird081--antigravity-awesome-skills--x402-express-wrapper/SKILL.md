...
description: Wrapper oficial de M2MCent (Node.js) para inyectar muros de pago x402 en APIs o servidores Model Context Protocol (MCP). Usar al construir nuevos servicios que requieran monetización máquina a máquina. Use when this capability is needed.
metadata:
  author: Blackbird081
---
...
---
> Source: [Blackbird081/antigravity-awesome-skills](https://github.com/Blackbird081/antigravity-awesome-skills) — distributed by [TomeVault](https://tomevault.io).
