---
name: rust-profiling
description: Profile Rust code using samply to identify CPU bottlenecks. Use when performance is slow, before optimizing, or when the user asks to profile. Use when this capability is needed.
metadata:
  author: blacktop
---
