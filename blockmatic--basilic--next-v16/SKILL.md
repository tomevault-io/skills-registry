...
description: Next.js v16 best practices - proxy.ts, file conventions, RSC boundaries, Cache Components, async APIs, route handlers, image/font optimization Use when this capability is needed.
metadata:
  author: blockmatic
---
