...
description: Primary skill for working with the BlueLibs Runner Framework. Use it for general Runner questions, framework implementation work, and Runner-specific topics such as resources, tasks, events and hooks, middleware, tags, runtime lifecycle, serialization and validation, observability, testing, Remote Lanes (RPC and Events), and Durable Workflows. Use when this capability is needed.
metadata:
  author: bluelibs
---
