...
description: RED-GREEN-REFACTOR for process documentation - baseline without skill, write addressing failures, iterate closing loopholes Use when this capability is needed.
metadata:
  author: blurjp
---
