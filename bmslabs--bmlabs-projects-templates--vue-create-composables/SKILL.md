...
description: Genera composables Vue 3 (Composition API) para la gestión del estado reactivo, lógica de negocio encapsulada y orquestación de servicios. Use when this capability is needed.
metadata:
  author: bmslabs
---
