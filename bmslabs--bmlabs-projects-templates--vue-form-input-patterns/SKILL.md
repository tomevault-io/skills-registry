...
description: Define patrones uniformes para inputs de formularios basados en tipos de datos. Garantiza consistencia en 3 invocaciones del mismo formulario. Use when this capability is needed.
metadata:
  author: bmslabs
---
