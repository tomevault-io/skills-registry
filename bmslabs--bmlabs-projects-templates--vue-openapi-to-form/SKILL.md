...
description: Transforma especificaciones OpenAPI 3.0 o Schemas de datos en un stack completo de frontend (DTO, API Service, Composable y Formulario) 100% funcional. Use when this capability is needed.
metadata:
  author: bmslabs
---
