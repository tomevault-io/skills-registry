...
description: Gestiona la orquestación y el estado de diálogos modales (AppModal y ConfirmModal) con flujos de confirmación asíncronos corporativos. Use when this capability is needed.
metadata:
  author: bmslabs
---
