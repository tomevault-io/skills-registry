...
description: Researches and documents existing codebase implementations. Use when exploring how code works, understanding architecture, answering 'how does X work?' questions, or gathering context before making changes. Produces structured research documents with code references. Use when this capability is needed.
metadata:
  author: bnadlerjr
---
