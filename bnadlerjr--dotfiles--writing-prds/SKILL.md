---
name: writing-prds
description: Build Product Requirements Documents from Product Briefs. Use when transforming product vision into actionable requirements for engineers and designers. Produces high-level design principles, use case compendiums, and milestone definitions. A PRD focuses on 'what' not 'how'. Use when this capability is needed.
metadata:
  author: bnadlerjr
---
