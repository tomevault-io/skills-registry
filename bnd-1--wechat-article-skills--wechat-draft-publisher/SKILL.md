...
description: 自动将 HTML 文章发布到微信公众号草稿箱，支持封面图上传、标题、作者和元数据管理。当用户说"推送到微信"、"发布到公众号草稿"、"上传到草稿箱"或提到微信文章发布时使用。 Use when this capability is needed.
metadata:
  author: bnd-1
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/bnd-1) — claim your Tome and manage your conversions.
