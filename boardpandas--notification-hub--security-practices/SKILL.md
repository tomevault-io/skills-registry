...
description: Universal security principles including authentication, input validation, SQL injection prevention, and secrets management Use when this capability is needed.
metadata:
  author: boardpandas
---
