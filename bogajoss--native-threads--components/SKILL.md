---
name: gluestack-ui-v4components
description: Component usage patterns for gluestack-ui v4 - covers component selection, props vs className, compound patterns, icons, and provider setup. Use when this capability is needed.
metadata:
  author: bogajoss
---
