---
name: security
description: Security guidelines for secure coding and code review. This skill should be used when architecting/designing systems, writing code, or reviewing code. Use proactively when discussing vulnerabilities, OWASP, injection attacks, XSS, CSRF, SQL injection, authentication, authorization, access control, encryption, secrets management, input validation, or secure coding practices. (user) Use when this capability is needed.
metadata:
  author: booch
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/booch) — claim your Tome and manage your conversions.
