...
description: 根据用户描述的网站特征和扫描需求，智能生成适合的 dirsearch 命令。当用户需要目录扫描、路径发现、敏感文件探测、Web 渗透测试侦察时使用此 skill。支持快速扫描、深度扫描、特定技术栈扫描、WAF 绕过等多种场景，每次提供至少 5 种命令选项供用户选择。 Use when this capability is needed.
metadata:
  author: boqiqibo
---
...
---
> Source: [boqiqibo/Sec-Skills](https://github.com/boqiqibo/Sec-Skills) — distributed by [TomeVault](https://tomevault.io).
