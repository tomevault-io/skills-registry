---
name: issue-triage
description: Triage and classify GitHub issues for the Vorta project. Use when reviewing issues, applying labels, deciding whether to close issues, or evaluating feature requests against project scope. Use when this capability is needed.
metadata:
  author: borgbase
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/borgbase) — claim your Tome and manage your conversions.
