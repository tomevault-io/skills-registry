...
description: 专注于构建高性能、可扩展且架构清晰的 Flutter 应用。涵盖整洁架构、高级状态管理和深度性能优化。 Use when this capability is needed.
metadata:
  author: boshi-xixixi
---
...
---
> Source: [boshi-xixixi/agenticflow-skills](https://github.com/boshi-xixixi/agenticflow-skills) — distributed by [TomeVault](https://tomevault.io).
