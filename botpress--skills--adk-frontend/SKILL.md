---
name: adk-frontend
description: Guidelines for building frontend applications that integrate with Botpress ADK bots - covering authentication, type generation, client setup, and calling bot actions Use when this capability is needed.
metadata:
  author: botpress
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/botpress) — claim your Tome and manage your conversions.
