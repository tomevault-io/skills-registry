---
name: smoke-test
description: Build and smoke test the Hugo site by starting a local server and checking key pages load properly using Playwright MCP. Use when the user wants to verify the site builds correctly, test deployment, check for broken pages, or run smoke tests. Use when this capability is needed.
metadata:
  author: boundsj
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/boundsj) — claim your Tome and manage your conversions.
