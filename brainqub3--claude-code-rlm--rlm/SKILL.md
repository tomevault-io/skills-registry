---
name: rlm
description: Run a Recursive Language Model-style loop for long-context tasks. Uses a persistent local Python REPL and an rlm-subcall subagent as the sub-LLM (llm_query). Use when this capability is needed.
metadata:
  author: brainqub3
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/brainqub3) — claim your Tome and manage your conversions.
