---
name: kitty-docs
description: Reference codebase for Kitty. Use this skill when you need to understand anything about how Kitty terminal works. Use when this capability is needed.
metadata:
