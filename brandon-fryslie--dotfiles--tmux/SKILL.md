---
name: tmux
description: Use only when you need to run interactive CLI tools (Python REPL, etc.) that require real-time input/output OR when asked to use tmux Use when this capability is needed.
metadata:
