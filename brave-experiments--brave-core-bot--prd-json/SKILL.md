---
name: prd-json
description: Convert PRDs to prd.json format for the autonomous agent system. Use when you have an existing PRD and need to convert it to prd.json format. Triggers on: convert this prd, turn this into prd.json, create prd.json from this. Use when this capability is needed.
metadata:
