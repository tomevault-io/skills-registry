---
name: email
description: Draft, send, search, and manage emails via Gmail using gog CLI. Use when the user wants to compose emails, create drafts, search inbox, reply to threads, find contact emails, or manage Gmail labels. Use when this capability is needed.
metadata:
  author: brennerspear
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/brennerspear) — claim your Tome and manage your conversions.
