---
name: favicon
description: Generate a complete set of favicons from a source image and update HTML. Use when setting up favicons for a web project. Use when this capability is needed.
metadata:
  author: brianlovin
---
