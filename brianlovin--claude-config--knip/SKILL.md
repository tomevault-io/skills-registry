---
name: knip
description: Run knip to find and remove unused files, dependencies, and exports. Use for cleaning up dead code and unused dependencies. Use when this capability is needed.
metadata:
  author: brianlovin
---
