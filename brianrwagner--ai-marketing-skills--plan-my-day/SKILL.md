---
name: plan-my-day
description: Generate an energy-optimized, time-blocked daily plan based on circadian rhythm research and GTD principles Use when this capability is needed.
metadata:
  author: brianrwagner
---
