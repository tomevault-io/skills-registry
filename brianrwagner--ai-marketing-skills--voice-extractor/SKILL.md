...
description: Extract and document someone's authentic writing voice from samples. Use when someone needs a "voice guide," wants to capture their writing DNA, or needs to train AI to write in their style. Also useful for ghostwriting, brand voice documentation, or onboarding writers. Use when this capability is needed.
metadata:
  author: brianrwagner
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/brianrwagner) — claim your Tome and manage your conversions.
