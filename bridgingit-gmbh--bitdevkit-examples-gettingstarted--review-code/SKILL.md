---
name: review-code
description: Perform comprehensive csharp/dotnet code reviews focusing on clean code, security, testing, performance, and documentation Use when this capability is needed.
metadata:
