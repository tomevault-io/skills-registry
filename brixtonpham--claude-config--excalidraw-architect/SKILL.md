...
description: Create diagrams, flowcharts, and architecture visualizations using Excalidraw. Use when user requests "create diagram", "draw flowchart", "architecture diagram", or mentions Excalidraw, visualization, system design. Use when this capability is needed.
metadata:
  author: brixtonpham
---
