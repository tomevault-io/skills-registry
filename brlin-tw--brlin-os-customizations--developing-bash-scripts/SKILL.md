...
description: Provide guidelines on how to develop bash shell scripts that are compliant with project standards.  Should be used when generating, modifying, or reviewing bash scripts. Use when this capability is needed.
metadata:
  author: brlin-tw
---
