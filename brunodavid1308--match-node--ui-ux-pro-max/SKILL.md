...
**Ubuntu/Debian:**
```bash
sudo apt update && sudo apt install py
```
...
```bash
py skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack html-tailwind
```
...
```bash
py skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness service elegant" --design-system -p "Serenity Spa"
```
...
py skills/ui-ux-pro-max/scripts/search.py "animation accessibility" --domain ux

# Get alternative typography options if needed
py skills/ui-ux-pro-max/scripts/search.py "elegant luxury serif" --domain typography
```

### Step 4: Stack Guidelines

```bash
py skills/ui-ux-pro-max/scripts/search.py "layout responsive form" --stack html-tailwind
```
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/brunodavid1308) — claim your Tome and manage your conversions.
