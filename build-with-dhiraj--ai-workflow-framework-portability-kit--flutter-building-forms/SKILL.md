...
description: Build Flutter forms with validation and input handling. Use for login screens, data entry, multi-field input. Use when this capability is needed.
metadata:
