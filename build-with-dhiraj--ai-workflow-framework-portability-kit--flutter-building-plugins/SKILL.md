...
description: Build Flutter plugins providing native interop for other apps. Use for reusable platform-bridge packages. Use when this capability is needed.
metadata:
