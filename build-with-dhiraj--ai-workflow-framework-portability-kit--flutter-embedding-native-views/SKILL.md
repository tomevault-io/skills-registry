...
description: Embed native Android, iOS, or macOS views in a Flutter app. Use for maps, web views, complex native components. Use when this capability is needed.
metadata:
