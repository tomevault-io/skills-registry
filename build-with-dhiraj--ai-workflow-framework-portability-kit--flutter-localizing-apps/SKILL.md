...
description: Configure a Flutter app for multiple languages and regions. Use when preparing for international markets. Use when this capability is needed.
metadata:
