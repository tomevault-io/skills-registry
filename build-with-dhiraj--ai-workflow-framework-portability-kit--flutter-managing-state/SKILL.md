...
description: Manage application and ephemeral state in Flutter. Use for sharing data between widgets or complex UI state. Use when this capability is needed.
metadata:
