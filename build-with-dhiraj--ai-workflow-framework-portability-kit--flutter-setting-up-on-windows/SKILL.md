...
description: Set up a Windows environment for Flutter development. Use to configure Windows for desktop/Android builds. Use when this capability is needed.
metadata:
