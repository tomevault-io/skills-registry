...
description: Customize a Flutter app's appearance via the theming system. Use to define global styles, colors, typography. Use when this capability is needed.
metadata:
