...
description: Manage local persistence using SQLite or other DBs in Flutter. Use to store, query, sync structured device data. Use when this capability is needed.
metadata:
