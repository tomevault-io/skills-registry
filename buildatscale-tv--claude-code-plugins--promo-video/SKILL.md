---
name: promo-video
description: Create professional promotional videos using Remotion with AI voiceover and background music. Invoke with /promo-video. Use when this capability is needed.
metadata:
