...
description: Resolve git merge, rebase, cherry-pick, and stash conflicts. Use when git status shows "unmerged paths", "rebase in progress", or after failed stash pop. Use when this capability is needed.
metadata:
  author: buvis
---
