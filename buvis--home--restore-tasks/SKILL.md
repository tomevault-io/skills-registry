---
name: restore-tasks
description: Restore tasks from a previous session. Triggers on "restore tasks", "load tasks", "recover tasks", "get my tasks back", "tasks from previous session". Use when this capability is needed.
metadata:
  author: buvis
---
