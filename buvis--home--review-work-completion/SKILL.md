...
description: Multi-agent review of completed work against PRD requirements. Use after all tasks are completed to validate implementation quality. Triggers on "review work", "check completed work", "validate implementation", "are we done". Use when this capability is needed.
metadata:
  author: buvis
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/buvis) — claim your Tome and manage your conversions.
