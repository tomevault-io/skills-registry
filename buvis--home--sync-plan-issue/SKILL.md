...
description: Create or update GitHub issue with plan summary. Triggers on "sync plan to github", "update issue with plan", "share plan", "create issue from plan". Use after planning is complete. Use when this capability is needed.
metadata:
  author: buvis
---
