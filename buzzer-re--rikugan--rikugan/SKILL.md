...
description: Patch binary code in Binary Ninja using natural language — read, assemble, write, verify Use when this capability is needed.
metadata:
  author: buzzer-re
---
...
---
> Source: [buzzer-re/Rikugan](https://github.com/buzzer-re/Rikugan) — distributed by [TomeVault](https://tomevault.io).
