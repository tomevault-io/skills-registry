...
description: Registers a local skill to the AgentKit platform by uploading it. Invoke when the user wants to publish, upload, or register a skill they have created. Use when this capability is needed.
metadata:
  author: bytedance
---
