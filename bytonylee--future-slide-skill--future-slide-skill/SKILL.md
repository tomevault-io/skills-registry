...
description: Render slide images sequentially from DESIGN.md and slide prompt JSON using Codex native image generation, saving each output into the workspace with page-number filenames. Use when this capability is needed.
metadata:
  author: bytonylee
---
...
---
> Source: [bytonylee/future-slide-skill](https://github.com/bytonylee/future-slide-skill) — distributed by [TomeVault](https://tomevault.io).
