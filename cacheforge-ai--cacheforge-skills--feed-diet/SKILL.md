---
name: feed-diet
description: Audit your information diet across HN and RSS feeds — beautiful reports with category breakdowns, ASCII charts, and personalized recommendations. Use when this capability is needed.
metadata:
