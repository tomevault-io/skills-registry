...
description: Local development workflow for list-github-stars. Use when orienting in the workspace, choosing just/go/Docker/GoReleaser commands, or validating general changes. Use when this capability is needed.
metadata:
  author: caian-org
---
...
---
> Source: [caian-org/list-github-stars](https://github.com/caian-org/list-github-stars) — distributed by [TomeVault](https://tomevault.io).
