...
description: Run Sanmill's Flutter test suite, including unit tests, widget tests, and integration tests; use when running tests or checking test coverage. Use when this capability is needed.
metadata:
  author: calcitem
---
