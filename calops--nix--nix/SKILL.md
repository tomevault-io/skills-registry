...
description: Process PR review comments iteratively, one by one. Use whenever asked to address incoming review feedback on a pull request. Use when this capability is needed.
metadata:
  author: calops
---
