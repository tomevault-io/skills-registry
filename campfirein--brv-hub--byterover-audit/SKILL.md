...
description: Audit knowledge freshness and coverage. Checks what's documented against the current codebase, identifies stale or outdated knowledge, finds gaps, and provides targeted brv curate commands to fix them. Use when this capability is needed.
metadata:
  author: campfirein
---
