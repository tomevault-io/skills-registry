...
description: Check project progress, resume paused work, and route to the next action. Loads project state from the knowledge base, presents a status report, detects incomplete work or handoffs, and suggests the most logical next workflow to invoke. Use when this capability is needed.
metadata:
  author: campfirein
---
