...
description: AI-ready skill to test, register, and publish Markdown articles to WeChat Official Accounts using a local custom CSS theme via Wenyan CLI. Use when this capability is needed.
metadata:
  author: caol64
---
