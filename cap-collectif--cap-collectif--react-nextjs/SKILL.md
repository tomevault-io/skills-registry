---
name: react-nextjs
description: Crée des composants React et pages Next.js avec Relay GraphQL dans admin-next/. Couvre fragments, queries, pages dynamiques, hooks et patterns du projet. Use when this capability is needed.
metadata:
