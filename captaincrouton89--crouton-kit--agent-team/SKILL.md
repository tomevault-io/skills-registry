---
name: agent-team
description: Reference documentation for Claude Code agent teams — coordinating multiple Claude instances with shared tasks, messaging, and centralized management. Use when creating teams, spawning teammates, managing task lists, or troubleshooting team coordination. Use when this capability is needed.
metadata:
