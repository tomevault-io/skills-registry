...
description: Starter index for a creator-first polyglot setup with one general agent and language-specific skills. Use when bootstrapping or extending TypeScript, JavaScript, Python, and Go workflows with scaffold-if-missing and implement-first behavior. Use when this capability is needed.
metadata:
  author: caraya
---
...
---
> Source: [caraya/agent-skills](https://github.com/caraya/agent-skills) — distributed by [TomeVault](https://tomevault.io).
