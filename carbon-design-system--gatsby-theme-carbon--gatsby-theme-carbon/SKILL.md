...
description: Formats Git commit messages using the Conventional Commits standard and enforces project-specific linting rules. Use when this capability is needed.
metadata:
...
---
> Source: [carbon-design-system/gatsby-theme-carbon](https://github.com/carbon-design-system/gatsby-theme-carbon) — distributed by [TomeVault](https://tomevault.io).
