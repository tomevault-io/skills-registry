---
name: cursor-agent
description: Use when working with a comprehensive skill for using the Cursor CLI agent for various software engineering tasks (updated for 2026 features, includes tmux automation guide).
metadata:
  author: carboon
---
