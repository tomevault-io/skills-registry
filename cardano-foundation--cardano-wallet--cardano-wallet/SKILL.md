---
name: cardano-deps
description: Cardano dependencies management, CHaP, source-repository-package, version bumps Use when this capability is needed.
metadata:
...
---
> Source: [cardano-foundation/cardano-wallet](https://github.com/cardano-foundation/cardano-wallet) — distributed by [TomeVault](https://tomevault.io).
