...
description: Expert instructions for creating new global skills for the Antigravity agent. Use this when the user asks to create a new skill. Use when this capability is needed.
metadata:
  author: carlosdoers
---
