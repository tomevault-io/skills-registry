...
description: Dispatch a release using GitHub Actions. Use when asked to create a release, publish to npm, or start the release process. Use when this capability is needed.
metadata:
  author: cartridge-gg
---
