---
name: run-tests
description: Run the test suite for the Cartridge Controller monorepo. Use when validating changes, before committing, or when asked to run tests. Use when this capability is needed.
metadata:
  author: cartridge-gg
---
