---
name: test
description: Run appropriate test suites based on changed files or user request. Use to run tests intelligently based on the type of changes. Use when this capability is needed.
metadata:
  author: cartridge-gg
---
