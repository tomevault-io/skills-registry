...
description: Update Storybook visual regression snapshots after intentional UI changes. Use when visual tests fail due to expected changes, or when asked to update snapshots. Use when this capability is needed.
metadata:
  author: cartridge-gg
---
