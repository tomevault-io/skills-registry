---
name: implement-plan
description: Execute approved implementation plans from scratchpad. Use when implementing a previously planned feature. Use when this capability is needed.
metadata:
