...
description: Security-first Uniswap V4 hook development. Use when user mentions "v4 hooks", "hook security", "PoolManager", "beforeSwap", "afterSwap", or asks about V4 hook best practices, vulnerabilities, or audit requirements. Use when this capability is needed.
metadata:
  author: catalys-go
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/catalys-go) — claim your Tome and manage your conversions.
