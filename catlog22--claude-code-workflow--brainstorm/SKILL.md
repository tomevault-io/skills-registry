---
name: brainstorm
description: Unified brainstorming skill with dual-mode operation — auto mode (framework generation, parallel multi-role analysis, cross-role synthesis) and single role analysis. Triggers on "brainstorm", "头脑风暴". Use when this capability is needed.
metadata:
  author: catlog22
---
