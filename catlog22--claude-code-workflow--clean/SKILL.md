---
name: clean
description: Intelligent code cleanup with mainline detection, stale artifact discovery, and safe execution. Supports targeted cleanup and confirmation. Use when this capability is needed.
metadata:
  author: catlog22
---
