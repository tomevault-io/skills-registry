...
description: Adding a new asset to snowboardkids2.yaml requires following specific steps to ensure assets are in the correct order and properly declared. Use this skill when you need to add a new binary asset. Use when this capability is needed.
metadata:
  author: cdlewis
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cdlewis) — claim your Tome and manage your conversions.
