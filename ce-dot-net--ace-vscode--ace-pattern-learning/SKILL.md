...
description: Search ACE playbook before implementing, building, fixing, debugging, or refactoring code. Capture patterns after completing substantial coding work. Use when this capability is needed.
metadata:
  author: ce-dot-net
---
<!-- ACE_SECTION v0.4.32 -->
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ce-dot-net) — claim your Tome and manage your conversions.
