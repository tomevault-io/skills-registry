---
name: color-themes
description: Guide for using WinnetouJs ColorThemes for dynamic theme switching. Use this skill when you need to implement light/dark mode or custom themes in your Winnetou.js applications. Use when this capability is needed.
metadata:
  author: cedrosdev
---
