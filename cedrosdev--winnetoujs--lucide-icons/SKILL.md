---
name: lucide-icons
description: Guide for using Lucide icons in WinnetouJs constructos. Use this skill when you need to add icons to your UI components. Use when this capability is needed.
metadata:
  author: cedrosdev
---
