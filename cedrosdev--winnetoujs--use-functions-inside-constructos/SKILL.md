...
description: Guide for using WinnetouFx (`W.fx`) to handle events in constructos. Use this skill when you need to add event handlers to your WinnetouJs UI components. Use when this capability is needed.
metadata:
  author: cedrosdev
---
