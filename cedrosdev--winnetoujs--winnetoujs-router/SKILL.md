...
description: Guide for using WinnetouJs Router to build SPA navigation. Use this skill when you need to implement client-side routing in your Winnetou.js applications. Use when this capability is needed.
metadata:
  author: cedrosdev
---
