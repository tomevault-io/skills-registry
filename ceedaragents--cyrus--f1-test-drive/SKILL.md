---
name: f1-test-drive
description: Orchestrate F1 test drives to validate the Cyrus agent system end-to-end across issue-tracker, EdgeWorker, and activity rendering. Use when this capability is needed.
metadata:
  author: ceedaragents
---
