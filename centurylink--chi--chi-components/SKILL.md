---
name: chi-components
description: Extract and provide information about Chi CSS components (buttons, alerts, modals, cards, etc.). Use when the user asks about Chi components, their modifiers, BEM structure, or Web Component equivalents. Reads SCSS source files directly. Use when this capability is needed.
metadata:
  author: centurylink
---
