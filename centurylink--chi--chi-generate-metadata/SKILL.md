...
description: Generate and sync MCP metadata for the Chi Design System. Use when the user asks to build, generate, or update the MCP metadata, or to sync Skills/Rules from SCSS sources. Use when this capability is needed.
metadata:
  author: centurylink
---
