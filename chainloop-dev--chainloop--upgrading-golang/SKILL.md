...
description: Upgrades Go version across the entire Chainloop codebase including source files, Docker images, CI/CD workflows, and documentation. Use when the user mentions upgrading Go, golang version, or updating Go compiler version. Use when this capability is needed.
metadata:
  author: chainloop-dev
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/chainloop-dev) — claim your Tome and manage your conversions.
