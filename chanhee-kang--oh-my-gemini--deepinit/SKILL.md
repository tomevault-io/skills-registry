---
name: deepinit
description: Deep codebase initialization with hierarchical AGENTS.md documentation Use when this capability is needed.
metadata:
  author: chanhee-kang
---
...
```
Task(subagent_type="explore", model="gemini-flash-latest",
