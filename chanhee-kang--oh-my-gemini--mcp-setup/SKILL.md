---
name: mcp-setup
description: Configure popular MCP servers for enhanced agent capabilities Use when this capability is needed.
metadata:
  author: chanhee-kang
---
...
MCP servers provide additional tools that Gemini CLI agents can use. This skill helps you configure popular MCP servers using the `claude mcp add` command-line interface.
...
- Run /oh-my-gemini:doctor to diagnose issues

MANAGING MCP SERVERS:
- Add more servers: /oh-my-gemini:mcp-setup or `claude mcp add ...`
