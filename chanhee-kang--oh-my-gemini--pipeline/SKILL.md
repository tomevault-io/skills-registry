---
name: pipeline
description: Chain agents together in sequential or branching workflows with data passing Use when this capability is needed.
metadata:
  author: chanhee-kang
---
...
**Explicit invocation:**
```
/oh-my-gemini:pipeline review "task"
```
