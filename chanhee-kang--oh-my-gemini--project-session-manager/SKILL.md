...
description: Manage isolated dev environments with git worktrees and tmux sessions Use when this capability is needed.
metadata:
  author: chanhee-kang
---
...
Automate isolated development environments using git worktrees and tmux sessions with Gemini CLI. Enables parallel work across multiple tasks, projects, and repositories.
...
8. **Launch Gemini CLI** (unless --no-claude):
   ```bash
