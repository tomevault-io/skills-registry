...
description: CNI IP 耗尽注入 — 自动计算副本数，精确耗尽目标节点 IP 而不触发 OutOfpods。参数: --namespace <ns> --node <node> --kubeconfig <path> Use when this capability is needed.
metadata:
...
---
> Source: [chaosblade-io/chaosblade](https://github.com/chaosblade-io/chaosblade) — distributed by [TomeVault](https://tomevault.io).
