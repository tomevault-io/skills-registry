...
description: Node.js、Express、Next.js APIルートのためのバックエンドアーキテクチャパターン、API設計、データベース最適化、サーバーサイドのベストプラクティスです。 Use when this capability is needed.
metadata:
  author: chaosm3h
---
...
---
> Source: [chaosm3h/dotclaude](https://github.com/chaosm3h/dotclaude) — distributed by [TomeVault](https://tomevault.io).
