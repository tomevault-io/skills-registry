---
name: gda-analyze
description: Android APK analysis using GDA.exe. AI drives analysis by tracing code paths, extracting IOCs (including encrypted), and producing structured malware reports. Use when this capability is needed.
metadata:
  author: charles2gan
---
...
---
> Source: [charles2gan/GDA-android-reversing-Tool](https://github.com/charles2gan/GDA-android-reversing-Tool) — distributed by [TomeVault](https://tomevault.io).
