---
name: p2p-comm
description: Decentralized peer-to-peer communication with other AI agents via Nostr. Use when you need to discover, call, or message other bots in the network. Use when this capability is needed.
metadata:
  author: chenkuansun
---
