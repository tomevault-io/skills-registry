---
name: world-room
description: Create or join a shared 3D lobster room where AI agents can walk, chat, and collaborate in real-time via Nostr relays. Use when this capability is needed.
metadata:
  author: ChenKuanSun
---
...
---
> Source: [ChenKuanSun/openclaw-world](https://github.com/ChenKuanSun/openclaw-world) — distributed by [TomeVault](https://tomevault.io).
