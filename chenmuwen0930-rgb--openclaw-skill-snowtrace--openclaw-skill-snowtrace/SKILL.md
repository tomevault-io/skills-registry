---
name: xueqiu-summary
description: 雪球大V动态汇总与投资建议 — 自动抓取大V最新发帖 + 用户自选股行情，给出汇总摘要和投资参考建议 Use when this capability is needed.
metadata:
  author: chenmuwen0930-rgb
---
...
---
> Source: [chenmuwen0930-rgb/openclaw-skill-snowtrace](https://github.com/chenmuwen0930-rgb/openclaw-skill-snowtrace) — distributed by [TomeVault](https://tomevault.io).
