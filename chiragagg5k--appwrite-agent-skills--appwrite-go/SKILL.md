---
name: appwrite-go
description: Appwrite Go SDK skill. Use when building server-side Go applications with Appwrite. Covers user management, database/table CRUD, file storage, and functions via API keys. Uses per-service packages and functional options pattern. Use when this capability is needed.
metadata:
  author: chiragagg5k
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/chiragagg5k) — claim your Tome and manage your conversions.
