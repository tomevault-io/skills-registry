---
name: vue-patterns
description: Vue.js 3 Composition API patterns, component architecture, reactivity best practices, Pinia state management, Vue Router navigation, and Nuxt SSR patterns. Activates for Vue, Nuxt, Vite, or Pinia projects. Use when this capability is needed.
metadata:
  author: chris-yyau
---
...
---
> Source: [chris-yyau/busdriver](https://github.com/chris-yyau/busdriver) — distributed by [TomeVault](https://tomevault.io).
