---
name: add-parallel
description: Legacy MCP-based integration notes for Parallel AI. The Codex version of NanoClaw uses IPC actions instead of MCP. Use when this capability is needed.
metadata:
  author: chrisfrantz
---
