...
```bash
SOCKET_DIR="${CHRISKJAER_TMUX_SOCKET_DIR:-${TMPDIR:-/tmp}/chriskjaer-tmux-sockets}"
mkdir -p "$SOCKET_DIR"
SOCKET="$SOCKET_DIR/chriskjaer-op.sock"
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/chriskjaer) — claim your Tome and manage your conversions.
