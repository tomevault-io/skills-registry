...
description: summarize machine learning experiment logs in chinese when the input includes training logs, eval results, hyperparameter changes, user notes, or multiple runs and the user needs a grounded experiment summary, error analysis, best configuration recap, or a weekly update ready abstract. Use when this capability is needed.
metadata:
  author: chtc66
---
...
---
> Source: [chtc66/academic-skills](https://github.com/chtc66/academic-skills) — distributed by [TomeVault](https://tomevault.io).
