...
description: Reliability-first shell selection policy for AI agents on Windows. Choose WSL or PowerShell based on execution risk, not preference. Use when this capability is needed.
metadata:
  author: cikichen
---
