...
description: Author and refactor Storybook stories for qti-interactions using the required docs/split structure, query policy, and interaction-focused testing boundaries. Use when this capability is needed.
metadata:
  author: citolab
---
