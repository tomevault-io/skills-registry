...
description: Build and work with cjmellor/approval features, including approval workflows, custom states, time-based expirations, rollbacks, and event handling. Use when this capability is needed.
metadata:
  author: cjmellor
---
...
---
> Source: [cjmellor/approval](https://github.com/cjmellor/approval) — distributed by [TomeVault](https://tomevault.io).
