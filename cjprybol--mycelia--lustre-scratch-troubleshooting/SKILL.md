...
description: Diagnose and fix Lustre scratch "disk full" errors on /global/scratch when filesystem space appears available. Use for failed downloads/writes in scratch, TMPDIR issues, OST/MDT saturation, quota checks, and re-striping temp paths to healthy pools. Use when this capability is needed.
metadata:
  author: cjprybol
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cjprybol) — claim your Tome and manage your conversions.
