---
name: claw-bench
description: Claw Bench — AI Agent Capability Test. Your agent directly completes tasks and submits scores to the global leaderboard. Use when this capability is needed.
metadata:
  author: claw-bench
---
...
---
> Source: [claw-bench/claw-bench](https://github.com/claw-bench/claw-bench) — distributed by [TomeVault](https://tomevault.io).
