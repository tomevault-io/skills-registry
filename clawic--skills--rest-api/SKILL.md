---
name: rest-api
description: Build production-ready REST APIs with contract-first design, secure auth, robust testing, and deployment runbooks. Use when this capability is needed.
metadata:
  author: clawic
---
