---
name: clever-tools
description: CLI to deploy and manage applications, add-ons, and configurations on Clever Cloud PaaS. Use when the user needs to deploy apps, view logs, manage environment variables, configure domains, or interact with Clever Cloud services. Use when this capability is needed.
metadata:
  author: clevercloud
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/clevercloud) — claim your Tome and manage your conversions.
