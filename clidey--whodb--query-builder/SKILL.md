---
name: query-builder
description: Convert natural language questions into SQL queries. Activates when users ask data questions in plain English like "show me users who signed up last week" or "find orders over $100". Use when this capability is needed.
metadata:
  author: clidey
---
