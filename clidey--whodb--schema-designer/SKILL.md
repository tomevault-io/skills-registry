...
description: Help design database schemas, create tables, and plan data models. Activates when users ask to create tables, design schemas, or model data relationships. Use when this capability is needed.
metadata:
  author: clidey
---
