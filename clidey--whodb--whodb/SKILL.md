---
name: whodb
description: Database operations including querying, schema exploration, and data analysis. Activates for tasks involving PostgreSQL, MySQL, MariaDB, SQLite, MongoDB, Redis, Elasticsearch, or ClickHouse databases. Use when this capability is needed.
metadata:
  author: clidey
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/clidey) — claim your Tome and manage your conversions.
