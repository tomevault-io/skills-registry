---
name: branch
description: ブランチ作成Skill。仕様策定用（spec/*）または実装用（impl/*）のブランチを作成。/spec や spec-workflow から呼び出される。 Use when this capability is needed.
metadata:
  author: clionegohan
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/clionegohan) — claim your Tome and manage your conversions.
