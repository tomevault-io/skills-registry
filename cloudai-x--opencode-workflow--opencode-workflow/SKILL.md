...
description: Guides software architecture decisions, design patterns, and system design principles. Use when designing systems, choosing patterns, or making architectural decisions. Use when this capability is needed.
metadata:
  author: CloudAI-X
---
...
---
> Source: [CloudAI-X/opencode-workflow](https://github.com/CloudAI-X/opencode-workflow) — distributed by [TomeVault](https://tomevault.io).
