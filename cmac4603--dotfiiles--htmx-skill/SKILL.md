---
name: htmx-skill
description: Documentation for the htmx JavaScript library (attributes, events, headers, API, extensions, examples, migration guides, server examples). Use when you need accurate htmx syntax/behavior or to locate the right reference page for an htmx question. Use when this capability is needed.
metadata:
  author: cmac4603
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cmac4603) — claim your Tome and manage your conversions.
