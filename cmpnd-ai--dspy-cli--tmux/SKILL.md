---
name: tmux
description: Instructions for using tmux to spawn multiple processes, inspect them, and capture their output. Useful for running servers or long-running tasks in the background. Use when this capability is needed.
metadata:
  author: cmpnd-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cmpnd-ai) — claim your Tome and manage your conversions.
