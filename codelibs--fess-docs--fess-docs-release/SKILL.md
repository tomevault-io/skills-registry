...
description: Automate Fess documentation updates across all languages (ja, en, de, es, fr, ko, zh-cn) for a new release. Updates documentation.rst, downloads.rst, index.rst, news.rst, and archives.rst for each language. Use when this capability is needed.
metadata:
  author: codelibs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/codelibs) — claim your Tome and manage your conversions.
