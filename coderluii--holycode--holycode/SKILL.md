...
description: Configure or reconfigure oh-my-openagent for HolyCode. Mirrors the upstream provider questionnaire, writes plugin config, keeps only primary agents visible, and prints doctor/refresh/auth follow-up steps. Use when this capability is needed.
metadata:
  author: CoderLuii
---
...
---
> Source: [CoderLuii/HolyCode](https://github.com/CoderLuii/HolyCode) — distributed by [TomeVault](https://tomevault.io).
