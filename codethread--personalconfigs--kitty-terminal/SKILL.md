---
name: kitty-terminal
description: Configure and control kitty terminal emulator using kitten commands, kitty.conf settings, remote control, and session automation. Use when working with kitty terminal, kittens, kitty.conf, terminal automation, or debugging kitty sessions. Use when this capability is needed.
metadata:
  author: codethread
---
