---
name: write-issue
description: Create or update project issues following the Epic specification format with Behaviors (Rules + Examples), Technical Specifications (Action/Hook/Component/Service), and task lists. Use when user asks to create/update an issue, document requirements, or write specifications for a new feature. Use when this capability is needed.
metadata:
  author: coeus-ventures
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/coeus-ventures) — claim your Tome and manage your conversions.
