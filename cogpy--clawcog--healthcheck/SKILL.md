---
name: healthcheck
description: Host security hardening and risk-tolerance configuration for OpenCog deployments. Use when a user asks for security audits, firewall/SSH/update hardening, risk posture, exposure review, OpenCog cron scheduling for periodic checks, or version status checks on a machine running OpenCog (laptop, workstation, Pi, VPS). Use when this capability is needed.
metadata:
  author: cogpy
---
