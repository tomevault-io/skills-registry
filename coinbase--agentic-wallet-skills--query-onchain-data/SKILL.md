...
description: Query onchain data on Base using the CDP SQL API via x402. Use when you or your user want to view onchain information about decoded blocks, transactions, and event. Use when this capability is needed.
metadata:
  author: coinbase
---
