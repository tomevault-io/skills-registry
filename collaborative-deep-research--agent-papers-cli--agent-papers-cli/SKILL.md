...
description: Coordinate a research task by choosing the right workflow and dispatching to specialized agents. Use when the user has a broad or complex research request that may involve multiple steps. Use when this capability is needed.
metadata:
  author: collaborative-deep-research
---
