---
name: adapt
description: Analyze project and fill in PROJECT.md. Use when adapting dot-agents to a new project, after initial installation. Use when this capability is needed.
metadata:
  author: colmarius
---
