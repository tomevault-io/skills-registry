...
description: Writes Playwright e2e tests for ComfyUI_frontend. Use when creating, modifying, or debugging browser tests. Triggers on: playwright, e2e test, browser test, spec file. Use when this capability is needed.
metadata:
  author: comfy-org
---
