...
description: Migrate existing projects into the speckit structure by generating spec.md, plan.md, and tasks.md from existing code. Use when this capability is needed.
metadata:
  author: compnew2006
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/compnew2006) — claim your Tome and manage your conversions.
