...
description: Analyze content sequences and determine authoring approach (default content vs blocks). Validates block selection and section styling for Edge Delivery Services migration. Use when this capability is needed.
metadata:
