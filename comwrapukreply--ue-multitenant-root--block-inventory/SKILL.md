...
description: Survey available blocks from local project and Block Collection to understand the block palette available for authoring. Returns block inventory with purposes to inform content modeling decisions. Use when this capability is needed.
metadata:
  author: comwrapukreply
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/comwrapukreply) — claim your Tome and manage your conversions.
