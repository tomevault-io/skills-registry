...
# Core Tool 2  
python scripts/inference_optimizer.py --input data/ --output optimized/ --config config.yaml

# Core Tool 3
python scripts/dataset_pipeline_builder.py --input data/ --output pipelines/ --config config.yaml
```
...
```bash
# Model training
python scripts/vision_model_trainer.py --input data/ --output results/ --verbose
