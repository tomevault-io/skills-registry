---
name: skill-creator
description: Guide for creating effective skills, adding skill references, skill scripts or optimizing existing skills. This skill should be used when users want to create a new skill (or update an existing skill) that extends Codex's capabilities with specialized knowledge, workflows, frameworks, libraries or plugins usage, or API and tool integrations. Use when this capability is needed.
metadata:
  author: congdon1207
---
...
## References
- [Agent Skills](https://docs.Codex.com/en/docs/Codex-code/skills.md)
