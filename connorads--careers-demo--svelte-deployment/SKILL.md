...
description: Svelte deployment guidance. Use for adapters, Vite config, pnpm setup, library authoring, PWA, or production builds. Use when this capability is needed.
metadata:
  author: connorads
---
