---
name: svelte-runes
description: Svelte runes guidance. Use for reactive state, props, effects, or migration. Covers $state, $derived, $effect, $props, $bindable. Prevents reactivity mistakes. Use when this capability is needed.
metadata:
  author: connorads
---
