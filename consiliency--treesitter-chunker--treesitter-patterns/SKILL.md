...
description: Universal patterns for tree-sitter code parsing. Covers AST visitors, query patterns, and language plugin development. Framework-agnostic. Use when this capability is needed.
metadata:
  author: consiliency
---
