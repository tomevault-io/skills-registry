---
name: objc-swift-ios
description: Objective-C-first layout, headers, and Swift interop for this iOS persistence repo Use when this capability is needed.
metadata:
  author: contentstack
---
...
---
> Source: [contentstack/contentstack-ios-persistence](https://github.com/contentstack/contentstack-ios-persistence) — distributed by [TomeVault](https://tomevault.io).
