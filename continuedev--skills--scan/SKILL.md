---
name: scan
description: Scans the codebase against another skill's criteria using a parallel agent team. Use when the user says /scan <skill-name> to audit code quality, find violations, or assess conformance to best practices. Use when this capability is needed.
metadata:
  author: continuedev
---
