---
name: writing-checks
description: Write Continue check files that review pull requests with AI agents. Use when the user asks to create, write, or generate a check, or wants to enforce a convention on PRs. Use when this capability is needed.
metadata:
  author: continuedev
---
