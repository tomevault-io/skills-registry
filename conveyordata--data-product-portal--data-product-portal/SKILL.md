...
description: Use for ANY PostgreSQL interaction — queries, schema exploration, metrics, or business data questions. MUST be used before postgres tools to load semantic models containing business context, field mappings, and validated metric formulas. Use when this capability is needed.
metadata:
  author: conveyordata
---
