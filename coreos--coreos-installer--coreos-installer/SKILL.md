...
description: Add a new Fedora signing key and drop the oldest one in coreos-installer Use when this capability is needed.
metadata:
  author: coreos
---
...
---
> Source: [coreos/coreos-installer](https://github.com/coreos/coreos-installer) — distributed by [TomeVault](https://tomevault.io).
