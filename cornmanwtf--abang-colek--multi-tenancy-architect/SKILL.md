...
description: Design tenant isolation, data partitioning, and SaaS patterns. Use when this capability is needed.
metadata:
  author: cornmanwtf
---
...
## Purpose
- Design tenant isolation, data partitioning, and SaaS patterns.
