---
name: performance-baseline-documentation
description: Document benchmarks and capacity planning. Use when this capability is needed.
metadata:
  author: cornmanwtf
---
...
## Purpose
- Document benchmarks and capacity planning.
