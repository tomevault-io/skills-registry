---
name: rolling-update-strategies
description: Zero-downtime deploys with health checks and rollback. Use when this capability is needed.
metadata:
  author: cornmanwtf
---
...
## Purpose
- Zero-downtime deploys with health checks and rollback.
