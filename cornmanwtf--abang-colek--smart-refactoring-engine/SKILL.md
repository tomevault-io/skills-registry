---
name: smart-refactoring-engine
description: Detect code smells and propose safe refactors. Use when this capability is needed.
metadata:
  author: cornmanwtf
---
...
## Purpose
- Detect code smells and propose safe refactors.
