...
description: Maintain the Awesome Mac repository when adding, updating, or relocating app entries across README.md, README-zh.md, README-ja.md, and README-ko.md. Use this when the task requires category selection, multilingual sync, concise listing copy, ordering consistency, or repository-specific curation rules. Use when this capability is needed.
metadata:
  author: Correia-jpv
---
...
---
> Source: [Correia-jpv/fucking-awesome-mac](https://github.com/Correia-jpv/fucking-awesome-mac) — distributed by [TomeVault](https://tomevault.io).
