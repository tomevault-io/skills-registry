...
description: 通过 IMA OpenAPI 处理知识库任务。支持知识库内容搜索、命中详情查看、条目浏览、列出知识库、上传文件、导入网页。用户提到知识库、资料库、上传到知识库、导入网页、搜知识库时使用。 Use when this capability is needed.
metadata:
  author: countbot-ai
---
...
---
> Source: [countbot-ai/CountBot](https://github.com/countbot-ai/CountBot) — distributed by [TomeVault](https://tomevault.io).
