...
description: Workflow for implementing and managing react-i18next multi-language (English and Myanmar) features in React/Vite projects. Use when this capability is needed.
metadata:
