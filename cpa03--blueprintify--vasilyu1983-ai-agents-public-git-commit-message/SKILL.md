...
description: Auto-generates conventional commit messages from git diffs with tiered format enforcement. Analyzes staged changes to produce meaningful commit messages following Conventional Commits specification. Use when this capability is needed.
metadata:
  author: cpa03
---
