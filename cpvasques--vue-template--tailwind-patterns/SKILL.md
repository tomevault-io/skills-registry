...
description: Princípios do Tailwind CSS v4. Configuração CSS-first, container queries, padrões modernos, arquitetura de design tokens. Use when this capability is needed.
metadata:
  author: cpvasques
---
