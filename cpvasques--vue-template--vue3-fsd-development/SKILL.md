...
description: Desenvolve aplicações Vue 3 seguindo arquitetura Feature-Sliced Design (FSD), implementando lazy loading, code splitting, e padrões de performance. Use quando desenvolvendo features, componentes, ou trabalhando com Vue 3 neste projeto. Use when this capability is needed.
metadata:
  author: cpvasques
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cpvasques) — claim your Tome and manage your conversions.
