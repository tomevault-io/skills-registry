---
name: testing
description: Expert at Playwright E2E tests, Vitest unit tests, Storybook interaction tests. Use when writing tests, debugging test failures, or improving test coverage. Use when this capability is needed.
metadata:
  author: crazyswami
---
