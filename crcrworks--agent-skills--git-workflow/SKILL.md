---
name: git-workflow
description: Git workflow best practices and patterns. Use this skill when working with git operations, creating commits, managing branches, handling pull requests, or establishing team git workflows. Provides guidance on commit messages, branching strategies, and collaboration patterns. Use when this capability is needed.
metadata:
  author: crcrworks
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/crcrworks) — claim your Tome and manage your conversions.
