---
name: async-drop
description: Guide to the AsyncDrop pattern for async cleanup in Rust. Use when working with AsyncDropGuard, implementing AsyncDrop trait, or handling async resource cleanup. Use when this capability is needed.
metadata:
  author: cryfs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/cryfs) — claim your Tome and manage your conversions.
