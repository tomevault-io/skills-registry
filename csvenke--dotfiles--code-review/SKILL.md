---
name: code-review
description: Staff/Principal engineer quality code reviews. Triggers on requests to review code, diffs, changes, patches, branches, commits, or pull requests. Accepts code from any source: GitHub PRs, git diffs, patch files, or code shared directly. Applies senior engineering judgment across architecture, security, operations, performance, quality, and testing - independent of language or technology stack. Use when this capability is needed.
metadata:
  author: csvenke
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/csvenke) — claim your Tome and manage your conversions.
