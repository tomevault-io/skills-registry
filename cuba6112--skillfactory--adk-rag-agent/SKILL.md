---
name: adk-rag-agent
description: Build RAG (Retrieval-Augmented Generation) agents with Google ADK and Vertex AI RAG Engine. Use when implementing document Q&A, knowledge base search, or citation-backed responses. Covers VertexAiRagRetrieval tool, corpus setup, and citation formatting. Use when this capability is needed.
metadata:
  author: cuba6112
---
