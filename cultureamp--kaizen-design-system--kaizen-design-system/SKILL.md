...
description: Checks deps update in widely consumed repos will cause problems or not, and ranks dependency updates by downstream impact for prioritisation. Use when this capability is needed.
metadata:
  author: cultureamp
---
...
---
> Source: [cultureamp/kaizen-design-system](https://github.com/cultureamp/kaizen-design-system) — distributed by [TomeVault](https://tomevault.io).
