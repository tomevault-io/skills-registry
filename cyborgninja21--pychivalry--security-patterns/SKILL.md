...
description: Security vulnerability detection patterns including OWASP Top 10, language-specific vulnerabilities, and remediation guidance. Load when reviewing code for security issues, conducting audits, or implementing authentication/authorization. Use when this capability is needed.
metadata:
...
---
> Source: [Cyborgninja21/pychivalry](https://github.com/Cyborgninja21/pychivalry) — distributed by [TomeVault](https://tomevault.io).
