...
description: OWASP Package URL (PURL) format expert Use when this capability is needed.
metadata:
  author: CycloneDX
---
...
---
> Source: [CycloneDX/sbom-utility](https://github.com/CycloneDX/sbom-utility) — distributed by [TomeVault](https://tomevault.io).
