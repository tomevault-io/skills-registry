---
name: api-notion
description: Notion REST API for pages, databases, blocks. Uses internal integration token for headless/CI. Activate for Notion operations. Use when this capability is needed.
metadata:
  author: d0nghyun
---
