---
name: git-commit
description: Stages changes and commits with an auto-generated message derived from the diff. Use when the user wants to commit with a smart message, "git commit with message from changes", or to stage and commit in one go without typing the message. Use when this capability is needed.
metadata:
  author: d3nd3
---
