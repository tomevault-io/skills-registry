...
description: External AI API integration with retry logic, rate limiting, content safety detection, and multi-turn conversation support for image generation. Use when this capability is needed.
metadata:
  author: dadbodgeoff
---
