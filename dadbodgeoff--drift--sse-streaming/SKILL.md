---
name: sse-streaming
description: Implement Server-Sent Events (SSE) for real-time updates with automatic reconnection and heartbeats. Use when building live dashboards, notifications, progress indicators, or any feature needing server-to-client push. Use when this capability is needed.
metadata:
  author: dadbodgeoff
---
