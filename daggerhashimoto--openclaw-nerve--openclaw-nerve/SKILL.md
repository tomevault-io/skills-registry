---
name: nerve-kanban
description: Interact with the Nerve Kanban board API. CRUD tasks, manage workflow (execute, approve, reject, abort), handle proposals, configure the board. All endpoints are under /api/kanban on the Nerve server. Use when this capability is needed.
metadata:
  author: daggerhashimoto
---
...
---
> Source: [daggerhashimoto/openclaw-nerve](https://github.com/daggerhashimoto/openclaw-nerve) — distributed by [TomeVault](https://tomevault.io).
