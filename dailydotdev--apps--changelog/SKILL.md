---
name: changelog
description: Generate a daily.dev changelog post for a new feature or update. Use when a team member needs to write a changelog announcement. Use when this capability is needed.
metadata:
  author: dailydotdev
---
