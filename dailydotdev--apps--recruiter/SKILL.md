---
name: recruiter
description: Think like a skeptical technical recruiter when working on the daily.dev Recruiter platform. Use when reviewing UI/UX, features, or code in webapp/pages/recruiter. Use when this capability is needed.
metadata:
  author: dailydotdev
---
