---
name: local-env
description: Local environment management - run SQL queries, set up fake payments, reset test data. Use when the user needs help with local database operations or test data setup. Use when this capability is needed.
metadata:
  author: dailydotdev
---
