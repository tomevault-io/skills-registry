...
description: Product management agent for feature prioritization, customer discovery, PRD development, and roadmap planning using RICE framework Use when this capability is needed.
metadata:
  author: dalvincodes
---
