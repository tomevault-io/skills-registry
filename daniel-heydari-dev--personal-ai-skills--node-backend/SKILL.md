---
name: node-backend
description: Best practices for Node.js server applications including Express, project structure, and middleware. Use when building backend APIs, setting up Express routes, implementing middleware, or when user asks about "Node.js backend", "Express API", "server setup", or "REST endpoints". Use when this capability is needed.
metadata:
...
---
> Source: [daniel-heydari-dev/personal-ai-skills](https://github.com/daniel-heydari-dev/personal-ai-skills) — distributed by [TomeVault](https://tomevault.io).
