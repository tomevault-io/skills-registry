---
name: seo-technical
description: Implement technical SEO infrastructure for Next.js apps. Use this skill when setting up sitemaps, robots.txt, meta tags, OpenGraph, structured data (JSON-LD), canonical URLs, and other technical SEO elements. Covers Next.js 15/16 App Router patterns and 2026 best practices. Use when this capability is needed.
metadata:
  author: daniel0queiroz
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/daniel0queiroz) — claim your Tome and manage your conversions.
