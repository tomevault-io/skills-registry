---
name: code-review
description: Review changed code against project standards. Checks for missing tests, dead code, type safety, lint issues, and coding conventions. Run after completing any implementation work. Use when this capability is needed.
metadata:
  author: danielabelski
---
...
---
> Source: [danielabelski/hindsight](https://github.com/danielabelski/hindsight) — distributed by [TomeVault](https://tomevault.io).
