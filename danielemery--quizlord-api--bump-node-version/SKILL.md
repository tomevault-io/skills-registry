...
description: Bump the project's Node.js version to the latest LTS. Updates .nvmrc, Dockerfile, package.json, package-lock.json, CI workflows, and node-related packages. Use when this capability is needed.
metadata:
  author: danielemery
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/danielemery) — claim your Tome and manage your conversions.
