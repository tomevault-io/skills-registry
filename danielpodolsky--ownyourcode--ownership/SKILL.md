---
name: ownership-gate
description: Verifies junior truly understands code they wrote through line-by-line walkthrough. BLOCKING gate that must pass to complete any task. Triggered during /own:done flow. Use when this capability is needed.
metadata:
