---
name: blog-new
description: Creative writing partner for Swedish blog posts. Use when the user wants to write a new blog post, create an article, says "new blog post", "nytt inlägg", "skriv blogginlägg", or wants help exploring ideas for their developer blog. Use when this capability is needed.
metadata:
  author: danielv14
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/danielv14) — claim your Tome and manage your conversions.
