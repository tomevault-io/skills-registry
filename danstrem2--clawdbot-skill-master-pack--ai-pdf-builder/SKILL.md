---
name: ai-pdf-builder
description: Generate professional PDFs from Markdown using Pandoc and LaTeX with AI-powered content generation. Creates whitepapers, term sheets, memos, agreements, SAFEs, NDAs, and more. Use when this capability is needed.
metadata:
  author: danstrem2
---
