...
description: Sync and query CalDAV calendars (iCloud, Google, Fastmail, Nextcloud, etc.) using vdirsyncer + khal. Works on Linux. Use when this capability is needed.
metadata:
  author: danstrem2
---
