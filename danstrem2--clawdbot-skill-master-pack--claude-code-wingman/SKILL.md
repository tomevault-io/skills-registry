...
description: Your Claude Code wingman - orchestrate multiple Claude Code sessions across projects, monitor them all from WhatsApp Use when this capability is needed.
metadata:
  author: danstrem2
---
