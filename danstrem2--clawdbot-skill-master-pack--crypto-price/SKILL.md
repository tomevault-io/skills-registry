---
name: crypto-price
description: Get cryptocurrency token price and generate candlestick charts via CoinGecko API or Hyperliquid API. Use when user asks for token price, crypto price, price chart, or cryptocurrency market data. Use when this capability is needed.
metadata:
  author: danstrem2
---
