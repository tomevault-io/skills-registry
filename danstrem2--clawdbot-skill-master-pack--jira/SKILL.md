---
name: jira
description: Manage Jira issues, boards, sprints, and projects via the jira-cli. Search, create, update, and transition issues directly from the command line. Use when this capability is needed.
metadata:
  author: danstrem2
---
