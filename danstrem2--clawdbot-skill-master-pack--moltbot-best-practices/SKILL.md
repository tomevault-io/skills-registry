...
description: Best practices for AI agents to avoid common mistakes. Learn from real failures - confirms before executing, shows drafts before publishing, stops when told to stop, and doesn't over-automate. Use when this capability is needed.
metadata:
  author: danstrem2
---
