---
name: yt-api-cli
description: Manage your YouTube account from the command line. Complete CLI for YouTube Data API v3 - list/search videos, upload, manage playlists, and more. Use when this capability is needed.
metadata:
  author: danstrem2
---
