---
name: jujutsu
description: **REQUIRED** - ALways activate FIRST on any git/VCS operations (commit, status, branch, push, etc.), especially when HEAD is detached. If `.jj/` exists -> this is a Jujutsu (jj) repo - git commands will corrupt data. Essential git safety instructions inside. DO NOT IGNORE. Use when this capability is needed.
metadata:
  author: danverbraganza
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/danverbraganza) — claim your Tome and manage your conversions.
