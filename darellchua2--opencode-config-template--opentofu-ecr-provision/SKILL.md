...
description: Provision AWS Elastic Container Registry (ECR) repositories with GitHub OIDC integration following BETEKK standards Use when this capability is needed.
metadata:
  author: darellchua2
---
