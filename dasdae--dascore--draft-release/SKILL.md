---
name: draft-release
description: Draft the next release version and changelog by fetching tags, computing the next semantic v* tag, collecting merged PRs into master since last release via gh, and printing the proposed version and categorized changelog. Use when this capability is needed.
metadata:
  author: dasdae
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dasdae) — claim your Tome and manage your conversions.
