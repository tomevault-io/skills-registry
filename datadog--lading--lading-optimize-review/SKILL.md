...
description: Reviews optimization patches using a 5-persona peer review system. Requires unanimous approval backed by benchmarks. Use when this capability is needed.
metadata:
  author: datadog
---
