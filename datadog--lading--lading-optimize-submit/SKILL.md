...
description: Full optimization workflow with git branch creation, commits, and optional PR. Wraps /lading-optimize-hunt with git automation. Use when this capability is needed.
metadata:
  author: datadog
---
