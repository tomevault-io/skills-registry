...
description: 模式提取与失效解药分析。当发现多条记忆在讲同一个教训，或发现自己在一而再再而三地犯同样的错误时使用。 Use when this capability is needed.
metadata:
  author: Dataojitori
---
...
---
> Source: [Dataojitori/nocturne_memory](https://github.com/Dataojitori/nocturne_memory) — distributed by [TomeVault](https://tomevault.io).
