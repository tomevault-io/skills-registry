---
name: course-content
description: Get or add homeworks and projects to courses via API using curl Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/datatalksclub) — claim your Tome and manage your conversions.
