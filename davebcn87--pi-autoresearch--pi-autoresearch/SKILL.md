...
description: Finalize an autoresearch session into clean, reviewable branches. Use when asked to "finalize autoresearch", "clean up experiments", or "prepare autoresearch for review". Use when this capability is needed.
metadata:
  author: davebcn87
---
...
---
> Source: [davebcn87/pi-autoresearch](https://github.com/davebcn87/pi-autoresearch) — distributed by [TomeVault](https://tomevault.io).
