---
name: auth-patterns
description: This skill should be used when the user asks about "authentication in Next.js", "NextAuth", "Auth.js", "middleware auth", "protected routes", "session management", "JWT", "login flow", or needs guidance on implementing authentication and authorization in Next.js applications. Use when this capability is needed.
metadata:
  author: davepoon
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/davepoon) — claim your Tome and manage your conversions.
