---
name: analyze-deps
description: Analyze class dependencies and generate processing order using topological sort. Use when determining build order, finding dependency cycles, or understanding class relationships in the decompiled codebase. Use when this capability is needed.
metadata:
