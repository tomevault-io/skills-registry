---
name: process-batch
description: Orchestrate parallel processing of multiple classes through the modernization pipeline. Use when batch processing classes, coordinating header and method generation, or managing large-scale code modernization tasks. Use when this capability is needed.
metadata:
