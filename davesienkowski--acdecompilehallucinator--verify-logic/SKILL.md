---
name: verify-logic
description: Verify that modernized C++ code preserves the exact logic of the original decompiled function. Use when checking code equivalence, validating refactoring changes, or ensuring no logic was accidentally altered during modernization. Use when this capability is needed.
metadata:
  author: davesienkowski
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/davesienkowski) — claim your Tome and manage your conversions.
