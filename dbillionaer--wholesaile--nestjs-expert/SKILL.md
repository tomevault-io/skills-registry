---
name: nestjs-expert
description: Nest.js framework expert specializing in module architecture, dependency injection, middleware, guards, interceptors, testing with Jest/Supertest, TypeORM/Mongoose integration, and Passport.js auth... Use when this capability is needed.
metadata:
  author: Dbillionaer
---
...
---
> Source: [Dbillionaer/wholesaile](https://github.com/Dbillionaer/wholesaile) — distributed by [TomeVault](https://tomevault.io).
