---
name: pin-workflows
description: Audits all .github/workflows/ action references, upgrades any that are behind the latest release, and pins every tag to its exact SHA commit hash for supply chain security. Use when this capability is needed.
metadata:
  author: dbrennand
---
...
---
> Source: [dbrennand/home-ops](https://github.com/dbrennand/home-ops) — distributed by [TomeVault](https://tomevault.io).
