...
description: Guides users through configuring Content Security Policy (CSP) in Tauri v2 applications to prevent XSS attacks and enhance security by restricting resource loading. Use when this capability is needed.
metadata:
  author: dchuk
---
