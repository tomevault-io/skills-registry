...
description: Explains the Tauri process model architecture including the Core process, WebView process, inter-process communication, multiwindow handling, and process isolation security patterns. Use when this capability is needed.
metadata:
  author: dchuk
---
