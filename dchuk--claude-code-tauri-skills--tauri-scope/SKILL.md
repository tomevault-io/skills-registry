...
description: Guides users through configuring Tauri command scopes for security, including filesystem restrictions, URL patterns, dynamic scope management, and capability-based access control. Use when this capability is needed.
metadata:
  author: dchuk
---
