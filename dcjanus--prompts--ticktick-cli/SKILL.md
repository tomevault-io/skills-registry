---
name: ticktick-cli
description: 使用 Python CLI 与 Dida365 Open API 交互以管理滴答清单任务/项目，适用于需要通过脚本或命令行调用滴答清单接口的场景（如项目/任务的查询、创建、更新、完成、删除）。 Use when this capability is needed.
metadata:
  author: dcjanus
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dcjanus) — claim your Tome and manage your conversions.
