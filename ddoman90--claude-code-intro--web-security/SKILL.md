---
name: web-security
description: Enforce web security and avoid security vulnerabilities Use when this capability is needed.
metadata:
  author: ddoman90
---
...
Treat web security as a core requirement, not an afterthought. Assume hostile input and untrusted environments by default.
