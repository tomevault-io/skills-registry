...
description: Use ButtonKit's AsyncButton for SwiftUI button actions that start a Task, call async/await, use do/catch, or need built-in loading/progress/error feedback. Trigger when replacing custom Button+Task wrappers or when a button action can throw or is async. Use when this capability is needed.
metadata:
  author: Dean151
---
...
---
> Source: [Dean151/ButtonKit](https://github.com/Dean151/ButtonKit) — distributed by [TomeVault](https://tomevault.io).
