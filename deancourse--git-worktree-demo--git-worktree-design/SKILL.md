...
description: 當使用者的需求是新增多個功能，或判斷使用者的需求適合拆分成多個 feature branch 並行開發時，或是提到 "worktree"、"git worktree"、"多分支開發"、"parallel branches"，自動觸發此 Skill。先分析需求並建議 worktree 拆分方案，經使用者確認後執行建立。 Use when this capability is needed.
metadata:
  author: deancourse
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/deancourse) — claim your Tome and manage your conversions.
