...
description: Evaluate acquisition channels using unit economics, customer quality, and scalability. Use when deciding whether to scale, test, or kill a growth channel. Use when this capability is needed.
metadata:
  author: deanpeters
---
