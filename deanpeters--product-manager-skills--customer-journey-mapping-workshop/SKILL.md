...
description: Run a customer journey mapping workshop with adaptive questions and outputs. Use when you need to map stages, actions, emotions, pain points, and opportunities for a persona and scenario. Use when this capability is needed.
metadata:
  author: deanpeters
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/deanpeters) — claim your Tome and manage your conversions.
