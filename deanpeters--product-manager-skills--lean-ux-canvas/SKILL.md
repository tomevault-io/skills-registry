---
name: lean-ux-canvas
description: Guide teams through Lean UX Canvas v2. Use when framing a business problem, surfacing assumptions, and defining what to learn next. Use when this capability is needed.
metadata:
  author: deanpeters
---
