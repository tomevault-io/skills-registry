---
name: pol-probe
description: Define a Proof of Life probe to test a risky hypothesis cheaply. Use when you need harsh truth before building real product. Use when this capability is needed.
metadata:
  author: deanpeters
---
