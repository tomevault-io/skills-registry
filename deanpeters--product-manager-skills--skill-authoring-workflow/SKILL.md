...
description: Turn raw PM content into a compliant, publish-ready skill. Use when creating or updating a repo skill without breaking standards. Use when this capability is needed.
metadata:
  author: deanpeters
---
