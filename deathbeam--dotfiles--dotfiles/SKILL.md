...
description: Convert the user's initial request into a fully-specified, unambiguous, execution-ready prompt through structured interaction. Use when this capability is needed.
metadata:
  author: deathbeam
---
...
---
> Source: [deathbeam/dotfiles](https://github.com/deathbeam/dotfiles) — distributed by [TomeVault](https://tomevault.io).
