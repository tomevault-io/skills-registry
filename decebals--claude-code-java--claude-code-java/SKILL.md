...
description: Detect potential code-level performance smells in Java - streams, collections, boxing, regex, object creation. Provides awareness, not absolutes - always measure before optimizing. For JPA/database performance, use jpa-patterns instead. Use when this capability is needed.
metadata:
  author: decebals
---
...
---
> Source: [decebals/claude-code-java](https://github.com/decebals/claude-code-java) — distributed by [TomeVault](https://tomevault.io).
