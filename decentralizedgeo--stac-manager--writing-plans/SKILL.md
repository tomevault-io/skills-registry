...
**Single Document Preference:**
All phases and tasks should reside in a single implementation plan document. This maintains cognitive context and makes it easier to track cross-phase dependencies. 

**Structure:**
- **Table of Contents**: At the top, provide a linked list of all phases and their task counts.
- **Phase Headers**: Use `## Phase N: [Phase Name]` to clearly separate major blocks of work.
- **Task Subheadings**: Use `### Task N: [Task Name]` for granular tasks within each phase.
