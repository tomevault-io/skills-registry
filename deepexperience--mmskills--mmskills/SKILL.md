...
description: Insert a media object on the intended slide, optionally configure click behavior, and verify the requested result before leaving the slide. Use when this capability is needed.
metadata:
...
---
> Source: [DeepExperience/MMSkills](https://github.com/DeepExperience/MMSkills) — distributed by [TomeVault](https://tomevault.io).
