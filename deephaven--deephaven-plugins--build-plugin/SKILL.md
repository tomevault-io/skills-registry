---
name: build-plugin
description: Build and install Python plugins using plugin_builder.py. Use when asked to build, install, or reinstall a plugin. Use when this capability is needed.
metadata:
  author: deephaven
---
