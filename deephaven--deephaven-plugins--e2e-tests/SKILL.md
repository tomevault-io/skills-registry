---
name: e2e-tests
description: Run Playwright end-to-end tests in Docker. Use when asked to run e2e tests, integration tests, Playwright tests, or browser tests. Use when this capability is needed.
metadata:
  author: deephaven
---
