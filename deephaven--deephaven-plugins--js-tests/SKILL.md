---
name: js-tests
description: Run JavaScript/TypeScript Jest unit tests. Use when asked to run JS tests, Jest tests, or frontend unit tests. Use when this capability is needed.
metadata:
  author: deephaven
---
