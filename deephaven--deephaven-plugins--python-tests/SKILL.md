---
name: python-tests
description: Run Python plugin tests using tox. Use when asked to run Python tests, unit tests for a plugin, or tox commands. Use when this capability is needed.
metadata:
  author: deephaven
---
