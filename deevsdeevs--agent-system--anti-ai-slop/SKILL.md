---
name: anti-ai-slop
description: After working on the code, ensure the branch contains only the minimal, idiomatic changes by removing AI-generated slop introduced on this branch. Use when this capability is needed.
metadata:
  author: deevsdeevs
---
