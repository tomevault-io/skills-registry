---
name: chat-to-skill
description: Convert current chat session into a reusable skill. Use when user says "/chat-to-skill", "save this as skill", "create skill from chat", "turn this into a skill", or wants to preserve learnings from the conversation as long-term memory. Use when this capability is needed.
metadata:
  author: dejanr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dejanr) — claim your Tome and manage your conversions.
