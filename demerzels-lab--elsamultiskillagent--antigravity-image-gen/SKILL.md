...
description: Generate images using the internal Google Antigravity API (Gemini 3 Pro Image). High quality, native generation without browser automation. Use when this capability is needed.
metadata:
