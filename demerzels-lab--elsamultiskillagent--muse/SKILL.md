---
name: muse
description: AI coding analytics and agent orchestration via the `tribe` CLI. Search sessions, manage knowledge, orchestrate agents with MUSE and CIRCUIT. Deploy your own instance at tribeclaw.com in minutes. Use when this capability is needed.
metadata:
