---
name: sheet-cog
description: Spreadsheet generation powered by CellCog. Create Excel files, financial models, budget templates, data trackers, calculations, projections, XLSX files. AI-powered spreadsheet builder. Use when this capability is needed.
metadata:
