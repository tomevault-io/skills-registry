---
name: translation
description: Guidelines for translating and localizing the Nova Code extension, including language-specific rules for German, Simplified Chinese, and Traditional Chinese. Use when this capability is needed.
metadata:
