---
name: code-review
description: Review a PR diff with focused, actionable feedback. Use when reviewing pull requests, code changes, or when the user asks for a code review. Use when this capability is needed.
metadata:
  author: devclarityai
---
