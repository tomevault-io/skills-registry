---
name: init-context
description: Analyze the codebase and generate context rules for Cursor. Use when setting up or populating .cursor/rules/ files. Use when this capability is needed.
metadata:
  author: devclarityai
---
