...
description: Guide for creating effective skills for any AI agent (Claude, Trae, Gemini, OpenCode, Qwen, etc.). This skill should be used when users want to create a new skill or update an existing one. Use when this capability is needed.
metadata:
  author: devskale
---
