...
description: 为即梦 Seedance 2.0 多模态AI视频生成模型撰写高质量提示词。当用户需要使用文本、图片、视频、音频等多模态输入创作视频提示词时触发。涵盖@引用语法、运镜复刻、特效模仿、视频延长、视频编辑、音乐卡点、电商广告、短剧创作、科普教育等场景。 Use when this capability is needed.
metadata:
  author: dexhunter
---
...
---
> Source: [dexhunter/seedance2-skill](https://github.com/dexhunter/seedance2-skill) — distributed by [TomeVault](https://tomevault.io).
