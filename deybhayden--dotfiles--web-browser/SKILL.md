---
name: web-browser
description: Browser automation using the agent-browser CLI (Chromium via Playwright). Use it to navigate pages, capture snapshots, and interact with elements. Use when this capability is needed.
metadata:
  author: deybhayden
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/deybhayden) — claim your Tome and manage your conversions.
