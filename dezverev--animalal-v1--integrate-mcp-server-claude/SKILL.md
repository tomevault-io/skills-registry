---
name: integrate-mcp-server-claude
...
- Use the **NestedMCPKernelPlugin** pattern: lazy async kernel (`Lazy<Task<Kernel>>`), MCP client lifecycle, disposal, retry for transient failures, thread-safe initialization.
