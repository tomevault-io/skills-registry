---
name: claude-chrome
description: Use Claude Code with Chrome browser extension for web browsing and automation tasks. Alternative to OpenClaw's built-in browser tools. Use when this capability is needed.
metadata:
  author: dgriffin831
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dgriffin831) — claim your Tome and manage your conversions.
