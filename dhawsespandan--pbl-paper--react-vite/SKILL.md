---
name: react-vite
description: Guidelines for building React + Vite web apps in the pnpm monorepo with design subagent delegation. Use when this capability is needed.
metadata:
  author: dhawsespandan
---
...
---
> Source: [dhawsespandan/pbl-paper](https://github.com/dhawsespandan/pbl-paper) — distributed by [TomeVault](https://tomevault.io).
