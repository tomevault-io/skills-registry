...
description: Refactor recently modified code to be clearer and more consistent without changing behavior; follow CLAUDE.md conventions and avoid “clever” one-liners. Use when this capability is needed.
metadata:
  author: diegobit
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/diegobit) — claim your Tome and manage your conversions.
