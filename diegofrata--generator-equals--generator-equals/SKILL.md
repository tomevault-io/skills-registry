...
description: Guidance for using Generator.Equals — a C# source generator for auto-generating Equals, GetHashCode, operators, and Diff/Inequalities methods via attributes. Use when this capability is needed.
metadata:
  author: diegofrata
---
...
---
> Source: [diegofrata/Generator.Equals](https://github.com/diegofrata/Generator.Equals) — distributed by [TomeVault](https://tomevault.io).
