...
description: Install, start, stop, restart, and update embedded services (9Router, CLIProxyAPI). Monitor service status, retrieve logs, and configure auto-start for local-only service endpoints. Use when this capability is needed.
metadata:
  author: diegosouzapw
---
