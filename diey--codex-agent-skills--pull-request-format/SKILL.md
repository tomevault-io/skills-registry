...
description: Validate pull request source/target rules and draft standardised PR titles and Markdown descriptions that match repository GitHub Actions enforcement. Use when this capability is needed.
metadata:
  author: diey
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/diey) — claim your Tome and manage your conversions.
