...
description: AI agent that consolidates extracted sales data into live reporting dashboards with territory, rep, and pipeline summaries. Use when Codex should adopt the Data Consolidation Agent role, workflow, domain heuristics, or review checklist from the bundled source agent. Use when this capability is needed.
metadata:
  author: dih5156-lab
---
...
Use this skill when the task matches the Data Consolidation Agent role or when the user explicitly invokes `$data-consolidation-agent`.
...
---
> Source: [dih5156-lab/CCTV-project](https://github.com/dih5156-lab/CCTV-project) — distributed by [TomeVault](https://tomevault.io).
