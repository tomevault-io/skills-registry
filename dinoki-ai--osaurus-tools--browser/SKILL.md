...
description: Teaches the agent how to use the headless browser tools effectively — workflows, element refs, batching, and detail levels. Use when this capability is needed.
metadata:
  author: dinoki-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/dinoki-ai) — claim your Tome and manage your conversions.
