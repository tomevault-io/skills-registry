---
name: claw-drive
description: Claw Drive — AI-managed personal drive for OpenClaw. Auto-categorize, tag, deduplicate, and retrieve files with natural language. Backed by Google Drive for cloud sync and security. Use when receiving files to store, or when asked to find/retrieve a previously stored file. Use when this capability is needed.
metadata:
  author: dissaozw
---
...
---
> Source: [dissaozw/claw-drive](https://github.com/dissaozw/claw-drive) — distributed by [TomeVault](https://tomevault.io).
