...
description: Hyper-pedantic Django code review skill emulating Monty's correctness-first, multi-tenant-safe, harness-aware review style. Use when this capability is needed.
metadata:
  author: diversioteam
---
