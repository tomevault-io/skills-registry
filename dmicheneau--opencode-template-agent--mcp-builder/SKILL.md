---
name: mcp-builder
description: Guide for creating high-quality MCP (Model Context Protocol) servers that enable LLMs to interact with external services through well-designed tool... Use when this capability is needed.
metadata:
  author: dmicheneau
---
