...
description: Expert in designing effective prompts for LLM-powered applications. Masters prompt structure, context management, output formatting, and prompt eva... Use when this capability is needed.
metadata:
  author: dmicheneau
---

<!-- Synced from aitmpl.com | source: davila7/claude-code-templates | category: ai-research -->
