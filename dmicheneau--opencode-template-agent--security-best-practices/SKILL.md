...
description: Perform language and framework specific security best-practice reviews and suggest improvements. Trigger only when the user explicitly requests sec... Use when this capability is needed.
metadata:
  author: dmicheneau
---
