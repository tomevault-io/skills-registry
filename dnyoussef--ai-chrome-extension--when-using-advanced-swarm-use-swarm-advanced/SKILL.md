...
description: Advanced swarm patterns with dynamic topology switching and self-organizing behaviors for complex multi-agent coordination Use when this capability is needed.
metadata:
  author: dnyoussef
---
