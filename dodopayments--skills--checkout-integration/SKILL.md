...
description: Guide for creating checkout sessions and payment flows with Dodo Payments - one-time, subscriptions, and overlay checkout. Use when this capability is needed.
metadata:
  author: dodopayments
---
