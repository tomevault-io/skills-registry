---
name: nothing-design
description: This skill should be used when the user explicitly says "Nothing style", "Nothing design", "/nothing-design", or directly asks to use/apply the Nothing design system. NEVER trigger automatically for generic UI or design tasks. Use when this capability is needed.
metadata:
  author: dominikmartn
---
...
---
> Source: [dominikmartn/nothing-design-skill](https://github.com/dominikmartn/nothing-design-skill) — distributed by [TomeVault](https://tomevault.io).
