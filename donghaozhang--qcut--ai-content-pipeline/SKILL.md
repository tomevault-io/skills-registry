...
description: Generate AI content (images, videos, audio, avatars) and analyze videos with AICP in QCut. Primary mode uses QCut's bundled AICP binary with secure API key injection. Use when this capability is needed.
metadata:
  author: donghaozhang
---
