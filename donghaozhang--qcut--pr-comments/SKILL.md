---
name: pr-comments
description: Export, preprocess, and fix GitHub PR review comments. Use when user wants to export PR comments, evaluate code reviews, or fix review feedback from CodeRabbit/Gemini/Devin bots. Use when this capability is needed.
metadata:
  author: donghaozhang
---
