...
description: Guide for writing Aspire CLI end-to-end tests using Hex1b terminal automation. Use this when asked to create, modify, or debug CLI E2E tests. Use when this capability is needed.
metadata:
  author: dotnet
---
...
---
> Source: [dotnet/aspire](https://github.com/dotnet/aspire) — distributed by [TomeVault](https://tomevault.io).
