---
name: pr-testing
description: Downloads and tests Aspire CLI from a PR build, verifies version, and runs test scenarios based on PR changes. Use this when asked to test a pull request. Use when this capability is needed.
metadata:
  author: dotnet
---
