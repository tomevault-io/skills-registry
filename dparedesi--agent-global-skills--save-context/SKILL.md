---
name: save-context
description: Save session context for agent handoffs. Use when ending work, switching agents, or when user says "save context", "handoff", "wrap up", or "save session". Use when this capability is needed.
metadata:
  author: dparedesi
---
