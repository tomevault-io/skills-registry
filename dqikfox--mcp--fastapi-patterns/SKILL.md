...
description: Production FastAPI patterns with Pydantic v2, async endpoints, OAuth2/JWT, dependency injection, testing, and Kubernetes deployment Use when this capability is needed.
metadata:
  author: dqikfox
---
...
---
> Source: [dqikfox/mcp](https://github.com/dqikfox/mcp) — distributed by [TomeVault](https://tomevault.io).
