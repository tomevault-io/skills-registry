---
name: explain-code
description: Analyze and explain code functionality with structured breakdowns. Use when the user asks to "explain this code", "how does this work", "what does this do", or "walk me through this code". Use when this capability is needed.
metadata:
  author: drafael
---
