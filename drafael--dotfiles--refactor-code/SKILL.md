---
name: refactor-code
description: Intelligently refactor and improve code quality with incremental, test-backed changes. Use when the user asks to "refactor", "clean up code", "improve code quality", "restructure", or "simplify this code". Use when this capability is needed.
metadata:
  author: drafael
---
