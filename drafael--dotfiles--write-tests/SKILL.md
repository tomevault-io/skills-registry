---
name: write-tests
description: Write unit and integration tests for code. Use when the user asks to "write tests", "add tests", "add test coverage", or "create test cases" for functions, services, or components. Use when this capability is needed.
metadata:
  author: drafael
---
