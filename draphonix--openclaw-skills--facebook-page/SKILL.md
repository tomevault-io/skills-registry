---
name: facebook-page
description: Manage Facebook Pages via Meta Graph API. Post content (text, photos, links), list posts, manage comments (list/reply/hide/delete). Use when user wants to publish to Facebook Page, check Page posts, or handle comments. Use when this capability is needed.
metadata:
  author: draphonix
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/draphonix) — claim your Tome and manage your conversions.
