---
name: linearis
description: Linear.app CLI for issue tracking. Use for listing, creating, updating, and searching Linear issues, comments, documents, cycles, and projects. Optimized for LLM agents with JSON output. Use when this capability is needed.
metadata:
  author: drbobber
---
