...
description: Search the official Claude Code marketplace (claude-plugins-official) for plugins matching capability gaps. Uses plugin CLI to list and search, presents top 5 matches for user approval. Use when this capability is needed.
metadata:
  author: drbscl
---
