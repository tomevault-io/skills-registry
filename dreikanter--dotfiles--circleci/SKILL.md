---
name: circleci
description: Fetch CircleCI CI status, test failures, and job logs for a GitHub PR. Use when checking if a PR passed CI, fetching test errors, or investigating CI failures. Use when this capability is needed.
metadata:
  author: dreikanter
---
