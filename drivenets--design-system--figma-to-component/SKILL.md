...
description: Create a design system component from a Figma URL. Extracts design tokens, maps to CSS custom properties, and scaffolds the component. Use when the user provides a Figma link and asks to implement it. Use when this capability is needed.
metadata:
  author: drivenets
---
