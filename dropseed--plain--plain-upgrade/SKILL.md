---
name: plain-upgrade
description: Upgrades Plain packages and applies required migration changes. Use when updating to newer package versions. Use when this capability is needed.
metadata:
  author: dropseed
---
