---
name: plainx-release
description: Releases plainx packages with version suggestions, changelog generation, and git tagging. Use when releasing a package to PyPI. Use when this capability is needed.
metadata:
  author: dropseed
---
