---
name: fact-checker
description: AI tool that analyzes language and context to identify potential misinformation and fact-check claims made by public figures Use when this capability is needed.
metadata:
