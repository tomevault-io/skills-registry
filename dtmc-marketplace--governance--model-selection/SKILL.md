...
description: Select appropriate AI/ML models based on capability matching, benchmarks, cost-performance tradeoffs, and deployment constraints. Use when this capability is needed.
metadata:
