...
description: Evaluate and design data warehouse schemas — star, snowflake, data vault, OBT — with grain definition, SCD strategies, and normalization trade-offs Use when this capability is needed.
metadata:
  author: dtsong
---
