...
description: [AI & Tools] Use when you need to sync Claude Code knowledge to GitHub Copilot instructions. Auto-inits docs/copilot-registry.json when missing. Flag: --fast (script-only workflow-catalog sync, no registry-curation pass). Use when this capability is needed.
metadata:
  author: duc01226
---
...
---
> Source: [duc01226/easy-claude](https://github.com/duc01226/easy-claude) — distributed by [TomeVault](https://tomevault.io).
