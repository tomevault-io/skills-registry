...
description: [Architecture] Use when analyzing and improving performance for database queries, API endpoints, or frontend rendering. Use when this capability is needed.
metadata:
  author: duc01226
---
