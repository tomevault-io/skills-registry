---
name: custom-agent
description: [AI & Tools] Use when you need create, verify, or enhance Claude Code custom agents (Claude Code custom agent files). Use when this capability is needed.
metadata:
  author: duc01226
---
