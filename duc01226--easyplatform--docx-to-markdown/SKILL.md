...
description: [Document Processing] Convert Microsoft Word (.docx) files to Markdown with GFM support (tables, images, code blocks). Cross-platform. Use when this capability is needed.
metadata:
  author: duc01226
---
