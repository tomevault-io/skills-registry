...
description: [Document Processing] Convert markdown files to Microsoft Word (.docx) format with GFM support and math rendering Use when this capability is needed.
metadata:
  author: duc01226
---
