...
description: [Document Processing] Convert markdown files to PDF with syntax highlighting and custom CSS support. Cross-platform (Windows, macOS, Linux). Use when this capability is needed.
metadata:
  author: duc01226
---
