...
description: [Document Processing] Convert PDF files to Markdown with support for native text PDFs and scanned documents (OCR). Cross-platform. Use when this capability is needed.
metadata:
  author: duc01226
---
