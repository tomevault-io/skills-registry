---
name: repomix
description: [AI & Tools] Package code repositories into single AI-friendly files using Repomix with customizable patterns and multiple output formats. Triggers: repomix, package repo, repository context, codebase snapshot, repo pack. Use when this capability is needed.
metadata:
  author: duc01226
---
