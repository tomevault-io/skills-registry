---
name: skill-add
description: [Skill Management] Add new reference files or scripts to a skill. Triggers on: add reference, add script, skill reference, skill script. Use when this capability is needed.
metadata:
  author: duc01226
---
