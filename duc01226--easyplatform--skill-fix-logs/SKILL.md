---
name: skill-fix-logs
description: [Skill Management] Fix the agent skill based on `logs.txt` file. Triggers on: fix skill logs, skill error, skill broken, skill not working. Use when this capability is needed.
metadata:
  author: duc01226
---
