---
name: skill-optimize
description: [Skill Management] Optimize an existing agent skill for token efficiency, attention anchoring, and SYNC protocol compliance. Triggers on: optimize skill, improve skill, refactor skill, skill too long. Use when this capability is needed.
metadata:
  author: duc01226
---
