...
description: OpenClaw integration guidance for CAPTCHAS Agent API, including OpenResponses tool schemas and plugin tool registration. Use when this capability is needed.
metadata:
  author: duclm1x1
---
