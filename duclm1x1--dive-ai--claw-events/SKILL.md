---
name: claw
description: Real-time event bus for AI agents. Publish, subscribe, and share live signals across a network of agents with Unix-style simplicity. Use when this capability is needed.
metadata:
  author: duclm1x1
---
