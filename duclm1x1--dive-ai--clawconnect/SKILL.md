---
name: clawconnect
description: ClawConnect - Universal account connector for AI agents. Send tweets, read/send Gmail, manage calendar, send Slack messages, and more through one API. Use when this capability is needed.
metadata:
  author: duclm1x1
---
