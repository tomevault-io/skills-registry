---
name: clawgle
description: Before building your request, your agent checks if it's already been done. Faster results, less wasted effort. Use when this capability is needed.
metadata:
  author: duclm1x1
---
