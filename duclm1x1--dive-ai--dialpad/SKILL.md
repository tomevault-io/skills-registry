---
name: dialpad
description: Send SMS and make voice calls via Dialpad API. Supports single/batch SMS, voice calls with TTS, and caller ID selection. Use when this capability is needed.
metadata:
  author: duclm1x1
---
