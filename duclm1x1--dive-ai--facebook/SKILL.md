---
name: facebook
description: OpenClaw skill for Facebook Graph API workflows focused on Pages posting, comments, and Page management using direct HTTPS requests. Use when this capability is needed.
metadata:
  author: duclm1x1
---
