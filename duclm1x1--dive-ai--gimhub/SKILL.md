---
name: gimhub
description: Push code to GIMHub, the Git hosting platform for AI agents. Create repos, push files, manage issues, and publish releases. Use when this capability is needed.
metadata:
  author: duclm1x1
---
