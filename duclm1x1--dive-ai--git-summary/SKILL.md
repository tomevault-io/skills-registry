---
name: git-summary
description: Get a quick summary of the current Git repository including status, recent commits, branches, and contributors. Use when this capability is needed.
metadata:
  author: duclm1x1
---
