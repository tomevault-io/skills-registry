---
name: gitclassic
description: Fast, no-JavaScript GitHub browser optimized for AI agents. Browse public repos, read files, view READMEs with sub-500ms load times. PRO adds private repo access via GitHub OAuth. Use when this capability is needed.
metadata:
  author: duclm1x1
---
