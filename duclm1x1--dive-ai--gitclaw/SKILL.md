---
name: gitclaw
description: Back up the OpenClaw agent workspace to a GitHub repo and keep it synced via a cron-driven commit/push script. Use when this capability is needed.
metadata:
  author: duclm1x1
---
