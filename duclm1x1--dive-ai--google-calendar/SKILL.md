...
description: Interact with Google Calendar via the Google Calendar API – list upcoming events, create new events, update or delete them. Use this skill when you need programmatic access to your calendar from OpenClaw. Use when this capability is needed.
metadata:
  author: duclm1x1
---
