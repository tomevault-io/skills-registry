---
name: inkjet
description: Print text, images, and QR codes to a cheap wireless Bluetooth thermal printer from a MacOS device. Use `inkjet print` for output, `inkjet scan` to discover printers. Use when this capability is needed.
metadata:
  author: duclm1x1
---
