...
description: Format and beautify markdown documents with configurable styles. Preserve structure, fix formatting, ensure consistency. Use when this capability is needed.
metadata:
  author: duclm1x1
---
