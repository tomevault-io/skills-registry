---
name: messenger
description: OpenClaw skill for Facebook Messenger Platform workflows, including messaging, webhooks, and Page inbox operations using direct HTTPS requests. Use when this capability is needed.
metadata:
  author: duclm1x1
---
