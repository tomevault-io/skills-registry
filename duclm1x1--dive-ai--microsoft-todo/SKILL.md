---
name: microsoft-todo
description: Manage Microsoft To Do tasks via the `todo` CLI. Use when user wants to add, list, complete, remove tasks, manage subtasks (steps), notes, or organize task lists. Use when this capability is needed.
metadata:
  author: duclm1x1
---
