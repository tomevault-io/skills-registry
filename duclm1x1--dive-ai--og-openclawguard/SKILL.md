---
name: flaw0
description: Security and vulnerability scanner for OpenClaw code, plugins, skills, and Node.js dependencies. Powered by OpenClaw AI models. Use when this capability is needed.
metadata:
  author: duclm1x1
---
