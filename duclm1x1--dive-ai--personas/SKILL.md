---
name: personas
description: Transform into 20 specialized AI personalities on demand - from Dev (coding) to Chef Marco (cooking) to Dr. Med (medical). Switch mid-conversation. Token-efficient, loads only active persona. Use when this capability is needed.
metadata:
  author: duclm1x1
---
