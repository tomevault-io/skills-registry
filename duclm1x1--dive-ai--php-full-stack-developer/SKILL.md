...
description: Use when working with a senior, governance-backed PHP full-stack delivery OS for OpenClaw. Emphasizes pre-flight analysis, safe data changes, explicit contracts, and reproducible verification.
metadata:
  author: duclm1x1
---
