---
name: pollclaw
description: Deprecated: Pollclaw is now MeetLark. Use the coordinate-meeting skill instead for meeting scheduling. See https://meetlark.ai Use when this capability is needed.
metadata:
  author: duclm1x1
---
