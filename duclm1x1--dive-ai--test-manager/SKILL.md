---
name: clickup
description: Interact with ClickUp API for task management. Use for listing tasks, creating tasks, updating task status, and managing workspaces. Base URL: https://api.clickup.com/api/v2 Use when this capability is needed.
metadata:
  author: duclm1x1
---
