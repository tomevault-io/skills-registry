...
description: Create a Starknet account to your agent through Typhoon anonymous deployer and interact with Starknet contracts (read/write + preflight). Use when this capability is needed.
metadata:
  author: duclm1x1
---
