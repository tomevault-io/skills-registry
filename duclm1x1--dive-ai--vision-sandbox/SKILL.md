---
name: vision-sandbox
description: Agentic Vision via Gemini's native Code Execution sandbox. Use for spatial grounding, visual math, and UI auditing. Use when this capability is needed.
metadata:
  author: duclm1x1
---
