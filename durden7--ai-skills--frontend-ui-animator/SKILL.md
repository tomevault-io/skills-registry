...
description: Analyze and implement purposeful UI animations for Next.js + Tailwind + React projects. Use when user asks to add animations, enhance UI motion, animate pages/components, or improve visual feedback. Triggers on "add animations", "animate UI", "motion design", "hover effects", "scroll animations", "page transitions", "micro-interactions". Use when this capability is needed.
metadata:
  author: durden7
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/durden7) — claim your Tome and manage your conversions.
