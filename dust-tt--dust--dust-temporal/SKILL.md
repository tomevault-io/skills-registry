---
name: dust-temporal
description: Step-by-step guide for creating Temporal workflows in Dust. Use when adding background jobs, async processing, durable workflows, or task queues. Use when this capability is needed.
metadata:
  author: dust-tt
---
