---
name: paperbanana
description: Generate publication-quality academic diagrams from paper methodology text Use when this capability is needed.
metadata:
  author: dwzhu-pku
---
...
---
> Source: [dwzhu-pku/PaperBanana](https://github.com/dwzhu-pku/PaperBanana) — distributed by [TomeVault](https://tomevault.io).
