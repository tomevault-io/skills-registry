---
name: dyaddebug-with-playwright
description: Debug E2E tests by taking screenshots at key points to visually inspect application state. Use when this capability is needed.
metadata:
  author: dyad-sh
---
