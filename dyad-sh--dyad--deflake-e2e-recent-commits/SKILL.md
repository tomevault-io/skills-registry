---
name: dyaddeflake-e2e-recent-commits
description: Automatically gather flaky E2E tests from recent CI runs on the main branch and from recent PRs by wwwillchen/keppo-bot/dyad-assistant, then deflake them. Use when this capability is needed.
metadata:
  author: dyad-sh
---
