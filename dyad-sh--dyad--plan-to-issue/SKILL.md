---
name: dyadplan-to-issue
description: Create a plan collaboratively with the user, then convert the approved plan into a GitHub issue. Use when this capability is needed.
metadata:
  author: dyad-sh
---
