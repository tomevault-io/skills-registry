---
name: dyadpr-fix
description: Address all outstanding issues on a GitHub Pull Request by handling both review comments and failing CI checks. Use when this capability is needed.
metadata:
  author: dyad-sh
---
