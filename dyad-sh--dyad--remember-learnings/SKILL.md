...
description: Review the current session for errors, issues, snags, and hard-won knowledge, then update the rules/ files (or AGENTS.md if no suitable rule file exists) with actionable learnings. Use when this capability is needed.
metadata:
  author: dyad-sh
---
