---
name: dyadswarm-to-plan
description: Swarm planning session with PM, UX, and Engineering agents who debate an idea, ask clarifying questions, and produce a detailed spec written to plans/$plan-name.md. Use when this capability is needed.
metadata:
  author: dyad-sh
---
