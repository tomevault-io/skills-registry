---
name: lilya
description: Lilya best practices and conventions. Use when working with the Lilya ASGI toolkit and Pydantic/Edgy models. Keeps Lilya code clean and up to date with the latest features and patterns, updated with new versions. Write new code or refactor and update old code. Use when this capability is needed.
metadata:
  author: dymmond
---
...
---
> Source: [dymmond/lilya](https://github.com/dymmond/lilya) — distributed by [TomeVault](https://tomevault.io).
