...
description: Generate new videos from text prompts, images, or reference inputs using EachLabs AI models. Supports text-to-video, image-to-video, transitions, motion control, talking head, and avatar generation. Use when the user wants to create new video content. For editing existing videos, see eachlabs-video-edit. Use when this capability is needed.
metadata:
  author: eachlabs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/eachlabs) — claim your Tome and manage your conversions.
