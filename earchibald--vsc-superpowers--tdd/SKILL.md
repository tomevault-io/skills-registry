...
Manual testing is ad-hoc. You think you tested everything but can't re-run systematically.
...
| "Tests after achieve same goals" | Tests-after ≠ tests-first. Different disciplines. |
