...
description: Use at the end of a Claude Code session to create a comprehensive summary note in Obsidian and add a brief reference to the daily note Use when this capability is needed.
metadata:
  author: ebinnion
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ebinnion) — claim your Tome and manage your conversions.
