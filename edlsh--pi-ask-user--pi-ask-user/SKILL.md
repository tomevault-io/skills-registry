---
name: ask-user
description: You MUST use this before high-stakes architectural decisions, irreversible changes, or when requirements are ambiguous. Runs a decision handshake with the ask_user tool: summarize context, present structured options, collect explicit user choice, then proceed. Use when this capability is needed.
metadata:
  author: edlsh
---
...
---
> Source: [edlsh/pi-ask-user](https://github.com/edlsh/pi-ask-user) — distributed by [TomeVault](https://tomevault.io).
