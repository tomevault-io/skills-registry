---
name: vercel-deploy
description: Deploy applications and websites to Vercel using the bundled `scripts/deploy.sh` claimable-preview flow. Use when the user asks to deploy to Vercel, wants a preview URL, or says to push a project live on Vercel. Use when this capability is needed.
metadata:
  author: edrodrigues
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/edrodrigues) — claim your Tome and manage your conversions.
