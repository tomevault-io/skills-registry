---
name: slidev
description: Create and present web-based slides for developers using Markdown, Vue components, code highlighting, animations, and interactive features. Use when building technical presentations, conference talks, or teaching materials. Use when this capability is needed.
metadata:
  author: efterklang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/efterklang) — claim your Tome and manage your conversions.
