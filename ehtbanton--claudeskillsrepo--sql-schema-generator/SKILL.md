...
description: Generate SQL database schema files with tables, relationships, indexes, and constraints for PostgreSQL, MySQL, or SQLite. Triggers on "create SQL schema", "generate database schema", "SQL tables for", "database design for". Use when this capability is needed.
metadata:
  author: ehtbanton
---
