---
name: modern-python
description: Modern Python best practices. Use when creating new Python projects, and writing Python scripts, or migrating existing projects from legacy tools. Use when this capability is needed.
metadata:
  author: elderevil
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/elderevil) — claim your Tome and manage your conversions.
