...
description: Generate properly formatted Conventional Commits messages with Claude Code footer. Use when creating git commits, writing commit messages, or the user mentions "commit", "git commit", or wants to save changes. Use when this capability is needed.
metadata:
  author: elenatanasoiu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/elenatanasoiu) — claim your Tome and manage your conversions.
