---
name: start-work
description: Start new work on an issue with discovery, worktree/branch setup, TDD workflow, and draft PR creation. Use when beginning work on a GitHub issue. Use when this capability is needed.
metadata:
