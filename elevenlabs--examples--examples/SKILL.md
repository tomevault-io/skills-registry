...
description: Scaffold prompt-driven examples in this repository using the existing example patterns and repo skills in `.agents/skills`. Use when adding a new example directory, creating matching `README.md`, `PROMPT.md`, and `setup.sh` files, or preparing a new example for `pnpm run generate`. Use when this capability is needed.
metadata:
  author: elevenlabs
---
...
---
> Source: [elevenlabs/examples](https://github.com/elevenlabs/examples) — distributed by [TomeVault](https://tomevault.io).
