---
name: jj
description: Uses the jj (Jujutsu) version control system. Use when asked about jj commands, git push/fetch workflow, or rebasing onto main for non git repo Use when this capability is needed.
metadata:
  author: elianiva
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/elianiva) — claim your Tome and manage your conversions.
