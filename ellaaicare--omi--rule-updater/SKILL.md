---
name: rule-updater
description: Skill for programmatically reading, updating, and creating Cursor rules based on patterns and lessons learned Use when this capability is needed.
metadata:
  author: ellaaicare
---
...
---
> Source: [ellaaicare/omi](https://github.com/ellaaicare/omi) — distributed by [TomeVault](https://tomevault.io).
