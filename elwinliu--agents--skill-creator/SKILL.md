---
name: skill-creator
description: Guide for creating effective skills. This skill should be used when users want to create a new skill (or update an existing skill) that extends AI's capabilities with specialized knowledge, workflows, or tool integrations. Use when this capability is needed.
metadata:
  author: elwinliu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/elwinliu) — claim your Tome and manage your conversions.
