...
2. If deleted, check your own backups (the user's chosen backup location, if any — set up before running this migration)
...
---
> Source: [emanuelrechsteiner/claude-code-config](https://github.com/emanuelrechsteiner/claude-code-config) — distributed by [TomeVault](https://tomevault.io).
