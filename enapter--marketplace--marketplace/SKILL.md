...
description: Enapter Blueprint skill covering Lua script, manifest, profiles, publishing to Marketplace. Use for any Enapter Blueprint development task. Use when this capability is needed.
metadata:
  author: Enapter
---
...
---
> Source: [Enapter/marketplace](https://github.com/Enapter/marketplace) — distributed by [TomeVault](https://tomevault.io).
