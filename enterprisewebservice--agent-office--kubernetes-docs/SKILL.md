...
description: Search and read Kubernetes documentation in markdown format. Use when the user asks about Kubernetes concepts, tasks, API reference, kubectl, or any upstream k8s topic — including pods, deployments, services, RBAC, networking, storage, or scheduling. Use when this capability is needed.
metadata:
  author: enterprisewebservice
---
...
---
> Source: [enterprisewebservice/agent-office](https://github.com/enterprisewebservice/agent-office) — distributed by [TomeVault](https://tomevault.io).
