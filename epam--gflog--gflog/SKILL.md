---
name: gflog
description: Add or update logging statements using GFLog library. Use when creating new log statements, refactoring existing logging code (JUL/SLF4J), or when you see string concatenation in log statements. Use when this capability is needed.
metadata:
  author: epam
---
...
---
> Source: [epam/gflog](https://github.com/epam/gflog) — distributed by [TomeVault](https://tomevault.io).
