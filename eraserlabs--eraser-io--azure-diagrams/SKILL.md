---
name: azure-diagrams
description: Visualizes Azure infrastructure from ARM templates, Azure CLI, or descriptions. Use when user has Azure resources to diagram. Use when this capability is needed.
metadata:
  author: eraserlabs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/eraserlabs) — claim your Tome and manage your conversions.
