---
name: evtxecmd-maps
description: Understand, author, and validate EvtxECmd map files that normalize Windows event log EventData into first-class CSV/JSON columns. Use when this capability is needed.
metadata:
...
---
> Source: [EricZimmerman/evtx](https://github.com/EricZimmerman/evtx) — distributed by [TomeVault](https://tomevault.io).
