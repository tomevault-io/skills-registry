...
description: Reference for all Erigon network ports. Use this when running multiple Erigon instances to avoid port conflicts. Lists every CLI flag that binds a port, its default value, and the protocol used. Use when this capability is needed.
metadata:
  author: erigontech
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/erigontech) — claim your Tome and manage your conversions.
