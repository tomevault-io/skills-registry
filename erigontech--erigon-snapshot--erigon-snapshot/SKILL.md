...
description: Analyze snapshot automation PR changes and produce a structured review report. Use when asked to summarize or review a snapshot PR. Use when this capability is needed.
metadata:
  author: erigontech
---
...
---
> Source: [erigontech/erigon-snapshot](https://github.com/erigontech/erigon-snapshot) — distributed by [TomeVault](https://tomevault.io).
