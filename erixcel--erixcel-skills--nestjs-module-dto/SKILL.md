...
description: patterns for creating DTOs with Swagger documentation, Class Validator, and Type Safety (Create, Update, List, Result). Use when this capability is needed.
metadata:
  author: erixcel
---
...
export class UserCreateDto implements Omit<
  UserDTO,
  "id" | "createdAt" | "updatedAt" | "deletedAt" | "fullName" | "isActive"
> {
  @ApiProperty({
