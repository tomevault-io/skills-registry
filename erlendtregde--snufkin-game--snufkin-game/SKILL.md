---
name: snufkin-game
description: Project-specific architecture and patterns for the Snufkin game. Use when working on this specific Godot project involving player movement, scene transitions (house interior, fishing scene, main world, map navigation), NPC dialogue system, interaction zones, global state management, particle effects (falling leaves, wind gusts), fishing mechanics, main menu system, map-based travel system, or UI systems specific to this game. Use when this capability is needed.
metadata:
  author: erlendtregde
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/erlendtregde) — claim your Tome and manage your conversions.
