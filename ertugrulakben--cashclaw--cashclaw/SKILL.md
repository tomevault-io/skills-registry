...
description: Performs competitor research and generates detailed analysis reports with market positioning insights. Covers feature comparison, pricing analysis, SWOT, and strategic recommendations. Use when this capability is needed.
metadata:
...
---
> Source: [ertugrulakben/cashclaw](https://github.com/ertugrulakben/cashclaw) — distributed by [TomeVault](https://tomevault.io).
