---
name: skill-loader
description: Load and install skills from external GitHub repositories. Manages skill sources and keeps local skills up-to-date. Use when this capability is needed.
metadata:
  author: escotilha
---
