---
name: go-practices
description: Go conventions for hexagonal architecture, project structure, error handling, testing, and observability. Use when writing Go services. Use when this capability is needed.
metadata:
  author: eser
---
