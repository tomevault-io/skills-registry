...
description: Development tooling standards including Deno runtime, JSR package registry, and configuration files. Use when setting up projects, managing dependencies, or configuring build tools. Use when this capability is needed.
metadata:
  author: eser
---
