...
description: JS/TS conventions for syntax, modules, and types. Use when writing or reviewing JavaScript/TypeScript code. Use when this capability is needed.
metadata:
  author: eser
---
