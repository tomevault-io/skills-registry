...
**skill_path**
- {project_path}/skills/deep-research
---
...
**All modes execute:**
- Phase 1: SCOPE - Define boundaries ([method]({skill_path}/reference/methodology.md#phase-1-scope))
- Phase 3: RETRIEVE - Parallel search execution (5-10 concurrent searches + agents) ([method]({skill_path}/reference/methodology.md#phase-3-retrieve---parallel-information-gathering))
- Phase 8: PACKAGE - Generate report using [template]({skill_path}/templates/report_template.md)

**Standard/Deep/UltraDeep execute:**
- Phase 2: PLAN - Strategy formulation
- Phase 4: TRIANGULATE - Verify 3+ sources per claim
- Phase 4.5: OUTLINE REFINEMENT - Adapt structure based on evidence (WebWeaver 2025) ([method]({skill_path}/reference/methodology.md#phase-45-outline-refinement---dynamic-evolution-webweaver-2025))
...
- Load [methodology]({skill_path}/reference/methodology.md) sections on-demand
- Load [template]({skill_path}/templates/report_template.md) only for Phase 8
...
- ALWAYS create dedicated folder: `{project_path}/Documents/[TopicName]_Research_[YYYYMMDD]/`
- Extract clean topic name from research question (remove special chars, use underscores/CamelCase)
- Examples:
  - "psilocybin research 2025" → `{project_path}/Documents/Psilocybin_Research_20251104/`
  - "compare React vs Vue" → `{project_path}/Documents/React_vs_Vue_Research_20251104/`
  - "AI safety trends" → `{project_path}/Documents/AI_Safety_Trends_Research_20251104/`
...
- Also save copy to: `{project_path}/research_output/` (internal tracking)
...
- Use McKinsey template: [mckinsey_template]({skill_path}/templates/mckinsey_report_template.html)
...
- Use [template]({skill_path}/templates/report_template.md) as exact structure
...
2. Organized folder path (e.g., "All files saved to: {project_path}/Documents/Psilocybin_Research_20251104/")
...
**OUTPUT TOKEN LIMIT SAFEGUARD (CRITICAL - GLM Code Default: 32K):**

GLM Code default limit: 32,000 output tokens (≈24,000 words total per skill execution)
...
- User manually combines or asks GLM to merge files
...
- Save copy to {project_path}/research_output/
- Done! ✓

**If total output will exceed 18,000 words:** Auto-Continuation Protocol

**Step 1: Save Continuation State**
Create file: `{project_path}/research_output/continuation_state_[report_id].json`
...
1. Read McKinsey template from `{skill_path}/templates/mckinsey_report_template.html`
...
**Format:** Comprehensive markdown report following [template]({skill_path}/templates/report_template.md) EXACTLY
...
- [Complete Methodology]({skill_path}/reference/methodology.md) - 8-phase details
- [Report Template]({skill_path}/templates/report_template.md) - Output structure
- [README]({skill_path}/README.md) - Usage docs
- [Quick Start]({skill_path}/QUICK_START.md) - Fast reference
- [Competitive Analysis]({skill_path}/COMPETITIVE_ANALYSIS.md) - vs OpenAI/Gemini
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/eskonbg) — claim your Tome and manage your conversions.
