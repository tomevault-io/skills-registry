...
description: Esposter Vue 3 component architecture patterns — generic components, type correctness, co-location, file length, and slot extraction. Apply when designing or refactoring Vue components. Use when this capability is needed.
metadata:
  author: Esposter
---
