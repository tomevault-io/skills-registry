...
> **💡 Prompt Engineering**: MCP tool descriptions and schemas are prompts that guide AI behavior. Consider loading the `prompt-engineering` skill for best practices on writing clear tool descriptions, effective parameter descriptions, and actionable error messages.
