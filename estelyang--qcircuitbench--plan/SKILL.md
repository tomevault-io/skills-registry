---
name: plan
description: Generate a plan for how an agent should accomplish a complex coding task. Use when a user asks for a plan, and optionally when they want to save, find, read, update, or delete plan files in $CODEX_HOME/plans (default ~/.codex/plans). Use when this capability is needed.
metadata:
  author: estelyang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/estelyang) — claim your Tome and manage your conversions.
