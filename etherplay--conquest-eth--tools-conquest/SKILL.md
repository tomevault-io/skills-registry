---
name: tools-conquest
description: Interact with Conquest.eth, a persistent game of diplomacy, using the conquest CLI. Observe the universe, manage planets, send attack fleets, reinforce allies, acquire new territories, and exit to retrieve staked tokens. Use when this capability is needed.
metadata:
  author: etherplay
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/etherplay) — claim your Tome and manage your conversions.
