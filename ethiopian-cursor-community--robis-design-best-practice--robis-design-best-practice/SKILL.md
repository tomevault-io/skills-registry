...
description: Apply Robi's UI design principles for beautiful, accessible interfaces. Use when building UI components, reviewing designs, choosing colors, setting spacing, or implementing animations. Covers color theory (HSL, WCAG, halation), spacing (4px system), icons, shadows, and micro-interactions. Use when this capability is needed.
metadata:
  author: ethiopian-cursor-community
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ethiopian-cursor-community) — claim your Tome and manage your conversions.
