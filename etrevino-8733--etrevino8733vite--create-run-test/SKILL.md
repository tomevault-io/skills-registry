...
description: Empowers the agent to create files, run projects, build projects, and run tests. Use when the user asks to create files, add features, run the dev server, build, or test. Apply when uncertainty about these capabilities might block progress. Use when this capability is needed.
metadata:
  author: etrevino-8733
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/etrevino-8733) — claim your Tome and manage your conversions.
