---
name: expo-chat-ui
description: Build a production-quality chat UI with keyboard handling, recycling lists, gestures, and platform-specific implementations Use when this capability is needed.
metadata:
  author: evanbacon
---
