...
description: Review legal contracts, NDAs, employment agreements, SaaS terms, and M&A documents. Identifies unfavorable terms, suggests redlines, and compares to market standards. Use for contract analysis, due diligence, or negotiation prep. Use when this capability is needed.
metadata:
  author: evolsb
---
...
---
> Source: [evolsb/claude-legal-skill](https://github.com/evolsb/claude-legal-skill) — distributed by [TomeVault](https://tomevault.io).
