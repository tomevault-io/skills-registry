---
name: search
description: Deep research powered by Exa. Use for lead generation, literature reviews, deep dives, competitive analysis, or any query where one search falls short, including phrases like 'research this', 'find everything about', 'find me all', or 'deep dive on'. Use when this capability is needed.
metadata:
  author: exa-labs
---
...
---
> Source: [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) — distributed by [TomeVault](https://tomevault.io).
