---
name: fix
description: Fix a GitHub issue end-to-end — fetches issue, creates worktree, plans and implements fix, runs validation, opens PR, cleans up. Use when this capability is needed.
metadata:
  author: exercism
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/exercism) — claim your Tome and manage your conversions.
