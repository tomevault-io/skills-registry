...
description: Essential exploitation payloads: anti-virus test files, file name exploits, malicious files. Curated for testing. Use when this capability is needed.
metadata:
  author: eyadkelleh
---
