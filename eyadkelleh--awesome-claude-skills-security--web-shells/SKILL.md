...
description: Web shell samples for detection and analysis: PHP, ASP, ASPX, JSP, Python, Perl shells. Use for security research and detection system testing. Use when this capability is needed.
metadata:
  author: eyadkelleh
---
