...
description: Generate Go code from ezorm YAML (mysql/mysqlr). Prefer mysqlr unless the user explicitly asks for mysql. Provide the exact ezorm CLI command(s). Use when this capability is needed.
metadata:
  author: ezbuy
---
