...
description: Write ezorm YAML schema files for this repo (mysql/mysqlr). Prefer mysqlr unless the user explicitly asks for mysql. Output YAML only (no Go code). Use when this capability is needed.
metadata:
  author: ezbuy
---
