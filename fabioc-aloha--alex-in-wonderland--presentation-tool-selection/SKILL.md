...
description: Best practice decision matrix for choosing between Marp, Gamma, and PptxGenJS based on use case requirements. Use when this capability is needed.
metadata:
  author: fabioc-aloha
---
