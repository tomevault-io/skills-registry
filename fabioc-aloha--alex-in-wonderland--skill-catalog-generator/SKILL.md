...
description: Generate dynamic skill catalogs with network diagrams to visualize Alex's capabilities and track learning progress. Use when this capability is needed.
metadata:
  author: fabioc-aloha
---
