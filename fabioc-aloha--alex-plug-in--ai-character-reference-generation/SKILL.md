...
description: Generate consistent visual character references across multiple scenarios using Flux and nano-banana-pro on Replicate Use when this capability is needed.
metadata:
  author: fabioc-aloha
---
