...
description: Detect user frustration from conversational signals and respond with empathy, de-escalation, and practical support. Use when this capability is needed.
metadata:
  author: fabioc-aloha
---
