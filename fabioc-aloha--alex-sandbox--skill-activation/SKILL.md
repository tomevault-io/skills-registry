...
description: Internal metacognitive skill for automatic capability discovery — self-triggers when uncertain about available skills Use when this capability is needed.
metadata:
  author: fabioc-aloha
---
