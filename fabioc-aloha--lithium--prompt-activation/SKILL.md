...
description: Internal metacognitive skill for episodic memory retrieval cues — surfaces relevant workflows when needed Use when this capability is needed.
metadata:
  author: fabioc-aloha
---
