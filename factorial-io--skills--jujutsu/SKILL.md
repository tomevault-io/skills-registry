---
name: jujutsu
description: This document instructs Claude Code to use `jj` (Jujutsu) instead of `git` for version control operations. jj is a Git-compatible VCS that provides a simpler mental model and powerful history editing. Use when this capability is needed.
metadata:
  author: factorial-io
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/factorial-io) — claim your Tome and manage your conversions.
