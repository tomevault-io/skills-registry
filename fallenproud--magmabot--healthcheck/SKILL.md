---
name: healthcheck
description: Host security hardening and risk-tolerance configuration for MagmaBot deployments. Use when a user asks for security audits, firewall/SSH/update hardening, risk posture, exposure review, MagmaBot cron scheduling for periodic checks, or version status checks on a machine running MagmaBot (laptop, workstation, Pi, VPS). Use when this capability is needed.
metadata:
  author: fallenproud
---
