...
description: Automatically detect and fix documentation inconsistencies, outdated examples, and missing @file headers in the u-he-preset-randomizer project. Triggers when documentation appears outdated or when making significant code changes that affect public APIs. Use when this capability is needed.
metadata:
  author: Fannon
---
...
---
> Source: [Fannon/u-he-preset-randomizer](https://github.com/Fannon/u-he-preset-randomizer) — distributed by [TomeVault](https://tomevault.io).
