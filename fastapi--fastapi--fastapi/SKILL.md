---
name: fastapi
description: FastAPI best practices and conventions. Use when working with FastAPI APIs, Pydantic models, dependencies, streaming responses including Server-Sent Events (SSE), and serving frontend apps. Keeps FastAPI code clean and up to date with the latest features and patterns. Use when this capability is needed.
metadata:
  author: fastapi
---
...
---
> Source: [fastapi/fastapi](https://github.com/fastapi/fastapi) — distributed by [TomeVault](https://tomevault.io).
