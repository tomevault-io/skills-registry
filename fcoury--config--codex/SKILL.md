---
name: codex
description: Second opinion from Codex model. Use when reviewing plans, double-checking approaches, debugging hard problems, or finding edge cases. Use when this capability is needed.
metadata:
  author: fcoury
---
