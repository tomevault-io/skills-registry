...
description: Design and improve Ratatui TUI applications with modern, polished aesthetics. Use when creating terminal apps, improving TUI look and feel, designing layouts, or working with Ratatui components in Rust. Use when this capability is needed.
metadata:
  author: fcoury
---
