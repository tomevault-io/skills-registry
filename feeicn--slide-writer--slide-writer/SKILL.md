---
name: slide-writer
description: 把想法、大纲、文档或草稿变成结构清晰、设计精良的企业级 HTML 演示文稿。 Use when this capability is needed.
metadata:
  author: FeeiCN
---
...
---
> Source: [FeeiCN/slide-writer](https://github.com/FeeiCN/slide-writer) — distributed by [TomeVault](https://tomevault.io).
