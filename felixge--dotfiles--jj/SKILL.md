---
name: jj
description: Use the jj version control system. Always use this instead of git for all version control operations including commits, diffs, logs, branches, rebasing, pushing, pulling, and any other VCS tasks. Use when this capability is needed.
metadata:
  author: felixge
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/felixge) — claim your Tome and manage your conversions.
