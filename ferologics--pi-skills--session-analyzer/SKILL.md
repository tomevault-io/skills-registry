...
description: Analyze pi session transcripts to discover patterns that could become AGENTS.md rules, skills, or prompt templates. Mines your usage history for automation opportunities. Use when this capability is needed.
metadata:
  author: ferologics
---
