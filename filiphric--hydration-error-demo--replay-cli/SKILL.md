---
name: replay-cli
description: Record your application to gather performance data and debug issues. It enables users to install Replay ClI, record a session, upload and manage them. Use when this capability is needed.
metadata:
  author: filiphric
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/filiphric) — claim your Tome and manage your conversions.
