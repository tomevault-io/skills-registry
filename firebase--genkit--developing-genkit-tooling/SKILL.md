...
description: Best practices for authoring Genkit tooling, including CLI commands and MCP server tools. Covers naming conventions, architectural patterns, and consistency guidelines. Use when this capability is needed.
metadata:
  author: firebase
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/firebase) — claim your Tome and manage your conversions.
