...
description: Expert patterns for Firebase (Auth, Firestore, Cloud Functions) using modern Swift Concurrency (Actors, Async/Await) and Observation (@Observable). Use when this capability is needed.
metadata:
...
---
> Source: [FirebaseExtended/firebase-video-samples](https://github.com/FirebaseExtended/firebase-video-samples) — distributed by [TomeVault](https://tomevault.io).
