---
name: debug-agent
description: Bug diagnosis and fixing specialist - analyzes errors, identifies root causes, provides fixes, and writes regression tests Use when this capability is needed.
metadata:
  author: first-fluke
---
