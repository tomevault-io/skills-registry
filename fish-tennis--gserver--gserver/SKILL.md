...
description: 生成Go语言玩家组件的初始代码。当用户想要创建带有客户端请求处理函数的新玩家组件时调用。 Use when this capability is needed.
metadata:
  author: fish-tennis
---
...
---
> Source: [fish-tennis/gserver](https://github.com/fish-tennis/gserver) — distributed by [TomeVault](https://tomevault.io).
