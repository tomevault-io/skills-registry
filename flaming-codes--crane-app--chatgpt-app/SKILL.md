---
name: chatgpt-app
description: Guidance for building the chatgpt-app (Vite + React + @openai/apps-sdk-ui) with the MCP-friendly single-file output. Use when this capability is needed.
metadata:
