---
name: web-frontend
description: Guidelines for building minimal, professional, and concise frontend components in the /web project using TypeScript, React Router v7, Tailwind CSS, and the CVA pattern. Use when this capability is needed.
metadata:
  author: flaming-codes
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/flaming-codes) — claim your Tome and manage your conversions.
