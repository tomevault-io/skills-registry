...
description: Generate a Product Requirements Document (PRD) for rube-goldberg-tui task orchestration. Creates PRDs with user stories that can be converted to beads issues or prd.json for automated execution. Triggers on: create a prd, write prd for, plan this feature, requirements for, spec out. Use when this capability is needed.
metadata:
  author: flatfinderai-cyber
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/flatfinderai-cyber) — claim your Tome and manage your conversions.
