---
name: code-review
description: Review a defined git-backed change set for bugs, regressions, missing requirements, and test gaps before merge. Use when this capability is needed.
metadata:
  author: flc1125
---
...
---
> Source: [flc1125/skills](https://github.com/flc1125/skills) — distributed by [TomeVault](https://tomevault.io).
