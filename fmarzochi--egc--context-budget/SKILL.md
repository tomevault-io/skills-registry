---
name: context-budget
description: Audits Gemini Code context window consumption across agents, skills, MCP servers, and rules. Identifies bloat, redundant components, and produces prioritized token-savings recommendations. Use when this capability is needed.
metadata:
  author: Fmarzochi
---
