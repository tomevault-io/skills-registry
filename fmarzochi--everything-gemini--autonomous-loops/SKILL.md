...
description: Patterns and architectures for autonomous Gemini Code loops: from simple sequential pipelines to RFC-driven multi-agent DAG systems. Use when this capability is needed.
metadata:
  author: Fmarzochi
---
