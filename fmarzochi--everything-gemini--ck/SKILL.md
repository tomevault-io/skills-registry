---
name: ck
description: Persistent per-project memory for Gemini Code. Auto-loads project context on session start, tracks sessions with git activity, and writes to native memory. Commands run deterministic Node.js scripts: behavior is consistent across model versions. Use when this capability is needed.
metadata:
  author: Fmarzochi
---
