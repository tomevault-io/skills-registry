...
description: Guide to transform prototypes into robust, distributable Python packages using the src layout, hybrid paradigm, and strict configuration management. Use when this capability is needed.
metadata:
  author: fmind
---
