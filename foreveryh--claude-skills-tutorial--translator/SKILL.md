---
name: translator
description: Professional translation using Claude's native capabilities. Use this skill when the user needs to translate text between languages with high quality, or when content needs to be localized for different language audiences. Use when this capability is needed.
metadata:
  author: foreveryh
---
