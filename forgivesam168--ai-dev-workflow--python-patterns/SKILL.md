...
description: Pythonic idioms, PEP 8 standards, type hints, pytest testing strategies, TDD methodology, and best practices for building robust Python applications. Use when this capability is needed.
metadata:
...
- Use `print` in tests (use assertions)
