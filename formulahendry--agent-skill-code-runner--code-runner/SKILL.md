---
name: code-runner
description: This skill enables you to run code snippets in multiple programming languages directly from the command line. Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/formulahendry) — claim your Tome and manage your conversions.
