...
description: Execute and generate Jest tests for JavaScript/TypeScript projects with support for unit, integration, and E2E testing Use when this capability is needed.
metadata:
