...
description: Guides through npm package updates including minor/patch updates and major version updates. Use when user wants to update npm dependencies, handle breaking changes, manage package versions, or run npm outdated/update commands. Use when this capability is needed.
metadata:
  author: forumone
---
