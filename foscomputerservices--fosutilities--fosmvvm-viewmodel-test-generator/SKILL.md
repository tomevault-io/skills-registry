...
description: Generate ViewModel tests with codable round-trip, versioning stability, and multi-locale translation verification. Use when this capability is needed.
metadata:
