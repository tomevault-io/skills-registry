...
description: Generate new Claude Code skills following the context-aware pattern. Scaffolds SKILL.md, reference docs, and frontmatter. Use when this capability is needed.
metadata:
