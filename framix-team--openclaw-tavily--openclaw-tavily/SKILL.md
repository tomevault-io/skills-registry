---
name: tavily-search
description: Web search, extraction, crawling, mapping, and deep research via Tavily API. Five tools for finding information, extracting content, exploring websites, and generating research reports. Use when this capability is needed.
metadata:
  author: framix-team
---
...
---
> Source: [framix-team/openclaw-tavily](https://github.com/framix-team/openclaw-tavily) — distributed by [TomeVault](https://tomevault.io).
