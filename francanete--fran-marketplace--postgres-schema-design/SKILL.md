...
description: Comprehensive PostgreSQL-specific table design reference covering data types, indexing, constraints, performance patterns, and advanced features. Use when designing database schemas, creating tables, or reviewing database structure. Use when this capability is needed.
metadata:
  author: francanete
---
