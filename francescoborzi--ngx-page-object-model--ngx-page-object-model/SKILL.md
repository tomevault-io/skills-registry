...
description: MUST invoke before creating or editing any Angular component's tests (spec file). Enforces the Page Object Model pattern – tests drive components through the rendered DOM (their public contract) rather than reaching into component internals. Use when this capability is needed.
metadata:
  author: FrancescoBorzi
---
