...
description: Develops Inertia.js v3 Vue client-side applications. Activates when creating Vue pages, forms, or navigation; using <Link>, <Form>, useForm, useHttp, setLayoutProps, or router; working with deferred props, prefetching, optimistic updates, instant visits, or polling; or when user mentions Vue with Inertia, Vue pages, Vue forms, or Vue navigation. Use when this capability is needed.
metadata:
  author: francoism90
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/francoism90) — claim your Tome and manage your conversions.
