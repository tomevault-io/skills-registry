...
description: 通用图片生成 Skill，支持多种 AI 模型（ModelScope、Gemini 等），可被其他 Skills 调用 Use when this capability is needed.
metadata:
  author: frank-syncmarket
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/frank-syncmarket) — claim your Tome and manage your conversions.
