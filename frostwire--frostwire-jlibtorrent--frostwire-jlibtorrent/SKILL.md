...
description: End-to-end workflow for upgrading the underlying libtorrent C++ library in the frostwire-jlibtorrent Java/JNI bindings project. This skill covers the full lifecycle from version bump through SWIG regeneration, Java wrapper additions, native builds across all platforms, testing, and release. Use when this capability is needed.
metadata:
  author: frostwire
---
...
---
> Source: [frostwire/frostwire-jlibtorrent](https://github.com/frostwire/frostwire-jlibtorrent) — distributed by [TomeVault](https://tomevault.io).
