---
name: agmsg
description: Cross-agent messaging via SQLite. Send messages between Claude Code, Codex, Gemini CLI, GitHub Copilot CLI, and other agents. No daemon, no network, no dependencies beyond bash and sqlite3. Use when this capability is needed.
metadata:
  author: fujibee
---
...
---
> Source: [fujibee/agmsg](https://github.com/fujibee/agmsg) — distributed by [TomeVault](https://tomevault.io).
