---
name: jimeng-api
description: Generate images using the Jimeng API based on text prompts. Use this skill when users request AI-generated images from the Jimeng (即梦AI) service, artwork, illustrations, or visual content creation. Supports text-to-image and image-to-image generation with customizable ratios and resolutions. Use when this capability is needed.
metadata:
  author: fuliangtuan
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/fuliangtuan) — claim your Tome and manage your conversions.
