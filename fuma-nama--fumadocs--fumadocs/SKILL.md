...
description: Keep packages/radix-ui (fumadocs-ui) and packages/base-ui in sync. Use when editing either package, adding features, or fixing bugs so both UI variants stay consistent. Use when this capability is needed.
metadata:
  author: fuma-nama
---
...
---
> Source: [fuma-nama/fumadocs](https://github.com/fuma-nama/fumadocs) — distributed by [TomeVault](https://tomevault.io).
