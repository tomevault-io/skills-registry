---
name: git-workflow
description: Git version control including branching strategies, interactive rebase, bisect, hooks, conflict resolution, and monorepo workflows. Trigger for git branching questions, merge conflicts, rebase strategies, or git workflow design. Use when this capability is needed.
metadata:
  author: FutureJJ
---
