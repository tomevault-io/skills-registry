...
```bash
SOCKET_DIR="${TMUX_SOCKET_DIR:-${TMPDIR:-/tmp}/agent-tmux-sockets}"
mkdir -p "$SOCKET_DIR"
...
- Use `TMUX_SOCKET_DIR` env var to override the default socket directory.
- Default socket path: `"$TMUX_SOCKET_DIR/agent.sock"`.
