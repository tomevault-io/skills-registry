---
name: ci
description: Diagnoses and fixes CI failures and re-runs GitHub Actions jobs. Use when CI is failing, tests break in CI, lint errors block merging, a build fails, or jobs need re-running. Use when this capability is needed.
metadata:
  author: gadget-inc
---
