---
name: plan
description: Plan lifecycle management for Codex plans stored in $CODEX_HOME/plans (default ~/.codex/plans). Use when a user asks to create, find, read, update, delete, or manage plan documents for implementation work or overview/reference documentation. Use when this capability is needed.
metadata:
  author: gakonst
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gakonst) — claim your Tome and manage your conversions.
