---
name: web
description: Use to browse or verify external info—run web searches, open pages, drive Chrome via CDP tools, and cite sources when facts may be outdated, niche, or user-requested. Use when this capability is needed.
metadata:
  author: gakonst
---
