...
description: > 会话上下文管理器 - 智能保存、管理和恢复 Claude Code 会话上下文 Use when this capability is needed.
metadata:
  author: gaoziman
---
...
---
> Source: [gaoziman/claude-context-manager](https://github.com/gaoziman/claude-context-manager) — distributed by [TomeVault](https://tomevault.io).
