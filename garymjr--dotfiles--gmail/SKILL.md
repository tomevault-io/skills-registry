---
name: gmail
description: Manage Gmail emails - list, read, archive, trash, and label emails using the Gmail API. Use when user asks to check emails, read messages, organize inbox, or manage email labels. Use when this capability is needed.
metadata:
  author: garymjr
---
