...
```
Which framework?
├─ I want full control, maximum performance, no framework overhead └─ core/ (imperative API)
├─ I know React, want familiar component patterns └─ react/ (React reconciler)
├─ I want fine-grained reactivity, optimal re-renders └─ solid/ (Solid reconciler)
