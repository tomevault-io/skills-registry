---
name: review
description: Code review skill. Use when reviewing changes, commits, branches, or pull requests. Focuses on bugs, structure, performance with actionable feedback. Use when this capability is needed.
metadata:
  author: garymjr
---
