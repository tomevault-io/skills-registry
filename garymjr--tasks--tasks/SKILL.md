---
name: tasks-cli
description: Local-first tasks CLI for managing project work with dependencies, tags, priorities, and status. Use when adding, editing, or organizing tasks with the `tasks` command in a repo. Use when this capability is needed.
metadata:
  author: garymjr
---
