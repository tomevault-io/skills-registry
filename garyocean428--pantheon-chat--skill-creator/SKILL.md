---
name: skill-creator
description: Guide for creating effective skills. Use when creating a new skill or updating an existing skill that extends agent capabilities with specialized knowledge, workflows, or tool integrations. Works across Manus, Codex, Copilot, Windsurf, and Claude. Use when this capability is needed.
metadata:
  author: garyocean428
---
