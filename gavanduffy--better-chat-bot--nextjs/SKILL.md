---
name: nextjs
description: Use when: building Next.js 16 projects, or troubleshooting async params (Promise types), "use cache" directives, parallel route 404s (missing default.js), or proxy.ts CORS.
metadata:
  author: gavanduffy
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gavanduffy) — claim your Tome and manage your conversions.
