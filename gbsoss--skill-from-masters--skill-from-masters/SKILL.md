...
description: Extract methodologies from documents or examples to create executable skills Use when this capability is needed.
metadata:
  author: GBSOSS
---
...
---
> Source: [GBSOSS/skill-from-masters](https://github.com/GBSOSS/skill-from-masters) — distributed by [TomeVault](https://tomevault.io).
