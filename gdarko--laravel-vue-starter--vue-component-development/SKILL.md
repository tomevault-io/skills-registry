...
description: Activate when creating or modifying Vue 3 components, pages, layouts, stores, or services in the frontend. Covers component patterns, DaisyUI usage, icon system, toast notifications, drawer patterns, form handling, and the SPA routing/auth flow. Use when working in resources/app/. Use when this capability is needed.
metadata:
  author: gdarko
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gdarko) — claim your Tome and manage your conversions.
