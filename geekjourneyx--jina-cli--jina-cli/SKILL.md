---
name: jina-cli
description: Reads web content and searches the web using Jina AI Reader API. Use when extracting content from URLs, reading social media posts (X/Twitter), or web searching for current information. Use when this capability is needed.
metadata:
  author: geekjourneyx
---
