...
description: Use these skills to set up and optimize production-ready vector workloads by simply expressing your intent and performance requirements. Use when this capability is needed.
metadata:
...
---
> Source: [gemini-cli-extensions/cloud-sql-postgresql](https://github.com/gemini-cli-extensions/cloud-sql-postgresql) — distributed by [TomeVault](https://tomevault.io).
