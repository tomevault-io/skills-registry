...
description: アーキテクチャ設計書を作成するための詳細ガイドとテンプレート。アーキテクチャ設計時にのみ使用。 Use when this capability is needed.
metadata:
  author: generativeagents
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/generativeagents) — claim your Tome and manage your conversions.
