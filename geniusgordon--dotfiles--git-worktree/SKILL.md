---
name: git-worktree
description: Manage git bare repos with worktrees for parallel feature development and code review. Use when user mentions git worktrees, bare repos, parallel branch development, reviewing PRs in separate directories, or wants to work on multiple branches simultaneously without stashing. Use when this capability is needed.
metadata:
  author: geniusgordon
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/geniusgordon) — claim your Tome and manage your conversions.
