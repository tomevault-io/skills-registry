...
description: This skill should be used when the user asks to "create a component", "add a new component", "build a section", "scaffold a component", or when creating any new React component for the site. Use when this capability is needed.
metadata:
  author: gentryriggen
---
