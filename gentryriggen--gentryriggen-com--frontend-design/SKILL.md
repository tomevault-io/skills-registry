...
description: This skill should be used when the user asks to "style a component", "update the design", "change colors", "fix the layout", "add dark mode support", "make it responsive", "add an animation", or any UI/visual styling task. Use when this capability is needed.
metadata:
  author: gentryriggen
---
