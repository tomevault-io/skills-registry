---
name: page-creation
description: This skill should be used when the user asks to "add a page", "create a new page", "add a route", "create a new section of the site", or when adding new pages/routes to the website. Use when this capability is needed.
metadata:
  author: gentryriggen
---
