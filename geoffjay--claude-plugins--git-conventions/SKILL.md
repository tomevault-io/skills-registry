...
description: Git conventions and workflow best practices including Conventional Commits, branch naming, and commit message guidelines. Use when user needs guidance on git standards, commit formats, or workflow patterns. Use when this capability is needed.
metadata:
  author: geoffjay
---
