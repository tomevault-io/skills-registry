...
description: 分析 Vue 前端项目的组件依赖关系，从入口文件开始递归分析所有组件，生成组件层级关系图。支持 Vue 2 和 Vue 3 项目，输出包含组件名称、文件路径和所需属性。使用当用户需要分析 Vue 组件结构、排查组件依赖关系或理解项目架构时。 Use when this capability is needed.
metadata:
...
---
> Source: [GeorgeDoors888/GB-Power-Market-JJ](https://github.com/GeorgeDoors888/GB-Power-Market-JJ) — distributed by [TomeVault](https://tomevault.io).
