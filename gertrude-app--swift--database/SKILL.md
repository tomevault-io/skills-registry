---
name: database
description: You have read-only access to the Gertrude PostgreSQL database for querying and analysis. Use when this capability is needed.
metadata:
  author: gertrude-app
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gertrude-app) — claim your Tome and manage your conversions.
