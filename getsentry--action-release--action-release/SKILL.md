---
name: triage-issue
description: Triage GitHub issues with codebase research and actionable recommendations Use when this capability is needed.
metadata:
  author: getsentry
---
...
---
> Source: [getsentry/action-release](https://github.com/getsentry/action-release) — distributed by [TomeVault](https://tomevault.io).
