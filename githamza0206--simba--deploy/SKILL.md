---
name: deploy
description: Deploy the Simba chat widget to a client website. Use when embedding the widget, connecting to Simba cloud or local, and configuring appearance. Use when this capability is needed.
metadata:
  author: githamza0206
---
