---
name: glean-cli
description: Glean CLI: access company knowledge, search documents, chat with Glean Assistant, look up people, and manage enterprise content. Use when the user asks about internal docs, company information, people, policies, or enterprise data. Use when this capability is needed.
metadata:
  author: gleanwork
---
