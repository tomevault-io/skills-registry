---
name: doctorg
description: Evidence-based health research using tiered trusted sources with GRADE-inspired evidence ratings. Integrates Apple Health data for personalized context. Use when user asks health, nutrition, exercise, sleep, or wellness questions. Use when this capability is needed.
metadata:
  author: glebis
---
