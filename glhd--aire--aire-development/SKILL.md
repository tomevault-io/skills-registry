...
description: Build and work with Aire forms in Laravel, including the fluent PHP API, data binding, validation, and customization. Use when this capability is needed.
metadata:
  author: glhd
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/glhd) — claim your Tome and manage your conversions.
