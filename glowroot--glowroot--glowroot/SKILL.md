---
name: update-grpc
description: Procedure to update gRPC, Netty, and BoringSSL versions in this Java/Maven project while maintaining compatibility Use when this capability is needed.
metadata:
  author: glowroot
---
...
---
> Source: [glowroot/glowroot](https://github.com/glowroot/glowroot) — distributed by [TomeVault](https://tomevault.io).
