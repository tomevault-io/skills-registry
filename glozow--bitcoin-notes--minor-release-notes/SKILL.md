...
description: Automatically generate minor release notes based on the PRs merged into this branch since the last version. Use when this capability is needed.
metadata:
  author: glozow
---
