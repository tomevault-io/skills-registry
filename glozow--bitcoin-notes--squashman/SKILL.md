...
description: Split staged changes or HEAD commit into `fixup!` commits that target the appropriate previous commits in the current branch. Use when this capability is needed.
metadata:
  author: glozow
---
# Git Smart Fixup
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/glozow) — claim your Tome and manage your conversions.
