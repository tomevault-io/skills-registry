---
name: flow-next-deps
description: Show epic dependency graph and execution order. Use when asking 'what's blocking what', 'execution order', 'dependency graph', 'what order should epics run', 'critical path', 'which epics can run in parallel'. Use when this capability is needed.
metadata:
  author: gmickel
---
