...
description: Epic completion review - verifies all epic tasks implement spec requirements. Triggers on /flow-next:epic-review. Use when this capability is needed.
metadata:
  author: gmickel
---
