...
description: Integrate Resend email service via MCP protocol for AI agents to send emails with Claude Desktop, GitHub Copilot, and Cursor. Set up transactional and marketing emails, configure sender verification, and use AI to automate email workflows. Use when this capability is needed.
metadata:
  author: gocallum
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gocallum) — claim your Tome and manage your conversions.
