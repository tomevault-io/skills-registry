...
description: Build WhatsApp automations with Kapso workflows: configure WhatsApp triggers, edit workflow graphs, manage executions, deploy functions, and use databases/integrations for state. Use when automating WhatsApp conversations and event handling. Use when this capability is needed.
metadata:
  author: gokapso
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gokapso) — claim your Tome and manage your conversions.
