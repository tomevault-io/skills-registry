...
description: Implement comprehensive error handling for the current code to make it robust and resilient ...; keywords: error. Use only on explicit request; skip in routine implementation discussions. Use when this capability is needed.
metadata:
  author: gologo13
---
