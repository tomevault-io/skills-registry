---
name: diagrams
description: Analyze the provided code, architecture, or concept and generate a clear, well-structured Me...; keywords: mermaid, diagram, git, api. Use only on explicit request; skip in routine implementation discussions. Use when this capability is needed.
metadata:
  author: gologo13
---
