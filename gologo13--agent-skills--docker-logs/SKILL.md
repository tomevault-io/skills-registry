---
name: docker-logs
description: Tail logs from Docker containers to check for errors and monitor application behavior; keywords: docker, error. Use only on explicit request; skip in routine implementation discussions. Use when this capability is needed.
metadata:
  author: gologo13
---
