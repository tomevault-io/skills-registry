...
description: Perform a quick quality pass on current diffs to surface risky areas, ensure polish, and fla...; keywords: debug, review, test, fix. Use only on explicit request; skip in routine implementation discussions. Use when this capability is needed.
metadata:
  author: gologo13
---
