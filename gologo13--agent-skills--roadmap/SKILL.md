---
name: roadmap
description: Analyze the codebase and generate a visual roadmap of potential features and improvements; keywords: mermaid, diagram, performance, roadmap. Use only on explicit request; skip in routine implementation discussions. Use when this capability is needed.
metadata:
  author: gologo13
---
