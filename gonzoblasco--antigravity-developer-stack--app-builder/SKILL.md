---
name: app-builder
description: Use cuando el usuario quiera crear una nueva aplicación, necesite scaffolding de proyecto, determinar tech stack, o construir algo desde cero. Keywords: nueva app, crear proyecto, scaffolding, full-stack, tech stack, boilerplate, from scratch. Use when this capability is needed.
metadata:
  author: gonzoblasco
---
