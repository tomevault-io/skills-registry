...
description: Release a new r-shell version and draft a GitHub release. Use when: releasing, publishing, bumping version, tagging, drafting release, creating release notes, gh release create, version bump, patch release, minor release, major release. Use when this capability is needed.
metadata:
  author: GOODBOY008
---
