...
description: MANDATORY: Use this skill for ANY and ALL tasks involving building Skia with GN, Ninja, or compiling any Skia tool. It is the authoritative source for Skia's build workflows and MUST be used whenever compilation is required. Use when this capability is needed.
metadata:
  author: google
---
...
---
> Source: [google/skia](https://github.com/google/skia) — distributed by [TomeVault](https://tomevault.io).
