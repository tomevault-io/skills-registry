...
description: Set up a repository for local GitHub Actions verification using act, so Jules can validate CI before pushing Use when this capability is needed.
metadata:
...
---
> Source: [google-labs-code/jules-skills](https://github.com/google-labs-code/jules-skills) — distributed by [TomeVault](https://tomevault.io).
