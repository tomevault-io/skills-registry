...
description: Design the domain model for the Stitch SDK. Use when mapping MCP tools to domain classes and bindings in domain-map.json. This is Stage 2 of the generation pipeline. Use when this capability is needed.
metadata:
...
---
> Source: [google-labs-code/stitch-sdk](https://github.com/google-labs-code/stitch-sdk) — distributed by [TomeVault](https://tomevault.io).
