---
name: go-backend-dev
description: Specialist in implementing robust HTTP services and APIs in Go. Activates for "endpoint", "handler", "API", "server". Use when this capability is needed.
metadata:
