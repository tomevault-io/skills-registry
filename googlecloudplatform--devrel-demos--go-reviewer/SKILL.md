---
name: go-reviewer
description: Expert code reviewer focusing on idiomatic Go, concurrency safety, and clean code principles. Activates for "review", "idiomatic", "refactor". Use when this capability is needed.
metadata:
