---
name: go-test-expert
description: Expert in Go testing patterns, table-driven tests, httptest, benchmarking, and fuzzing. Activates for "test", "fail", "benchmark", "debug", "fuzz". Use when this capability is needed.
metadata:
