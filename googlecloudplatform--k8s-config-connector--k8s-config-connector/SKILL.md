...
description: This skill provides a structured workflow for matching the mock {service}{resource} behaviour with the real GCP. Use when this capability is needed.
metadata:
