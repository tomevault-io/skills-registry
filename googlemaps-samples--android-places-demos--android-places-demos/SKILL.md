---
name: places-android
description: Guide for integrating the Places SDK for Android into an application. Use when users ask to add Places, autocomplete, place details, or search for places. Use when this capability is needed.
metadata:
  author: googlemaps-samples
---
...
---
> Source: [googlemaps-samples/android-places-demos](https://github.com/googlemaps-samples/android-places-demos) — distributed by [TomeVault](https://tomevault.io).
