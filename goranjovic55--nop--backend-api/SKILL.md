---
name: backend-api
description: FastAPI, async SQLAlchemy, WebSocket, Authentication, and Database patterns. Load when editing Python files in backend/, api/, routes/, services/, models/. Use when this capability is needed.
metadata:
  author: goranjovic55
---
