---
name: frontend-react
description: React, TypeScript, Zustand state management, and WebSocket client patterns. Load when editing .tsx, .jsx files or working in components/, pages/, store/, hooks/. Use when this capability is needed.
metadata:
  author: goranjovic55
---
