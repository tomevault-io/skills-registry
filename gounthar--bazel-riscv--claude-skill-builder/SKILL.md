...
description: Interactive skill creator for Claude Code. Triggers when user mentions creating skills, building skills, skill templates, skill frontmatter, allowed-tools, or wants to scaffold a new skill. Use when this capability is needed.
metadata:
  author: gounthar
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gounthar) — claim your Tome and manage your conversions.
