---
name: gpu-cli
description: Run ML training, LLM inference, and ComfyUI workflows on remote NVIDIA GPUs (A100, H100, RTX 4090). Cloud GPU compute with smart file sync — prefix any command with 'gpu' to run it remotely. Use when this capability is needed.
metadata:
  author: gpu-cli
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gpu-cli) — claim your Tome and manage your conversions.
