---
name: fix-issue
description: Systematically investigate and fix a GitHub Issue with root cause analysis. Use when user says "fix issue", "fix #123", "investigate bug", or provides a GitHub issue number. Follows reproduce-diagnose-fix-verify workflow. Use when this capability is needed.
metadata:
  author: gr1m0h
---
