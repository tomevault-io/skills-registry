---
name: parallel
description: Execute independent skills in parallel for faster results. Use when user says "run in parallel", "parallel skills", or pipes multiple skill names with "|". Integrates results after all skills complete. Use when this capability is needed.
metadata:
  author: gr1m0h
---
