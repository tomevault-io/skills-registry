...
description: Update Go version across the Tempo codebase (go.mod, tools/go.mod, Dockerfile, CI workflows, tools image tag) Use when this capability is needed.
metadata:
  author: grafana
---
