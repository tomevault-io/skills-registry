---
name: add-plugin-doc
description: Create documentation for a new official GramIO plugin with proper template, badges, installation instructions, and sidebar registration. Use when this capability is needed.
metadata:
  author: gramiojs
---
