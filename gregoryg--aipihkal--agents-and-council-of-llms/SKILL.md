...
description: invoke multiple LLMs to gather different perspectives, review each other's outputs, and act as a council under the directorship of you the Council Head. Or more generally, call other LLM instances as agents to provide summaries without cluttering context. Use when this capability is needed.
metadata:
  author: gregoryg
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gregoryg) — claim your Tome and manage your conversions.
