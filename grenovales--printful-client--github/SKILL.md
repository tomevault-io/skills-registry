---
name: github
description: Create, review, and merge GitHub pull requests using GitHub CLI and best practices. Use when the user asks to open a PR, review a PR, merge a branch, squash merge, or work with GitHub pull requests and merges. Use when this capability is needed.
metadata:
  author: grenovales
---
