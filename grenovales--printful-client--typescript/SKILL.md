---
name: typescript
description: Apply TypeScript best practices for strict typing, explicit public API types, and declaration-safe code. Use when writing or editing TypeScript files, adding or refining types, or when the user asks for TypeScript guidance. Use when this capability is needed.
metadata:
  author: grenovales
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/grenovales) — claim your Tome and manage your conversions.
