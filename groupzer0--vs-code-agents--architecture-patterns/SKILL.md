...
description: Common software architecture patterns, ADR templates, and anti-pattern detection. Supports architectural review, design decisions, and system documentation. Use when this capability is needed.
metadata:
  author: groupzer0
---
