...
description: Structured code review criteria for pre-implementation plan review (Critic) and post-implementation security/quality review. Covers security, performance, maintainability, and correctness with severity ratings. Use when this capability is needed.
metadata:
  author: groupzer0
---
