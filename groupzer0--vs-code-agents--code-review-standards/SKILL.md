...
description: Code review checklist, severity definitions, and document templates. Load when performing code reviews or defining review criteria. Use when this capability is needed.
metadata:
  author: groupzer0
---
