...
description: Version management, release verification, and deployment procedures for software releases. Includes semver guidance, version consistency checks, and platform-specific constraints. Use when this capability is needed.
metadata:
  author: groupzer0
---
