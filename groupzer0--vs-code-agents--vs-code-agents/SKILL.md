---
name: vs-code-agents
description: Use when working with a systematic approach to converting unknowns to knowns through structured investigation.
metadata:
  author: groupzer0
---
...
---
> Source: [groupzer0/vs-code-agents](https://github.com/groupzer0/vs-code-agents) — distributed by [TomeVault](https://tomevault.io).
