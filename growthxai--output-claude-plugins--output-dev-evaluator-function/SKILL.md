...
description: Create evaluator functions in evaluators.ts for Output SDK workflows. Use when implementing quality assessment, validation logic, or content evaluation. Use when this capability is needed.
metadata:
  author: growthxai
---
