...
description: Create shared HTTP clients in src/shared/clients/ for Output SDK workflows. Use when integrating external APIs, creating service wrappers, or standardizing HTTP operations. Use when this capability is needed.
metadata:
  author: growthxai
---
