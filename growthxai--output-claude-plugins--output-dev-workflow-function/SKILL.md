...
description: Create workflow.ts files for Output SDK workflows. Use when defining workflow functions, orchestrating steps, or fixing workflow structure issues. Use when this capability is needed.
metadata:
  author: growthxai
---
