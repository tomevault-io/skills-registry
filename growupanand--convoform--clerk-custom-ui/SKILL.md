...
description: Customize Clerk component appearance - themes, layout, colors, fonts, CSS. Use for appearance styling, visual customization, branding. Use when this capability is needed.
metadata:
  author: growupanand
---
