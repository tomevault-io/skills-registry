---
name: memory
description: Use when working with a file-based long-term memory using a single JSONL file, with append-only writes and recent-window search via bash + jq.
metadata:
  author: growvv
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/growvv) — claim your Tome and manage your conversions.
