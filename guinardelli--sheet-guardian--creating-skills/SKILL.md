...
description: Helps the agent generate high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user asks to create a new skill or modify an existing one. Use when this capability is needed.
metadata:
  author: guinardelli
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/guinardelli) — claim your Tome and manage your conversions.
