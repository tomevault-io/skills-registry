---
name: async-event
description: Rules for asynchronous processing, Spring event-driven communication, @Async, @TransactionalEventListener, and event design patterns Use when this capability is needed.
metadata:
  author: gykk16
---
