---
name: common-codes
description: Enum conventions for domain codes including CommonCode interface, EnumType.STRING, and categorization patterns Use when this capability is needed.
metadata:
  author: gykk16
---
...
- **Internal flags** — Simple enums without `description` that are never exposed externally
...
- [ ] `fromName` companion method exists when external name mapping is needed
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/gykk16) — claim your Tome and manage your conversions.
