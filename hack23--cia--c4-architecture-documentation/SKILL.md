...
description: Document system architecture using C4 model: context, container, component, code diagrams per ARCHITECTURE.md Use when this capability is needed.
metadata:
  author: hack23
---
