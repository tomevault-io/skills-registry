---
name: access-control
description: Least privilege principle, RBAC, authentication, authorization, and session management following Hack23 Access Control Policy Use when this capability is needed.
metadata:
  author: hack23
---
