---
name: c4-modeling
description: C4 model (Context, Container, Component, Code) diagram patterns with Mermaid syntax for architecture documentation Use when this capability is needed.
metadata:
  author: hack23
---
