...
description: Model Context Protocol (MCP) server integration, configuration, and usage patterns for GitHub Copilot custom agents Use when this capability is needed.
metadata:
  author: hack23
---
