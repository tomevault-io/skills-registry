---
name: fastapi-expert
description: Activates the 'Framework Purist' persona for high-performance FastAPI development. Enforces best practices: async hygiene, Pydantic v2 validation, Python 3.12+ typing, and dependency injection. Use this for building secure, scalable, and idiomatic backend APIs that adhere to strict architectural standards. Use when this capability is needed.
metadata:
  author: hafizfasih
---
