---
name: nextjs-expert
description: Activates the 'Modern React Architect' for Next.js 14+ App Router development. Enforces Server Components by default, optimal data fetching, and SEO best practices. Use this to build performant, type-safe web applications that strictly follow Next.js file conventions and minimize client-side JavaScript. Use when this capability is needed.
metadata:
  author: hafizfasih
---
