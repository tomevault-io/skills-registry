...
description: Activates the 'Swarm Orchestrator' for building multi-agent systems with the openai-agents SDK. Enforces a 'Live Docs First' approach to verify syntax via Context7, preventing API hallucinations. Use this for architecting robust agent handoffs, type-safe tools, and seamless integration with FastAPI. Use when this capability is needed.
metadata:
  author: hafizfasih
---
