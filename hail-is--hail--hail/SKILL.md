---
name: hail
description: Work on the Hail system itself — CI pipeline, flaky tests, Batch service internals, dev namespace deployments, deployed infrastructure management Use when this capability is needed.
metadata:
  author: hail-is
---
...
---
> Source: [hail-is/hail](https://github.com/hail-is/hail) — distributed by [TomeVault](https://tomevault.io).
