---
name: prd
description: description: "Generate a Product Requirements Document (PRD) for a new feature. Use when planning a feature, starting a new project, or when asked to create a PRD. Triggers on: create a prd, write prd for, plan this feature, requirements for, spec out." Use when this capability is needed.
metadata:
  author: haluvibe
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/haluvibe) — claim your Tome and manage your conversions.
