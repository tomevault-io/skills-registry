---
name: form-builder
description: Generate complete React Hook Form code from natural language field definitions. Use when the user wants to scaffold a typed form with validation and error handling. Use when this capability is needed.
metadata:
  author: hamsurang
---
...
---
> Source: [hamsurang/react-ko-form](https://github.com/hamsurang/react-ko-form) — distributed by [TomeVault](https://tomevault.io).
