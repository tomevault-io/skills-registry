...
description: Notify user with repeated ping sound after task completion Use when this capability is needed.
metadata:
  author: hanFengSan
---
...
---
> Source: [hanFengSan/eHunter](https://github.com/hanFengSan/eHunter) — distributed by [TomeVault](https://tomevault.io).
