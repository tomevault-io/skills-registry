---
name: xcode-26
description: Xcode 26 and Apple platform update notes with a focus on Liquid Glass, Foundation Models Framework, and Apple Intelligence. Use when asked to explain, summarize, compare, or implement Xcode 26 era framework changes across SwiftUI, UIKit, AppKit, Foundation, App Intents, StoreKit, MapKit, WidgetKit, visionOS, or Swift language features. Use when this capability is needed.
metadata:
  author: harryworld
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/harryworld) — claim your Tome and manage your conversions.
