...
description: Sample hello world tool via uloop CLI. Use when you need to test the MCP tool system or see an example of custom tool implementation. Use when this capability is needed.
metadata:
  author: hatayama
---
