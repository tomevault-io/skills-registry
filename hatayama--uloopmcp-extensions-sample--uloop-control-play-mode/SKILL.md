...
description: Control Unity Editor play mode via uloop CLI. Use when you need to: (1) Start play mode for testing, (2) Stop play mode after testing, (3) Pause play mode for debugging. Use when this capability is needed.
metadata:
  author: hatayama
---
