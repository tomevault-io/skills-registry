---
name: hathor-release
description: Manage Hathor wallet-lib release process. Use when initiating a release (PR from master to release branch) or bumping version (minor/patch/major). Handles PR creation with proper templates, reviewer assignment, labels, and GitHub project integration. Use when this capability is needed.
metadata:
  author: hathornetwork
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hathornetwork) — claim your Tome and manage your conversions.
