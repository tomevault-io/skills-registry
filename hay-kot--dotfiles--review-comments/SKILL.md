...
description: Review code comments for relevance and purpose. Identifies comments that restate what code does instead of explaining why. Use when reviewing PRs, refactoring, or when the user asks to evaluate comment quality. Use when this capability is needed.
metadata:
  author: hay-kot
---
