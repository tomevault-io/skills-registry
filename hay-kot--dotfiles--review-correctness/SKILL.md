...
description: Review code for correctness including logic bugs, error handling, edge cases, race conditions, and security vulnerabilities. Use when reviewing PRs or auditing code for bugs. Use when this capability is needed.
metadata:
  author: hay-kot
---
