---
name: review-design
description: Review code for design quality including API surface, naming, structure, separation of concerns, and adherence to project conventions. Use when reviewing PRs, refactoring, or evaluating architecture decisions. Use when this capability is needed.
metadata:
  author: hay-kot
---
