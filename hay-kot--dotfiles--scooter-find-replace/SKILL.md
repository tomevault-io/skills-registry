...
description: Use the scooter CLI for find and replace operations across codebases. Use when the user asks for bulk find-and-replace, renaming symbols across files, codebase-wide text substitution, or when sed/awk would be too fragile for multi-file replacements. Use when this capability is needed.
metadata:
  author: hay-kot
---
