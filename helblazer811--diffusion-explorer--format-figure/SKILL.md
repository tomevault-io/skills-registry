---
name: format-figure
description: Reformats a figure component file to conform to the standard section order and naming conventions defined in the figure guidelines. Use when this capability is needed.
metadata:
  author: helblazer811
---
