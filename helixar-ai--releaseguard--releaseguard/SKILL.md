---
name: releaseguard
description: Scan, harden, sign, and verify release artifacts with ReleaseGuard — the artifact policy engine for dist/ and release/ outputs. Use when this capability is needed.
metadata:
  author: Helixar-AI
---
...
---
> Source: [Helixar-AI/ReleaseGuard](https://github.com/Helixar-AI/ReleaseGuard) — distributed by [TomeVault](https://tomevault.io).
