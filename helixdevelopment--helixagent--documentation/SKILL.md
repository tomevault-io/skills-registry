---
name: documentation
description: Write effective technical documentation including READMEs, API docs, architecture decisions, and inline code documentation. Use when this capability is needed.
metadata:
