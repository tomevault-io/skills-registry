...
description: This skill should be used when the user asks to "perform complex task", "implement advanced pattern", "handle multiple scenarios", or needs comprehensive guidance with validation tools. Demonstrates full-featured skill structure. Use when this capability is needed.
metadata:
  author: helmecke
---
