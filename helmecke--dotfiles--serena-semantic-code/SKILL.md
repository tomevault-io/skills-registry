...
description: This skill should be used when the user asks to "find a symbol", "locate code", "refactor", "rename across codebase", or performs ANY coding task with Serena toolbox. Use Language Server Protocol (LSP) for semantic navigation, symbol discovery, finding references, and intelligent editing. Applies to ALL coding tasks - dramatically improves code quality and reduces token usage. Use when this capability is needed.
metadata:
  author: helmecke
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/helmecke) — claim your Tome and manage your conversions.
