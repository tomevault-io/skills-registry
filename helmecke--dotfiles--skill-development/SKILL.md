...
description: This skill should be used when the user asks to "create a skill", "add a skill", "write a new skill", "improve skill description", "organize skill content", or "validate skill structure". Provides guidance on skill development best practices for OpenCode. Use when this capability is needed.
metadata:
  author: helmecke
---
