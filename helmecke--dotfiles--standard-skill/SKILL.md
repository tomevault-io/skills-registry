...
description: This skill should be used when the user asks to "perform standard task", "follow best practices", "implement common pattern", or needs comprehensive guidance. Demonstrates recommended skill structure with progressive disclosure. Use when this capability is needed.
metadata:
  author: helmecke
---
