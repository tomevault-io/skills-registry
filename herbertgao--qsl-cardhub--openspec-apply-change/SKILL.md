...
description: 实现 OpenSpec 变更中的任务。当用户想要开始实现、继续实现或处理任务时使用。 Use when this capability is needed.
metadata:
  author: herbertgao
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/herbertgao) — claim your Tome and manage your conversions.
