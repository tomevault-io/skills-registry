...
description: Creates new skills for the Antigravity agent environment. Use when the user asks to create a skill, build a skill, or generate a skill structure.
metadata:
  author: herdiansah
---
