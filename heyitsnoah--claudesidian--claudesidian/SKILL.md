...
description: Install claudesidian shell command to launch Claude Code from anywhere. Use when the user wants to install a shell alias/launcher for their vault, or asks to set up the claudesidian command. Use when this capability is needed.
metadata:
  author: heyitsnoah
---
...
---
> Source: [heyitsnoah/claudesidian](https://github.com/heyitsnoah/claudesidian) — distributed by [TomeVault](https://tomevault.io).
