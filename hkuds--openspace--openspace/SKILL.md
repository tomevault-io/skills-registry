...
description: Execute Python scripts for spreadsheet operations with mandatory source data validation and fallback protocols Use when this capability is needed.
metadata:
  author: HKUDS
---
...
---
> Source: [HKUDS/OpenSpace](https://github.com/HKUDS/OpenSpace) — distributed by [TomeVault](https://tomevault.io).
