...
description: Use for CodexPilot screenshot requests that should open a local preview in the Codex in-app browser, capture clean images, and save them to a requested location. Use when this capability is needed.
metadata:
  author: hl9565
---
...
---
> Source: [hl9565/CodexPilot](https://github.com/hl9565/CodexPilot) — distributed by [TomeVault](https://tomevault.io).
