...
正确路径：
```bash
scripts/init_skill.py my-skill --path apps/desktop/skills
scripts/init_skill.py my-skill --path apps/desktop/skills --resources scripts,references
scripts/init_skill.py my-skill --path apps/desktop/skills --resources scripts --examples
```

错误路径（不会被加载）：
```bash
scripts/init_skill.py my-skill --path skills/public  # 错误！
scripts/init_skill.py my-skill --path ~/my-skills    # 错误！
```
