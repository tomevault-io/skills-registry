...
description: Validate Terraform modules and configurations across CP infrastructure repos. Use when checking Terraform code, reviewing infrastructure changes, or verifying module consistency. Use when this capability is needed.
metadata:
  author: hmcts
---
...
---
> Source: [hmcts/claude](https://github.com/hmcts/claude) — distributed by [TomeVault](https://tomevault.io).
