---
name: opal-flow-lld
description: Create low-level design (LLD) documents for Opal frontend flows using the Flow LLD template. Use when asked to draft, fill out, or update a flow LLD for Opal. Use when this capability is needed.
metadata:
  author: hmcts
---
