...
description: Integrate payments with SePay (VietQR, Vietnamese bank transfers) and Polar (global SaaS subscriptions, billing). Use for checkout flows, webhooks, QR codes, subscription management. Use when this capability is needed.
metadata:
  author: hoanghd218
---
