...
description: Tạo video tin tức ngắn 9:16 (~60s) từ URL bài báo hoặc file .txt tiếng Việt. Trigger khi user yêu cầu tạo video tin tức, làm short news, làm bản tin video, render tin thành video, làm TikTok tin tức. Output: video.mp4 + voice.mp3 + script.txt cho CapCut. Use when this capability is needed.
metadata:
  author: hoquanghai
---
...
---
> Source: [hoquanghai/Auto-Create-Video](https://github.com/hoquanghai/Auto-Create-Video) — distributed by [TomeVault](https://tomevault.io).
