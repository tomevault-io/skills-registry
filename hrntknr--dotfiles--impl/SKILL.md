---
name: impl
description: Incremental implementation workflow for non-trivial code changes. Use when a feature or fix needs planning, verification, and review. Use when this capability is needed.
metadata:
  author: hrntknr
---
