---
name: pr-auto
description: Create and merge pull requests via git and GitHub CLI while following repo templates and Conventional Commits. Use when a user asks to enable auto-merge, or merge a PR. Use when this capability is needed.
metadata:
  author: hrntknr
---
