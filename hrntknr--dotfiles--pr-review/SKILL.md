---
name: pr-review
description: Review a GitHub pull request by inspecting the diff locally and with GitHub CLI, then use the reviewer subagent to identify merge-blocking issues or approve the change. Use when this capability is needed.
metadata:
  author: hrntknr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hrntknr) — claim your Tome and manage your conversions.
