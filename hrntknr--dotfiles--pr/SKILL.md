---
name: pr
description: Create pull requests via git and GitHub CLI while following repo templates and Conventional Commits. Use when a user asks to make a PR, push a branch, open a GitHub PR. Use when this capability is needed.
metadata:
  author: hrntknr
---
