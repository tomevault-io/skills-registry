...
description: Workflow skill for proactively updating stale docs and fixing docs path/layout drift. Use when: docs in README.md or docs/** are outdated, command usage has changed, or documentation file/folder placement changed. Use when this capability is needed.
metadata:
  author: htnabe
---
...
---
> Source: [htnabe/HikaeMe](https://github.com/htnabe/HikaeMe) — distributed by [TomeVault](https://tomevault.io).
