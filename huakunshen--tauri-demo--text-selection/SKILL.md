...
description: Build a global text selection popup tool using Tauri v2, Monio, and the Selection crate. Detects text selected in any application system-wide and shows a floating action popup near the mouse cursor with monitor-aware edge clamping. Use when this capability is needed.
metadata:
  author: huakunshen
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/huakunshen) — claim your Tome and manage your conversions.
