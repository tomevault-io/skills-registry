...
description: Fixes broken typing checks detected by ty, make typing, or make check-repo. Use when typing errors appear in local runs, CI, or PR logs. Use when this capability is needed.
metadata:
  author: huggingface
---
...
---
> Source: [huggingface/transformers](https://github.com/huggingface/transformers) — distributed by [TomeVault](https://tomevault.io).
