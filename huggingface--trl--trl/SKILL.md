---
name: trl-training
description: Train and fine-tune transformer language models using TRL (Transformers Reinforcement Learning). Supports SFT, DPO, GRPO, KTO, RLOO and Reward Model training via CLI commands. Use when this capability is needed.
metadata:
  author: huggingface
---
...
---
> Source: [huggingface/trl](https://github.com/huggingface/trl) — distributed by [TomeVault](https://tomevault.io).
