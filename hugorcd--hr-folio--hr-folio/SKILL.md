...
description: Generate branch names, conventional commit messages, and PR titles from real project conventions. Use when asked to propose commit/PR text (especially /create-commit or /create-pr) while validating types/scopes against repo standards. Use when this capability is needed.
metadata:
  author: HugoRCD
---
...
---
> Source: [HugoRCD/hr-folio](https://github.com/HugoRCD/hr-folio) — distributed by [TomeVault](https://tomevault.io).
