...
description: Add, remove, and manage dotfiles in your bare git repository at ~/.dotfiles/. Use when: (1) User wants to track a new config file or directory, (2) User needs to untrack an existing file or directory, (3) User needs help with .gitignore patterns for selective tracking Use when this capability is needed.
metadata:
  author: huibosa
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/huibosa) — claim your Tome and manage your conversions.
