---
name: health-chat
description: Unified health conversation entry point - automatically loads all health data for each conversation, supports natural language queries, and intelligently routes to appropriate health data processing Use when this capability is needed.
metadata:
  author: huifer
---
