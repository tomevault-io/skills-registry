---
name: radiation
description: Record and track medical radiation exposure from imaging tests with automatic dose calculation based on body surface area and cumulative dose tracking. Use when this capability is needed.
metadata:
  author: huifer
---
