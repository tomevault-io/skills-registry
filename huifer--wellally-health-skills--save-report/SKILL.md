---
name: save-report
description: Save medical test reports from images with AI-powered data extraction, supporting both biochemical tests and imaging studies. Use when this capability is needed.
metadata:
  author: huifer
---
