...
description: improve a CLAUDE.md file using <important if> blocks to improve instruction adherence Use when this capability is needed.
metadata:
  author: humanlayer
---
...
---
> Source: [humanlayer/skills](https://github.com/humanlayer/skills) — distributed by [TomeVault](https://tomevault.io).
