...
> **Deprecated**: Use `continuous-learning-v2` instead. v2 provides instinct-based learning with confidence scoring and hook-based observation (100% reliable vs v1's ~50-80% skill-based observation).
