...
description: Deploy Hummingbot trading infrastructure including API server, MCP server, and Condor Telegram bot. Use this skill when the user wants to install, deploy, set up, or configure Hummingbot. Use when this capability is needed.
metadata:
  author: hummingbot
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hummingbot) — claim your Tome and manage your conversions.
