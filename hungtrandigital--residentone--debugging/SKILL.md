---
name: debugging
description: Systematic debugging framework ensuring root cause investigation before fixes. Includes four-phase debugging process, backward call stack tracing, multi-layer validation, and verification protocols. Use when encountering bugs, test failures, unexpected behavior, performance issues, or before claiming work complete. Prevents random fixes, masks over symptoms, and false completion claims. Use when this capability is needed.
metadata:
  author: hungtrandigital
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hungtrandigital) — claim your Tome and manage your conversions.
