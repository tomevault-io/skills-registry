---
name: code-audit
description: Comprehensive static code analysis to enforce architectural patterns, conventions, and code quality standards. Use when this capability is needed.
metadata:
  author: huseyindeniz
---
