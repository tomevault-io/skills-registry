---
name: docs-generator
description: Comprehensive documentation generation through automated codebase analysis, pattern detection, and diagram creation. Use when this capability is needed.
metadata:
  author: huseyindeniz
---
