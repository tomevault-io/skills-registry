---
name: ralph-tasks
description: Convert PRDs to prd.json format for the Ralph2 autonomous agent system. Use when you have an existing PRD and need to convert it to Ralph's JSON format. Triggers on: convert this prd, turn this into ralph format, create prd.json from this, ralph json, ralph-tasks. Use when this capability is needed.
metadata:
  author: hyodar
---
