---
name: proto
description: This skill should be used when the user asks to "install proto", "configure proto", "manage tool versions", "pin versions", "set up .prototools", "install node version", "install rust version", "install python version", "proto plugins", or mentions proto commands, .prototools file, or multi-language version management. Use when this capability is needed.
metadata:
  author: hyperb1iss
---
