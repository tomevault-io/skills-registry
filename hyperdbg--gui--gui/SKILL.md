...
description: Checks Go implementation consistency with C++ HyperDbg. Invoke when comparing Go test code with C++ Libhyperdbg implementation or debugging IOCTL structure mismatches. Use when this capability is needed.
metadata:
  author: HyperDbg
---
...
---
> Source: [HyperDbg/gui](https://github.com/HyperDbg/gui) — distributed by [TomeVault](https://tomevault.io).
