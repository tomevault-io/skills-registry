---
name: claude-review
description: Review code changes using Hyperlane Explorer coding standards. Use when reviewing PRs, checking your own changes, or doing self-review before committing. Use when this capability is needed.
metadata:
