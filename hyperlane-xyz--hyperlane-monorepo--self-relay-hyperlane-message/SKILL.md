...
description: Uses the Hyperlane CLI to manually deliver (self-relay) a message between chains that are Ethereum protocol type. Use when this capability is needed.
metadata:
