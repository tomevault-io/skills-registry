...
description: Add a new exported API function to the asext module, wrapping a private server.dll/server.so function for use by external plugins. Use when you need to expose CASDocumentation, CASDirectoryList, or other AngelScript-related private functions through the ASEXT_* API layer. Use when this capability is needed.
metadata:
  author: hzqst
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/hzqst) — claim your Tome and manage your conversions.
