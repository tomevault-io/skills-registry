---
name: api-security
description: API security specialist. Use for securing APIs, implementing authentication/authorization, protecting against OWASP API Top 10, or handling security best practices. Use when this capability is needed.
metadata:
  author: i-synergy
---
