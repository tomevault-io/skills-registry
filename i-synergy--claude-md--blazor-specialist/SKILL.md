...
description: Blazor UI development specialist. Use for building Blazor Server or WebAssembly apps, component development, state management, or form handling. Use when this capability is needed.
metadata:
  author: i-synergy
---
