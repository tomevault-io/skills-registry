...
description: DevOps and CI/CD specialist. Use for building pipelines, containerization, infrastructure as code, or deployment automation. User-invocable only for production deployments. Use when this capability is needed.
metadata:
  author: i-synergy
---
