...
description: External API integration specialist. Use when integrating with third-party APIs, implementing webhooks, message queues, or handling external service communication. Use when this capability is needed.
metadata:
  author: i-synergy
---
