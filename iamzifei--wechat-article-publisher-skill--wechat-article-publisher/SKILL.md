...
description: Publish Markdown/HTML articles to WeChat Official Account (微信公众号) drafts via API Use when this capability is needed.
metadata:
  author: iamzifei
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/iamzifei) — claim your Tome and manage your conversions.
