...
description: AI-powered generation of Paracle artifacts (agents, workflows, skills, policies) from natural language descriptions. Use when you need to create new framework components programmatically. Use when this capability is needed.
metadata:
  author: ibiface-tech
---
