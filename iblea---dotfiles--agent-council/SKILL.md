---
name: agent-council
description: Collect and synthesize opinions from multiple AI Agents. Use when users say "summon the council", "ask other AIs", "council", or want multiple AI perspectives on a question. Use when this capability is needed.
metadata:
  author: iblea
---
