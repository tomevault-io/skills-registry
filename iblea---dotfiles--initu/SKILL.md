---
name: initu
description: Update project init files (AGENTS.md, CLAUDE.md, GEMINI.md) based on conversation history. Use when documenting new conventions, architectural decisions, or workflow changes. Use when this capability is needed.
metadata:
  author: iblea
---
