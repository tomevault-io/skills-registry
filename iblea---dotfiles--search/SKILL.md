---
name: search
description: Research topics via web search and create reliable reports. Use when gathering up-to-date information, cross-validating data, or searching academic papers with th/dis options. Use when this capability is needed.
metadata:
  author: iblea
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/iblea) — claim your Tome and manage your conversions.
