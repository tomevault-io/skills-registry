...
description: 本技能用于在网站文档中为组件创建示例页，说明示例页应包含的要素与组织规范：组件定位、可复制运行的基础示例、常见变体、交互与边界条件、可访问性要点以及测试与视觉回归快照路径。示例采用 MDX/TSX 格式并保证代码可直接复制运行。 Use when this capability is needed.
metadata:
  author: idealjs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/idealjs) — claim your Tome and manage your conversions.
