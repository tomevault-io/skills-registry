...
description: Implements and uses interactive setup/config flows in @ideascol/cli-maker, including encrypted password fields, default values, and config reads in commands. Use when this capability is needed.
metadata:
  author: ideascoldigital
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ideascoldigital) — claim your Tome and manage your conversions.
