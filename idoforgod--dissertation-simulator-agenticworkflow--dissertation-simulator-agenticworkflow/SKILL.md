...
description: Automated workflow (workflow.md) generator for Claude Code. Produces Research → Planning → Implementation 3-stage workflows with sub-agents, agent teams, hooks, skills, and slash commands. Use when this capability is needed.
metadata:
  author: idoforgod
---
