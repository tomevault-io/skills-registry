---
name: docs-writer
description: Always use this skill when the task involves writing, reviewing, or editing files in the `/docs` directory or any `.md` files in the repository. Use when this capability is needed.
metadata:
  author: idotta
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/idotta) — claim your Tome and manage your conversions.
