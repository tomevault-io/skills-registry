...
description: Convert PDF files to Markdown using MinerU API. Use when user wants to convert a PDF (from URL or local path) to Markdown format. Supports both remote URLs and local file paths. Use when this capability is needed.
metadata:
  author: ihainan
---
