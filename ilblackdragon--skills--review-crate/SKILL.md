---
name: review-crate
description: Deep audit of a Rust crate for vulnerabilities, bugs, unfinished work, inconsistencies, duplicate code, and oversights. Works on the current crate or a specified path. Use when this capability is needed.
metadata:
