...
description: End the Q&A phase and generate the plan. Use after the blueprint skill has gathered enough context. Use when this capability is needed.
metadata:
  author: imbue-ai
---
...
---
> Source: [imbue-ai/blueprint](https://github.com/imbue-ai/blueprint) — distributed by [TomeVault](https://tomevault.io).
