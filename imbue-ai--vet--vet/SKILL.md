---
name: vet
description: Run vet immediately after ANY logical unit of code changes. Do not batch your changes, do not wait to be asked to run vet, make sure you are proactive. Use when this capability is needed.
metadata:
  author: imbue-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/imbue-ai) — claim your Tome and manage your conversions.
