---
name: redis-scaffold
description: Generate code patterns for StackExchange.Redis.Extensions — Streams, Geo, VectorSet, Hash, Pub/Sub, Sets, Compression Use when this capability is needed.
metadata:
  author: imperugo
---
...
---
> Source: [imperugo/StackExchange.Redis.Extensions](https://github.com/imperugo/StackExchange.Redis.Extensions) — distributed by [TomeVault](https://tomevault.io).
