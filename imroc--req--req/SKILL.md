...
description: Go 依赖升级专家。分析过时依赖、执行升级、运行测试验证、生成升级报告。用于定期自动升级项目依赖时主动调用。 Use when this capability is needed.
metadata:
  author: imroc
---
...
---
> Source: [imroc/req](https://github.com/imroc/req) — distributed by [TomeVault](https://tomevault.io).
