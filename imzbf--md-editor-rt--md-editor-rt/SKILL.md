---
name: md-editor-rt
description: 集成、定制或排查 md-editor-rt 时使用。适用于在 React 18+、Next.js、SSR 或 Web Component 项目中接入 MdEditor、MdPreview、MdCatalog，给 md-editor-rt 增加图片上传、目录联动、自定义工具栏/页脚、主题/语言、markdown-it 与 CodeMirror 扩展、config() 全局依赖替换，以及处理 SSR、样式、MdCatalog 滚动、高亮/公式/mermaid/echarts、本地实例替代 CDN、XSS 与副作用等常见问题。 Use when this capability is needed.
metadata:
  author: imzbf
---
...
---
> Source: [imzbf/md-editor-rt](https://github.com/imzbf/md-editor-rt) — distributed by [TomeVault](https://tomevault.io).
