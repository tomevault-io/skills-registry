---
name: ios-deploy
description: Build and deploy IngrediCheck to iOS device. Use when user wants to deploy, test on device, or run the app. Use when this capability is needed.
metadata:
  author: ingredicheck
---
