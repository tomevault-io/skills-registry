---
name: align-proto
description: Detect proto package changes (indexer-proto-ts-v2, abacus-proto-ts-v2, tc-abacus-proto-ts-v2), compare old vs new proto files, and implement new/modified gRPC services in sdk-ts following established patterns. Use when this capability is needed.
metadata:
...
---
> Source: [InjectiveLabs/injective-ts](https://github.com/InjectiveLabs/injective-ts) — distributed by [TomeVault](https://tomevault.io).
