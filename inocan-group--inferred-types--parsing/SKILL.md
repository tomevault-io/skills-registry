...
description: Utilities in this library which provide effective ways to parse or mutate text at both runtime and design-time while ensuring that the resulting type is as narrow as possible. Use when this capability is needed.
metadata:
  author: inocan-group
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/inocan-group) — claim your Tome and manage your conversions.
