---
name: deploy
description: Install and deploy Canvas Android apps to connected devices or emulators using adb and Gradle. Use when user mentions installing, deploying, running on device, launching app, or working with emulators. Use when this capability is needed.
metadata:
  author: instructure
---
