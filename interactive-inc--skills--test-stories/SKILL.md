---
name: test-stories
description: Create and update E2E tests from user stories using Playwright. Generate test scenarios based on story acceptance criteria. Use when this capability is needed.
metadata:
