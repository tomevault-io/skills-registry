...
description: Add a new LLM or VLM to LMDeploy's PyTorch backend. Use when this capability is needed.
metadata:
  author: InternLM
---
...
---
> Source: [InternLM/lmdeploy](https://github.com/InternLM/lmdeploy) — distributed by [TomeVault](https://tomevault.io).
