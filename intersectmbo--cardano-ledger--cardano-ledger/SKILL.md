...
description: Update CHANGELOG.md files and cabal version numbers for all packages changed since origin/master, following PVP and project RELEASING.md rules. Use when preparing a PR or when asked to update changelogs or version numbers. Use when this capability is needed.
metadata:
  author: IntersectMBO
---
...
---
> Source: [IntersectMBO/cardano-ledger](https://github.com/IntersectMBO/cardano-ledger) — distributed by [TomeVault](https://tomevault.io).
