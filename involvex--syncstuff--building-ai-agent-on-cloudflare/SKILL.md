...
description: Generates production-ready agent code deployed to Workers.
metadata:
  author: involvex
---
---
...
---
> Source: [involvex/syncstuff](https://github.com/involvex/syncstuff) — distributed by [TomeVault](https://tomevault.io).
