---
name: format-code
description: Formats the codebase using nightly rustfmt. Use when asked to "format the code", "run rustfmt", "cargo fmt", or when formatting is needed after code changes. Use when this capability is needed.
metadata:
  author: iopsystems
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/iopsystems) — claim your Tome and manage your conversions.
