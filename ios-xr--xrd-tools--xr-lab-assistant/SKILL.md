...
description: Building or modifying IOS-XR/XRd labs or network topologies, creating router configurations, starting or stopping testbeds, running show commands, exploring protocol behavior, or troubleshooting boot and config issues. Use when this capability is needed.
metadata:
  author: ios-xr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ios-xr) — claim your Tome and manage your conversions.
