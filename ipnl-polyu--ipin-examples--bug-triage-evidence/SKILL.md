...
description: Triage bugs and package reproducible evidence cleanly (.dev artifacts, chapter figures, and README updates). Use when fixing a bug or mismatch vs expected results. Use when this capability is needed.
metadata:
  author: ipnl-polyu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ipnl-polyu) — claim your Tome and manage your conversions.
