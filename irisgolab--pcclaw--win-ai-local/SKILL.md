---
name: win-ai-local
description: Local AI inference via Ollama — run LLMs on-device, manage models, detect NPU/GPU/DirectML hardware, zero cloud dependencies. Use when this capability is needed.
metadata:
  author: irisgolab
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/irisgolab) — claim your Tome and manage your conversions.
