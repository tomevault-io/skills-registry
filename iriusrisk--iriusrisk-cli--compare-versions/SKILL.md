...
description: Compare different states of a threat model to identify architectural and security changes. Use when reviewing pull requests for security impacts, detecting drift from approved baselines, or auditing historical changes. Returns structured diff for interpretation. Use when this capability is needed.
metadata:
  author: iriusrisk
---
