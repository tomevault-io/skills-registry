---
name: skill-creator
description: This skill should be used when the user asks to create a new skill, build a skill, make a custom skill, develop a CLI skill, or wants to extend the CLI with new capabilities. Automates the entire skill creation workflow from brainstorming to installation. Use when this capability is needed.
metadata:
  author: iskenkenya
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/iskenkenya) — claim your Tome and manage your conversions.
