...
description: Kubernetes clusters, pods, nodes, workloads, storage, networking, and resource relationships. Query K8s inventory, diagnose degraded deployments and pod failures, investigate rollouts, audit ingress and network policies. Use when this capability is needed.
metadata:
  author: israel-salgado
---
...
---
> Source: [israel-salgado/dt-mcp-server](https://github.com/israel-salgado/dt-mcp-server) — distributed by [TomeVault](https://tomevault.io).
