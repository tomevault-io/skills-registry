---
name: user-docs
description: Write user-facing documentation for Huddo products. Use when creating how-to guides, feature tutorials, or end-user instructions (not admin/installation docs). Use when this capability is needed.
metadata:
  author: isw-kudos
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/isw-kudos) — claim your Tome and manage your conversions.
