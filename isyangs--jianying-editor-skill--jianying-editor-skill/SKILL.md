...
description: 剪映 (JianYing) AI自动化剪辑的高级封装 API。支持录屏、素材导入、字幕生成、Web 动效合成及项目导出。 Use when this capability is needed.
metadata:
  author: isYangs
---
...
---
> Source: [isYangs/jianying-editor-skill](https://github.com/isYangs/jianying-editor-skill) — distributed by [TomeVault](https://tomevault.io).
