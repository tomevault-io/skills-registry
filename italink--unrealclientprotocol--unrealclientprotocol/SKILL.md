...
description: Systematically analyze and translate large UE Blueprints (10+ functions) into C++ or other targets. Use when the user asks to convert a Blueprint to C++, audit a complex Blueprint, or understand a large Blueprint's full logic. Use when this capability is needed.
metadata:
  author: Italink
---
...
---
> Source: [Italink/UnrealClientProtocol](https://github.com/Italink/UnrealClientProtocol) — distributed by [TomeVault](https://tomevault.io).
