---
name: writing-plans
description: Create comprehensive implementation plans with bite-sized tasks. Use when you have requirements before touching code. Use when this capability is needed.
metadata:
  author: itseffi
---
