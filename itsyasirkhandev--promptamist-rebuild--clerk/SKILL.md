---
name: clerk
description: Check `package.json` to determine the Clerk SDK version. This determines which patterns to use: Use when this capability is needed.
metadata:
  author: itsyasirkhandev
---
...
---
> Source: [itsyasirkhandev/promptamist-rebuild](https://github.com/itsyasirkhandev/promptamist-rebuild) — distributed by [TomeVault](https://tomevault.io).
