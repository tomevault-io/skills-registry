...
description: AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters Use when this capability is needed.
metadata:
  author: iTzFaisal
---
