...
description: AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting Use when this capability is needed.
metadata:
  author: iTzFaisal
---
