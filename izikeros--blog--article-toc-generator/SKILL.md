...
description: Add or update Table of Contents in markdown articles with proper anchor links. Removes legacy SublimeText MarkdownTOC plugin markers and generates clean, genuine TOC. Automatically invokes article-post-edit-actions skill after completion. Use when this capability is needed.
metadata:
  author: izikeros
---
