---
name: skill-creator
description: Create, improve, and troubleshoot Claude Code agent skills. Use when asked to make a new skill, write a SKILL.md file, improve skill discoverability, debug why a skill isn't activating, answer questions about skills, or review skill best practices. Use when this capability is needed.
metadata:
  author: j-r-beckett
---
...
---
> Source: [j-r-beckett/SpeedReader](https://github.com/j-r-beckett/SpeedReader) — distributed by [TomeVault](https://tomevault.io).
