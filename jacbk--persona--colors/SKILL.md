---
name: colors
description: Reference guide for portfolio color palettes. Includes quick vibe lookup, full palettes, and application guidelines using the 60-30-10 rule. Use when this capability is needed.
metadata:
  author: jacbk
---
