---
name: research
description: Gather information about users from materials, profile config, GitHub, and web search to inform portfolio content and design decisions. Use when this capability is needed.
metadata:
  author: jacbk
---
