...
description: Guides Claude in writing idiomatic, efficient, well-structured Rust code using proper data modeling, traits, impl organization, macros, and build-speed best practices. Use when this capability is needed.
metadata:
  author: Jacke
---
...
---
> Source: [Jacke/doradura](https://github.com/Jacke/doradura) — distributed by [TomeVault](https://tomevault.io).
