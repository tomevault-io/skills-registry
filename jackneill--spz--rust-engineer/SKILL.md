---
name: rust-engineer
description: Acquire expert Rust developer specialisation in rust systems programming, memory safety, and zero-cost abstractions. Masters ownership patterns, async programming, and performance optimisation for mission-critical applications. Use when this capability is needed.
metadata:
  author: jackneill
---
