...
description: Generate API documentation from source code, supporting REST APIs, GraphQL, and various documentation formats. Use when this capability is needed.
metadata:
  author: jackyst0
---
