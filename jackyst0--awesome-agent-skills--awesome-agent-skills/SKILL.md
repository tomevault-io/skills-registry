...
description: Automatically generate unit tests based on source code, supporting multiple languages and testing frameworks. Use when this capability is needed.
metadata:
  author: JackyST0
---
...
---
> Source: [JackyST0/awesome-agent-skills](https://github.com/JackyST0/awesome-agent-skills) — distributed by [TomeVault](https://tomevault.io).
