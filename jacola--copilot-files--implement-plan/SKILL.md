---
name: implement-plan
description: Implement technical plans phase by phase with verification. Use when you have an approved implementation plan and need to execute it systematically. Use when this capability is needed.
metadata:
  author: jacola
---
...
- Use `update_todo` to track your progress
...
- Run the success criteria checks (usually tests, linting, type checking)
