---
name: graphite-cli
description: Use Graphite CLI (gt) for stacked PRs and branch management. Use when creating branches, committing changes, submitting PRs, syncing with trunk, or managing stacked pull requests. Use when this capability is needed.
metadata:
  author: jakewaldrip
---
