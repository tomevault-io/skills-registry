---
name: lint-running
description: Run lint and format checks in the Commons monorepo. Use when validating code style, checking for linting errors, before commits, or when the user mentions linting or formatting code. Use when this capability is needed.
metadata:
  author: jakewaldrip
---
