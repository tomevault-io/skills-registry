---
name: test-running
description: Run Jest tests in the Commons monorepo. Use when testing code changes, validating implementations, debugging test failures, or when the user mentions running tests. Use when this capability is needed.
metadata:
  author: jakewaldrip
---
