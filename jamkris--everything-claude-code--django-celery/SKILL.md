---
name: django-celery
description: Django + Celery async task patterns — configuration, task design, beat scheduling, retries, canvas workflows, monitoring, and testing. Use when adding background jobs, scheduled tasks, or async processing to a Django app. Use when this capability is needed.
metadata:
  author: Jamkris
---
...
---
> Source: [Jamkris/everything-claude-code](https://github.com/Jamkris/everything-claude-code) — distributed by [TomeVault](https://tomevault.io).
