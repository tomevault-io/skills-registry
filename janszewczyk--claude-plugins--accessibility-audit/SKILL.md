...
description: Perform WCAG accessibility audits on React components using automated tools and manual checks. Use when auditing accessibility, fixing a11y issues, or ensuring WCAG compliance. Use when this capability is needed.
metadata:
  author: janszewczyk
---
