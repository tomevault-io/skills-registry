...
description: Type-safe environment variable validation with @t3-oss/env-nextjs and Zod. Build-time validation ensures all required env vars are present and correctly typed. Use when this capability is needed.
metadata:
  author: janszewczyk
---
