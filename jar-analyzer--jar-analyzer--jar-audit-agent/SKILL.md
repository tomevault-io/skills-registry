...
description: 基于 jar-analyzer（SQLite + 内置 MCP）的证据驱动 Java 安全审计技能。核心目标：把“结论”变成“可复现证据 + 可度量覆盖率”。 Use when this capability is needed.
metadata:
  author: jar-analyzer
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jar-analyzer) — claim your Tome and manage your conversions.
