...
description: Naming conventions for files, variables, types, constants, booleans, generics. Applies to new files, refactoring, code review, or inconsistent naming issues. Use when this capability is needed.
metadata:
  author: jasondocton
---
