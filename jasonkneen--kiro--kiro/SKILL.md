...
description: Create comprehensive steering documents for development projects. Generates project-specific standards, git workflows, and technology guidelines in .kiro/steering/ directory. Use when this capability is needed.
metadata:
  author: jasonkneen
---
...
---
> Source: [jasonkneen/kiro](https://github.com/jasonkneen/kiro) — distributed by [TomeVault](https://tomevault.io).
