---
name: gh-fix-ci
description: - Inspect GitHub PR checks with gh, pull failing GitHub Actions logs, summarize Use when this capability is needed.
metadata:
...
1. Verify gh authentication.
   ...
   - If sandboxed auth status fails, rerun the command with
     `sandbox_permissions=require_escalated` to allow network/keyring access.
