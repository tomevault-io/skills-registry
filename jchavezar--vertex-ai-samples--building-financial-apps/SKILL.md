...
description: Enforces the 'Zero-Parsing' AI architecture (Vercel AI SDK + React 19 + Gemini) for financial applications. Use when the user asks to build, refactor, or modernize financial dashboards or chat interfaces. Use when this capability is needed.
metadata:
  author: jchavezar
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jchavezar) — claim your Tome and manage your conversions.
