...
description: Enforces strict 'Zero-Leak' security practices, including secret management, gitignore rules, and environment variable protocols. Use when starting new projects or rigorously auditing existing ones. Use when this capability is needed.
metadata:
  author: jchavezar
---
