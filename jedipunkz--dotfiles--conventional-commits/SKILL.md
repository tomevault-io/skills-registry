...
description: Enforces conventional commit message and branch naming conventions with specific prefixes (feat, fix, docs, style, refactor, perf, test, chore). Use when creating git commits, suggesting branch names, reviewing commit messages, or when the user asks about git workflow. Use when this capability is needed.
metadata:
  author: jedipunkz
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jedipunkz) — claim your Tome and manage your conversions.
