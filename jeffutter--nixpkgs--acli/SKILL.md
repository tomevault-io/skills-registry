---
name: acli
description: Use acli jira CLI for Jira work item management, project operations, sprint tracking, and board management with JQL search capabilities. Use when this capability is needed.
metadata:
  author: jeffutter
---
