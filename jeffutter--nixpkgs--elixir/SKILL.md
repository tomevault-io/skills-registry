---
name: elixir
description: Guidelines and best practices when writing Elixir code. Claude should use this skill whenever asked to modify, evaluate or review Elixir files (.ex or .exs). Use when this capability is needed.
metadata:
  author: jeffutter
---
