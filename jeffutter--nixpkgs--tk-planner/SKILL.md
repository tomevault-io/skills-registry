---
name: tk-planner
description: Autonomous planning skill for tickets (tk). Use when planning implementation for a ticket (proj-xxx). Spawns research subagents, analyzes dependencies, creates sub-tickets for discrete work, and writes detailed implementation plans. Use when this capability is needed.
metadata:
  author: jeffutter
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jeffutter) — claim your Tome and manage your conversions.
