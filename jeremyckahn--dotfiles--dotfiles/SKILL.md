---
name: skill-builder
description: Use when working with a comprehensive guide and helper to define reusable behavior via SKILL.md definitions for OpenCode.
metadata:
  author: jeremyckahn
---
...
---
> Source: [jeremyckahn/dotfiles](https://github.com/jeremyckahn/dotfiles) — distributed by [TomeVault](https://tomevault.io).
