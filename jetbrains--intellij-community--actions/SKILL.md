---
name: actions
description: Guidelines for implementing IntelliJ actions (AnAction). Use those rules when you need to create or change an action in the intellij platform. Use when this capability is needed.
metadata:
  author: jetbrains
---
