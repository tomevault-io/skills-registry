---
name: debugging
description: Debugging techniques and tools for IntelliJ development. Use when debugging IDE issues or investigating failures. Use when this capability is needed.
metadata:
  author: jetbrains
---
