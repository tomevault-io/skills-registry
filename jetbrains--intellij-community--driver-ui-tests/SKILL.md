...
description: Guide for writing UI tests using IDE Starter and UI Driver frameworks. Use when creating or modifying UI tests or when user ask to implement test case from testops. Use when this capability is needed.
metadata:
  author: jetbrains
---
