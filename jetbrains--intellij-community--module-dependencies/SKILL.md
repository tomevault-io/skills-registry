...
description: How to manage module dependencies in IntelliJ codebase. Use when adding or modifying module dependencies in iml files. Use when this capability is needed.
metadata:
  author: jetbrains
---
