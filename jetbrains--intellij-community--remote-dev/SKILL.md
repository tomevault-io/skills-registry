---
name: remote-dev
description: Guidelines for structuring and developing IntelliJ remote development modules. Use when working on Remote Development features. Use when this capability is needed.
metadata:
  author: jetbrains
---
