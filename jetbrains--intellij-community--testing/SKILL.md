---
name: testing
description: Comprehensive testing reference for running tests in IntelliJ codebase via tests.cmd. Use when running, debugging, or troubleshooting test execution. Use when this capability is needed.
metadata:
  author: jetbrains
---
