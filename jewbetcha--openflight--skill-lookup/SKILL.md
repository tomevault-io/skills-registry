---
name: skill-lookup
description: Activates when the user asks about Agent Skills, wants to find reusable AI capabilities, needs to install skills, or mentions skills for Claude. Use for discovering, retrieving, and installing skills. Use when this capability is needed.
metadata:
  author: jewbetcha
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jewbetcha) — claim your Tome and manage your conversions.
