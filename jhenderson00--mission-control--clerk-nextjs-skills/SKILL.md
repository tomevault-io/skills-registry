...
description: Clerk authentication for Next.js 16 (App Router only) with proxy.ts setup, migration from middleware.ts, environment configuration, and MCP server integration. Use when this capability is needed.
metadata:
  author: jhenderson00
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jhenderson00) — claim your Tome and manage your conversions.
