---
name: coder
description: Coding assistant capabilities including file investigation, reading, searching, editing, and command execution. Use when this capability is needed.
metadata:
  author: jiamingkong
---
