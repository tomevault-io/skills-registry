...
description: Guide for creating and organizing FastAPI routes using a file-based routing system or modular router pattern. Helps organize complex API structures. Use when this capability is needed.
metadata:
  author: jidohyun
---
