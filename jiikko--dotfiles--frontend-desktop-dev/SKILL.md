...
description: Comprehensive frontend and desktop development skill combining CSS, Node.js, and Electron expertise. Use for building web frontends, Node.js backends, or Electron desktop applications. Automatically coordinates between css-expert, nodejs-expert, and electron-expert agents. Use when this capability is needed.
metadata:
  author: jiikko
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jiikko) — claim your Tome and manage your conversions.
