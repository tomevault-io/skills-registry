...
description: Domain-Driven Development workflow specialist using ANALYZE-PRESERVE-IMPROVE cycle for behavior-preserving code transformation Use when this capability is needed.
metadata:
  author: jikime
---
