---
name: opsxff
description: Fast-forward through OpenSpec artifact creation. Generates all artifacts (proposal, specs, design, tasks) in one go. Use when this capability is needed.
metadata:
  author: jkrumm
---
