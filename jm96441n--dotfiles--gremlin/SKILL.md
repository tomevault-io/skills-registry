---
name: gremlin
description: Write Gremlin graph traversal queries for Neptune using the gremlin-go driver patterns in this codebase Use when this capability is needed.
metadata:
  author: jm96441n
---
