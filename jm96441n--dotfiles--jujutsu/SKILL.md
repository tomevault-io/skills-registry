---
name: jujutsu
description: Prefer Jujutsu (jj) over git for version control. Use squash workflow pattern where commits are described first, then changes are made in a scratch child commit and squashed into the parent. Use when this capability is needed.
metadata:
  author: jm96441n
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jm96441n) — claim your Tome and manage your conversions.
