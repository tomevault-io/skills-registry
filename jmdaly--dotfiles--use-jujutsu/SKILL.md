---
name: use-jujutsu
description: Comprehensive skill for Jujutsu (jj) VCS operations. Use this when the user needs to manage version control, translate Git commands to jj, query repository history with revsets, or resolve conflicts in a jj-managed repository. Use when this capability is needed.
metadata:
  author: jmdaly
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jmdaly) — claim your Tome and manage your conversions.
