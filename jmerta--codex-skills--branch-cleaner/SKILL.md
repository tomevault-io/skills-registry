---
name: branch-cleaner
description: Identify and clean up stale git branches locally and on remotes with safe, reversible steps. Use when asked to prune, list, or delete merged/old branches or audit branch hygiene. Use when this capability is needed.
metadata:
  author: jmerta
---
# Branch cleaner
