---
name: research
description: Use before implementing new features to gather context from documentation, real-world code examples, and web resources. Provides structured findings to inform implementation decisions. Use when this capability is needed.
metadata:
  author: jmreicha
---
