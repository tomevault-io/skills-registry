---
name: testing
description: Use to choose and apply TDD or BDD based on the change, enforcing fast Red-Green-Refactor and Given-When-Then loops. Use when this capability is needed.
metadata:
  author: jmreicha
---
