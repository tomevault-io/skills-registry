---
name: encapp
description: This skill should be used when the user asks about "encapp", "video encoding tests", "codec testing", "Android encoder", "transcode test", "camera encoding", "video quality metrics", "VMAF", "rate-distortion", or running video encoding experiments on Android devices. Use when this capability is needed.
metadata:
  author: johanblome
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/johanblome) — claim your Tome and manage your conversions.
