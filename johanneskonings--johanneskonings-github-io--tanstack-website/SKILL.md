...
description: Uses the TanStack MCP to search docs, fetch pages, list libraries, and create TanStack apps. Covers the TanStack website as a blog: static content configuration, TanStack DevTools integration, and optimization for SEO and agent access. Use when working on the TanStack website, blog, static content, DevTools, SEO, agent access, TanStack docs, or TanStack tooling. Use when this capability is needed.
metadata:
  author: johanneskonings
---
