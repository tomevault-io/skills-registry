---
name: github
description: Manage GitHub issues using gh CLI - create, list, view, update, close, and assign issues. Use when working with GitHub issues, bug tracking, or project management tasks. Use when this capability is needed.
metadata:
