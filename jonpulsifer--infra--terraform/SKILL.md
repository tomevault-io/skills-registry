---
name: terraform
description: Work with Terraform modules in this infra repo (everything under terraform/: gcp, cloudflare, vault, argo, unifi, tailscale, google-workspace, k8s). Covers workflow, CI behaviour, and module layout. Use when this capability is needed.
metadata:
  author: jonpulsifer
---
...
---
> Source: [jonpulsifer/infra](https://github.com/jonpulsifer/infra) — distributed by [TomeVault](https://tomevault.io).
