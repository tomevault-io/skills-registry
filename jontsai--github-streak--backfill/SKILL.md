---
name: backfill
description: Backfill missing GitHub streak dates using the streakify.sh script. Use this when the user asks to backfill dates, fix missing streak days, or catch up on streak commits. Use when this capability is needed.
metadata:
  author: jontsai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jontsai) — claim your Tome and manage your conversions.
