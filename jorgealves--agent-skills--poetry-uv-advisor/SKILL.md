...
description: Optimize pyproject.toml and resolve complex dependency trees using modern tools like Poetry or uv. Use to modernize Python project management. Use when this capability is needed.
metadata:
  author: jorgealves
---
