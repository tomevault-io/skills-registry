...
description: Analyze and optimize pytest suites to improve speed, identify flaky tests, and increase coverage. Use to maintain high-quality, fast-running test pipelines. Use when this capability is needed.
metadata:
  author: jorgealves
---
# pytest Optimizer
