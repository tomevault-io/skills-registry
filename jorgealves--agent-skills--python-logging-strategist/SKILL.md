...
description: Design structured logging systems with context propagation. Use to ensure Python applications are observable and logs are machine-readable. Use when this capability is needed.
metadata:
  author: jorgealves
---
