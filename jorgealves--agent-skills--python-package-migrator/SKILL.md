...
description: Plan and execute upgrades for Python libraries, handling breaking changes. Use when performing major version bumps for frameworks like Django or FastAPI. Use when this capability is needed.
metadata:
  author: jorgealves
---
