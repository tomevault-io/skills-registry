...
description: Automatically add or improve type annotations in legacy Python code. Use to improve code readability, IDE support, and catch type errors early. Use when this capability is needed.
metadata:
  author: jorgealves
---
