...
description: Build, troubleshoot, and modernize this repository's Next.js build pipeline (Next.js + Contentlayer + next-sitemap + next-pwa). Use when the user mentions build errors, dependency upgrades, env vars (NEXT_PUBLIC_SITE_URL), sitemap/robots generation, PWA issues, or deployment mismatches. Use when this capability is needed.
metadata:
  author: josenaldo
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/josenaldo) — claim your Tome and manage your conversions.
