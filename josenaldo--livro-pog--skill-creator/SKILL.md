---
name: skill-creator
description: Guia para criar skills eficazes. Use esta skill quando quiser criar ou atualizar uma skill que expanda as capacidades do agente Copilot com conhecimento especializado, fluxos de trabalho ou integrações técnicas. Use when this capability is needed.
metadata:
  author: josenaldo
---
