---
name: java-test
description: Run Java tests with Gradle and summarize results. Shows only failures and key statistics. Use when testing Java code, validating backend changes, or debugging test failures. Use when this capability is needed.
metadata:
  author: joshcanfield
---
