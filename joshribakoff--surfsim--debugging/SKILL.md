---
name: debugging
description: Apply systematic debugging methodology. Use when investigating bugs, unexpected behavior, or when user reports issues. Auto-apply when conversation includes "bug", "broken", "not working", "wrong", "glitch", "flickering". Use when this capability is needed.
metadata:
  author: joshribakoff
---
