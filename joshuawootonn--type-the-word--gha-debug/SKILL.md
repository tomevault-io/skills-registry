---
name: gha-debug
description: Investigates failed GitHub Actions runs using gh CLI, identifies root cause from failing jobs and logs, and suggests concrete fixes and rerun steps. Use when CI fails, checks are red, or the user asks to debug GitHub Actions. Use when this capability is needed.
metadata:
