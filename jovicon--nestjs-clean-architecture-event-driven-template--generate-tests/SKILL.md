---
name: generate-tests
description: Generate comprehensive tests for use cases, entities, repositories, and endpoints. Use when adding tests for existing code or achieving better coverage. Use when this capability is needed.
metadata:
  author: jovicon
---
