---
name: documentation
description: Write and maintain documentation for Particle-Viewer following project conventions. Use when creating docs, updating guides, writing API references, or reviewing documentation. Covers file organization, linking, formatting, and content standards. Use when this capability is needed.
metadata:
  author: jpegthedev
---
