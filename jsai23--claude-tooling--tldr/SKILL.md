---
name: tldr
description: Token-efficient code analysis reference. Use when analyzing large codebases or needing structured code intelligence. Use when this capability is needed.
metadata:
  author: jsai23
---
# TLDR CLI Reference
