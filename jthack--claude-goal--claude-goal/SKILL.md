---
name: goal
description: Codex-style /goal for Claude Code. Use when the user runs /goal, wants a persistent long-running objective, or wants to pause, resume, clear, or complete a goal. Use when this capability is needed.
metadata:
  author: jthack
---
...
---
> Source: [jthack/claude-goal](https://github.com/jthack/claude-goal) — distributed by [TomeVault](https://tomevault.io).
