...
description: Search and navigate large codebases efficiently. Use when finding specific code patterns, tracing function calls, understanding code structure, or locating bugs. Handles semantic search, grep patterns, AST analysis. Use when this capability is needed.
metadata:
  author: juanjaragavi
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/juanjaragavi) — claim your Tome and manage your conversions.
