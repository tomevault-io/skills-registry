---
name: feature-docs
description: [Docs] Generate single-file feature documentation with verified test cases. Use for quick feature docs, feature README, and single-file verified documentation in non-enterprise projects. Outputs one markdown file with code evidence. For enterprise module hierarchy, use business-feature-docs instead. Use when this capability is needed.
metadata:
  author: juanjoarranz
---
...
**GOLD STANDARD Reference**: `.agents/skills/feature-docs/references/README.ExampleFeature1.md` (Example App)
**Template File**: `.agents/skills/feature-docs/references/detailed-feature-docs-template.md`
...
| ---- | ---------------- | --------------------------------------------------------------- |
| 1    | Feature Analysis | Build knowledge model in `.vscode/.ai/workspace/analysis/`      |
...
- Use `.agents/skills/feature-docs/references/README.ExampleFeature1.md` as gold standard reference
...
Build knowledge model in `.vscode/.ai/workspace/analysis/[feature-name].md`.
...
Generate at `.vscode/docs/features/{Module}/detailed-features/README.{FeatureName}.md`.
...
**Output**: `.vscode/docs/features/{Module}/detailed-features/README.{FeatureName}.ai.md`
**Template**: `.agents/skills/feature-docs/references/detailed-feature-docs-template.ai.md`
