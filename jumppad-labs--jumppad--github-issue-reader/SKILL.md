...
description: Load comprehensive GitHub issue information including title, description, comments, labels, assignees, milestones, and related items (linked PRs and cross-references). This skill should be used when planning to fix an issue, when detailed issue context is needed for implementation work, or when a plan command needs to understand the full scope of an issue. Use when this capability is needed.
metadata:
  author: jumppad-labs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/jumppad-labs) — claim your Tome and manage your conversions.
