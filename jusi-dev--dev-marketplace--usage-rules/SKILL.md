---
name: usage-rules
description: Search for package-specific usage rules and best practices from Elixir packages. Use when you need coding conventions, patterns, common mistakes, getting an overview about the project, when the ash-plan command/skill is used, or good/bad examples for packages like Ash, Phoenix, Ecto, etc. Use when this capability is needed.
metadata:
  author: jusi-dev
---
