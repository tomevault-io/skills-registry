---
name: onnx-doctor
description: Development conventions for the onnx-doctor ONNX model linter. Use this when adding rules, writing providers, or modifying the linter codebase. Use when this capability is needed.
metadata:
  author: justinchuby
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/justinchuby) — claim your Tome and manage your conversions.
