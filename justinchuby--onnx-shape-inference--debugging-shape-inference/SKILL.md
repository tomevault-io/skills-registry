...
description: Guide for debugging shape inference errors, particularly "Inferred shape and existing shape differ" from ONNX C++. Use when this capability is needed.
metadata:
  author: justinchuby
---
