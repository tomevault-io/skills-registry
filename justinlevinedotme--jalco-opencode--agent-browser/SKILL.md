...
Browser automation using agent-browser CLI for web testing, form filling, screenshots, and data extraction.
...
Recording creates a fresh context but preserves cookies/storage from your session. If no URL is provided, it automatically returns to your current page.
