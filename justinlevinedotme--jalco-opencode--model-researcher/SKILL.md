...
## Banned Legacy Models

The following models MUST NOT be used in any configuration as they are DEPRECATED, REPLACED, or OBSOLETE in Q4 2025:
...
You MUST NOT hallucinate model specifications. Models have precise identifiers, context limits, and API requirements. A wrong value means broken requests or wasted tokens.
...
You MUST confirm specs with user before applying model configuration.
...
Before touching config, you MUST present your research:
