---
name: subagent
description: Delegate codebase exploration or scripted actions to a non-interactive Codex exec run (codex exec / codex e). Use when you want a subagent to read lots of code or take actions without human interaction, and you can accept CLI output and optional file changes as the result. Use when this capability is needed.
metadata:
  author: jxnl
---
