---
name: react-native-setup-expo
description: To initialize a scalable, cross-platform mobile application using React Native and Expo, configured with TypeScript and standard linting tools. Use when: Starting a new mobile project for iOS and Android; Prototyping rapidly without complex native build setups; When needing access to native device features via a managed workflow. Use when this capability is needed.
metadata:
  author: jyjeanne
---
