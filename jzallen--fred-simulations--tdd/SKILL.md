...
description: Practice Red-Green-Refactor-Commit TDD methodology with pytest, avoiding common antipatterns and following FIRST principles for robust test suites. Use when this capability is needed.
metadata:
  author: jzallen
---
