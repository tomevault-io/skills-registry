---
name: configure
description: Set up the Telegram channel — save the bot token and review access policy. Use when the user pastes a Telegram bot token, asks to configure Telegram, asks "how do I set this up" or "who can reach me," or wants to check channel status. Use when this capability is needed.
metadata:
  author: k1p1l0
---
...
---
> Source: [k1p1l0/claude-telegram-supercharged](https://github.com/k1p1l0/claude-telegram-supercharged) — distributed by [TomeVault](https://tomevault.io).
