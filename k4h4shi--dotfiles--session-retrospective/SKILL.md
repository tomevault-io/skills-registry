...
description: Claude Codeのセッションを分析し、設定改善案（permissions/memory/rules/skills/agents/hooks）を提案する。完了セッションの振り返り時に使用する。トリガー例: retrospective / session analysis / improve Claude config / セッションID指定。 Use when this capability is needed.
metadata:
  author: k4h4shi
---
