...
description: ローカル差分 or PR のレビューを subagent（Codex/Gemini）に委譲する。コミット前は local、PRがあるなら pr を使う。Usage: /subagent-review [local|pr] [PR_NUMBER] [codex|gemini] Use when this capability is needed.
metadata:
  author: k4h4shi
---
