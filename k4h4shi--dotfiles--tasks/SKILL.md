---
name: tasks
description: Obsidianのbacklog.mdとDailyノートのログ欄を管理する。GitHub/Jira/Obsidianなど複数ソースからイシューを取得して正規化し、Dailyへ提案・バックログへ同期する。Usage: /tasks Use when this capability is needed.
metadata:
  author: k4h4shi
---
