...
description: Skill for generating premium visual assets (logos, hero images, favicons) using AI generation tools and implementing them in a React/Vite frontend. Use when this capability is needed.
metadata:
  author: k4ilham
---
