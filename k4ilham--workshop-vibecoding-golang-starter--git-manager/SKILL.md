---
name: git-manager
description: Use when working with a comprehensive skill for managing Git repositories, specifically designed to automate the creation of .gitignore files and streamline common git commands.
metadata:
  author: k4ilham
---
