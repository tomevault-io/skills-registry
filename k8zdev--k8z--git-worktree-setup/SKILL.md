...
description: Automate git worktree creation and copy private files (not tracked in git) to new workdirs. Use when creating a new git worktree for this Flutter project that requires untracked private files like secrets.dart, Firebase configs, etc. Use when this capability is needed.
metadata:
  author: k8zdev
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/k8zdev) — claim your Tome and manage your conversions.
