---
name: pytest-coder
description: Write comprehensive pytest tests with fixtures, parametrization, mocking, async testing, and modern patterns. Use when this capability is needed.
metadata:
  author: kaisero
---
...
---
> Source: [kaisero/scm-chainguard](https://github.com/kaisero/scm-chainguard) — distributed by [TomeVault](https://tomevault.io).
