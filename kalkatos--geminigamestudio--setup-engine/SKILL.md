---
name: setup-engine
description: Configure the project's game engine and version. Pins the engine in GEMINI.md, detects knowledge gaps, and populates engine reference docs via WebSearch when the version is beyond the LLM's training data. Use when this capability is needed.
metadata:
  author: kalkatos
---
...
---
> Source: [kalkatos/GeminiGameStudio](https://github.com/kalkatos/GeminiGameStudio) — distributed by [TomeVault](https://tomevault.io).
