---
name: skills-sync
description: DEPRECATED - Use skill-manager instead. This skill is kept for backward compatibility. For syncing skills: use 'skills sync' from skill-manager. Use when this capability is needed.
metadata:
  author: kang-chen
---
