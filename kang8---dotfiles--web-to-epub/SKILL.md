---
name: web-to-epub
description: 将在线书籍网站（每章一个页面）转换为 EPUB 电子书。提供网站 URL 即可自动抓取、提取正文、生成带目录的 EPUB。 Use when this capability is needed.
metadata:
  author: kang8
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kang8) — claim your Tome and manage your conversions.
