...
### 与相邻 skill 的区分
- 与 `never-issue-shares` 的区别：不用股票收购是绝对原则，第一法则是具体判断
...
---
> Source: [kangarooking/buffett-letters-skill](https://github.com/kangarooking/buffett-letters-skill) — distributed by [TomeVault](https://tomevault.io).
