---
name: algo-sensei
description: Your personal DSA & LeetCode mentor. Use for problem explanations, progressive hints, code reviews, mock interviews, pattern recognition, complexity analysis, and custom problem generation. Automatically adapts to your learning style and request type. Use when this capability is needed.
metadata:
  author: karanb192
---
...
---
> Source: [karanb192/algo-sensei](https://github.com/karanb192/algo-sensei) — distributed by [TomeVault](https://tomevault.io).
