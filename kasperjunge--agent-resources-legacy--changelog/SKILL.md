---
name: changelog
description: Generate and maintain CHANGELOG.md following Keep a Changelog format. Use when creating a changelog, updating after releases, or when the user says "changelog", "/changelog", or asks to document project history. Analyzes git history and existing changelog to produce a properly formatted changelog. Use when this capability is needed.
metadata:
  author: kasperjunge
---
