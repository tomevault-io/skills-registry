...
description: Make design changes to Hugo sites across templates, partials, HTML, and CSS/Tailwind while preserving the site's visual system. Use when this capability is needed.
metadata:
  author: kaushikgopal
---
...
---
> Source: [kaushikgopal/henry-hugo](https://github.com/kaushikgopal/henry-hugo) — distributed by [TomeVault](https://tomevault.io).
