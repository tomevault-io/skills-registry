---
name: design
description: 方案设计阶段详细规则；进入方案设计时读取；包含方案构思、任务拆解、风险评估、方案包创建 Use when this capability is needed.
metadata:
  author: kaze-sn
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kaze-sn) — claim your Tome and manage your conversions.
