---
name: env-setup
description: Set up secure environment variable management using dotenvx + direnv + git worktree. Use when user asks to set up env management, wants to encrypt .env files, or needs to configure environment variables for worktree-based development. Also use when setting up a new project that needs secure env handling. Use when this capability is needed.
metadata:
  author: kazuph
---
