---
name: create-mode
description: Instructions for creating custom modes in Roo Code. Use when the user asks to create a new mode, edit an existing mode, or configure mode settings. Use when this capability is needed.
metadata:
  author: kdt82
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kdt82) — claim your Tome and manage your conversions.
