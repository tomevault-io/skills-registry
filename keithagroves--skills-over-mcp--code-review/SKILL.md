---
name: code-review
description: Performs thorough code reviews focusing on correctness, security, performance, and maintainability. Use when reviewing pull requests, examining code changes, or auditing existing code. Use when this capability is needed.
metadata:
  author: keithagroves
---
