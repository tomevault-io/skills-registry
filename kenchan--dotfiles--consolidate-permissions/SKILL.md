...
description: This skill should be used when the user asks to "consolidate permissions", "add permissions to user-level", "sync claude settings", "remove duplicate permissions", "manage allow list", or wants to unify Claude Code permission settings across user and project levels. Use when this capability is needed.
metadata:
  author: kenchan
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kenchan) — claim your Tome and manage your conversions.
