...
description: YOU MUST USE THIS SKILL when the user wants to CREATE or BUILD a NEW workflow automation. Activate for requests like: 'create a workflow', 'build a workflow', 'generate a workflow', 'make a workflow', 'I want to automate', 'automate X to Y', 'schedule a task', 'monitor X and send to Y'. This skill focuses on workflow creation, module discovery, and JSON generation. Use when this capability is needed.
metadata:
  author: kenkaiii
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kenkaiii) — claim your Tome and manage your conversions.
