...
description: 谷歌关键词竞争度分析。当用户要求分析某个关键词的搜索竞争度、SEO难度、关键词排名机会、市场调研，或要求"分析下XXX关键词"时触发。使用浏览器抓取Google搜索结果页作为主要数据源，输出结构化竞争度报告。 Use when this capability is needed.
metadata:
  author: kennyzir
---
...
---
> Source: [kennyzir/7deer_skills](https://github.com/kennyzir/7deer_skills) — distributed by [TomeVault](https://tomevault.io).
