...
description: Best practices for using agent-browser with Kernel cloud browsers. Use when automating websites with agent-browser -p kernel, dealing with bot detection, iframes, login persistence, or needing to find Kernel browser session IDs and live view URLs. Use when this capability is needed.
metadata:
  author: kernel
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kernel) — claim your Tome and manage your conversions.
