...
description: Build browser automation scripts using the Kernel Python SDK with Playwright and remote browser management. Use when this capability is needed.
metadata:
  author: kernel
---
