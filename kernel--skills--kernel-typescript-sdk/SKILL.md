...
description: Build browser automation scripts using the Kernel TypeScript SDK with Playwright, CDP, and remote browser management. Use when this capability is needed.
metadata:
  author: kernel
---
