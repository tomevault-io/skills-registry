---
name: clawfeed
description: AI-powered news digest tool. Automatically generates structured summaries (4H/daily/weekly/monthly) from Twitter and RSS feeds. Use when this capability is needed.
metadata:
  author: kevinho
---
# ClawFeed
...
---
> Source: [kevinho/clawfeed](https://github.com/kevinho/clawfeed) — distributed by [TomeVault](https://tomevault.io).
