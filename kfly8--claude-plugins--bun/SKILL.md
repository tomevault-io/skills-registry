---
name: bun
description: Default to using Bun instead of Node.js for all JavaScript/TypeScript operations including running files, testing, building, and package management. Use when this capability is needed.
metadata:
  author: kfly8
---
