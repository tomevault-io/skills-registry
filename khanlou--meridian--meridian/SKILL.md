---
name: meridian-stack
description: Build or modify Meridian-based Swift server apps that render HTML via the HTML/Swim DSL, define routes with property wrappers, and query Postgres via a Database.swift layer. Use for: adding routes, request parsing, middleware, responses/errors, HTML rendering, SchemaSwift-generated models, or server wiring in Meridian projects. Use when this capability is needed.
metadata:
  author: khanlou
---
...
---
> Source: [khanlou/Meridian](https://github.com/khanlou/Meridian) — distributed by [TomeVault](https://tomevault.io).
