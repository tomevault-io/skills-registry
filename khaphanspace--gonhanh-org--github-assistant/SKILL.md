...
description: GitHub workflow automation using `gh` CLI. Use when creating PRs, reviewing code, managing issues, auto-replying to fixed issues, adding comments, assigning users, managing labels, merging PRs, or checking CI status. Includes auto-reply script and Vietnamese templates. Use when this capability is needed.
metadata:
  author: khaphanspace
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/khaphanspace) — claim your Tome and manage your conversions.
