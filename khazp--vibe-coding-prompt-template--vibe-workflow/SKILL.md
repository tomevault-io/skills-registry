---
name: vibe-workflow
description: Complete 5-step workflow to build an MVP from idea to launch. Use when the user wants to start a new project from scratch, go through the full workflow, or says "help me build an MVP", "start new project", or "vibe coding workflow". Use when this capability is needed.
metadata:
  author: khazp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/khazp) — claim your Tome and manage your conversions.
