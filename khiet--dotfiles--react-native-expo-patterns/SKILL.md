...
description: Write maintainable React Native / Expo code with disciplined component design, hook hygiene, Zustand state management, and platform-aware patterns. Use when this capability is needed.
metadata:
  author: khiet
---
...
---
> Source: [khiet/dotfiles](https://github.com/khiet/dotfiles) — distributed by [TomeVault](https://tomevault.io).
