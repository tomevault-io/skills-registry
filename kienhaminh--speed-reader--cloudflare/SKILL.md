---
name: cloudflare
description: Guide for building applications on Cloudflare's edge platform. Use when implementing serverless functions (Workers), edge databases (D1), storage (R2, KV), real-time apps (Durable Objects), AI features (Workers AI, AI Gateway), static sites (Pages), or any edge computing solutions. Use when this capability is needed.
metadata:
  author: kienhaminh
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kienhaminh) — claim your Tome and manage your conversions.
