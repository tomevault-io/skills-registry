---
name: primevue
description: Setup and use PrimeVue UI component library in Vue/Vite projects with auto-import, theming, and component configuration. Use when working with PrimeVue components, setting up PrimeVue in a Vue project, configuring themes (Aura, Lara, etc.), or implementing auto-import for PrimeVue components. Use when this capability is needed.
metadata:
  author: kindy
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kindy) — claim your Tome and manage your conversions.
