---
name: create-skill
description: Guides users through creating effective Agent Skills. Use when the user wants to create, write, or author a new skill, or asks about skill structure, best practices, or SKILL.md format. Use when this capability is needed.
metadata:
