---
name: test-writing
description: テストコードを書く際のベストプラクティスとルール。テストファイルを作成・編集する際に自動適用されます。 Use when this capability is needed.
metadata:
  author: kitagry
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kitagry) — claim your Tome and manage your conversions.
