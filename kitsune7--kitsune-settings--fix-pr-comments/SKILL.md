...
description: Pulls down all comments for a given PR URL using the GitHub CLI, finds unresolved concerns, validates they are real issues, and fixes them. Use when this capability is needed.
metadata:
  author: kitsune7
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kitsune7) — claim your Tome and manage your conversions.
