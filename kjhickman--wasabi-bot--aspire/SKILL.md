...
Use `aspire start` to run the AppHost in the background.
...
- In this repository, do not use `--isolated` unless the user explicitly asks for it. It can prevent dashboard telemetry and trace collection from working as expected here.
...
---
> Source: [kjhickman/wasabi-bot](https://github.com/kjhickman/wasabi-bot) — distributed by [TomeVault](https://tomevault.io).
