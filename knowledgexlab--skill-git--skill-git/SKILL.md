...
description: Extract a structured list of rules from all markdown files at the top level of a skill directory. Use this skill whenever you need to parse rules out of a skill for conflict checking, merging, or diffing. Use when this capability is needed.
metadata:
...
---
> Source: [KnowledgeXLab/skill-git](https://github.com/KnowledgeXLab/skill-git) — distributed by [TomeVault](https://tomevault.io).
