---
name: codigo-limpo
description: Princípios e padrões de código limpo para o projeto Konecty backend. Aplica KISS, YAGNI, DRY, SOLID, prefer-const, programação funcional, p-limit para concorrência e error handling centralizado. Use ao gerar ou revisar código Node.js/TypeScript backend. Use when this capability is needed.
metadata:
  author: konecty
---
