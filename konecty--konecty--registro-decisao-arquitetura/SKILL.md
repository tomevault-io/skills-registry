...
description: Use esta skill ao documentar decisões arquiteturais significativas. Fornece templates de RDA seguindo o formato Nygard com seções para contexto, decisão, consequências e alternativas. Ajuda equipes a manter memória arquitetural e justificativas para sistemas backend, designs de API, escolhas de banco de dados e decisões de infraestrutura. Use when this capability is needed.
metadata:
  author: konecty
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/konecty) — claim your Tome and manage your conversions.
