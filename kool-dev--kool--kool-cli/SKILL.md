---
name: kool-cli
description: Docker development environment CLI. Use for managing containers (start/stop/restart), executing commands in services, viewing logs, and running project scripts from kool.yml. Use when this capability is needed.
metadata:
  author: kool-dev
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kool-dev) — claim your Tome and manage your conversions.
