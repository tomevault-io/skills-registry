...
description: Code refactoring patterns and techniques for improving code quality without changing behavior. Use for cleaning up legacy code, reducing complexity, or improving maintainability. Use when this capability is needed.
metadata:
  author: kousw
---
...
6. **Run project scripts** - Lint/format/test using repo scripts (e.g., `bun run lint`, `bun run format`, `bun run test`)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kousw) — claim your Tome and manage your conversions.
