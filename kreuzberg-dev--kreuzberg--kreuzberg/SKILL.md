...
description: Plugin architecture, registration, and trait patterns Use when this capability is needed.
metadata:
...
---
> Source: [kreuzberg-dev/kreuzberg](https://github.com/kreuzberg-dev/kreuzberg) — distributed by [TomeVault](https://tomevault.io).
