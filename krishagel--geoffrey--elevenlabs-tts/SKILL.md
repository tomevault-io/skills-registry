---
name: elevenlabs-tts
description: Generate high-quality audio from text using Eleven Labs API. Use for podcasts, narration, voice-overs, and audio summaries. Use when this capability is needed.
metadata:
  author: krishagel
---
