...
> **Activation:** Use this skill at the start of any HTML/CSS or client-side JS task — modals, animations, CWV performance, Web APIs, layout, forms, framework UI — to retrieve current best-practice guides before implementing. Do NOT use for backend SQL/ORM logic, CI/CD pipelines, Docker, or server-side-only tasks.
