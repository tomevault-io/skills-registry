...
description: When the user repeats the same correction or convention multiple times, suggest a Cursor rule to encode it permanently. Use when this capability is needed.
metadata:
  author: kscius
---
...
- Don't be annoying â€” only suggest after a genuine repeated pattern, not on the first correction
- Keep rule files small and focused â€” one concern per file
