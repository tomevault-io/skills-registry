...
description: Extract durable working preferences from recent Cursor chats and convert them into skills, rules, or workflow docs. Use when asked to learn preferences, mine feedback, personalize workflows, or generate team/person-specific agent guidance. Use when this capability is needed.
metadata:
  author: kscius
---
...
- asked to learn preferences, mine feedback, personalize workflows, or generate team/person-specific agent guidance

> **On-demand loading:** Read this file when the task matches the triggers below.

> **Activation:** Use this skill when asked to learn working preferences from recent Cursor chats, mine feedback, personalize workflows, or generate team/person-specific agent guidance — producing skills, rules, or workflow docs from extracted preference atoms. Do NOT use for summarizing chat content without the goal of encoding reusable guidance.
