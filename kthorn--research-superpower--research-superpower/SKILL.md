...
description: Safely remove intermediate files from completed research sessions while preserving important data Use when this capability is needed.
metadata:
  author: kthorn
---
...
---
> Source: [kthorn/research-superpower](https://github.com/kthorn/research-superpower) — distributed by [TomeVault](https://tomevault.io).
