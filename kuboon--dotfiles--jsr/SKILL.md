---
name: jsr
description: jsr release workflow for Deno projects. Use when publishing or releasing packages to JSR (JavaScript Registry) using Deno. Use when this capability is needed.
metadata:
  author: kuboon
---
