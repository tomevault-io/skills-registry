---
name: kkrpc
description: Build bidirectional RPC systems in TypeScript with kkrpc. Create RPC channels, expose APIs, use multiple transports (stdio, WebSocket, HTTP), handle callbacks, property access, and errors across Node.js, Deno, Bun, and browsers. Use when this capability is needed.
metadata:
  author: kunkunsh
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kunkunsh) — claim your Tome and manage your conversions.
