...
description: Build and test Kurtosis from source on local Docker. Compiles all components (engine, core, files-artifacts-expander), builds Docker images, installs the CLI, and restarts the engine. Use when developing Kurtosis and testing changes locally with Docker. Use when this capability is needed.
metadata:
...
---
> Source: [kurtosis-tech/kurtosis](https://github.com/kurtosis-tech/kurtosis) — distributed by [TomeVault](https://tomevault.io).
