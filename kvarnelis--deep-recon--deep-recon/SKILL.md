---
name: deep-recon
description: Run extended multi-agent reconnaissance sessions. Use when asked to brainstorm deeply, explore ideas from multiple angles, or generate a structured recon document. Use when this capability is needed.
metadata:
  author: kvarnelis
---
...
---
> Source: [kvarnelis/deep-recon](https://github.com/kvarnelis/deep-recon) — distributed by [TomeVault](https://tomevault.io).
