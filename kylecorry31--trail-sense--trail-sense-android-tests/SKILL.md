...
description: Add UI automation tests to Trail-Sense Android app using AutomationLibrary. Use when asked to create, add, write, or implement automated tests, UI tests, integration tests, or androidTests for Trail Sense tools. Covers test class structure, AutomationLibrary functions, and testing patterns. Use when this capability is needed.
metadata:
  author: kylecorry31
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kylecorry31) — claim your Tome and manage your conversions.
