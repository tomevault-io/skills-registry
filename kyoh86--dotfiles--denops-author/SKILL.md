---
name: denops-author
description: Best practices for Denops plugin implementation drawn from lambdalisue's Denops plugins. Use when Codex needs concrete patterns for buffer/local/global/env vars, key mappings, and Vimscript/TypeScript boundaries in Denops plugins based on those repos. Use when this capability is needed.
metadata:
  author: kyoh86
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/kyoh86) — claim your Tome and manage your conversions.
