---
name: gogh-cli
description: Use for everyday gogh CLI operations, including auth/roots/config plus overlay, script, hook, and extra workflows. Use when this capability is needed.
metadata:
  author: kyoh86
---
