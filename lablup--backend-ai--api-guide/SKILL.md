---
name: api-guide
description: Guide for implementing REST and GraphQL APIs (create, get, search, update, delete, purge, scope prefix patterns, admin_ prefix, SearchScope, BaseFilterAdapter, @api_function, Click CLI) Use when this capability is needed.
metadata:
  author: lablup
---
