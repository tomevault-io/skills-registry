---
name: bep-guide
description: Guide for writing and managing BEPs (Backend.AI Enhancement Proposals) - creation workflow, document segmentation, context-for-ai blocks, Decision Log Use when this capability is needed.
metadata:
  author: lablup
---
