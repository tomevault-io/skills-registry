---
name: release
description: Guide the Backend.AI release process - run release.sh, generate changelog via towncrier, consolidate RC entries for final releases with subsection grouping. Use when this capability is needed.
metadata:
  author: lablup
---
