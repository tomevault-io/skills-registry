...
description: Analyze vphone600 kernel artifacts using the local symbol database and XNU source tree. Use when working on kernel reverse engineering, address-to-symbol lookup, release-vs-research kernel comparison, or patch analysis for vphone600 variants in this repository. Use when this capability is needed.
metadata:
  author: Lakr233
---
...
---
> Source: [Lakr233/vphone-cli](https://github.com/Lakr233/vphone-cli) — distributed by [TomeVault](https://tomevault.io).
