---
name: ai-notes
description: Manage AI notes in ~/Compost/AI-Notes - read existing notes, list recent documents, and write new implementation plans (仕様書, 計画書, 設計書). Auto-triggers when reading from or writing to notes, specifications, or plans. Use when this capability is needed.
metadata:
  author: lambdalisue
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lambdalisue) — claim your Tome and manage your conversions.
