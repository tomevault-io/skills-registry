---
name: cc-cursor-cc
description: Cursor PM でアイデアを検証し Plans.md を更新してバトンタッチ。Cursor ↔ Claude Code 2-Agent ワークフロー対応。Use when user mentions Cursor PM handoff, 2-agent plan validation, CC-Cursor round trip, or brainstorm review. Do NOT load for: implementation work, single-agent tasks, or direct coding. Use when this capability is needed.
metadata:
  author: lane2077
---
...
---
> Source: [lane2077/claude-code-harness-zh](https://github.com/lane2077/claude-code-harness-zh) — distributed by [TomeVault](https://tomevault.io).
