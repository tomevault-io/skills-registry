---
name: git
description: Git version control and GitHub CLI workflows for commits, branches, pull requests, and code reviews with professional commit message practices. Use when this capability is needed.
metadata:
  author: lanej
---
