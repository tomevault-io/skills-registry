---
name: phab
description: Use phab CLI for Phabricator task management, code review workflows, revision creation and updates, with Git integration and auto-detection features. Use when this capability is needed.
metadata:
  author: lanej
---
