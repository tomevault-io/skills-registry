---
name: python
description: Use uv for fast Python project management, script execution, dependency handling, and tool installation. AVOID pip - always use uv commands (uv add, uv sync, uv run) instead. Use when this capability is needed.
metadata:
  author: lanej
---
