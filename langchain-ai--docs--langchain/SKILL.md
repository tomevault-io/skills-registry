---
name: langchain
description: Build agents with a prebuilt architecture and integrations for any model or tool. Use when creating tool-calling agents, switching model providers, or adding structured output. Use when this capability is needed.
metadata:
  author: langchain-ai
---
