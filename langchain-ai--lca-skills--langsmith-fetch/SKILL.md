...
description: Fetches LangSmith traces for debugging agent behavior. Use when troubleshooting agent issues, reviewing conversation history, or investigating tool calls. Use when this capability is needed.
metadata:
  author: langchain-ai
---
