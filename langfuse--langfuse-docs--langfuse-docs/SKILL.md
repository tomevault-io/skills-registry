...
description: Add a new team member to Langfuse's canonical team data and shared team table. Use when onboarding a new employee who needs to appear on the website team, press, about, careers, or handbook pages. Use when this capability is needed.
metadata:
  author: langfuse
---
...
---
> Source: [langfuse/langfuse-docs](https://github.com/langfuse/langfuse-docs) — distributed by [TomeVault](https://tomevault.io).
