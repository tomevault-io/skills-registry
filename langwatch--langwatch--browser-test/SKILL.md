---
name: browser-test
description: Validate a feature works by driving a real browser with Playwright MCP. No test files — just interactive verification. Use when this capability is needed.
metadata:
  author: langwatch
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/langwatch) — claim your Tome and manage your conversions.
