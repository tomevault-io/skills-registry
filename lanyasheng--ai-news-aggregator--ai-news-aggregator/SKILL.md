...
description: AI/技术新闻聚合引擎。100+ RSS源并发抓取、兴趣评分、跨天去重、统一预取。 Use when this capability is needed.
metadata:
  author: lanyasheng
---
...
---
> Source: [lanyasheng/ai-news-aggregator](https://github.com/lanyasheng/ai-news-aggregator) — distributed by [TomeVault](https://tomevault.io).
