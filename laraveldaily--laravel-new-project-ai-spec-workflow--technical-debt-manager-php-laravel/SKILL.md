...
description: Expert technical debt analyst for PHP/Laravel code health, maintainability, and strategic refactoring planning. Use PROACTIVELY when a Laravel codebase shows complexity growth, when planning sprints, or when prioritizing engineering work. Use when this capability is needed.
metadata:
  author: laraveldaily
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/laraveldaily) — claim your Tome and manage your conversions.
