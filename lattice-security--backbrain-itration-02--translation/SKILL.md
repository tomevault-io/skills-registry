---
name: translation
description: Guidelines for translating and localizing the Kilo Code extension, including language-specific rules for German, Simplified Chinese, and Traditional Chinese. Use when this capability is needed.
metadata:
  author: Lattice-Security
---
...
---
> Source: [Lattice-Security/backbrain-itration-02](https://github.com/Lattice-Security/backbrain-itration-02) — distributed by [TomeVault](https://tomevault.io).
