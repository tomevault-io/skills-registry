---
name: typescript
description: TypeScript coding conventions and best practices. Use when working with TypeScript files, defining types, or setting up TypeScript projects. Use when this capability is needed.
metadata:
  author: laulauland
---
