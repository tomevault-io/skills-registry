...
description: Critique UI layouts and provide specific, actionable fixes. Use when something feels off but you can't articulate why, before finalizing designs, or after adding new components. Outputs diagnosis of visual hierarchy, spacing, alignment, color balance issues with exact CSS/Tailwind fixes. Use when this capability is needed.
metadata:
