...
description: Fast file finding using fd command-line tool with smart defaults, gitignore awareness, and parallel execution. Use when searching for files by name, extension, or pattern across directories. Use when this capability is needed.
metadata:
  author: laurigates
---
