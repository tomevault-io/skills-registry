...
description: Generate 1280x640 PNG social preview images for GitHub repositories using nano-banana-pro. Use when user mentions social preview, Open Graph image, or needs repository images for social media sharing. Use when this capability is needed.
metadata:
  author: laurigates
---
