---
name: rg-code-search
description: Fast code search using ripgrep (rg) with smart defaults, regex patterns, and file filtering. Use when searching for text patterns, code snippets, or performing multi-file code analysis. Use when this capability is needed.
metadata:
  author: laurigates
---
