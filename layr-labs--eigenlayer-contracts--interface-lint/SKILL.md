---
name: interface-lint
description: Format and lint Solidity interface files following EigenLayer conventions. Use when the user asks to format an interface, add documentation to an interface, or create a new interface. Ensures proper organization with Errors/Events/Types sub-interfaces. Use when this capability is needed.
metadata:
  author: layr-labs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/layr-labs) — claim your Tome and manage your conversions.
