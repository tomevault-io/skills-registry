---
name: wps-ppt
description: WPS 演示智能助手，通过自然语言操控 PPT，解决排版美化、内容生成、动画设置等痛点问题 Use when this capability is needed.
metadata:
  author: lc2panda
---
...
---
> Source: [lc2panda/wps-skills](https://github.com/lc2panda/wps-skills) — distributed by [TomeVault](https://tomevault.io).
