...
description: Enforces the project's core TypeScript standards including explicit typing, import organization, class member ordering, and code safety rules. ALWAYS apply when creating, modifying, or reviewing any TypeScript (.ts/.tsx) file. Use when this capability is needed.
metadata:
  author: ldapts
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ldapts) — claim your Tome and manage your conversions.
