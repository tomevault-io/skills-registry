...
description: Write the Highlights section for Lean 4 release notes. Use when asked to write, draft, or update release highlights for a Lean version. Use when this capability is needed.
metadata:
  author: leanprover
---
...
---
> Source: [leanprover/lean4](https://github.com/leanprover/lean4) — distributed by [TomeVault](https://tomevault.io).
