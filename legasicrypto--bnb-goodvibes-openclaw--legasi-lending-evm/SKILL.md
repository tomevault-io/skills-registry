...
description: Autonomous USDC borrowing for AI agents on BNB Smart Chain Testnet. Deposit collateral, borrow USDC, earn LP yield, use flash loans. Use when this capability is needed.
metadata:
  author: legasicrypto
---
