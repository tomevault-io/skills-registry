...
description: Create new Agent Skills following the official specification and best practices. Use when the user wants to create a skill, write a SKILL.md file, or package instructions/workflows for reuse across conversations. Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/leocavalcante) — claim your Tome and manage your conversions.
