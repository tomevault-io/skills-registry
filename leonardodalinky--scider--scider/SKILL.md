...
description: Evaluate scientific claims and evidence quality, assess experimental design validity, identify biases and confounders, and apply evidence grading frameworks (GRADE, Cochrane Risk of Bias). Use when this capability is needed.
metadata:
...
---
> Source: [leonardodalinky/SciDER](https://github.com/leonardodalinky/SciDER) — distributed by [TomeVault](https://tomevault.io).
