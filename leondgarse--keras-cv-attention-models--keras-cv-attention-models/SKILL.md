...
description: Converting PyTorch model weights to Keras h5 format for keras_cv_attention_models Use when this capability is needed.
metadata:
  author: leondgarse
---
...
---
> Source: [leondgarse/keras_cv_attention_models](https://github.com/leondgarse/keras_cv_attention_models) — distributed by [TomeVault](https://tomevault.io).
