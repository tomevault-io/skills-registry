...
description: `@expo/ui/jetpack-compose` package lets you use Jetpack Compose Views and modifiers in your app. Use when this capability is needed.
metadata:
  author: LeonDvlpmnt
---
...
---
> Source: [LeonDvlpmnt/react-raptor](https://github.com/LeonDvlpmnt/react-raptor) — distributed by [TomeVault](https://tomevault.io).
