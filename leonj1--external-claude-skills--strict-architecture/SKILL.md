...
description: Enforces universal strict governance rules (500 lines, 5 funcs, 4 args) and interface-first I/O for Python, Golang, and .NET. Use when this capability is needed.
metadata:
  author: leonj1
---
