---
name: slow-down
description: Pacing guidance for relational, identity-forming, or emotionally costly work. Slows only when speed risks bypassed understanding or human contact. Use when this capability is needed.
metadata:
  author: leovoon
---
...
---
> Source: [leovoon/slow-down](https://github.com/leovoon/slow-down) — distributed by [TomeVault](https://tomevault.io).
