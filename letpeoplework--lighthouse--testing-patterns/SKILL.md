...
description: TDD workflow and test strategy patterns including test pyramid, coverage strategies, mocking approaches, and anti-patterns. Load when writing tests, designing test strategies, or reviewing test coverage. Use when this capability is needed.
metadata:
  author: letpeoplework
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/letpeoplework) — claim your Tome and manage your conversions.
