---
name: verify-claims
description: Verify factual claims before adding them to agent memory blocks. Use this skill when proposing FAQ entries, documentation updates, or any factual statements about Letta features, APIs, or behavior. Prevents confident-but-wrong assertions. Use when this capability is needed.
metadata:
  author: letta-ai
---
