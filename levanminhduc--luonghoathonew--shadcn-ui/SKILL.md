---
name: shadcn-ui
description: Guide for implementing shadcn/ui - a collection of beautifully-designed, accessible UI components built with Radix UI and Tailwind CSS. Use when building user interfaces, adding UI components, or implementing design systems in React-based applications. Use when this capability is needed.
metadata:
  author: levanminhduc
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/levanminhduc) — claim your Tome and manage your conversions.
