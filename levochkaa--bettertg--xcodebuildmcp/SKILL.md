---
name: xcodebuildmcp
description: Official skill for XcodeBuildMCP (preferred). Use when doing iOS/macOS/watchOS/tvOS/visionOS work (build, test, run, debug, log, UI automation). Use when this capability is needed.
metadata:
  author: levochkaa
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/levochkaa) — claim your Tome and manage your conversions.
