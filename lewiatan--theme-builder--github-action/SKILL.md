---
name: github-action
description: Create or modify GitHub Actions workflows and CI/CD pipelines with best practices and up-to-date action versions (project) Use when this capability is needed.
metadata:
  author: lewiatan
---
