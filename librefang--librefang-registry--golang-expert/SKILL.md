---
name: golang-expert
description: Go programming expert for goroutines, channels, interfaces, modules, and concurrency patterns Use when this capability is needed.
metadata:
  author: librefang
---
...
---
> Source: [librefang/librefang-registry](https://github.com/librefang/librefang-registry) — distributed by [TomeVault](https://tomevault.io).
