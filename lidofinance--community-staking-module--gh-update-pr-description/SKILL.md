...
description: Update the current-branch GitHub PR title, description, and labels with gh CLI using this repository's PR template. Use when asked to inspect template/labels and apply concise PR metadata updates. Use when this capability is needed.
metadata:
  author: lidofinance
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lidofinance) — claim your Tome and manage your conversions.
