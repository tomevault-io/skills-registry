...
description: Apply the Lightdash frontend style guide when working on React components, migrating Mantine v6 to v8, or styling frontend code. Use when editing TSX files, fixing styling issues, or when user mentions Mantine, styling, or CSS modules. Use when this capability is needed.
metadata:
  author: lightdash
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lightdash) — claim your Tome and manage your conversions.
