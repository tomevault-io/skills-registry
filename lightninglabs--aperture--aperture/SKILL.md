---
name: aperture
description: Manage Aperture L402 reverse proxy via aperturecli. Use when creating/updating/deleting services, checking transactions, managing tokens, viewing stats, or changing pricing on an Aperture instance. Use when this capability is needed.
metadata:
...
---
> Source: [lightninglabs/aperture](https://github.com/lightninglabs/aperture) — distributed by [TomeVault](https://tomevault.io).
