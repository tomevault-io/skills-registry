...
description: Generate SAP Fiori Launchpad URLs from app names using AppList.json. Looks up app information by name and constructs proper FLP URLs with required parameters like sap-client and sap-language. Use when this capability is needed.
metadata:
  author: likweitan
---
