...
- **Bundled Skills**: `项目目录/skills/` - Built-in skills included with the application
- **Workspace Skills**: `~/.myagent/skills/` - User-created or custom skills

When creating a new skill, you can place it in either location:
- Use **bundled** for skills that should be shared with all users
- Use **workspace** for personal, user-specific skills
