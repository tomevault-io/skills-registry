...
description: Diagnose and fix Lingui SWC plugin compatibility errors with Next.js, Rspack, or other SWC runtimes. Use when seeing errors like "failed to invoke plugin", "failed to run Wasm plugin transform", "out of bounds memory access", or "LayoutError" during builds with @lingui/swc-plugin. Use when this capability is needed.
metadata:
  author: lingui
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lingui) — claim your Tome and manage your conversions.
