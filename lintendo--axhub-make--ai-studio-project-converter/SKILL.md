...
description: 将 Google AI Studio 生成的 React 项目转换为本项目页面组件的流程规范；在处理 Import Map、样式迁移、依赖安装、环境变量与验收时使用。 Use when this capability is needed.
metadata:
  author: lintendo
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lintendo) — claim your Tome and manage your conversions.
