...
> **Vendored from [onmax/nuxt-skills](https://github.com/onmax/nuxt-skills) (MIT).** See `.claude/skills/NOTICE.md`.
...
- **Header:** `@linuxfoundation/lfx-ui-core` web component (client-only)
...
---
> Source: [linuxfoundation/lfx-crowdfunding](https://github.com/linuxfoundation/lfx-crowdfunding) — distributed by [TomeVault](https://tomevault.io).
