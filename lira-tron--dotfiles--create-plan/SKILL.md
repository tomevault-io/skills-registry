---
name: create-plan
description: Create implementation plans with requirements, design, and tasks. Use when planning new features or components. Generates three files with approval gates at each phase. Use when this capability is needed.
metadata:
  author: lira-tron
---
