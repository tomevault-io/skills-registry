...
description: Generate foundational steering documents (product.md, tech.md, structure.md) for current workspace by analyzing codebase. Use when starting new projects or documenting existing ones. Use when this capability is needed.
metadata:
  author: lira-tron
---
