...
description: Add new BSB-LAN parameters to the python-bsblan library. Use this skill when adding parameter IDs, updating models, or extending the API to support new heating controller parameters. Use when this capability is needed.
metadata:
  author: liudger
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/liudger) — claim your Tome and manage your conversions.
