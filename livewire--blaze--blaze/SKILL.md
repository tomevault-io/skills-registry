---
name: blaze-optimize
description: Set up and optimize Blade component rendering with Blaze. Use when installing Blaze, optimizing components, or configuring @blaze directives and strategies. Use when this capability is needed.
metadata:
  author: livewire
---
...
---
> Source: [livewire/blaze](https://github.com/livewire/blaze) — distributed by [TomeVault](https://tomevault.io).
