---
name: file-downloads
description: Add file download and export functionality (CSV, Excel, PDF, JSON) to a Goravel entity page using the existing client-side export system. Also covers chart PNG capture. Use when this capability is needed.
metadata:
  author: liwoo
---
