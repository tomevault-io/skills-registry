...
description: 确保引用代码时使用可点击跳转的格式。当显示、引用或讨论代码库中现有的代码时使用。Use when showing code from the codebase, referencing existing files, or discussing specific code locations. Use when this capability is needed.
metadata:
  author: lixiaoquan
---
