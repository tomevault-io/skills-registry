---
name: marknative
description: `marknative-skill` is an [agent skill](https://www.npmjs.com/package/marknative-skill) for Claude Code. Once installed, Claude automatically knows how to use the marknative CLI — you can ask it to render any Markdown file without explaining the flags yourself. Use when this capability is needed.
metadata:
  author: liyown
---
# Claude Code Skill
