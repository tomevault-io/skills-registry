---
name: pr-transcript
description: Export the current Pi session transcript to an HTML file for inclusion in a pull request. Use when the user is ready to submit a PR and wants to include an AI session transcript. Use when this capability is needed.
metadata:
  author: llimllib
---
