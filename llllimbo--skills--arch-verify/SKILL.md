---
name: arch-verify
description: Verify Java architecture rules with ArchUnit. Use when you need to define or validate package or layer boundaries, dependency constraints, slices, or cyclic dependencies in Java projects, including during refactors or when adding governance checks to CI builds. Use when this capability is needed.
metadata:
  author: llllimbo
---
