---
name: product-prd
description: Generate a Product Requirements Document (PRD) for feature development. Creates PRDs with user stories optimized for AI agent execution. Use when this capability is needed.
metadata:
  author: llllimbo
---
