---
name: web-haptics
description: Add haptic feedback to web apps using the web-haptics library. Use when building mobile-facing UIs that need tactile feedback on buttons, toggles, forms, pickers, and other interactive elements. Use when this capability is needed.
metadata:
  author: lochie
---
...
---
> Source: [lochie/web-haptics](https://github.com/lochie/web-haptics) — distributed by [TomeVault](https://tomevault.io).
