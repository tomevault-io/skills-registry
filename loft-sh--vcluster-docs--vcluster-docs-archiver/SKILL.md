...
description: Archive End-of-Life vCluster documentation versions. Use this skill when creating EOL documentation branches for vCluster or Platform versions. Handles branch creation, Docusaurus configuration, link fixing, Netlify deployment, and main branch updates. Use when this capability is needed.
metadata:
  author: loft-sh
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/loft-sh) — claim your Tome and manage your conversions.
