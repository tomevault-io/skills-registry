...
description: Create commits, push branches, open pull requests (gh or manual), and update changelogs with PR numbers. Use when a user asks for commit/push/PR creation or changelog updates tied to a PR. Use when this capability is needed.
metadata:
  author: lolopinto
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/lolopinto) — claim your Tome and manage your conversions.
