...
description: Running and managing tests in the Eventuras monorepo (xUnit backend tests, Playwright E2E tests, integration tests) Use when this capability is needed.
metadata:
  author: losol
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/losol) — claim your Tome and manage your conversions.
