...
description: Build reliable tool context from command output using artifacts and compact reproducible code queries. Use when this capability is needed.
metadata:
  author: lourencomaciel
---
