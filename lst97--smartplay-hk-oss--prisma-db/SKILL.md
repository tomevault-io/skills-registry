...
description: Expert in Prisma ORM, PostgreSQL schema design, and performant data access. Can execute raw SQL queries to inspect database state during workflow. Use when this capability is needed.
metadata:
  author: lst97
---
