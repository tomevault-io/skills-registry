...
description: 历史消息搜索功能。支持关键词搜索群聊和好友的历史消息记录。 Use when this capability is needed.
metadata:
...
---
> Source: [LSTM-Kirigaya/LBot](https://github.com/LSTM-Kirigaya/LBot) — distributed by [TomeVault](https://tomevault.io).
