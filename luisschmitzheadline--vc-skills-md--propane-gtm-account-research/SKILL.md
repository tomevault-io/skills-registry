...
description: Research a company or person and get actionable GTM intel. Works standalone with web search, supercharged when you connect ~~data enrichment~~ or ~~CRM~~. Trigger with "research [company]", "look up [person]", "intel on [prospect]", "who is [name] at [company]", or "tell me about [company]". Use when this capability is needed.
metadata:
