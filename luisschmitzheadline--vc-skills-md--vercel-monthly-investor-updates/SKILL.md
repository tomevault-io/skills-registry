...
description: This skill should be used when the user asks to "write an investor update", "draft monthly update", "send investor email", "create investor newsletter", "prepare investor communication", or mentions monthly updates, investor emails, LP updates, or stakeholder communication for a VC-backed startup. Use when this capability is needed.
metadata:
