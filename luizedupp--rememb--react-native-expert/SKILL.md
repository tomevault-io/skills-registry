...
description: Build, optimize, and debug cross-platform mobile applications with React Native and Expo. Use when the user needs navigation setup, native-module integration, mobile performance work, or platform-specific iOS and Android handling. Use when this capability is needed.
metadata:
  author: LuizEduPP
---
...
---
> Source: [LuizEduPP/Rememb](https://github.com/LuizEduPP/Rememb) — distributed by [TomeVault](https://tomevault.io).
