---
name: terrashark
description: Prevent Terraform/OpenTofu hallucinations by diagnosing and fixing failure modes: identity churn, secret exposure, blast-radius mistakes, CI drift, and compliance gate gaps. Use when generating, reviewing, refactoring, or migrating IaC and when building delivery/testing pipelines. Use when this capability is needed.
metadata:
  author: LukasNiessen
---
...
---
> Source: [LukasNiessen/terrashark](https://github.com/LukasNiessen/terrashark) — distributed by [TomeVault](https://tomevault.io).
