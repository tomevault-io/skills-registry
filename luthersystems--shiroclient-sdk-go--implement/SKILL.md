---
name: implement
description: Core development loop for making code changes. Use when implementing features, fixing bugs, or refactoring. Triggers: 'implement', 'make a change', 'add feature', 'fix bug'. Use when this capability is needed.
metadata:
