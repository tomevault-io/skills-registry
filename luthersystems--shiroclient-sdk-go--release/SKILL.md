---
name: release
description: Create a new release with a semver tag and GitHub release. Triggers: 'release', 'cut a release', 'tag a new version', 'create release'. Use when this capability is needed.
metadata:
