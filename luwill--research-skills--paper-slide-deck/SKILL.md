...
description: Generate professional slide deck images from academic papers and content. Creates comprehensive outlines with style instructions, auto-detects figures from PDFs, then generates individual slide images. Use when user asks to "create slides", "make a presentation", "generate deck", or "slide deck" for papers. Use when this capability is needed.
metadata:
  author: luwill
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/luwill) — claim your Tome and manage your conversions.
