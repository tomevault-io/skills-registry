...
**Personal skills live in agent-specific directories (for example `~/.codex/skills`, `~/.claude/skills`, or equivalent locations for your tool).** 
...
**Official guidance:** For Anthropic's official skill authoring best practices, see `skill-best-practices.md` in this folder. This document provides additional patterns and guidelines that complement the TDD-focused approach in this skill.
...
**IMPORTANT: Use task tracker to create todos for EACH checklist item below.**
