---
name: ai-detector
description: Evidence-based AI-generated text risk analysis for essays, emails, reviews, articles, messages, and other prose samples. Use when this capability is needed.
metadata:
  author: lynote-ai
---
