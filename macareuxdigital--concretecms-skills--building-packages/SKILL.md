...
description: Create and manage Concrete CMS packages. Use this skill when the user asks to create a custom package or manage existing packages. Use when this capability is needed.
metadata:
