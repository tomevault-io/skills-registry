...
description: 指导将单个页面从Vue2升级到Vue3的完整迁移流程，包括分析源页面、类型定义、API方法、页面代码转换、路由注册和UI验证。适用于mall-app-vue3项目的页面迁移工作。 Use when this capability is needed.
metadata:
  author: macrozheng
---
...
---
> Source: [macrozheng/mall-app-web](https://github.com/macrozheng/mall-app-web) — distributed by [TomeVault](https://tomevault.io).
