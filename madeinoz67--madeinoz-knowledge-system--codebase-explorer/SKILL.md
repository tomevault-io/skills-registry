...
description: Deep codebase exploration using semantic search and relationship mapping. Use when you need to understand the current codebase. Use when this capability is needed.
metadata:
  author: madeinoz67
---
