...
description: Add authorization methods for a new entity to AuthorizationService. Use after creating a resource service. Triggers on "add permissions", "authorization methods", "entity permissions", "add auth methods". Use when this capability is needed.
metadata:
  author: madooei
---
