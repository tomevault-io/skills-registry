---
name: add-error-type
description: Add a new custom error type for domain-specific errors. Use when creating errors for specific business rules or HTTP status codes. Triggers on "add error", "custom error", "error type". Use when this capability is needed.
metadata:
  author: madooei
---
