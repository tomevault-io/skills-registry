---
name: use-dom
description: Use Expo DOM components to run web code in a webview on native and as-is on web. Migrate web code to native incrementally. Use when this capability is needed.
metadata:
  author: magicappdev
---
