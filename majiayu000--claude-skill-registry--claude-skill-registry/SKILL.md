---
name: form-patterns
description: DaisyUI v5 form patterns. Use for inputs, selects, textareas, validation, and form structure with fieldset/legend. Use when this capability is needed.
metadata:
  author: majiayu000
---
