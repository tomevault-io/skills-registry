...
Instead of asking "What is the MVP?" or "How do we fix the bug?", ask: **"What could be?"**
This pushes the team to imagine the most ambitious, "soulful" version of a solution that transcends basic utility.
