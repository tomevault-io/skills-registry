---
name: shadcn-ui
description: Using shadcn/ui component library for UI components. Use when creating or modifying UI components in .tsx files. Use when this capability is needed.
metadata:
  author: makeprisms
---
