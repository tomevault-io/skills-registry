---
name: laravelinertia
description: Ship Laravel UI integration changes (Livewire/Inertia) with stable contracts and predictable state behavior. Use for inertia tasks. Use when this capability is needed.
metadata:
  author: makfly
---
