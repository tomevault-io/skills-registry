---
name: laravelproject-structure
description: Apply production-grade Laravel architecture and execution discipline for focused, low-risk delivery. Use for project structure tasks. Use when this capability is needed.
metadata:
  author: makfly
---
