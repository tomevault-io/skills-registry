...
description: Apply production-grade Laravel architecture and execution discipline for focused, low-risk delivery. Use for quality checks tasks. Use when this capability is needed.
metadata:
  author: makfly
---
