---
name: laravelrequests-validation
description: Strengthen Laravel validation/auth/authorization boundaries with explicit failure-safe implementation patterns. Use for requests validation tasks. Use when this capability is needed.
metadata:
  author: makfly
---
