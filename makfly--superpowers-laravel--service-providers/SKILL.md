---
name: laravelservice-providers
description: Apply production-grade Laravel architecture and execution discipline for focused, low-risk delivery. Use for service providers tasks. Use when this capability is needed.
metadata:
  author: makfly
---
