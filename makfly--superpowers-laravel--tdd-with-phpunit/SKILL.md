---
name: laraveltdd-with-phpunit
description: Deliver Laravel behavior safely with test-first workflows and deterministic regression protection. Use for tdd with phpunit tasks. Use when this capability is needed.
metadata:
  author: makfly
---
