---
name: laraveltesting-database
description: Deliver Laravel behavior safely with test-first workflows and deterministic regression protection. Use for testing database tasks. Use when this capability is needed.
metadata:
  author: makfly
---
