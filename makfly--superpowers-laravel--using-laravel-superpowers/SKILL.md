...
description: Apply production-grade Laravel architecture and execution discipline for focused, low-risk delivery. Use for using laravel superpowers tasks. Use when this capability is needed.
metadata:
  author: makfly
---
