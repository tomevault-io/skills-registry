---
name: symfonyapi-platform-dto-resources
description: Deliver robust API Platform contracts in Symfony with explicit operations, mapping, and policy-safe behavior. Use for api platform dto resources tasks. Use when this capability is needed.
metadata:
  author: makfly
---
