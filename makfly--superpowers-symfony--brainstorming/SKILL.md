---
name: symfonybrainstorming
description: Apply production-grade Symfony architecture and execution workflows with controlled scope and clear checkpoints. Use for brainstorming tasks. Use when this capability is needed.
metadata:
  author: makfly
---
