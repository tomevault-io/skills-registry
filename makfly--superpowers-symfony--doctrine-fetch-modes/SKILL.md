...
description: Evolve Symfony Doctrine models and schema safely with integrity, performance, and rollout discipline. Use for doctrine fetch modes tasks. Use when this capability is needed.
metadata:
  author: makfly
---
