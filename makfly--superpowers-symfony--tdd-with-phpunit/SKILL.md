...
description: Drive Symfony delivery with deterministic tests and strong regression protection. Use for tdd with phpunit tasks. Use when this capability is needed.
metadata:
  author: makfly
---
