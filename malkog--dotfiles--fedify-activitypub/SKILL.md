...
description: Guide for building and maintaining ActivityPub/fediverse applications using Fedify. This skill should be used when users want to create federated social applications, implement ActivityPub protocols, build new features, test and debug federation, deploy to production, look up FEPs, or maintain existing Fedify applications. Use when this capability is needed.
metadata:
  author: malkog
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/malkog) — claim your Tome and manage your conversions.
