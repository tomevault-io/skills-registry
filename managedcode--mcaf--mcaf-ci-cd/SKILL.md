---
name: mcaf-ci-cd
description: Design or refine CI/CD workflows, quality gates, release flow, and safe AI-assisted pipeline authoring. Use when adding or changing build pipelines, release stages, IaC-driven environments, or deployment rollback policy. Use when this capability is needed.
metadata:
  author: managedcode
---
