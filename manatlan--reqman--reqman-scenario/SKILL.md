...
description: Create distinctive, production-grade reqman scenario with high quality. Use this skill when the user asks to build a reqman scenario. Generates creative, polished code (this skill is under construction). (more info https://github.com/manatlan/reqman) Use when this capability is needed.
metadata:
  author: manatlan
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/manatlan) — claim your Tome and manage your conversions.
