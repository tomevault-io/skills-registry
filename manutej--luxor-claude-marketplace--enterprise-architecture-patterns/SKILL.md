...
description: Complete guide for enterprise architecture patterns including domain-driven design, event sourcing, CQRS, saga patterns, API gateway, service mesh, and scalability Use when this capability is needed.
metadata:
  author: manutej
---
