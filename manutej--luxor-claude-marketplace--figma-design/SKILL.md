---
name: figma-design
description: Figma workflows, components, auto layout, constraints, prototyping, design systems, and plugin development based on Figma Plugin API documentation Use when this capability is needed.
metadata:
  author: manutej
---
