---
name: ux-principles
description: User research, usability heuristics, user psychology, accessibility, inclusive design, user testing, and UX metrics Use when this capability is needed.
metadata:
  author: manutej
---
