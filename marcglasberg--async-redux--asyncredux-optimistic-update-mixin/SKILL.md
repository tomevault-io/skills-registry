...
description: Add the OptimisticUpdate mixin for instant UI feedback before server confirmation. Covers immediate state changes, automatic rollback on failure, and optionally notifying users of rollback. Use when this capability is needed.
metadata:
  author: marcglasberg
---
