...
description: Predict what an article will say, then score how much it exceeded the prediction. Use when the user wants to evaluate whether an article is worth reading. Use when this capability is needed.
metadata:
  author: marcus-crane
---
...
---
> Source: [marcus-crane/dotfiles](https://github.com/marcus-crane/dotfiles) — distributed by [TomeVault](https://tomevault.io).
