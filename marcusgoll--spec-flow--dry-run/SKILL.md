---
name: dry-run
description: Preview command effects without making changes. Simulates file writes, git operations, agent spawns, and state changes. All reads execute normally for accurate preview. Use --dry-run flag on any command. Use when this capability is needed.
metadata:
  author: marcusgoll
---
