...
description: Generate regression tests when bugs are discovered during /debug or continuous checks. Auto-detects test framework, creates Arrange-Act-Assert tests, and links to error-log.md entries. (project) Use when this capability is needed.
metadata:
  author: marcusgoll
---
