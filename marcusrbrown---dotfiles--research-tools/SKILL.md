---
name: research-tools
description: External research via Context7 (docs), Grep.app (code examples), Exa (web search), and Tavily (web search). Loads MCPs on-demand via skill_mcp. Use when this capability is needed.
metadata:
  author: marcusrbrown
---
