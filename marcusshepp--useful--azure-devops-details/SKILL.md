...
description: Retrieve complete details for specific Azure DevOps work items by ID, including all fields, comments, change history, and related items. Use when the user asks about a specific ticket number or needs full context on a work item. PAT token in .env file at network/.env. Use when this capability is needed.
metadata:
  author: marcusshepp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/marcusshepp) — claim your Tome and manage your conversions.
