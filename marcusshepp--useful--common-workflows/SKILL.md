...
description: Common patterns and workflows for Azure DevOps and database queries. Use to avoid inefficient searches and tangents. Use when this capability is needed.
metadata:
  author: marcusshepp
---
