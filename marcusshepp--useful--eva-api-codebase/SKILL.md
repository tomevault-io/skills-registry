...
description: Navigate and understand the EvaAPI codebase structure. Use when searching for models, services, controllers, migrations, or any code related to Eva database entities. Helps locate where specific features are implemented. Use when this capability is needed.
metadata:
  author: marcusshepp
---
