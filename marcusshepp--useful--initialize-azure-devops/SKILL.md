...
description: Set up connection to Azure DevOps organization and project. Required before using any Azure DevOps commands. Use when starting a new session. Use when this capability is needed.
metadata:
  author: marcusshepp
---
