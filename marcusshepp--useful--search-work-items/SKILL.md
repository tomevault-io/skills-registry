...
description: Search for Azure DevOps work items using text search and filters. IMPORTANT - Only use Bug or User Story types by default, exclude Enabler and other types. Use when this capability is needed.
metadata:
  author: marcusshepp
---
