---
name: flux-migrate
description: Build zero-downtime database migrations — forward SQL, rollback SQL, deployment sequence. Use when asked to "write migration", "schema change", "add column", "rename table", "drop column", or "migrate safely". Use when this capability is needed.
metadata:
  author: mark1ian
---
...
---
> Source: [mark1ian/jeremylongshore-claude-code-plugins-plus-skills](https://github.com/mark1ian/jeremylongshore-claude-code-plugins-plus-skills) — distributed by [TomeVault](https://tomevault.io).
