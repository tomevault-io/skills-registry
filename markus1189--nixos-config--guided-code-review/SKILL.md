...
description: Conducts an interactive, chunk-by-chunk code review of commits for a ticket or branch. Builds a mental model from story/commits, maps changes, then walks through logical groups with the reviewer. Accumulates findings for a structured final summary. Trigger: user asks for a 'guided code review'. Use when this capability is needed.
metadata:
  author: markus1189
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/markus1189) — claim your Tome and manage your conversions.
