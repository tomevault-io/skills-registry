---
name: code-review
description: This skill should be used when the user asks to "review code", "check changes", "analyze a PR", "do a security review", or "assess code quality" — providing comprehensive review across correctness, security, performance, accessibility, and testing. Use when this capability is needed.
metadata:
  author: markus41
---
