---
name: lookup-docs
description: Look up documentation for any library using Context7. Resolves library IDs and queries versioned docs. Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/marshall-hallenbeck) — claim your Tome and manage your conversions.
