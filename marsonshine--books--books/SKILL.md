---
name: books
description: | name                 | description                                                  | Use when this capability is needed.
metadata:
  author: MarsonShine
---
| name                 | description                                                  |
...
---
> Source: [MarsonShine/Books](https://github.com/MarsonShine/Books) — distributed by [TomeVault](https://tomevault.io).
