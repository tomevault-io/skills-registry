...
description: Python development standards including pytest, ruff, black, and mypy. Use when working with Python files, tests, or dependencies. Use when this capability is needed.
metadata:
  author: martimramos
---
