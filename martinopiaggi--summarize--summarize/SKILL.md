---
name: summarize
description: Transcribe and summarize videos from YouTube, local files, Google Drive, Dropbox, and social media platforms (TikTok, Instagram, Twitter/X, Reddit) using any OpenAI-compatible LLM. Use when asked to summarize, analyze, extract insights, fact-check, or create study materials from video content. Use when this capability is needed.
metadata:
  author: martinopiaggi
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/martinopiaggi) — claim your Tome and manage your conversions.
