---
name: brainstorm
description: This skill should be used when the user asks to "brainstorm", "design a feature", "think through an idea", "help me plan", or has a vague concept that needs refining into a technical specification through collaborative dialogue. Use when this capability is needed.
metadata:
  author: martintrojer
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/martintrojer) — claim your Tome and manage your conversions.
