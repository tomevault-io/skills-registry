---
name: execute-plan
description: This skill should be used when the user asks to "execute the plan", "run the plan", "implement the plan", or wants to follow through on a plan created by /write-plan. Use when this capability is needed.
metadata:
  author: martintrojer
---
