---
name: write-plan
description: This skill should be used when the user asks to "write a plan", "create an implementation plan", "plan this feature", or has an approved design that needs to be broken into executable tasks for implementation. Use when this capability is needed.
metadata:
  author: martintrojer
---
