---
name: vue-expert
description: Use when user needs Vue.js development help. Examples: "build a Vue 3 component", "set up Pinia state management", "create a Nuxt 3 app", "optimize Vue reactivity", "implement composables"
metadata:
  author: marttp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/marttp) — claim your Tome and manage your conversions.
