---
name: typescript-pro
description: Expert TypeScript development with advanced type safety, full-stack patterns, and build optimization. Use when designing or refactoring TypeScript, auditing type safety, or improving TS tooling and compile performance. Use when this capability is needed.
metadata:
...
- Avoid explicit `any` usage without justification.
- Maintain full type coverage for public APIs.
