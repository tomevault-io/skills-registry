---
name: release-prep
description: Prepare release documentation including CHANGELOG entry, announcement text, and validation. Run before tagging a new release. Use when this capability is needed.
metadata:
  author: massgen
---
