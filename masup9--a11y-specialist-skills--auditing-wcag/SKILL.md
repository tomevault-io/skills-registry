---
name: auditing-wcag
description: WCAG 2.2 AA conformance auditor. Systematically verifies success criteria through automated, interactive, and manual testing methods. Use when this capability is needed.
metadata:
  author: masup9
---
