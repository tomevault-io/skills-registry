...
description: WCAG audit planning support based on WAIC test guidelines. Helps determine audit scope, page selection method, and generates audit plan documents. Use when this capability is needed.
metadata:
  author: masup9
---
