...
3. **Escopo**: Pessoal (~/.gemini/skills/) ou projeto (./.gemini/skills/)
...
```
./.gemini/commands/nome-do-comando.md
```
...
```
./.gemini/skills/git-commit-analyzer/
└── SKILL.md
```
...
```
.gemini/commands/security-audit.md
```
