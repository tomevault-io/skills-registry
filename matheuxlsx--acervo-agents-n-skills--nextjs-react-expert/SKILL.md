...
| Need | Skill |
|------|-------|
| API design patterns | `@[.agent/skills/api-patterns]` |
| Database optimization | `@[.agent/skills/database-design]` |
| Testing strategies | `@[.agent/skills/testing-patterns]` |
| UI/UX design principles | `@[.agent/skills/frontend-design]` |
| TypeScript patterns | `@[.agent/skills/typescript-expert]` |
| Deployment & DevOps | `@[.agent/skills/deployment-procedures]` |
