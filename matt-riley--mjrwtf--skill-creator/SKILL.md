...
AgentSkills-compatible frontmatter may include optional fields (e.g., license, compatibility, metadata, allowed-tools) when they help the runner constrain tooling or document requirements. Keep frontmatter concise because it is always loaded.
