...
description: API actions for managing seasons and competitions — create seasons, register corps, create and run competitions, get scores and recaps Use when this capability is needed.
metadata:
  author: mattbillock
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mattbillock) — claim your Tome and manage your conversions.
