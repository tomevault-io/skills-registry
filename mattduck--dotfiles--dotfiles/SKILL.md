---
name: md-commit
description: Git commit using standard layout Use when this capability is needed.
metadata:
  author: mattduck
---
...
---
> Source: [mattduck/dotfiles](https://github.com/mattduck/dotfiles) — distributed by [TomeVault](https://tomevault.io).
