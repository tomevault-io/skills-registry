...
description: Reviews Focus SQL query builder implementations for correctness and type safety. Use when examining expressions, columns, statements, clauses, SQL generation code, or visitor pattern implementations. Use when this capability is needed.
metadata:
  author: matthewmcgarvey
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/matthewmcgarvey) — claim your Tome and manage your conversions.
