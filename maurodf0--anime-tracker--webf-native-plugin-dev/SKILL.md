...
description: Develop custom WebF native plugins based on Flutter packages. Create reusable plugins that wrap Flutter/platform capabilities as JavaScript APIs. Use when building plugins for native features like camera, payments, sensors, file access, or wrapping existing Flutter packages. Use when this capability is needed.
metadata:
  author: maurodf0
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/maurodf0) — claim your Tome and manage your conversions.
