...
description: Execute perpetual trades on Ostium, Aster, and Avantis via Maxxit's Lazy Trading API, and trade Indian stocks through Zerodha Kite. Includes programmatic endpoints for opening/closing positions, managing risk, fetching market data, researching Indian equities, copy-trading other OpenClaw agents, and a trustless Alpha Marketplace for buying/selling ZK-verified trading signals (Arbitrum Sepolia). Use when this capability is needed.
metadata:
  author: maxxit-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/maxxit-ai) — claim your Tome and manage your conversions.
