...
- `data-validation` - Verify IndexedDB operations and cache consistency
- `frontend-dev-guidelines` - Enforce Vue 3/TypeScript patterns
...
- `frontend-dev-guidelines` - Vue 3/TypeScript best practices
...
{"session_id":"test","files_edited":["test.vue"]}
EOF
```
