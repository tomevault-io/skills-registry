---
name: mcpp-style-ref
description: 为 mcpp 项目应用 Modern/Module C++ (C++23) 编码风格。适用于编写或审查带模块的 C++ 代码、命名标识符、组织 .cppm/.cpp 文件，或用户提及 mcpp、module C++、现代 C++ 风格时。 Use when this capability is needed.
metadata:
  author: mcpp-community
---
...
---
> Source: [mcpp-community/mcpp-style-ref](https://github.com/mcpp-community/mcpp-style-ref) — distributed by [TomeVault](https://tomevault.io).
