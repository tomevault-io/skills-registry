...
description: End-to-end workflow for triaging, reproducing, fixing, and shipping a GitHub issue. Use when the user provides a GitHub issue URL or issue number and asks to investigate, reproduce, fix, or create a PR for it. Covers: checking whether the issue is already resolved, reproducing the bug in the example app, applying the fix, committing on a new branch, and opening a PR linked to the issue. Use when this capability is needed.
metadata:
  author: mduccc
---
...
---
> Source: [mduccc/flutter_calendar_week](https://github.com/mduccc/flutter_calendar_week) — distributed by [TomeVault](https://tomevault.io).
