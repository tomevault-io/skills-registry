---
name: web-search
description: Web search using DuckDuckGo (free, unlimited). Falls back to Brave Search API for content extraction or when ddgr fails. Use when this capability is needed.
metadata:
  author: megalithic
---
