...
- Trigger this skill on natural-language requests for Vue 3, Nuxt 3, Pinia, Composition API, or Vue+TypeScript implementation.
- Use `$vue-expert` as the command-style label when providing examples.
- For larger app migrations or audits, use Codex multi-agent delegation (`spawn_agent` + `wait`) and synthesize findings into one delivery.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/megastep) — claim your Tome and manage your conversions.
