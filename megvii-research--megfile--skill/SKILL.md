---
name: megfile
description: Use megfile’s APIs, SmartPath, configuration, and CLI to perform filesystem tasks easy across local FS, S3/OSS-style object storage, SFTP, WebDAV, HTTP, HDFS, and stdio. Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/megvii-research) — claim your Tome and manage your conversions.
