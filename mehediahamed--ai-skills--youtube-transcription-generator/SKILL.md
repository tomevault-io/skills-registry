...
description: Use VLM Run (vlmrun) to generate transcriptions from YouTube videos. Download a video with yt-dlp, then run vlmrun to transcribe with optional timestamps. VLMRUN_API_KEY must be in .env; follow vlmrun-cli-skill for CLI setup and options. Use when this capability is needed.
metadata:
  author: mehediahamed
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mehediahamed) — claim your Tome and manage your conversions.
