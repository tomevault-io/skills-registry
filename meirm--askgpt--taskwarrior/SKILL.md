---
name: taskwarrior
description: Manage tasks using taskwarrior CLI. Use this when the user wants to add, list, complete, modify, delete, or search tasks, set priorities, due dates, tags, or work with task contexts and reports. Use when this capability is needed.
metadata:
  author: meirm
---
