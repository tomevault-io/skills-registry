---
name: techdebt
description: Find and fix technical debt including duplicated code, dead code, outdated patterns, and code smells. Run at the end of sessions to clean up. Use when this capability is needed.
metadata:
  author: meleantonio
---
