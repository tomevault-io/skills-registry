---
name: write-changelog-item
description: Create/write the changelog item / release note for a given Github PR and update the docs release PR description. Use when this capability is needed.
metadata:
  author: memgraph
---
