---
name: deploy
description: Deploy MimiClaw firmware to an ESP32-S3 board. Covers prerequisites, configuration, build, flash, verification, and troubleshooting. Use when this capability is needed.
metadata:
  author: memovai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/memovai) — claim your Tome and manage your conversions.
