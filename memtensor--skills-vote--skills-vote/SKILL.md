...
description: Download videos and audio from 1500+ websites including YouTube, Bilibili, TikTok, Twitter/X, Instagram, Vimeo, and more using yt-dlp. Use when the user wants to download videos, save media from social platforms, download with specific resolution (720p/1080p/4K), get subtitles, or download entire playlists. Triggers on requests like 'download this video', 'save this YouTube video', 'download in 1080p', 'download with subtitles', 'download this playlist'. Use when this capability is needed.
metadata:
  author: MemTensor
---
...
---
> Source: [MemTensor/skills-vote](https://github.com/MemTensor/skills-vote) — distributed by [TomeVault](https://tomevault.io).
