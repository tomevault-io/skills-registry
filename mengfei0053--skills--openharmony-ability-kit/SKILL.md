...
description: 用于使用 Ability Kit 开发 OpenHarmony 应用时 - UIAbility 生命周期、使用 Want 进行组件通信、Context API、ExtensionAbility、BundleManager,或处理错误如 16000001(ability 未找到)、16000011(context 不存在)等 Use when this capability is needed.
metadata:
  author: mengfei0053
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mengfei0053) — claim your Tome and manage your conversions.
