---
name: culture-craft
description: Designs team culture and sets standards of excellence using David Singleton (Stripe) and Dharmesh Shah (HubSpot) frameworks. Use when building teams, setting cultural values, creating rituals, or establishing excellence standards. Use when this capability is needed.
metadata:
  author: menkesu
---
