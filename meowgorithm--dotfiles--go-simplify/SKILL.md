---
name: go-simplify
description: Simplify and refine Go code for clarity, consistency, and maintainability while preserving functionality. Use when asked to "simplify", "clean up", or "refactor" Go code, after writing complex code that could benefit from simplification, or when Go code has grown hard to follow. Use when this capability is needed.
metadata:
  author: meowgorithm
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/meowgorithm) — claim your Tome and manage your conversions.
