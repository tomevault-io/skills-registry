---
name: git-workflow
description: Branch naming, commit conventions, and workflow steps for clean git history. Triggers on: commit, branch, merge, git, PR, pull request. Use when this capability is needed.
metadata:
  author: Mercurium-Group
---
...
---
> Source: [Mercurium-Group/context-mogging](https://github.com/Mercurium-Group/context-mogging) — distributed by [TomeVault](https://tomevault.io).
