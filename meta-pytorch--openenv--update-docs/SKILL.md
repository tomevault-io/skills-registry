---
name: update-docs
description: Update documentation across the repo after API changes. Finds stale references in docs, examples, docstrings, and fixes them. Use when this capability is needed.
metadata:
  author: meta-pytorch
---
