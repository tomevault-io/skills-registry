...
description: 企业AI场景地图生成报告工具。通过 web-search 深度调研企业信息，按照V2.1标准模板生成结构化AI应用场景地图报告，包含企业画像、业务诊断、行业实践、AI场景全量表、实施路径等完整内容。 Use when this capability is needed.
metadata:
  author: MetaInFLow
---
...
---
> Source: [MetaInFLow/Enterprise-ai-scenario-map-skill](https://github.com/MetaInFLow/Enterprise-ai-scenario-map-skill) — distributed by [TomeVault](https://tomevault.io).
