---
name: mirrord-ci
description: Help users set up mirrord in CI pipelines for testing against real Kubernetes environments. Use when users want to run end-to-end tests, integration tests, or automated tests in CI using mirrord to connect to staging/shared clusters. Use when this capability is needed.
metadata:
  author: metalbear-co
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/metalbear-co) — claim your Tome and manage your conversions.
