---
name: use-fullpath
description: Ensure .NET projects use `Meziantou.Framework.FullPath` for local file path manipulation instead of raw strings. Use when: reviewing or writing code that constructs, combines, compares, or passes around local file/directory paths as strings in .NET/C# projects. Use when this capability is needed.
metadata:
  author: meziantou
---
