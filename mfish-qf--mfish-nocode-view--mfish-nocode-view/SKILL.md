...
description: name: add-screen-component Use when this capability is needed.
metadata:
  author: mfish-qf
---
﻿---
...
---
> Source: [mfish-qf/mfish-nocode-view](https://github.com/mfish-qf/mfish-nocode-view) — distributed by [TomeVault](https://tomevault.io).
