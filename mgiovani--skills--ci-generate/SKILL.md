---
name: ci-generate
description: Generate CI/CD pipeline configurations for GitHub Actions, GitLab CI, CircleCI, or Jenkins. This skill should be used when users want to create CI/CD workflows, set up automated pipelines, generate deployment configurations, or add continuous integration to a project. Use when this capability is needed.
metadata:
  author: mgiovani
---
