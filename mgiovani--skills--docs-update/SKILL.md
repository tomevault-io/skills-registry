---
name: docs-update
description: Update documentation by synchronizing with the current codebase state. This skill should be used when users want to refresh stale documentation, sync docs with code changes, or update specific documentation files or categories. Use when this capability is needed.
metadata:
  author: mgiovani
---
