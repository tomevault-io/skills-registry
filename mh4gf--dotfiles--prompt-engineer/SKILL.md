...
description: MUST use when editing CLAUDE.md, SKILL.md, or slash commands. Applies prompt engineering best practices regardless of task size. Use when this capability is needed.
metadata:
  author: mh4gf
---
