...
description: Create HTML technical documentation with code blocks, API workflows, system architecture diagrams, and syntax highlighting. Use when users request technical documentation, API docs, API references, code examples, or developer documentation. Use when this capability is needed.
metadata:
  author: mhattingpete
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mhattingpete) — claim your Tome and manage your conversions.
