---
name: gh-pr-issue
description: Keep pull requests and issues healthy using gh CLI (list, view, comment, close). Use when this capability is needed.
metadata:
  author: mholmes91
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mholmes91) — claim your Tome and manage your conversions.
