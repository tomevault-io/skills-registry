...
description: Simplifies and refines Go code for clarity, consistency, and maintainability while preserving all functionality. Use when Gemini CLI needs to refactor recently modified code, improve readability, or align with Go-specific best practices in the ServiceNow SDK. Use when this capability is needed.
metadata:
...
---
> Source: [michaeldcanady/servicenow-sdk-go](https://github.com/michaeldcanady/servicenow-sdk-go) — distributed by [TomeVault](https://tomevault.io).
