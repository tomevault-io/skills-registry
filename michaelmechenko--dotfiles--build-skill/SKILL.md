---
name: build-skill
description: Create effective skills for OpenCode agents. Load FIRST before writing any SKILL.md. Provides required format, naming conventions, progressive disclosure patterns, and validation. Use when building, reviewing, or debugging skills. Use when this capability is needed.
metadata:
  author: michaelmechenko
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/michaelmechenko) — claim your Tome and manage your conversions.
