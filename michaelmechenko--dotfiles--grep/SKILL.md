---
name: grep
description: Use ripgrep (rg) to search any folder/file for context. Use when you need to find code patterns, search across projects, count matches, or explore unfamiliar codebases. Use when this capability is needed.
metadata:
