...
description: Generate session handoff summaries for context preservation. Use at session end, before breaks, or when transferring context to new session/agent. Use when this capability is needed.
metadata:
