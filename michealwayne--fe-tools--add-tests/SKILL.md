---
name: add-tests
description: Add or update Jest unit tests for fe-tools utilities. Writes test cases, verifies coverage for common behavior, edge cases, and error inputs. Use when new functions are added, existing behavior changes, or the user asks to add tests across utils, web-utils, node-utils, canvas-utils, or ai-utils. Use when this capability is needed.
metadata:
  author: michealwayne
---
# Add Tests
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/michealwayne) — claim your Tome and manage your conversions.
