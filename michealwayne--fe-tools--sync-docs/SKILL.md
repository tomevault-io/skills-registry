---
name: sync-docs
description: Regenerate or verify documentation for fe-tools. Generates API reference from TypeDoc comments, checks for missing documentation, and validates code-doc alignment. Use when the user asks to update docs, generate TypeDoc output, or verify documentation alignment. Use when this capability is needed.
metadata:
  author: michealwayne
---
# Sync Docs
