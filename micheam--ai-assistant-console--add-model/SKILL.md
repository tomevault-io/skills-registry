---
name: add-model
description: Add a new AI model to a provider (anthropic, openai, groq, cerebras). Use when a new model is announced and needs to be supported in aico. Use when this capability is needed.
metadata:
  author: micheam
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/micheam) — claim your Tome and manage your conversions.
