...
description: Fetch unresolved PR review comments using GitHub GraphQL API, filtering out resolved and outdated feedback. Use when this capability is needed.
metadata:
  author: microck
---
