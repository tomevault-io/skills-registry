---
name: provider-naming
description: Enforces consistent naming for provider auxiliary functions in src/providers/. Use when creating, renaming, or reviewing provider modules or their tests. Use when this capability is needed.
metadata:
  author: microlinkhq
---
...
---
> Source: [microlinkhq/unavatar](https://github.com/microlinkhq/unavatar) — distributed by [TomeVault](https://tomevault.io).
