...
description: Find and close stale bug issues in microsoft/AzureStorageExplorer. Use this when asked to clean up stale issues, close inactive bugs, or perform issue hygiene. Use when this capability is needed.
metadata:
  author: microsoft
---
...
---
> Source: [microsoft/AzureStorageExplorer](https://github.com/microsoft/AzureStorageExplorer) — distributed by [TomeVault](https://tomevault.io).
