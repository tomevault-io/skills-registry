...
description: Prepare a release for the Feature Management .NET SDK. Use when user mentions release preparation, version bump, creating merge PRs, preview release, or stable release for this project. Use when this capability is needed.
metadata:
  author: microsoft
---
...
---
> Source: [microsoft/FeatureManagement-Dotnet](https://github.com/microsoft/FeatureManagement-Dotnet) — distributed by [TomeVault](https://tomevault.io).
