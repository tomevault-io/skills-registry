...
description: Fix all vulnerabilities on the current branch using npm audit. Local branch only — no ADO/GitHub queries. Use when this capability is needed.
metadata:
  author: microsoft
---
...
---
> Source: [microsoft/powerplatform-build-tools](https://github.com/microsoft/powerplatform-build-tools) — distributed by [TomeVault](https://tomevault.io).
