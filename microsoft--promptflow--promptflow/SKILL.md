---
name: promptflow
description: This skill wraps a Microsoft Agent Framework (`agent-framework`) workflow into Use when this capability is needed.
metadata:
  author: microsoft
---
---
...
---
> Source: [microsoft/promptflow](https://github.com/microsoft/promptflow) — distributed by [TomeVault](https://tomevault.io).
