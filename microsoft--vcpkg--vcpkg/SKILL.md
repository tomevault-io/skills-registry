---
name: vcpkg
description: generates a report by package and triplet.
metadata:
  author: microsoft
---
---
...
---
> Source: [microsoft/vcpkg](https://github.com/microsoft/vcpkg) — distributed by [TomeVault](https://tomevault.io).
