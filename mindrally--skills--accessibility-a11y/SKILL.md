...
description: Implement web accessibility (a11y) best practices following WCAG guidelines to create inclusive, accessible user interfaces. Use when this capability is needed.
metadata:
  author: mindrally
---
