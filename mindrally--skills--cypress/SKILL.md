---
name: cypress
description: Cypress end-to-end testing best practices for web applications, covering test structure, commands, and reliability patterns. Use when this capability is needed.
metadata:
  author: mindrally
---
