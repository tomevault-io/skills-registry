...
description: Guidelines for integrating Figma designs with development workflows using MCP servers and best practices Use when this capability is needed.
metadata:
  author: mindrally
---
