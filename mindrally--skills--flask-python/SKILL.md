---
name: flask-python
description: Guidelines for Flask Python development with best practices for blueprints, RESTful APIs, and application factories. Use when this capability is needed.
metadata:
  author: mindrally
---
