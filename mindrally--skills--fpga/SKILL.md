---
name: fpga
description: FPGA development guidelines covering Vivado, SystemVerilog, timing closure, AXI interfaces, and hardware optimization. Use when this capability is needed.
metadata:
  author: mindrally
---
