---
name: htmx
description: HTMX development guidelines for building dynamic web applications with minimal JavaScript using HTML attributes. Use when this capability is needed.
metadata:
  author: mindrally
---
