---
name: kysely
description: Guidelines for developing with Kysely, a type-safe TypeScript SQL query builder with autocompletion support Use when this capability is needed.
metadata:
  author: mindrally
---
