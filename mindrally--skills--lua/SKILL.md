---
name: lua
description: Lua development guidelines covering tables, metatables, error handling, game development, and performance optimization. Use when this capability is needed.
metadata:
  author: mindrally
---
