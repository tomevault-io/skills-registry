---
name: react-query
description: Guidelines for using React Query for data fetching, caching, and server state synchronization in React applications Use when this capability is needed.
metadata:
  author: mindrally
---
