...
description: Comprehensive guidelines for Django REST API development covering project structure, views, models, serializers, authentication, performance, and error handling. Use when this capability is needed.
metadata:
  author: mindrally
---
