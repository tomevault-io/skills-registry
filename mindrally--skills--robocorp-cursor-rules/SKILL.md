...
description: Guidelines for building RoboCorp RPA automation with Python, emphasizing functional programming, Pydantic validation, and async operations. Use when this capability is needed.
metadata:
  author: Mindrally
---
