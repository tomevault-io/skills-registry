---
name: pdf-processing
description: Comprehensive PDF processing techniques for handling large files that exceed Claude Code's reading limits, including chunking strategies, text/table extraction, and OCR for scanned documents. Use when working with PDFs larger than 10-15MB or more than 30-50 pages. Use when this capability is needed.
metadata:
  author: ming-kai-lc
---
