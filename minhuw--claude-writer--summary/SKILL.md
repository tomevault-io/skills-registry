---
name: summary
description: This skill should be used when providing concise summaries of research paper text. Use for quickly understanding the core content, arguments, and contributions of paper sections targeting top-tier computer science conferences. Use when this capability is needed.
metadata:
  author: minhuw
---
...
---
> Source: [minhuw/claude-writer](https://github.com/minhuw/claude-writer) — distributed by [TomeVault](https://tomevault.io).
