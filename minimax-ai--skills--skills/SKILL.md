...
description: Plan and orchestrate multi-slide PowerPoint creation from scratch. Use before generating a full deck with subagents: classify each slide type, enforce visual variety, set typography/spacing rules, and run text-based QA to catch content issues. Use when this capability is needed.
metadata:
  author: MiniMax-AI
---
...
---
> Source: [MiniMax-AI/skills](https://github.com/MiniMax-AI/skills) — distributed by [TomeVault](https://tomevault.io).
