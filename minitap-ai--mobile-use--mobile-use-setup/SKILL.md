...
description: Interactive setup wizard for Minitap mobile-use SDK. USE WHEN user wants to set up mobile automation, configure mobile-use SDK, connect iOS or Android devices, or create a new mobile testing project. Use when this capability is needed.
metadata:
  author: minitap-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/minitap-ai) — claim your Tome and manage your conversions.
