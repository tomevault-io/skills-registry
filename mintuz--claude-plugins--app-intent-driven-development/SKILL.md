...
description: WHEN designing features App Intent-first so Siri/Shortcuts, widgets, and SwiftUI share logic; NOT UI-first; reuse intents across app. Use when this capability is needed.
metadata:
  author: mintuz
---
