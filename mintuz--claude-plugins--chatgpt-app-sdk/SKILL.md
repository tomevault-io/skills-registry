...
description: WHEN building ChatGPT apps using the OpenAI Apps SDK and MCP; create conversational, composable experiences with proper UX, UI, state management, and server patterns. Use when this capability is needed.
metadata:
  author: mintuz
---
