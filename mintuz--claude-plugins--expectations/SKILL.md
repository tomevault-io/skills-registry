---
name: expectations
description: WHEN setting working agreements/TDD rules for this codebase; clarifies boundaries and documentation expectations. Use when this capability is needed.
metadata:
  author: mintuz
---
