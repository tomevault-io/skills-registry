...
description: WHEN testing any front-end UI with DOM Testing Library; behavior-first queries, userEvent flows, async patterns. Use when this capability is needed.
metadata:
  author: mintuz
---
