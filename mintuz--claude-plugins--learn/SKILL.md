---
name: learn
description: WHEN capturing learnings/gotchas/decisions into CLAUDE.md; NOT trivial changes; guides what to record, where it lives, and format. Use when this capability is needed.
metadata:
  author: mintuz
---
