---
name: react-testing
description: WHEN testing React components/hooks/context with React Testing Library; NOT e2e; covers renderHook, providers, forms, and anti-patterns. Use when this capability is needed.
metadata:
  author: mintuz
---
