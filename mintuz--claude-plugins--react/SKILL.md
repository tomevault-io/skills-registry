---
name: react
description: WHEN building React components/pages/apps; enforces scalable architecture, state management, API layer, performance patterns. Use when this capability is needed.
metadata:
  author: mintuz
---
