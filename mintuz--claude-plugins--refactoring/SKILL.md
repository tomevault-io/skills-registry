---
name: refactoring
description: WHEN tests are green and you need a refactor plan; NOT for new feature delivery; commit-first safety with prioritized improvements. Use when this capability is needed.
metadata:
  author: mintuz
---
