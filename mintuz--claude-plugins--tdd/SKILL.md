---
name: tdd
description: WHEN working in TDD Red-Green-Refactor; NOT ad-hoc coding; write tests first, add minimal code to green, then assess refactoring. Use when this capability is needed.
metadata:
  author: mintuz
---
