---
name: add-mpk-model
description: Guide for adding a new model (e.g., Llama4, DeepSeek V3) to the MPK persistent kernel. Covers prerequisites check, demo structure, layer wiring, and testing. Use when this capability is needed.
metadata:
...
---
> Source: [mirage-project/mirage](https://github.com/mirage-project/mirage) — distributed by [TomeVault](https://tomevault.io).
