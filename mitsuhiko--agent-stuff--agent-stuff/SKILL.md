...
description: Trigger native web search. Use when you need quick internet research with concise summaries and full source URLs. Use when this capability is needed.
metadata:
  author: mitsuhiko
---
