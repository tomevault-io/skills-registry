---
name: coverage
description: Comprehensive analysis of testing strategy and coverage across the codebase. Evaluates all test types and identifies gaps. Use when this capability is needed.
metadata:
  author: mjwestcott
---
