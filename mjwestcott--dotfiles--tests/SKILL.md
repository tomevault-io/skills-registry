---
name: tests
description: Reviews test coverage and testing strategy for recent code changes. Use before creating PRs to ensure changes are well-tested. Use when this capability is needed.
metadata:
  author: mjwestcott
---
