...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use this skill when the user wants to create a new skill or modify an existing one.
metadata:
  author: mkas08
---
