---
name: swift-mlx
description: MLX Swift - High-performance ML framework for Apple Silicon with lazy evaluation, automatic differentiation, and unified memory Use when this capability is needed.
metadata:
  author: ml-explore
---
