---
name: agent-evolver
description: description: AI Agent self-evolution engine that enables agents to learn from experience, detect problems, extract insights, and optimize strategies autonomously. Invoke when users need to improve agent performance, analyze execution errors, or implement continuous learning capabilities. Use when this capability is needed.
metadata:
  author: modbender
---
---
