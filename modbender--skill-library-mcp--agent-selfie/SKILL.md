---
name: agent-selfie
description: description: AI agent self-portrait generator. Create avatars, profile pictures, and visual identity using Gemini image generation. Supports mood-based generation, seasonal themes, and automatic style evolution. Use when this capability is needed.
metadata:
  author: modbender
---
---
