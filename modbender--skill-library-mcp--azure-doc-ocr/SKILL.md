---
name: azure-doc-ocr
description: Extract text and structured data from documents using Azure Document Intelligence (formerly Form Recognizer). Use when this capability is needed.
metadata:
  author: modbender
---
---
