---
name: langchain
description: description: Avoid common LangChain mistakes — LCEL gotchas, memory persistence, RAG chunking, and output parser traps. Use when this capability is needed.
metadata:
  author: modbender
---
---
