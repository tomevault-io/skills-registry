---
name: vue-expert-js
description: description: Use when building Vue 3 applications with JavaScript only (no TypeScript). Invoke for JSDoc typing, vanilla JS composables, .mjs modules. Use when this capability is needed.
metadata:
  author: modbender
---
---
