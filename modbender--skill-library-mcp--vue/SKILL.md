---
name: vue
description: description: Build Vue 3 applications with Composition API, proper reactivity patterns, and production-ready components. Use when this capability is needed.
metadata:
  author: modbender
---
---
