---
name: figma-mcp
description: Use the Figma MCP server to translate a Figma design into a Vue page or component layout. Use when the user provides a Figma URL, asks to implement a design, or wants to draft a page layout from Figma. Use when this capability is needed.
metadata:
  author: modrinth
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/modrinth) — claim your Tome and manage your conversions.
