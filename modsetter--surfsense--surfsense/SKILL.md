---
name: report-writing
description: How to scope, draft, and revise a Markdown report artifact via generate_report Use when this capability is needed.
metadata:
  author: MODSetter
---
...
---
> Source: [MODSetter/SurfSense](https://github.com/MODSetter/SurfSense) — distributed by [TomeVault](https://tomevault.io).
