---
name: react-pdf
description: 1. **Fonts MUST be local files** - Remote font URLs (http/https) do NOT work. Always download fonts Use when this capability is needed.
metadata:
  author: molefrog
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/molefrog) — claim your Tome and manage your conversions.
