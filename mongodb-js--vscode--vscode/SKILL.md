...
description: Guide users through configuring key MongoDB MCP server options. Use this skill when a user wants to set up or modify their MongoDB MCP server configuration. Use when this capability is needed.
metadata:
  author: mongodb-js
---
...
---
> Source: [mongodb-js/vscode](https://github.com/mongodb-js/vscode) — distributed by [TomeVault](https://tomevault.io).
