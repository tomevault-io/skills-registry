...
description: Perform a structured code quality audit on a target path in the monorepo. The workflow is: run Use when this capability is needed.
metadata:
  author: moonrepo
---
...
---
> Source: [moonrepo/proto](https://github.com/moonrepo/proto) — distributed by [TomeVault](https://tomevault.io).
