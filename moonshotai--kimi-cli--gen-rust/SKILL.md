---
name: gen-rust
description: Sync Rust implementation with Python changes (exclude UI/login) by reviewing recent changes, mapping modules, porting logic, and updating tests. Use when this capability is needed.
metadata:
  author: moonshotai
---
