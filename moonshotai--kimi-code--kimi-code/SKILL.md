---
name: consolidate
description: Apply an approved sub-skill grouping by moving user-specified skills into a parent bundle, with timestamped backups of every modified directory. Use when this capability is needed.
metadata:
  author: MoonshotAI
---
