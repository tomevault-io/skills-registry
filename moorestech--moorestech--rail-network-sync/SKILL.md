...
description: Implement and review rail/train network synchronization flows across client and server while preserving unified TickUnifiedId ordering and per-TrainUnit snapshot boundaries. Use when changing rail/train sync behavior, event apply order, or recovery-related synchronization paths. Use when this capability is needed.
metadata:
  author: moorestech
---
