...
description: Implement and modify train/rail event tags, payload schemas, server emit paths, and client handlers under unified TickUnifiedId ordering and per-TrainUnit snapshot boundaries. Use when adding or changing `va:event:*` behavior. Use when this capability is needed.
metadata:
  author: moorestech
---
