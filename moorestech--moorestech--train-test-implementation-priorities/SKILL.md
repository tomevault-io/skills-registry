...
description: Plan and prioritize train test implementation by risk and coverage gaps under unified tick ordering and per-unit snapshot synchronization architecture. Use when selecting train regression tests after changes to ordering, hash gates, snapshot sync, topology, or persistence behavior. Use when this capability is needed.
metadata:
  author: moorestech
---
