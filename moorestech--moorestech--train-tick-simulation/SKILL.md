...
description: Define and enforce deterministic train tick behavior under unified TickUnifiedId ordering, hash gating, diff-bundle simulation triggers, and coexistence with per-unit TrainUnit snapshot events. Use when changing tick progression, hash verification flow, bundle timing, or gate/advance behavior. Use when this capability is needed.
metadata:
  author: moorestech
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/moorestech) — claim your Tome and manage your conversions.
