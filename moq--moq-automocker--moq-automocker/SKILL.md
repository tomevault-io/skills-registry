---
name: doc-writer
description: Guidelines for producing accurate and maintainable documentation for Moq.AutoMocker. Use when writing or updating API docs, source generator docs, tutorials, README content, or any documentation in the docs/ folder. Use when this capability is needed.
metadata:
  author: moq
---
