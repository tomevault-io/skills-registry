---
name: coding-agent
description: Run Claude Code (preferred), Codex CLI, OpenCode, or Pi Coding Agent via background process for programmatic control. Use when this capability is needed.
metadata:
