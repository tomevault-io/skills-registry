...
description: Claude Codeセッションの標準的なMarkdownフォーマット規約。セッションログ、対話履歴、ツール実行結果を一貫した構造で記録する必要がある場合に使用。不正確な情報への注釈方法とnb標準のハッシュタグ形式も定義 Use when this capability is needed.
metadata:
  author: mozumasu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mozumasu) — claim your Tome and manage your conversions.
