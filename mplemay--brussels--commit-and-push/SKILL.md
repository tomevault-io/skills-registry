...
description: Run the repo's finalize workflow (uv pytest, pre-commit with per-hook fixes, conventional commit, git push). Use when asked to run tests/lint, fix hook failures, commit changes, or push updates. Use when this capability is needed.
metadata:
  author: mplemay
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mplemay) — claim your Tome and manage your conversions.
