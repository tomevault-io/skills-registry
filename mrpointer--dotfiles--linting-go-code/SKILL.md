...
description: Lint and format Go code. Use when you need to run linters, fix lint errors, format code, or understand why a linter is complaining. Use when this capability is needed.
metadata:
  author: mrpointer
---
