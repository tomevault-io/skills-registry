...
description: Kubernetes NetworkPolicies provide pod-level network segmentation by defining ingress and egress rules that control Use when this capability is needed.
metadata:
  author: mseep-ai
---
...
---
> Source: [mseep-ai/Anthropic-Cybersecurity-Skills](https://github.com/mseep-ai/Anthropic-Cybersecurity-Skills) — distributed by [TomeVault](https://tomevault.io).
