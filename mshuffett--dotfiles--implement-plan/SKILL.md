---
name: implement-plan
description: phased implementation of a structured plan you must use this skill when asked to implement a plan file in rpi/tasks/* Use when this capability is needed.
metadata:
  author: mshuffett
---
