---
name: planning
description: Generate comprehensive plans for new features by exploring the codebase, synthesizing approaches, validating with spikes, and decomposing into beads. Use when asked to plan a feature, create a roadmap, or design an implementation approach. Use when this capability is needed.
metadata:
  author: mthangtr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mthangtr) — claim your Tome and manage your conversions.
