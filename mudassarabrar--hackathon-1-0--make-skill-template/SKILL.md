...
description: Create new Agent Skills for GitHub Copilot from prompts or by duplicating this template. Use when asked to create, scaffold, or build a skill. Generates SKILL.md files with correct frontmatter, directory structure, and optional scripts, references, Use when this capability is needed.
metadata:
  author: mudassarabrar
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mudassarabrar) — claim your Tome and manage your conversions.
