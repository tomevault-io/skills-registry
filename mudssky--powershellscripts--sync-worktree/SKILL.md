---
name: sync-worktree
description: 在多个 git worktree 分支之间同步代码（rebase / merge）。支持状态概览、单分支同步、批量同步、自定义基准分支、合并回主分支。 Use when this capability is needed.
metadata:
  author: mudssky
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mudssky) — claim your Tome and manage your conversions.
