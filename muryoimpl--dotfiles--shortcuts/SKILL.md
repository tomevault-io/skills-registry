---
name: shortcuts
description: Claude Code のキーボードショートカット一覧を表示する。ユーザーが /shortcuts と入力した時に発動。 Use when this capability is needed.
metadata:
  author: muryoimpl
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/muryoimpl) — claim your Tome and manage your conversions.
