---
name: go-development
description: Go development practices and tooling. Use when working with Go code (*.go files, go.mod, go.sum). Activates for Go code style, testing, linting, concurrency patterns, and Go idioms. Use when this capability is needed.
metadata:
  author: mway
---
