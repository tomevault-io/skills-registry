---
name: create-module
description: Create a new NestJS module with controller, service, model, and schema files. Use when adding new feature modules, API endpoints, or business domains. Use when this capability is needed.
metadata:
  author: mx-space
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mx-space) — claim your Tome and manage your conversions.
