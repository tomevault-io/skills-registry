---
name: mx-review
description: Review code for MX Space project conventions. Checks NestJS patterns, TypeGoose models, Zod schemas, API design, etc. Use when this capability is needed.
metadata:
  author: mx-space
---
