...
description: MX Space project TypeGoose model patterns. Apply when creating data models, defining schemas, or handling MongoDB operations. Use when this capability is needed.
metadata:
  author: mx-space
---
