---
name: audit-entries
description: Audits all existing entries in the awesome-playwright README for staleness, broken links, abandoned projects, or superseded tools. Recommends removals with evidence. Use when user says "audit entries", "audit list", "clean up list", "check existing entries", or "prune list". Use when this capability is needed.
metadata:
  author: mxschmitt
---
...
---
> Source: [mxschmitt/awesome-playwright](https://github.com/mxschmitt/awesome-playwright) — distributed by [TomeVault](https://tomevault.io).
