---
name: fix
description: Use Codex CLI to diagnose and fix a bug, error, or failing test. Use when you want a second opinion on a bug or when Claude's fix isn't working. Use when this capability is needed.
metadata:
  author: myobie
---
