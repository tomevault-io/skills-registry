---
name: refactor
description: Use Codex CLI to refactor a module, file, or code pattern. Use when you want an independent take on how to restructure complex or tangled code. Use when this capability is needed.
metadata:
  author: myobie
---
