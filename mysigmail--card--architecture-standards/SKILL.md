...
description: Универсальные архитектурные стандарты проекта. Правила создания новых модулей (UI/Logic) и декомпозиции существующих. Гарантирует чистоту кода через использование composables, разделение ответственности и соблюдение соглашений об именовании. Use when this capability is needed.
metadata:
  author: mysigmail
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/mysigmail) — claim your Tome and manage your conversions.
