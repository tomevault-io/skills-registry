---
name: fastapi
description: description: FastAPI patterns for building high-performance Python APIs. Covers routing, dependency injection, Pydantic models, background tasks, WebSockets, testing, and production deployment. Use when this capability is needed.
metadata:
