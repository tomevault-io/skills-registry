---
name: design-style
description: This skill automatically retrieves the appropriate design system prompt (Neo-brutalism, Modern Dark, Bauhaus, Cyberpunk, Material, etc.) to help create visually distinctive, production-grade frontend code instead of generic UI. Use when this capability is needed.
metadata:
  author: nakanosanku
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nakanosanku) — claim your Tome and manage your conversions.
