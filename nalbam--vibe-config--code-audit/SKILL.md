---
name: code-audit
description: Deep code audit — analyze entire codebase for issues, root causes, and improvements. 전체 코드 심층 감사 — 문제점, 근본원인, 개선사항 분석. Use when this capability is needed.
metadata:
  author: nalbam
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nalbam) — claim your Tome and manage your conversions.
