...
description: Activate for email campaigns, newsletters, drip sequences, automation flows, and email copywriting. Use when creating email content, designing automation workflows, or optimizing email performance. Use when this capability is needed.
metadata:
  author: nammdev
---
