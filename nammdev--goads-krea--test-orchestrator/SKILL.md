...
description: Test ClaudeKit workflows by scanning commands/agents/skills, generating test scenarios, and executing step-by-step with manual verification. Use when this capability is needed.
metadata:
  author: nammdev
---
