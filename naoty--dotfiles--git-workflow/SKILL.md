---
name: git-workflow
description: コードの変更・コミット・PRを作成するときのGitワークフローガイドライン。変更の粒度、コミットメッセージの形式、PRの作成方法を定める。 Use when this capability is needed.
metadata:
  author: naoty
---
...
---
> Source: [naoty/dotfiles](https://github.com/naoty/dotfiles) — distributed by [TomeVault](https://tomevault.io).
