...
description: Nix patterns for flakes, overlays, unfree handling, and binary overlays. Use when working with flake.nix or shell.nix. Use when this capability is needed.
metadata:
  author: napisani
---
