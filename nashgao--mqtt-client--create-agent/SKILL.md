---
name: create-agent
description: Generate specialized agents with smart prefix-based naming following established patterns Use when this capability is needed.
metadata:
  author: nashgao
---
...
**AGENT PLACEMENT:**
- **Target directory**: `templates/agents/` (NOT templates/skills/)
