---
name: aerospace
description: This skill should be used when users want to manage windows on macOS using AeroSpace, an i3-like tiling window manager. Use for both ad-hoc window management requests ("move this window to workspace 2", "tile these windows") and scripting tasks (writing shell scripts, automations, or config modifications). Use when users mention "aerospace", "window management", "tiling", "workspaces", or ask about managing windows on macOS. Use when this capability is needed.
metadata:
  author: nateberkopec
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nateberkopec) — claim your Tome and manage your conversions.
