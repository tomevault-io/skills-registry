...
description: This skill should be used when users want to validate or critique an argument by extracting premises, surfacing hidden assumptions, checking logical validity, optionally formalizing in Lean, and researching premise support. Use when this capability is needed.
metadata:
  author: nateberkopec
---
