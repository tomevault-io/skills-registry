---
name: nanobanana
description: Generate, edit, and restore images using Gemini CLI with the Nano Banana extension. Use when users request image generation, edits, icons, patterns, diagrams, or visual storytelling. Use when this capability is needed.
metadata:
  author: nateberkopec
---
