---
name: typography
description: This skill should be used when selecting fonts, reviewing CSS typography, improving legibility, fixing link affordance, or reducing readability/accessibility risks in UI text. Use when this capability is needed.
metadata:
  author: nateberkopec
---
