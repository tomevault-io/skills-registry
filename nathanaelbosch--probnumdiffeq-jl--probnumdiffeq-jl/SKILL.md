...
description: Test whether the lower compat bounds in Project.toml are still resolvable. Identifies stale bounds, dead version ranges, and suggests updates. Use when this capability is needed.
metadata:
