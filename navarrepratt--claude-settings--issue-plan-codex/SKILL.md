...
description: Plan issues using autonomous AI debate between Claude (opus) and Codex (gpt-5.2). Heavyweight and thorough - best for complex architectural work, large refactors, or ambiguous problems that need deep analysis. Use when the work is too important for the lightweight issue-plan or when you need maximum rigor in discovery and planning without user involvement. Use when this capability is needed.
metadata:
  author: navarrepratt
---
