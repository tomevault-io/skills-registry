---
name: navi
description: Navi programming language expert. Use when writing Navi code, implementing features, handling errors, or working with Navi's type system, concurrency, and modules. Navi is a high-performance, statically-typed compiled language with modern optional types, no NULL pointer exceptions, and built-in concurrency support. Use when this capability is needed.
metadata:
  author: navi-language
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/navi-language) — claim your Tome and manage your conversions.
