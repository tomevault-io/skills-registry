---
name: commit-message
description: Write well-crafted commit messages following best practices. Use when creating commits, writing commit messages, or when the user asks for help with commits. Use when this capability is needed.
metadata:
  author: nb
---
