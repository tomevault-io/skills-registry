---
name: configure-ecc
description: Interactive installer for Everything Codex Agentic Code — guides users through selecting and installing skills and rules to user-level or project-level directories, verifies paths, and optionally optimizes installed files. Use when this capability is needed.
metadata:
  author: ndhananj
---

# Configure Everything Codex Agentic Code (ECC)

An interactive, step-by-step installation wizard for the Everything Codex Agentic Code project. Uses `AskUserQuestion` to guide users through selective installation of skills and rules, then verifies correctness and offers optimization.
...
This skill must be accessible to Codex Agentic Code before activation. Two ways to bootstrap:
...
Options:
  - "User-level (~/.claude/)" — "Applies to all your Codex Agentic Code projects"
...
### "Skills not being picked up by Codex Agentic Code"
...
- Restart Codex Agentic Code after installing rules
...
---
> Source: [ndhananj/codex-agent-setup](https://github.com/ndhananj/codex-agent-setup) — distributed by [TomeVault](https://tomevault.io).
