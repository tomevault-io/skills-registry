...
Config precedence: pytest.toml > pytest.ini > pyproject.toml > tox.ini > setup.cfg
...
- **[gcp-secretmanager.md](references/gcp-secretmanager.md)** -- Google Cloud Secret Manager Python client: SecretManagerServiceClient, types, resource paths, testing patterns

---
> Source: [nealepetrillo/pytest-gcpsecretmanager](https://github.com/nealepetrillo/pytest-gcpsecretmanager) — distributed by [TomeVault](https://tomevault.io).
