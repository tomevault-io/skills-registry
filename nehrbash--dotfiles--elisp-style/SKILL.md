---
name: elisp-style
description: Apply modern Emacs Lisp coding conventions when writing or editing elisp code, Emacs configuration, or .el files Use when this capability is needed.
metadata:
  author: nehrbash
---
