---
name: mr-description
description: Generate a GitLab merge request description by comparing current branch with a base branch. Compare with main by default, or specify an alternative branch. Use when preparing MR descriptions or understanding what changed between branches. Use when this capability is needed.
metadata:
  author: nekhaevskiy
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nekhaevskiy) — claim your Tome and manage your conversions.
