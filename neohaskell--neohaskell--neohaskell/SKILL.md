...
description: Analyses the design draft against the performance methodology to surface raw hot-path findings. Use when this capability is needed.
metadata:
  author: neohaskell
---
...
---
> Source: [neohaskell/NeoHaskell](https://github.com/neohaskell/NeoHaskell) — distributed by [TomeVault](https://tomevault.io).
