---
name: customaize-agentcreate-agent
description: Comprehensive guide for creating Claude Code agents with proper structure, triggering conditions, system prompts, and validation - combines official Anthropic best practices with proven patterns Use when this capability is needed.
metadata:
  author: neolabhq
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/neolabhq) — claim your Tome and manage your conversions.
