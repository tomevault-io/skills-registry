---
name: exec-plan
description: Create or resume an execution plan - a design document that a coding agent can follow to deliver a working feature or system change Use when this capability is needed.
metadata:
  author: neontowel
---
