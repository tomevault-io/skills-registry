---
name: templates
description: This skill should be used when the user wants to add a service from a template, find templates for a specific use case, or deploy tools like Ghost, Strapi, n8n, Minio, Uptime Kuma, etc. For databases (Postgres, Redis, MySQL, MongoDB), prefer the database skill. Use when this capability is needed.
metadata:
  author: nestledjs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nestledjs) — claim your Tome and manage your conversions.
