...
description: Develop and extend NetAlertX REST API endpoints. Use this when asked to create endpoint, add API route, implement API, or modify API responses. Use when this capability is needed.
metadata:
  author: netalertx
---
