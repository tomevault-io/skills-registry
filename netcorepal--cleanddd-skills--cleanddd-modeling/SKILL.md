...
description: 基于 cleanddd-requirements-analysis 结果，输出符合 CleanDDD 的聚合、命令、事件、查询、API 端点（Endpoints）、定时任务模型；用于从已拆解的需求快速得到建模蓝图 Use when this capability is needed.
metadata:
  author: netcorepal
---
