...
description: Strunk & White composition review using the 11 principles from "Elements of Style" Chapter II. Use when analyzing structure, improving flow, or tightening prose. Use when this capability is needed.
metadata:
  author: neurofoo
---
...
---
> Source: [neurofoo/agent-skills](https://github.com/neurofoo/agent-skills) — distributed by [TomeVault](https://tomevault.io).
