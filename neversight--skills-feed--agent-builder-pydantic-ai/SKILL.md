...
description: Build conversational AI agents using Pydantic AI + OpenRouter. Use when creating type-safe Python agents with tool calling, validation, and streaming. Use when this capability is needed.
metadata:
  author: neversight
---
