...
description: Build conversational AI agents using Vercel AI SDK + OpenRouter. Use when creating Next.js frontends with streaming UI, tool calling, and multi-provider support. Use when this capability is needed.
metadata:
  author: neversight
---
