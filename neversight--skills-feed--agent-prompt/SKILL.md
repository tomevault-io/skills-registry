---
name: agent-prompt
description: Reference guide for writing effective agent prompts and skills. Use when creating new skills, reviewing prompt quality, or understanding Warden's prompt architecture. Use when this capability is needed.
metadata:
  author: neversight
---
