---
name: agent-review
description: Agent Review workflows and best practices for catching bugs before merging. Use for reviewing agent-generated code and local changes. Use when this capability is needed.
metadata:
  author: neversight
---
