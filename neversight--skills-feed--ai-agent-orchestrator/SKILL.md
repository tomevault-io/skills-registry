...
description: Эксперт по оркестрации AI агентов. Используй для multi-agent systems, agent coordination, task delegation и agent workflows. Use when this capability is needed.
metadata:
  author: neversight
---
