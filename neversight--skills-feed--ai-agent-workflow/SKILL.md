...
description: Build resumable multi-agent workflows with durable execution, tool loops, and automatic stream recovery on client reconnection. Use when this capability is needed.
metadata:
  author: neversight
---
