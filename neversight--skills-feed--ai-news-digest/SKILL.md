---
name: ai-news-digest
description: Multi-source AI news aggregation and digest generation with deduplication, classification, and source tracing. Supports 20+ sources, 5 theme categories, multi-language output (ZH/EN/JA), and image export. Use when this capability is needed.
metadata:
  author: neversight
---
