---
name: alphaear-stock
description: Search A-Share finance stock tickers and retrieve finance stock price history. Use when user asks about finance stock codes, recent price changes, or specific company finance stock info. Use when this capability is needed.
metadata:
  author: neversight
---
