...
description: Modern Angular UI patterns for loading states, error handling, and data display. Use when building UI components, handling async data, or managing component states. Use when this capability is needed.
metadata:
  author: neversight
---
