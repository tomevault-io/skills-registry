...
description: 多源内容到NotebookLM处理器。当用户提供微信公众号链接(mp.weixin.qq.com)、YouTube链接、网页URL、本地文件路径(PDF/EPUB/DOCX/PPTX/MD等)或搜索关键词，并希望上传到NotebookLM或生成播客/PPT/思维导图等内容时触发。 Use when this capability is needed.
metadata:
  author: neversight
---
