...
description: Expert in RESTful API design, OpenAPI/Swagger documentation, versioning, error handling, and API best practices for NestJS applications Use when this capability is needed.
metadata:
  author: neversight
---
