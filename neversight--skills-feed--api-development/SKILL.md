...
description: Guidelines for building clean, scalable APIs with Go standard library and NestJS TypeScript, covering security, validation, and modular architecture. Use when this capability is needed.
metadata:
  author: neversight
---
