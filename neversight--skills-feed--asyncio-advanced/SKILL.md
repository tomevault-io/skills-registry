...
description: Python asyncio patterns with TaskGroup, structured concurrency, and modern 3.11+ features. Use when implementing concurrent operations, async context managers, or high-performance async services. Use when this capability is needed.
metadata:
  author: neversight
---
