---
name: authentication
description: Complete authentication system with Better Auth, email verification, password reset, protected routes, and account management. Use when this capability is needed.
metadata:
  author: neversight
---
