---
name: authjs-skills
description: Auth.js v5 setup for Next.js authentication including Google OAuth, credentials provider, environment configuration, and core API integration Use when this capability is needed.
metadata:
  author: neversight
---
