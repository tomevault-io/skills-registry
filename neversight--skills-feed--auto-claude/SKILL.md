---
name: auto-claude
description: Autonomous multi-agent coding with git worktree isolation, QA validation, and memory. Use for complex features requiring autonomous implementation. Use when this capability is needed.
metadata:
  author: neversight
---
