---
name: base-ui
description: Base UI unstyled React components. Covers forms, menus, overlays, composition. Keywords: @base-ui/react, render props. Use when this capability is needed.
metadata:
  author: neversight
---
