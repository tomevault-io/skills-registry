---
name: bash-scripting
description: Bash scripting guidelines covering security, portability, error handling, and automation best practices for DevOps. Use when this capability is needed.
metadata:
  author: neversight
---
