...
description: Expert guidance for HTML/XML parsing using BeautifulSoup in Python with best practices for DOM navigation, data extraction, and efficient scraping workflows. Use when this capability is needed.
metadata:
  author: neversight
---
