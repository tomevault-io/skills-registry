...
description: Bitbucket best practices for pull requests, Pipelines CI/CD, Jira integration, and Atlassian ecosystem workflows Use when this capability is needed.
metadata:
  author: neversight
---
