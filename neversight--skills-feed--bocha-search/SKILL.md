---
name: bocha-search
description: High-quality web search with AI-optimized results. Use when user needs to search the internet for current information, news, or research topics. Use when this capability is needed.
metadata:
  author: neversight
---
