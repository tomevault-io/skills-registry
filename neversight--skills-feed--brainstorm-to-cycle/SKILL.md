...
description: Convert brainstorm session output to parallel-dev-cycle input with idea selection and context enrichment. Unified parameter format. Use when this capability is needed.
metadata:
  author: neversight
---
