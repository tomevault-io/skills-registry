---
name: cangjie-lang
description: Cangjie programming language code generation and analysis expert. Use this when users need to write or analyze Cangjie code. Use when this capability is needed.
metadata:
  author: neversight
---
