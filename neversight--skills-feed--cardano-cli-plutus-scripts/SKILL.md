...
description: Plutus script guidance: datums, redeemers, collateral, reference scripts. Templates only—use operator to execute. Use when this capability is needed.
metadata:
  author: neversight
---
