...
description: Staking guidance: registration, delegation, rewards. Provides templates (no execution). Use operator skill to execute. Use when this capability is needed.
metadata:
  author: neversight
---
