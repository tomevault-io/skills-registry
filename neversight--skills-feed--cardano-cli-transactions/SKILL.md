...
description: Transaction guidance: build, sign, submit patterns. Provides templates (no execution). Use operator skill to execute. Use when this capability is needed.
metadata:
  author: neversight
---
