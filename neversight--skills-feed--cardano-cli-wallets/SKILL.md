...
description: Wallet guidance: key generation, address building, UTxO queries. Provides templates and explanations (no execution). Use when this capability is needed.
metadata:
  author: neversight
---
