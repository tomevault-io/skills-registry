...
description: Automatically creates user-facing changelogs from git commits by analyzing Use when this capability is needed.
metadata:
  author: neversight
---
...
```
changelog-generator (○) + SDF.Ch2 (−) + [balancer] (+) = 0
```
