...
description: Expert guidance for HTML/XML parsing using Cheerio in Node.js with best practices for DOM traversal, data extraction, and efficient scraping pipelines. Use when this capability is needed.
metadata:
  author: neversight
---
