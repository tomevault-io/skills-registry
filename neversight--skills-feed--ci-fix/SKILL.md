---
name: ci-fix
description: Fix GitHub Actions CI failures using GitHub CLI (gh): inspect runs/logs, identify root cause, patch workflows/code, rerun jobs, and summarize verification. Use when GitHub Actions CI is failing or needs diagnosis. Use when this capability is needed.
metadata:
  author: neversight
---
