---
name: coco-cli
description: ODB++ PCB design file analysis CLI. Query layers/nets/components, measure feature distances, analyze net clearances, render PNG images. Use when this capability is needed.
metadata:
  author: neversight
---
