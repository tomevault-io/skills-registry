...
description: Guides users through configuring Tauri capabilities for security and access control, covering capability files, permissions, per-window security boundaries, and platform-specific configurations. Use when this capability is needed.
metadata:
  author: neversight
---
