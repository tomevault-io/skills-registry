...
description: Compare document similarity using TF-IDF, cosine similarity, and Jaccard index. Use for plagiarism detection, duplicate finding, or content matching. Use when this capability is needed.
metadata:
  author: neversight
---
