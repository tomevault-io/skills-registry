...
description: Skill for creating AI agent projects using the VoltAgent framework. Guide for CLI setup and manual bootstrapping. Use when this capability is needed.
metadata:
  author: neversight
---
