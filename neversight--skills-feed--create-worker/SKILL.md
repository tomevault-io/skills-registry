---
name: create-worker
description: This skill should be used when creating custom agents for Claude Code, configuring specialized AI assistants, or when the user asks about agent creation, agent configuration, or delegating tasks to workers. Covers both file-based agents and teams delegation. Use when this capability is needed.
metadata:
  author: neversight
---
