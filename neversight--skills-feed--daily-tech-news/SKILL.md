...
description: 每日技术资讯搜集。搜索 AI、GitHub、前端、后端、开源项目等技术领域的最新资讯，生成中文摘要博客文章。关键词：资讯、新闻、daily news、tech news、AI news、GitHub trending。 Use when this capability is needed.
metadata:
  author: neversight
---
