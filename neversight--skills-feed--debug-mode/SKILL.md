---
name: debug-mode
description: Debug mode workflows and best practices for troubleshooting bugs, regressions, and performance issues. Use when debugging tricky issues that standard agent interactions struggle with. Use when this capability is needed.
metadata:
  author: neversight
---
