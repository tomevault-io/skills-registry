...
description: Visualize OrchestKit architecture decisions over time, tracking CC version evolution and best practices adoption. Use when reviewing decisions, understanding rationale, or generating timeline docs. Use when this capability is needed.
metadata:
  author: neversight
---
