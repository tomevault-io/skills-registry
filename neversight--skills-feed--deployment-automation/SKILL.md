...
description: Automate deployment to Vercel platform. Manages deployment configuration, environment setup, and CI/CD integration. Use when this capability is needed.
metadata:
  author: neversight
---
