---
name: devops
description: Deploy to Cloudflare (Workers, R2, D1, KV, Pages), Docker containers, GCP (Cloud Run, GKE). Use for serverless, edge computing, CI/CD pipelines, container orchestration. Use when this capability is needed.
metadata:
  author: neversight
---
