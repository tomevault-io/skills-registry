---
name: discover-tui
description: Automatically discover terminal UI skills when working with terminal user interfaces. Activates for tui development tasks. Use when this capability is needed.
metadata:
  author: neversight
---
