---
name: doctor
description: OrchestKit health diagnostics command that validates plugin configuration and reports issues. Use when running doctor checks or troubleshooting plugin health. Use when this capability is needed.
metadata:
  author: neversight
---
