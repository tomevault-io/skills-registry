...
description: Convert Microsoft Word (.docx) files to Markdown. Use when importing Word documents, extracting content from DOCX for version control, or converting documentation to Markdown format. Use when this capability is needed.
metadata:
  author: neversight
---
