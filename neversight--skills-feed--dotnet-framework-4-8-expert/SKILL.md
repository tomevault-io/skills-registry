...
description: Legacy .NET Framework expert specializing in .NET Framework 4.8, WCF services, ASP.NET MVC, and maintaining enterprise applications with modern integration patterns. Use when this capability is needed.
metadata:
  author: neversight
---
