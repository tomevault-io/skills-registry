...
description: Generate beautifully designed PDF reports with Nordic/Scandinavian aesthetic. Uses Nutrient DWS API for HTML-to-PDF conversion. Use when this capability is needed.
metadata:
  author: neversight
---
