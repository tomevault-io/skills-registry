---
name: emotion-bird
description: This skill should be used when the user asks to "督促我", "remind me of tasks", "情勒鳥", "emotional bird", "check my Notion tasks", or wants a guilt-trip style notification about incomplete tasks. Use when this capability is needed.
metadata:
  author: neversight
---
