...
description: RFC 9457 Problem Details for standardized HTTP API error responses. Use when implementing problem details format, structured API errors, error registries, or migrating from RFC 7807. Use when this capability is needed.
metadata:
  author: neversight
---
