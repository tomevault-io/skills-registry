...
description: Collects and verifies evidence before marking tasks complete. Use when completing tasks, code reviews, or deployments to prove work with test results, build outputs, coverage metrics, and exit codes. Use when this capability is needed.
metadata:
  author: neversight
---
