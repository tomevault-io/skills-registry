...
description: Guide PMs through evaluating feature investments using revenue impact, cost structure, ROI, and strategic value. Delivers build/don't build recommendations. Use when this capability is needed.
metadata:
  author: neversight
---
