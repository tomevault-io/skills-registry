...
description: FFmpeg video and audio processing patterns. Use when transcoding video/audio, extracting clips, adding filters, merging media, creating thumbnails, or batch processing media files. Use when this capability is needed.
metadata:
  author: neversight
---
