...
description: Find agent skills by keyword and enrich results with descriptions. Use when a user asks to discover skills and wants more context than a raw list (e.g., descriptions or comparisons). Use when this capability is needed.
metadata:
  author: neversight
---
