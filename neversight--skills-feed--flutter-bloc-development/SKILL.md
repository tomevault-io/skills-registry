...
description: Build Flutter features using BLoC state management, clean architecture layers, and the project's design system. Apply when creating screens, widgets, or data integrations. Use when this capability is needed.
metadata:
  author: neversight
---
