---
name: flyctl
description: Deploy and manage apps on Fly.io using flyctl CLI. Triggers on: fly deploy, fly.io, flyctl, deploy to fly. Handles launch, deploy, scale, secrets, volumes, databases. Use when this capability is needed.
metadata:
  author: neversight
---
