---
name: frontend-agent
description: Frontend specialist for React, Next.js, TypeScript with FSD-lite architecture, shadcn/ui, and design system alignment Use when this capability is needed.
metadata:
  author: neversight
---
