...
description: Translate designs and UI requirements into robust, extensible implementations. Apply when converting designs to code, implementing components, fixing broken UI, or handling responsive layouts. Use when this capability is needed.
metadata:
  author: neversight
---
