---
name: ghost
description: Ghost CMS theme development with Handlebars templating, Alpine.js, Tailwind CSS, and performance optimization Use when this capability is needed.
metadata:
  author: neversight
---
