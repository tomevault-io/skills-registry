---
name: git-submodule
description: Manage Git submodules for including external repositories within a main repository. Use when working with external libraries, shared modules, or managing dependencies as separate Git repositories. Use when this capability is needed.
metadata:
  author: neversight
---
