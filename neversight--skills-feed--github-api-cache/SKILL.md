...
description: MANDATORY before any GitHub project operations - caches project metadata to prevent rate limit exhaustion. Called by session-start. Other skills MUST use cached data. Use when this capability is needed.
metadata:
  author: neversight
---
