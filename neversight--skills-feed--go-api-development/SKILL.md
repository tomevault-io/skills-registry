...
description: Go API development guidelines using the standard library (1.22+) with best practices for RESTful API design, error handling, and security Use when this capability is needed.
metadata:
  author: neversight
---
