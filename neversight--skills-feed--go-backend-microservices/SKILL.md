...
description: Go backend development best practices for microservices with clean architecture, observability, and production-ready patterns Use when this capability is needed.
metadata:
  author: neversight
---
