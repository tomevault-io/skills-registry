...
description: Use when working with the functional options pattern for Go constructors and public APIs. Use when designing APIs with optional configuration, especially with 3+ parameters.
metadata:
  author: neversight
---
