---
name: go-performance
description: Go performance patterns including efficient string handling, type conversions, and container capacity hints. Use when optimizing Go code or writing performance-critical sections. Use when this capability is needed.
metadata:
  author: neversight
---
