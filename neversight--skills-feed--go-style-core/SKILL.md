---
name: go-style-core
description: Core Go style principles and formatting guidelines from Google and Uber style guides. Use when writing any Go code to ensure clarity, simplicity, and consistency. This is the foundational skill - other Go style skills build on these principles. Use when this capability is needed.
metadata:
  author: neversight
---
