---
name: grimoire-aave
description: Fetches Aave V3 public market data using the Grimoire venue CLI. Use when you need Aave health checks, chain listings, market metadata, or reserve info. Use when this capability is needed.
metadata:
  author: neversight
---
