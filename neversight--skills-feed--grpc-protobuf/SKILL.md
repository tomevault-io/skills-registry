---
name: grpc-protobuf
description: gRPC and Protocol Buffers - use for service-to-service communication, API definitions, streaming, and inter-service contracts Use when this capability is needed.
metadata:
  author: neversight
---
