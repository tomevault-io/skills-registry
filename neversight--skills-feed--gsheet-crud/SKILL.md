---
name: gsheet-crud
description: GSheet-CRUD API 使用指南。将 Google Sheets 作为 RESTful API 数据库。当用户需要通过 API 操作 Google Sheets 数据时使用此技能，包括：查询数据(GET)、插入数据(POST)、更新数据(PUT)、删除数据(DELETE)。 Use when this capability is needed.
metadata:
  author: neversight
---
