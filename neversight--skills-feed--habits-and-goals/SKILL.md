...
description: Guides annual goal-setting and execution with a systematic framework. Applies when planning the year, breaking down ambitious goals into daily systems, running monthly check-ins, or using the ABC System for consistent habit execution. Use when this capability is needed.
metadata:
  author: neversight
---
