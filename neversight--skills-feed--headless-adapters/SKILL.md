...
description: Discover, create, and validate headless adapters for agent integration. Includes scaffolding tools and schema-driven compliance testing. Use when this capability is needed.
metadata:
  author: neversight
---
