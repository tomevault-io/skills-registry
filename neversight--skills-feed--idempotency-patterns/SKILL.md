...
description: Idempotency patterns for APIs and event handlers. Use when implementing exactly-once semantics, deduplicating requests, or building reliable distributed systems. Use when this capability is needed.
metadata:
  author: neversight
---
