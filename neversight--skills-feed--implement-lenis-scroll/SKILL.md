---
name: implement-lenis-scroll
description: Instructions for implementing Lenis smooth scrolling in a Next.js or React application. Use when this capability is needed.
metadata:
  author: neversight
---
