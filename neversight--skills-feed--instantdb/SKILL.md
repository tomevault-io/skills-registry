---
name: instantdb
description: Build complete, functional apps with InstantDB as the backend. Use when creating React/vanilla JS or expo applications. Triggers on requests for building apps. Use when this capability is needed.
metadata:
  author: neversight
---
