---
name: intent-init
description: Initialize IDD structure in a project. Checks existing state, creates directory structure, and generates templates. Use /intent-init to set up Intent-driven development in current project. Use when this capability is needed.
metadata:
  author: neversight
---
