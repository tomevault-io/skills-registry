...
description: Implement internationalization (i18n) best practices for web and mobile applications to support multiple languages and locales. Use when this capability is needed.
metadata:
  author: neversight
---
