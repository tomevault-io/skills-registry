...
description: Java Quarkus development guidelines for building cloud-native applications with fast startup, minimal memory footprint, and GraalVM native builds Use when this capability is needed.
metadata:
  author: neversight
---
