---
name: jira-workflow
description: Jira ticket creation and management for AI agent commands, with severity-based processing and proper integration Use when this capability is needed.
metadata:
  author: neversight
---
