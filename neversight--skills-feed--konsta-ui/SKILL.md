---
name: konsta-ui
description: Guide to using Konsta UI for pixel-perfect iOS and Material Design components in Capacitor apps. Works with React, Vue, and Svelte. Use this skill when users want native-looking UI without Ionic, or prefer a lighter framework. Use when this capability is needed.
metadata:
  author: neversight
---
