...
description: LangGraph subgraph patterns for modular workflows. Use when building nested graphs, composing reusable workflow components, or coordinating multi-agent systems with isolated state. Use when this capability is needed.
metadata:
  author: neversight
---
