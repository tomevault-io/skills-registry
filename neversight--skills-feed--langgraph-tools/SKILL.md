...
description: LangGraph tool calling patterns. Use when binding tools to LLMs, implementing ToolNode for execution, dynamic tool selection, or adding approval gates to tool calls. Use when this capability is needed.
metadata:
  author: neversight
---
