---
name: lean-ux-canvas
description: Guide product managers through Jeff Gothelf's Lean UX Canvas v2—a one-page tool that frames work around a business problem, exposes assumptions, and ensures learning every sprint. Use when this capability is needed.
metadata:
  author: neversight
---
