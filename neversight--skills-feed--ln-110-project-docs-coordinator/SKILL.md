...
description: Coordinates project documentation creation. Gathers context once, detects project type, delegates to 5 L3 workers (ln-111-115). L2 Coordinator invoked by ln-100. Use when this capability is needed.
metadata:
  author: neversight
---
