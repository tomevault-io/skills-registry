...
description: Worker that runs existing tests to catch regressions. Auto-detects framework, reports pass/fail. No status changes or task creation. Use when this capability is needed.
metadata:
  author: neversight
---
