...
description: Orchestrates test planning pipeline (research → manual → auto tests). Coordinates ln-511, ln-512, ln-513. Invoked by ln-500-story-quality-gate. Use when this capability is needed.
metadata:
  author: neversight
---
