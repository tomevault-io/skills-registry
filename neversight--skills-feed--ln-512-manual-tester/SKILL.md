...
description: Performs manual testing of Story AC via executable bash scripts saved to tests/manual/. Creates reusable test suites per Story. Worker for ln-510. Use when this capability is needed.
metadata:
  author: neversight
---
