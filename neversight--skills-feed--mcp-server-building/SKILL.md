...
description: Building MCP (Model Context Protocol) servers for Claude extensibility. Use when creating MCP servers, building custom Claude tools, extending Claude with external integrations, or developing tool packages for Claude Desktop. Use when this capability is needed.
metadata:
  author: neversight
---
# MCP Server Building
