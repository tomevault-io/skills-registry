...
description: Pattern for building MCP servers in Next.js with mcp-handler, shared Zod schemas, and reusable server actions. Use when this capability is needed.
metadata:
  author: neversight
---
