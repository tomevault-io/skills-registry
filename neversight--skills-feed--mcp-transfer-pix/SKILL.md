...
description: Guide for creating Pix transfers using the kobana-mcp-transfer MCP server. Use when the user wants to send Pix transfers or manage transfer batches using MCP tools instead of direct API calls. Use when this capability is needed.
metadata:
  author: neversight
---
