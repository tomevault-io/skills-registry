---
name: md2wechat
description: Convert Markdown to WeChat Official Account HTML. Supports API mode (fast) and AI mode (themed). Features writer style assistant, AI trace removal (humanizer), and draft upload. Use when this capability is needed.
metadata:
  author: neversight
---
