---
name: memory-fabric
description: Graph-first memory orchestration - knowledge graph (PRIMARY, always available) with optional mem0 cloud enhancement for semantic search. Use when designing memory orchestration or combining graph and mem0. Use when this capability is needed.
metadata:
  author: neversight
---
