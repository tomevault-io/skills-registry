---
name: meta
description: Execute Claude Code commands in the telegram_agent project directory. Use when the user wants to work on the telegram agent itself, fix bugs, add features, or modify the bot code. This is a COMMAND HANDLER, not a script executor. Use when this capability is needed.
metadata:
  author: neversight
---
