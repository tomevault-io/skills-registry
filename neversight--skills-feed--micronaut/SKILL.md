---
name: micronaut
description: Expert guidance for Micronaut framework development with compile-time dependency injection, GraalVM native builds, and cloud-native microservices Use when this capability is needed.
metadata:
  author: neversight
---
