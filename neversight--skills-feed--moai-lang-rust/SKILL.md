---
name: moai-lang-rust
description: Rust 1.92+ development specialist covering Axum, Tokio, SQLx, and memory-safe systems programming. Use when building high-performance, memory-safe applications or WebAssembly. Use when this capability is needed.
metadata:
  author: neversight
---
