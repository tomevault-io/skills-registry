...
description: Google Stitch MCP integration for AI-powered UI/UX design generation. Use when generating UI designs from text, extracting design context from screens, exporting screen code and images, or managing Stitch projects and screens. Use when this capability is needed.
metadata:
  author: neversight
---
