...
description: Create modern product launch/pitch videos using Remotion. Use when creating app promo videos, SaaS launch videos, product demos, or startup pitch videos. Use when this capability is needed.
metadata:
  author: neversight
---
