...
description: Monorepo development guidelines using Tamagui, Turbo, Next.js, Expo, Supabase, and cross-platform best practices. Use when this capability is needed.
metadata:
  author: neversight
---
