---
name: multimodal-rag
description: CLIP, SigLIP 2, Voyage multimodal-3 patterns for image+text retrieval, cross-modal search, and multimodal document chunking. Use when building RAG with images, implementing visual search, or hybrid retrieval. Use when this capability is needed.
metadata:
  author: neversight
---
