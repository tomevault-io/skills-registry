...
description: Combine multiple images using Gemini 2.5 Flash (Nano Banana) via OpenRouter. Use when merging 2-8 images with AI-guided composition. Use when this capability is needed.
metadata:
  author: neversight
---
