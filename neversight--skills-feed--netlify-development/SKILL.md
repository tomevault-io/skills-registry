...
description: Netlify development best practices for serverless functions, edge functions, Blobs storage, build configuration, and deployment workflows. Use when this capability is needed.
metadata:
  author: neversight
---
