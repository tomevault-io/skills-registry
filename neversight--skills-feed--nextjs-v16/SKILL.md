---
name: nextjs-v16
description: Advanced patterns for Next.js 16 including cache components, server components, and error handling. Use when building pages, implementing data fetching, setting up caching strategies, or handling errors in Next.js applications. Use when this capability is needed.
metadata:
  author: neversight
---
