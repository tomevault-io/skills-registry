...
description: Activate when user provides a prompt, SKILL.md, or agent instruction and requests optimization. Transforms weak instructions into reliable, enforceable agent protocols. Use when this capability is needed.
metadata:
  author: neversight
---
