...
description: Omi backend patterns conversation processing memory extraction chat system LangGraph FastAPI Firestore Pinecone Redis Use when this capability is needed.
metadata:
  author: neversight
---
