...
description: Omi plugin app development webhook patterns chat tools OAuth flows prompt-based apps integration apps FastAPI Express Use when this capability is needed.
metadata:
  author: neversight
---
