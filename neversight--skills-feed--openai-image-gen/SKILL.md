...
description: Generate images using OpenAI's DALL-E 3 API. Use when needing to create graphics, icons, backgrounds, or any visual assets. Requires OPENAI_API_KEY in environment. Use when this capability is needed.
metadata:
  author: neversight
---
