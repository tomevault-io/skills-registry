---
name: openapi
description: OpenAPI Specification (OAS 3.x): document structure, paths, operations, schemas, parameters, security schemes, and validation. Use when this capability is needed.
metadata:
  author: neversight
---
