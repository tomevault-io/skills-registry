---
name: pai-monitor
description: Monitor Personal AI Infrastructure repo for updates and identify improvement opportunities for Geoffrey. Use when you want to sync Geoffrey with PAI's latest patterns, packs, or architectural decisions. Use when this capability is needed.
metadata:
  author: neversight
---
