...
description: Utilities for parseArger. Use this skill for PROJECT scaffolding, DOCUMENTATION generation, COMPLETION scripts, and HTML FORMS. Use when this capability is needed.
metadata:
  author: neversight
---
