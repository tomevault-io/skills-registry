---
name: pellicule
description: Create videos with Vue using Pellicule - a Vue-native video rendering library Use when this capability is needed.
metadata:
  author: neversight
---
...
- [rules/getting-started.md](rules/getting-started.md) - Installation and basic setup
...
- [rules/rendering.md](rules/rendering.md) - CLI options and rendering videos
