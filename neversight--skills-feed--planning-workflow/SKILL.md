...
description: Complete planning workflow orchestrating architecture planning, task breakdown, and progress tracking setup. Sequential workflow from requirements analysis through structure design and task breakdown to implementation tracking. Use when planning complex skills, setting up comprehensive project plans, or preparing for systematic skill development with full planning artifacts. Use when this capability is needed.
metadata:
  author: neversight
---
