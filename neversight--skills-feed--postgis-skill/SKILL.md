---
name: postgis-skill
description: PostGIS-focused SQL tips, tricks and gotchas. Use when in need of dealing with geospatial data in Postgres. Use when this capability is needed.
metadata:
  author: neversight
---
