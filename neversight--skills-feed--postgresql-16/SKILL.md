---
name: postgresql-16
description: PostgreSQL 16 database documentation. Use for SQL queries, indexes, transactions, JSON operations, full-text search, and performance tuning. Use when this capability is needed.
metadata:
  author: neversight
---
