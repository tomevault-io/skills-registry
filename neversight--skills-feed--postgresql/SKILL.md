---
name: postgresql
description: PostgreSQL best practices: multi-tenancy with RLS, schema design, Alembic migrations, async SQLAlchemy, and query optimization. Use when this capability is needed.
metadata:
  author: neversight
---
