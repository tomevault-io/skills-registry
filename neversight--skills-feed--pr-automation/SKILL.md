---
name: pr-automation
description: Automate PR workflows. Use before creating PRs. Generates PR descriptions, validates PR requirements, checks for missing tests/docs, and links issues automatically. Use when this capability is needed.
metadata:
  author: neversight
---
