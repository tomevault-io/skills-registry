---
name: pr-lifecycle
description: GitHub CLI commands and workflows for managing pull requests, CI checks, CodeRabbit reviews, and branch protection Use when this capability is needed.
metadata:
  author: neversight
---
