...
description: Anticipates and pre-loads optimal skills before task execution based on pattern matching and historical success rates Use when this capability is needed.
metadata:
  author: neversight
---
