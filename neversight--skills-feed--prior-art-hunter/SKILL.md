...
description: Autonomous prior art search and analysis agent. Searches multiple databases, analyzes references, creates claim charts, and assesses patentability impact. Use when this capability is needed.
metadata:
  author: neversight
---
