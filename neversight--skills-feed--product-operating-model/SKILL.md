...
description: Index of the Modern Product Operating Model — a collection of composable product skills. Use when user wants an overview of all product skills, doesn't know which specific skill they need, or wants to understand how the product systems connect. Use when this capability is needed.
metadata:
  author: neversight
---
