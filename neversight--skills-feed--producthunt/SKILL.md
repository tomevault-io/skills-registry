---
name: producthunt
description: Search and retrieve content from Product Hunt. Get posts, topics, users, and collections via the GraphQL API. Use when this capability is needed.
metadata:
  author: neversight
---
