...
description: Core coding standards, SOLID principles, Clean Code, and naming conventions. Use this skill for any coding task to ensure consistency. Use when this capability is needed.
metadata:
  author: neversight
---
