---
name: pulumi-go
description: Pulumi infrastructure as code using Go with Pulumi Cloud and ESC integration. Use when working with Pulumi Go projects, ESC environments, dynamic secrets, OIDC credentials, or infrastructure automation with Golang. Use when this capability is needed.
metadata:
  author: neversight
---
