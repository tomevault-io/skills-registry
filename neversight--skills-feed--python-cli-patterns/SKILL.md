...
description: CLI application patterns for Python. Triggers on: cli, command line, typer, click, argparse, terminal, rich, console, terminal ui. Use when this capability is needed.
metadata:
  author: neversight
---
