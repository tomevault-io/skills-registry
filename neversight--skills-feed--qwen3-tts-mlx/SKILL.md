---
name: qwen3-tts-mlx
description: Local Qwen3-TTS speech synthesis on Apple Silicon via MLX. Use for offline narration, audiobooks, video voiceovers, and multilingual TTS. Use when this capability is needed.
metadata:
  author: neversight
---
