---
name: qwen3-tts
description: Generate multilingual CustomVoice samples and one-off voice replies with Qwen3‑TTS (no Remotion). Includes local setup (Conda Py3.12) and simple CLI scripts. Use when this capability is needed.
metadata:
  author: neversight
---
