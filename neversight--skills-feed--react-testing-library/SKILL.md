...
description: React Testing Library: user-centric component testing with queries, user-event simulation, async utilities, and accessibility-first API. Use when this capability is needed.
metadata:
  author: neversight
---
