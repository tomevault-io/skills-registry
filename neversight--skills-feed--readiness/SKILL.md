---
name: readiness
description: Evaluate repository readiness for AI agents. Analyzes 81 criteria across 8 pillars, assigns maturity level 1-5, generates visual report. Use when this capability is needed.
metadata:
  author: neversight
---
