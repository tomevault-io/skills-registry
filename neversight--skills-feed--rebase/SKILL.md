---
name: rebase
description: Guide for rebasing feature branches onto main in the Fusion Framework monorepo, including handling pnpm-lock.yaml conflicts Use when this capability is needed.
metadata:
  author: neversight
---
