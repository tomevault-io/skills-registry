---
name: refactor-code
description: Refactor code to improve clarity and maintainability without changing behavior. Use when improving readability, reducing complexity, or eliminating duplication. Use when this capability is needed.
metadata:
  author: neversight
---
