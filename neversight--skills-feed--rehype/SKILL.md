---
name: rehype
description: Operate, configure, test, and deploy Doppler's Rehype V4 hook whenever a task mentions Rehype, fee splits, buybacks, or Doppler hook troubleshooting. Use when this capability is needed.
metadata:
  author: neversight
---
