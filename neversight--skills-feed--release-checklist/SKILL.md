...
description: Run a final release checklist before shipping. Verifies no TODOs, no debug code, docs updated, tests passing, dependencies justified, and security reviewed. Use when this capability is needed.
metadata:
  author: neversight
---
