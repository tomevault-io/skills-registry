---
name: remember
description: Store decisions and patterns in knowledge graph with optional cloud sync. Use when saving patterns, storing decisions, remembering approaches that worked. Use when this capability is needed.
metadata:
  author: neversight
---
