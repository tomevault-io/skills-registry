...
description: Use when working with the Game Architect. Expert in Game Feel ("Juice"), Core Loop Psychology, and Cross-Platform Engineering. Use for designing fun, monetization, and engine selection logic.
metadata:
  author: neversight
---
