...
description: Responsive design with Container Queries, fluid typography, cqi/cqb units, and mobile-first patterns for React applications. Use when building responsive layouts or container queries. Use when this capability is needed.
metadata:
  author: neversight
---
