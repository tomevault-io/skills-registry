...
- Check for relevant plan tickets (`tk list --tag plan`)
...
- Task ticket or plan ticket (tagged `plan`)
...
After completing the review, follow handbook `15.04` to create `tk` tickets for all surfaced issues.
