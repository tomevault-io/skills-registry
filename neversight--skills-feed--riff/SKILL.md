---
name: riff
description: Generate 3-10 app variations in parallel for comparing ideas. Use when user says "explore options", "give me variations", "riff on this", "brainstorm approaches", or wants to see multiple interpretations of a concept. Use when this capability is needed.
metadata:
  author: neversight
---
