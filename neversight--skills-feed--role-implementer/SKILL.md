...
description: Default Implementer mode for writing production code. Use for general coding tasks following project conventions. Use when this capability is needed.
metadata:
  author: neversight
---
