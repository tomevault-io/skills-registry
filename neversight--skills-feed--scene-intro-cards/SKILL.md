...
description: Transitional intro cards between video scenes. Use when adding "Coming Up Next" cards, scene transitions, or visual breathing room in demos Use when this capability is needed.
metadata:
  author: neversight
---
