...
description: Security best practices for backend development, microservices, and secure coding patterns with emphasis on input validation and authentication Use when this capability is needed.
metadata:
  author: neversight
---
