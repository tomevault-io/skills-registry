...
description: Detect quiet failures in LLM agents - tool skipping, gibberish outputs, infinite loops, and degraded quality. Use when agents appear to work but produce incorrect results. Use when this capability is needed.
metadata:
  author: neversight
---
