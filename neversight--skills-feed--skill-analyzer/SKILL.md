---
name: skill-analyzer
description: Reference patterns for parsing skill metadata. Use when extracting phases, examples, or features from SKILL.md files for demo generation Use when this capability is needed.
metadata:
  author: neversight
---
