...
description: Guide for creating Claude Code skills to document @rytass packages (建立套件文件 skill 指南). Use when creating new package documentation skills, writing SKILL.md files, or designing skill structure. Use when this capability is needed.
metadata:
  author: neversight
---
