...
description: Always active. Tracks usage of code-craft skills across sessions. Log skill applications to enable analytics and identify gaps. Use when this capability is needed.
metadata:
  author: neversight
---
