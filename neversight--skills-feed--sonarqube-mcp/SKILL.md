---
name: sonarqube-mcp
description: Query and manage code quality using SonarQube/SonarCloud MCP tools. Use when checking quality gates, finding issues, analyzing code snippets, understanding SonarQube rules, or working with code quality metrics. Use when this capability is needed.
metadata:
  author: neversight
---
