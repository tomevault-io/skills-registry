...
description: SpacetimeDB CLI reference for initializing projects, building modules, publishing databases, querying data, and managing servers Use when this capability is needed.
metadata:
  author: neversight
---
