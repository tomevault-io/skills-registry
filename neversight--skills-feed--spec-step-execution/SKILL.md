...
description: Execute a single step from a spec. Used by spec-step-executor agent and main process when running steps directly. Use when this capability is needed.
metadata:
  author: neversight
---
