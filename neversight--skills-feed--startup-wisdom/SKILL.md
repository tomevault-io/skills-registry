---
name: startup-wisdom
description: Apply startup execution wisdom to product, strategy, and business decisions. Use for feature prioritization, build-vs-buy decisions, go-to-market planning, pricing, hiring, scope/timeline reality checks, or when evaluating whether an idea has product-market fit potential. Use when this capability is needed.
metadata:
  author: neversight
---
