...
description: Install a pre-configured Claude Code statusline with model, tokens, cost, lines changed, and context usage. A batteries-included alternative to /statusline with formatting and color thresholds already defined. Use when this capability is needed.
metadata:
  author: neversight
---
