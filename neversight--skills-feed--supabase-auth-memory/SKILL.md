...
description: Standardize authentication and persistent memory storage using Supabase PostgreSQL. Use when building SaaS apps that need user auth, cross-device sync, and conversation history. Use when this capability is needed.
metadata:
  author: neversight
---
