---
name: supabase-auth
description: Manage authentication and user operations in Supabase. Use for sign up, sign in, sign out, password resets, and user management. Use when this capability is needed.
metadata:
  author: neversight
---
