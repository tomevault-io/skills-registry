...
description: Perform database operations (CRUD) on Supabase tables using the REST API. Use for querying, inserting, updating, and deleting data in your Supabase database. Use when this capability is needed.
metadata:
  author: neversight
---
