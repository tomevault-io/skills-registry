...
description: Extract tables from PDFs and images to CSV or Excel. Support for scanned documents with OCR, multi-page PDFs, and complex table structures. Use when this capability is needed.
metadata:
  author: neversight
---
