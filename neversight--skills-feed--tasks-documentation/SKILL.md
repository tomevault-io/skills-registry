...
description: Autonomous subagent variant of documentation. Use when creating or updating technical documentation, API documentation, or inline code documentation. Use when this capability is needed.
metadata:
  author: neversight
---
