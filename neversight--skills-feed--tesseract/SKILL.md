---
name: tesseract
description: Pull and start Tesseract - the Information Mapping Knowledge Engine with Firebase backend. Provides localhost and Tailscale URLs. Use when this capability is needed.
metadata:
  author: neversight
---
