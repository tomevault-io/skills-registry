---
name: test-spec
description: Generate test specifications from PBIs and acceptance criteria. Use when creating test specs, defining test strategy, or planning QA coverage. Triggers on keywords like "test spec", "test specification", "qa spec", "test strategy", "what to test". Use when this capability is needed.
metadata:
  author: neversight
---
