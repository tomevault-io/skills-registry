...
description: Thumbnail and first-frame optimization for CTR. Use when designing thumbnails, fixing frame-0 visibility issues, or optimizing for platform requirements Use when this capability is needed.
metadata:
  author: neversight
---
