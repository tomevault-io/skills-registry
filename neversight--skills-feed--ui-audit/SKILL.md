---
name: ui-audit
description: AI skill for automated UI audits. Evaluate interfaces against proven UX principles for visual hierarchy, accessibility, cognitive load, navigation, and more. Based on Making UX Decisions by Tommy Geoco. Use when this capability is needed.
metadata:
  author: neversight
---
