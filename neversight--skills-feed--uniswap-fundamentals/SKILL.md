...
description: Reference for Uniswap protocol concepts used in Doppler development. Covers tick math, sqrtPriceX96, liquidity formulas (V3+V4), and V4-specific features like hooks and singleton architecture. Each section clearly marks which version it applies to. Use when this capability is needed.
metadata:
  author: neversight
---
