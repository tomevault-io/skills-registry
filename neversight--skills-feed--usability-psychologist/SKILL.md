...
description: Evaluate UI/flows from cognitive load, error prevention, and accessibility perspectives. Apply when reviewing UX, discussing user confusion, high drop-off, or form usability issues. Use when this capability is needed.
metadata:
  author: neversight
---
