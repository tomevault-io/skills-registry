...
description: VCR.py HTTP recording for Python tests. Use when testing Python code making HTTP requests, recording API responses for replay, or creating deterministic tests for external services. Use when this capability is needed.
metadata:
  author: neversight
---
