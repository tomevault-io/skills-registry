---
name: vibery-manager
description: Unified management for Vibery monorepo (templates, kits, CLI, website). Use /template, /kit, /sync, /publish, /deploy commands. Use when this capability is needed.
metadata:
  author: neversight
---
