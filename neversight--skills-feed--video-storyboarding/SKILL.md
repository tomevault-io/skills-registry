...
description: Pre-production planning for tech demo videos. Use when planning scenes, structuring narrative flow, or applying AIDA framework to video content Use when this capability is needed.
metadata:
  author: neversight
---
