...
description: View Transitions API for smooth page transitions, shared element animations, and SPA/MPA navigation in React applications. Use when adding view transitions or page animations. Use when this capability is needed.
metadata:
  author: neversight
---
