...
description: 帮助用户使用 @visactor/vtable 进行高性能表格组件开发，涵盖 ListTable、PivotTable、PivotChart 三种表格类型、13 种单元格类型、样式主题、自定义渲染、事件系统和完整 API。 Use when this capability is needed.
metadata:
  author: neversight
---
