---
name: vuetify0
description: Build with @vuetify/v0 headless composables and components. Use when creating v0-based UIs, working with Selection/Registry/Step patterns, or integrating headless primitives. Use when this capability is needed.
metadata:
  author: neversight
---
