---
name: weather-query
description: 查询中国各地实时天气和天气预报，包括温度、湿度、风速、空气质量等信息。Use when users ask about weather conditions, forecasts, or climate information for locations in China. Use when this capability is needed.
metadata:
  author: neversight
---
