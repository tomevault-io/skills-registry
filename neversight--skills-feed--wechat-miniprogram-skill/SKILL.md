...
description: Expert guidelines for Native WeChat Mini Program development focusing on performance, code size, and native compatibility. Use when developing WeChat Mini Programs in native JavaScript. Use when this capability is needed.
metadata:
  author: neversight
---
