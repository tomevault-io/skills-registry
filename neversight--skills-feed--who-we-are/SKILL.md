---
name: who-we-are
description: Know ourselves - show identity, model info, session stats, and Oracle philosophy. Use when user asks "who we are", "who", or wants to check current AI identity. Use when this capability is needed.
metadata:
  author: neversight
---
