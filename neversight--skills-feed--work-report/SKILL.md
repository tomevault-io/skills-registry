---
name: work-report
description: Write a daily or weekly work report using git commits. Use when the user asks to write or send a daily report/standup or weekly report, especially "日报", "发日报", "周报", "发周报", "daily report", "weekly report", or "work report". Use when this capability is needed.
metadata:
  author: neversight
---
