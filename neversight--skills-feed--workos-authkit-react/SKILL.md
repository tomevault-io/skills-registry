...
description: Integrate WorkOS AuthKit with React single-page applications. Client-side only authentication. Use when the project is a React SPA without Next.js or React Router. Use when this capability is needed.
metadata:
  author: neversight
---
