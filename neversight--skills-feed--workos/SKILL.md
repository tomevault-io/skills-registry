---
name: workos
description: Identify which WorkOS skill to load based on the user's task — covers AuthKit, SSO, RBAC, migrations, and all API references. Use when this capability is needed.
metadata:
  author: neversight
---
