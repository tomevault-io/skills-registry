---
name: wp-debugging
description: WordPress debugging, dependency checking, and local development patterns. Use when debugging WordPress issues, checking plugin dependencies, setting up local environments, resolving conflicts, or troubleshooting errors in themes and plugins. Use when this capability is needed.
metadata:
  author: neversight
---
