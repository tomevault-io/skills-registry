---
name: wp-playground
description: Use for WordPress Playground workflows: fast disposable WP instances in browser or locally via @wp-playground/cli, auto-mounting plugins/themes, switching WP/PHP versions, blueprints, and debugging with Xdebug. Use when this capability is needed.
metadata:
  author: neversight
---
