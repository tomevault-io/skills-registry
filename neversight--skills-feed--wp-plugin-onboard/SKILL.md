...
description: Automated plugin onboarding - clones repo, generates architecture docs, creates CLAUDE.md. Use when starting work on any WordPress plugin. Saves tokens by pre-indexing codebase. Use when this capability is needed.
metadata:
  author: neversight
---
