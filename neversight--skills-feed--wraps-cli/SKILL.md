---
name: wraps-cli
description: CLI that deploys SES, DynamoDB, Lambda, and IAM resources to your AWS account with automatic DKIM, SPF, DMARC configuration. Use when this capability is needed.
metadata:
  author: neversight
---
