---
name: wraps-email
description: TypeScript SDK for AWS SES with automatic credential resolution, React.email support, and template management. Use when this capability is needed.
metadata:
  author: neversight
---
