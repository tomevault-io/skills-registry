---
name: x-twitter-api
description: Interact with X (Twitter) API v2. Post tweets, search, engage, moderate, and analyze — all from your AI agent. Full 31-command skill for Twitter/X automation. Use when this capability is needed.
metadata:
  author: neversight
---
