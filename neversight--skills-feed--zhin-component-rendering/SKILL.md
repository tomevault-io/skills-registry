...
description: Covers Zhin component rendering, defineComponent usage, and message template composition. Use when creating reusable message UI components. Use when this capability is needed.
metadata:
  author: neversight
---
