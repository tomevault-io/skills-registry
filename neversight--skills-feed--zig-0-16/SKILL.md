---
name: zig-0-16
description: Notes for porting code to Zig 0.16-dev (std.Io era). Use this when fixing 0.15-era code that fails on 0.16 master/dev. Use when this capability is needed.
metadata:
  author: neversight
---
