...
description: Loads project context, lists existing specs and changes, searches capabilities and requirements. Use when user asks about project state, existing specs, active changes, available capabilities, or needs context discovery. Triggers include "what specs exist", "show changes", "list capabilities", "project context", "find specs", "what's in the spec", "show me specs". Use when this capability is needed.
metadata:
  author: nextbysam
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nextbysam) — claim your Tome and manage your conversions.
