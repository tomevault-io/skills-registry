---
name: new-lesson
description: Create a new numbered lesson page within an existing training module. Use when adding a new topic like '05_error_handling.md' to an existing course. Use when this capability is needed.
metadata:
  author: nextflow-io
---
