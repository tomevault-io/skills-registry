...
**Reference:** [common-issues.md](common-issues.md) - Quick lookup table for common problems
...
```bash
./scripts/ssh.sh wa     # WorkAdventure
./scripts/ssh.sh lk     # LiveKit
./scripts/ssh.sh turn   # Coturn
./scripts/ssh.sh jitsi  # Jitsi
```
...
**For complete manual cleanup:** See [teardown skill](../teardown/SKILL.md) and [manual-cleanup-scripts.md](../teardown/manual-cleanup-scripts.md)
