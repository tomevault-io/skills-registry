...
description: If asked to manipulate the local sqlite3 database, utilize this skill to perform queries and data checks, along with possibly change data in the local database Use when this capability is needed.
metadata:
  author: nhcarrigan-spring-2026-cohort
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nhcarrigan-spring-2026-cohort) — claim your Tome and manage your conversions.
