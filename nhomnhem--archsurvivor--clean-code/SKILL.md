...
| **Cysharp Stack** | Use ZLinq, R3, MessagePipe for performance |
| **Logging** | Use `GameLog` instead of `UnityEngine.Debug` |

---

## Logging Rules (Unity)

| Context | ❌ Standard | ✅ Project Standard |
| :--- | :--- | :--- |
| Info | `Debug.Log("msg")` | `GameLog.Info("msg")` |
| Warning | `Debug.LogWarning("msg")` | `GameLog.Warning("msg")` |
| Error | `Debug.LogError("msg")` | `GameLog.Error("msg")` |
| Exception | `Debug.LogException(e)` | `GameLog.Error(e.Message)` |
...
>
> **Rule:** Never leave broken imports or missing updates.
