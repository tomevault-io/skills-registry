...
description: Create reusable skills that extend agent capabilities. Use when the user asks to create a skill, teach you something reusable, or save instructions for future tasks. Use when this capability is needed.
metadata:
  author: nhshajib
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nhshajib) — claim your Tome and manage your conversions.
