...
description: Guide for removing skills from an existing workflow and updating all related documentation. Use when user wants to remove skills from a workflow (e.g., "remove skill", "delete skill", "移除技能", "删除技能"). Use when this capability is needed.
metadata:
  author: nicepkg
---
...
---
> Source: [nicepkg/ai-workflow](https://github.com/nicepkg/ai-workflow) — distributed by [TomeVault](https://tomevault.io).
