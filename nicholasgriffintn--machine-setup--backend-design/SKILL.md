---
name: backend-design
description: Design robust backend systems and APIs. Use when users ask to plan or implement services, data models, or integrations. Use when this capability is needed.
metadata:
