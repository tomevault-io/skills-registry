---
name: git-workflow
description: Use when working with a skill that outlines best practices for using Git in a collaborative development environment, including branching strategies, commit conventions, and pull request workflows.
metadata:
