...
description: Generate PandaDoc proposals from client information or sales call transcripts. Use when user asks to create a proposal, generate a quote, draft a contract, or prepare a client document. Use when this capability is needed.
metadata:
  author: nickjwells
---
