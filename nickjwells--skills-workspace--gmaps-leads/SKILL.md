---
name: gmaps-leads
description: Scrape Google Maps for B2B leads with deep website enrichment and contact extraction. Use when user asks to find local businesses, scrape Google Maps, generate contractor lists, or build local service business databases. Use when this capability is needed.
metadata:
  author: nickjwells
---
