...
description: Create cold email campaigns in Instantly with A/B testing. Use when user asks to create email campaigns, set up cold outreach, build email sequences, or configure Instantly campaigns. Use when this capability is needed.
metadata:
  author: nickjwells
---
