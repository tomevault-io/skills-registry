---
name: modal-deploy
description: Deploy execution scripts to Modal cloud. Use when user asks to deploy to Modal, push code to cloud, or update Modal functions. Use when this capability is needed.
metadata:
  author: nickjwells
---
