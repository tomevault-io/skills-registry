---
name: upwork-apply
description: Scrape Upwork jobs and generate personalized proposals with cover letters. Use when user asks to find Upwork jobs, create Upwork proposals, or apply to Upwork listings. Use when this capability is needed.
metadata:
  author: nickjwells
---
