---
name: codex-cli
description: OpenAI Codex CLI reference. Use when running codex in interactive_shell overlay or when user asks about codex CLI options. Use when this capability is needed.
metadata:
  author: nicobailon
---
