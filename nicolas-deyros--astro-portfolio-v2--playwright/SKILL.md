---
name: playwright
description: description: Playwright end-to-end testing best practices for web applications, covering test design, locator strategies, and assertion patterns. Use when this capability is needed.
metadata:
