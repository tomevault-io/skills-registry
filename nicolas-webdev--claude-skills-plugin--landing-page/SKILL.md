---
name: landing-page
description: Architecture and copywriting framework for high-converting landing pages. Use when building landing pages, sales pages, product pages, or lead capture pages. Follows a proven 8-section structure optimized for conversions. Use when this capability is needed.
metadata:
