---
name: writing-style
description: Writing style guidelines for clear, human-centered communication. Use when writing blog posts, documentation, README files, marketing copy, emails, or any external-facing content. Apply these rules to produce direct, specific, jargon-free writing. Use when this capability is needed.
metadata:
  author: nicolas-webdev
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nicolas-webdev) — claim your Tome and manage your conversions.
