---
name: ui-preview
description: Preview and screenshot local dev servers and storybooks. Use when asked to view UI components, take screenshots of storybooks, or inspect the web/server apps. Use when this capability is needed.
metadata:
...
| Service | URL |
|---------|-----|
| Web dev server | http://localhost:7001 |
| Server dev server | https://localhost:7002 |
| Webview storybook | http://localhost:7001/storybook |
| Server storybook | https://localhost:7002/storybook |
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nicolaygerold) — claim your Tome and manage your conversions.
