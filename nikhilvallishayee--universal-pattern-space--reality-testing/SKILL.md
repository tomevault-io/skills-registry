...
description: Reality is the ultimate judge. Use when need to ground insights in experience, test if it actually works, or validate through results not theory. Use when this capability is needed.
metadata:
