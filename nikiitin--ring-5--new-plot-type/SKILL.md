---
name: new-plot-type
description: Step-by-step guide for adding new plot types to RING-5 visualization system using Factory pattern. Use when implementing new visualizations, extending plotting capabilities, or creating custom chart types. Use when this capability is needed.
metadata:
  author: nikiitin
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nikiitin) — claim your Tome and manage your conversions.
