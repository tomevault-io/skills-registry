...
description: Guides implementation of complete gem5 statistics parsing workflows using async patterns. Use when parsing gem5 stats.txt files, scanning for variables, or implementing data loading workflows. Use when this capability is needed.
metadata:
  author: nikiitin
---
