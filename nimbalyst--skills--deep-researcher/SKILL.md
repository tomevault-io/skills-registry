...
description: Parallel multi-agent research with citations. Use when conducting deep research, competitive analysis, or investigating complex topics. Use when this capability is needed.
metadata:
  author: nimbalyst
---
