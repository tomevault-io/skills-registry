...
description: Run unit tests that require the Spanner emulator. Use this skill when the user wants to run tests in packages like satellite/metabase, satellite/metainfo, or any other tests that interact with Spanner. Automatically handles checking for and configuring the Spanner emulator environment. Use when this capability is needed.
metadata:
  author: nkeonye-akumah
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nkeonye-akumah) — claim your Tome and manage your conversions.
