---
name: nocodb
description: Access and manage NocoDB databases via REST APIs. Free plans support bases, tables, fields, records, links, filters, sorts, and attachments. Enterprise plans add workspaces, views, scripts, teams, and collaboration features. Use when this capability is needed.
metadata:
  author: nocodb
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nocodb) — claim your Tome and manage your conversions.
