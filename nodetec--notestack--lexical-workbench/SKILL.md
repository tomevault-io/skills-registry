...
description: Guide for working with the Lexical editor codebase and docs in docs/lexical. Use when implementing or debugging Lexical features: editor state, updates/selection, commands, nodes/serialization, plugins, extensions, transforms, React integration, or theming, especially when the task requires consulting Lexical documentation or source structure in this repo. Use when this capability is needed.
metadata:
  author: nodetec
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/nodetec) — claim your Tome and manage your conversions.
