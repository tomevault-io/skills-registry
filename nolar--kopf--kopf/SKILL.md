---
name: docs-checker
description: Check documentation and docstrings for grammar, punctuation, and style errors. Use when the user asks to verify, review, or fix grammar/style in docs, or before committing documentation changes. Use when this capability is needed.
metadata:
  author: nolar
---
...
---
> Source: [nolar/kopf](https://github.com/nolar/kopf) — distributed by [TomeVault](https://tomevault.io).
