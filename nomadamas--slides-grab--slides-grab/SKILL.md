...
description: Generate square Instagram-style card news by reusing the slides-grab workflow with card-news mode enabled. Defaults to per-slide PNG export. Use when this capability is needed.
metadata:
  author: NomaDamas
---
