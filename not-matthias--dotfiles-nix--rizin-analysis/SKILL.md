---
name: rizin-analysis
description: Guide to using Rizin and Radare2 for binary analysis - lookup instructions, functions, basic blocks, and control flow graphs. Use when analyzing binary structure, investigating control flow graphs, disassembling code, or exploring function calls and jumps. Use when this capability is needed.
metadata:
  author: not-matthias
---
