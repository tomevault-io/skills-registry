...
description: Systematic technical research and brainstorming. Given a question, recursively explores attached specifications, source code, documentation, GitHub repositories, and authoritative online sources to build comprehensive, accurate answers. Surfaces edge cases, caveats, and implementation details that matter. Use when this capability is needed.
metadata:
  author: not-matthias
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/not-matthias) — claim your Tome and manage your conversions.
