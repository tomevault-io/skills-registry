...
description: Run tests, linting, and quality checks for PooCommerce development. Use when running tests, fixing code style, or following the development workflow. Use when this capability is needed.
metadata:
  author: notmattpress
---
