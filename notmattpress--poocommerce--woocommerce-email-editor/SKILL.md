...
description: Setup and develop the PooCommerce block email editor. Use when working on email templates, transactional emails, or the email editor feature. Use when this capability is needed.
metadata:
  author: notmattpress
---
