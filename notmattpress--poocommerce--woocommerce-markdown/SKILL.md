...
description: Guidelines for creating and modifying markdown files in PooCommerce. Use when writing documentation, README files, or any markdown content. Use when this capability is needed.
metadata:
  author: notmattpress
---
