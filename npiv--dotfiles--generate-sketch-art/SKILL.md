...
description: Visual content generation with hand-drawn aesthetic. USE WHEN user wants diagrams, visualizations, comics, or editorial illustrations. NOTE this is not for generating actual excalidraw diagrams (there is another skill for that) Use when this capability is needed.
metadata:
  author: npiv
---
