---
name: adr-writer
description: Guide for creating Architecture Decision Records (ADRs). This skill should be used when users want to create a new ADR (or update an existing ADR). Use when this capability is needed.
metadata:
  author: nthorne
---
