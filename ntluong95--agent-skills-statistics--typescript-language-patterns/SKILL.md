...
description: Modern TypeScript standards for type safety and maintainability. Use when working with types, interfaces, generics, enums, unions, or tsconfig settings. Use when this capability is needed.
metadata:
  author: ntluong95
---
...
---
> Source: [ntluong95/agent-skills-statistics](https://github.com/ntluong95/agent-skills-statistics) — distributed by [TomeVault](https://tomevault.io).
