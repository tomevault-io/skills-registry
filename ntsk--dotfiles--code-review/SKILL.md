---
name: code-review
description: Code review workflow using GitHub CLI. Use when reviewing pull requests, checking PR diffs, adding review comments, or approving/requesting changes on PRs. Use when this capability is needed.
metadata:
  author: ntsk
---
