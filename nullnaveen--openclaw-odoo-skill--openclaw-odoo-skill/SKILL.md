---
name: odoo
description: Build or use the Odoo ERP connector for OpenClaw (Sales, CRM, Purchase, Inventory, Projects, HR, Fleet, Manufacturing integration via XML-RPC). Use when this capability is needed.
metadata:
  author: NullNaveen
---
...
---
> Source: [NullNaveen/openclaw-odoo-skill](https://github.com/NullNaveen/openclaw-odoo-skill) — distributed by [TomeVault](https://tomevault.io).
