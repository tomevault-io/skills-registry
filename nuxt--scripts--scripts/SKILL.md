...
description: ALWAYS use when writing code importing \"@nuxt/test-utils\". Consult for debugging, best practices, or modifying @nuxt/test-utils, nuxt/test-utils, nuxt test-utils, nuxt test utils, test-utils, test utils. Use when this capability is needed.
metadata:
  author: nuxt
---
...
---
> Source: [nuxt/scripts](https://github.com/nuxt/scripts) — distributed by [TomeVault](https://tomevault.io).
