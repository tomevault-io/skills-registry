...
description: Shared site configuration for Nuxt 3 modules. ALWAYS use when writing code importing \"nuxt-site-config\". Consult for debugging, best practices, or modifying nuxt-site-config, nuxt site config. Use when this capability is needed.
metadata:
  author: nuxt-modules
---
...
---
> Source: [nuxt-modules/sitemap](https://github.com/nuxt-modules/sitemap) — distributed by [TomeVault](https://tomevault.io).
