---
name: cudaq-guide
description: CUDA-Q onboarding guide for installation, test programs, GPU simulation, QPU hardware, and quantum applications. Use when this capability is needed.
metadata:
  author: NVIDIA
---
...
---
> Source: [NVIDIA/cuda-quantum](https://github.com/NVIDIA/cuda-quantum) — distributed by [TomeVault](https://tomevault.io).
