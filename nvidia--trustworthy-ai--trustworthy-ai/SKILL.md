...
description: Use only to generate or update a governance skill card for a specified existing agent skill directory. Do not use for explaining, listing, comparing, or discussing skill capabilities. Use when this capability is needed.
metadata:
  author: NVIDIA
---
...
---
> Source: [NVIDIA/Trustworthy-AI](https://github.com/NVIDIA/Trustworthy-AI) — distributed by [TomeVault](https://tomevault.io).
