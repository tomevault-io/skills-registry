---
name: bug-triage
description: Reproduce, isolate, and fix a bug (or failing build/test), then summarize root cause, fix, and verification steps. Use when this capability is needed.
metadata:
  author: nymbo
---
