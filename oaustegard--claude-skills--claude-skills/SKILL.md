...
description: DEPRECATED - Use browsing-bluesky skill instead. Sample and analyze Bluesky firehose to identify trending topics and content clusters. Use when user asks about "what's happening on Bluesky", "Bluesky trends", "zeitgeist", "firehose analysis", or wants to see real-time topic clusters from the network. Use when this capability is needed.
metadata:
  author: oaustegard
---
...
---
> Source: [oaustegard/claude-skills](https://github.com/oaustegard/claude-skills) — distributed by [TomeVault](https://tomevault.io).
