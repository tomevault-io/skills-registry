...
description: Discovers and indexes Python code in skills, enabling cross-skill imports. Use when importing functions from other skills or analyzing skill codebases. Use when this capability is needed.
metadata:
  author: oaustegard
---
