...
description: 备份、日志归档、物理恢复、恢复时间窗、NFS/OSS/COS 归档路径、对象存储权限、备租户恢复源、ob_admin 读取归档位点、oblogminer schema_meta 等问题；OMS 迁移同步问题不使用本 skill。 Use when this capability is needed.
metadata:
  author: oceanbase
---
...
---
> Source: [oceanbase/obdiag](https://github.com/oceanbase/obdiag) — distributed by [TomeVault](https://tomevault.io).
