...
description: Compose commit message from diff using Conventional Commits. Use when user asks for commit message or staged changes. Use when this capability is needed.
metadata:
