...
description: Conventions and layout for octarine-wrapper (TS SDK for Dota 2). Use when editing code, adding abilities/items/modifiers, or working with prototypes/scripts_files. Use when this capability is needed.
metadata:
  author: octarine-public
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/octarine-public) — claim your Tome and manage your conversions.
