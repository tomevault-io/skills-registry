---
name: pr
description: Create GitHub pull requests with proper formatting and descriptions. Use when the user asks to create a PR, open a pull request, or submit their changes for review. Use when this capability is needed.
metadata:
  author: oedokumaci
---
# Pull Request Skill
