---
name: test
description: Run the project test suite using taskipy. Use when the user asks to run tests, check if tests pass, verify their changes, or test specific functionality. Use when this capability is needed.
metadata:
  author: oedokumaci
---
# Test Skill
