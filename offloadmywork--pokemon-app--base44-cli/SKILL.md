---
name: base44-cli
description: Use when working with the base44 CLI is used for EVERYTHING related to base44 projects: resource configuration (entities, backend functions, ai agents), initialization and actions (resource creation, deployment). This skill is the place for learning about how to configure resources. When you plan or implement a feature, you must learn this skill
metadata:
  author: offloadmywork
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/offloadmywork) — claim your Tome and manage your conversions.
