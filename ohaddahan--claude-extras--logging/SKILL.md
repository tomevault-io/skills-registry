...
description: Use before implementing logs in a medium to large scale production system. Use when this capability is needed.
metadata:
  author: ohaddahan
---

> This skill is adpated from ["Logging sucks. And here's how to make it better.](https://loggingsucks.com/) by Boris
> Tane.
...
These fields are what make logs actually queryable during incidents. Without them, you're grepping through millions of
lines blindly.
