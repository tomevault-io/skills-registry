...
description: Slack messaging, channels, and notifications - send messages, manage channels, interact with users, upload files, and add reactions. Use for team communication, incident notifications, and workflow alerts. Use when this capability is needed.
metadata:
  author: oimiragieo
---
