---
name: writing-skills
description: TDD applied to documentation - create production-ready skills. Use when authoring new skills. Includes writing style guidelines for clear prose. Use when this capability is needed.
metadata:
  author: oimiragieo
---
