---
name: mcp-testing
description: description: Testing strategies for MCP servers including unit tests, integration tests, schema validation, and security testingUse when "mcp testing, test mcp server, mcp inspector, mcp validation, mcp, testing, unit-testing, integration-testing, schema-validation" mentioned. Use when this capability is needed.
metadata:
  author: omer-metin
---
---
