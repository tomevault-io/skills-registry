---
name: ast-grep
description: Structural code search using ast-grep. Use for syntax-aware searches, finding patterns, refactoring, or when you need to understand code structure beyond plain text matching. Use when this capability is needed.
metadata:
  author: onbjerg
---
