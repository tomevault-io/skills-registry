...
description: Specialized agent for fixing production bugs in ONE-FM codebase. Analyzes bug reports, generates minimal, targeted fixes, and ensures fixes maintain security, performance, and code quality standards. Use when fixing bugs reported via HD tickets that have been created as GitHub issues. Use when this capability is needed.
metadata:
  author: one-f-m
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/one-f-m) — claim your Tome and manage your conversions.
