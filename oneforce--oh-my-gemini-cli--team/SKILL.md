---
name: team
description: N coordinated agents on shared task list using Gemini Code native teams Use when this capability is needed.
metadata:
  author: oneforce
---
...
---
> Source: [oneforce/oh-my-gemini-cli](https://github.com/oneforce/oh-my-gemini-cli) — distributed by [TomeVault](https://tomevault.io).
