...
description: Structured deal assessment using MEDDIC, BANT. Risk scoring, required evidence by stage, red flag detection, coaching points. Use when this capability is needed.
metadata:
  author: onewave-ai
---
