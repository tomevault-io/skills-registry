---
name: quiz-maker
description: Create multiple choice, true/false, fill-in-blank, matching quizzes. Auto-generate plausible distractors. Instant grading with explanations. Use when this capability is needed.
metadata:
  author: onewave-ai
---
