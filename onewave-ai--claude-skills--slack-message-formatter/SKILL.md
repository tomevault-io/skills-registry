...
description: Convert long text into Slack-optimized format with emojis, bullets, code blocks, and threading suggestions Use when this capability is needed.
metadata:
  author: onewave-ai
---
