---
name: afml-docs-loop
description: Build and run an AFML-grounded, chapter-by-chapter documentation loop for OpenQuant docs. Use this when you need consistent module docs, hierarchical chapter coverage, and iterative progress tracking with MCP-backed prompts. Use when this capability is needed.
metadata:
  author: open-quant
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/open-quant) — claim your Tome and manage your conversions.
