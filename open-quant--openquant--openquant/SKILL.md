...
description: Execute OpenQuant notebook code cells non-interactively, persist outputs to artifact paths, and fail fast on runtime errors. Use when this capability is needed.
metadata:
  author: Open-Quant
---
