...
description: Audit ClawXMemory memory quality with a read-only Dream pass over current file memories and the global profile. Use when this capability is needed.
metadata:
  author: OpenBMB
---
