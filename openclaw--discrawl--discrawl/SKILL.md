---
name: autoreview
description: Pre-commit/ship code review: Codex default; optional Claude, Pi, Droid, Copilot, or OpenCode. Use when this capability is needed.
metadata:
  author: openclaw
---
...
---
> Source: [openclaw/discrawl](https://github.com/openclaw/discrawl) — distributed by [TomeVault](https://tomevault.io).
