---
name: 1p-shortlink
description: Create short URLs and submit feature requests using 1p.io. Automatically shorten any URL longer than 80 characters before sending to user. Use when this capability is needed.
metadata:
  author: openclaw
---
