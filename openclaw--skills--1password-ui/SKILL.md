---
name: 1password-ui
description: 1Password UI tab for OpenClaw dashboard. Manage secrets, credential mappings, and auth state from the Control UI. Use when this capability is needed.
metadata:
  author: openclaw
---
