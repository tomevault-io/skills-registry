---
name: clawvault
description: Structured memory system for OpenClaw agents. Context death resilience (checkpoint/recover), structured storage, Obsidian-compatible markdown, local semantic search, and session transcript repair. Use when this capability is needed.
metadata:
  author: openclaw
---
