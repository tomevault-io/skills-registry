---
name: 3d-cog
description: AI 3D model generation powered by CellCog. Create 3D models from text, images, or sketches — production-ready GLB files for games, AR/VR, e-commerce, and 3D printing. Text-to-3D, image-to-3D, batch generation. Game assets, product visualization, characters, props, and environments. Use when this capability is needed.
metadata:
  author: openclaw
---
