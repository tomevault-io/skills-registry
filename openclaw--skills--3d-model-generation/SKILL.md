...
description: Generate 3D models using each::sense AI. Create 3D assets from text or images for games, products, architecture, characters, vehicles, and more with PBR textures. Use when this capability is needed.
metadata:
  author: openclaw
---
