---
name: 8004-skill
description: ERC-8004 Trustless Agents - Register and manage AI agent identities on TRON and BSC blockchains with on-chain reputation tracking Use when this capability is needed.
metadata:
  author: openclaw
---
