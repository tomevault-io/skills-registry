---
name: a11y-auditor
description: Scan HTML and JSX for accessibility issues and get fix suggestions. Use when you need to catch WCAG violations before they hit production. Use when this capability is needed.
metadata:
  author: openclaw
---
