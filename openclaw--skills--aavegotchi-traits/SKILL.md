...
description: Retrieve Aavegotchi NFT data by gotchi ID or name on Base. Returns traits, wearables, rarity scores, kinship, XP, level, and owner data. Use when this capability is needed.
metadata:
  author: openclaw
---
