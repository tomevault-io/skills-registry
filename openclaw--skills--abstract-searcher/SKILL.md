...
description: Add abstracts to .bib file entries by searching academic databases (arXiv, Semantic Scholar, CrossRef) with browser fallback. Use when this capability is needed.
metadata:
  author: openclaw
---
