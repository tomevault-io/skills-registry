---
name: accounts
description: Centralized account management for all platforms. Store usernames, URLs, and settings for SNS and marketplaces. Use when this capability is needed.
metadata:
  author: openclaw
---
