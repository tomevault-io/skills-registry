...
description: **Learn from errors and corrections in real-time. Continuously improve by capturing failures, user feedback, and successful patterns.** Use when this capability is needed.
metadata:
  author: openclaw
---
