...
description: Generate production-ready API documentation from endpoint descriptions. Outputs OpenAPI 3.0, markdown reference docs, and SDK quickstart guides. Use when this capability is needed.
metadata:
  author: openclaw
---
