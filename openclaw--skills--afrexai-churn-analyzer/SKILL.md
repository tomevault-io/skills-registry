...
description: Identify customers most likely to churn before they leave. Uses behavioral signals, usage patterns, and engagement data to score accounts and recommend retention actions. Use when this capability is needed.
metadata:
  author: openclaw
---
# Churn Risk Analyzer
