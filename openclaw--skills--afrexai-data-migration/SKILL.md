...
description: Plan, execute, and validate data migrations between systems. Covers schema mapping, ETL pipeline design, rollback strategies, and post-migration validation. Use when this capability is needed.
metadata:
  author: openclaw
---
