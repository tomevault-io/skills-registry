...
description: Run every non-standard deal through a repeatable review process. Catch margin leaks, enforce discount guardrails, and close faster with pre-approved terms. Use when this capability is needed.
metadata:
  author: openclaw
---
