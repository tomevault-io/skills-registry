...
description: Complete email marketing system — deliverability, list building, sequences, cold outreach, automation, analytics, and revenue optimization. Zero dependencies. Use when this capability is needed.
metadata:
  author: openclaw
---
