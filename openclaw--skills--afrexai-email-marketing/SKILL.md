...
description: Complete email marketing system — strategy, sequences, segmentation, automation, deliverability, and analytics. Build campaigns that convert. Use when this capability is needed.
metadata:
  author: openclaw
---
