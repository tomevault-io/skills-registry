...
description: Score and compare job candidates objectively using weighted criteria. Eliminates gut-feel hiring decisions. Use when this capability is needed.
metadata:
  author: openclaw
---
