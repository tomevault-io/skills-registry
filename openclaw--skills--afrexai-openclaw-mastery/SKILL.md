...
description: This skill gives you the complete OpenClaw operating system. Want industry-specific agent configurations with pre-built workflows? Use when this capability is needed.
metadata:
  author: openclaw
---
