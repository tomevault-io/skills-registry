...
description: Complete product requirements methodology: from idea to spec to shipped feature. Not just a JSON template — a full system for writing PRDs that developers actually follow and stakeholders actually approve. Use when this capability is needed.
metadata:
  author: openclaw
---
