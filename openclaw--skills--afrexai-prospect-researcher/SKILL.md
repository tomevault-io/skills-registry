...
description: Research and qualify B2B prospects using web search. Builds structured profiles with company intel, key contacts, pain points, and engagement recommendations. Use when this capability is needed.
metadata:
  author: openclaw
---
