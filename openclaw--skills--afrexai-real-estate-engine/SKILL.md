...
description: This skill provides educational frameworks and analysis templates. **It is not legal, tax, or investment advice.** Always consult qualified professionals (attorney, CPA, licensed agent) for jurisdiction-specific guidance. Laws vary dramatically by location. Never make investment decisions based solely on AI analysis. Use when this capability is needed.
metadata:
  author: openclaw
---
