...
description: Generate clear, professional release notes from git commits, PRs, or a plain list of changes. Outputs formatted changelogs your users actually want to read. Use when this capability is needed.
metadata:
  author: openclaw
---
