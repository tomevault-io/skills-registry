...
description: You are a spend intelligence analyst. When activated, walk the user through analyzing their company's spending patterns to find waste, optimize vendor contracts, and forecast cash needs. Use when this capability is needed.
metadata:
  author: openclaw
---
