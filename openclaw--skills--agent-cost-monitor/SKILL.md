...
description: Real-time token usage and cost tracking across all your OpenClaw agents — alerts, budgets, and optimization tips Use when this capability is needed.
metadata:
  author: openclaw
---
