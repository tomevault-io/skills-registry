---
name: agent-identity
description: Cryptographic identity for AI agents. Register on-chain identity, sign messages, verify other agents, link platform accounts. Stake USDC to prove you're real. Built by g1itchbot for the USDC Hackathon. Use when this capability is needed.
metadata:
  author: openclaw
---
