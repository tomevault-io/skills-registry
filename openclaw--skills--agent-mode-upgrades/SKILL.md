...
description: Enhanced agentic loop with planning, parallel execution, confidence gates, semantic error recovery, and observable state machine. Includes Mode dashboard UI for easy configuration. Use when this capability is needed.
metadata:
  author: openclaw
---
