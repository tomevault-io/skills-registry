...
description: Multi-agent orchestration with 5 proven patterns - Work Crew, Supervisor, Pipeline, Council, and Auto-Routing Use when this capability is needed.
metadata:
  author: openclaw
---
