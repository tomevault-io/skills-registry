---
name: agent
description: Define agent identity, personality, voice, and boundaries to create assistants that feel authentic rather than generic. Use when this capability is needed.
metadata:
  author: openclaw
---
