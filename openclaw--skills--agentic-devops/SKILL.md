---
name: agentic-devops
description: Production-grade agent DevOps toolkit — Docker, process management, log analysis, and health monitoring. Built by engineers who run production. Use when this capability is needed.
metadata:
  author: openclaw
---
