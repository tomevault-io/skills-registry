...
description: This skill is for running fdv.lol **CLI mode** (`cli.mjs`) with **Agent Gary Full AI Control** enabled, so the AI can fully drive Auto Trader decisions. Use when this capability is needed.
metadata:
  author: openclaw
---
