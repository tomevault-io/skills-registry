---
name: agentos-sdk
description: AgentOS is a complete accountability infrastructure for AI agents. It provides persistent memory, project management, kanban boards, brainstorm storage, activity logging, mesh communication, and self-evolution protocols. Use when this capability is needed.
metadata:
  author: openclaw
---
# AgentOS SDK Skill
