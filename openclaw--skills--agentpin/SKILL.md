---
name: agentpin
description: **Purpose**: This guide helps AI assistants work with AgentPin for domain-anchored cryptographic agent identity verification. Use when this capability is needed.
metadata:
  author: openclaw
---
