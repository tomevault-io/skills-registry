---
name: agents
description: Design, build, and deploy AI agents with architecture patterns, framework selection, memory systems, and production safety. Use when this capability is needed.
metadata:
  author: openclaw
---
