...
description: Provides 10 Mastra tools: `getBalance`, `transfer`, `swap`, `bridge`, `x402Pay`, `registerIdentity`, `verifyAgent`, `getTransactionHistory`, `estimateGas`, `getChainInfo`.
metadata:
  author: openclaw
---
