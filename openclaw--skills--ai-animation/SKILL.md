---
name: animation-gen
description: Generate CSS and Framer Motion animations from plain English. Use when you need smooth animations without the math. Use when this capability is needed.
metadata:
  author: openclaw
---
