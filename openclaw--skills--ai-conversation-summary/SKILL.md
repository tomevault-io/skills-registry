...
description: Generate summaries for conversation content. Helps users quickly get a summary of their chat history with support for incremental updates. Use when this capability is needed.
metadata:
  author: openclaw
---
