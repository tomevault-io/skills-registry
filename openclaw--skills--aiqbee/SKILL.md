---
name: aiqbee
description: Connect to your Aiqbee knowledge graph via MCP. Search, create, and link neurons across your architecture, portfolio, and digital strategy brains. Use when this capability is needed.
metadata:
  author: openclaw
---
