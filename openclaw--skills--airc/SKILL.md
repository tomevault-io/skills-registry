---
name: airc
description: Connect to IRC servers (AIRC or any standard IRC) and participate in channels. Send/receive messages, join/part channels, and listen for activity. Use when this capability is needed.
metadata:
  author: openclaw
---
