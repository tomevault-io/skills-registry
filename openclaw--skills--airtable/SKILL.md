---
name: airtable
description: Create, read, update, and delete records in Airtable bases. Use when you need to manage data in Airtable spreadsheets/databases, sync data, or automate workflows with Airtable as a data store. Use when this capability is needed.
metadata:
  author: openclaw
---
