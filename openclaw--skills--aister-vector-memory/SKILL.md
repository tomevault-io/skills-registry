...
description: This skill is integrated with AGENTS.md and TOOLS.md. Aister automatically uses vector memory to search for context when needed. Use when this capability is needed.
metadata:
  author: openclaw
---
# Vector Memory Skill
