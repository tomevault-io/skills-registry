---
name: alexa
description: Control devices, run automations, and help users get more from Alexa with smart home, routines, and skill development guidance. Use when this capability is needed.
metadata:
  author: openclaw
---
