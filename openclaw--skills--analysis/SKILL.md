---
name: analysis
description: Run deep system health checks across workspace, config, skills, and integrations with prioritized findings and remediation. Use when this capability is needed.
metadata:
  author: openclaw
---
