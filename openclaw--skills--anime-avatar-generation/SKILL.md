...
description: Generate anime-style avatars and characters using each::sense AI. Transform photos into anime, create Ghibli-style portraits, manga characters, chibi avatars, and full character sheets with multiple angles. Use when this capability is needed.
metadata:
  author: openclaw
---
