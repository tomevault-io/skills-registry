---
name: qmd
description: Search markdown knowledge bases efficiently using qmd. Use this when searching Obsidian vaults or markdown collections to find relevant content with minimal token usage. Use when this capability is needed.
metadata:
  author: openclaw
---
