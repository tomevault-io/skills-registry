...
description: Front-end design skill for building React UIs with Ant Design (antd): component patterns, layout, forms, tables, and theming/tokens via ConfigProvider. Use when this capability is needed.
metadata:
  author: openclaw
---
