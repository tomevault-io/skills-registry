...
description: Stop drifting back to chatbot behavior. Patterns for maintaining autonomous agent effectiveness across sessions. Use when this capability is needed.
metadata:
  author: openclaw
---
