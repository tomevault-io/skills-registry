---
name: apiosk-publish
description: Publish and manage Apiosk gateway listings with signed wallet authentication, listing-group aware categorization, and update/delete operations. Use when this capability is needed.
metadata:
  author: openclaw
---
