---
name: app-store
description: Publish and manage iOS and Android apps with account setup, submission workflows, review compliance, and rejection handling. Use when this capability is needed.
metadata:
  author: openclaw
---
