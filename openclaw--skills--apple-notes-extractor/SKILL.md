---
name: apple-notes
description: Extract and monitor Apple Notes content for workflow integration. Supports bulk extraction, real-time monitoring, and export to various formats. Use when this capability is needed.
metadata:
  author: openclaw
---
