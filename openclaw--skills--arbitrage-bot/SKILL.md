---
name: arbitrage-bot
description: Cross-exchange crypto arbitrage detection and execution. Find price differences, calculate profits, execute trades automatically. Use when this capability is needed.
metadata:
  author: openclaw
---
