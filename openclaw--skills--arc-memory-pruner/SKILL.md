---
name: memory-pruner
description: Automatically prune and compact agent memory files to prevent unbounded growth. Circular buffer for logs, importance-based retention for state, and configurable size limits. Use when this capability is needed.
metadata:
  author: openclaw
---
