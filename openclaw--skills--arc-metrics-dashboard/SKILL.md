...
description: Track and visualize your agent's operational metrics. Record API calls, task completions, uptime, errors, and custom counters. Generate text-based dashboards and export data for analysis. Use when this capability is needed.
metadata:
  author: openclaw
---
