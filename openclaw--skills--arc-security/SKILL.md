---
name: arc-security
description: Chain-agnostic security infrastructure for OpenClaw skills. Auditors stake USDC to vouch for skill safety, users pay micro-fees to access verified skills, and malicious skills get slashed through decentralized governance -- all powered by CCTP on Arc. Use when this capability is needed.
metadata:
  author: openclaw
---
