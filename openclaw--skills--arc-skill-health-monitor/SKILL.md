...
description: Monitor deployed skills for performance drift, errors, and unexpected behavior changes. Continuous post-deployment health checks with alerting and trend tracking. Use when this capability is needed.
metadata:
  author: openclaw
---
