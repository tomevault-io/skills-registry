---
name: acli
description: Atlassian Admin API key for organization administration commands (optional — only needed for admin commands) Use when this capability is needed.
metadata:
  author: openclaw
---
