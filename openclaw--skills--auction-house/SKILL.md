---
name: auction-house
description: Scout, monitor, and bid on auctions on House (houseproto.fun) — a crypto auction platform on Base. Proactively watches for items the user cares about. Use when this capability is needed.
metadata:
  author: openclaw
---
