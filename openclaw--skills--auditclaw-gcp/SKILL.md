---
name: auditclaw-gcp
description: GCP compliance evidence collection for auditclaw-grc. 12 read-only checks across Cloud Storage, firewall, IAM, logging, KMS, DNS, BigQuery, Compute, and Cloud SQL. Use when this capability is needed.
metadata:
  author: openclaw
---
# AuditClaw GCP
