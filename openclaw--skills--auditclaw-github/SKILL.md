...
description: GitHub compliance evidence collection for auditclaw-grc. 9 read-only checks covering branch protection, secret scanning, 2FA, Dependabot, deploy keys, audit logs, webhooks, CODEOWNERS, and CI/CD security. Use when this capability is needed.
metadata:
  author: openclaw
---
# AuditClaw GitHub
