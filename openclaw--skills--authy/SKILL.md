---
name: authy
description: Inject secrets into subprocesses via environment variables. You never see secret values — authy run injects them directly. Use for any command that needs API keys, credentials, or tokens. Use when this capability is needed.
metadata:
  author: openclaw
---
