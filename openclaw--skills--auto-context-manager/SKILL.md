...
description: AI-powered automatic project context management. Detects which project the user is referring to and maintains context awareness. Use when this capability is needed.
metadata:
  author: openclaw
---
