---
name: auto-pr-merger
description: This skill automates the workflow of checking out a GitHub PR, running tests, attempting to fix failures, and merging if successful. Use when this capability is needed.
metadata:
  author: openclaw
---
