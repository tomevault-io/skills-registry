---
name: auto-research
description: This skill enables OpenClaw to conduct autonomous research on any topic, compiling structured briefings with executive summaries, key findings, and actionable recommendations. Research outputs are stored in your Obsidian vault and vectorized in Qdrant for semantic retrieval. Use when this capability is needed.
metadata:
  author: openclaw
---
# Auto-Research Skill
