---
name: autonomy
description: Expand agent capabilities by identifying tasks where human approval adds no value. Systematic delegation. Use when this capability is needed.
metadata:
  author: openclaw
---
