---
name: avantis
description: Execute leverage trading on Avantis (Base). Long/short crypto, forex, commodities with up to 100x leverage. Uses Python SDK with direct wallet integration. Use when this capability is needed.
metadata:
  author: openclaw
---
