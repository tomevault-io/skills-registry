...
description: Generate images using Azure OpenAI DALL-E. Supports batch generation, custom prompts, and outputs a gallery. Use when this capability is needed.
metadata:
  author: openclaw
---
