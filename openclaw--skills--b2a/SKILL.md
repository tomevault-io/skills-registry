---
name: b2a
description: Sell to AI agents with machine-readable products, agent-optimized APIs, structured pricing, and discovery strategies for the agentic economy. Use when this capability is needed.
metadata:
  author: openclaw
---
