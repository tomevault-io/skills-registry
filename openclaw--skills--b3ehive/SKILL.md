---
name: b3ehive
description: Enable competitive code generation where three isolated AI agents implement the same functionality, evaluate each other objectively, and deliver the optimal solution through data-driven selection. Use when this capability is needed.
metadata:
  author: openclaw
---
