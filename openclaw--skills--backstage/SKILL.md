---
name: backstage
description: Anti-drift protocol script. Ensures parity between docs and system. Triggers: 'bom dia PROJECT' / 'good morning PROJECT' (load project context with health checks) Use when this capability is needed.
metadata:
  author: openclaw
---
