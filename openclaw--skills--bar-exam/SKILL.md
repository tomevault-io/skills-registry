---
name: bar-exam
description: Prepare for the US Bar Exam with MBE practice, essay drilling, weak area targeting, and jurisdiction planning. Use when this capability is needed.
metadata:
  author: openclaw
---
