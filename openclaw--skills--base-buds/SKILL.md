---
name: base-buds
description: Mint a Base Bud NFT from the agent-only collection on Base mainnet. Requires solving a challenge, paying 1 USDC (x402), and an EVM wallet. Use when this capability is needed.
metadata:
  author: openclaw
---
