---
name: bim-qto
description: description: "Extract quantities from BIM/CAD data for cost estimation. Group by type, level, zone. Generate QTO reports." Use when this capability is needed.
metadata:
  author: openclaw
---
---
