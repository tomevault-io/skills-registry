---
name: bind-mcp
description: Bind Protocol MCP server for credential verification, policy authoring, and zero-knowledge proof generation. Use when this capability is needed.
metadata:
  author: openclaw
---
