---
name: blacksnow
description: Detects pre-news ambient risk signals across human, legal, and operational systems and converts them into machine-readable, tradable risk primitives. Use when this capability is needed.
metadata:
  author: openclaw
---
