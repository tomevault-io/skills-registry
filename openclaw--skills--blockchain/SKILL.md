---
name: blockchain
description: Understand blockchain technology, interact with smart contracts, and evaluate when distributed ledgers solve real problems. Use when this capability is needed.
metadata:
  author: openclaw
---
