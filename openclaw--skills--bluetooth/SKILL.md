---
name: bluetooth
description: Discover, connect, and control Bluetooth devices with automatic profile learning, cross-platform tools, and device management. Use when this capability is needed.
metadata:
  author: openclaw
---
