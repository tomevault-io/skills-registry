---
name: bmkg-monitor
description: Monitoring earthquake, weather, and tsunami data in Indonesia using BMKG official data. Use when the user asks about earthquakes, weather forecasts, weather warnings, felt tremors, tsunami potential, or seismic events in Indonesia. Use when this capability is needed.
metadata:
  author: openclaw
---
