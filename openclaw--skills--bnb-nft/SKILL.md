---
name: bnb-nft
description: NFT operations on BNB Chain — get NFT metadata, check ownership, list NFTs by owner, transfer ERC-721 tokens, get collection info. Use for any NFT-related tasks on BSC. Use when this capability is needed.
metadata:
  author: openclaw
---
