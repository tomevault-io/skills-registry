---
name: book-test-prep
description: Book test-prep services through Lokuli MCP. Use when user needs to find and book test-prep. Triggers on requests like "book a test-prep", "find test-prep near me", or any test-prep service request. Use when this capability is needed.
metadata:
  author: openclaw
---
