...
description: Get an email address without your human. Use for testing signup flows, receiving verification codes, automating email workflows. Free. Use when this capability is needed.
metadata:
  author: openclaw
---
