---
name: build-session
description: Use when working with a framework for productive autonomous agent sessions. Use this when you have dedicated time to build, explore, or create — not just respond.
metadata:
  author: openclaw
---
# Build Session Skill
