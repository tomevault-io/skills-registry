---
name: cacheforge
description: CacheForge primary skill — bootstrap onboarding + ops + stats for the OpenAI-compatible token optimization gateway. Cut your LLM bill by up to 30% (results vary by provider/workload). Use when this capability is needed.
metadata:
  author: openclaw
---
