---
name: calendly
description: Manage Calendly scheduling - list events, bookings, and availability. Create scheduling links programmatically. Use when this capability is needed.
metadata:
  author: openclaw
---
