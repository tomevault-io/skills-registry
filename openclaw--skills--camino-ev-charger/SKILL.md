---
name: ev-charger
description: Find EV charging stations along a route or near a destination using Camino AI's location intelligence with OpenStreetMap data. Use when this capability is needed.
metadata:
  author: openclaw
---
