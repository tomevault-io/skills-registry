---
name: fitness-finder
description: Search for gyms, yoga studios, swimming pools, and sports facilities using Camino AI's location intelligence with AI-powered ranking. Use when this capability is needed.
metadata:
  author: openclaw
---
