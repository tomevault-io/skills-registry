---
name: journey
description: Plan multi-waypoint journeys with route optimization, feasibility analysis, and time budget constraints. Use when you need to plan trips with multiple stops or check if an itinerary is achievable. Use when this capability is needed.
metadata:
  author: openclaw
---
