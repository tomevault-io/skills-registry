---
name: parking-finder
description: Locate parking garages, lots, and street parking near your destination using Camino AI's location intelligence with AI-powered ranking. Use when this capability is needed.
metadata:
  author: openclaw
---
