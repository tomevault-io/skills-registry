---
name: cloudflare
description: Manage Cloudflare via API — DNS zones and records, page rules, SSL/TLS settings, caching, firewall rules, Workers, and analytics. Free tier includes DNS, CDN, DDoS protection, and SSL. Use when this capability is needed.
metadata:
  author: openclaw
---
