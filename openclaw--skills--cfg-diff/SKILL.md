---
name: cfg-diff
description: Compare configuration files, highlight differences, and suggest merge strategies for YAML, JSON, TOML, and INI formats. Use when this capability is needed.
metadata:
  author: openclaw
---
