---
name: chatgpt-import
description: Import ChatGPT conversation history into OpenClaw's memory search. Use when migrating from ChatGPT, giving OpenClaw access to old conversations, or building a searchable archive of past chats. Use when this capability is needed.
metadata:
  author: openclaw
---
