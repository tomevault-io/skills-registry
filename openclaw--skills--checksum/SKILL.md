---
name: checksum
description: Use when working with a CLI utility for generating and verifying cryptographic file checksums (MD5, SHA1, SHA256). Supports recursive directory hashing and verification from file.
metadata:
  author: openclaw
---
