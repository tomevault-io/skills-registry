---
name: cherry-mcp
description: HTTP bridge that keeps MCP servers alive and exposes them via REST. Built for OpenClaw agents that need MCP tools without native MCP support. Use when this capability is needed.
metadata:
  author: openclaw
---
