...
description: Telegram Web App for Chia wallet verification via WalletConnect and Sage. Enables cryptographic proof of wallet ownership through signature verification using MintGarden API. Use when this capability is needed.
metadata:
  author: openclaw
---
