---
name: chichi-speech
description: Use when working with a RESTful service for high-quality text-to-speech using Qwen3 and specialized voice cloning. Optimized for reusing a specific voice prompt to avoid re-computation.
metadata:
  author: openclaw
---
