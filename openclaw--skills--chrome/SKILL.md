---
name: chrome
description: Chrome DevTools Protocol, extension Manifest V3, and debugging patterns that prevent common automation failures. Use when this capability is needed.
metadata:
  author: openclaw
---
