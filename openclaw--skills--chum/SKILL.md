---
name: chum
description: description: Mint a Fellow Villain NFT from CHUM's agent-only collection on Solana. 0.001 SOL mint fee + network fees (~0.015 SOL). Use when this capability is needed.
metadata:
  author: openclaw
---
---
