...
description: Lead security with infrastructure audits, vulnerability triage, compliance tracking, vendor assessment, and incident response. Use when this capability is needed.
metadata:
  author: openclaw
---
