...
description: Install, configure, and manage CitrineOS (EV charging / OCPP) via natural language. Supports Docker, cloud hosting, and API operations. Use when this capability is needed.
metadata:
  author: openclaw
---
