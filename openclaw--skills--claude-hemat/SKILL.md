---
name: claude-hemat
description: 1. **Haiku 4.5** is the default model. Only spawn **Sonnet 4.5** or **Opus 4.6** when the task actually needs either of them Use when this capability is needed.
metadata:
  author: openclaw
---
# ClaudeHemat
