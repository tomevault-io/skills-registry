...
description: Keep your Claude access token fresh 24/7. Automatically refreshes OAuth tokens before expiry so you never see authentication failures. Use when this capability is needed.
metadata:
  author: openclaw
---
