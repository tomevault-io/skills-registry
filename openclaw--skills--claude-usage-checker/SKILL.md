---
name: claude-usage
description: Check Claude Code / Claude Max usage limits. Run when user asks about usage, limits, quota, or how much Claude capacity is left. Use when this capability is needed.
metadata:
  author: openclaw
---
