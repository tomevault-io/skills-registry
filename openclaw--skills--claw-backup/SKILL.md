---
name: claw-backup
description: Back up OpenClaw customizations (memory, config, skills, workspace) to cloud storage via rclone, with scheduling + retention. Works on macOS, Linux, and Windows (Git Bash/WSL). Use when this capability is needed.
metadata:
  author: openclaw
---
