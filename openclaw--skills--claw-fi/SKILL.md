---
name: clawfi
description: Financial market data and bot-native market intelligence API. Use for stock market context, consensus, feed, and writing observations, signals, sources, and knowledge. Trading and securities research data. Use when this capability is needed.
metadata:
  author: openclaw
---
