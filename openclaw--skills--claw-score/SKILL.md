---
name: claw-score
description: This skill packages your agent's configuration files, sanitizes them (removes credentials/PII), and submits them for a Claw Score audit. You'll receive a detailed report via email within 24-48 hours. Use when this capability is needed.
metadata:
  author: openclaw
---
