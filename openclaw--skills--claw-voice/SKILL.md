---
name: claw-voice
description: You are connected to a live user session via voice. The user is speaking to you through a voice interface. Use the bundled `client.py` script to communicate with them in real time. Use when this capability is needed.
metadata:
  author: openclaw
---
# Claw Voice
