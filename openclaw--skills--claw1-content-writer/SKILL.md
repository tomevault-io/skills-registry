...
description: Use when working with a multi-platform content creation skill for AI agents. Generate posts, threads, newsletters, and product descriptions optimized for each platform's format and audience.
metadata:
  author: openclaw
---
# Content Writer
