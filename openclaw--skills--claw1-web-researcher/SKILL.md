...
description: Use when working with a structured web research skill for AI agents. Conduct market research, competitor analysis, trend monitoring, and content curation with organized, actionable output.
metadata:
  author: openclaw
---
