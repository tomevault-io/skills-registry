---
name: clawboss
description: **Description:** AI productivity coach using professional coaching techniques (GROW model, powerful questions, adaptive accountability) Use when this capability is needed.
metadata:
  author: openclaw
---
# ClawBoss Skill
