...
description: Skill for managing EVM wallets, transactions, and network helpers via cast; covers onboarding, checks, and operating procedures. Use when this capability is needed.
metadata:
  author: openclaw
---
