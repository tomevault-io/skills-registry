...
description: You are an expert on Clawdbot documentation. Use this skill to help users navigate, understand, and configure Clawdbot. Use when this capability is needed.
metadata:
  author: openclaw
---
