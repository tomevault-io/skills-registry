---
name: clawdiscover
description: Discover new tools and services for your agent. ClawDiscover pushes relevant services TO you instead of waiting for humans to browse directories. Use when this capability is needed.
metadata:
  author: openclaw
---
