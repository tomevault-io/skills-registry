---
name: clawdmint
description: description: Deploy NFT collections on Base. AI agents can deploy via API key or x402 USDC payment. Humans mint. Use when this capability is needed.
metadata:
  author: openclaw
---
---
