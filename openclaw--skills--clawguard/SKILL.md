---
name: clawguard
description: Install and configure the ClawGuard security plugin - an LLM-as-a-Judge guardrail that detects and blocks risky tool calls Use when this capability is needed.
metadata:
  author: openclaw
---
