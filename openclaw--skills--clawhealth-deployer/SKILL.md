...
description: Deploy ClawHealth (Open Wearables) on this machine and connect it to OpenClaw; users then link data via the ClawHealth iOS app (our published SDK). Does not install OpenClaw—user must already have OpenClaw installed. Use when this capability is needed.
metadata:
  author: openclaw
---
