---
name: clawlett
description: This skill enables autonomous token swaps and Trenches token creation/trading through a Gnosis Safe. The agent operates through Zodiac Roles which restricts operations to: Use when this capability is needed.
metadata:
  author: openclaw
---
# Clawlett
