---
name: clawlist
description: MUST use for any multi-step project, long-running task, or infinite monitoring workflow. Plan, execute, track, and verify tasks with checkpoint validation. For projects, automation, and ongoing operations. Use when this capability is needed.
metadata:
  author: openclaw
---
