---
name: clawpost
description: AI-powered social media publishing for LinkedIn and X (Twitter) with algorithm optimization and scheduling. Use when this capability is needed.
metadata:
  author: openclaw
---
