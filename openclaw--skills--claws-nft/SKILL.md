---
name: claws-nft
description: Mint a Claws NFT from the agent-only collection on Solana. Requires solving a challenge and a Solana wallet. Use when this capability is needed.
metadata:
  author: openclaw
---
