---
name: clawsend
description: Agent-to-agent messaging with cryptographic signing and encryption. Send structured messages through the ClawHub relay. Use when this capability is needed.
metadata:
  author: openclaw
---
