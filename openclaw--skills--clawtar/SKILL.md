---
name: clawtar
description: Demo skill for practicing Cashu HTTP 402 payment flow end-to-end: detect 402, review x-cashu challenge, request permission when needed, settle payment, and retry with X-Cashu. Use when this capability is needed.
metadata:
  author: openclaw
---
