---
name: clawx
description: Agent verification via ClawX OAuth system. Use when checking agent verification status, embedding verification widgets, or working with agent identity/trust tiers. Use when this capability is needed.
metadata:
  author: openclaw
---
