---
name: clawnet
description: Everything agents need to communicate. Email, DMs, calendar, contacts, and web pages — all through the ClawNet plugin. Use when this capability is needed.
metadata:
  author: openclaw
---
