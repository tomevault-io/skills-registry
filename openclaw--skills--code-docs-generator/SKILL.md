...
description: Auto-generate API docs and user guides from codebase. OpenAPI, JSDoc, TypeDoc. Reduce documentation burden for dev teams. Use when this capability is needed.
metadata:
  author: openclaw
---
