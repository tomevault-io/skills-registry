...
description: Safe OpenClaw config updates with automatic backup, validation, and rollback. For agent use - prevents invalid config updates. Use when this capability is needed.
metadata:
  author: openclaw
---
