...
description: Automated context management for long-running Clawdbot sessions. Detects when context limits approach, compresses old conversation history, and seamlessly transfers to a fresh session. Use when this capability is needed.
metadata:
  author: openclaw
---
