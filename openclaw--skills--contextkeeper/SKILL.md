---
name: contextkeeper
description: ContextKeeper — Safe project state tracking for AI agents. Manual checkpoint creation with validated inputs. No background processes, no PID manipulation, no command execution. Use when this capability is needed.
metadata:
  author: openclaw
---
