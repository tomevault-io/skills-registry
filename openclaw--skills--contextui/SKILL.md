---
name: contextui
description: API key for ContextUI Exchange (publishing, downloading, browsing marketplace workflows). Get yours from the Exchange dashboard at contextui.ai. Use when this capability is needed.
metadata:
  author: openclaw
---
