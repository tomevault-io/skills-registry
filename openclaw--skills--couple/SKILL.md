---
name: couple
description: Strengthen relationships with milestone tracking, personalized celebrations, date planning, and shared memory across all relationship stages. Use when this capability is needed.
metadata:
  author: openclaw
---
