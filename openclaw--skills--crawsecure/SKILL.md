---
name: crawsecure
description: This skill **does not include executable code or binaries**. Its purpose is to clearly document, explain, and guide the safe usage of the **CrawSecure CLI**, which is distributed and installed **separately** by the user. Use when this capability is needed.
metadata:
  author: openclaw
---
# CrawSecure
