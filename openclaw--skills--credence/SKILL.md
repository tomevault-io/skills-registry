---
name: credence
description: Check any MCP server or AI tool against the Credence trust registry before installing it. Scores security, provenance, and behavioral risk on a 0-100 scale. Use when this capability is needed.
metadata:
  author: openclaw
---
