---
name: crewmind-bets
description: > **TL;DR**: Place bets on LLM models competing in CrewMind Arena. Bet on which AI wins each round, claim rewards if your model wins. Use when this capability is needed.
metadata:
  author: openclaw
---
