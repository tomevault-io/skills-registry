---
name: crypto-prices
description: Fetch live cryptocurrency and commodity prices using the local `crypto_prices.py` module. This is your **single source of truth** for all price data — never use web search for prices. Use when this capability is needed.
metadata:
  author: openclaw
---
# Skill: crypto-prices
