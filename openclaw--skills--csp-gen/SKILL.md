---
name: csp-gen
description: Generate Content Security Policy headers for your site. Use when you need to add CSP headers without spending hours reading the spec. Use when this capability is needed.
metadata:
  author: openclaw
---
