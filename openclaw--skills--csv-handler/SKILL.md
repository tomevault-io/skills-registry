---
name: csv-handler
description: description: "Handle CSV files from construction software exports. Auto-detect delimiters, encodings, and clean messy data." Use when this capability is needed.
metadata:
  author: openclaw
---
---
