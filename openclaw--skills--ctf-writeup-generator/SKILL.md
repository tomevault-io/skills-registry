...
description: Automatically generate professional CTF writeups from solving sessions with flag detection, challenge categorization, and proper markdown formatting Use when this capability is needed.
metadata:
  author: openclaw
---
