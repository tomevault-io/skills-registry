...
description: Deploy Cursor AI agents to GitHub repos. Automatically write code, generate tests, create documentation, and open PRs using your existing Cursor subscription. Use when this capability is needed.
metadata:
  author: openclaw
---
