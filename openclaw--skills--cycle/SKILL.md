---
name: cycle
description: Design custom workflow cycles for any domain. Create structured, repeatable processes that become persistent skills. Use when this capability is needed.
metadata:
  author: openclaw
---
