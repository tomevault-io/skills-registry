---
name: daily-oracle
description: This skill is designed to run as a background process (Cron Job). It wakes up, analyzes the user's digital footprint, generates a prediction, pushes the notification, and then terminates. Use when this capability is needed.
metadata:
  author: openclaw
---
---
