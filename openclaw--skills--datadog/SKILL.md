---
name: datadog
description: Monitor infrastructure and applications via Datadog API. Query metrics, manage dashboards, and create alerts. Use when this capability is needed.
metadata:
  author: openclaw
---
