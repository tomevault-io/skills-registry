---
name: debridge-mcp
description: Enable AI agents to execute non-custodial cross-chain cryptocurrency swaps and transfers via the deBridge protocol. Use when this capability is needed.
metadata:
  author: openclaw
---
# deBridge MCP Skill
