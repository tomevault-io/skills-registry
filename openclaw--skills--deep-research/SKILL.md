---
name: deep-research
description: Perform comprehensive web research using local SearXNG. Iteratively searches, fetches content, and synthesizes a report with citations. Use for complex research questions requiring multiple sources. Use when this capability is needed.
metadata:
  author: openclaw
---
