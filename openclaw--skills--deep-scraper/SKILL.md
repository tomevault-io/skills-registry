---
name: deep-scraper
description: Use when working with a high-performance engineering tool for deep web scraping. It uses a containerized Docker + Crawlee (Playwright) environment to penetrate protections on complex websites like YouTube and X/Twitter, providing "interception-level" raw data.
metadata:
  author: openclaw
---
# Skill: deep-scraper
