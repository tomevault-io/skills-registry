---
name: deepthink
description: DeepThink is the user's personal knowledge base. Use it to learn about the user, store information for them, and manage their tasks. Use when this capability is needed.
metadata:
  author: openclaw
---
# DeepThink
