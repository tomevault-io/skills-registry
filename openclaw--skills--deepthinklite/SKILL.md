---
name: deepthinklite
description: Local-first deep research like OpenAI Deep Research: generates questions.md + response.md artifacts and enforces a time budget. Use when this capability is needed.
metadata:
  author: openclaw
---
