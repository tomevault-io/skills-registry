---
name: depguard
description: Dependency audit, vulnerability scanning, and license compliance. Free vuln check + paid continuous monitoring via git hooks. Use when this capability is needed.
metadata:
  author: openclaw
---
