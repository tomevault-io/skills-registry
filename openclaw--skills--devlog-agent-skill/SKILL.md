...
description: This skill enables agents to maintain a professional developer log. It's designed to capture context, project milestones, and task statuses in a structured SQLite database. Use when this capability is needed.
metadata:
  author: openclaw
---
# DevLog Skill 🦞
