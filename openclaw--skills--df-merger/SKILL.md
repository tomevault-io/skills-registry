---
name: df-merger
description: description: "Merge pandas DataFrames from multiple construction sources. Handle different schemas, keys, and data quality issues." Use when this capability is needed.
metadata:
  author: openclaw
---
---
