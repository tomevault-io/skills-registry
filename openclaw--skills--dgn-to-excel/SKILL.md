---
name: dgn-to-excel
description: description: "Convert DGN files (v7-v8) to Excel databases. Extract elements, levels, and properties from infrastructure CAD files." Use when this capability is needed.
metadata:
  author: openclaw
---
---
