---
name: diagram
description: Generate diagrams from descriptions with Mermaid, PlantUML, or ASCII for architecture, flows, sequences, and data models. Use when this capability is needed.
metadata:
  author: openclaw
---
