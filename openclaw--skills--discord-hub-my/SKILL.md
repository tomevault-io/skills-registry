---
name: discord-hub-my
description: OpenClaw skill for Discord Bot API workflows, covering interactions, commands, messages, and operations using direct HTTPS requests. Use when this capability is needed.
metadata:
  author: openclaw
---
