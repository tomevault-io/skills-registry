---
name: dji-backup
description: This skill automates backing up DJI camera footage from an SD card (or USB share) to a NAS archive folder. Use when this capability is needed.
metadata:
  author: openclaw
---
