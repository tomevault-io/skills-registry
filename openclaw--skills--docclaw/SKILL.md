---
name: docclaw
description: DocClaw is a documentation skill for OpenClaw that combines live docs search, direct markdown fetch, and offline local-doc fallback. Use when this capability is needed.
metadata:
  author: openclaw
---
