...
description: Use when working with a skill that allows OpenClaw to interact with Docker-deployed Xunlei services for downloading magnet links and managing download tasks.
metadata:
  author: openclaw
---
