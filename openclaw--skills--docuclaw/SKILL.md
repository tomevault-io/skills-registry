---
name: docuclaw
description: Sovereign document intelligence & archival system. Extracts structured data from invoices, receipts, and contracts 100% locally using AI. Use when this capability is needed.
metadata:
  author: openclaw
---
