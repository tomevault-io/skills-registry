---
name: dogecoin-node
description: Use when working with a skill to set up and operate a Dogecoin Core full node with RPC access, blockchain tools, and optional tipping functionality.
metadata:
  author: openclaw
---
