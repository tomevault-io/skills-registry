---
name: domain
description: description: Check availability. Search related domains. Find more possibilities. Explore connections. Turn AI into your domain agent. Use when this capability is needed.
metadata:
  author: openclaw
---
---
