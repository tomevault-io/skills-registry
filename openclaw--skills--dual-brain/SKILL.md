---
name: dual-brain
description: **What it does:** Provides cognitive diversity by automatically generating perspectives from a secondary LLM (different from your primary model) for every user message. Use when this capability is needed.
metadata:
  author: openclaw
---
# Dual-Brain Skill
