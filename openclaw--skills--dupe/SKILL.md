---
name: dupe
description: Uses dupe.com APIs in order to find similar products for the product found in the input URL given by the user. Use when this capability is needed.
metadata:
  author: openclaw
---
