---
name: dzen
description: Publish articles and posts to Dzen.ru (Yandex Zen). Supports text, images, and videos. Requires session cookies and a CSRF token from a logged-in browser session. Use when this capability is needed.
metadata:
  author: openclaw
---
