---
name: email-manager
description: Check and reply to emails via Gmail API. Monitor inbox, draft responses, send emails. Use when user says "check email", "reply email", "send email". Use when this capability is needed.
metadata:
  author: openclaw
---
