---
name: embeddings
description: Generate, store, and search vector embeddings with provider selection, chunking strategies, and similarity search optimization. Use when this capability is needed.
metadata:
  author: openclaw
---
