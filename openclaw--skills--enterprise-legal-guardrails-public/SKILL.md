...
description: Legal/compliance guardrails for outbound OpenClaw actions (anti-spam, defamation, privacy, financial claims). Use when this capability is needed.
metadata:
  author: openclaw
---
