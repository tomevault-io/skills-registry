...
description: Generate TypeScript types from .env files with smart inference. Type-safe environment variables. Optional Zod schema. Free CLI tool. Use when this capability is needed.
metadata:
  author: openclaw
---
