---
name: erc-800claw
description: Use when working with the OpenClaw entry point for ERC-8004 agent identity and reputation. Register agents on-chain, query identities, give and receive feedback ratings.
metadata:
  author: openclaw
---
