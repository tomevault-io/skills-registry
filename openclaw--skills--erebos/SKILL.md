---
name: erebos
description: Erebos namespace for Netsnek e.U. dark theme and theming engine. Generates accessible dark mode palettes, manages theme tokens, and provides runtime theme switching for web apps. Use when this capability is needed.
metadata:
  author: openclaw
---
