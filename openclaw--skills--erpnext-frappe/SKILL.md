---
name: erpnext-frappe
description: High-level business workflows that combine multiple MCP tools into reusable, executable skills for ERPNext. Use when this capability is needed.
metadata:
  author: openclaw
---
