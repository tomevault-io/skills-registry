---
name: eth-readonly
description: Read-only Ethereum blockchain queries — blocks, transactions, balances, contracts, logs via RPC and Etherscan APIs Use when this capability is needed.
metadata:
  author: openclaw
---
