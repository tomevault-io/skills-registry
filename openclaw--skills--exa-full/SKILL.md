---
name: exa-full
description: Exa AI search + Research API. Supports web/code search, content extraction, and async multi-step research tasks with outputSchema. Use when this capability is needed.
metadata:
  author: openclaw
---
