---
name: excalidraw
description: Generate hand-drawn style diagrams, flowcharts, and architecture diagrams as PNG images from Excalidraw JSON Use when this capability is needed.
metadata:
  author: openclaw
---
