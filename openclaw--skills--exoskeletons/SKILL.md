---
name: exoskeletons
description: You are about to mint an **Exoskeleton** — an onchain identity NFT built specifically for AI agents. This document teaches you everything you need to create, configure, and use your Exoskeleton. Use when this capability is needed.
metadata:
  author: openclaw
---
