...
description: Agent web access acceleration layer — reads any URL as structured JSON. Cache-first (public library hit = 0 tokens). The smart alternative to raw web_fetch. Use when this capability is needed.
metadata:
  author: openclaw
---
