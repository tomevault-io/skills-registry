---
name: facture-make
description: Ce skill permet de générer et d'envoyer des factures professionnelles vers Make.com après une étape de confirmation humaine. Use when this capability is needed.
metadata:
  author: openclaw
---
# Skill: Facture Make
