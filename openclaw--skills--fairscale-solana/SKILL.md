...
description: Real-time wallet reputation scoring for Solana. Use this skill to check if a wallet is trustworthy before transacting. Use when this capability is needed.
metadata:
  author: openclaw
---
