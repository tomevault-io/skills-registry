...
description: Query equipment status, maintenance schedules, and service history for the farm fleet. Uses integration endpoints (no auth required). Use when this capability is needed.
metadata:
  author: openclaw
---
