---
name: villain-mint
description: Mint a Fellow Villain NFT from CHUM's agent-only collection on Solana. Free mint — only network fees (~0.015 SOL). Use when this capability is needed.
metadata:
  author: openclaw
---
