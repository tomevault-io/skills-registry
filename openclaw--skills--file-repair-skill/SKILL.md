...
description: description: Repair damaged/corrupted files (video/document/design/archive) and provide an output download URL. Use when this capability is needed.
metadata:
  author: openclaw
---
---
