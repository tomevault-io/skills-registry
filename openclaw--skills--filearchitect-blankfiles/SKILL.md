---
name: blankfiles
description: Use blankfiles.com as a binary test-file gateway: discover formats, filter by type/category, and return direct download URLs from the public API. Use when this capability is needed.
metadata:
  author: openclaw
---
