---
name: find
description: Locate anything with progressive search expansion, multi-source validation, and iterative refinement until found. Use when this capability is needed.
metadata:
  author: openclaw
---
