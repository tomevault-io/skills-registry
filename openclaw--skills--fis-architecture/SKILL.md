...
description: Orchestrate multi-agent workflows with JSON tickets and A2A coordination. Use when delegating tasks between CyberMao (Main) and Worker agents (Engineer/Researcher/Writer). Use when this capability is needed.
metadata:
  author: openclaw
---
