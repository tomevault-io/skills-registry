...
description: Generate Anki/Quizlet-compatible flashcards from text, notes, or documents using learning science principles. Use when this capability is needed.
metadata:
  author: openclaw
---
