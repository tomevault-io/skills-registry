---
name: flashcards
description: Create effective flashcards with optimal formatting, spaced repetition integration, and memory science principles. Use when this capability is needed.
metadata:
  author: openclaw
---
