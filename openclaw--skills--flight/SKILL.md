---
name: flight
description: Search, compare, book, and manage flights with price tracking, multi-platform comparison, and loyalty optimization. Use when this capability is needed.
metadata:
  author: openclaw
---
