---
name: flowclaw
description: Unkillable LLM load balancer for OpenClaw. Monitors usage across Anthropic, Google, OpenAI, GitHub Copilot, and Ollama. Scores accounts by urgency, rotates automatically, and fails over to local models. Your agent never gets stuck. Use when this capability is needed.
metadata:
  author: openclaw
---
