---
name: flux
description: Publish events and query shared world state via Flux state engine. Use when agents need to share observations, coordinate on shared data, or track entity state across systems. Use when this capability is needed.
metadata:
  author: openclaw
---
