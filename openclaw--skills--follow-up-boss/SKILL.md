---
name: follow-up-boss
description: CLI for interacting with the Follow Up Boss API. Manage people, notes, tasks, events, deals, webhooks, and more. Use when this capability is needed.
metadata:
  author: openclaw
---
