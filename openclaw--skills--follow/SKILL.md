---
name: follow
description: Monitor content from people, topics, and sources across platforms with smart filtering, tiered alerts, and searchable archives. Use when this capability is needed.
metadata:
  author: openclaw
---
