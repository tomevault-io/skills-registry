...
description: Generate FOSMVVM Fields protocols with validation rules, FormField definitions, and localized messages. Define form contracts once, validate everywhere. Use when this capability is needed.
metadata:
  author: openclaw
---
