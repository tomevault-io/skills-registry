...
description: Generate SwiftUI views that render FOSMVVM ViewModels. Scaffolds ViewModelView pattern with binding, loading states, and previews. Use when this capability is needed.
metadata:
  author: openclaw
---
