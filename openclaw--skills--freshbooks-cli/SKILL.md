---
name: freshbooks-cli
description: FreshBooks CLI for managing invoices, clients, and billing. Use when the user mentions freshbooks, invoicing, billing, clients, or accounting. Use when this capability is needed.
metadata:
  author: openclaw
---
