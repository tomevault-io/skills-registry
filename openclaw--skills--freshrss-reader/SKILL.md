---
name: freshrss
description: Query headlines and articles from a self-hosted FreshRSS instance. Use when the user asks for RSS news, latest headlines, feed updates, or wants to browse articles from their FreshRSS reader. Supports filtering by category, time range, and count. Use when this capability is needed.
metadata:
  author: openclaw
---
