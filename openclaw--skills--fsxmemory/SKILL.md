---
name: fsxmemory
description: Structured memory system for AI agents. Context death resilience (checkpoint/recover), structured storage, Obsidian-compatible markdown, and local semantic search. Use when this capability is needed.
metadata:
  author: openclaw
---
