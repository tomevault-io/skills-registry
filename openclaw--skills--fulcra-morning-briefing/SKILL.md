...
description: Compose a personalized morning briefing using sleep, biometrics, calendar, and weather data from the Fulcra Life API. Adapts tone and detail to how your human actually slept. Use when this capability is needed.
metadata:
  author: openclaw
---
