...
description: Command-line fuzzy finder for interactive filtering and selection - integrates with shell, vim, and other tools. Use when this capability is needed.
metadata:
  author: openclaw
---
