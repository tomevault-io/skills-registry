---
name: garmin-skill
description: Talk to your Garmin data — ask questions about your activities, training load, VO2 Max, heart rate zones, and more using AI. Use when this capability is needed.
metadata:
  author: openclaw
---
