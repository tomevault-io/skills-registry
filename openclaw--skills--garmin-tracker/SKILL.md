---
name: garmin-tracker
description: Rebuild and maintain garmin_tracking.json from Garmin web data (activities + training plan) with a fixed schema from 2026-02-01. Use when this capability is needed.
metadata:
  author: openclaw
---
