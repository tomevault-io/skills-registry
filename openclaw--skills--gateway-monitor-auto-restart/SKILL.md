...
description: This skill provides comprehensive monitoring for the OpenClaw gateway with automatic restart capabilities. It includes: Use when this capability is needed.
metadata:
  author: openclaw
---
