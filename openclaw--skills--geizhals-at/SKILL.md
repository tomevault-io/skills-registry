---
name: geizhals-at
description: Search Geizhals.at (Austria) with HTTP-only autocomplete + detail-page parsing (no browser automation). Use when users want quick price checks from Geizhals.at and accept unofficial/best-effort scraping limits. Use when this capability is needed.
metadata:
  author: openclaw
---
