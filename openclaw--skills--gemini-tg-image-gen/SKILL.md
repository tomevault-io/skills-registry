...
description: Generate images via OpenRouter (google/gemini-2.5-flash-image) and send to Telegram. Use when user asks for AI-generated images in TG. Use when this capability is needed.
metadata:
  author: openclaw
---
