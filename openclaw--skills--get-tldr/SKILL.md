---
name: get-tldr
description: description: Provide the summary returned by the get-tldr.com summarize API without further summarization; the skill should format the API output for readability but must not change its content. Use when this capability is needed.
metadata:
  author: openclaw
---
---
