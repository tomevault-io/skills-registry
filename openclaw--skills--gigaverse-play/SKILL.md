---
name: gigaverse
description: Enter the Gigaverse as an AI agent. Create a wallet, quest through dungeons, battle echoes, and earn rewards. The dungeon awaits. Use when this capability is needed.
metadata:
  author: openclaw
---
