---
name: git-changelog
description: Generate changelogs from git commits. Supports markdown, plain text, and JSON output with date ranges and tag-based filtering. Use when this capability is needed.
metadata:
  author: openclaw
---
