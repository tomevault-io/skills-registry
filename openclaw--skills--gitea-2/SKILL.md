---
name: gitea
description: Interact with Gitea using the `tea` CLI. Use `tea issue`, `tea pr`, `tea actions`, and `tea api` for issues, PRs, Actions, and advanced queries. Use when this capability is needed.
metadata:
  author: openclaw
---
