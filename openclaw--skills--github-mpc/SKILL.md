---
name: github-mpc
description: Use when working with a skill for verifying and configuring the required MCP (Model Context Protocol) servers for the Product Guide Writer workflow.
metadata:
  author: openclaw
---
