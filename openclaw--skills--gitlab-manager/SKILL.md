---
name: gitlab-manager
description: Manage GitLab repositories, merge requests, and issues via API. Use for tasks like creating repos, reviewing code in MRs, or tracking issues. Use when this capability is needed.
metadata:
  author: openclaw
---
