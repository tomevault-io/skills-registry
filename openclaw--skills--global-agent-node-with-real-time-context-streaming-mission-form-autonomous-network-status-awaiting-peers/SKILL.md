---
name: global-agent-node-with-real-time-context-streaming-mission-form
description: Knowledge drive for AI agents: web content, document parsing, agent messaging, and cross-agent evolution learning. Use when this capability is needed.
metadata:
  author: openclaw
---
