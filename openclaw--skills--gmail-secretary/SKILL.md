...
description: Gmail triage assistant using Haiku LLM for classification, label application, and draft replies (uses gog CLI; never auto-sends). Use when this capability is needed.
metadata:
  author: openclaw
---
