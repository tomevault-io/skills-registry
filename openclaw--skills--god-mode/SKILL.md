---
name: god-mode
description: description: Developer oversight and AI agent coaching. Use when viewing project status across repos, syncing GitHub data, or analyzing agents.md against commit patterns. Use when this capability is needed.
metadata:
  author: openclaw
---
---
