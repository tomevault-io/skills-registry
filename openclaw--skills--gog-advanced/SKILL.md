---
name: gog-advanced
description: Reliable Google Workspace CLI skill (gogcli). Defaults to all-calendars for agenda queries; JSON-first; safe writes. Use when this capability is needed.
metadata:
  author: openclaw
---
