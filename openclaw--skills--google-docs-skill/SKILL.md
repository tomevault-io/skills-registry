...
description: Direct access to the Google Docs API using OAuth 2.0. Create documents, insert and format text, and manage document content. Use when this capability is needed.
metadata:
  author: openclaw
---
