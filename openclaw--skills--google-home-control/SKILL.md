---
name: google-home
description: Control smart home devices (lights, TV, etc.) via the Google Assistant SDK. Use when the user wants to trigger home automation commands. Use when this capability is needed.
metadata:
  author: openclaw
---
