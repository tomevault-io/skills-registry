...
description: OpenClaw skill that installs a Google Sheets CLI with setup steps and commands for read/write, batch, formatting, and sheet management. Use when this capability is needed.
metadata:
  author: openclaw
---
