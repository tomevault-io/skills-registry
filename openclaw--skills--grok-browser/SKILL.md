---
name: grok-browser
description: Query Grok AI via browser automation. Use when you need to ask Grok questions, get AI responses, or use Grok's DeepSearch/Think features. Copies response text instead of using screenshots. Use when this capability is needed.
metadata:
  author: openclaw
---
