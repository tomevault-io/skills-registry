---
name: guardrails
description: Helps users configure comprehensive security guardrails for their OpenClaw workspace through an interactive interview process. Use when this capability is needed.
metadata:
  author: openclaw
---
