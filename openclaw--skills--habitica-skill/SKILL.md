---
name: habitica
description: Habitica gamified habit tracker integration. Use for listing/creating/completing habits, dailies, todos, and rewards. Trigger on "habitica", "习惯", "待办", "日常任务", or requests to check off tasks. Use when this capability is needed.
metadata:
  author: openclaw
---
