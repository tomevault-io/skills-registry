---
name: harpa-ai
description: description: Automate web browsers, scrape pages, search the web, and run AI prompts on live websites via HARPA AI Grid REST API Use when this capability is needed.
metadata:
  author: openclaw
---
---
