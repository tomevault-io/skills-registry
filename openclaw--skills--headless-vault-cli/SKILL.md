...
description: Read and edit Markdown notes on your personal computer via SSH tunnel. Use when the user asks to read, create, or append to notes in their vault. Use when this capability is needed.
metadata:
  author: openclaw
---
