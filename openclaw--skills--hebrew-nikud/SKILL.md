---
name: hebrew-nikud
description: Hebrew nikud (vowel points) reference for AI agents. Correct nikud rules for verb conjugations (binyanim), dagesh, gender suffixes, homographs, and common mistakes. Use before adding nikud to Hebrew text (especially for TTS). Use when this capability is needed.
metadata:
  author: openclaw
---
