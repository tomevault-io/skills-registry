---
name: hex-vetter
description: Physical-layer hex auditing for skills. Detects hidden binary data, control characters, and encoding-based attacks. Use when this capability is needed.
metadata:
  author: openclaw
---
