---
name: hiring
description: Hire humans or AI agents for tasks you cannot do yourself, with platform selection, vetting, contracts, and payment management. Use when this capability is needed.
metadata:
  author: openclaw
---
