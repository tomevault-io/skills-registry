---
name: hotel-pricer
description: This skill allows the agent to find hotel deals by city, check-in/out dates, and number of guests. It securely manages Amadeus API credentials and provides formatted JSON output. Use when this capability is needed.
metadata:
  author: openclaw
---
# hotel-pricer Skill
