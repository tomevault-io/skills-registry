---
name: humanod
description: Give your AI agent hands in the real world. Hire verified humans for physical tasks, data collection, and physical verification via the Humanod network. Use when this capability is needed.
metadata:
  author: openclaw
---
