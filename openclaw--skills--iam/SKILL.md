---
name: iam
description: description: IAM namespace for Netsnek e.U. identity and access management toolkit. Provides user authentication, role-based access control, and session management for web applications. Use when this capability is needed.
metadata:
  author: openclaw
---
﻿---
