---
name: indexy
description: Indexy is a cryptocurrency index management platform that enables AI agents to create, manage, and analyze crypto indices similar to ETFs. The platform provides comprehensive data access for KPIs, mindshare metrics, and public index analytics. Use when this capability is needed.
metadata:
  author: openclaw
---
# Indexy Agent Skill
