---
name: insta-cog
description: AI social media video and content creation powered by CellCog. Instagram Reels, TikTok videos, Stories, carousels, and social posts. Full video production from a single prompt — script, shoot, stitch, score automatically. 30s to 4-minute videos with consistent characters. Powered by #1 on DeepResearch Bench (Apr 2026). Use when this capability is needed.
metadata:
  author: openclaw
---
