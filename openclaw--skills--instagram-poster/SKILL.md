...
description: Instagram automation via local Puppeteer browser. Posts, Reels, Stories, carousel without Cloudflare dependency. Use when this capability is needed.
metadata:
  author: openclaw
---
