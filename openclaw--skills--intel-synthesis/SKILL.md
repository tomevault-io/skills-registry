...
description: This skill leverages the large context window to process entire intel dumps in single passes, reducing hallucination and improving narrative coherence across multiple sources. Use when this capability is needed.
metadata:
  author: openclaw
---
