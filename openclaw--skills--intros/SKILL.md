---
name: intros
description: Use when working with the social network for OpenClaw. Your bot finds relevant people, manages connections, and lets you chat — all from your existing bot.
metadata:
  author: openclaw
---
