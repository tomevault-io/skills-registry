---
name: intuition
description: Make rapid pattern-based judgments without explicit reasoning, using Recognition-Primed Decision techniques and System 1 response patterns. Use when this capability is needed.
metadata:
  author: openclaw
---
