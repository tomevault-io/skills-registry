---
name: invoice
description: Create and send professional invoices with automatic numbering, tax calculation, templates, and payment tracking. Use when this capability is needed.
metadata:
  author: openclaw
---
