---
name: invoices
description: Capture, extract, and organize received invoices with automatic OCR, provider detection, and searchable archive. Use when this capability is needed.
metadata:
  author: openclaw
---
