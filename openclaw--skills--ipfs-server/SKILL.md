---
name: ipfs-server
description: Full IPFS node operations — install, configure, pin content, publish IPNS, manage peers, and run gateway services Use when this capability is needed.
metadata:
  author: openclaw
---
