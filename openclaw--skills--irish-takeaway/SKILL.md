---
name: irish-takeaway
description: Find nearby takeaways in Ireland and browse menus via Deliveroo/Just Eat. Uses Google Places API for discovery and browser automation for menu scraping. Use when this capability is needed.
metadata:
  author: openclaw
---
