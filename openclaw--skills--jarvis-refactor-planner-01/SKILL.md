...
description: Plan low-risk refactors with seams, tests, and rollback points. Use when handling development work that needs repeatable steps, quality gates, and practical outputs. Use when this capability is needed.
metadata:
  author: openclaw
---
