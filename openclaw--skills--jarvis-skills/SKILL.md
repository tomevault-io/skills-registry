---
name: jarvis-skills
description: Use when working with the Robotic Control skill integrates OpenClaw for physical robotic arm and gripper manipulation through voice commands and programmatic control.
metadata:
  author: openclaw
---
