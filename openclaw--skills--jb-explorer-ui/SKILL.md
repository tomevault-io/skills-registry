---
name: jb-explorer-ui
description: Etherscan-like contract explorer for Juicebox projects. Read contract state, write transactions, and decode events. Use when this capability is needed.
metadata:
  author: openclaw
---
