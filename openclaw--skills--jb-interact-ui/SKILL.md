---
name: jb-interact-ui
description: Generate minimal frontends for interacting with existing Juicebox V5 projects. Pay, cash out, claim tokens, view project state - all in standalone HTML files. Use when this capability is needed.
metadata:
  author: openclaw
---
