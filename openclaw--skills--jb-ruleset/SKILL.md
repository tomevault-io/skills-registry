---
name: jb-ruleset
description: Configure and queue Juicebox V5 rulesets. Design ruleset parameters including issuance rate, reserved rate, cash out tax rate, splits, payout limits, and approval hooks. Generate scripts for queueing new rulesets. Use when this capability is needed.
metadata:
  author: openclaw
---
