---
name: jee
description: Prepare for India's Joint Entrance Examination with progress tracking, weak area analysis, mock test strategy, and IIT/NIT targeting. Use when this capability is needed.
metadata:
  author: openclaw
---
