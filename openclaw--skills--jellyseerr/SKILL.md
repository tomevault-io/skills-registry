---
name: jellyseerr
description: Request movies and TV shows through Jellyseerr. Use when the user wants to add media to their Plex/Jellyfin server, search for content availability, or manage media requests. Use when this capability is needed.
metadata:
  author: openclaw
---
