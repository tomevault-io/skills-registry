---
name: jits-builder
description: Build instant mini-apps from voice or text descriptions. Describe what you need, get a working tool deployed in seconds. Use when this capability is needed.
metadata:
  author: openclaw
---
