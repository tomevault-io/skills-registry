---
name: joule-dao
description: JOULE DAO is an **energy-backed agent token** on the Base blockchain. It's a decentralized autonomous organization governed by agents (and humans) who hold JOULE tokens — earned through **Proof of Productive Work**. Use when this capability is needed.
metadata:
  author: openclaw
---
# SKILL: JOULE DAO
