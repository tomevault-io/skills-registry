...
description: Process, filter, and transform JSON data using jq - the lightweight and flexible command-line JSON processor. Use when this capability is needed.
metadata:
  author: openclaw
---
