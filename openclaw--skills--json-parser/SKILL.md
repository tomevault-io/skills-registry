---
name: json-parser
description: description: "Parse and validate JSON data from construction APIs, IoT sensors, and BIM exports. Transform nested JSON to flat DataFrames." Use when this capability is needed.
metadata:
  author: openclaw
---
---
