---
name: jules-api
description: description: Create and manage Google Jules AI coding sessions via the Jules REST API. Start tasks, monitor progress, approve plans, send messages, list sources/repos, and retrieve session activities/artifacts. Use when this capability is needed.
metadata:
  author: openclaw
---
---
