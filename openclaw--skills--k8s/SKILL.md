---
name: kubernetes
description: Avoid common Kubernetes mistakes — resource limits, probe configuration, selector mismatches, and RBAC pitfalls. Use when this capability is needed.
metadata:
  author: openclaw
---
