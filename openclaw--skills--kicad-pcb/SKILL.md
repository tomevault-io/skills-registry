---
name: kicad-pcb
description: Automate PCB design with KiCad. Create schematics, design boards, export Gerbers, order from PCBWay. Full design-to-manufacturing pipeline. Use when this capability is needed.
metadata:
  author: openclaw
---
