---
name: knhb-hockey
description: Query Dutch field hockey match schedules and results from KNHB Match Center (hockeyweerelt.nl). Use when looking up hockey clubs, teams, upcoming matches, or match results in the Netherlands. Use when this capability is needed.
metadata:
  author: openclaw
---
