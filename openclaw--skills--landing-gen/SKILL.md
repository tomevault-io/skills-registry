---
name: landing-gen
description: Generate a beautiful HTML landing page from your package.json. Use when you need a quick marketing page for your project. Use when this capability is needed.
metadata:
  author: openclaw
---
