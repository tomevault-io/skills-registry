...
description: Use when working with the `EmailAgent` class provides an AI-powered email composition and sending capability using LangChain with OpenAI's GPT model. It includes human-in-the-loop middleware that requires approval before emails are sent.
metadata:
  author: openclaw
---
# EmailAgent README
