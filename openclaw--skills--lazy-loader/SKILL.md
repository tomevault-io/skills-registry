---
name: lazy-loader
description: Identify components that should be lazy loaded using AI. Use when optimizing bundle size and initial load. Use when this capability is needed.
metadata:
  author: openclaw
---
