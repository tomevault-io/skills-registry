---
name: pocket-tts
description: Generate speech from text using Kyutai Pocket TTS - lightweight, CPU-friendly, streaming TTS with voice cloning. English only. ~6x real-time on M4 MacBook Air. Use when this capability is needed.
metadata:
  author: openclaw
---
