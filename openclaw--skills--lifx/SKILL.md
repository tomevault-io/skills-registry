---
name: lifx
description: Control LIFX smart lights via natural language. Toggle, set colors/brightness, activate scenes, create gradients on multi-zone devices. Use when this capability is needed.
metadata:
  author: openclaw
---
