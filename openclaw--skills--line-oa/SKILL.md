---
name: line-oa
description: Operate LINE Official Account Manager (chat.line.biz) via browser automation. Use when asked to check LINE messages, reply to LINE customers, or manage LINE OA chat interface. Use when this capability is needed.
metadata:
  author: openclaw
---
