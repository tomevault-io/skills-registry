---
name: linear-todos
description: Use when working with a CLI tool that executes Python source code to manage todos via Linear's API. Creates tasks with natural language dates, priorities, and scheduling. This is a source-execution skill - code in src/linear_todos/ runs when commands are invoked.
metadata:
  author: openclaw
---
