---
name: linear-webhook
description: Comment @mason or @eureka in Linear issues to dispatch tasks to agents. Webhook receives Linear comments and routes to correct agent. Use when this capability is needed.
metadata:
  author: openclaw
---
