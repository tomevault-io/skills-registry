...
description: This skill lets AI agents discover available ad space on any town board, then claim and pay for pins using the x402 USDC payment protocol. **Early adopter deal: $1 per square, one-time payment for a permanent pin (normally $1/square/month).** Use when this capability is needed.
metadata:
  author: openclaw
---
