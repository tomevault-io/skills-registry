---
name: logo
description: Generate logos with AI image tools using effective prompt structures, validation loops, and export workflows for App Store icons and brand marks. Use when this capability is needed.
metadata:
  author: openclaw
---
