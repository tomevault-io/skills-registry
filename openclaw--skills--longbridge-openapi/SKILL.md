...
description: Longbridge Securities OpenAPI SDK, supporting Hong Kong and US stock trading, real-time market data subscription, and account management. Use when this capability is needed.
metadata:
  author: openclaw
---
# Longbridge OpenAPI
