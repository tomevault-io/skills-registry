---
name: lotus-wisdom
description: Step-by-step contemplative problem-solving using Buddhist wisdom domains. Interactive dialogue where each step completes before proceeding. Use for complex problems, paradoxes, creative blocks requiring deep insight through disciplined reflection. CRITICAL - This is not a monologue framework, it requires stopping after each step. Use when this capability is needed.
metadata:
  author: openclaw
---
