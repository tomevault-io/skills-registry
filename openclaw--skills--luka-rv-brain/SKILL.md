---
name: researchvault
description: High-velocity research orchestration engine. Manages persistent state, synthesis, and autonomous verification for agents. Use when this capability is needed.
metadata:
  author: openclaw
---
