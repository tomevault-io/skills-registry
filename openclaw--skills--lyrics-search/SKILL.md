---
name: lyrics-search
description: Search song lyrics by title and artist using the LrcApi public API. Use when the user asks to find, display, or print lyrics for a song. Use when this capability is needed.
metadata:
  author: openclaw
---
