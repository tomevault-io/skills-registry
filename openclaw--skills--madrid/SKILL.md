---
name: madrid
description: Navigate Madrid as visitor, resident, tech worker, student, or entrepreneur with neighborhoods, transport, costs, safety, and local insights. Use when this capability is needed.
metadata:
  author: openclaw
---
