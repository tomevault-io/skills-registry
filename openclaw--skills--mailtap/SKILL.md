---
name: mailtap
description: This skill provides seamless access to the MailTap Public API, a free temporary email service that generates disposable email addresses valid for 30 minutes. Use when this capability is needed.
metadata:
  author: openclaw
---
