---
name: makex
description: OpenClaw is a skill-based integration system that allows apps built on MakeX to discover and execute actions from third-party services (Gmail, Slack, GitHub, etc.) via Composio. Use when this capability is needed.
metadata:
  author: openclaw
---
