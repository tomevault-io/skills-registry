...
description: Manage Apple Notes from the terminal using the inotes CLI. Use when asked to list, read, create, edit, delete, or search notes in Notes.app on macOS. Use when this capability is needed.
metadata:
  author: openclaw
---
