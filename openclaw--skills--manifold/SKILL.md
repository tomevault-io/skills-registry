---
name: manifold
description: Read and trade on Manifold Markets (search markets, fetch probabilities, inspect users/bets, place bets/sell/comment). Never place a bet/sell/comment without explicit user confirmation. Use when this capability is needed.
metadata:
  author: openclaw
---
