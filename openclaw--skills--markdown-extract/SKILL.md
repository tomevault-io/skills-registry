...
description: This skill converts web pages to clean markdown format using the markdown.new API. It supports multiple extraction methods and handles errors gracefully. Use when this capability is needed.
metadata:
  author: openclaw
---
