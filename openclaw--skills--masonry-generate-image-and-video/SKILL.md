---
name: masonry
description: AI-powered image and video generation. Generate images, videos, manage jobs, and explore models via the masonry CLI. Use when this capability is needed.
metadata:
  author: openclaw
---
