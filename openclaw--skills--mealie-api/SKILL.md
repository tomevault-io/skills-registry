---
name: mealie
description: Interact with Mealie recipe manager (recipes, shopping lists, meal plans). Self-hosted recipe and meal planning API client. Use when this capability is needed.
metadata:
  author: openclaw
---
