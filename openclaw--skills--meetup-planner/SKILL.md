---
name: meetup-planner
description: Use when working with an intelligent event finder that searches for meetups and events based on your interests, tracks them, and reminds you before they happen
metadata:
  author: openclaw
---
