---
name: mema-vault
description: Secure credential manager using AES-256 (Fernet) encryption. Stores, retrieves, and rotates secrets using a mandatory Master Key. Use for managing API keys, database credentials, and other sensitive tokens. Use when this capability is needed.
metadata:
  author: openclaw
---
