---
name: mema
description: Mema's personal brain - SQLite metadata index for documents and Redis short-term context buffer. Use for organizing workspace knowledge paths and managing ephemeral session state. Use when this capability is needed.
metadata:
  author: openclaw
---
