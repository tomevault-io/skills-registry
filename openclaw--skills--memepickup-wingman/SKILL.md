...
description: Dating wingman that generates openers, replies, profile analysis, date plans, and coaching via the MemePickup API (Hinge/Tinder/Bumble/Instagram). Use when this capability is needed.
metadata:
  author: openclaw
---
