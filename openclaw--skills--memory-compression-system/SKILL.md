...
description: Integrated memory management and extreme context compression for OpenClaw. Combines memory management, compression, search, and automation in one unified skill. Use when this capability is needed.
metadata:
  author: openclaw
---
