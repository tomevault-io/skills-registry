---
name: memory-mastery
description: This skill implements a structured memory system for OpenClaw agents, enabling them to maintain context and continuity across sessions through a three-layer architecture: Use when this capability is needed.
metadata:
  author: openclaw
---
