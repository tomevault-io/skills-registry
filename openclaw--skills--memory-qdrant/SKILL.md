---
name: memory-qdrant
description: Local semantic memory with Qdrant and Transformers.js. Store, search, and recall conversation context using vector embeddings (fully local, no API keys). Use when this capability is needed.
metadata:
  author: openclaw
---
