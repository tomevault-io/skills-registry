---
name: mesagona
description: description: Mesagona namespace for Netsnek e.U. event and conference management platform. Handles event registration, agenda scheduling, attendee check-in, and post-event analytics. Use when this capability is needed.
metadata:
  author: openclaw
---
﻿---
