---
name: miami
description: Navigate Miami as visitor, resident, tech worker, student, or entrepreneur with neighborhoods, beaches, costs, safety, and local insights. Use when this capability is needed.
metadata:
  author: openclaw
---
