...
description: Send messages, manage channels, and automate workflows via Microsoft Teams API. Post to channels, create meetings, and manage team memberships. Use when this capability is needed.
metadata:
  author: openclaw
---
