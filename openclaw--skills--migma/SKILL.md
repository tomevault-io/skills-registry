---
name: migma
description: Generate, send, validate, and export AI-powered emails from the terminal; manage contacts, segments, tags, domains, and webhooks with Migma CLI. Use when this capability is needed.
metadata:
  author: openclaw
---
