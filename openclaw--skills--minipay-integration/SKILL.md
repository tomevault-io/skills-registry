...
description: Build Mini Apps for MiniPay wallet. Use when building applications for MiniPay, detecting MiniPay wallet, or creating mobile-first dApps for Celo. Use when this capability is needed.
metadata:
  author: openclaw
---
