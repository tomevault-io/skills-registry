---
name: mintyouragent
description: AI agent toolkit for Solana — launch tokens, play poker, link your agent identity to mintyouragent.com. Reads agent personality files (SOUL.md) for profile linking. Stores wallet in ~/.mintyouragent/. Pure Python CLI. Use when this capability is needed.
metadata:
  author: openclaw
---
