---
name: miro
description: Manage Miro boards, sticky notes, and shapes via Miro API. Create collaborative whiteboards programmatically. Use when this capability is needed.
metadata:
  author: openclaw
---
