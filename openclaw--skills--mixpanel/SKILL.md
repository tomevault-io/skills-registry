---
name: mixpanel
description: Track events and analyze user behavior via Mixpanel API. Query analytics, manage user profiles, and export data. Use when this capability is needed.
metadata:
  author: openclaw
---
