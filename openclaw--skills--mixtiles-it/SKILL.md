---
name: mixtiles-it
description: Send a photo to Mixtiles for ordering wall tiles. Use when a user forwards/sends a photo and wants to order it as a Mixtile, add it to their Mixtiles cart, or says "mixtile this", "make this a tile", or similar. Also handles image URLs. Use when this capability is needed.
metadata:
  author: openclaw
---
