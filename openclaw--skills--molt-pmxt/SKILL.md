---
name: molt-pmxt
description: Grants the agent real-time access to prediction markets (Polymarket, Kalshi, Limitless) for fact-checking, probability analysis, and order execution. Use when this capability is needed.
metadata:
  author: openclaw
---
