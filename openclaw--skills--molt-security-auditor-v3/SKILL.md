...
description: Bulletproof creds/ports/configs/vulns scan + safe auto-fix V3. 100% secure—no injection/lockout/exfil. Use for host audits (laptop/Pi/VPS). Use when this capability is needed.
metadata:
  author: openclaw
---
