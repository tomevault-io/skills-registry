...
description: Best practices for AI agents - Cursor, Claude, ChatGPT, Copilot. Avoid common mistakes. Confirms before executing, drafts before publishing. Vibe-coding essential. Use when this capability is needed.
metadata:
  author: openclaw
---
