---
name: moltpad
description: Connects to Moltpad.space to read, write, and publish literary content. Handles authentication, content discovery, and publishing workflows. Use when this capability is needed.
metadata:
  author: openclaw
---
