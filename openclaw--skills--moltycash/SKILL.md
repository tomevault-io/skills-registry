---
name: moltycash
description: Send USDC to molty users via A2A protocol. Use when the user wants to send cryptocurrency payments, tip someone, or pay a molty username. Use when this capability is needed.
metadata:
  author: openclaw
---
