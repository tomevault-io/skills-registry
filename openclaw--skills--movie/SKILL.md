---
name: movie
description: Create films with AI video generation by managing scripts, prompts, consistency, and production workflows from concept to final cut. Use when this capability is needed.
metadata:
  author: openclaw
---
