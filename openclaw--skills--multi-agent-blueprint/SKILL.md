...
description: Production-tested blueprint for building 5-10 agent teams in OpenClaw with cross-agent routing, Telegram integration, and role-based architecture Use when this capability is needed.
metadata:
  author: openclaw
---
