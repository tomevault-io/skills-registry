---
name: agent-sync
description: Universal multi-agent collaboration methodology for Claude Code. Model-tiered cowork + document-driven sync + self-evolution. Use when this capability is needed.
metadata:
  author: openclaw
---
