...
description: Guide users to create multi-factor stock selection strategies and generate independent YAML configuration files Use when this capability is needed.
metadata:
  author: openclaw
---
