---
name: mvp
description: Build, validate, and launch minimum viable products with scope discipline, user signals, and iteration speed. Use when this capability is needed.
metadata:
  author: openclaw
---
