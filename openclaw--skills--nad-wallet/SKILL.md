---
name: nad-wallet
description: 🔐 Nad Wallet - Monad Chain Identity for AI Agents. Create wallets, sign messages (SIWE), manage MON tokens programmatically. Built for the Nad ecosystem (nad.fun, NadMail, NadName). Use when this capability is needed.
metadata:
  author: openclaw
---
