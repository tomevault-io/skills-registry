---
name: nadfun-skill
description: Monad blockchain token launchpad with bonding curves. Trade tokens, launch your own, monitor events—all with pure viem. Use when this capability is needed.
metadata:
  author: openclaw
---
