...
description: AI image generation using Google Gemini API. Create thumbnails, banners, and graphics with Japanese text support. Use when this capability is needed.
metadata:
  author: openclaw
---
