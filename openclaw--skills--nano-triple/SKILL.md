---
name: nano-triple
description: 3 images, one prompt, instant A/B/C. Nano Banana Pro's natural randomness gives you three distinct takes on any image idea — generated in parallel. Pick the winner or give feedback on any version to spin 3 more. The fastest way to find the right image. Use when this capability is needed.
metadata:
  author: openclaw
---
