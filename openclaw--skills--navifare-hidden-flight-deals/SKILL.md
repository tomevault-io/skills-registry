...
description: Find hidden flight deals by comparing prices across 10+ booking sites. Trigger when users share flight prices from any booking site (Skyscanner, Kayak, Google Flights, etc.) or upload flight screenshots. Returns ranked results with booking links and savings calculations. Use when this capability is needed.
metadata:
  author: openclaw
---
