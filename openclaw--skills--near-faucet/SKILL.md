---
name: near-faucet
description: OpenClaw skill for requesting NEAR testnet tokens via faucet. Provides faucet requests, status checking, and balance queries with rate limiting. Use when this capability is needed.
metadata:
  author: openclaw
---
