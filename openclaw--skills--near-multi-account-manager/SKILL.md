...
description: Secure multi-account management for NEAR Protocol with encrypted credential storage, account switching, and balance aggregation. Use when this capability is needed.
metadata:
  author: openclaw
---
