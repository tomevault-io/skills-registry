---
name: nerve-bridge
description: Bi-directional control of Trae via macOS AppleScript with built-in feedback mechanism. Use when needing to execute code/commands in Trae IDE and wait for completion confirmation. Use when this capability is needed.
metadata:
  author: openclaw
---
