---
name: nervepay
description: Agent identity and analytics. Sign requests with Ed25519, track API usage, build reputation. Use after external API calls. Use when this capability is needed.
metadata:
  author: openclaw
---
