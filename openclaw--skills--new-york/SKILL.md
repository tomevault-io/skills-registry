---
name: new-york-state
description: Navigate New York State for living, moving, working, and visiting with region fit, taxes, winter risk, and daily logistics. Use when this capability is needed.
metadata:
  author: openclaw
---
