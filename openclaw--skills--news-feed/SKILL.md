---
name: news-feeds
description: Fetch latest news headlines from major RSS feeds (BBC, Reuters, AP, Al Jazeera, NPR, The Guardian, DW). No API keys required. Use when this capability is needed.
metadata:
  author: openclaw
---
