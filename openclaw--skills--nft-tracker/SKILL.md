---
name: nft-tracker
description: Track NFT collection prices, floor prices, and sales data. Supports Ethereum collections including BAYC, MAYC, CryptoPunks, and more. Use when this capability is needed.
metadata:
  author: openclaw
---
