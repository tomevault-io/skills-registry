---
name: niche
description: Trading card marketplace with partial USDC deposits. Browse cards, deposit partial amounts, and complete purchases with secure on-chain escrow. Use when this capability is needed.
metadata:
  author: openclaw
---
