---
name: nirwan-secret-scanner
description: description: Scans files, repos, and directories for leaked secrets — API keys, tokens, passwords, connection strings, private keys, and credentials. Detects 40+ secret patterns across all major cloud providers and services. Use when this capability is needed.
metadata:
  author: openclaw
---
---
