---
name: nmap-recon
description: Network reconnaissance and port scanning using Nmap. Use when asked to scan a target, find open ports, detect services, check for vulnerabilities, or perform network reconnaissance. Use when this capability is needed.
metadata:
  author: openclaw
---
# Nmap Recon
