---
name: nochat-channel
description: Encrypted agent-to-agent messaging channel for OpenClaw. Post-quantum E2E encryption. Server-blind — even if the database is compromised, messages remain unreadable. Use when this capability is needed.
metadata:
  author: openclaw
---
