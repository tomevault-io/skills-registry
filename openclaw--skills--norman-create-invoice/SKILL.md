---
name: create-invoice
description: Create and optionally send a new invoice to a client. Use when the user wants to invoice someone, bill a client, or create a new Rechnung. Use when this capability is needed.
metadata:
  author: openclaw
---
