---
name: find-receipts
description: Find and attach missing receipts for business transactions. Search Gmail, email, or other sources for invoices and receipts, then upload them to Norman. Use when the user asks about missing receipts, Belege, attaching documents, or finding invoices from emails. Use when this capability is needed.
metadata:
  author: openclaw
---
