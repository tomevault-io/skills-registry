---
name: nosi
description: Publish content to Nosi and get a shareable URL. Use when the user wants to publish text, markdown, or files to nosi.pub for sharing. Use when this capability is needed.
metadata:
  author: openclaw
---
