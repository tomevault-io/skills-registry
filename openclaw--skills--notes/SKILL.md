...
description: Let your agent write notes anywhere: local markdown, Apple Notes, Bear, Obsidian, Notion, Evernote, configurable per note type. Use when this capability is needed.
metadata:
  author: openclaw
---
