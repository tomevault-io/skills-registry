...
description: Fetch and summarize recent news articles from GNews for any user-provided topic, then produce a Markdown digest with date, greeting, and top links. Use when this capability is needed.
metadata:
  author: openclaw
---
