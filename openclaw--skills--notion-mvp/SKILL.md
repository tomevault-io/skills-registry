---
name: notion-mvp
description: Create and list Notion tasks in a single database via Notion API. Use when the user asks to add tasks, list today tasks, or capture quick todos in Notion from chat. Use when this capability is needed.
metadata:
  author: openclaw
---
