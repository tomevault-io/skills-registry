---
name: notion
description: Notion API for creating and managing pages, databases, blocks, relations, rollups, and multi-workspace profiles via the notioncli CLI tool. Use when this capability is needed.
metadata:
  author: openclaw
---
