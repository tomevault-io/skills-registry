---
name: ns-trains
description: Check Dutch train schedules, departures, disruptions, and plan journeys using the NS API. Perfect for daily commute checks. Use when this capability is needed.
metadata:
  author: openclaw
---
