---
name: okx-trader
description: Generates a highly condensed PnL and status report. Automatically detects all configured instruments from `grid_settings.json` and reports per-grid statistics.
metadata:
  author: openclaw
---
# OKX Trader Skill
