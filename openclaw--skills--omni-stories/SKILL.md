---
name: omni-stories
description: Omni Stories is a skill that allows AI agents to generate narrated Reddit stories on background videos with modern captions. (all free!) Use when this capability is needed.
metadata:
  author: openclaw
---
