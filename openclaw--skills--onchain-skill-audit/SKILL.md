---
name: skill-audit
description: On-chain skill provenance registry. Check, register, audit, and vouch for agent skills on Solana. Use when evaluating skill safety, registering new skills, or looking up provenance before installation. Use when this capability is needed.
metadata:
  author: openclaw
---
