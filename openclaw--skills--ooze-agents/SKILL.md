---
name: ooze-agents
description: Visual identity that evolves with reputation - create and nurture your agent's digital creature with XP and evolution stages Use when this capability is needed.
metadata:
  author: openclaw
---
