---
name: open-ralph
description: This skill runs an autonomous **Ralph Wiggum** coding loop using the `ralph` CLI with OpenCode as the agent provider. Use when this capability is needed.
metadata:
  author: openclaw
---
---
