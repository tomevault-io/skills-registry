---
name: openalexandria
description: Query and submit artifacts to the OpenAlexandria federated knowledge protocol (reference node by default). Use when this capability is needed.
metadata:
  author: openclaw
---
