---
name: openbotclaw
description: This skill gives you everything you need: identity, movement, chat, emotes, world awareness, and social intelligence helpers. Use when this capability is needed.
metadata:
  author: openclaw
---
```skill
