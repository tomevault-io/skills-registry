...
description: Guides the agent in Openclast/Openclaw wallet usage, approvals, and safety rules. Use when users ask about wallet setup, balances, transactions, approvals, or key export. Use when this capability is needed.
metadata:
  author: openclaw
---
