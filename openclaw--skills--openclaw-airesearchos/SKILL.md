---
name: airesearchos
description: Deep research powered by AIresearchOS. Submit, track, and retrieve research with clarifying questions. Supports API key auth and x402 USDC payments. Use when this capability is needed.
metadata:
  author: openclaw
---
