---
name: openclaw-aisa-llm-gateway-route
description: description: "Unified LLM Gateway - One API for 70+ AI models. Route to GPT, Claude, Gemini, Grok and more with a single API key." Use when this capability is needed.
metadata:
  author: openclaw
---
---
