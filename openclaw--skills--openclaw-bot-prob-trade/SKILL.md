---
name: probtrade-bot
description: Autonomous trading bot for Polymarket via prob.trade. Run strategies, manage risk, scan markets. Requires the probtrade skill for API access. Use when this capability is needed.
metadata:
  author: openclaw
---
