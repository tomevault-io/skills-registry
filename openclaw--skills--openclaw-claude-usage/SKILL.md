---
name: claude-usage
description: Check Claude Max plan usage limits by launching Claude Code and running /usage. Use when the user asks about Claude plan usage, remaining quota, rate limits, or sends /claude_usage. Use when this capability is needed.
metadata:
  author: openclaw
---
