---
name: github
description: Query and manage GitHub repositories - list repos, check CI status, create issues, search repos, and view recent activity. Use when this capability is needed.
metadata:
  author: openclaw
---
