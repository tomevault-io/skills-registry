...
description: macOS-native web dashboard for monitoring and controlling your OpenClaw agent. Live chat, cron management, task workshop, scout engine, cost tracking, and more. Use when this capability is needed.
metadata:
  author: openclaw
---
