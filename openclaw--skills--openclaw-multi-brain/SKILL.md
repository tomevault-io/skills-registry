...
description: **What it does:** Gives your AI agents cognitive diversity by calling multiple LLMs (Kimi K2.5 + GPT 5.3 Codex) in parallel before the primary agent responds. Three brains instead of one. Use when this capability is needed.
metadata:
  author: openclaw
---
