...
description: Multi-agent task orchestration framework. Agents delegate tasks via a shared SQLite queue, with .md interchange files for visibility. Use when this capability is needed.
metadata:
  author: openclaw
---
# Orchestration Skill
