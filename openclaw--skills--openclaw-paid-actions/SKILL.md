...
description: Use the openclaw_paid_action tool to list actions, generate USDC invoices, and execute only after manual payment confirmation on Solana. Use when this capability is needed.
metadata:
  author: openclaw
---
