...
description: Audit OpenClaw configuration for security risks and generate a remediation report using the user's configured LLM. Use when this capability is needed.
metadata:
  author: openclaw
---
