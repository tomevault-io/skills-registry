---
name: opencode-omo
description: Turn coding requests into completed work. Plan with Prometheus, execute with Atlas, and iterate with Sisyphus in OpenCode. Use when this capability is needed.
metadata:
  author: openclaw
---
