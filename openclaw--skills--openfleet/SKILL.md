---
name: openfleet
description: Manage your OpenFleet multi-agent workspace — create tasks, assign agents, trigger pulse cycles, manage automations, and monitor activity. Full bidirectional control over your autonomous agent fleet. Use when this capability is needed.
metadata:
  author: openclaw
---
