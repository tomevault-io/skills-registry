---
name: outfits
description: Build an outfit planning system for saving inspiration, creating combinations, and dressing for any occasion. Use when this capability is needed.
metadata:
  author: openclaw
---
