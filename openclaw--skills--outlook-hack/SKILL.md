---
name: outlook-hack
description: Your agent reads Outlook email all day. Drafts replies for you. Won't send a single one. Not even if you ask nicely. Use when this capability is needed.
metadata:
  author: openclaw
---
