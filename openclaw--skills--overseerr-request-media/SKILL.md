...
description: Request a movie or TV show using the user's Overseerr instance. Overseerr forwards the request to Sonarr/Radarr. Use when this capability is needed.
metadata:
  author: openclaw
---
