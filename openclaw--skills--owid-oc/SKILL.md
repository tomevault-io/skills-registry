---
name: owid-oc
description: searches, retrieves, and summarizes content from Our World in Data using the `owid-catalog` Python module. Developed under Ubuntu. The developer would appreciate feedback on whether it works for you. Use when this capability is needed.
metadata:
  author: openclaw
---
