---
name: paper-fetcher
description: Fetch academic papers from Sci-Hub given a DOI. Automatically downloads PDFs and saves them to research/papers/ with clean filenames. Use when the user provides a DOI or requests a paper from PubMed. Use when this capability is needed.
metadata:
  author: openclaw
---
