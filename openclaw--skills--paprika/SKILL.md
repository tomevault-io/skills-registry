---
name: paprika
description: Access recipes, meal plans, and grocery lists from Paprika Recipe Manager. Use when user asks about recipes, meal planning, or cooking. Use when this capability is needed.
metadata:
  author: openclaw
---
