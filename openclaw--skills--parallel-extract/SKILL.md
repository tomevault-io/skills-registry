...
description: URL content extraction via Parallel API. Extracts clean markdown from webpages, articles, PDFs, and JS-heavy sites. Use for reading specific URLs with LLM-ready output. Use when this capability is needed.
metadata:
  author: openclaw
---
