...
description: AI-powered web search via Parallel API. Returns ranked results with LLM-optimized excerpts. Use for up-to-date research, fact-checking, and domain-scoped searching. Use when this capability is needed.
metadata:
  author: openclaw
---
