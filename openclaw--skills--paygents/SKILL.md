---
name: paygents
description: Accept crypto payments in AI agent conversations. Generate MetaMask/Trust Wallet deeplinks, verify transactions on-chain, check balances, issue receipts. No custody, no backend, no API keys. Use when this capability is needed.
metadata:
  author: openclaw
---
