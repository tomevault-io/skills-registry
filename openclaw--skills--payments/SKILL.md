---
name: payments
description: Integrate payments with provider selection, checkout flows, subscription billing, and security best practices. Use when this capability is needed.
metadata:
  author: openclaw
---
