---
name: paypal
description: Integrate PayPal payments with proper webhook verification, OAuth handling, and security validation for checkout flows and subscriptions. Use when this capability is needed.
metadata:
  author: openclaw
---
