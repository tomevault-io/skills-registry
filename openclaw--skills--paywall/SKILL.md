---
name: paywall
description: Build high-converting paywalls for mobile apps and web with proven patterns, pricing strategies, and A/B testing. Use when this capability is needed.
metadata:
  author: openclaw
---
