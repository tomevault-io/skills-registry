...
description: PDF document parsing tool based on local MinerU, supports converting PDF to Markdown, JSON, and other machine-readable formats. Use when this capability is needed.
metadata:
  author: openclaw
---
