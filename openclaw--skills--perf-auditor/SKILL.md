---
name: perf-auditor
description: Run a Lighthouse performance audit with AI fix suggestions. Use when your site is slow and you need actionable fixes. Use when this capability is needed.
metadata:
  author: openclaw
---
