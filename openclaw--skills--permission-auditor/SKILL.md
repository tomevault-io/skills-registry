...
description: Generate RBAC permission configs from your routes. Use when you need role-based access control without building it from scratch. Use when this capability is needed.
metadata:
  author: openclaw
---
