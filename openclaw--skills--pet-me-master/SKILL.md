---
name: pet-me-master
description: Batch-pet Aavegotchis on Base via Bankr with cooldown checks, reminder automation, and natural-language routing. Use when this capability is needed.
metadata:
  author: openclaw
---
