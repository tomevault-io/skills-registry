---
name: phantom
description: Work with Phantom browser extension - add custom networks, import tokens, check connected dApps, troubleshoot issues, and manage Solana/Ethereum/Polygon accounts. Use when this capability is needed.
metadata:
  author: openclaw
---
