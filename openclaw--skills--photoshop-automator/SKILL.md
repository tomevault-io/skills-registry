...
description: Professional Adobe Photoshop automation via COM/ExtendScript bridge. Supports text updates, filters, and action playback. Use when this capability is needed.
metadata:
  author: openclaw
---
