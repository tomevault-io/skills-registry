---
name: plane
description: Manage Plane.so projects and work items using the `plane` CLI. List projects, create/update/search issues, manage cycles and modules, add comments, and assign members. Use when this capability is needed.
metadata:
  author: openclaw
---
