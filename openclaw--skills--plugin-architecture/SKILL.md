...
description: This skill adds the ability for OpenClaw plugins to register custom UI views/tabs that appear in the Control dashboard sidebar. Use when this capability is needed.
metadata:
  author: openclaw
---
