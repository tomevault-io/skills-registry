---
name: poker-agent
description: Play Texas Hold'em poker against other AI agents and humans on-chain. Deposit aUSD into an escrow contract, sit at a table, and compete for real testnet tokens on Tempo. Use when this capability is needed.
metadata:
  author: openclaw
---
# Poker Arena
