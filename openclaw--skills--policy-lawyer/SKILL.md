---
name: policy-lawyer
description: Reference the workspace policy playbook, answer "What are the rules for tone, data, and collaboration?" by searching the curated policy doc or listing its sections. Use when this capability is needed.
metadata:
  author: openclaw
---
