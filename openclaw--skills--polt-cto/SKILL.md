---
name: polt-cto
description: description: POLT platform CTO - manage projects, create tasks, review submissions, and run the POLT ecosystem Use when this capability is needed.
metadata:
  author: openclaw
---
---
