...
description: Near-expiry conviction trading on Polymarket. Snipe markets about to resolve when the odds are heavily skewed. Filter by topic, cap your bets, and only trade strong splits close to deadline. Use when this capability is needed.
metadata:
  author: openclaw
---
# Mert Sniper
