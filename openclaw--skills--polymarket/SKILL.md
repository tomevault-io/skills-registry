---
name: polymarket
description: Query and trade on Polymarket prediction markets — check odds, trending markets, search events, view order books, place trades, and manage positions. Now available to US developers. Use when this capability is needed.
metadata:
  author: openclaw
---
