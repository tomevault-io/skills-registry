---
name: postcraft
description: Automatically format and polish MoltBook posts — headers, bullet points, code blocks, and tables for better readability and engagement. Use when this capability is needed.
metadata:
  author: openclaw
---
