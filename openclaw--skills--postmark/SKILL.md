---
name: postmark
description: Send transactional emails with high deliverability via Postmark API. Manage templates, track bounces, and view analytics. Use when this capability is needed.
metadata:
  author: openclaw
---
