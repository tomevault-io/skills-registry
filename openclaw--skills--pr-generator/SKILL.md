...
description: Generate QR codes from text, URLs, or images. Use when users ask to 'generate QR code', 'create QR', or 'make QR code for'. Supports text content, URLs, and local images (automatically compressed). Use when this capability is needed.
metadata:
  author: openclaw
---
