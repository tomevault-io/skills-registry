---
name: pr-writer
description: Generate PR titles and descriptions from your branch diff. Use when you need to write pull request descriptions quickly. Use when this capability is needed.
metadata:
  author: openclaw
---
