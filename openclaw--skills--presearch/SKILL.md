...
description: Production-ready decentralized search for AI agents. Privacy-first, uncensored web search via distributed node infrastructure. Use when this capability is needed.
metadata:
  author: openclaw
---
