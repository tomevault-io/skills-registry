...
description: Compare two sources to find shared and divergent principles — discover what survives independent observation. Use when this capability is needed.
metadata:
  author: openclaw
---
