---
name: prism-scanner
description: Instant rug pull detection for any token. Holder concentration, liquidity locks, contract risks. DYOR before you ape. Works with AI agents. Use when this capability is needed.
metadata:
  author: openclaw
---
