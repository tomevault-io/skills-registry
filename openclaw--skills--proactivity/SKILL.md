...
description: Anticipates needs, keeps work moving, and improves through use so the agent gets more proactive over time. Use when this capability is needed.
metadata:
  author: openclaw
---
