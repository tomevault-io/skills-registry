...
description: Keep a living project state document updated after each commit, so any agent (or future session) can instantly understand where things stand. Use when this capability is needed.
metadata:
  author: openclaw
---
