---
name: hiro
description: This skill enables encoding and decoding of text messages using the Hiro hieroglyphic system. It supports: Use when this capability is needed.
metadata:
  author: openclaw
---
