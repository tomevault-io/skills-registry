...
description: Gestiona el sistema de proyectos interno basado en JSON. Permite crear tareas, moverlas por el tablero Kanban y sincronizar con Apple Reminders. Use when this capability is needed.
metadata:
  author: openclaw
---
