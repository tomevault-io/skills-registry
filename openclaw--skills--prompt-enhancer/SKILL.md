...
description: Automatically rewrites rough user inputs into optimized, structured prompts for dramatically better AI responses. Prefix any message with "p:" to activate. Use when this capability is needed.
metadata:
  author: openclaw
---
