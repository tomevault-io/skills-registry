---
name: promptlayer
description: Manage prompts, log LLM requests, run evaluations, and track scores via the PromptLayer API. Use when working with prompt versioning, A/B testing prompts, LLM observability/logging, prompt evaluation pipelines, datasets, or PromptLayer agents/workflows. Use when this capability is needed.
metadata:
  author: openclaw
---
