---
name: protonmail
description: Read, search, and scan ProtonMail via IMAP bridge (Proton Bridge or hydroxide). Includes daily digest for important emails. Use when this capability is needed.
metadata:
  author: openclaw
---
