---
name: protoss-voice
description: Apply Protoss-style (StarCraft) psionic effects to ANY audio file. Use as a post-processing layer for TTS or user recordings. Use when this capability is needed.
metadata:
  author: openclaw
---
