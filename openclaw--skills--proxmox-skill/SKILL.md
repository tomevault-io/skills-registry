---
name: proxmox
description: Manage Proxmox VE nodes, VMs, and containers. Can list hardware stats, resources, and control power states (start, stop, reboot, shutdown). Use when this capability is needed.
metadata:
  author: openclaw
---
