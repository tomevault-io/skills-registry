---
name: proxy-pay
description: Quick command to create a payment via Proxy. Usage: /proxy-pay [amount] [merchant] [description]. Creates payment intent and provisions virtual card. Use when this capability is needed.
metadata:
  author: openclaw
---
