---
name: pull-request
description: Create high-quality pull requests with pre-submission validation, maintainer-friendly formatting, and automated quality checks. Use when this capability is needed.
metadata:
  author: openclaw
---
