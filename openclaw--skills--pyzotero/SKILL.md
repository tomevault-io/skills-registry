---
name: pyzotero-cli
description: Python scripts for Zotero - supports search, browse, add items, and full collection management. Both local API and online Web API modes. Use when this capability is needed.
metadata:
  author: openclaw
---
