---
name: qfc-order
description: Automate QFC (qfc.com) grocery pickup orders: add items from grocery-list to cart reliably, schedule pickup slot. Use when this capability is needed.
metadata:
  author: openclaw
---
