---
name: quality-gate
description: Quality gates for code and operations. Enforce build, lint, test pass before deployment. Auto-triggers before commits and deploys. Use when this capability is needed.
metadata:
  author: openclaw
---
