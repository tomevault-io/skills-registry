...
description: Automate Raiffeisen ELBA online banking: login/logout, list accounts, and fetch transactions via Playwright. Use when this capability is needed.
metadata:
  author: openclaw
---
