...
description: Upgrade React applications from class components to hooks, adopt concurrent features, and migrate between major versions. Use when this capability is needed.
metadata:
  author: openclaw
---
