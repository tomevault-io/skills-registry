---
name: read-ai
description: Access meeting summaries, transcripts, and action items from Read.ai. Get AI-powered meeting insights via API. Use when this capability is needed.
metadata:
  author: openclaw
---
