---
name: readme-gen
description: Generate beautiful README.md files with badges, install instructions, and API docs. Use when starting new projects. Use when this capability is needed.
metadata:
  author: openclaw
---
