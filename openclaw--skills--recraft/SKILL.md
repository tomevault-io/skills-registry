---
name: recraft
description: Generate, vectorize, upscale, replace background, variate, remove background, and transform images via Recraft API. Use when this capability is needed.
metadata:
  author: openclaw
---
