---
name: recruitly-mcp
description: Search candidates, manage jobs, view pipelines, track billing and team performance in Recruitly CRM via MCP. Use when this capability is needed.
metadata:
  author: openclaw
---
