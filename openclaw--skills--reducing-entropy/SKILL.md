...
description: Minimize total codebase size through ruthless simplification. Measure success by final code amount, not effort. Bias toward deletion. Use when this capability is needed.
metadata:
  author: openclaw
---
