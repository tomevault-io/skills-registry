---
name: rei
description: Set up Rei Qwen3 Coder as a model provider. Use when configuring coder.reilabs.org, adding Rei to Clawdbot, or troubleshooting 403 errors from Rei endpoints. Use when this capability is needed.
metadata:
  author: openclaw
---
