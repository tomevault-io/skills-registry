---
name: relayplane
description: Agent ops layer for OpenClaw — observability, governance, and cost optimization with automatic failover. Never breaks your setup. Use when this capability is needed.
metadata:
  author: openclaw
---
