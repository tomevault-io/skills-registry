---
name: remarkable
description: Bidirectional sync with reMarkable tablet via Cloud API (rmapi). Fetch handwritten notes/sketches, process with AI, and push content back. Use for sketch enhancement, journal extraction, or sending documents/images to the tablet. Use when this capability is needed.
metadata:
  author: openclaw
---
