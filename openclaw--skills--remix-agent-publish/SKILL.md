...
description: Build Remix games for remix.gg with the server-api v1 agents REST API and Farcade game SDK requirements. Use when this capability is needed.
metadata:
  author: openclaw
---
