...
description: Headless video rendering with Remotion v5 on any Linux server — no Mac or GUI needed. Templates for chat demos, promos, and more. Uses Chrome Headless Shell for fast, dependency-free rendering. Use when this capability is needed.
metadata:
  author: openclaw
---
