...
description: Safely remove Google Analytics from a project. Cleans up all tracking code, dependencies, and environment variables. Use when this capability is needed.
metadata:
  author: openclaw
---
