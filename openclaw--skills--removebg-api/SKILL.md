---
name: removebg-api
description: Remove image backgrounds using the remove.bg API with API-key auth and transparent PNG output. Use when high-quality cutouts are needed and cloud processing is acceptable. Use when this capability is needed.
metadata:
  author: openclaw
---
