---
name: render-stl-png
description: Render an STL to a PNG from a nice, consistent 3D angle ("Blender-ish" default perspective) with a solid color. Use when this capability is needed.
metadata:
  author: openclaw
---
# render-stl-png
