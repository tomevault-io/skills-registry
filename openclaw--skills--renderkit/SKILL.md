---
name: renderkit
description: Render structured data as beautiful hosted web pages, and create hosted forms for data collection, using the RenderKit API. Use this for visual pages, surveys, RSVPs, feedback forms, or any structured data. Use when this capability is needed.
metadata:
  author: openclaw
---
