...
description: Use Preloop's request_approval tool to get human approval before risky operations like deletions, production changes, or external modifications Use when this capability is needed.
metadata:
  author: openclaw
---
