---
name: research-token
description: Research a token's Uniswap liquidity, volume profile, pool distribution, and risk factors. Use when the user asks about a token's tradability, liquidity depth, or wants due diligence. Use when this capability is needed.
metadata:
  author: openclaw
---
