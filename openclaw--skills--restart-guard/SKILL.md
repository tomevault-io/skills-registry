---
name: restart-guard
description: Deterministic OpenClaw gateway restart with down/up state-machine verification, origin-session proactive ACK, and backward-compatible config. Use when this capability is needed.
metadata:
  author: openclaw
---
