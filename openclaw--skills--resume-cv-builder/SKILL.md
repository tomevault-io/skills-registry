...
description: Create professional resumes and CVs. Generate ATS-friendly formats, optimize bullet points, tailor for specific jobs, and export to multiple formats (Markdown, HTML, LaTeX, PDF). Use when this capability is needed.
metadata:
  author: openclaw
---
