---
name: resume
description: Adapt, diagnose, and optimize resumes to land interviews with ATS optimization, job-specific tailoring, and recruiter-tested tactics. Use when this capability is needed.
metadata:
  author: openclaw
---
