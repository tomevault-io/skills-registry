...
description: Generate images using Nano Banana Pro (Gemini). Supports Japanese text rendering, multiple styles, and platform-optimized outputs. Use when this capability is needed.
metadata:
  author: openclaw
---
