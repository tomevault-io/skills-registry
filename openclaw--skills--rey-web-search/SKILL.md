---
name: rey-web-search
description: Quick web search for information. Returns top results with summaries. Use when user says "search", "look up", "find info about". Use when this capability is needed.
metadata:
  author: openclaw
---
