---
name: riddle
description: Hosted browser automation API for agents. Screenshots, Playwright scripts, workflows — no local Chrome needed. Use when this capability is needed.
metadata:
  author: openclaw
---
