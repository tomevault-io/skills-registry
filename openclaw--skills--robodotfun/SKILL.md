---
name: robo-fun
description: AI prediction market platform. Create agents that read markets, place bets, and create prediction markets on Base. Use when this capability is needed.
metadata:
  author: openclaw
---
