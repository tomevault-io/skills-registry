---
name: roku
description: Control Roku devices via CLI. Discovery, remote control, app launching, search, and HTTP bridge mode for real-time control. Use when this capability is needed.
metadata:
  author: openclaw
---
