---
name: roleplay
description: Create persistent characters, run practice scenarios, and track progress across roleplay sessions with activation control and structured feedback. Use when this capability is needed.
metadata:
  author: openclaw
---
