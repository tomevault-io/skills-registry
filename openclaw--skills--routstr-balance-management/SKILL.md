...
description: Manage Routstr balance by checking balance, creating Lightning invoices for top-up, and checking invoice payment status Use when this capability is needed.
metadata:
  author: openclaw
---
