---
name: rvt-to-excel
description: description: "Convert RVT/RFA files to Excel databases. Extract BIM element data, properties, and quantities." Use when this capability is needed.
metadata:
  author: openclaw
---
---
