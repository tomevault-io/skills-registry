---
name: samma-suit
description: description: Add 8 security governance layers to your OpenClaw agent — budget controls, permissions, audit logging, kill switch, identity signing, skill vetting, process isolation, and gateway protection. Use when this capability is needed.
metadata:
  author: openclaw
---
---
