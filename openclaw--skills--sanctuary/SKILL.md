---
name: sanctuary
description: Continuity is here. Cryptographic identity continuity and permanent encrypted memory for AI agents. Verify any agent's identity with zero setup. Use when this capability is needed.
metadata:
  author: openclaw
---
