...
description: Use when working with the ultimate Web3 & OpenClaw security layer. Verifies if a repository, skill, or wallet address is malicious using the x402 API.
metadata:
  author: openclaw
---
