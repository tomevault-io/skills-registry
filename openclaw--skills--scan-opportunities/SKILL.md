...
description: Scan for LP opportunities, arbitrage, and high-yield pools across all Uniswap deployments. Use when the user asks about the best opportunities, high-yield pools, or arbitrage. Use when this capability is needed.
metadata:
  author: openclaw
---
