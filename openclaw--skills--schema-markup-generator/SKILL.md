...
description: SEO schema markup generator: create JSON-LD structured data for FAQ, HowTo, Article, Product, and LocalBusiness rich results in Google. Part of a 20-skill SEO & GEO suite. 结构化标记/结构化数据/富摘要/JSON-LD/谷歌富媒体 Use when this capability is needed.
metadata:
  author: openclaw
---
