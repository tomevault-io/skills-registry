---
name: schemapin
description: **Purpose**: This guide helps AI assistants quickly integrate SchemaPin into applications for cryptographic tool schema verification. Use when this capability is needed.
metadata:
  author: openclaw
---
