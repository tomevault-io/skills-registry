---
name: scholargraph
description: Academic literature intelligence toolkit for multi-source paper search, analysis, and knowledge graph building with AI assistance. Use when this capability is needed.
metadata:
  author: openclaw
---
