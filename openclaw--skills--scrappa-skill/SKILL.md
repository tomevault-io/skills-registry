---
name: scrappa-mcp
description: Access Scrappa's MCP server for Google, YouTube, Amazon, LinkedIn, Trustpilot, flights, hotels, and more via Model Context Protocol Use when this capability is needed.
metadata:
  author: openclaw
---
