---
name: search-x
description: Real-time X/Twitter search powered by Grok-4. Find tweets, trends, and discussions with citations. Grok-4.20 also returns image results alongside tweet citations. Use when this capability is needed.
metadata:
  author: openclaw
---
