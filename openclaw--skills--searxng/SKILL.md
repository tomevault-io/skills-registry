---
name: searxng
description: Privacy-first web search via local SearXNG instance. Google-free meta-search using DuckDuckGo, Brave, Qwant, Startpage, and more. Use for any web search query. Use when this capability is needed.
metadata:
  author: openclaw
---
