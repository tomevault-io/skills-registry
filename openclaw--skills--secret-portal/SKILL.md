---
name: secret-portal
description: Spin up a one-time web UI for securely entering secret keys and env vars. Supports guided instructions, single-key mode, and cloudflared tunneling. Use when this capability is needed.
metadata:
  author: openclaw
---
