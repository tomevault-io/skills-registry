...
description: Comprehensive security review for code, configs, and operations. OWASP, prompt injection, crypto security. Auto-triggers on security-related changes. Use when this capability is needed.
metadata:
  author: openclaw
---
