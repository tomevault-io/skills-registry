...
description: OpenClaw skill: fetch replay-stable receipts (signed SAR v0.1) from SettlementWitness. Stateless. Deterministic. Use when this capability is needed.
metadata:
  author: openclaw
---
