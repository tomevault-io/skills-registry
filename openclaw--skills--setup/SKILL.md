---
name: setup
description: Configure OpenClaw installations with optimized settings, channel setup, security hardening, and production recommendations. Use when this capability is needed.
metadata:
  author: openclaw
---
