...
description: Enforces the default shadcn/ui Neutral theme (black/white/gray) with OKLCH CSS variables, Tailwind v4 integration, and dark mode support Use when this capability is needed.
metadata:
  author: openclaw
---
