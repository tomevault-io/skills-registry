...
description: Full read/write access to Shopify Admin REST API for managing orders, products, customers, inventory, fulfillments, refunds, returns, and transactions. Use when this capability is needed.
metadata:
  author: openclaw
---
