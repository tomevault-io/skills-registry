...
description: Track product prices and surface official coupons or discounts without purchasing or account access. Use when a user wants price alerts, deal summaries, or coupon lists for specific items or retailers. Use when this capability is needed.
metadata:
  author: openclaw
---
