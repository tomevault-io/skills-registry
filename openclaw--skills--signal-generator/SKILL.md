...
description: This skill generates trading signals based on technical indicators and automatically sends alerts to your configured channels (Discord, Telegram, etc.). Use when this capability is needed.
metadata:
  author: openclaw
---
