---
name: singapore
description: Navigate Singapore as visitor, resident, tech worker, student, or entrepreneur with neighborhoods, transport, costs, visas, and local insights. Use when this capability is needed.
metadata:
  author: openclaw
---
