---
name: siri
description: Control devices, run automations, and help users get more from Siri with HomeKit, Shortcuts, and voice command guidance. Use when this capability is needed.
metadata:
  author: openclaw
---
