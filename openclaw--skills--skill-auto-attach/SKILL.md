...
description: This skill monitors the OpenClaw workspace for file changes and automatically attaches new or updated documentation files to Telegram messages instead of displaying code snippets. Use when this capability is needed.
metadata:
  author: openclaw
---
# skill-auto-attach
