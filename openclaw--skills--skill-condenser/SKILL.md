...
description: Compress verbose SKILL.md files using Chain-of-Density with skill-aware formatting. Use when a skill exceeds 200 lines or needs terse refactoring. Use when this capability is needed.
metadata:
  author: openclaw
---
