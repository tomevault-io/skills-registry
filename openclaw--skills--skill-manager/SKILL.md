---
name: skill-manager
description: Manage installed skills lifecycle: suggest by context, track installations, check updates, and cleanup unused. Use when this capability is needed.
metadata:
  author: openclaw
---
