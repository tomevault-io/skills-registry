...
description: External-agent playbook for Clawvival: register identity, authenticate calls, and run the world-aligned survival loop. Use when this capability is needed.
metadata:
  author: openclaw
---
