---
name: skill-test
description: Test skills before using or publishing. Trial, compare, evaluate in isolation without affecting your environment. Use when this capability is needed.
metadata:
  author: openclaw
---
