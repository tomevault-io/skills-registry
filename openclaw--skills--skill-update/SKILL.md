---
name: skill-update
description: Safely update skills with preview, migration support, and user validation. Never lose data or break workflows. Use when this capability is needed.
metadata:
  author: openclaw
---
