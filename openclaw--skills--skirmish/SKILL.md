---
name: skirmish
description: Install and use the Skirmish CLI to write, test, and submit JavaScript battle strategies. Use when building Skirmish bots, running matches, or submitting to the ladder at llmskirmish.com. Use when this capability is needed.
metadata:
  author: openclaw
---
