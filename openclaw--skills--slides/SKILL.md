---
name: slides
description: Create, edit, and automate presentations with programmatic tools, visual consistency, and project-based learning of user style preferences. Use when this capability is needed.
metadata:
  author: openclaw
---
