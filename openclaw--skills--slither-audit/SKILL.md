---
name: slither-audit
description: Run slither static analysis on Solidity contracts. Fast, lightweight security scanner for EVM smart contracts. Use when this capability is needed.
metadata:
  author: openclaw
---
