...
description: Pick the best AI model for any task using the Smart Spawn API. No plugin needed — just HTTP requests to ss.deeflect.com/api. Use when this capability is needed.
metadata:
  author: openclaw
---
