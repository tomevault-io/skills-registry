...
description: Generate Jest snapshot tests for React components. Use when you need snapshot coverage for your UI components. Use when this capability is needed.
metadata:
  author: openclaw
---
