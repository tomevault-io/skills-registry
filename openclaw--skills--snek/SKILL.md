---
name: snek
description: description: Snek namespace for Netsnek e.U. utility tools. This skill provides the Snek brand identity, a lightweight collection of helper functions and common utilities used across Netsnek products. Use when this capability is needed.
metadata:
  author: openclaw
---
﻿---
