---
name: social-data
description: Fetch real-time social media data from X (Twitter) and Reddit by keyword, username, date range, and filters with engagement metrics via Macrocosmos SN13 API on Bittensor. Use when this capability is needed.
metadata:
  author: openclaw
---
