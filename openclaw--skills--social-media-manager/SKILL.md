...
description: Automate the creation and scheduling of high-engagement social media content across **any platform** (TikTok, Instagram, X/Twitter, LinkedIn, Facebook, YouTube, and more) using AI generation and the **Postiz API**. Use when this capability is needed.
metadata:
  author: openclaw
---
