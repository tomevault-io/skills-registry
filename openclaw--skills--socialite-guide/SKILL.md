...
description: Expert guidance for generating "Socialite Style" (名媛风) images using AI art tools (Nano Banana Pro). Contains professional advice on lighting, composition, poses, makeup, styling, and prompt engineering formulas. Use when this capability is needed.
metadata:
  author: openclaw
---
