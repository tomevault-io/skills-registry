---
name: sociclaw
description: This skill build does **not** execute `git pull` or `pip install` automatically (to reduce security risk and scanner flags). Use when this capability is needed.
metadata:
  author: openclaw
---
---
