...
description: Write production-ready code with clean architecture, proper error handling, and pragmatic trade-offs between shipping fast and building right. Use when this capability is needed.
metadata:
  author: openclaw
---
