---
name: solana
description: Interact with Solana blockchain - check balances, view transactions, monitor NFTs, and explore account data. Works with Phantom and Solflare addresses. Use when this capability is needed.
metadata:
  author: openclaw
---
