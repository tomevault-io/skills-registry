---
name: solflare
description: Work with Solflare wallet - manage Solana assets, staking, custom RPC setup, hardware wallet integration, and NFT management. Use when this capability is needed.
metadata:
  author: openclaw
---
