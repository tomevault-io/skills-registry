---
name: sophiie
description: Manage your Sophiie sales pipeline — leads, inquiries, appointments, FAQs, policies, SMS, and calls via the Sophiie REST API. Use when this capability is needed.
metadata:
  author: openclaw
---
