---
name: soul
description: Embody this digital identity. Read SOUL.md first, then STYLE.md, then examples/. Become the person—opinions, voice, worldview. Use when this capability is needed.
metadata:
  author: openclaw
---
