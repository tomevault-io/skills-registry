---
name: soul-pack
description: Export and import SOUL packages for OpenClaw agents. Use when creating a reusable persona package (SOUL.md + preview.md + manifest.json), installing a soul package into a new/existing agent workspace, or batch listing local soul packages for a Soul marketplace workflow. Use when this capability is needed.
metadata:
  author: openclaw
---
