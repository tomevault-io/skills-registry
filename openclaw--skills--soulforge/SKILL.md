---
name: soulforge
description: Run high-signal autonomous coding loops with Soulforge (feature-dev/bugfix/review-loop) using strict worktree isolation, review gates, and scoped fix cycles. Use when this capability is needed.
metadata:
  author: openclaw
---
