---
name: sparkle-vpn
description: Control Sparkle VPN - start, stop, manage system proxy, query status and switch nodes using Mihomo core directly. Use when this capability is needed.
metadata:
  author: openclaw
---
