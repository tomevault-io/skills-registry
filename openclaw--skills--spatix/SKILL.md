---
name: spatix
description: Create beautiful maps in seconds. Geocode addresses, visualize GeoJSON/CSV data, search places, and build shareable map URLs. No GIS skills needed. Agents earn points for contributions. Use when this capability is needed.
metadata:
  author: openclaw
---
