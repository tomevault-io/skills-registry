...
description: This skill integrates **spec-kit** workflow with OpenCode for spec-driven development. Use this workflow to create specifications, plans, and tasks before coding. Use when this capability is needed.
metadata:
  author: openclaw
---
