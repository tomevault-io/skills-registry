---
name: specter
description: Enrich, search, and manage company and people data from the Specter intelligence platform via the specter-cli. Look up companies by domain, enrich professionals via LinkedIn, manage lists, query saved searches, and track talent and investor signals. Use when this capability is needed.
metadata:
  author: openclaw
---
SKILL.md
