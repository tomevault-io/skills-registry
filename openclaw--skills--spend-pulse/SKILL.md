---
name: spend-pulse
description: Proactive spending alerts via Plaid. Track credit card spending against a monthly budget with pace-based alerts. Use when this capability is needed.
metadata:
  author: openclaw
---
