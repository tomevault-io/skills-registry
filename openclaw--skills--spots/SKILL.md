---
name: spots
description: Exhaustive Google Places search using grid-based scanning. Finds ALL places, not just what Google surfaces. Use when this capability is needed.
metadata:
  author: openclaw
---
