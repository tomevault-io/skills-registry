---
name: arya-reminders
description: Recordatorios en lenguaje natural (Bogotá). Crea cron jobs seguros y registra en markdown (y opcionalmente Sheets). Use when this capability is needed.
metadata:
  author: openclaw
---
