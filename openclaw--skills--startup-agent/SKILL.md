---
name: startup-agent
description: Alias for raon-os — AI-powered startup companion for Korean founders. Install the main package for full functionality. Use when this capability is needed.
metadata:
  author: openclaw
---
