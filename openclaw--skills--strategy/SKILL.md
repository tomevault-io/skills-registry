---
name: strategy
description: Design robust strategies for any domain with proven frameworks, cognitive bias protection, and constraint-aware recommendations. Use when this capability is needed.
metadata:
  author: openclaw
---
