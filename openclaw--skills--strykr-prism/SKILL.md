---
name: strykr-prism
description: Real-time financial data API for AI agents. Stocks, crypto, forex, ETFs. 120+ endpoints. Alternative to Alpha Vantage, CoinGecko. Works with Claude, Cursor. Use when this capability is needed.
metadata:
  author: openclaw
---
