...
description: Transform plain text into Substack article format with proper HTML formatting for copy-paste into Substack editor. Use when this capability is needed.
metadata:
  author: openclaw
---
