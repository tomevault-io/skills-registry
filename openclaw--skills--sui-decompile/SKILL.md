---
name: sui-decompile
description: Fetch on-chain Sui Move contract source code and let your agent explain how smart contracts work. Scrape from Suivision/Suiscan explorers, analyze DeFi protocols, and understand any contract on Sui. Use when this capability is needed.
metadata:
  author: openclaw
---
