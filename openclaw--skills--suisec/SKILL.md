---
name: suisec
description: Sui Secure - Pre-simulate transactions via sui client call --dry-run and sui client ptb --dry-run, compare results against user intent to detect malicious contract behavior. Only execute if intent matches; block otherwise. Use when this capability is needed.
metadata:
  author: openclaw
---
