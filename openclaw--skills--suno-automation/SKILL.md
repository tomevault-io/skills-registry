...
description: This skill allows the agent to control Suno (suno.com) via the OpenClaw Managed Browser to generate music. Use when this capability is needed.
metadata:
  author: openclaw
---
# Suno Skill
