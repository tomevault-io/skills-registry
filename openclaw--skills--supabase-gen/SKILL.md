---
name: supabase-gen
description: Generate Supabase RLS policies from Prisma schema. Use when setting up row-level security for your tables. Use when this capability is needed.
metadata:
  author: openclaw
---
