...
description: **The ultimate proactive + memory system for AI agents.** Combines the best of 11 top-rated skills into one unified architecture. Use when this capability is needed.
metadata:
  author: openclaw
---
