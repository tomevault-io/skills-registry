---
name: super-research
description: This skill handles any research task from quick lookups to deep academic analysis. It knows when to use which approach. Use when this capability is needed.
metadata:
  author: openclaw
---
# Super Research
