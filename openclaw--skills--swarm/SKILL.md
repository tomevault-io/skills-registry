---
name: swarm
description: Cut your LLM costs by 200x. Offload parallel, batch, and research work to Gemini Flash workers instead of burning your expensive primary model. Use when this capability is needed.
metadata:
  author: openclaw
---
