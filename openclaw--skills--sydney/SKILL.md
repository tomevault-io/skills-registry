---
name: sydney
description: Navigate Sydney as visitor, resident, tech worker, student, or entrepreneur with neighborhoods, beaches, transport, visas, and local insights. Use when this capability is needed.
metadata:
  author: openclaw
---
