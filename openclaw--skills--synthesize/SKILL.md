---
name: synthesize
description: Combine multiple sources into unified insights with source tracking, conflict resolution, and coverage verification. Use when this capability is needed.
metadata:
  author: openclaw
---
