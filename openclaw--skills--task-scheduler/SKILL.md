---
name: scheduler
description: Schedule tasks and commands to run at specific times. Execute shell commands, agent tasks, API calls, and automations on a cron schedule. Tested on Telegram & Discord. Use when this capability is needed.
metadata:
  author: openclaw
---
