---
name: tavily-search
description: AI-optimized search and content extraction using Tavily API. Includes deep search, news filtering, and raw content extraction for LLM processing. Use when this capability is needed.
metadata:
  author: openclaw
---
