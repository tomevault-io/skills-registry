---
name: taxi
description: Handle everything for ground transportation, from price comparison to booking, tracking, disputes, and expense management. Use when this capability is needed.
metadata:
  author: openclaw
---
