...
description: Get stock prices, quotes, and compare stocks using Tencent Finance API. No API key required. Supports US stocks, China A-Shares, Hong Kong stocks. Optimized for use in mainland China. Use when this capability is needed.
metadata:
  author: openclaw
---
