---
name: telebiz-mcp
description: Access Telegram data via MCP using the telebiz-tt browser client. Lists chats, reads messages, searches, manages folders, and sends messages through an authenticated Telegram session. Use when this capability is needed.
metadata:
  author: openclaw
---
