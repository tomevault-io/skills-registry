---
name: telnyx-tts
description: Generate speech audio from text using Telnyx Text-to-Speech API. Use when you need to convert text to spoken audio, create voice messages, or generate audio content. Use when this capability is needed.
metadata:
  author: openclaw
---
