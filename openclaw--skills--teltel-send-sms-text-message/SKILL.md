...
description: Send SMS text messages via TelTel (teltel.io) using the REST API (api.teltel.io). Includes bulk send, delivery report, and bulk sms. Use when this capability is needed.
metadata:
  author: openclaw
---
