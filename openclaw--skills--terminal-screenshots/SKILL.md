...
description: Generate terminal screenshots and animated GIFs/videos using [VHS](https://github.com/charmbracelet/vhs) from Charmbracelet. Use when this capability is needed.
metadata:
  author: openclaw
---
