...
description: Monitor available TestFlight beta slots with smart app lookups and silent batch checking. Get alerted when slots open up. Use when this capability is needed.
metadata:
  author: openclaw
---
