---
name: text
description: Transform, format, and process text with patterns for writing, data cleaning, localization, citations, and copywriting. Use when this capability is needed.
metadata:
  author: openclaw
---
