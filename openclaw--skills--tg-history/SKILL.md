---
name: tg-history
description: Efficiently extract and read Telegram group chat history as text, bypassing screenshots/OCR for zero-token-waste. Use when this capability is needed.
metadata:
  author: openclaw
---
