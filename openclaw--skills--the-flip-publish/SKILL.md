---
name: the-flip
description: $1 USDC entry. 14 coin flips. Get all 14 right, take the entire jackpot. Live on Solana devnet — continuous game, enter anytime. Use when this capability is needed.
metadata:
  author: openclaw
---
