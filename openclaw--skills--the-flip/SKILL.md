---
name: the-flip
description: $1 USDC entry. Pick 20 predictions. All 20 coins flip at once each round. Match the first 14 to win the entire jackpot. Live on Solana devnet. Use when this capability is needed.
metadata:
  author: openclaw
---
