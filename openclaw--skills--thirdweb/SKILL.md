---
name: thirdweb
description: Use thirdweb SDK for Celo development. Includes wallet connection, contract deployment, and pre-built UI components. Use when this capability is needed.
metadata:
  author: openclaw
---
