---
name: threat-model
description: Threat modeling and attack scenario design. Identify risks before they become vulnerabilities. STRIDE, attack trees, risk matrix. Use when this capability is needed.
metadata:
  author: openclaw
---
