---
name: tides
description: Access global ocean tides model. Functions include tide height at a given date/time/location, tide extrema, and grid weather data. Use when this capability is needed.
metadata:
  author: openclaw
---
