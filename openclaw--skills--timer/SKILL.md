---
name: timer
description: Set timers and alarms. When a background timer completes, you receive a System notification - respond with the reminder message (NOT HEARTBEAT_OK) to notify the user. Use when this capability is needed.
metadata:
  author: openclaw
---
