---
name: toefl
description: Prepare for the TOEFL iBT exam with progress tracking, weak area analysis, score prediction, and university targeting. Use when this capability is needed.
metadata:
  author: openclaw
---
