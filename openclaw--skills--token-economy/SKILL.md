---
name: token-economy
description: Reduce OpenClaw costs by 60-80% through intelligent model routing and context management. Cheap-first escalation (GPT-4o → Sonnet → Opus), zero-token heartbeats, and budget guardrails. Save $60-105/month per deployment. Use when this capability is needed.
metadata:
  author: openclaw
---
# Token Economy
