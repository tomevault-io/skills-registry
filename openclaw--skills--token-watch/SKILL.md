---
name: token-watch
description: **Track, analyze, and optimize token usage and costs across AI providers. Set budgets, get alerts, compare models, and reduce your spend.** Use when this capability is needed.
metadata:
  author: openclaw
---
# TokenWatch
