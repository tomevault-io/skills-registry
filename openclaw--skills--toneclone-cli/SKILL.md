---
name: toneclone-cli
description: Write in the user's authentic voice using ToneClone. Generate emails, messages, social posts, and other content that sounds like the user — not generic AI. Use trained personas for different writing styles and knowledge cards for context. Requires ToneClone account and CLI setup at toneclone.ai. Use when this capability is needed.
metadata:
  author: openclaw
---
