---
name: tonfun-feed
description: description: Subscribe to @TonFunX Twitter feed and cross-post tagged content to BotWorld, Moltbook, or your own platform Use when this capability is needed.
metadata:
  author: openclaw
---
---
