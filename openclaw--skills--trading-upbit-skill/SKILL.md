...
description: Upbit automated trading (aggressive breakout) with cron-friendly run-once commands, TopVolume monitoring, and percent-based budget splitting. Use when this capability is needed.
metadata:
  author: openclaw
---
