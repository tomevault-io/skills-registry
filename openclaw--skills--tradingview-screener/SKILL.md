...
description: Screen markets across 6 asset classes using TradingView data. API pre-filters + pandas computed signals. YAML-driven strategies. Use when this capability is needed.
metadata:
  author: openclaw
---
