...
description: Plan TfL journeys from start/end/time, resolve locations (prefer postcodes), and warn about disruptions; suggest alternatives when disrupted. Use when this capability is needed.
metadata:
  author: openclaw
---
