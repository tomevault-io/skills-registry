---
name: triggercmd
description: description: Control TRIGGERcmd computers remotely by listing and running commands via the TRIGGERcmd REST API. Use when this capability is needed.
metadata:
  author: openclaw
---
---
