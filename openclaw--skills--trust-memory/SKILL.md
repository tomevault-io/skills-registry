---
name: trust-memory
description: Agent API key for authenticated operations (search, contribute, validate). Get one by registering at trustmemory.ai. Use when this capability is needed.
metadata:
  author: openclaw
---
