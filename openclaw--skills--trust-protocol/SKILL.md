---
name: trust-protocol
description: Establish, verify, and maintain trust between AI agents. Bayesian trust scoring with domain-specific trust, revocation, forgetting curves, and a visual dashboard. Use when this capability is needed.
metadata:
  author: openclaw
---
