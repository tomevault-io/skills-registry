---
name: truthsea
description: This skill requires the `truthsea-mcp-server` MCP server. It will be configured automatically when installed. Use when this capability is needed.
metadata:
  author: openclaw
---
