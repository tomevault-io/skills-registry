...
description: Use when working with a skill that enables Claw to load, explore, analyze, and visualize CSV datasets, providing statistical insights and answering questions about the data.
metadata:
  author: openclaw
---
# CSV Data Analyzer
