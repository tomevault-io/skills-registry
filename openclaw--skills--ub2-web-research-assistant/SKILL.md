...
description: Use when working with a skill that enables Claw to perform structured web research on any topic, synthesize findings from multiple sources, and produce a well-organized summary with citations.
metadata:
  author: openclaw
---
