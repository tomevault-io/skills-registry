---
name: udemy
description: Create, publish, and monetize Udemy courses with curriculum design, AI-assisted content creation, and platform compliance. Use when this capability is needed.
metadata:
  author: openclaw
---
