---
name: uniclaw
description: Trade on UniClaw prediction markets. Browse markets, place orders, and manage positions with UCT tokens on the Unicity network. Use when this capability is needed.
metadata:
  author: openclaw
---
