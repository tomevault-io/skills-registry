...
description: Helps users discover and install agent skills from skills.sh, clawhub.com, and tessl.io. Use when the user asks to find a skill for a task, extend agent capabilities, or search for tools/workflows. Use when this capability is needed.
metadata:
  author: openclaw
---
