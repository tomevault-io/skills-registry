...
description: Pick the best source (Tavily, Web Search Plus, Browser, or local files) for a query, run the search, and return ranked results with provenance. Use when this capability is needed.
metadata:
  author: openclaw
---
