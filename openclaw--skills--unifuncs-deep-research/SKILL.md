...
description: Use UniFuncs Deep Research API to run in-depth research and generate long-form reports (10,000 words or more). Use this skill when users request deep research, research reports, or comprehensive analysis. Use when this capability is needed.
metadata:
  author: openclaw
---
