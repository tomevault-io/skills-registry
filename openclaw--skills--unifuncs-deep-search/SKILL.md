...
description: Use UniFuncs Deep Search API for fast, comprehensive information gathering. Use this skill when users ask for deep search, broad investigation, or in-depth topic coverage. Use when this capability is needed.
metadata:
  author: openclaw
---
