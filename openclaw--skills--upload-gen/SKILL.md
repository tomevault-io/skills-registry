---
name: upload-gen
description: Generate file upload handling code. Use when building upload features with S3, local storage, or cloud providers. Use when this capability is needed.
metadata:
  author: openclaw
---
