---
name: upnote
description: Manage UpNote notes and notebooks via x-callback-url automation. Use when a user asks to create notes, open notes, create notebooks, view tags, or manage content in UpNote. Use when this capability is needed.
metadata:
  author: openclaw
---
