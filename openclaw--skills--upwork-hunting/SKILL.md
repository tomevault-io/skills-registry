---
name: upwork-hunting
description: Systematically find and win Upwork jobs using our n8n workflow library (2,061 templates) as a speed advantage. Use when this capability is needed.
metadata:
  author: openclaw
---
