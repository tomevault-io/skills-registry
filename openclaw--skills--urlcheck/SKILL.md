---
name: urlcheck
description: Companion skill for @cybrlab/urlcheck-openclaw. Requires URLCheck plugin tools to assess URLs for threats and intent alignment before navigation. Use when this capability is needed.
metadata:
  author: openclaw
---
