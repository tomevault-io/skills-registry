---
name: usdc-escrow
description: Trustless USDC escrow for agent-to-agent payments on Base. Create, release, dispute escrows via simple commands. Use when this capability is needed.
metadata:
  author: openclaw
---
