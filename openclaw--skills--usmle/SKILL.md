---
name: usmle
description: Prepare for US medical licensing exams with progress tracking, weak area analysis, question bank management, and residency match planning. Use when this capability is needed.
metadata:
  author: openclaw
---
