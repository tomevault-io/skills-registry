---
name: validator-gen
description: Generate Zod and Yup validation schemas from TypeScript types. Use when you need runtime validation that matches your types. Use when this capability is needed.
metadata:
  author: openclaw
---
