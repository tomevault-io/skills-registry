---
name: valtec-tts
description: description: Local Vietnamese text-to-speech via VITS2 (offline, no cloud). Supports 5 built-in speaker voices and zero-shot voice cloning from reference audio. Use when this capability is needed.
metadata:
  author: openclaw
---
---
