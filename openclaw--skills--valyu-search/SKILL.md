---
name: valyu-search
description: Use Valyu (valyu.ai) to search the web, extract content from web pages, answer with sources, and do deepresearch. Use when this capability is needed.
metadata:
  author: openclaw
---
