---
name: vapi-skill
description: This skill is **API-first** (Vapi REST) and optionally integrates with the **Vapi CLI** for MCP docs / local workflows. Use when this capability is needed.
metadata:
  author: openclaw
---
