---
name: vast-ai
description: This skill allows you to provision on-demand GPU infrastructure. You must have a user-provided API Key before performing write actions. Use when this capability is needed.
metadata:
  author: openclaw
---
