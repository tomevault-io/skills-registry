---
name: venice-admin
description: This skill uses `uv run` which automatically installs Python dependencies (httpx) via [PEP 723](https://peps.python.org/pep-0723/) inline script metadata. No manual Python package installation required - `uv` handles everything. Use when this capability is needed.
metadata:
  author: openclaw
---
---
