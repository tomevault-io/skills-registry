---
name: venice-ai
description: Complete Venice AI platform — text generation, web search, embeddings, TTS, speech-to-text, image generation, video creation, upscaling, and AI editing. Private, uncensored AI inference for everything. Use when this capability is needed.
metadata:
  author: openclaw
---
