...
description: Verification checkpoint before completion claims. Ensure tests pass, build succeeds, and functionality works. Use when this capability is needed.
metadata:
  author: openclaw
---
