---
name: verify-task
description: MUST use after completing any multi-step task or project. Verifies completion against the original plan, checks quality criteria, and documents outcomes. Use when this capability is needed.
metadata:
  author: openclaw
---
