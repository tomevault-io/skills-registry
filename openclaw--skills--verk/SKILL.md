---
name: verk
description: Manage tasks, projects, and workflows in Verk — AI-powered task management. Create, update, assign, and track tasks. Add comments, change status, list automation flows. Use when this capability is needed.
metadata:
  author: openclaw
---
