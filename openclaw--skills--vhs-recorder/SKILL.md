---
name: vhs-recorder
description: Create professional terminal recordings with VHS tape files - guides through syntax, timing, settings, and best practices Use when this capability is needed.
metadata:
  author: openclaw
---
