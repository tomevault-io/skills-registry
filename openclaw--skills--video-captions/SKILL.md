---
name: video-captions
description: Generate professional captions and subtitles with multi-engine transcription, word-level timing, styling presets, and burn-in. Use when this capability is needed.
metadata:
  author: openclaw
---
