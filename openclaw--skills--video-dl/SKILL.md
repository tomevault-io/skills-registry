---
name: video-dl
description: Download videos from YouTube, Reddit, Twitter/X, TikTok, Instagram, and 1000+ other sites using yt-dlp. Use when user provides a video link and wants to download it. Use when this capability is needed.
metadata:
  author: openclaw
---
