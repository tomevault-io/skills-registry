---
name: vikunja-kanban
description: Manage a Vikunja kanban board via API. Read status, create/move/complete tasks, and integrate with heartbeat and triage crons. Use when this capability is needed.
metadata:
  author: openclaw
---
