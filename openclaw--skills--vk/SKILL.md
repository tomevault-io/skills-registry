---
name: vk
description: Manage VK.com (Vkontakte) community: post content (text, photos, videos) and handle messages. Use for automating community management via VK API. Use when this capability is needed.
metadata:
  author: openclaw
---
