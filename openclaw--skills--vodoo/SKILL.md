---
name: vodoo
description: Query and manage Odoo ERP data (helpdesk tickets, projects, tasks, CRM leads, knowledge articles) via the vodoo CLI Use when this capability is needed.
metadata:
  author: openclaw
---
