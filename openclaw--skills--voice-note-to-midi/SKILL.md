...
description: Convert voice notes, humming, and melodic audio recordings to quantized MIDI files using ML-based pitch detection and intelligent post-processing Use when this capability is needed.
metadata:
  author: openclaw
---
