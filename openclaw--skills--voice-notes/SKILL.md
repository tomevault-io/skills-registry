---
name: voice-notes
description: Organize voice message transcripts into a structured, searchable knowledge base with tags, links, and progressive note-taking. Use when this capability is needed.
metadata:
  author: openclaw
---
