---
name: voice-to-text
description: Convert voice messages and audio files to text using Vosk offline speech recognition. Use when a user sends a voice message, audio file, or asks to transcribe speech to text. Use when this capability is needed.
metadata:
  author: openclaw
---
