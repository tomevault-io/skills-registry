---
name: voice-ui
description: Self-evolving voice assistant UI. Talk to your AI, ask it to improve itself, and watch the code update in real-time. Use when this capability is needed.
metadata:
  author: openclaw
---
