---
name: voice
description: Use when working with the Voice skill provides enhanced text-to-speech functionality using edge-tts, allowing you to convert text to spoken audio with multiple playback options.
metadata:
  author: openclaw
---
# Voice Skill
