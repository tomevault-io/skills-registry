...
description: Entry skill for Volcengine ARK model invocation and routing. Use when users ask to start with ARK, need request templates, endpoint setup, model routing, or authentication troubleshooting. Use when this capability is needed.
metadata:
  author: openclaw
---
