...
description: Using volcengine video_generate.py script to generate video, need to provide filename and prompt, optional provide first frame image (URL or local path). Use when this capability is needed.
metadata:
  author: openclaw
---
