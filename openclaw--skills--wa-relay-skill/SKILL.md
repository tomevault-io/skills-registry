---
name: wa-relay
description: WhatsApp message relay for OpenClaw v0.2.0. Routes third-party DMs to a relay agent that forwards them to the main agent via sessions_send. The main agent notifies the owner with a suggested response. Supports direct number allowlists. Use when this capability is needed.
metadata:
  author: openclaw
---
