---
name: wagmi
description: Use wagmi React hooks for Celo dApps. Includes wallet connection, transaction hooks, and React integration patterns. Use when this capability is needed.
metadata:
  author: openclaw
---
