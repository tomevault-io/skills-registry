---
name: wallapop-cli
description: Use the wallapop CLI to search listings, fetch item details, view user profiles, and list categories. Apply when a user asks for Wallapop marketplace data or when you need CLI commands and flags for wallapop-cli usage. Use when this capability is needed.
metadata:
  author: openclaw
---
