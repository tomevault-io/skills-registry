...
description: Execute on-chain transactions with user-granted permissions. Built on MetaMask ERC-7715. No private keys, full guardrails. Use when this capability is needed.
metadata:
  author: openclaw
---
