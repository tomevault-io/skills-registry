---
name: waste-reminder
description: This skill helps automate waste collection reminders based on user-defined schedules. It uses simple JSON configuration for maximum flexibility and minimal token usage. Use when this capability is needed.
metadata:
  author: openclaw
---
