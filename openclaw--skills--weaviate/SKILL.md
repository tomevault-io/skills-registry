---
name: weaviate
description: Build vector search with Weaviate using v4 syntax, proper module configuration, and production-ready patterns. Use when this capability is needed.
metadata:
  author: openclaw
---
