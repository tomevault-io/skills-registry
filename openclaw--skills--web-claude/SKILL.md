---
name: web-claude
description: Unified web search skill. Fallback order — web_search(Brave) → duckduckgo → claude.ai. Auto-cache search results (saved to memory/research/) Use when this capability is needed.
metadata:
  author: openclaw
---
