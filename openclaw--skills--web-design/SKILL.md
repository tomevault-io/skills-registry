---
name: web-design
description: CSS implementation patterns for layout, typography, color, spacing, and responsive design. Complements ui-design (fundamentals) with code-focused examples. Use when this capability is needed.
metadata:
  author: openclaw
---
