---
name: web-qa-bot
description: AI-powered automated QA for web apps. Smoke tests, accessibility, visual regression. Works with Cursor, Claude, ChatGPT, Copilot. Vibe-coding ready. Use when this capability is needed.
metadata:
  author: openclaw
---
