---
name: web-scraper
description: Configurable web scraping service. Extract structured data from any website. Custom projects and monthly maintenance contracts. Use when this capability is needed.
metadata:
  author: openclaw
---
