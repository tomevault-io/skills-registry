...
description: Send messages via WhatsApp Business Cloud API. Send templates, media, and interactive messages to customers. Use when this capability is needed.
metadata:
  author: openclaw
---
