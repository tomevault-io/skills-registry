...
description: Automatically detect appointments and urgent messages from WhatsApp, alert via Telegram, and optionally add to Google Calendar. Use when this capability is needed.
metadata:
  author: openclaw
---
# WhatsApp Analyzer
