...
description: This skill checks the local cache only. A number not found may still have WhatsApp — it simply hasn't interacted with the bot yet. Use when this capability is needed.
metadata:
  author: openclaw
---
---
