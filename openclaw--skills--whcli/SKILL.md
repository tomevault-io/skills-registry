---
name: whcli
description: Willhaben CLI for searching Austria's largest classifieds marketplace. Search listings, view details, check seller profiles. Use when this capability is needed.
metadata:
  author: openclaw
---
