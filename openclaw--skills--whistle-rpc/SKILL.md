---
name: whistle-rpc
description: description: Production Solana RPC for AI agents. Unlimited JSON-RPC, WebSocket. 1 SOL/month via on-chain payment. No rate limits, no tiers. Use when this capability is needed.
metadata:
  author: openclaw
---
---
