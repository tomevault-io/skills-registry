---
name: wikipedia-oc
description: searches, retrieves, and summarizes content from English Wikipedia using the `wikipedia` Python module. Developed under Ubuntu. The developer would appreciate feedback on whether it works for you. Use when this capability is needed.
metadata:
  author: openclaw
---
