...
description: Spatially-routed LLM inference at $0.004/req. Routes to cheapest, greenest energy. 200+ models. OpenAI-compatible. Onchain attestations on Base. Use when this capability is needed.
metadata:
  author: openclaw
---
