---
name: wordpress
description: OpenClaw skill that provides a WordPress REST API CLI for posts, pages, categories, tags, users, and custom requests using plain HTTP. Use when this capability is needed.
metadata:
  author: openclaw
---
