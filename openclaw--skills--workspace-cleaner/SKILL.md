...
description: Safe, automated cleanup for OpenClaw workspaces. Finds temp files, duplicates, and cruft while protecting important data. Use when this capability is needed.
metadata:
  author: openclaw
---
# Workspace Cleaner
