---
name: wrynai-skill
description: This skill enables OpenClaw to perform advanced web crawling and content extraction using the WrynAI SDK. It provides capabilities for multi-page crawling, content extraction, search engine results parsing, and intelligent data gathering from websites. Use when this capability is needed.
metadata:
  author: openclaw
---
