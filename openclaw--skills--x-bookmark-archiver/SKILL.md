...
description: This skill fetches your X bookmarks using the [bird CLI](https://github.com/steipete/bird), categorizes them by URL patterns, generates AI summaries using OpenAI, and saves them as organized markdown files. Use when this capability is needed.
metadata:
  author: openclaw
---
# X Bookmark Archiver
