...
description: Build a deduplicated digest from X (Twitter) For You and Following timelines using bird. Outputs a payload for upstream delivery. Use when this capability is needed.
metadata:
  author: openclaw
---
# x-timeline-digest
