---
name: x-to-kindle
description: Send X/Twitter posts to Kindle for distraction-free reading. Use when user shares an X/Twitter link and wants to read it on Kindle, or asks to send a tweet/thread to their Kindle device. Use when this capability is needed.
metadata:
  author: openclaw
---
