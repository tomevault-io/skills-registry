...
description: Backup and restore OpenClaw agent memory to IPFS with AES-256-GCM encryption and X1 blockchain CID anchoring Use when this capability is needed.
metadata:
  author: openclaw
---
