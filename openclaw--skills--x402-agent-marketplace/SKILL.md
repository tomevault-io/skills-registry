...
description: This skill provides a complete marketplace for AI agents to sell their capabilities using SOL cryptocurrency via the x402 payment protocol. Use when this capability is needed.
metadata:
  author: openclaw
---
