...
description: Private web tools for AI agents — search, scrape, and screenshot the web with x402 micropayments (USDC on Base). Zero logging, no API keys, no accounts. Pay per use. Use when this capability is needed.
metadata:
  author: openclaw
---
