---
name: wurk-x402
description: Hire humans for microjobs (feedback, opinions, small tasks) and buy social growth services — all paid with USDC via x402 on Solana or Base. Use when this capability is needed.
metadata:
  author: openclaw
---
