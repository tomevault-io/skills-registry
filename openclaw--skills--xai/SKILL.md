---
name: xai
description: Chat with Grok models via xAI API. Supports Grok-4, Grok-4.20, Grok-3, Grok-3-mini, vision, and real-time X search. Use when this capability is needed.
metadata:
  author: openclaw
---
