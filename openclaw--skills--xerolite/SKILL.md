---
name: xerolite
description: Integrate OpenClaw with Xerolite - IBKR. Use when: querying Xerolite API, placing orders, searching contracts. Use when this capability is needed.
metadata:
  author: openclaw
---
