---
name: xfetch
description: Fast X/Twitter CLI scraper. Use when you need to fetch tweets, user profiles, search results, timelines, followers, or any X/Twitter data. No API keys required - uses cookie-based auth. Use when this capability is needed.
metadata:
  author: openclaw
---
