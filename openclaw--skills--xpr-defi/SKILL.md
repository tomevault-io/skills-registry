---
name: defi
description: Complete DeFi toolkit for XPR Network — DEX trading, AMM swaps, OTC escrow, yield farming, liquidity, and multisig Use when this capability is needed.
metadata:
  author: openclaw
---
