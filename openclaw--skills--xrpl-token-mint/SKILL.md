...
description: Create and manage XRPL tokens (issued currencies) and NFTs. Use for: (1) Minting new tokens, (2) Setting up token issuers, (3) Creating NFTs, (4) Managing trust lines. Use when this capability is needed.
metadata:
  author: openclaw
---
