---
name: yahoo-finance
description: Get stock quotes, financial data, market news, and portfolio analytics from Yahoo Finance. Use when you need real-time stock prices, historical data, company financials, crypto prices, or market analysis. Use when this capability is needed.
metadata:
  author: openclaw
---
