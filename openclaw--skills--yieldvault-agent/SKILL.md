...
description: Autonomous yield farming agent for BNB Chain with deterministic execution, smart contract integration, and automated decision-making. Use when this capability is needed.
metadata:
  author: openclaw
---
