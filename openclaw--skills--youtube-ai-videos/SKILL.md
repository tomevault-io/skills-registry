...
description: Fetch latest AI-related YouTube videos from curated channels using YouTube Data API v3 and filter by keywords Use when this capability is needed.
metadata:
  author: openclaw
---
