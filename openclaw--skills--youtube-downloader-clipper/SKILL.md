...
description: Extract specific sections from YouTube videos with precise timestamps. A powerful ClawHub skill that makes video clipping effortless - just provide a URL and time range. Use when this capability is needed.
metadata:
  author: openclaw
---
