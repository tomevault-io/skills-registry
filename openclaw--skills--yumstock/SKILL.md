---
name: yumstock
description: Macro-gated US stock analysis combining technical indicators, fundamentals, and macro environment with weighted scoring and Buy/Hold/Sell verdicts. Use when this capability is needed.
metadata:
  author: openclaw
---
