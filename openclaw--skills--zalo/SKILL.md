---
name: zalo
description: OpenClaw skill for Zalo Bot API workflows (bot token) plus optional guidance on unofficial personal automation tools. Use when this capability is needed.
metadata:
  author: openclaw
---
