---
name: zerion-api
description: This skill provides access to Zerion's interpreted crypto wallet data through MCP tools. Supports **EVM chains** (Ethereum, Polygon, Arbitrum, Optimism, Base, BSC, and 50+ more) and **Solana**. Use when this capability is needed.
metadata:
  author: openclaw
---
