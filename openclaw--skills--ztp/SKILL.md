---
name: ztp
description: Use when working with a mandatory security audit skill for validating new code, skills, and MCP servers against the SEP-2026 Zero Trust protocol.
metadata:
  author: openclaw
---
