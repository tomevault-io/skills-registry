---
name: claw-monitor
description: Use the `clawmonitor` CLI/TUI to inspect OpenClaw sessions, model health, token usage, and gateway service health. Use when this capability is needed.
metadata:
  author: openclawq
---
...
---
> Source: [openclawq/clawmonitor](https://github.com/openclawq/clawmonitor) — distributed by [TomeVault](https://tomevault.io).
