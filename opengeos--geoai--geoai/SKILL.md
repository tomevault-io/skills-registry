...
description: AI-powered geospatial analysis CLI. Segment satellite imagery, detect objects, classify images, detect changes, download data, and manage raster/vector operations -- all from the command line with JSON output for agent integration. Use when this capability is needed.
metadata:
  author: opengeos
---
...
---
> Source: [opengeos/geoai](https://github.com/opengeos/geoai) — distributed by [TomeVault](https://tomevault.io).
