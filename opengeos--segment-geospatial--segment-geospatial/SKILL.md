...
description: CLI harness for segment-geospatial — segment satellite/aerial imagery with SAM models from the command line Use when this capability is needed.
metadata:
  author: opengeos
---
...
---
> Source: [opengeos/segment-geospatial](https://github.com/opengeos/segment-geospatial) — distributed by [TomeVault](https://tomevault.io).
