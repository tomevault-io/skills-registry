---
name: notion
description: Create, search, and update Notion pages/databases using the Notion API. Use for documenting work, generating runbooks, and automating knowledge base updates. Use when this capability is needed.
metadata:
  author: openhands
---
