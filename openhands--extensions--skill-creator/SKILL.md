---
name: skill-creator
description: This skill should be used when the user wants to "create a skill", "write a new skill", "improve skill description", "organize skill content", or needs guidance on skill structure, progressive disclosure, or skill development best practices. Use when this capability is needed.
metadata:
  author: openhands
---
