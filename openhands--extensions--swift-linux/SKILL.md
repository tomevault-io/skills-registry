---
name: swift-linux
description: Install and configure Swift programming language on Debian Linux for server-side development. Use when building Swift applications on Linux or setting up a Swift development environment. Use when this capability is needed.
metadata:
  author: openhands
---
