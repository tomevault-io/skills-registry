---
name: openpond-cli
description: Use the OpenPond CLI to create repos, watch deployments, and run tools without the web UI. Use when this capability is needed.
metadata:
  author: openpond
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/openpond) — claim your Tome and manage your conversions.
