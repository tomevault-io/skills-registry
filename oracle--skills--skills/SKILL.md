---
name: apexlang
description: Public APEXlang router with deterministic local-context discovery and compact machine-readable contracts. Use when this capability is needed.
metadata:
  author: oracle
---
