---
name: orchata-mcp
description: Use Orchata MCP tools to search, browse, and manage knowledge bases programmatically. For MCP-connected environments only. Use when this capability is needed.
metadata:
  author: orchata-ai
---
