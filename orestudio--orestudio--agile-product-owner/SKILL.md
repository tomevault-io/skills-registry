...
description: Manage development team through story creation, prioritization, and sprint planning. Use when this capability is needed.
metadata:
  author: orestudio
---
...
-   Sprint Backlog Stories
    ...
    \#+begin\_src fundamental ,\*\*\*\* STARTED Story title :tag1:
    ...
    -   Notes
        ...
        Any additional context, decisions, or links to related work. \#+end\_src
...
When planning a new sprint (typically done using the [new-sprint](../new-sprint/SKILL.md) skill):
...
1.  **Single tag allowed** – Stories must have a single tag.
