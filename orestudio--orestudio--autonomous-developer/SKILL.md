...
description: Autonomously pick up stories from sprint backlog, implement them incrementally with tests and commits, then submit for review. Use when this capability is needed.
metadata:
  author: orestudio
---
