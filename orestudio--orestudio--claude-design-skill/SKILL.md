...
Use **Microsoft Fluent UI System Icons**. Icons clarify, not decorate — if removing an icon loses no meaning, remove it. Refer to the [Icon Guidelines](../icon-guidelines/SKILL.md) skill for the complete icon inventory and semantic usage.
