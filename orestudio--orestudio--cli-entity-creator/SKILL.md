...
description: Create CLI commands for domain entities in ores.cli including import, export, list, delete, and add operations. Use when this capability is needed.
metadata:
  author: orestudio
---
