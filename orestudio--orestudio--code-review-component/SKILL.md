...
description: Deep review of a component for technical debt, modernization, and convention compliance. Use when this capability is needed.
metadata:
  author: orestudio
---
...
Reference: [component-creator](../component-creator/SKILL.md) skill for expected structure.
...
| Check                | Description                                         |
|-------------------- |--------------------------------------------------- |
| snake\_case (non-Qt) | All classes, methods, variables use snake\_case.    |
...
For each domain type in the component, verify completeness per [domain-type-creator](../domain-type-creator/SKILL.md) skill.
...
For components with messaging, verify per [binary-protocol-developer](../binary-protocol-developer/SKILL.md) skill.
...
Verify diagrams are up-to-date per [plantuml-class-modeler](../plantuml-class-modeler/SKILL.md) skill.
...
Verify test coverage per [unit-test-writer](../unit-test-writer/SKILL.md) skill.
