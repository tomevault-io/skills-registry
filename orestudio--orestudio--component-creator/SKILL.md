...
description: Guide for creating new components that follow our project structure.. Use when this capability is needed.
metadata:
  author: orestudio
---
...
Using the [CMake Runner Skill](../cmake-runner/SKILL.md):
...
Once the scaffold is working, document the component's architecture using the [Component Model Creator](../component-model-creator/SKILL.md) skill. This produces:
