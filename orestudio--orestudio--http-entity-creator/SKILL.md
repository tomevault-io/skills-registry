...
description: Create HTTP REST API endpoints for domain entities in ores.http.server including CRUD operations and history. Use when this capability is needed.
metadata:
  author: orestudio
---
