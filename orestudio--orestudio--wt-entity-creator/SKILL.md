...
description: Create Wt web UI components for domain entities including list widgets, detail dialogs, and application integration. Use when this capability is needed.
metadata:
  author: orestudio
---
