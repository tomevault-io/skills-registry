...
description: Execute a GRACE development plan in controller-managed parallel waves with selectable safety profiles, verification-plan excerpts, batched shared-artifact sync, and scoped reviews. Use when this capability is needed.
metadata:
  author: osovv
---
