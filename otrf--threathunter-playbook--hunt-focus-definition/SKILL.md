...
description: Define a focused hunt hypothesis by synthesizing completed system internals and adversary tradecraft research. Use this skill after research has been completed to narrow a high-level hunt topic into a single, concrete attack pattern with clear investigative intent. This skill produces a structured, testable hypothesis and should be used before selecting data sources, defining environment scope, or developing analytics. Use when this capability is needed.
metadata:
  author: otrf
---
# Define Hunt Focus
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/otrf) — claim your Tome and manage your conversions.
