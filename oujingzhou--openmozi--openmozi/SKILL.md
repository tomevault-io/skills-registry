---
name: greeting
description: 根据时间和场景提供个性化问候 Use when this capability is needed.
metadata:
  author: oujingzhou
---
...
---
> Source: [oujingzhou/openmozi](https://github.com/oujingzhou/openmozi) — distributed by [TomeVault](https://tomevault.io).
