---
name: docs-update
description: Keep documentation up-to-date after code changes. Covers which docs to check, how to write them, and how to regenerate API docs. Use after any feature, fix, or refactor. Use when this capability is needed.
metadata:
