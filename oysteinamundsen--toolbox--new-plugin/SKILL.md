---
name: new-plugin
description: Create a new grid plugin for @toolbox-web/grid following the canonical plugin structure. Use when adding a new plugin with hooks, styles, tests, and documentation. Use when this capability is needed.
metadata:
