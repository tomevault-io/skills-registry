---
name: vite
description: description: Vite build tool configuration, plugin API, SSR, and Vite 8 Rolldown migration. Use when working with Vite projects, vite.config.ts, Vite plugins, or building libraries/SSR apps with Vite. Use when this capability is needed.
metadata:
  author: ozymandros
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ozymandros) — claim your Tome and manage your conversions.
