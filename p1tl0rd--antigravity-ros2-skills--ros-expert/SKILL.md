---
name: ros-expert
description: description: Robotics Operating System (ROS 1 & 2) expert. Specializes in node lifecycle, transformations (TF2), URDF modeling, navigation, and build systems (catkin/colcon). Use when this capability is needed.
metadata:
  author: p1tl0rd
---
---
