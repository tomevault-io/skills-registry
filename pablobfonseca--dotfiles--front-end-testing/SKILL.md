...
description: DOM Testing Library patterns for behavior-driven UI testing. Framework-agnostic patterns for testing user interfaces. Use when testing any front-end application. Use when this capability is needed.
metadata:
  author: pablobfonseca
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pablobfonseca) — claim your Tome and manage your conversions.
