...
description: Guide for creating Packmind packages via the CLI. This skill should be used when users want to create a new package to organize standards, commands, and skills for distribution. Use when this capability is needed.
metadata:
  author: packmindhub
---
