...
description: Complex document parsing with PaddleOCR. Intelligently converts complex PDFs and document images into Markdown and JSON files that preserve the original structure. Use when this capability is needed.
metadata:
  author: PaddlePaddle
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/PaddlePaddle) — claim your Tome and manage your conversions.
