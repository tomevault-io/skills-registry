...
description: Teaches the model how to formulate strategic <coding_plan> blocks, apply indentation-agnostic Aider search/replace patches, manage Git-like version logs, and control in-message status reporting. Use when this capability is needed.
metadata:
  author: ParisNeo
---
...
---
> Source: [ParisNeo/lollms_client](https://github.com/ParisNeo/lollms_client) — distributed by [TomeVault](https://tomevault.io).
