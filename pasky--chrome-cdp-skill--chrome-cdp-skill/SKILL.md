---
name: chrome-cdp
description: Interact with local Chrome browser session (only on explicit user approval after being asked to inspect, debug, or interact with a page open in Chrome) Use when this capability is needed.
metadata:
  author: pasky
---
...
---
> Source: [pasky/chrome-cdp-skill](https://github.com/pasky/chrome-cdp-skill) — distributed by [TomeVault](https://tomevault.io).
