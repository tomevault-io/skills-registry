...
description: Implements content safety filters with PII redaction, policy constraints, prompt injection detection, and safe refusal templates. Use when adding "content moderation", "safety filters", "PII protection", or "guardrails". Use when this capability is needed.
metadata:
...
---
> Source: [patricio0312rev/skills](https://github.com/patricio0312rev/skills) — distributed by [TomeVault](https://tomevault.io).
