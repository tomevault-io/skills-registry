---
name: dv-pit-bridge
description: When and how to build PIT tables and Bridge tables in DVOS — manifest config, materialisation options, bridge types, naming rules. Use when this capability is needed.
metadata:
  author: PatrickCuba
---
...
---
> Source: [PatrickCuba/the_data_must_flow](https://github.com/PatrickCuba/the_data_must_flow) — distributed by [TomeVault](https://tomevault.io).
