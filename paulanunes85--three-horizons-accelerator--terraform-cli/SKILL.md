---
name: terraform-cli
description: Terraform CLI operations for Azure infrastructure management Use when this capability is needed.
metadata:
  author: paulanunes85
---
...
---
> Source: [paulanunes85/three-horizons-accelerator](https://github.com/paulanunes85/three-horizons-accelerator) — distributed by [TomeVault](https://tomevault.io).
