...
description: Checks current branch changes against local main for AGENTS.md conformance, writes a report, and auto-fixes violations. Use when asked to enforce standards, check conformance, or fix branch to match AGENTS.md. Use when this capability is needed.
metadata:
  author: paulchiu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/paulchiu) — claim your Tome and manage your conversions.
