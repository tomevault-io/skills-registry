...
description: Create and iterate Excalidraw diagrams via a local Excalidraw MCP CLI. Use when a user asks for architecture diagrams, flowcharts, sequence views, or visual system maps. Use when this capability is needed.
metadata:
  author: pauldthomson
---
