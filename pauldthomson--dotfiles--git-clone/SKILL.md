---
name: git-clone
description: Clone git repositories using standard CLI conventions and directory layout. Use when a user asks to clone a repo or set up a local checkout. Use when this capability is needed.
metadata:
  author: pauldthomson
---
