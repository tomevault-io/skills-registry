---
name: pr-summary
description: Generate reviewer-ready PR bodies with high-level changes, rationale, session context, decisions, alternatives, trade-offs, and test impact. Always use when creating or editing a PR body for agent-authored changes. Use when this capability is needed.
metadata:
  author: pauldthomson
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pauldthomson) — claim your Tome and manage your conversions.
