---
name: agent-creating
description: Used to create a new agent. Used when a user wants to create a new agent Use when this capability is needed.
metadata:
  author: pauliusos
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pauliusos) — claim your Tome and manage your conversions.
