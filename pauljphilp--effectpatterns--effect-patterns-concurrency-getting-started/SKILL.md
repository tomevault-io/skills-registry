...
description: Effect-TS patterns for Concurrency Getting Started. Use when working with concurrency getting started in Effect-TS applications. Use when this capability is needed.
metadata:
  author: pauljphilp
---
