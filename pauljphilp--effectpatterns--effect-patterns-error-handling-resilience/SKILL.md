...
description: Effect-TS patterns for Error Handling Resilience. Use when working with error handling resilience in Effect-TS applications. Use when this capability is needed.
metadata:
  author: pauljphilp
---
