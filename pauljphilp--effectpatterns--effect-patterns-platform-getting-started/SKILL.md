...
description: Effect-TS patterns for Platform Getting Started. Use when working with platform getting started in Effect-TS applications. Use when this capability is needed.
metadata:
  author: pauljphilp
---
