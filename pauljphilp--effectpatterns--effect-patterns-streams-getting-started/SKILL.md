...
description: Effect-TS patterns for Streams Getting Started. Use when working with streams getting started in Effect-TS applications. Use when this capability is needed.
metadata:
  author: pauljphilp
---
