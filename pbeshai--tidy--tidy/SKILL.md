---
name: using-tidyjs
description: Write correct, idiomatic tidyjs code. Activates when the user works with @tidyjs/tidy imports, mentions tidyjs, or asks about JavaScript data wrangling in a project that uses tidyjs. Use when this capability is needed.
metadata:
  author: pbeshai
---
...
---
> Source: [pbeshai/tidy](https://github.com/pbeshai/tidy) — distributed by [TomeVault](https://tomevault.io).
