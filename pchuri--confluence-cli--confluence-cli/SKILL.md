---
name: confluence
description: Use confluence-cli to read, search, create, update, move, delete, and convert Confluence pages and attachments from the terminal. Use when this capability is needed.
metadata:
  author: pchuri
---
...
---
> Source: [pchuri/confluence-cli](https://github.com/pchuri/confluence-cli) — distributed by [TomeVault](https://tomevault.io).
