---
name: ghpr
description: GitHub Pull Request creation workflow for OSS contributions. Creates well-structured PRs with issue references, conventional prefixes, and proper descriptions. Use when the user wants to create a PR, send changes upstream, or submit a contribution. Use when this capability is needed.
metadata:
  author: peacock0803sz
---
