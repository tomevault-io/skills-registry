...
description: API documentation to be loaded at startup - when starting a Coot session, immediately call get_function_descriptions() with the functions listed in this skill. Use when this capability is needed.
metadata:
  author: pemsley
---
