...
description: McKinsey顾问式问题解决系统。从商业问题出发,通过假设驱动的结构化分析方法,生成McKinsey风格研究报告和PPT。融合Problem Solving方法论、MECE原则、Issue Tree拆解、Hypotheses形成、Dummy Page设计、智能数据收集和专业PPT生成能力。 Use when this capability is needed.
metadata:
  author: pennypny163
---
...
---
> Source: [pennypny163/mbb-deck-builder](https://github.com/pennypny163/mbb-deck-builder) — distributed by [TomeVault](https://tomevault.io).
