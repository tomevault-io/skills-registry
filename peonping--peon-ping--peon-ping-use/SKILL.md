---
name: peon-ping-use
description: Set which voice pack (character voice) plays for the current chat session. Automatically enables session_override rotation mode if not already set. Use when user wants a specific character voice like GLaDOS, Peon, or Kerrigan for this conversation. Use when this capability is needed.
metadata:
  author: peonping
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/peonping) — claim your Tome and manage your conversions.
