---
name: zellij
description: Control Zellij terminal multiplexer from Claude Code. Use when the user asks to create panes, tabs, run commands in new panes, manage terminal layout, or interact with the Zellij workspace. Use when this capability is needed.
metadata:
  author: pepegar
---
