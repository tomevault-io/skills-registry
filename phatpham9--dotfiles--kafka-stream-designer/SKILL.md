...
description: Design Kafka topics, partitions, consumer groups, producers with idempotency, retry strategies, dead letter queues, exactly-once semantics, and schema registry integration Use when this capability is needed.
metadata:
  author: phatpham9
---
