...
description: Scaffold NestJS backend modules, controllers, services, DTOs, REST/GraphQL APIs, WebSocket handlers, validation pipes, guards, interceptors, and Jest integration tests Use when this capability is needed.
metadata:
  author: phatpham9
---
