---
name: zalo-agent
description: Automate Zalo messaging, Official Account (OA), and MCP server integration via zalo-agent-cli. Triggers: 'zalo', 'send zalo', 'zalo OA', 'official account', 'bank card', 'QR transfer', 'VietQR', 'listen zalo', 'zalo webhook', 'zalo group', 'zalo friend', 'zalo MCP', 'MCP server'. Use when this capability is needed.
metadata:
  author: PhucMPham
---
...
---
> Source: [PhucMPham/zalo-agent-cli](https://github.com/PhucMPham/zalo-agent-cli) — distributed by [TomeVault](https://tomevault.io).
