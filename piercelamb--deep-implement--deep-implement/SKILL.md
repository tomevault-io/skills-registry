---
name: deep-implement
description: Implements code from /deep-plan section files with TDD methodology, code review, and git workflow. Use when implementing plans created by /deep-plan. Use when this capability is needed.
metadata:
  author: piercelamb
---
...
---
> Source: [piercelamb/deep-implement](https://github.com/piercelamb/deep-implement) — distributed by [TomeVault](https://tomevault.io).
