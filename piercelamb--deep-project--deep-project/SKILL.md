---
name: deep-project
description: Decomposes vague, high-level project requirements into well-scoped planning units for /deep-plan. Use when starting a new project that needs to be broken into manageable pieces. Use when this capability is needed.
metadata:
  author: piercelamb
---
...
---
> Source: [piercelamb/deep-project](https://github.com/piercelamb/deep-project) — distributed by [TomeVault](https://tomevault.io).
