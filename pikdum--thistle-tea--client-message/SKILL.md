---
name: client-message
description: Implement Thistle Tea CMSG_* client messages following our architecture patterns. Use this when asked to implement a new message or you need to use one that isn't implemented yet. Use when this capability is needed.
metadata:
  author: pikdum
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pikdum) — claim your Tome and manage your conversions.
