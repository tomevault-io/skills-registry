---
name: squash-commits
description: Reorganize messy branch commits into a small set of logical, meaningful commits without changing any content. Drops merge-from-main commits. Safe: creates a backup branch first. Use when this capability is needed.
metadata:
  author: pipecat-ai
---
...
---
> Source: [pipecat-ai/pipecat](https://github.com/pipecat-ai/pipecat) — distributed by [TomeVault](https://tomevault.io).
