---
name: design
description: Gather requirements and create a specification for a new feature or system. Use when the user wants to design, spec out, or plan requirements for something they want to build. Use when this capability is needed.
metadata:
  author: pitriq
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pitriq) — claim your Tome and manage your conversions.
