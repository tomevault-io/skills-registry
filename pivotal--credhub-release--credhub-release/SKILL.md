...
description: Generate release notes for the latest credhub-release. Use when this capability is needed.
metadata:
  author: pivotal
---
...
---
> Source: [pivotal/credhub-release](https://github.com/pivotal/credhub-release) — distributed by [TomeVault](https://tomevault.io).
