---
name: claude-honcho
description: Migrates Honcho Python SDK code from v1.6.0 to v2.0.0. Use when upgrading honcho package, fixing breaking changes after upgrade, or when errors mention AsyncHoncho, observations, Representation class, .core property, or get_config methods. Use when this capability is needed.
metadata:
  author: plastic-labs
---
...
---
> Source: [plastic-labs/claude-honcho](https://github.com/plastic-labs/claude-honcho) — distributed by [TomeVault](https://tomevault.io).
