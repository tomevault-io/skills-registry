---
name: migrate-honcho
description: Migrates Honcho Python SDK code from v1.6.0 to v2.1.1. Use when upgrading honcho package, fixing breaking changes after upgrade, or when errors mention AsyncHoncho, observations, Representation class, .core property, or get_config methods. Use when this capability is needed.
metadata:
  author: plastic-labs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/plastic-labs) — claim your Tome and manage your conversions.
