...
description: Containerize and deploy Node.js applications with Docker including multi-stage builds, Docker Compose, and production optimization Use when this capability is needed.
metadata:
