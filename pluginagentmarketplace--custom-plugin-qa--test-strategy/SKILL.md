---
name: test-strategy
description: Production-grade test strategy skill with risk-based testing, coverage analysis, quality gates, and resource optimization Use when this capability is needed.
metadata:
