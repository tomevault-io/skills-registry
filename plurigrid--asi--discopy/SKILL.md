---
name: discopy
description: DisCoPy: Python library for computing with string diagrams - monoidal categories, quantum circuits, QNLP, operads, and tensor networks. Use when this capability is needed.
metadata:
  author: plurigrid
---
