---
name: gflownet
description: Bengio's GFlowNets: Generative Flow Networks that sample proportionally to reward. Diversity over maximization for causal discovery and molecule design. Use when this capability is needed.
metadata:
  author: plurigrid
---
