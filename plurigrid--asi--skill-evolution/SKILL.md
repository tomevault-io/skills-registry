...
description: Patterns for evolutionarily robust skills that adapt across agent generations. Darwin-Godel machine principles for self-improving skill ecosystems. Use when this capability is needed.
metadata:
  author: plurigrid
---
