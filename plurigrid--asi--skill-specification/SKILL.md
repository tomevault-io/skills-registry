...
description: Agent Skills formal specification for cross-platform compatibility. Ensures skills are evolutionarily robust across Claude, Codex, Cursor, Amp, and future agents. Use when this capability is needed.
metadata:
  author: plurigrid
---
