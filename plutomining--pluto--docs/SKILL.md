---
name: docs
description: Create and manage documentation-only branches in a git worktree with consistent naming and PR workflow (squash merge). Use when this capability is needed.
metadata:
  author: plutomining
---
## What I do
