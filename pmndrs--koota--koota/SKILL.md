---
name: koota
description: Real-time ECS state management for TypeScript and React. Use when the user mentions koota, ECS, entities, traits, queries, or building data-oriented applications. Use when this capability is needed.
metadata:
  author: pmndrs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pmndrs) — claim your Tome and manage your conversions.
