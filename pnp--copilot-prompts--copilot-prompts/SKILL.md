...
description: This skill should be used when the user asks to "create a new prompt sample", "add a new prompt sample", "scaffold a new prompt sample", "create a prompt contribution", "add a prompt", or needs to create a new prompt sample with proper folder structure, README, and sample.json metadata. Do NOT use this skill for agent instructions or system prompts. Use when this capability is needed.
metadata:
  author: pnp
---
...
---
> Source: [pnp/copilot-prompts](https://github.com/pnp/copilot-prompts) — distributed by [TomeVault](https://tomevault.io).
