...
description: Refactor MoonBit code to be idiomatic: shrink public APIs, convert functions to methods, use pattern matching with views, add loop invariants, and ensure test coverage without regressions. Use when updating MoonBit packages or refactoring MoonBit APIs, modules, or tests. Use when this capability is needed.
metadata:
  author: pnsk-lab
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pnsk-lab) — claim your Tome and manage your conversions.
