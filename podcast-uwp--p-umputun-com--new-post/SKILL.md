---
name: new-post
description: Create, write, and refine blog posts for p.umputun.com in the author's Russian conversational style. Helps with brainstorming, structuring, drafting, image management, and publishing. This skill should be used when user wants to create a new blog post or work on an existing draft. Use when this capability is needed.
metadata:
  author: podcast-uwp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/podcast-uwp) — claim your Tome and manage your conversions.
