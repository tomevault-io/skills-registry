...
description: Implements features, bug fixes, refactoring, and code changes by breaking work into focused sub-problems. Use whenever writing, modifying, or creating code. Use when the user asks to implement, build, create, add, fix, update, refactor, or change anything in the codebase. Use when this capability is needed.
metadata:
  author: polizanov
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/polizanov) — claim your Tome and manage your conversions.
