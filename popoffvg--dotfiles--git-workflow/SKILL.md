---
name: git-workflow
description: This skill should be used when asked about branching, committing, PRs, or the end-to-end Git development flow. Covers available commands (/smart-commit, /pr, /fix), branch naming conventions, and when to use each tool. Use when this capability is needed.
metadata:
  author: popoffvg
---
...
---
> Source: [popoffvg/dotfiles](https://github.com/popoffvg/dotfiles) — distributed by [TomeVault](https://tomevault.io).
