---
name: signals
description: How to query the document_embeddings table for signals data using HogQL. Read when you need to perform semantic search over signals, fetch signals for a report or list signal types. Use when this capability is needed.
metadata:
  author: PostHog
---
