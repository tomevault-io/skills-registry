...
description: Migrate a library's user-facing errors, warnings, and logs to nostics diagnostics. Use when replacing console.warn/console.error, warn() helpers, or thrown Errors with stable diagnostic codes, or when designing or extending a defineDiagnostics catalog. Use when this capability is needed.
metadata:
  author: posva
---
...
---
> Source: [posva/pinia-colada](https://github.com/posva/pinia-colada) — distributed by [TomeVault](https://tomevault.io).
