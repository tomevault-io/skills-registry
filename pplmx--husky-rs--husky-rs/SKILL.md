...
description: Ensures all commit messages and PR titles follow the Conventional Commits specification. Use when this capability is needed.
metadata:
  author: pplmx
---
...
---
> Source: [pplmx/husky-rs](https://github.com/pplmx/husky-rs) — distributed by [TomeVault](https://tomevault.io).
