...
description: Accessibility testing skill using axe-core and Playwright for automated WCAG 2.1 compliance auditing, custom rules, and accessibility reporting. Use when this capability is needed.
metadata:
  author: pramoddutta
---
