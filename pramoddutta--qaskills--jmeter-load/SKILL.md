...
description: Load and performance testing skill using Apache JMeter, covering test plans, thread groups, assertions, listeners, timers, and distributed testing. Use when this capability is needed.
metadata:
  author: pramoddutta
---
