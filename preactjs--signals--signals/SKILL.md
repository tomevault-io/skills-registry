...
description: Interprets `@preact/signals-debug` updates and the AI-native Vite event stream to diagnose reactive UI bugs. Use when this capability is needed.
metadata:
  author: preactjs
---
...
---
> Source: [preactjs/signals](https://github.com/preactjs/signals) — distributed by [TomeVault](https://tomevault.io).
