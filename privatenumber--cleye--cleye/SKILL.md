---
name: cleye
description: cleye CLI development tool — argv parsing with typed parameters, flags, commands, and auto-generated help. Use when building Node.js CLI scripts with cleye or when the user imports `cli` or `command` from `cleye`. Use when this capability is needed.
metadata:
...
---
> Source: [privatenumber/cleye](https://github.com/privatenumber/cleye) — distributed by [TomeVault](https://tomevault.io).
