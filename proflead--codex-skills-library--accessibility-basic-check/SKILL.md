...
description: Run a basic accessibility checklist for UI changes. Use when a junior developer needs quick a11y guidance. Use when this capability is needed.
metadata:
  author: proflead
---
