...
description: Validate API changes against an expected contract. Use when a mid-level developer needs to detect breaking changes. Use when this capability is needed.
metadata:
  author: proflead
---
