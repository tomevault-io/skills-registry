---
name: napcat-qq
description: 为 openclaw 发送 QQ 消息（含图片/语音等媒体）时，强制使用 napcat 插件 API，并按照私聊/群聊规则生成与校验 sessionKey。适用于“发送QQ消息”“发群消息”“发QQ私聊”“发QQ图片”“发QQ语音”等请求。 Use when this capability is needed.
metadata:
  author: ProperSAMA
---
...
---
> Source: [ProperSAMA/openclaw-napcat-plugin](https://github.com/ProperSAMA/openclaw-napcat-plugin) — distributed by [TomeVault](https://tomevault.io).
