...
description: ALWAYS load when working in pwiz_tools/Skyline, on GitHub issues labeled 'skyline', or TODOs referencing Skyline code. Use when this capability is needed.
metadata:
  author: proteowizard
---
