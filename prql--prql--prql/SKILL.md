---
name: prql
description: Tend-specific guidance for this repo. Project build commands, test strategy, Use when this capability is needed.
metadata:
  author: PRQL
---
...
---
> Source: [PRQL/prql](https://github.com/PRQL/prql) — distributed by [TomeVault](https://tomevault.io).
