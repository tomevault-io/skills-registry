---
name: edgemail
description: Use this API when an agent needs to inspect a temporary inbox on `smtp.idont.date` over HTTP.
metadata:
  author: psarna
---
# Inbox API
...
---
> Source: [psarna/edgemail](https://github.com/psarna/edgemail) — distributed by [TomeVault](https://tomevault.io).
