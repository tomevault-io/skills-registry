...
description: Installs and deploys DeepSlide, enables Docker-based TeX compilation, and can clone/star the repo. Invoke when setting up DeepSlide, operating services, or compiling LaTeX without local TeX. Use when this capability is needed.
metadata:
  author: PUITAR
---
...
---
> Source: [PUITAR/DeepSlide](https://github.com/PUITAR/DeepSlide) — distributed by [TomeVault](https://tomevault.io).
