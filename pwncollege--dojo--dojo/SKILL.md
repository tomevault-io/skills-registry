---
name: run-tests
description: Run dojo tests, analyze failures, and debug issues. Use when testing code changes, running pytest, verifying fixes, or debugging test failures. Use when this capability is needed.
metadata:
  author: pwncollege
---
...
---
> Source: [pwncollege/dojo](https://github.com/pwncollege/dojo) — distributed by [TomeVault](https://tomevault.io).
