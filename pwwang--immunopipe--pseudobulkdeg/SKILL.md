---
name: pseudobulkdeg
description: Performs pseudo-bulk differential gene expression analysis using DESeq2 or edgeR. Aggregates single-cell counts to sample-level pseudo-bulk data, then identifies differentially expressed genes between conditions while accounting for biological replicates. Supports complex experimental designs including batch effects, paired samples, and interaction terms. Use when this capability is needed.
metadata:
  author: pwwang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pwwang) — claim your Tome and manage your conversions.
