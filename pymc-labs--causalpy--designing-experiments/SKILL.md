...
description: Selects the appropriate quasi-experimental method (DiD, ITS, SC) based on data structure and research questions. Use when the user is unsure which method to apply. Use when this capability is needed.
metadata:
  author: pymc-labs
---
