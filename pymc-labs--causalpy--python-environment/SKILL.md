...
description: Detect and configure a conda-compatible tool, create the CausalPy environment, and run commands inside it. Use before any task that requires Python execution. Use when this capability is needed.
metadata:
  author: pymc-labs
---
