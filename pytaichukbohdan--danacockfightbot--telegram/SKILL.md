---
name: telegram
description: This skill should be used when fetching, searching, downloading, or sending messages on Telegram. Use for queries like "show my Telegram messages", "search Telegram for...", "get unread messages", "send a message to...", or "add Telegram messages to my notes". Use when this capability is needed.
metadata:
  author: pytaichukbohdan
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/pytaichukbohdan) — claim your Tome and manage your conversions.
