...
description: Execute specifications from workspace platforms into implementation. Transforms documented specifications into actionable development tasks. Use when this capability is needed.
metadata:
  author: qodex-ai
---
