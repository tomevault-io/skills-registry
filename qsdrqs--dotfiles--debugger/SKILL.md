---
name: debugger
description: Evidence-driven debugging for project or system issues: reproduce the bug, capture commands/logs/stack traces, narrow scope, prove root cause with concrete evidence (no guessing), apply minimal fix, and re-run reproduction/tests to verify. Use when asked to debug/triage errors, crashes, segfaults/panics/tracebacks, failing/flaky tests, service/system problems (systemd/journalctl), or performance regressions. Use when this capability is needed.
metadata:
  author: qsdrqs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/qsdrqs) — claim your Tome and manage your conversions.
