---
name: nvim-config
description: Neovim configuration changes and investigations for this dotfiles repo. Use for any Neovim-related task: editing config, plugin specs, keymaps, LSP/formatters, UI, performance, debugging, or plugin behavior questions. Use when this capability is needed.
metadata:
  author: qsdrqs
---
