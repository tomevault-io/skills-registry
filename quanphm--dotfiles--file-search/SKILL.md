---
name: file-search
description: MUST use this skill when search for files and content. Modern file and content search using fd, ripgrep (rg), and fzf. instead of find, and grep. Use when this capability is needed.
metadata:
  author: quanphm
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/quanphm) — claim your Tome and manage your conversions.
