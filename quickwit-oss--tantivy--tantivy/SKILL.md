...
description: Update CHANGELOG.md with merged PRs since the last changelog update, categorized by type Use when this capability is needed.
metadata:
  author: quickwit-oss
---
...
---
> Source: [quickwit-oss/tantivy](https://github.com/quickwit-oss/tantivy) — distributed by [TomeVault](https://tomevault.io).
