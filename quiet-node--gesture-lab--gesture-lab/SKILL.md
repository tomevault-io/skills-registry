...
description: Three.js post-processing - EffectComposer, bloom, DOF, screen effects. Use when adding visual effects, color grading, blur, glow, or creating custom screen-space shaders. Use when this capability is needed.
metadata:
  author: quiet-node
---
...
---
> Source: [quiet-node/gesture-lab](https://github.com/quiet-node/gesture-lab) — distributed by [TomeVault](https://tomevault.io).
