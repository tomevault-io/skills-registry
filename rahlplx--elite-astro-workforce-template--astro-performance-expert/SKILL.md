...
description: Web performance optimization for Astro sites. Adapted from Vercel Engineering's 57 rules. Use when optimizing page load speed, eliminating waterfalls, reducing bundle size, or improving Core Web Vitals. Use when this capability is needed.
metadata:
  author: rahlplx
---
