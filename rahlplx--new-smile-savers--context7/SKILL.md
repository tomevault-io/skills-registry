...
description: Fetch up-to-date library documentation for Astro, Tailwind CSS, TypeScript, and other Smile Savers project dependencies using Context7 MCP Use when this capability is needed.
metadata:
  author: rahlplx
---
