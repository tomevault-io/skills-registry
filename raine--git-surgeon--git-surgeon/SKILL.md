---
name: git-surgeon
description: Non-interactive hunk-level git staging, unstaging, discarding, undoing, fold, amend, squash, commit splitting, and commit reordering. Use when selectively staging, unstaging, discarding, reverting, squashing, splitting, or reordering individual diff hunks by ID instead of interactively. Use when this capability is needed.
metadata:
  author: raine
---
...
---
> Source: [raine/git-surgeon](https://github.com/raine/git-surgeon) — distributed by [TomeVault](https://tomevault.io).
