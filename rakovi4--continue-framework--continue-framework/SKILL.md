...
description: Scan a prompt file for layer violations and structural problems, then fix them. Use when user wants to clean up documentation files or mentions /prompt-refactor command. Use when this capability is needed.
metadata:
  author: rakovi4
---
