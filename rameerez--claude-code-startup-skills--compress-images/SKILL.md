...
description: Compress images for web/SEO performance using cwebp. Use when optimizing images for faster page loads, reducing file sizes, or converting JPG/PNG to WebP format. Use when this capability is needed.
metadata:
  author: rameerez
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rameerez) — claim your Tome and manage your conversions.
