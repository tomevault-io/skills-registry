...
description: Apply whenever writing or reviewing Python code — prescriptive best practices for Python 3.14: which idioms to prefer, which anti-patterns to avoid, and which modern language features to reach for first. Use when this capability is needed.
metadata:
  author: ramesaliyev
---
...
---
> Source: [ramesaliyev/hello-python](https://github.com/ramesaliyev/hello-python) — distributed by [TomeVault](https://tomevault.io).
