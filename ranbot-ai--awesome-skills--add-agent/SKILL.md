---
name: add-agent
description: This agent helps create new microagents in the `.openhands/microagents` directory by providing guidance and templates. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
