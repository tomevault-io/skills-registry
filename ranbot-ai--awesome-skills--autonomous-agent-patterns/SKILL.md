...
description: Design patterns for building autonomous coding agents, inspired by [Cline](https://github.com/cline/cline) and [OpenAI Codex](https://github.com/openai/codex). Use when this capability is needed.
metadata:
  author: ranbot-ai
---
