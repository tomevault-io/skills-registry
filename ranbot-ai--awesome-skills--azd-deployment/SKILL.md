---
name: azd-deployment
description: Deploy containerized frontend + backend applications to Azure Container Apps with remote builds, managed identity, and idempotent infrastructure. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
