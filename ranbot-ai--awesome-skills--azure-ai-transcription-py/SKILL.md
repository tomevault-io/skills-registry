...
description: Azure AI Transcription SDK for Python. Use for real-time and batch speech-to-text transcription with timestamps and diarization. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
