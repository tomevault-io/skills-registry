...
description: Azure Monitor Ingestion SDK for Java. Send custom logs to Azure Monitor via Data Collection Rules (DCR) and Data Collection Endpoints (DCE). Use when this capability is needed.
metadata:
  author: ranbot-ai
---
