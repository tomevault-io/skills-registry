...
description: Azure Monitor OpenTelemetry Exporter for Java. Export OpenTelemetry traces, metrics, and logs to Azure Monitor/Application Insights. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
