...
description: Azure Monitor Query SDK for Java. Execute Kusto queries against Log Analytics workspaces and query metrics from Azure resources. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
