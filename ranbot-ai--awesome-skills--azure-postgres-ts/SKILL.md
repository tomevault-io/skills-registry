...
description: Connect to Azure Database for PostgreSQL Flexible Server from Node.js/TypeScript using the pg (node-postgres) package. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
