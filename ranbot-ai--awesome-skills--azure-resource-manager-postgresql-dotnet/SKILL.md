...
description: Azure PostgreSQL Flexible Server SDK for .NET. Database management for PostgreSQL Flexible Server deployments. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
