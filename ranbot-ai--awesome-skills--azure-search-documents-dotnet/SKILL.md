...
description: Azure AI Search SDK for .NET (Azure.Search.Documents). Use for building search applications with full-text, vector, semantic, and hybrid search. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
