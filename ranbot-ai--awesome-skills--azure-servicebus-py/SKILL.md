...
description: Azure Service Bus SDK for Python messaging. Use for queues, topics, subscriptions, and enterprise messaging patterns. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
