...
description: Azure Storage File Share SDK for Python. Use for SMB file shares, directories, and file operations in the cloud. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
