...
description: Azure Queue Storage JavaScript/TypeScript SDK (@azure/storage-queue) for message queue operations. Use for sending, receiving, peeking, and deleting messages in queues. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
