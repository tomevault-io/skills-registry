...
description: Braintree Automation: manage payment processing via Stripe-compatible tools for customers, subscriptions, payment methods, and transactions Use when this capability is needed.
metadata:
  author: ranbot-ai
---
