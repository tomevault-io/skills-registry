...
description: Execute comprehensive web application security testing using Burp Suite's integrated toolset, including HTTP traffic interception and modification, request analysis and replay, automated vulnerability Use when this capability is needed.
metadata:
  author: ranbot-ai
---
