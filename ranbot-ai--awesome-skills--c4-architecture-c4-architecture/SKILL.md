...
description: Generate comprehensive C4 architecture documentation for an existing repository/codebase using a bottom-up analysis approach. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
