...
description: Automate Capsule CRM operations -- manage contacts (parties), run structured filter queries, track tasks and projects, log entries, and handle organizations -- using natural language through the Compo Use when this capability is needed.
metadata:
  author: ranbot-ai
---
