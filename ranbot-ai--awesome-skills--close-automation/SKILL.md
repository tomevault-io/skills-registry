...
description: Automate Close CRM tasks via Rube MCP (Composio): create leads, manage calls/SMS, handle tasks, and track notes. Always search tools first for current schemas. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
