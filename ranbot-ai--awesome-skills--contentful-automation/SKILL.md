...
description: Automate headless CMS operations in Contentful -- list spaces, retrieve space metadata, and update space configurations through the Composio Contentful integration. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
