---
name: copilot-sdk
description: Build applications that programmatically interact with GitHub Copilot. The SDK wraps the Copilot CLI via JSON-RPC, providing session management, custom tools, hooks, MCP server integration, and stream Use when this capability is needed.
metadata:
  author: ranbot-ai
---
