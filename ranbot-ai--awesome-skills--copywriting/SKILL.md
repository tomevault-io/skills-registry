---
name: copywriting
description: Write rigorous, conversion-focused marketing copy for landing pages and emails. Enforces brief confirmation and strict no-fabrication rules. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
