...
description: Production-ready patterns for dbt (data build tool) including model organization, testing strategies, documentation, and incremental processing. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
