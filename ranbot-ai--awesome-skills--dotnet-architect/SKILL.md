...
description: Expert .NET backend architect specializing in C#, ASP.NET Core, Entity Framework, Dapper, and enterprise application patterns. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
