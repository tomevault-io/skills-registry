...
description: Master C#/.NET patterns for building production-grade APIs, MCP servers, and enterprise backends with modern best practices (2024/2025). Use when this capability is needed.
metadata:
  author: ranbot-ai
---
