...
description: You are a senior frontend engineer operating under strict architectural and performance standards. Use when creating components or pages, adding new features, or fetching or mutating data. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
