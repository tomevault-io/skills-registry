---
name: go-rod-master
description: Comprehensive guide for browser automation and web scraping with go-rod (Chrome DevTools Protocol) including stealth anti-bot-detection patterns. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
