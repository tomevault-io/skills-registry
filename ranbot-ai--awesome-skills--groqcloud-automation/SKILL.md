...
description: Automate AI inference, chat completions, audio translation, and TTS voice management through GroqCloud's high-performance API via Composio Use when this capability is needed.
metadata:
  author: ranbot-ai
---
