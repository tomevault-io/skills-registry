...
description: Automate Gumroad product management, sales tracking, license verification, and webhook subscriptions using natural language through the Composio MCP integration. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
