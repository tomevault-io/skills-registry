...
description: Automate AI video generation, avatar browsing, template-based video creation, and video status tracking through HeyGen's platform via Composio Use when this capability is needed.
metadata:
  author: ranbot-ai
---
