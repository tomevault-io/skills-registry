...
description: Build hosted agents using Azure AI Projects SDK with ImageBasedHostedAgentDefinition. Use when creating container-based agents in Azure AI Foundry. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
