...
description: Automate HubSpot CRM operations (contacts, companies, deals, tickets, properties) via Rube MCP using Composio integration. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
