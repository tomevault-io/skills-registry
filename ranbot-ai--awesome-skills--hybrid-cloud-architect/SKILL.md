...
description: Expert hybrid cloud architect specializing in complex multi-cloud solutions across AWS/Azure/GCP and private clouds (OpenStack/VMware). Use when this capability is needed.
metadata:
  author: ranbot-ai
---
