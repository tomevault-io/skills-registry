...
description: Automate LaunchDarkly feature flag management -- list projects and environments, create and delete trigger workflows, and track code references via the Composio MCP integration. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
