---
name: loki-mode
description: Version 2.35.0 | PRD to Production | Zero Human Intervention > Research-enhanced: OpenAI SDK, DeepMind, Anthropic, AWS Bedrock, Agent SDK, HN Production (2025) Use when this capability is needed.
metadata:
  author: ranbot-ai
---
