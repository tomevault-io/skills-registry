...
description: Automate email marketing workflows including subscriber management, campaign analytics, group segmentation, and account monitoring through MailerLite via Composio Use when this capability is needed.
metadata:
  author: ranbot-ai
---
