...
description: ⚠️ AUTHORIZED USE ONLY > This skill is for educational purposes or authorized security assessments only. > You must have explicit, written permission from the system owner before using this tool. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
