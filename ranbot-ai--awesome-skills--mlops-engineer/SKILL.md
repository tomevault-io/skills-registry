---
name: mlops-engineer
description: Build comprehensive ML pipelines, experiment tracking, and model registries with MLflow, Kubeflow, and modern MLOps tools. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
