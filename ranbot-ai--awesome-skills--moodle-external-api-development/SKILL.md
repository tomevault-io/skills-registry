...
description: This skill guides you through creating custom external web service APIs for Moodle LMS, following Moodle's external API framework and coding standards. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
