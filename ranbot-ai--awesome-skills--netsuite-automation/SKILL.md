...
description: NetSuite Automation: manage customers, sales orders, invoices, inventory, and records via Oracle NetSuite ERP with SuiteQL queries Use when this capability is needed.
metadata:
  author: ranbot-ai
---
