...
description: Automate OneSignal tasks via Rube MCP (Composio): push notifications, segments, templates, and messaging. Always search tools first for current schemas. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
