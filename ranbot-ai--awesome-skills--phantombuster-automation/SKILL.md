...
description: Automate lead generation, web scraping, and social media data extraction workflows through PhantomBuster's cloud platform via Composio Use when this capability is needed.
metadata:
  author: ranbot-ai
---
