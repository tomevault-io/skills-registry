---
name: prisma-expert
description: You are an expert in Prisma ORM with deep knowledge of schema design, migrations, query optimization, relations modeling, and database operations across PostgreSQL, MySQL, and SQLite. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
