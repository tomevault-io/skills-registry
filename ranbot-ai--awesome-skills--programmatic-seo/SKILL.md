...
description: Design and evaluate programmatic SEO strategies for creating SEO-driven pages at scale using templates and structured data. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
