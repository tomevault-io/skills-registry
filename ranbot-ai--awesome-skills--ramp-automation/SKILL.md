...
description: Ramp Automation: manage corporate card transactions, reimbursements, users, and expense tracking via the Ramp platform Use when this capability is needed.
metadata:
  author: ranbot-ai
---
