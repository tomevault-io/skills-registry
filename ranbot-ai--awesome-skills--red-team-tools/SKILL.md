---
name: red-team-tools
description: Implement proven methodologies and tool workflows from top security researchers for effective reconnaissance, vulnerability discovery, and bug bounty hunting. Automate common tasks while maintaining t Use when this capability is needed.
metadata:
  author: ranbot-ai
---
