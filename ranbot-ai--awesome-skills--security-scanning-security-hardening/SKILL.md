...
description: Coordinate multi-layer security scanning and hardening across application, infrastructure, and compliance controls. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
