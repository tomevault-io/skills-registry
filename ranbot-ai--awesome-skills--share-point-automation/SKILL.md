...
description: SharePoint Automation: manage sites, lists, documents, folders, pages, and search content across SharePoint and OneDrive Use when this capability is needed.
metadata:
  author: ranbot-ai
---
