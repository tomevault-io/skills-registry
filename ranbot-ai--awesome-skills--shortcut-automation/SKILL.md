...
description: Automate project management workflows in Shortcut -- create stories, manage tasks, track epics, and organize workflows through natural language commands. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
