...
description: Automate Snowflake data warehouse operations -- list databases, schemas, and tables, execute SQL statements, and manage data workflows via the Composio MCP integration. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
