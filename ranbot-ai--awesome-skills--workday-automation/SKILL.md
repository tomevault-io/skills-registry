...
description: Automate HR operations in Workday -- manage workers, time off requests, absence balances, and employee data through natural language commands. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
