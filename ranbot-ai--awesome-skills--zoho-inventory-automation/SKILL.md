...
description: Automate Zoho Inventory tasks via Rube MCP (Composio): items, orders, warehouses, shipments, and stock management. Always search tools first for current schemas. Use when this capability is needed.
metadata:
  author: ranbot-ai
---
