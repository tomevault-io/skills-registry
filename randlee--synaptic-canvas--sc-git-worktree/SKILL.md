...
description: This skill delegates all execution to specialized agents via the **Task tool** (no manual git commands in the primary session). Use when this capability is needed.
metadata:
  author: randlee
---
