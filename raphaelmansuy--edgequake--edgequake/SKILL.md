---
name: edgequake
description: Complete TypeScript/Next.js patterns and best practices for integrating CopilotKit. Use when this capability is needed.
metadata:
...
---
> Source: [raphaelmansuy/edgequake](https://github.com/raphaelmansuy/edgequake) — distributed by [TomeVault](https://tomevault.io).
