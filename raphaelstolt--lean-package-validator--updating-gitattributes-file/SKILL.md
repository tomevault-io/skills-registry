...
description: Update .gitattributes files for Laravel Boost projects using lean-package-validator; use when adding missing export-ignore entries or refreshing existing content. Use when this capability is needed.
metadata:
  author: raphaelstolt
---
