...
description: Build and test cudf Java bindings (cudf-java) inside a cudf devcontainer. Use when the user asks to build, compile, or test Java code in the cudf repository. Use when this capability is needed.
metadata:
  author: rapidsai
---
...
---
> Source: [rapidsai/cudf](https://github.com/rapidsai/cudf) — distributed by [TomeVault](https://tomevault.io).
