...
description: Structured self-review process for brainstorm, plan, spec, or ADR documents. Use when a document exists and needs refinement before proceeding to the next workflow step. Use when this capability is needed.
metadata:
  author: rawkode
---
