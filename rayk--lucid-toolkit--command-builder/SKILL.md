...
description: Expert guidance for creating Claude Code slash commands. Use when working with slash commands, creating custom commands, understanding command structure, or learning YAML configuration. Use when this capability is needed.
metadata:
  author: rayk
---
...
**User elicitation**: [references/user-elicitation.md](references/user-elicitation.md)
- Intelligent information gathering from users
- Natural language vs AskUserQuestion tool patterns
- Inference strategies and confidence-based presentation
- Minimize friction, maximize accuracy through smart defaults
  </reference_guides>
...
6. **Save the file**:
    - Project: `commands/command-name.md`
    - Personal: `~/commands/command-name.md`
      </generation_protocol>
