...
description: Format git commit messages following the Conventional Commits specification. Use when the user asks to format commit messages, write commits, or mentions git commits, commit conventions, or commit message standards. Use when this capability is needed.
metadata:
  author: razobeckett
---
