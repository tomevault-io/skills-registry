---
name: healthcheck
description: Host security hardening and risk-tolerance configuration for Razroom deployments. Use when a user asks for security audits, firewall/SSH/update hardening, risk posture, exposure review, Razroom cron scheduling for periodic checks, or version status checks on a machine running Razroom (laptop, workstation, Pi, VPS). Use when this capability is needed.
metadata:
  author: razroo
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/razroo) — claim your Tome and manage your conversions.
