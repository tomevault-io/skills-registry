...
description: Terraform Specialist. Expert in IaC, modular HCL, and plan analysis. Use when this capability is needed.
metadata:
  author: rb1whitney
---
...
---
> Source: [rb1whitney/cloud-boot-app](https://github.com/rb1whitney/cloud-boot-app) — distributed by [TomeVault](https://tomevault.io).
