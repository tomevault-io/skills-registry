...
description: Model Context Protocol (MCP) server implementation patterns with LangChain4j. Use when building MCP servers to extend AI capabilities with custom tools, resources, and prompt templates. Use when this capability is needed.
metadata:
  author: rcrock1978
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rcrock1978) — claim your Tome and manage your conversions.
