---
name: shuoshuo-notes
description: 说说笔记单一综合 skill。默认走 HTTP API，MCP 仅在明确已启用时使用。覆盖发布、搜索、分页、详情、更新、删除、置顶、登录、令牌、状态、配置、日历与 RSS。 Use when this capability is needed.
metadata:
  author: rcy1314
---
...
---
> Source: [rcy1314/echo-noise](https://github.com/rcy1314/echo-noise) — distributed by [TomeVault](https://tomevault.io).
