...
description: Updates or adds entries to CHANGELOG.md based on the changes in the Use when this capability is needed.
metadata:
  author: readium
---
...
---
> Source: [readium/swift-toolkit](https://github.com/readium/swift-toolkit) — distributed by [TomeVault](https://tomevault.io).
