---
name: extract
description: Run a quick extraction test against a URL or HTML file. Shows extracted fields, quality grade, and diagnostics. Use when this capability is needed.
metadata:
