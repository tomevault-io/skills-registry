...
description: Manage subscriptions and user eligibility using configuration-driven plans, the HasPlan trait, and dynamic feature checking. Use when this capability is needed.
metadata:
  author: realrashid
---
...
---
> Source: [realrashid/plan-craft](https://github.com/realrashid/plan-craft) — distributed by [TomeVault](https://tomevault.io).
