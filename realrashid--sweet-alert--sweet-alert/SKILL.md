...
description: Build and work with Sweet Alert features, including publishing assets, using the helper facade, and adding confirm-delete UI patterns. Use when this capability is needed.
metadata:
  author: realrashid
---
...
---
> Source: [realrashid/sweet-alert](https://github.com/realrashid/sweet-alert) — distributed by [TomeVault](https://tomevault.io).
