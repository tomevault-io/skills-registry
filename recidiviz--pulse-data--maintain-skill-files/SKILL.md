...
description: Proactively update SKILL.md files when they become outdated, incorrect, or need improvements. Use when you notice a skill doesn't match current workflow, when user corrects your skill usage, or when discovering better practices that should be documented. Use when this capability is needed.
metadata:
  author: recidiviz
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/recidiviz) — claim your Tome and manage your conversions.
