---
name: skill
description: Anti-detection browser automation MCP skill for OpenClaw agents with 47 tools for navigation, interaction, observation, extraction, downloads, profiles, sessions, and stealth web search. Use when this capability is needed.
metadata:
  author: redf0x1
---
...
---
> Source: [redf0x1/camofox-mcp](https://github.com/redf0x1/camofox-mcp) — distributed by [TomeVault](https://tomevault.io).
