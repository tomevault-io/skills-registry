...
description: Remove Rust-defined C symbols that are either unused or only used in C/C++ unit tests. Use this when you are refactoring a Rust FFI crate and want to remove unused symbols. Use when this capability is needed.
metadata:
  author: redisearch
---
