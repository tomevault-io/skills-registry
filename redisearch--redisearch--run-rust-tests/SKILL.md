---
name: run-rust-tests
description: Run Rust tests after making changes to verify correctness. Use this when you want to verify your changes to Rust code. Use when this capability is needed.
metadata:
  author: redisearch
---
