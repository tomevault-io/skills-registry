---
name: reedom-ghcreate-draft-pr
description: Prepare complete PR content ready for creation via reedom-gh:pr-maker agent. Use when this capability is needed.
metadata:
  author: reedom
---
