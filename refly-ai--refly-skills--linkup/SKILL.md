---
name: linkup
description: Find LinkedIn contacts with Linkup. Use when you need to: (1) search professional profiles, (2) discover LinkedIn contacts, or (3) enrich professional network data. Use when this capability is needed.
metadata:
  author: refly-ai
---
