...
description: Help users manage technical debt strategically. Use when someone is dealing with legacy code, planning refactoring work, deciding between rewrites vs. incremental fixes, trying to get buy-in for tech debt reduction, or balancing new features with maintenance. Use when this capability is needed.
metadata:
  author: refoundai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/refoundai) — claim your Tome and manage your conversions.
