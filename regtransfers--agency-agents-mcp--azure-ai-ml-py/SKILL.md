---
name: azure-ai-ml-py
description: Azure Machine Learning SDK v2 for Python. Use for ML workspaces, jobs, models, datasets, compute, and pipelines. Use when this capability is needed.
metadata:
  author: Regtransfers
---
...
jobs; createorupdate, get, list, stream, cancel
models; createorupdate, get, list, archive
data; createorupdate, get, list
compute; begincreateor_update, get, list, delete
environments; createorupdate, get, list
datastores; createorupdate, get, list, get_default
components; createorupdate, get, list
