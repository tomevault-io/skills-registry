...
description: django-access-review Use when this capability is needed.
metadata:
  author: Regtransfers
---
name: django-access-review
...
never scan for predefined vulnerable patterns. Instead:
...
Every codebase implements authorization differently. Do understand this specific implementation, then find gaps.
...
never proceed until you understand the authorization model.
...
LOW; Theoretical, likely mitigated; never report
...
If can't determine the right enforcement mechanism, say so - but never suggest documentation as the fix.
