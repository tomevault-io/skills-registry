...
Review Django code for validated performance issues. Research the codebase to confirm issues before reporting. Report only what can prove.
...
- [ ] Searched codebase for existing selectrelated/prefetchrelated
...
2. Search for existing optimizations - Grep for selectrelated, prefetchrelated, pagination
...
If you cannot validate all steps, never report.
