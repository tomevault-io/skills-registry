---
name: scikit-learn
description: Machine learning in Python with scikit-learn. Use for classification, regression, clustering, model evaluation, and ML pipelines. Use when this capability is needed.
metadata:
  author: Regtransfers
---
@ Scikit-learn
...
See: references/pipelinesandcomposition.md for comprehensive pipeline patterns.
...
File: references/pipelinesandcomposition.md
