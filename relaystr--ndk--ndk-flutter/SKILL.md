---
name: ndk-flutter
description: Flutter UI package for Nostr apps — ready-to-use widgets, account/login management, and wallet UI built on top of the ndk Dart library. Use when this capability is needed.
metadata:
  author: relaystr
---
