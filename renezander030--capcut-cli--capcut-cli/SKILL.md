---
name: capcut-edit
description: Edit CapCut / JianYing video projects — read and write subtitles, timing, speed, volume, templates, animations (fade/ken-burns), and cut long-form to shorts. Use when the user mentions capcut, jianying, subtitles, video editing, draft_content.json, draft_info.json, or cutting videos. Use when this capability is needed.
metadata:
...
---
> Source: [renezander030/capcut-cli](https://github.com/renezander030/capcut-cli) — distributed by [TomeVault](https://tomevault.io).
