...
description: Set up and run Playwright tests with Replay Browser to record test executions for debugging and performance analysis. Use when this capability is needed.
metadata:
  author: replayio
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/replayio) — claim your Tome and manage your conversions.
