---
name: food402
description: Order food from TGO Yemek (Trendyol GO), Turkey's leading food delivery service. Use when user wants to order food delivery in Turkey, browse restaurants, search for foods, manage delivery addresses, check order history, or checkout with 3D Secure payment. Use when this capability is needed.
metadata:
  author: rersozlu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rersozlu) — claim your Tome and manage your conversions.
