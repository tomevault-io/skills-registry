---
name: review-story
description: Use to perform comprehensive test architecture review with quality gate decision. Creates both story updates and detailed gate files. Use when this capability is needed.
metadata:
  author: resolve-io
---
