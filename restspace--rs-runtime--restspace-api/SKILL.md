---
name: restspace-api
description: Interact with Restspace Runtime servers. Use when you need to make HTTP requests to a Restspace instance for data, files, or other operations. Always discover services first via /.well-known/restspace/services. Use when this capability is needed.
metadata:
  author: restspace
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/restspace) — claim your Tome and manage your conversions.
