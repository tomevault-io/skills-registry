---
name: revenuecat
description: RevenueCat metrics, customer data, and documentation search. Use when querying subscription analytics, MRR, churn, customers, or RevenueCat docs. Use when this capability is needed.
metadata:
  author: revenuecat
---
