---
name: showroomblog-generate
description: This skill should be used when the user asks to "turn this lab into a blog post", "write a blog post from this module", "generate a blog from my Showroom content", "convert my workshop to a blog", "write a Red Hat Developer blog post", or "create a blog post from my demo". Use when this capability is needed.
metadata:
  author: rhpds
---
