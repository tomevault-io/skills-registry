---
name: ruv-fann
description: Fast Artificial Neural Network Library - FANN bindings for Node.js with network creation, training, and inference. Use when building neural networks with FANN, training models with backpropagation, running inference on trained networks, or integrating native FANN into Node.js pipelines. Use when this capability is needed.
metadata:
  author: ricable
---
