...
description: Check web interfaces against Vercel's design guidelines. Use when asked to "review my UI", "check accessibility", "audit design", "review UX", "check my site against best practices", or "apply Vercel design guidelines". Use when this capability is needed.
metadata:
  author: rich-harris
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rich-harris) — claim your Tome and manage your conversions.
