...
description: Documentation generation workflow covering API docs, architecture docs, README files, code comments, and technical writing. Use when this capability is needed.
metadata:
...
---
> Source: [richard-devbot/SDLC-rstack](https://github.com/richard-devbot/SDLC-rstack) — distributed by [TomeVault](https://tomevault.io).
