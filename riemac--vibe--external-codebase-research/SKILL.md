...
description: 外部代码库与文档调研技能。研究非本地工作区的第三方库、上游仓库和官方文档时使用。适用于了解第三方库 API/行为、查阅上游仓库源码、查找官方文档。 Use when this capability is needed.
metadata:
  author: riemac
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/riemac) — claim your Tome and manage your conversions.
