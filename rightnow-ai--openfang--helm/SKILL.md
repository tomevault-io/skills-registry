---
name: helm
description: Helm chart expert for Kubernetes package management, templating, and dependency management Use when this capability is needed.
metadata:
  author: RightNow-AI
---
...
---
> Source: [RightNow-AI/openfang](https://github.com/RightNow-AI/openfang) — distributed by [TomeVault](https://tomevault.io).
