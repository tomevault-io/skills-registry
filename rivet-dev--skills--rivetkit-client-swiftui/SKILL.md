...
description: RivetKit SwiftUI client guidance. Use for SwiftUI apps that connect to Rivet Actors with RivetKitSwiftUI, @Actor, rivetKit view modifiers, and SwiftUI bindings. Use when this capability is needed.
metadata:
  author: rivet-dev
---
