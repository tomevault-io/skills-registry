...
description: Adds a new publication page to the RLinf Sphinx docs (EN + ZH) and wires it into the Publications index/toctree and navbar. Use when the user asks to add a publication/paper page, convert a paper README/markdown into docs, or update the publications listing. Use when this capability is needed.
metadata:
  author: rlinf
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rlinf) — claim your Tome and manage your conversions.
