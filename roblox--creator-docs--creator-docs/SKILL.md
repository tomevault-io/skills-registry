...
description: Control the Studio Device Simulator to test UI across device form factors. Use when switching devices, testing orientations, running multi-device comparisons, or verifying UI layout via MCP tools (execute_luau + screen_capture). Use when this capability is needed.
metadata:
  author: Roblox
---
...
---
> Source: [Roblox/creator-docs](https://github.com/Roblox/creator-docs) — distributed by [TomeVault](https://tomevault.io).
