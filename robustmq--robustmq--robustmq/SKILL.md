...
description: Implements new RobustMQ MQTT connector integrations end-to-end using project conventions. Use when the user asks to add, implement, or support a new connector type such as webhook, opentsdb, clickhouse, influxdb, cassandra, mqtt bridge, or protocol-compatible targets. Use when this capability is needed.
metadata:
  author: robustmq
---
...
---
> Source: [robustmq/robustmq](https://github.com/robustmq/robustmq) — distributed by [TomeVault](https://tomevault.io).
