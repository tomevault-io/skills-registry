...
description: ActiveRecord model patterns and best practices for kw-app - validations, associations, scopes, queries, and when to keep models thin. Use when this capability is needed.
metadata:
  author: rockcodelabs
---
