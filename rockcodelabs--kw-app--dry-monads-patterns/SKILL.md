...
description: kw-app mandatory pattern for service objects using dry-monads Result monad with Success/Failure and do-notation. Replaces deprecated custom Result classes. Use when this capability is needed.
metadata:
  author: rockcodelabs
---
