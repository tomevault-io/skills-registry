...
description: Zero-downtime deployment with Kamal for kw-app (staging on Raspberry Pi ARM64, production on VPS x86_64). Covers deployment workflows, console access, and troubleshooting. Use when this capability is needed.
metadata:
  author: rockcodelabs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rockcodelabs) — claim your Tome and manage your conversions.
