...
description: Learn how to build a dynamic Flutter app using Server Side Rendering (SSR) with the rfw package, enabling UI updates driven by server logic and binary data exchange via HTTP. Use when this capability is needed.
metadata:
  author: rodydavis
---
