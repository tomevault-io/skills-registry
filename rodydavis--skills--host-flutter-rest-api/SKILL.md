...
description: Learn how to structure a Flutter project to reuse models and business logic across iOS, Android, Web, desktop platforms, and a REST API deployable to Google Cloud Run, enabling a single codebase for both client and server. Use when this capability is needed.
metadata:
  author: rodydavis
---
