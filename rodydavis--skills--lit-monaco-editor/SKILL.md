...
description: Learn how to create a Lit web component that wraps the Monaco Editor (powering VSCode) to add a fully functional code editor to your web applications. Use when this capability is needed.
metadata:
  author: rodydavis
---
