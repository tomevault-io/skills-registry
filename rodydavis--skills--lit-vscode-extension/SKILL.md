...
description: Learn how to build a VSCode extension using a Lit web component, covering setup, template creation, component implementation, and extension activation. Use when this capability is needed.
metadata:
  author: rodydavis
---
