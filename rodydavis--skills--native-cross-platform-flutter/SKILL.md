...
description: Learn how to import `dart:html` and `dart:io` in the same Flutter project to create cross-platform plugins that work seamlessly on mobile and web. Use when this capability is needed.
metadata:
  author: rodydavis
---
