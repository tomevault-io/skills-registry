...
description: Learn how to create a multi-page static site with file-based routing using TypeScript, allowing for quick updates and easy content management. Use when this capability is needed.
metadata:
  author: rodydavis
---
