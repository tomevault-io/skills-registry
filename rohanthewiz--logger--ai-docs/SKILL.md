...
description: logger is a structured error logger that integrates well with github.com/rohanthewiz/serr. logger.LogErr will write out all the context stored in the SErr. Use when this capability is needed.
metadata:
  author: rohanthewiz
---
