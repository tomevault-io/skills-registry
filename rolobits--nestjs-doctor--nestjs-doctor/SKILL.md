---
name: nestjs-doctor
description: Scan a NestJS project with nestjs-doctor, present a health report, and fix issues interactively Use when this capability is needed.
metadata:
  author: RoloBits
---
...
---
> Source: [RoloBits/nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) — distributed by [TomeVault](https://tomevault.io).
