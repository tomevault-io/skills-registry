...
description: Scaffolds a new custom Tool class for the Agent Development Kit (ADK). Use when this capability is needed.
metadata:
  author: rominirani
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rominirani) — claim your Tome and manage your conversions.
