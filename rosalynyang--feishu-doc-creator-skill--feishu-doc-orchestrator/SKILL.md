...
description: 飞书文档创建主编排技能 - 将 Markdown 文件转换为飞书文档，编排多个子技能协作完成，使用文件传递数据以节省 Token。 Use when this capability is needed.
metadata:
  author: rosalynyang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rosalynyang) — claim your Tome and manage your conversions.
