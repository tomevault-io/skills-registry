---
name: bugreport
description: Download and analyze a ConnectStats bug report. Use when user provides a bugreport ID or says "bugreport", "bug report", "look at bug", etc. Use when this capability is needed.
metadata:
  author: roznet
---
...
---
> Source: [roznet/connectstats](https://github.com/roznet/connectstats) — distributed by [TomeVault](https://tomevault.io).
