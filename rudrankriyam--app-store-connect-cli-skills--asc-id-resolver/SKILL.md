...
description: Resolve App Store Connect IDs (apps, builds, versions, groups, testers) from human-friendly names using asc. Use when commands require IDs. Use when this capability is needed.
metadata:
  author: rudrankriyam
---
