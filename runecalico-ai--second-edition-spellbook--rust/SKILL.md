---
name: rust
description: Rust systems programming expertise for Tauri desktop application backend development with memory safety and performance optimization. Use when Rust is selected as the primary language for the project. Use when writing Rust for Tauri backend development. Use when this capability is needed.
metadata:
  author: runecalico-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/runecalico-ai) — claim your Tome and manage your conversions.
