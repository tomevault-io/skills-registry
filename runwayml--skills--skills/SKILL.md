...
description: Help users embed Runway Character avatar calls in React apps using the @runwayml/avatars-react SDK Use when this capability is needed.
metadata:
  author: runwayml
---
...
---
> Source: [runwayml/skills](https://github.com/runwayml/skills) — distributed by [TomeVault](https://tomevault.io).
