...
description: Evaluate pending (unsubmitted) review comments on the current branch's PR and, after user confirmation, address each in a separate sub-agent and separate commit. Use when this capability is needed.
metadata:
  author: ryanb
---
...
---
> Source: [ryanb/dotfiles](https://github.com/ryanb/dotfiles) — distributed by [TomeVault](https://tomevault.io).
