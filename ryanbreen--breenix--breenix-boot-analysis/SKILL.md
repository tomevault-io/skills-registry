---
name: boot-analysis
description: This skill should be used when analyzing the Breenix kernel boot sequence, verifying initialization order, timing boot stages, identifying boot failures, optimizing boot time, or understanding the boot process from bootloader handoff to kernel ready state. Use when this capability is needed.
metadata:
  author: ryanbreen
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ryanbreen) — claim your Tome and manage your conversions.
