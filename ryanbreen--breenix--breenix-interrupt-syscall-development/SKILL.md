...
description: Enforce pristine interrupt/syscall paths with no logging, diagnostics, or heavy operations. Use when developing interrupt handlers, syscall entry/exit, context switches, or timer code. Use when this capability is needed.
metadata:
  author: ryanbreen
---
