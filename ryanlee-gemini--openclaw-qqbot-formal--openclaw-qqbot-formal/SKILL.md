---
name: qqbot-media
description: QQBot 富媒体收发能力。使用 <qqmedia> 标签，系统根据文件扩展名自动识别类型（图片/语音/视频/文件）。 Use when this capability is needed.
metadata:
  author: ryanlee-gemini
---
...
---
> Source: [ryanlee-gemini/openclaw-qqbot-formal](https://github.com/ryanlee-gemini/openclaw-qqbot-formal) — distributed by [TomeVault](https://tomevault.io).
