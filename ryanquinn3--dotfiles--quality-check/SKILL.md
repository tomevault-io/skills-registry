---
name: quality-check
description: Run before marking coding tasks complete - validates code quality via IDE diagnostics, code review rules, and tests with fast-feedback short-circuiting Use when this capability is needed.
metadata:
  author: ryanquinn3
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ryanquinn3) — claim your Tome and manage your conversions.
