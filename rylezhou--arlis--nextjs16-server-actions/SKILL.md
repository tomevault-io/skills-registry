...
description: Options for configuring Server Actions behavior in your Next.js application, including allowedOrigins and bodySizeLimit. Use when this capability is needed.
metadata:
  author: rylezhou
---
