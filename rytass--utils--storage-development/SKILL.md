...
description: Development guide for @rytass/storages base package (儲存基底套件開發指南). Use when creating new storage adapters (新增儲存 adapter), understanding base interfaces, or extending storage functionality. Covers StorageInterface, Storage class, file converters (檔案轉換器), hash algorithms (雜湊演算法), and implementation patterns. Use when this capability is needed.
metadata:
  author: rytass
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/rytass) — claim your Tome and manage your conversions.
