...
description: Run DuckDuckGo web searches from the terminal using `ddgr` with JSON output. Use when the task calls for lightweight web search, quick result triage, or filtering by region/time/site. Use when this capability is needed.
metadata:
  author: s-kostyaev
---
