---
name: mq
description: Query markdown files efficiently with mq CLI. Use when exploring documentation structure, extracting specific sections, or reducing token usage when reading .md files. Use when this capability is needed.
metadata:
  author: s-kostyaev
---
