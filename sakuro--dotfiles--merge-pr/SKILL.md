---
name: merge-pr
description: Safely merges GitHub pull requests using gh CLI. Use when the user wants to merge a PR, merge a pull request, or complete code review. Use when this capability is needed.
metadata:
  author: sakuro
---
