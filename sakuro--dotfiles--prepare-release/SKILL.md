...
description: Prepare a new release by triggering GitHub Actions release workflow. Invoke with /prepare-release VERSION Use when this capability is needed.
metadata:
  author: sakuro
---
