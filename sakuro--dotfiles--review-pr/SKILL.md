---
name: review-pr
description: Reviews a GitHub pull request. Use when the user wants to review a PR, get feedback on changes, or check code quality. Use when this capability is needed.
metadata:
  author: sakuro
---
