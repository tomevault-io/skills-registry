---
name: start-issue
description: Start working on a GitHub issue. Use when the user wants to work on an issue, start an issue, or begin implementation. Use when this capability is needed.
metadata:
  author: sakuro
---
