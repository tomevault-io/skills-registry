...
description: Automatically scans the TizenFX codebase on a rotating schedule to discover .NET 8 / C# 12+ refactoring targets and register them as GitHub Issues. Use when this capability is needed.
metadata:
  author: Samsung
---
...
---
> Source: [Samsung/TizenFX](https://github.com/Samsung/TizenFX) — distributed by [TomeVault](https://tomevault.io).
