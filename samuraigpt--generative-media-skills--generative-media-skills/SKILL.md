...
description: Create a high-end cinematic product video advertisement starting from a simple product photo. Use when this capability is needed.
metadata:
  author: SamurAIGPT
---
...
---
> Source: [SamurAIGPT/Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills) — distributed by [TomeVault](https://tomevault.io).
