...
description: Generate a deep, code-first project wiki and VitePress documentation site (DeepWiki-style) for a repository. Use when asked to create a complete wiki/manual for a new codebase, build a code-first documentation site, or generate a `codewiki/` folder with structured Markdown, diagrams, and navigation based on the source code (not existing docs). Use when this capability is needed.
metadata:
  author: samzong
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/samzong) — claim your Tome and manage your conversions.
