...
**Learning is too small for a skill**: Suggest creating a rule (`.claude/rules/`) instead, which is better suited for single-line or short guidelines.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sandriaas) — claim your Tome and manage your conversions.
