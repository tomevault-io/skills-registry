...
description: Expert guidance on Kotlin Coroutines and structured concurrency. Use when developers write or review async Kotlin code and need help ensuring correctness, safety, and testability of coroutine-based implementations. Use when this capability is needed.
metadata:
  author: santimattius
---
...
---
> Source: [santimattius/structured-coroutines](https://github.com/santimattius/structured-coroutines) — distributed by [TomeVault](https://tomevault.io).
