---
name: doc-sync
description: Audit AI guidance files (CLAUDE.md, copilot-instructions.md, .github/agents/, .github/prompts/) for consistency. Use after updating any AI-facing documentation. Use when this capability is needed.
metadata:
  author: SAP-samples
---
...
---
> Source: [SAP-samples/hana-hdbext-promisfied-example](https://github.com/SAP-samples/hana-hdbext-promisfied-example) — distributed by [TomeVault](https://tomevault.io).
