---
name: pdf
description: Comprehensive PDF manipulation toolkit with a MANDATORY LaTeX-first workflow for document generation. Use for (1) Generating structured PDFs via LaTeX, (2) Extracting text and tables, (3) Merging/splitting documents, and (4) Handling forms. Use when this capability is needed.
metadata:
  author: sargupta
---
