...
1. Initialize the frontend repo using `/Users/sargupta/SahayakAIV2/sahayakai/sahayakai-main/.agent/skills/web-artifacts-builder/scripts/init-artifact.sh`
2. Develop your artifact by editing the generated code
3. Bundle all code into a single HTML file using `/Users/sargupta/SahayakAIV2/sahayakai/sahayakai-main/.agent/skills/web-artifacts-builder/scripts/bundle-artifact.sh`
