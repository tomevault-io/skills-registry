---
name: customize
description: Add new capabilities or modify Gandalf behavior. Use when user wants to add channels (Telegram, Slack, email input), add integrations, modify the router, or make any other customizations. This is an interactive skill that asks questions to understand what the user wants. Use when this capability is needed.
metadata:
