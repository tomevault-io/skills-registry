---
name: writing-tests
description: Guide for writing tests using Fulcro Spec including specifications, assertions, mocking with when-mocking!, spying, and log capture. Use when writing or understanding tests in this codebase. Use when this capability is needed.
metadata:
  author: saskenuba
---
