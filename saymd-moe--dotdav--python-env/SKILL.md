---
name: python-env
description: Fast Python environment management with uv (10-100x faster than pip). Triggers on: uv, venv, pip, pyproject, python environment, install package, dependencies. Use when this capability is needed.
metadata:
  author: saymd-moe
---
