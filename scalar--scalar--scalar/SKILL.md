...
description: Minimal starter runbook for cloud agents to install dependencies, run packages, execute tests, and troubleshoot the Scalar monorepo quickly. Use when this capability is needed.
metadata:
  author: scalar
---
