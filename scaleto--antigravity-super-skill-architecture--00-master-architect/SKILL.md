...
description: Central Super-Skill that orchestrates all Skill Cells of the Conglomerate. Acts as a single entry point and intelligent router to specialized groups. Use when this capability is needed.
metadata:
  author: scaleto
---
