---
name: web-builder
description: Next.js/Reactを使用した高品質Webサイト・Webアプリを構築する。Use when: Webサイト作成、Webアプリ開発、Next.js、React、ランディングページ、ポートフォリオ、資料サイト作成時。 Use when this capability is needed.
metadata:
