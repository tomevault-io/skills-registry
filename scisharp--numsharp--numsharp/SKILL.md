---
name: np-function
description: Implement numpy np.* functions in NumSharp with full API parity. Use when adding new numpy functions, implementing np.* methods, or aligning NumSharp behavior with numpy 2.4.2. Use when this capability is needed.
metadata:
  author: SciSharp
---
...
---
> Source: [SciSharp/NumSharp](https://github.com/SciSharp/NumSharp) — distributed by [TomeVault](https://tomevault.io).
