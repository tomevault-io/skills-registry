---
name: beacon-skill
description: Agent-to-agent protocol for social coordination, crypto payments, and P2P mesh. Use when this capability is needed.
metadata:
  author: Scottcjn
---
# Beacon
...
---
> Source: [Scottcjn/beacon-skill](https://github.com/Scottcjn/beacon-skill) — distributed by [TomeVault](https://tomevault.io).
