---
name: release
description: Release the screenpipe monorepo. Bumps versions, triggers GitHub Actions for app, CLI, MCP, and JS packages. Use when this capability is needed.
metadata:
  author: screenpipe
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/screenpipe) — claim your Tome and manage your conversions.
