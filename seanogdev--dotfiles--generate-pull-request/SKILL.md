...
description: Generate a pull request using GitHub CLI following the project's PR template. Use when the user wants to open a PR, submit for review, send changes upstream, create a merge request, or says things like "PR this", "submit this", or "I'm done with this feature". Use when this capability is needed.
metadata:
  author: seanogdev
---
