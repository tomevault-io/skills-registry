---
name: jujutsu
description: LLM-specific guidance for using jujutsu. Complements commit skill with jujutsu-specific workflows: working copy model, commit commands, file tracking, non-interactive operations. Triggers: jj commands, jujutsu workflows, working copy questions, bookmark management. Use when this capability is needed.
metadata:
  author: sebnow
---
