---
name: auto-animate
description: AutoAnimate (@formkit/auto-animate) zero-config animations for React. Use for list transitions, accordions, toasts, or encountering SSR errors, animation libraries complexity. Use when this capability is needed.
metadata:
  author: secondsky
---
