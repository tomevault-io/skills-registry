---
name: better-chatbot
description: better-chatbot project conventions and standards. Use for contributing code, following three-tier tool system (MCP/Workflow/Default), or encountering server action validators, repository patterns, component design errors. Use when this capability is needed.
metadata:
  author: secondsky
---
