---
name: hono-routing
description: Type-safe Hono APIs with routing, middleware, RPC. Use for request validation, Zod/Valibot validators, or encountering middleware type inference, validation hook, RPC errors. Use when this capability is needed.
metadata:
  author: secondsky
---
