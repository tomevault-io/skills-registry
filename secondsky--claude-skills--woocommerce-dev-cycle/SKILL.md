...
description: Run tests, linting, and quality checks for WooCommerce development. Use when running tests, fixing code style, or following the development workflow in WooCommerce projects. Use when this capability is needed.
metadata:
  author: secondsky
---
