---
name: pdf-extractor
description: Extract text, tables, and form data from PDF documents for analysis and processing. Use when user asks to extract, parse, or analyze PDF files. Use when this capability is needed.
metadata:
  author: semir-labs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/semir-labs) — claim your Tome and manage your conversions.
