...
description: Comprehensive guide for building high-performance Solana programs using Pinocchio - the zero-dependency, zero-copy framework. Covers account validation, CPI patterns, optimization techniques, and migration from Anchor. Use when this capability is needed.
metadata:
  author: sendaifun
---
...
---
> Source: [sendaifun/skills](https://github.com/sendaifun/skills) — distributed by [TomeVault](https://tomevault.io).
