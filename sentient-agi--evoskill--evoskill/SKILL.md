---
name: brainstorming
description: IMMEDIATELY USE THIS SKILL before answering any task - internal design thinking that identifies the question type, selects applicable skills, and converges on the best approach before implementation Use when this capability is needed.
metadata:
  author: sentient-agi
---
...
---
> Source: [sentient-agi/EvoSkill](https://github.com/sentient-agi/EvoSkill) — distributed by [TomeVault](https://tomevault.io).
