---
name: healthcheck
description: Host security hardening and risk-tolerance configuration for NEMO deployments. Use when a user asks for security audits, firewall/SSH/update hardening, risk posture, exposure review, NEMO cron scheduling for periodic checks, or version status checks on a machine running NEMO (laptop, workstation, Pi, VPS). Use when this capability is needed.
metadata:
  author: sentientsprite
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sentientsprite) — claim your Tome and manage your conversions.
