---
name: scan
description: Scan a project with sentrux to get structural health grades (A-F) across 14 dimensions including coupling, cycles, cohesion, dead code, and test coverage. Use when the user wants to check code quality, architecture health, or before/after an agent session. Use when this capability is needed.
metadata:
  author: sentrux
---
...
---
> Source: [sentrux/sentrux](https://github.com/sentrux/sentrux) — distributed by [TomeVault](https://tomevault.io).
