...
description: Imported specialist agent skill for ai ml ops specialist. Use when requests match this domain or role. Use when this capability is needed.
metadata:
  author: seqis
---
...
## Imported Agent Spec
- Source file: `/path/to/source/.claude/agents/ai-ml-ops-specialist.md`
