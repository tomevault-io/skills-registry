...
description: API compatibility and breaking-change detection specialist. Use when this capability is needed.
metadata:
  author: seqis
---
...
## Imported Agent Spec
- Source file: `/path/to/source/.claude/agents/api-stability-sentinel.md`
