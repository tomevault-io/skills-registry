...
description: Internationalization best practices for React Router framework mode using remix-i18next. Use when setting up locales, middleware, resource routes, or language switching. Use when this capability is needed.
metadata:
  author: sergiodxa
---
...
---
> Source: [sergiodxa/agent-skills](https://github.com/sergiodxa/agent-skills) — distributed by [TomeVault](https://tomevault.io).
