...
description: Tailwind CSS patterns and conventions for frontend apps. Use when writing component styles, layouts, or working with CSS classes. Use when this capability is needed.
metadata:
  author: sergiodxa
---
