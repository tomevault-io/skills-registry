...
description: Testing best practices for the frontend. Emphasizes E2E tests over unit tests, minimal mocking, and testing behavior over implementation details. Use when writing tests or reviewing test code. Use when this capability is needed.
metadata:
  author: sergiodxa
---
