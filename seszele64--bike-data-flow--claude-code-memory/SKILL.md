...
description: Maintain Claude Code memory hygiene by auditing, organizing, updating, and optimizing memory files in `.claude/memory/`. Use when users request memory cleanup, organization, updates, or want to reduce context pollution. Handles stale content, redundancy, conflicts, and file organization issues. Use when this capability is needed.
metadata:
  author: seszele64
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/seszele64) — claim your Tome and manage your conversions.
