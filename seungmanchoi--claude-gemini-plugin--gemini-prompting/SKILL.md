...
description: Internal guidance for composing Gemini and GPT-5.4 prompts for coding, review, diagnosis, and research tasks inside the Gemini Claude Code plugin Use when this capability is needed.
metadata:
  author: seungmanchoi
---
...
Use this skill when `gemini:gemini-rescue` needs to ask Gemini or another GPT-5.4-based workflow for help.
