...
description: Transforms conversations and discussions into structured documentation pages in Notion. Captures insights, decisions, and knowledge from chat context, formats appropriately, and saves to wikis or databases with proper organization and linking. Trigger on "노션에 저장", "문서화해줘", "위키에 추가". For meeting prep use meeting-intelligence; for research reports use research-documentation; for spec breakdown use spec-to-implementation. Use when this capability is needed.
metadata:
  author: seungwonme
---
