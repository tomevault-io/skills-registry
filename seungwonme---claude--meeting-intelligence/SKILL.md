...
description: Prepares meeting materials by gathering context from Notion, enriching with Claude research, and creating both an internal pre-read and external agenda saved to Notion. Trigger on "회의 준비", "미팅 자료", "meeting prep". For saving knowledge to Notion use knowledge-capture; for research reports use research-documentation; for spec breakdown use spec-to-implementation. Use when this capability is needed.
metadata:
  author: seungwonme
---
