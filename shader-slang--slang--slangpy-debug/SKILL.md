---
name: slangpy-debug
description: Debug slangpy compatibility issues by building slangpy from source with a local Slang build. Covers cloning, building, installing, and testing slangpy against your local Slang changes. Use when this capability is needed.
metadata:
  author: shader-slang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/shader-slang) — claim your Tome and manage your conversions.
