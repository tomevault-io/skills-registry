---
name: fscan-agent
description: 使用 fscan 进行网络扫描和安全评估。当用户要求扫描网段、探测主机存活、发现开放端口、识别服务、检测漏洞或弱口令时使用。支持 NDJSON 结构化输出，适合 AI agent 管道消费。 Use when this capability is needed.
metadata:
  author: shadow1ng
---
...
---
> Source: [shadow1ng/fscan](https://github.com/shadow1ng/fscan) — distributed by [TomeVault](https://tomevault.io).
