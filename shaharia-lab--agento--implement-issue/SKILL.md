...
description: Autonomous workflow that takes a GitHub issue from triage to merged-ready PR. Fetches and validates the issue, creates a git worktree, implements the change via sub-agents, commits, pushes, monitors CI, runs PR review, fixes feedback, and promotes the PR from draft to ready. Use when this capability is needed.
metadata:
  author: shaharia-lab
---
