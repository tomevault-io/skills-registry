...
| `groups/AGENTS.md` | Global memory/persona (fallback: `groups/CLAUDE.md`) |
...
3. Document in `groups/AGENTS.md` (and keep legacy `groups/CLAUDE.md` in sync if present)
...
Persona changes -> edit `groups/AGENTS.md` (fallback: `groups/CLAUDE.md`)
Per-group behavior -> edit specific group's `AGENTS.md` (fallback: `CLAUDE.md`)
