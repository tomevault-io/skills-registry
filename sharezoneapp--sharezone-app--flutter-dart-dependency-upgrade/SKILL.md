...
description: Perform a controlled, maintenance-only upgrade of Flutter and Dart dependencies in a monorepo, including regeneration of code and localizations and reconciliation of iOS/macOS CocoaPods (notably Firebase SDK versions). Intended for manual or scheduled dependency hygiene tasks, not for routine feature development. Use when this capability is needed.
metadata:
  author: sharezoneapp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sharezoneapp) — claim your Tome and manage your conversions.
