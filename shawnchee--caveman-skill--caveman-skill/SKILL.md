---
name: caveman
description: Token-saving terse mode — no filler, no narration, just results Use when this capability is needed.
metadata:
  author: Shawnchee
---
...
---
> Source: [Shawnchee/caveman-skill](https://github.com/Shawnchee/caveman-skill) — distributed by [TomeVault](https://tomevault.io).
