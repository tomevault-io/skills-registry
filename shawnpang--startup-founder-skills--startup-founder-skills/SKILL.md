...
description: When the user wants to build personal brand, thought leadership, or IP as a founder on Twitter/X or LinkedIn. Also use when the user mentions "founder brand", "personal content", "build audience", or "grow my following". Use when this capability is needed.
metadata:
  author: shawnpang
---
...
---
> Source: [shawnpang/startup-founder-skills](https://github.com/shawnpang/startup-founder-skills) — distributed by [TomeVault](https://tomevault.io).
