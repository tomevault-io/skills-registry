---
name: claude-api
description: Build apps with the Claude API / Anthropic SDKs (TypeScript, Python, Agent SDK), choosing the right surface and language-specific patterns; not for OpenAI or other providers. USE WHEN code imports anthropic/@anthropic-ai/sdk/claude_agent_sdk or a user asks to use the Claude API or Anthropic Agent SDK. Use when this capability is needed.
metadata:
  author: Sheshiyer
---
