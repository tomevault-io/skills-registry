...
description: Idiomatic, efficient, well-structured Rust authoring — data modeling (struct/enum/newtype, ownership choices), trait & impl organization, derive/declarative/proc macros, and build-speed best practices (mold, sccache, cargo check, workspaces). USE WHEN shaping Rust data structures, organizing impls/modules, writing macros, or tuning compile times. Use when this capability is needed.
metadata:
  author: Sheshiyer
---
