---
name: rust-testing
description: Rust testing with unit and integration tests, async testing, property-based tests, mocking, and coverage under TDD. USE WHEN writing Rust tests, adding coverage to existing code, building benchmarks, or following a TDD workflow. Use when this capability is needed.
metadata:
  author: Sheshiyer
---
