...
description: Terraform & OpenTofu infrastructure-as-code best practices — module hierarchy, testing (validate/plan/frameworks), multi-environment structure, state management, and CI/CD. USE WHEN authoring, structuring, testing, or reviewing Terraform/OpenTofu configs and modules. Use when this capability is needed.
metadata:
  author: Sheshiyer
---
