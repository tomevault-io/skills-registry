...
description: Best practices for configuring Android FileProvider. Invoke when setting up file sharing, fixing exposed file uri exceptions, or configuring file_paths.xml. Use when this capability is needed.
metadata:
  author: shetiejun
---
