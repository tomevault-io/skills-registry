...
description: Best practices for implementing Android ViewModels, specifically focused on StateFlow for UI state and SharedFlow for one-off events. Use when this capability is needed.
metadata:
  author: shetiejun
---
