---
name: basekit-mvvm
description: Guide for BaseKit MVVM architecture. Invoke when implementing Activities, Fragments, ViewModels, or Adapters using BaseKit. Use when this capability is needed.
metadata:
  author: shetiejun
---
