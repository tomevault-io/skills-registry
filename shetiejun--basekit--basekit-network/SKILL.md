...
description: Complete guide for BaseKit Network module, including Coroutines support (KCHttp), error handling, HTTPS, SSE, and caching strategies. Use when this capability is needed.
metadata:
  author: shetiejun
---
