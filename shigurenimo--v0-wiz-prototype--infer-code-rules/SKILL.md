...
description: コードベースから設計パターン・規約を抽出してローカルルールに記録する。別のスキルから呼び出すか、コマンドで明示的に実行する。 Use when this capability is needed.
metadata:
  author: shigurenimo
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/shigurenimo) — claim your Tome and manage your conversions.
