...
description: Prompt engineering expert that helps users craft optimized prompts using 57 proven frameworks. Use when users want to optimize prompts, improve AI instructions, create better prompts for specific tasks, or need help selecting the best prompt framework for their use case. Use when this capability is needed.
metadata:
  author: shihan-1147
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/shihan-1147) — claim your Tome and manage your conversions.
