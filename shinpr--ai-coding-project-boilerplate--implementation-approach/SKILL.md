...
description: Selects implementation strategy (vertical slice, horizontal, or hybrid) with risk assessment. Use when planning feature implementation. Use when this capability is needed.
metadata:
  author: shinpr
---
