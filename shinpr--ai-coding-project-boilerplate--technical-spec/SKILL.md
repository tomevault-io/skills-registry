---
name: technical-spec
description: Defines environment variables, architecture design, and build/test commands. Use when configuring environment or designing architecture. Use when this capability is needed.
metadata:
  author: shinpr
---
