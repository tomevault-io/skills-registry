...
description: Technical decision criteria, anti-pattern detection, debugging techniques, and quality check workflow. Use when making technical decisions, detecting code smells, or performing quality assurance. Use when this capability is needed.
metadata:
  author: shinpr
---
