...
description: Language-agnostic coding principles for maintainability, readability, and quality. Use when implementing features, refactoring code, or reviewing code quality. Use when this capability is needed.
metadata:
  author: shinpr
---
