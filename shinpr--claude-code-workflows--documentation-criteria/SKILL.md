...
description: Documentation creation criteria including PRD, ADR, Design Doc, and Work Plan requirements with templates. Use when creating or reviewing technical documents, or determining which documents are required. Use when this capability is needed.
metadata:
  author: shinpr
---
...
---
> Source: [shinpr/claude-code-workflows](https://github.com/shinpr/claude-code-workflows) — distributed by [TomeVault](https://tomevault.io).
