...
description: Implementation strategy selection framework. Use when planning implementation strategy, selecting development approach, or defining verification criteria. Use when this capability is needed.
metadata:
  author: shinpr
---
