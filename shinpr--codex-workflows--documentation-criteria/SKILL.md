...
description: Documentation creation criteria for PRD, ADR, Design Doc, UI Spec, and Work Plan with templates. Use when: creating or reviewing technical documents, determining which documents are required, or following document templates. Use when this capability is needed.
metadata:
  author: shinpr
---
...
---
> Source: [shinpr/codex-workflows](https://github.com/shinpr/codex-workflows) — distributed by [TomeVault](https://tomevault.io).
