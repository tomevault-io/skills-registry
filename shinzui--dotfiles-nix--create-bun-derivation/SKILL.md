...
description: Create a new Bun/TypeScript derivation using bun2nix from a GitHub URL. Use when the user wants to package a JavaScript/TypeScript npm package as a Nix derivation. Use when this capability is needed.
metadata:
  author: shinzui
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/shinzui) — claim your Tome and manage your conversions.
