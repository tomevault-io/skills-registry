...
description: Create a new Rust derivation from a GitHub URL. Use when the user wants to add a new Rust package to their nix derivations. Use when this capability is needed.
metadata:
  author: shinzui
---
