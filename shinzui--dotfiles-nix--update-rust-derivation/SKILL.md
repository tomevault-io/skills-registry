...
description: Update a Rust derivation to a new version with correct hashes. Use when the user wants to update a Rust package in their nix derivations. Use when this capability is needed.
metadata:
  author: shinzui
---
