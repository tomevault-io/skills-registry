...
description: Section architecture, hero patterns, layout principles, and conversion optimization for marketing landing pages. Ensures strategic, high-converting page structure. Use when this capability is needed.
metadata:
  author: ship-studio
---
...
1. **Hero** — Hook with outcome, primary CTA
2. **Social Proof Bar** — Logos, numbers, or testimonial snippet
3. **Problem/Pain** — Acknowledge their struggle
4. **Solution/Features** — How you solve it
5. **How It Works** — Simple 3-step process
6. **Benefits** — What they gain (not what you do)
7. **Testimonials** — Full social proof section
...
1. **Size = Importance**: Largest = most important
2. **Contrast = Attention**: High contrast draws eye
3. **Spacing = Grouping**: Close things feel related
4. **Alignment = Order**: Aligned things feel intentional
...
**Option C: Carousel (use sparingly)**
Only if you have 5+ strong testimonials.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ship-studio) — claim your Tome and manage your conversions.
