---
name: btb-workflow
description: BackToBack/ByTheBooks (BTB) - An in-repo collaboration pattern for Human-AI engineering teams. Use this skill when working in repositories with a SPECS/ directory containing README.md, PROGRESS.md, and design documents. BTB emphasizes documentation-driven development, mandatory progress tracking before commits, and a feedback loop between design → MVP → implementation. Use when this capability is needed.
metadata:
  author: ships
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ships) — claim your Tome and manage your conversions.
