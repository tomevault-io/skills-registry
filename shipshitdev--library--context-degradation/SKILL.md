...
description: Recognize, diagnose, and mitigate patterns of context degradation in agent systems. Use when context grows large, agent performance degrades unexpectedly, or debugging agent failures. Use when this capability is needed.
metadata:
  author: shipshitdev
---
