...
description: Expert in error handling patterns, exception management, error responses, logging, and error recovery strategies for React, Next.js, and NestJS applications Use when this capability is needed.
metadata:
  author: shipshitdev
---
