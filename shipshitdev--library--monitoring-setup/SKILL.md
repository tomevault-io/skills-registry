...
description: Expert in setting up Sentry error tracking and Google Analytics for NestJS and Next.js applications. Use this skill when users need monitoring, error tracking, or analytics configuration. Use when this capability is needed.
metadata:
  author: shipshitdev
---
