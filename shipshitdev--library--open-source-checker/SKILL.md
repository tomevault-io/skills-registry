...
description: Expert in detecting private information, secrets, API keys, credentials, and sensitive data in codebases before open sourcing Use when this capability is needed.
metadata:
  author: shipshitdev
---
