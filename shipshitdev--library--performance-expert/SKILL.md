...
description: Expert in performance optimization for React, Next.js, NestJS applications covering frontend rendering, API response times, database queries, and infrastructure optimization Use when this capability is needed.
metadata:
  author: shipshitdev
---
