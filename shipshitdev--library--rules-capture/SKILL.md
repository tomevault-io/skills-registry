---
name: rules-capture
description: Automatically detects and documents user preferences, coding rules, and style guidelines when expressed during conversations Use when this capability is needed.
metadata:
  author: shipshitdev
---
