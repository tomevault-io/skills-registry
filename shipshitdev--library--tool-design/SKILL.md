---
name: tool-design
description: Design tools that agents can use effectively, including when to reduce tool complexity. Use when creating, optimizing, or reducing the set of tools available to an agent. Use when this capability is needed.
metadata:
  author: shipshitdev
---
