...
description: Performs code review using CodeRabbit CLI and provides actionable feedback. Use when the user requests a CodeRabbit review, wants automated code analysis, or needs pre-merge quality checks. Use when this capability is needed.
metadata:
  author: shogogg
---
