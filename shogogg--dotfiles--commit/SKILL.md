---
name: commit
description: Commits staged changes to the repository with conventional commit format. Use when the user wants to create a git commit, finalize work, or save changes with a structured commit message. Use when this capability is needed.
metadata:
  author: shogogg
---
