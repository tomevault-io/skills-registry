---
name: futu-stock
description: Access Futu stock market data via MCP server - real-time quotes, K-lines, options, account info for HK/US/CN markets Use when this capability is needed.
metadata:
  author: shuizhengqi1
---
...
---
> Source: [shuizhengqi1/futu-stock-mcp-server](https://github.com/shuizhengqi1/futu-stock-mcp-server) — distributed by [TomeVault](https://tomevault.io).
