...
description: Case study - role misconfiguration bug class applied to a yield aggregator protocol. Use as a template for applying all 10 bug classes to a single target. Use when this capability is needed.
metadata:
  author: shuvonsec
---
...
---
> Source: [shuvonsec/web3-bug-bounty-hunting-ai-skills](https://github.com/shuvonsec/web3-bug-bounty-hunting-ai-skills) — distributed by [TomeVault](https://tomevault.io).
