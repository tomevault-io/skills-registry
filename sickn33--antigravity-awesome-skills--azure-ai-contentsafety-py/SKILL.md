...
description: Azure AI Content Safety SDK for Python. Use for detecting harmful content in text and images with multi-severity classification. Use when this capability is needed.
metadata:
  author: sickn33
---
