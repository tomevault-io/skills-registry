...
description: Build table storage applications using the Azure Tables SDK for Java. Works with both Azure Table Storage and Cosmos DB Table API. Use when this capability is needed.
metadata:
  author: sickn33
---
