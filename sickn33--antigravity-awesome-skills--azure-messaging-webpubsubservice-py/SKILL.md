...
description: Azure Web PubSub Service SDK for Python. Use for real-time messaging, WebSocket connections, and pub/sub patterns. Use when this capability is needed.
metadata:
  author: sickn33
---
