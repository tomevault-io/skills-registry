...
description: Azure Monitor OpenTelemetry Exporter for Python. Use for low-level OpenTelemetry export to Application Insights. Use when this capability is needed.
metadata:
  author: sickn33
---
