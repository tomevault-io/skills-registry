...
description: Azure Queue Storage SDK for Python. Use for reliable message queuing, task distribution, and asynchronous processing. Use when this capability is needed.
metadata:
  author: sickn33
---
