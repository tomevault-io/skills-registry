---
name: biopython
description: Biopython is a comprehensive set of freely available Python tools for biological computation. It provides functionality for sequence manipulation, file I/O, database access, structural bioinformatics, phylogenetics, and many other bioinformatics tasks. Use when this capability is needed.
metadata:
  author: sickn33
---
...
---
> Source: [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) — distributed by [TomeVault](https://tomevault.io).
