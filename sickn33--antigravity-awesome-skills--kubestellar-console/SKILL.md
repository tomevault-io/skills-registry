...
description: Multi-cluster Kubernetes dashboard with AI-powered operations via MCP server and 10+ built-in agent skills Use when this capability is needed.
metadata:
  author: sickn33
---
