...
description: Generate complete Python scripts that build polished PowerPoint decks with python-pptx and real slide content. Use when this capability is needed.
metadata:
  author: sickn33
---
