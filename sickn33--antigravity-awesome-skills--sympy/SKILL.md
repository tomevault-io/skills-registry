---
name: sympy
description: SymPy is a Python library for symbolic mathematics that enables exact computation using mathematical symbols rather than numerical approximations. Use when this capability is needed.
metadata:
  author: sickn33
---
