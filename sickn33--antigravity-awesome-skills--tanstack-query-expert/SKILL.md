...
description: Expert in TanStack Query (React Query) — asynchronous state management. Covers data fetching, stale time configuration, mutations, optimistic updates, and Next.js App Router (SSR) integration. Use when this capability is needed.
metadata:
  author: sickn33
---
