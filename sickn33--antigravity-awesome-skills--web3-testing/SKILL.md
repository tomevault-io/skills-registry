---
name: web3-testing
description: Master comprehensive testing strategies for smart contracts using Hardhat, Foundry, and advanced testing patterns. Use when this capability is needed.
metadata:
  author: sickn33
---
