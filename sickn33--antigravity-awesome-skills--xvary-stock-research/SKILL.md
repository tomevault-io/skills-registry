...
description: Thesis-driven equity analysis from public SEC EDGAR and market data; /analyze, /score, /compare workflows with bundled Python tools (Claude Code, Cursor, Codex). Use when this capability is needed.
metadata:
  author: sickn33
---
