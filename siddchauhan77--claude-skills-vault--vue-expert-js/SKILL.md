...
After every output from this skill, ask: **"Rate this 1–5. What worked? What missed?"**

- **4–5** → no action needed
- **1–3** → identify the specific gap (wrong framework applied, fabricated fact, format broken, missed context) and patch the SKILL.md now, then commit to vault at `/tmp/claude-skills-vault`

This skill improves through use. Every gap caught is a permanent fix.

---
> Source: [siddchauhan77/claude-skills-vault](https://github.com/siddchauhan77/claude-skills-vault) — distributed by [TomeVault](https://tomevault.io).
