---
name: chief-wiggum
description: This skill addresses the natural accumulation of technical debt when code grows organically through many tasks without periodic review. Use when this capability is needed.
metadata:
  author: sig-id
---
| name | description |
