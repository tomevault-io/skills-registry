---
name: sightflow-agent
description: > Use when this capability is needed.
metadata:
  author: sightflow-dev
---
...
---
> Source: [sightflow-dev/sightflow-desktop-agent](https://github.com/sightflow-dev/sightflow-desktop-agent) — distributed by [TomeVault](https://tomevault.io).
