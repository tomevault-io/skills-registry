---
name: frontend-ui-ux
description: Designer-developer for UI/UX work Use when this capability is needed.
metadata:
  author: sigridjineth
---
...
```
/oh-my-codex:frontend-ui-ux <design task>
```
...
```
Task(subagent_type="oh-my-codex:designer", model="sonnet", prompt="{{ARGUMENTS}}")
```
