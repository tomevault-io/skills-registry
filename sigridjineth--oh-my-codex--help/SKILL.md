---
name: help
description: Guide on using oh-my-codex plugin Use when this capability is needed.
metadata:
  author: sigridjineth
---
...
- **README**: https://github.com/sigridjineth/oh-my-codex
- **Issues**: https://github.com/sigridjineth/oh-my-codex/issues
