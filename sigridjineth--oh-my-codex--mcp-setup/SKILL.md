...
MCP servers provide additional tools that Codex agents can use. This skill helps you configure popular MCP servers using the `claude mcp add` command-line interface.
...
- Run /oh-my-codex:doctor to diagnose issues

MANAGING MCP SERVERS:
- Add more servers: /oh-my-codex:mcp-setup or `claude mcp add ...`
