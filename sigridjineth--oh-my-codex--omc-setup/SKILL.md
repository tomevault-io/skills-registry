---
name: omc-setup
description: Setup and configure oh-my-codex (the ONLY command you need to learn) Use when this capability is needed.
metadata:
  author: sigridjineth
---
...
---
> Source: [sigridjineth/oh-my-codex](https://github.com/sigridjineth/oh-my-codex) — distributed by [TomeVault](https://tomevault.io).
