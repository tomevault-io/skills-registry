---
name: ralph-init
description: Initialize a PRD (Product Requirements Document) for structured ralph-loop execution Use when this capability is needed.
metadata:
  author: sigridjineth
---
...
```
/oh-my-codex:ralph-init "project or feature description"
```
...
3. **Link to Ralph** so that `/oh-my-codex:ralph` can use the PRD as its completion criteria
...
```
/oh-my-codex:ralph "implement the PRD"
```
