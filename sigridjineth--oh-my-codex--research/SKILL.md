...
```
/oh-my-codex:research <goal>                    # Standard research with user checkpoints
/oh-my-codex:research AUTO: <goal>              # Fully autonomous until complete
/oh-my-codex:research status                    # Check current research session status
/oh-my-codex:research resume                    # Resume interrupted research session
/oh-my-codex:research list                      # List all research sessions
/oh-my-codex:research report <session-id>       # Generate report for session
```

### Quick Examples

```
/oh-my-codex:research What are the performance characteristics of different sorting algorithms?
/oh-my-codex:research AUTO: Analyze authentication patterns in this codebase
/oh-my-codex:research How does the error handling work across the API layer?
```
...
```
/oh-my-codex:research AUTO: Comprehensive security analysis of the authentication system
...
| Command | Action |
|---------|--------|
| `/oh-my-codex:research status` | Show current session progress |
| `/oh-my-codex:research resume` | Resume most recent interrupted session |
| `/oh-my-codex:research resume <session-id>` | Resume specific session |
| `/oh-my-codex:research list` | List all sessions with status |
| `/oh-my-codex:research report <session-id>` | Generate/regenerate report |
| `/oh-my-codex:research cancel` | Cancel current session (preserves state) |
