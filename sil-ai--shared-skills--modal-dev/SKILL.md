---
name: modal-dev
description: Guidelines for developing Modal serverless cloud applications. Use when writing Modal apps, configuring GPUs and resources, creating web endpoints, or running Modal CLI commands. Covers Functions, Classes, Images, Volumes, and best practices. Use when this capability is needed.
metadata:
  author: sil-ai
---
