...
description: Q: 经过这次面试，我们认为你不适合这个岗位，决定不录用你，你自己认为，有哪些原因？ Use when this capability is needed.
metadata:
...
---
> Source: [silenceboychen/nodejs-interview](https://github.com/silenceboychen/nodejs-interview) — distributed by [TomeVault](https://tomevault.io).
