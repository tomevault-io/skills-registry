---
name: plan-design
description: Plan and design a change set. Define scope, constraints, risks, and acceptance signals before implementation. Use when this capability is needed.
metadata:
  author: sillsdev
---
