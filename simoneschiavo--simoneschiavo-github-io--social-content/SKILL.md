...
Save all social media content to `/work/social-media/[platform]/content/`:
...
└── cross-platform/
    ├── content-pillars.md
    ├── hook-library.md
    ├── repurposing-tracker.md
    └── weekly-calendar.md
```

### File Naming Convention

- **Date format:** `YYYY-MM-DD` (e.g., `2024-01-15-pricing-myths.md`)
- **Topic slug:** Lowercase, hyphenated (e.g., `cold-outreach-dead`)
- **Batch files:** Group daily tweets/short content (e.g., `2024-01-15-batch.md`)
...
**Platform:** LinkedIn
**Type:** Text post / Carousel / Thread
...
- **Hook type:** [e.g., Contrarian, Story, Value]
- **CTA:** [What action you want]
- **Link:** [If any, for comments]
- **Tags/Mentions:** [People to tag]
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/simoneschiavo) — claim your Tome and manage your conversions.
