...
description: Use when working with a guided walkthrough for SimplePDF Pro customers forking and deploying their own SimplePDF Copilot.
metadata:
  author: SimplePDF
---
# Fork and Go
...
---
> Source: [SimplePDF/simplepdf-embed](https://github.com/SimplePDF/simplepdf-embed) — distributed by [TomeVault](https://tomevault.io).
