---
name: agent-s
description: Agent-S is a powerful autonomous agent that can control your computer's graphical interface to complete complex tasks. It combines vision and action understanding to interact with any GUI element. Use when this capability is needed.
metadata:
  author: simular-ai
---
...
---
> Source: [simular-ai/Agent-S](https://github.com/simular-ai/Agent-S) — distributed by [TomeVault](https://tomevault.io).
