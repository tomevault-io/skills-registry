---
name: bank-skill
description: Traditional banking via Wise API + on-chain token swaps on Base Use when this capability is needed.
metadata:
  author: singularityhacker
---
...
---
> Source: [singularityhacker/bank-skills](https://github.com/singularityhacker/bank-skills) — distributed by [TomeVault](https://tomevault.io).
