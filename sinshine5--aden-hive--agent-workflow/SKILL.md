---
name: agent-workflow
description: Complete workflow for building, implementing, and testing goal-driven agents. Orchestrates building-agents-* and testing-agent skills. Use when starting a new agent project, unsure which skill to use, or need end-to-end guidance. Use when this capability is needed.
metadata:
  author: sinshine5
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sinshine5) — claim your Tome and manage your conversions.
