...
description: Core concepts for goal-driven agents - architecture, node types, tool discovery, and workflow overview. Use when starting agent development or need to understand agent fundamentals. Use when this capability is needed.
metadata:
  author: sinshine5
---
