---
name: claw-ed
description: This skill helps you build LLM-powered applications with Claude. Choose the right surface based on your needs, detect the project language, then read the relevant language-specific documentation. Use when this capability is needed.
metadata:
  author: SirhanMacx
---
...
---
> Source: [SirhanMacx/Claw-ED](https://github.com/SirhanMacx/Claw-ED) — distributed by [TomeVault](https://tomevault.io).
