...
description: Configure the UniFi Network MCP server for Claude Code, Codex, or OpenClaw — set controller host, credentials, and permissions Use when this capability is needed.
metadata:
  author: sirkirby
---
