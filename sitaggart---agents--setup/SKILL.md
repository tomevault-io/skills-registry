---
name: setup
description: Configure project-level settings for agent workflows. Currently a placeholder — review agent selection is handled automatically by ce:review. Use when this capability is needed.
metadata:
  author: sitaggart
---
