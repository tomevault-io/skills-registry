---
name: migrate-page
description: description: Migrate a page from legacy MVC to Angular SPA + API. Orchestrates grid, map, modal, and workflow sub-skills as needed. Use when this capability is needed.
metadata:
  author: sitkatech
---
---
