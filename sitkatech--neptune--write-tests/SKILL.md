---
name: write-tests
description: description: Create unit tests for API controllers (MSTest) or Angular components (Jasmine). Follows project testing patterns and conventions. Use when this capability is needed.
metadata:
  author: sitkatech
---
---
