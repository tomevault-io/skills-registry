...
description: Fetch all open security vulnerabilities from Dependabot (or pnpm audit as fallback) and bump every affected dependency to its patched version. Use when the user asks to fix, resolve, or address all security vulnerabilities, Dependabot alerts, or audit findings. Use when this capability is needed.
metadata:
  author: sjdemartini
---
...
---
> Source: [sjdemartini/mui-tiptap](https://github.com/sjdemartini/mui-tiptap) — distributed by [TomeVault](https://tomevault.io).
