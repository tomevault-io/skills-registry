...
description: Diagnose bug root causes and generate detailed, step-by-step TDD-based bug fix plans. Use this skill when users report bugs, unexpected behavior, or defects. This skill produces a plan but does not execute changes—pair with plan-executor for implementation. Use when this capability is needed.
metadata:
  author: sjmyuan
---
