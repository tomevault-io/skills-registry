...
### With copilot-instructions.md Rules

- **Priority**: copilot-instructions.md rules > intelligent-routing
- If copilot-instructions.md specifies explicit routing, follow it
...
Add to copilot-instructions.md temporarily:
...
**Next Steps**: Integrate this skill into copilot-instructions.md TIER 0 rules.
