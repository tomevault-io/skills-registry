...
description: Create framework components across all supported packages using the repository's anatomy/modules conventions. Use when this capability is needed.
metadata:
  author: skeletonlabs
---
...
---
> Source: [skeletonlabs/skeleton](https://github.com/skeletonlabs/skeleton) — distributed by [TomeVault](https://tomevault.io).
