---
name: screencast
description: Record agent-browser sessions to video. Use when user wants to create video demos, record browser automation, or capture agent-browser workflows. Triggers on requests involving screencasting, video recording, or visual demos of web interactions. Use when this capability is needed.
metadata:
  author: skelz0r
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/skelz0r) — claim your Tome and manage your conversions.
