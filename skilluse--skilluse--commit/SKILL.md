---
name: commit
description: Generate Conventional Commits 1.0.0 compliant messages. Use when the user says "commit", "create commit", or finishes implementing code. Use when this capability is needed.
metadata:
  author: skilluse
---
