---
name: issue
description: Create and manage local Issue specs (specs/issues/) - individual work items with testable acceptance criteria. Use for "create issue", "new task", "list issues", "check issues", "pick issue". NOTE - For GitHub issues, use `gh issue` command directly. Use when this capability is needed.
metadata:
  author: skilluse
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/skilluse) — claim your Tome and manage your conversions.
