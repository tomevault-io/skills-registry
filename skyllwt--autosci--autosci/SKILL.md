---
name: autosci
description: LaTeX compile → PDF — latexmk compile + auto-fix + page count/anonymity/font/[UNCONFIRMED] checks + submission checklist Use when this capability is needed.
metadata:
  author: skyllwt
---
...
---
> Source: [skyllwt/AutoSci](https://github.com/skyllwt/AutoSci) — distributed by [TomeVault](https://tomevault.io).
