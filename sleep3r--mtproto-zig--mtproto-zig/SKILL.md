...
description: Version-pinned Telegram client connection behavior notes for proxy compatibility debugging. Use when this capability is needed.
metadata:
  author: sleep3r
---
...
---
> Source: [sleep3r/mtproto.zig](https://github.com/sleep3r/mtproto.zig) — distributed by [TomeVault](https://tomevault.io).
