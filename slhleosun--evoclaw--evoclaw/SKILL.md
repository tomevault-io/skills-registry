---
name: evoclaw
description: > _Experience → Classification → Memory → Reflection → Proposal → Governance → SOUL Update → Log_ Use when this capability is needed.
metadata:
  author: slhleosun
---
...
---
> Source: [slhleosun/EvoClaw](https://github.com/slhleosun/EvoClaw) — distributed by [TomeVault](https://tomevault.io).
