---
name: clawhub
description: Use ClawHub CLI to search, install, update, and publish agent skills from clawhub.ai with advanced caching and compression. Use when you need to fetch new skills on the fly, sync installed skills to latest or a specific version, or publish new/updated skill folders with optimized performance. Use when this capability is needed.
metadata:
  author: snyk-labs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/snyk-labs) — claim your Tome and manage your conversions.
