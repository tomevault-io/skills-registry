---
name: d2rmh
description: ﻿| Skill Name                 | ID  | CharClass | Use when this capability is needed.
metadata:
  author: soarqin
---
﻿| Skill Name                 | ID  | CharClass |
|:---------------------------|:----|:----------|
| Attack                     | 0   |           |
| Kick                       | 1   |           |
| Throw                      | 2   |           |
...
---
> Source: [soarqin/D2RMH](https://github.com/soarqin/D2RMH) — distributed by [TomeVault](https://tomevault.io).
