---
name: sentry-issues
description: Analyse les dernières issues Sentry du projet, examine les stack traces et propose des corrections dans le code source. Use when this capability is needed.
metadata:
  author: SocialGouv
---
...
---
> Source: [SocialGouv/code-du-travail-numerique](https://github.com/SocialGouv/code-du-travail-numerique) — distributed by [TomeVault](https://tomevault.io).
