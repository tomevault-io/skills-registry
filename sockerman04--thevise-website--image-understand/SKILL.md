...
description: Implement specialized image understanding capabilities using the z-ai-web-dev-sdk. Use this skill when the user needs to analyze static images, extract visual information, perform OCR, detect objects, classify images, or understand visual content. Optimized for PNG, JPEG, GIF, WebP, and BMP formats. Use when this capability is needed.
metadata:
  author: sockerman04
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sockerman04) — claim your Tome and manage your conversions.
