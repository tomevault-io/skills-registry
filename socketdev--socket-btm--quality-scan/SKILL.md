---
name: quality-scan
description: Scans the codebase for bugs, logic errors, caching issues, and workflow problems using specialized agents. Use when preparing for release, investigating quality issues, or running pre-merge checks. Use when this capability is needed.
metadata:
  author: socketdev
---
