---
name: observer
description: Detect repeated request/skill patterns, propose new-skill opportunities, and maintain lightweight observation logs. Use for manual observation reviews, trigger-quality checks, or ongoing pattern monitoring with minimal token overhead. Use when this capability is needed.
metadata:
  author: soheunyi
---
