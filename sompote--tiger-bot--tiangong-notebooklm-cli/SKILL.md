---
name: notebooklm
description: NotebookLM CLI wrapper via `node {baseDir}/scripts/notebooklm.mjs`. Use for auth, notebooks, chat, sources, notes, sharing, research, and artifact generation/download. Use when this capability is needed.
metadata:
  author: sompote
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/sompote) — claim your Tome and manage your conversions.
