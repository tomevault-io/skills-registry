...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use this when the user asks to create, generate, or build a new skill.
metadata:
