...
description: Apply Spatie's version control conventions when creating commits, branches, pull requests, or managing Git repositories; use for naming repos, writing commit messages, choosing branch strategies, and merging code. Use when this capability is needed.
metadata:
  author: spatie
---
...
---
> Source: [spatie/guidelines-skills](https://github.com/spatie/guidelines-skills) — distributed by [TomeVault](https://tomevault.io).
