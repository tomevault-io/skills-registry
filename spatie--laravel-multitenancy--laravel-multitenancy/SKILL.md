...
description: Build and work with Spatie Laravel Multitenancy features, including tenant finders, the current tenant, switch tasks, multi-database setups, tenant-aware queues and artisan commands. Use when this capability is needed.
metadata:
  author: spatie
---
...
---
> Source: [spatie/laravel-multitenancy](https://github.com/spatie/laravel-multitenancy) — distributed by [TomeVault](https://tomevault.io).
