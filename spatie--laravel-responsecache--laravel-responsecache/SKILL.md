...
description: Cache entire HTTP responses using spatie/laravel-responsecache, including standard caching, flexible (stale-while-revalidate) caching, cache profiles, replacers, and selective cache clearing. Use when this capability is needed.
metadata:
  author: spatie
---
...
---
> Source: [spatie/laravel-responsecache](https://github.com/spatie/laravel-responsecache) — distributed by [TomeVault](https://tomevault.io).
