---
name: ray
description: Teaches how to interact with the Ray application. This skill should be used when users want to interact with Ray through a coding agent or LLM with skills capabilities. Use when this capability is needed.
metadata:
  author: spatie
---
