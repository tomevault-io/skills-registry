...
description: Track all URLs fetched during SpecStory AI coding sessions. Run when user says "show my link trail", "what URLs did I visit", "list fetched links", or "show web fetches". Use when this capability is needed.
metadata:
  author: specstoryai
---
