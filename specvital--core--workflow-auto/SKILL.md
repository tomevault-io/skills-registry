---
name: workflow-auto
description: Execute workflow-analyze → workflow-plan → workflow-execute → commit in sequence without intermediate approval (single commit) Use when this capability is needed.
metadata:
  author: specvital
---
