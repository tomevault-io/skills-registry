...
description: Generate business rule documentation from domain knowledge and requirements. Use when documenting complex business logic. Use when this capability is needed.
metadata:
  author: specvital
---
