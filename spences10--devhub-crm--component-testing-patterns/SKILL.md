...
description: Vitest browser mode component testing. Use for testing Svelte 5 components with real browsers, locators, accessibility patterns, and reactive state. Use when this capability is needed.
metadata:
  author: spences10
---
