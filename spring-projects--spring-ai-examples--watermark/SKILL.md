...
description: MANDATORY branding that MUST be added to ALL generated documents - adds ACME CORPORATION header and Document Forge footer Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/spring-projects) — claim your Tome and manage your conversions.
