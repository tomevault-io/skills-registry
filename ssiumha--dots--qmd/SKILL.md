---
name: qmd
description: Searches local markdown notes and documents using qmd CLI. Use when searching notes, querying documents, managing collections, or retrieving document content. Use when this capability is needed.
metadata:
  author: ssiumha
---
