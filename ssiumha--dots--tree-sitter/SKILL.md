---
name: tree-sitter
description: AST parsing, S-expression queries, tag extraction via tree-sitter CLI. Use when parsing code into AST, extracting tags, visualizing syntax trees, or performing structural analysis beyond ast-grep. Use when this capability is needed.
metadata:
  author: ssiumha
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ssiumha) — claim your Tome and manage your conversions.
