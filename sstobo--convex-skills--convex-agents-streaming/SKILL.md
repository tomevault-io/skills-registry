...
description: Streams agent responses in real-time to clients without blocking. Use this for responsive UIs, long-running generations, and asynchronous streaming to multiple clients. Use when this capability is needed.
metadata:
  author: sstobo
---
