...
description: Tracks LLM token consumption and usage metrics for billing, monitoring, and optimization. Use this to log token usage, calculate costs, generate invoices, and understand which agents or users consume the most resources. Use when this capability is needed.
metadata:
  author: sstobo
---
