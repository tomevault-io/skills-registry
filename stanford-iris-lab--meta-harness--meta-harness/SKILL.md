...
description: Run one iteration of AgentHarness evolution for Terminal-Bench 2. Use when this capability is needed.
metadata:
...
---
> Source: [stanford-iris-lab/meta-harness](https://github.com/stanford-iris-lab/meta-harness) — distributed by [TomeVault](https://tomevault.io).
