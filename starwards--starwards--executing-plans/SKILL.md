...
description: Structured approach for implementing architect-provided plans through controlled batch execution with review checkpoints - execute in batches (default 3 tasks), verify each step, stop on blockers; don't force through blockers Use when this capability is needed.
metadata:
  author: starwards
---
