...
description: npm workspace monorepo workflow for Starwards - build order, module dependencies, watch mode, testing across modules, and avoiding common monorepo pitfalls; core builds first always Use when this capability is needed.
metadata:
  author: starwards
---
