---
name: init
description: Initialize a project for AI-assisted development. Generates AGENTS.md (universal AI guide) through systematic codebase analysis. Use when setting up a new project or when no AI guidance files exist yet. Use when this capability is needed.
metadata:
