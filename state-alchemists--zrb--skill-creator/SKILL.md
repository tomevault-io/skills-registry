---
name: skill-creator
description: Interactive guide for building new Agent Skills. Use when asked to create a skill, command, or automated workflow. Use when this capability is needed.
metadata:
