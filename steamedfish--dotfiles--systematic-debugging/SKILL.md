...
- Verify changes match intention
- Check for unintended modifications
- Look for debugging code left behind
...
**When asking:**
1. Summarize what you investigated
2. List what you tried and results
3. State what you don't understand
4. Propose what you think should happen next (if any hypothesis)

**Don't ask for help:**
- Before trying Phase 1 investigation yourself
- Without documenting what you already tried
- For simple issues answerable by reading docs/code
- Because you're impatient (systematic process is faster than asking prematurely)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/steamedfish) — claim your Tome and manage your conversions.
