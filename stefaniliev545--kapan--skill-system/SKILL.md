---
name: skill-system
description: Load when you struggled with something docs would have helped, when you're about to move on from a complex area you now understand, or when managing skills Use when this capability is needed.
metadata:
