...
description: Native macOS/iOS app performance profiling via xctrace/Time Profiler and CLI-only analysis of Instruments traces. Use when asked to profile, attach, record, or analyze Instruments .trace files, find hotspots, or optimize native app performance without opening Instruments UI. Use when this capability is needed.
metadata:
  author: steipete
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/steipete) — claim your Tome and manage your conversions.
