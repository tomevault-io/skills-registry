---
name: commit-message
description: Generate a conventional commit message from staged git changes. Use this skill when the user wants to create a commit message for their staged changes. Use when this capability is needed.
metadata:
  author: stephanvs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/stephanvs) — claim your Tome and manage your conversions.
