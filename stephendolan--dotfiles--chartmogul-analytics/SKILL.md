...
description: Guide revenue analysis using ChartMogul reports. Use when discussing MRR, ARR, churn, retention, cohorts, or subscription metrics. Helps select the right report and interpret results. Use when this capability is needed.
metadata:
  author: stephendolan
---
