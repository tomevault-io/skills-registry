---
name: commit
description: Commit changes, save work, create git commit. Use when done coding, ready to commit, need to save progress, or "commit this". Creates conventional commit messages focused on why, not what. Use when this capability is needed.
metadata:
  author: stephendolan
---
