---
name: create-pr
description: Create PR, open pull request, submit for review, push branch. Use when code is ready for review, need to create PR, or "make a PR". Creates concise descriptions focused on the problem being solved. Use when this capability is needed.
metadata:
  author: stephendolan
---
