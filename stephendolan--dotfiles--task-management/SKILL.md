...
description: Manage personal tasks using OmniFocus via the `of` CLI. Use when discussing tasks, projects, inbox processing, GTD workflow, or adding/organizing to-dos. Use when this capability is needed.
metadata:
  author: stephendolan
---
