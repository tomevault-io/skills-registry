...
description: Create effective Agent Skills following the agentskills.io specification. Use when creating new skills, reviewing existing skills, or improving skill descriptions. Use when this capability is needed.
metadata:
  author: stephendolan
---
