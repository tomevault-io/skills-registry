---
name: code-review
description: Pre-PR code review with multi-agent parallel analysis. Use when user says 'code review', 'review this code', 'review my changes', 'check for bugs', or before creating a PR. Use when this capability is needed.
metadata:
  author: steveclarke
---
