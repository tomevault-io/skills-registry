---
name: add-screen
description: Guide for adding a new screen to the All About Olaf React Native app, including React Navigation setup, TypeScript types, component creation, and proper integration with the app's navigation system. Use when this capability is needed.
metadata:
  author: stodevx
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/stodevx) — claim your Tome and manage your conversions.
