---
name: dbx-regenerate
description: Regenerate DBX code after making changes to .dbx schema files. Runs code generation, shows diff summary, validates compilation, and reports any errors. Use when this capability is needed.
metadata:
  author: storj
---
