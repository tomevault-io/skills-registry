---
name: woop
description: Guide users through the WOOP goal-setting framework (Wish, Outcome, Obstacle, Plan) by Gabriele Oettingen. Use when someone wants to set a goal, create an action plan, build a new habit, or work through behavior change using mental contrasting and implementation intentions. Use when this capability is needed.
metadata:
  author: strager
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/strager) — claim your Tome and manage your conversions.
