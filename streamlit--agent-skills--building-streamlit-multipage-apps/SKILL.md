...
description: Building multi-page Streamlit apps. Use when creating apps with multiple pages, setting up navigation, or managing state across pages. Use when this capability is needed.
metadata:
  author: streamlit
---
