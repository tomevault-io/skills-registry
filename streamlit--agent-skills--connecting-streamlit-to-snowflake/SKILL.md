...
description: Connecting Streamlit apps to Snowflake. Use when setting up database connections, managing secrets, or querying Snowflake from a Streamlit app. Use when this capability is needed.
metadata:
  author: streamlit
---
