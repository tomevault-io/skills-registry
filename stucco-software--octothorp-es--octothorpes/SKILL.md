---
name: octothorpes
description: Develop and integrate with the Octothorpes Protocol, otherwise known as OP. This is a javascript based project. Triggers include "Let's work on OP", "Here's an OP issue," mentions of OP, octothorpes, MultiPass, Blobjects, harmonizers, SPARQL queries, thorped/linked/backlinked endpoints, or writing tests for this project. Use when this capability is needed.
metadata:
  author: stucco-software
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/stucco-software) — claim your Tome and manage your conversions.
