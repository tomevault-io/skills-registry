---
name: eui-neo
description: Use this skill when porting a highly customized web/CSS component into `components/workshop/`.
metadata:
  author: sudoevolve
---
...
---
> Source: [sudoevolve/EUI-NEO](https://github.com/sudoevolve/EUI-NEO) — distributed by [TomeVault](https://tomevault.io).
