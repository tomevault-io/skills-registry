---
name: better-auth
description: description: Better Auth integration using shared secret for JWT tokens between Next.js frontend and FastAPI backend for Phase 2 Todo application. Simpler approach using HS256 algorithm with shared BETTER_AUTH_SECRET. Use when this capability is needed.
metadata:
