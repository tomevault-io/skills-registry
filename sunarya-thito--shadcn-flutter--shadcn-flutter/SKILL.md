---
name: shadcn-flutter
description: Use when working with a comprehensive UI ecosystem for Flutter built on the shadcn/ui design system.
metadata:
...
---
> Source: [sunarya-thito/shadcn_flutter](https://github.com/sunarya-thito/shadcn_flutter) — distributed by [TomeVault](https://tomevault.io).
