---
name: canva
description: Create, export, and manage Canva designs via the Connect API. Generate social posts, carousels, and graphics programmatically. Use when this capability is needed.
metadata:
  author: sundial-org
---
