---
name: chromecast
description: Control Chromecast devices on your local network - discover, cast media, control playback, manage queues, and save/restore states Use when this capability is needed.
metadata:
  author: sundial-org
---
