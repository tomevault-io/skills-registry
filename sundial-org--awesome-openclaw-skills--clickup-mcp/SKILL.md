---
name: clickup-mcp
description: Manage ClickUp tasks, docs, time tracking, comments, chat, and search via official MCP. OAuth authentication required. Use when this capability is needed.
metadata:
  author: sundial-org
---
