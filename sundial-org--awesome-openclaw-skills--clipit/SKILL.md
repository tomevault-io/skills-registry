---
name: clipit
description: Use when working with the master tool for all advanced audio/video processing. Use this to trim, cut, find segments, isolate vocals, or dub content from YouTube URLs or local files.
metadata:
  author: sundial-org
---
