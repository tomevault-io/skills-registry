---
name: ddg-search
description: Perform web searches using DuckDuckGo. Use when web search is needed and no API key is available or Brave Search is not preferred. Use when this capability is needed.
metadata:
  author: sundial-org
---
