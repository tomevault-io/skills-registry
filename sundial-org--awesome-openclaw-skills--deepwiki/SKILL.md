---
name: deepwiki
description: Query the DeepWiki MCP server for GitHub repository documentation, wiki structure, and AI-powered questions. Use when this capability is needed.
metadata:
  author: sundial-org
---
