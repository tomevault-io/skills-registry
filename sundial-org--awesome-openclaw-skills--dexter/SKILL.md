---
name: dexter
description: Autonomous financial research agent for stock analysis, financial statements, metrics, prices, SEC filings, and crypto data. Use when this capability is needed.
metadata:
  author: sundial-org
---
