---
name: exa
description: Neural web search and code context via Exa AI API. Requires EXA_API_KEY. Use for finding documentation, code examples, research papers, or company info. Use when this capability is needed.
metadata:
  author: sundial-org
---
