---
name: gamma-2
description: Create presentations, documents, social posts, and websites using Gamma's AI API. Use when asked to create slides, presentations, decks, documents, or web content via Gamma. Use when this capability is needed.
metadata:
  author: sundial-org
---
