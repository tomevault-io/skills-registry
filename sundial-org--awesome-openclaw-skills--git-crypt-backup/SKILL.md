...
description: Backup Clawdbot workspace and config to GitHub with git-crypt encryption. Use for daily automated backups or manual backup/restore operations. Use when this capability is needed.
metadata:
  author: sundial-org
---
