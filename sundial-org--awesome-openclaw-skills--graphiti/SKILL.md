---
name: graphiti
description: Knowledge graph operations via Graphiti API. Search facts, add episodes, and extract entities/relationships. Use when this capability is needed.
metadata:
  author: sundial-org
---
