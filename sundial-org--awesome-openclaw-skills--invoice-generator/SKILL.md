...
description: Generate professional PDF invoices from JSON data. Use when the user needs to create an invoice, billing document, or payment request with company/client details and line items. Use when this capability is needed.
metadata:
  author: sundial-org
---
