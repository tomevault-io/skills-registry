---
name: jina-reader
description: Web content extraction via Jina AI Reader API. Three modes: read (URL to markdown), search (web search + full content), ground (fact-checking). Extracts clean content without exposing server IP. Use when this capability is needed.
metadata:
  author: sundial-org
---
