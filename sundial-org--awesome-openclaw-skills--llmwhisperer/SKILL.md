---
name: llmwhisperer
description: Extract text and layout from images and PDFs using LLMWhisperer API. Good for handwriting and complex forms. Use when this capability is needed.
metadata:
  author: sundial-org
---
