---
name: nb
description: Manage notes, bookmarks, and notebooks using the nb CLI. Create, list, search, and organize notes across multiple notebooks with Git-backed versioning. Use when this capability is needed.
metadata:
  author: sundial-org
---
