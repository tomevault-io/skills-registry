---
name: openssl
description: Generate secure random strings, passwords, and cryptographic tokens using OpenSSL. Use when creating passwords, API keys, secrets, or any secure random data. Use when this capability is needed.
metadata:
  author: sundial-org
---
