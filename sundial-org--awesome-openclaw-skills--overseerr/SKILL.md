---
name: overseerr
description: Request movies/TV and monitor request status via the Overseerr API (stable Overseerr, not the beta Seerr rewrite). Use when this capability is needed.
metadata:
  author: sundial-org
---
