---
name: parallel
description: High-accuracy web search and research via Parallel.ai API. Optimized for AI agents with rich excerpts and citations. Use when this capability is needed.
metadata:
  author: sundial-org
---
