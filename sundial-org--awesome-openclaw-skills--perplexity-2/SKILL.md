---
name: perplexity-2
description: Deep search via Perplexity API. Three modes: search (quick facts), reason (complex analysis), research (in-depth reports). Returns AI-grounded answers with citations. Use when this capability is needed.
metadata:
  author: sundial-org
---
