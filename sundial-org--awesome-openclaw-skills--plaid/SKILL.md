---
name: plaid
description: plaid-cli a cli for interacting with the plaid finance platform. link accounts from various institutions, query balances, and transactions by date range listing accounts/balances. Use when this capability is needed.
metadata:
  author: sundial-org
---
