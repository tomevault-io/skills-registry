---
name: searxng-3
description: Search the web using a self-hosted SearXNG instance. Privacy-respecting metasearch that aggregates results from multiple engines. Use when this capability is needed.
metadata:
  author: sundial-org
---
