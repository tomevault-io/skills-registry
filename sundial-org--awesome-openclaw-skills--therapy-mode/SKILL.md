---
name: therapy-mode
description: Comprehensive AI-assisted therapeutic support framework with CBT, ACT, DBT, MI, session notes CLI, and crisis protocols. Use when this capability is needed.
metadata:
  author: sundial-org
---
