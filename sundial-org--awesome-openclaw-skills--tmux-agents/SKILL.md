---
name: tmux-agents
description: Manage background coding agents in tmux sessions. Spawn Claude Code or other agents, check progress, get results. Use when this capability is needed.
metadata:
  author: sundial-org
---
