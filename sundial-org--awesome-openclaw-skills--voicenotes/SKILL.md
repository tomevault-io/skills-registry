---
name: voicenotes
description: Sync and access voice notes from Voicenotes.com. Use when the user wants to retrieve their voice recordings, transcripts, and AI summaries from Voicenotes. Supports fetching notes, syncing to markdown, and searching transcripts. Use when this capability is needed.
metadata:
  author: sundial-org
---
