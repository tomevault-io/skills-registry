---
name: weathercli
description: Get current weather conditions and forecasts for any location worldwide. Returns structured data with temperature, humidity, wind, precipitation, and more. No API key required. Use when this capability is needed.
metadata:
  author: sundial-org
---
