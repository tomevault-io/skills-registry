---
name: web-qa-bot
description: AI-powered web application QA automation using accessibility-tree based testing. Smoke tests, test suites, and PDF reports. Use when this capability is needed.
metadata:
  author: sundial-org
---
