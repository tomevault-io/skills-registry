---
name: webhook-gen
description: Generate webhook handlers with retry logic using AI. Use when integrating Stripe, GitHub, or any webhook provider. Use when this capability is needed.
metadata:
  author: sundial-org
---
