...
description: Skill to ensure all messages sent to WhatsApp follow the platform's specific formatting syntax. It prevents markdown bloat and ensures a clean, mobile-first reading experience. Use when this capability is needed.
metadata:
  author: sundial-org
---
