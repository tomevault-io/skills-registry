...
description: Free local speech-to-text for Telegram and WhatsApp using MLX Whisper on Apple Silicon. Private, no API costs. Use when this capability is needed.
metadata:
  author: sundial-org
---
