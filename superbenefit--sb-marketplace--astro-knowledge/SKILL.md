...
description: API documentation and reference provider for Astro/Starlight. Provides on-demand documentation lookup, API verification, and feature availability checks. Use when this capability is needed.
metadata:
  author: superbenefit
---
