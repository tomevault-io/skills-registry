...
description: FastAPI OpenTelemetry style: native FastAPIInstrumentor, centralized observability init, Python decorators, OTLP logs, and LLM cost metrics. Use when this capability is needed.
metadata:
  author: superloglabs
---
...
---
> Source: [superloglabs/skills](https://github.com/superloglabs/skills) — distributed by [TomeVault](https://tomevault.io).
