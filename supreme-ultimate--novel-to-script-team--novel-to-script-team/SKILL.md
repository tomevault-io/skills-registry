...
description: 导演自审技能。用于审核阶段一导演分析产出（讲戏本、人物清单、场景清单），通过逐行比对、脑内预演和评分制确保讲戏质量达标。 Use when this capability is needed.
metadata:
  author: Supreme-Ultimate
---
