...
description: GraphQL code generation and integration patterns across API, web, and native apps. Use this skill when setting up GraphQL operations, configuring code generation, or integrating GraphQL queries and mutations. Use when this capability is needed.
metadata:
  author: survikrowa
---
