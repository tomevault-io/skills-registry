...
description: React admin panel using Vite, TanStack Router, TanStack Query, and Tailwind CSS. Use this skill when working with the web admin interface in apps/web, creating admin features, forms, or data tables. Use when this capability is needed.
metadata:
  author: survikrowa
---
