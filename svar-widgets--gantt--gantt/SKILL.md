---
name: gantt
description: Use when building, configuring, styling, or modifying SVAR Svelte Gantt / @wx/svelte-gantt timelines, grids, task editors, toolbars, context menus, tooltips, scales, links, and Gantt data actions.
metadata:
  author: svar-widgets
---
...
---
> Source: [svar-widgets/gantt](https://github.com/svar-widgets/gantt) — distributed by [TomeVault](https://tomevault.io).
