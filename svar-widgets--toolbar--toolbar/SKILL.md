---
name: toolbar
description: Use when UI of app requires Toolbar, configuring, or modifying SVAR Svelte Toolbar / @wx/svelte-toolbar components
metadata:
  author: svar-widgets
---
...
---
> Source: [svar-widgets/toolbar](https://github.com/svar-widgets/toolbar) — distributed by [TomeVault](https://tomevault.io).
