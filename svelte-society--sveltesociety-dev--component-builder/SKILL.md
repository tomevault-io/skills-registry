...
description: Create UI components using tailwind-variants for type-safe styling. Use when creating or editing components in src/lib/ui/. Use when this capability is needed.
metadata:
