...
description: Fetches additional perspectives from OpenAI Codex and Google Gemini for architecture, review, and debugging. Transparently displays all LLM calls. Use when this capability is needed.
metadata:
  author: svenja-dev
---
