...
description: Release a new version of SVUnit. Use when: cutting a release, bumping the version number, tagging a release, publishing a new version. Covers the full release workflow: pre-release PR, GitHub Web UI steps, and post-release PR. Use when this capability is needed.
metadata:
  author: svunit
---
...
---
> Source: [svunit/svunit](https://github.com/svunit/svunit) — distributed by [TomeVault](https://tomevault.io).
