...
description: Professional rules for AI-driven data modeling and creation. Use this skill when users need to create and manage MySQL databases, design data models using Mermaid ER diagrams, and implement database schemas. Use when this capability is needed.
metadata:
  author: sycsky
---
