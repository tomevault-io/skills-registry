...
description: This skill helps create and configure stdio Model Context Protocol (MCP) server connections for OpenAI Agents SDK. Use when this capability is needed.
metadata:
