...
description: Instructs AI agents on documentation standards for design docs, folder READMEs, source code interfaces, and test cases Use when this capability is needed.
metadata:
