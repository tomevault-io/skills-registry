---
name: predictclaw
description: Predict.fun skill with a PolyClaw-style CLI for markets, wallet funding, trading, positions, and hedging. Use when this capability is needed.
metadata:
  author: tabilabs
---
...
---
> Source: [tabilabs/mandated-vault-factory](https://github.com/tabilabs/mandated-vault-factory) — distributed by [TomeVault](https://tomevault.io).
