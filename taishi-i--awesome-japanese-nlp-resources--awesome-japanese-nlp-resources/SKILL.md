...
description: Find Japanese NLP GitHub repositories and Hugging Face models/datasets that are NOT yet in awesome-japanese-nlp-resources. Suggests candidates to add for a given topic using WebSearch + WebFetch, then outputs contribution-ready markdown. Use when this capability is needed.
metadata:
  author: taishi-i
---
...
---
> Source: [taishi-i/awesome-japanese-nlp-resources](https://github.com/taishi-i/awesome-japanese-nlp-resources) — distributed by [TomeVault](https://tomevault.io).
