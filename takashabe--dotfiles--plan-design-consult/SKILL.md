...
description: Create or refine implementation plan files while consulting on design policy. Use when a user wants a plan drafted, then wants to identify design decision points, evaluate options, and finalize decisions before handoff to another session. Use when this capability is needed.
metadata:
  author: takashabe
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/takashabe) — claim your Tome and manage your conversions.
