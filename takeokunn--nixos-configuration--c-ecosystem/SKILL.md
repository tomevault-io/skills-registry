---
name: c-ecosystem
description: This skill should be used when working with C projects, "C11", "C17", "C23", "Makefile", "gcc", "clang", "valgrind", "getopt", or C language patterns. Provides comprehensive C23 and modern C patterns, memory management, and CLI development best practices. Use when this capability is needed.
metadata:
  author: takeokunn
---
