---
name: nix-ecosystem
description: This skill should be used when the user asks to "write nix", "nix expression", "flake.nix", "home-manager config", "programs.*", "services.*", "nixpkgs packaging", "buildGoModule", "buildRustPackage", or works with Nix language, flakes, or Home Manager. Provides comprehensive Nix ecosystem patterns and best practices. Use when this capability is needed.
metadata:
  author: takeokunn
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/takeokunn) — claim your Tome and manage your conversions.
