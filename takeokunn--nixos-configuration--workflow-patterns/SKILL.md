...
description: Patterns for output formats, reflection checkpoints, agent references, and self-evaluation shared across agents and commands. Use when this capability is needed.
metadata:
  author: takeokunn
---
