...
description: Install, upgrade, and configure the takielias/tablar starter kit — composer require, tablar:install, layout selection, post-install patches (SoftDeletes on User, base Controller class for L11+), and recovery from common install failures. Use when this capability is needed.
metadata:
  author: takielias
---
...
---
> Source: [takielias/tablar](https://github.com/takielias/tablar) — distributed by [TomeVault](https://tomevault.io).
