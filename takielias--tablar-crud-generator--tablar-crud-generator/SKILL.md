...
description: Scaffold a CRUD resource with takielias/tablar-crud-generator — make:crud {table} command (table-name argument, --route/--crud-name/--lang flags), what gets generated (Model, Controller, Views, Route), DB-schema-driven field inference, stub customization, regeneration strategy. Use when this capability is needed.
metadata:
  author: takielias
---
...
---
> Source: [takielias/tablar-crud-generator](https://github.com/takielias/tablar-crud-generator) — distributed by [TomeVault](https://tomevault.io).
