---
name: neta-adventure
description: Neta 奇遇剧本技能 - 创建和游玩 AI 驱动的交互式故事冒险。奇遇模式提供故事创作和故事讲述两种模式，Agent 作为 DM 并扮演角色，遵循剧情、规则和特殊指南。 Use when this capability is needed.
metadata:
  author: talesofai
---
...
---
> Source: [talesofai/neta-skills](https://github.com/talesofai/neta-skills) — distributed by [TomeVault](https://tomevault.io).
