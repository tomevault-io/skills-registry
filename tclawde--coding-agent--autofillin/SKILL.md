---
name: autofillin
description: Automated web form filling and file uploading skill with Playwright browser automation. Handles login persistence, form detection, file uploads, and waits for manual confirmation before submission. Use when this capability is needed.
metadata:
  author: tclawde
---
