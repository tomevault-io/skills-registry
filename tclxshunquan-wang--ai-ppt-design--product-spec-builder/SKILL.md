...
description: 当用户表达想要开发产品、应用、工具或任何软件项目时，使用此技能。通过深入对话收集需求，用直白的追问帮助用户想清楚，最终生成一份可直接用于 Google AI Studio Builder 的 Product Spec 文档（.md 文件）。 Use when this capability is needed.
metadata:
