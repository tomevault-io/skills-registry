---
name: telnyx-network
description: Private mesh networking and public IP exposure via Telnyx WireGuard infrastructure. Connect nodes securely or expose services to the internet. Use when this capability is needed.
metadata:
  author: team-telnyx
---
