---
name: telnyx-stt
description: Transcribe audio files to text using Telnyx Speech-to-Text API. Use when you need to convert audio recordings, voice messages, or spoken content to text. Use when this capability is needed.
metadata:
  author: team-telnyx
---
