---
name: bit-cli
description: MUST consult before running ANY bit command. Do NOT guess bit commands from memory. This skill tells you the right command, correct syntax, subcommands, and flags. Use when this capability is needed.
metadata:
  author: teambit
---
