...
> Based on Vite 8 beta (Rolldown-powered). Vite 8 uses Rolldown bundler and Oxc
> transformer.

Vite is a next-generation frontend build tool with fast dev server (native ESM +
HMR) and optimized production builds.
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tearingitup786) — claim your Tome and manage your conversions.
