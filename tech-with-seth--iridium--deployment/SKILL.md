---
name: deployment
description: This skill should be used when the user wants to manage Railway deployments, view logs, or debug issues. Covers deployment lifecycle (remove, stop, redeploy, restart), deployment visibility (list, status, history), and troubleshooting (logs, errors, failures, crashes, why deploy failed). NOT for deleting services - use environment skill with isDeleted for that. Use when this capability is needed.
metadata:
  author: tech-with-seth
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tech-with-seth) — claim your Tome and manage your conversions.
