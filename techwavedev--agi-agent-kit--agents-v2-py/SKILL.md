---
name: agents-v2-py
description: Build container-based Foundry Agents with Azure AI Projects SDK (ImageBasedHostedAgentDefinition). Use when creating hosted agents with custom container images in Azure AI Foundry. Use when this capability is needed.
metadata:
  author: techwavedev
---
