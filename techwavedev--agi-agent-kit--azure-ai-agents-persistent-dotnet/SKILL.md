...
description: Azure AI Agents Persistent SDK for .NET. Low-level SDK for creating and managing AI agents with threads, messages, runs, and tools. Use when this capability is needed.
metadata:
  author: techwavedev
---
