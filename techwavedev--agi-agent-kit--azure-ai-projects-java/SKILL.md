...
description: Azure AI Projects SDK for Java. High-level SDK for Azure AI Foundry project management including connections, datasets, indexes, and evaluations. Use when this capability is needed.
metadata:
  author: techwavedev
---
