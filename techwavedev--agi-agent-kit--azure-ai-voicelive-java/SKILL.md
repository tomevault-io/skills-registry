...
description: Azure AI VoiceLive SDK for Java. Real-time bidirectional voice conversations with AI assistants using WebSocket. Use when this capability is needed.
metadata:
  author: techwavedev
---
