...
description: Azure App Configuration SDK for Python. Use for centralized configuration management, feature flags, and dynamic settings. Use when this capability is needed.
metadata:
  author: techwavedev
---
