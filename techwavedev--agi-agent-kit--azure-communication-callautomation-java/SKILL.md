...
description: Build call automation workflows with Azure Communication Services Call Automation Java SDK. Use when implementing IVR systems, call routing, call recording, DTMF recognition, text-to-speech, or AI-... Use when this capability is needed.
metadata:
  author: techwavedev
---
