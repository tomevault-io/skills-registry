...
description: Send SMS messages with Azure Communication Services SMS Java SDK. Use when implementing SMS notifications, alerts, OTP delivery, bulk messaging, or delivery reports. Use when this capability is needed.
metadata:
  author: techwavedev
---
