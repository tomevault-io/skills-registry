...
description: Azure Batch SDK for Java. Run large-scale parallel and HPC batch jobs with pools, jobs, tasks, and compute nodes. Use when this capability is needed.
metadata:
  author: techwavedev
---
