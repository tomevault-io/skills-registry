...
description: Azure Cosmos DB SDK for Java. NoSQL database operations with global distribution, multi-model support, and reactive patterns. Use when this capability is needed.
metadata:
  author: techwavedev
---
