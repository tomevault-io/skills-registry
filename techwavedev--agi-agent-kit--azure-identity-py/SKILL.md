...
description: Azure Identity SDK for Python authentication. Use for DefaultAzureCredential, managed identity, service principals, and token caching. Use when this capability is needed.
metadata:
  author: techwavedev
---
