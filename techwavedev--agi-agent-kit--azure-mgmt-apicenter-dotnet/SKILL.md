...
description: Azure API Center SDK for .NET. Centralized API inventory management with governance, versioning, and discovery. Use when this capability is needed.
metadata:
  author: techwavedev
---
