...
description: Azure Bot Service Management SDK for Python. Use for creating, managing, and configuring Azure Bot Service resources. Use when this capability is needed.
metadata:
  author: techwavedev
---
