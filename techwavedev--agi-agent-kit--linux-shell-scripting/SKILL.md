...
description: This skill should be used when the user asks to \"create bash scripts\", \"automate Linux tasks\", \"monitor system resources\", \"backup files\", \"manage users\", or \"write production she... Use when this capability is needed.
metadata:
  author: techwavedev
---
