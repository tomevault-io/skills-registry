---
name: red-team-tools
description: This skill should be used when the user asks to \"follow red team methodology\", \"perform bug bounty hunting\", \"automate reconnaissance\", \"hunt for XSS vulnerabilities\", \"enumerate su... Use when this capability is needed.
metadata:
  author: techwavedev
---
