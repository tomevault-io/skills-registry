---
name: fastapi-routes
description: Create or modify FastAPI routes in the Oscilla codebase. Use when: adding new API endpoints, creating Pydantic request/response models, registering routers, designing REST APIs, or following route conventions for this project. Use when this capability is needed.
metadata:
  author: tedivm
---
...
---
> Source: [tedivm/oscilla](https://github.com/tedivm/oscilla) — distributed by [TomeVault](https://tomevault.io).
