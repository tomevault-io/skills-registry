---
name: context7
description: Search and query up-to-date documentation for any programming library via Context7 API. Use when you need current docs, code examples, or API references for libraries and frameworks. Use when this capability is needed.
metadata:
  author: telagod
---
