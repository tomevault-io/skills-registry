---
name: git-workflow
description: Git workflow assistant for branching, commits, PRs, and conflict resolution. Use when user asks about git strategy, branch management, or PR workflow. Use when this capability is needed.
metadata:
  author: telagod
---
