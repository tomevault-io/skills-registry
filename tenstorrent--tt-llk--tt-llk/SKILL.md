...
description: Delegates LLK test runs to the llk-test-runner agent using @.cursor/agents/llk-test-runner.md. Use when the user asks to run tests or mentions LLK tests. Ensure test commands run to completion before reading terminal output (no polling). Use when this capability is needed.
metadata:
  author: tenstorrent
---
