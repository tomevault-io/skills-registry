---
name: devops-cicd
description: CI/CD pipeline best practices for GitHub Actions and GitLab CI. Use when setting up or modifying CI/CD pipelines. Use when this capability is needed.
metadata:
  author: teodevlor
---
