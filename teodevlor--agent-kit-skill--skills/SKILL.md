...
description: Hệ thống tiêu chuẩn dự án đa năng (Standard Platform). Hỗ trợ Frontend, Backend, DevOps với nhiều tùy chọn ngôn ngữ/framework. Use when this capability is needed.
metadata:
  author: teodevlor
---
