---
name: termdock-ast
description: Use the Termdock AST API to locate symbols, dependencies, callers/callees, or impact before exploring unknown code. Skip when the user gives an exact file path or only needs a literal string search. Use when this capability is needed.
metadata:
  author: termdock
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/termdock) — claim your Tome and manage your conversions.
