...
description: Track complex, multi-session work with dependency graphs using bd (beads) issue tracker. Use when work spans multiple sessions, has complex dependencies, or requires persistent context across compaction cycles. For simple single-session linear tasks, TodoWrite remains appropriate. Use when this capability is needed.
metadata:
  author: terraconstructs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/terraconstructs) — claim your Tome and manage your conversions.
