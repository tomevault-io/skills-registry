...
description: Adds a new type of event that gets persisted to the event log. Use this when adding new kinds of write operations to the system or when adding new events to existing code. Use when this capability is needed.
metadata:
  author: terraware
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/terraware) — claim your Tome and manage your conversions.
