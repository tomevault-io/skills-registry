---
name: api-reviewer
description: API contract review, 接口契约评审。Use when: PRD 完成后、HLD/LLD/实现前需要审查 OpenAPI/AsyncAPI/GraphQL/gRPC/WebSocket/SSE/Webhook/SDK/文件格式/IPC-CLI 契约。 Use when this capability is needed.
metadata:
  author: testany-io
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/testany-io) — claim your Tome and manage your conversions.
