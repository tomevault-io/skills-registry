...
|------|------|----------------|
| 3.1 | Define agent State | State with Reducers |
| 3.2 | Async tool `check_stock` | Basic Agent Graph + async tools |
| 3.4 | Build StateGraph | Basic Agent Graph |
| 3.5 | Router node (Search vs Chat) | Conditional Branching |
| 4.1 | `interrupt_before=["order_node"]` | Human-in-the-Loop (below) |
| 4.2 | `graph.get_state(config)` | State Inspection |
