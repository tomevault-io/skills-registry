...
description: Best practices và patterns cho responsive web design. Bao gồm mobile-first approach, breakpoints, fluid typography với clamp(), responsive grids, touch-friendly UI, viewport optimization, và performance. Sử dụng khi implement layout mới, component mới, hoặc cải thiện responsive design cho website. Use when this capability is needed.
metadata:
  author: thanhnh98
---
