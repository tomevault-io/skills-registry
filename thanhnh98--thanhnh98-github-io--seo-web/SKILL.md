---
name: seo-web
description: Tối ưu SEO cho website Sắp Tết khi implement trang mới hoặc tính năng mới. Bao gồm meta tags, schema markup, Vietnamese SEO, social sharing, performance optimization. Sử dụng khi tạo trang HTML mới, thêm tính năng, hoặc cải thiện SEO cho trang hiện có. Use when this capability is needed.
metadata:
  author: thanhnh98
---
