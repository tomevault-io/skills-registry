---
name: lobster-use
description: NCBI API key for faster PubMed/GEO access (recommended) Use when this capability is needed.
metadata:
  author: the-omics-os
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/the-omics-os) — claim your Tome and manage your conversions.
