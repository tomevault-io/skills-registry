---
name: add-test
description: Add a new test file or new test cases to an existing file in Fluca. Handles source generation, CMakeLists.txt registration, golden output capture, and ctest verification. Use when this capability is needed.
metadata:
  author: thecasterian
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/thecasterian) — claim your Tome and manage your conversions.
