---
name: kubernetes-ops
description: description: "Kubernetes operations including deployments, services, HPA, RBAC, debugging, Helm charts, and cluster management. Trigger when users deploy to Kubernetes, debug pod issues, configure scaling, set up RBAC, or write Helm charts." Use when this capability is needed.
metadata:
  author: theding0x
---
---
