---
name: do
description: Execute a phased implementation plan using subagents. Use when asked to execute, run, or carry out a plan — especially one created by make-plan. Use when this capability is needed.
metadata:
  author: thedotmack
---
