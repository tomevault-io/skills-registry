---
name: neuro-symbolic
description: Neuro-symbolic architecture patterns. Use when building the bridge between LLM (Neural) and Python rules (Symbolic). Use when this capability is needed.
metadata:
  author: theinterneti
---
