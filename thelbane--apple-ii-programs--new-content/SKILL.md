---
name: new-content
description: Create new Apple II program posts or blog posts for this Jekyll site. Use when the user wants to add a new program, start a new post, create content, or asks about adding programs or blog entries. Use when this capability is needed.
metadata:
  author: thelbane
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/thelbane) — claim your Tome and manage your conversions.
