---
name: golang-pro
description: Master Go 1.25 with modern patterns, advanced concurrency, performance optimization, and production-ready microservices. Use when this capability is needed.
metadata:
  author: TheoBrigitte
---
...
---
> Source: [TheoBrigitte/claude-config](https://github.com/TheoBrigitte/claude-config) — distributed by [TomeVault](https://tomevault.io).
