...
description: Create component documentation with installation, usage examples, and preview sections. Apply when documenting 8-bit components with proper structure and examples. Use when this capability is needed.
metadata:
  author: theorcdev
---
