...
description: Patterns for game-like interfaces - health bars, XP bars, mana bars. Apply when building RPG/retro gaming UI components with state-driven visuals. Use when this capability is needed.
metadata:
  author: theorcdev
---
