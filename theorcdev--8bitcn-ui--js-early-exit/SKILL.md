---
name: js-early-exit
description: Use early returns to avoid unnecessary computation in loops and functions. Apply when processing arrays, validating input, or checking multiple conditions where the result can be determined before all iterations complete. Use when this capability is needed.
metadata:
  author: theorcdev
---
