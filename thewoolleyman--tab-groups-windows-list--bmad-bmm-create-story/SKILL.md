---
name: create-story
description: Create the next user story from epics+stories with enhanced context analysis and direct ready-for-dev marking Use when this capability is needed.
metadata:
