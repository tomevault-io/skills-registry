...
description: Designs modern, clean UI components and pages following Shadcn principles with minimalism, accessibility, and beautiful defaults. Use when building new UI components, redesigning pages, or creating consistent UI or simply wanting to use shadcn. Use when this capability is needed.
metadata:
  author: thieenjdev03
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/thieenjdev03) — claim your Tome and manage your conversions.
