...
description: Suggest relevant GitHub Copilot instruction files from the copilot-extensions repository based on current repository context and chat history, avoiding duplicates with existing instructions in this repository, and identifying outdated instructions that need updates. Use when this capability is needed.
metadata:
  author: thijs-philips
---
...
---
> Source: [thijs-philips/vscode](https://github.com/thijs-philips/vscode) — distributed by [TomeVault](https://tomevault.io).
