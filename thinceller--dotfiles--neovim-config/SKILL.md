---
name: neovim-config
description: This skill should be used when the user asks to "add a new plugin", "configure LSP", "add keymaps", "modify Neovim settings", "set up completion", "configure formatters", or mentions Neovim, nvim, or plugin configuration in this dotfiles repository. Use when this capability is needed.
metadata:
  author: thinceller
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/thinceller) — claim your Tome and manage your conversions.
