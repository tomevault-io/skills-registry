---
name: auto-updater
description: Automatically update ThinkFleetBot and all installed skills once daily. Runs via cron, checks for updates, applies them, and messages the user with a summary of what changed. Use when this capability is needed.
metadata:
  author: thinkfleetai
---
