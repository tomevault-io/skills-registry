---
name: revolut
description: Revolut Business API CLI — accounts, balances, transactions, counterparties, payments, FX exchange, CSV export. Auto-refreshes OAuth tokens. Business accounts only (not personal). Use when this capability is needed.
metadata:
  author: thinkfleetai
---
