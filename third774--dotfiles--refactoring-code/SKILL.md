...
description: Improve code structure while preserving behavior with test verification. Use when cleaning up code, reducing duplication, simplifying complexity, or reorganizing modules. Use when this capability is needed.
metadata:
  author: third774
---
