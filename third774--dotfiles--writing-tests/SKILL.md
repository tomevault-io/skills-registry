---
name: writing-tests
description: Write behavior-focused tests following Testing Trophy model with real dependencies, avoiding common anti-patterns like testing mocks and polluting production code. Use when writing new tests, reviewing test quality, or improving test coverage. Use when this capability is needed.
metadata:
  author: third774
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/third774) — claim your Tome and manage your conversions.
