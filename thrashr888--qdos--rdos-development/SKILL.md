---
name: development
description: R-DOS development process. Use when planning features, creating documentation, tracking work with beads, or understanding the documentation system. Use when this capability is needed.
metadata:
  author: thrashr888
---
