---
name: openmaic
description: `maic-importer` 开发规范。请先读 `DESIGN.md` 了解架构。 Use when this capability is needed.
metadata:
  author: THU-MAIC
---
# SKILL
...
---
> Source: [THU-MAIC/OpenMAIC](https://github.com/THU-MAIC/OpenMAIC) — distributed by [TomeVault](https://tomevault.io).
