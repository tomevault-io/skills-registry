...
description: Sync Matt Pocock's skills from upstream (github.com/mattpocock/skills), apply pi-specific patches that replace Claude Code sub-agent references, and flag new skills or unpatched patterns. Use when user says "sync skills", "update pocock skills", or "check for skill updates". Use when this capability is needed.
metadata:
  author: thxgg
---
...
---
> Source: [thxgg/dotfiles](https://github.com/thxgg/dotfiles) — distributed by [TomeVault](https://tomevault.io).
