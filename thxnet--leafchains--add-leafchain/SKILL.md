---
name: add-leafchain
description: Add a new leafchain (testnet or mainnet), generating the chain_spec and modifying all related files Use when this capability is needed.
metadata:
  author: thxnet
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/thxnet) — claim your Tome and manage your conversions.
