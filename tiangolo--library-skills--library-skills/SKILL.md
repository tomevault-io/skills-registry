---
name: library-skills
description: Use Library Skills to discover, install, refresh, repair, check, and manage agent skills from installed packages. Use when this capability is needed.
metadata:
  author: tiangolo
---
...
---
> Source: [tiangolo/library-skills](https://github.com/tiangolo/library-skills) — distributed by [TomeVault](https://tomevault.io).
