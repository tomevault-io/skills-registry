---
name: create-skill
description: Guide for creating new Claude Code skills. Use when you need to create a new skill to package expertise or workflow into a reusable capability that Claude can automatically invoke. Use when this capability is needed.
metadata:
  author: tidymodels
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tidymodels) — claim your Tome and manage your conversions.
