...
description: Optional local install of flowctl CLI and CLAUDE.md/AGENTS.md instructions. Use when user runs /flow-next:setup. Use when this capability is needed.
metadata:
  author: tiendung
---
