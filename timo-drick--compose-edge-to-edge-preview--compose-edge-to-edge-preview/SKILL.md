---
name: compose-edge-to-edge-preview
description: This skill covers Android Compose modules and Kotlin Multiplatform Compose modules that render previews through an Android target. Use when this capability is needed.
metadata:
  author: timo-drick
---
