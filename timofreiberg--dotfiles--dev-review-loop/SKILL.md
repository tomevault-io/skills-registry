...
description: Orchestrate a dev→review→fix loop using subagents. Iterates until review passes or findings are rejected. Use when this capability is needed.
metadata:
  author: timofreiberg
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/timofreiberg) — claim your Tome and manage your conversions.
