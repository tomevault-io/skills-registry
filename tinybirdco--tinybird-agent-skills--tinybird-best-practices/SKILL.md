---
name: tinybird
description: Tinybird file formats, SQL rules, optimization patterns, and best practices for datasources, pipes, endpoints, and materialized views. Use when this capability is needed.
metadata:
  author: tinybirdco
---
