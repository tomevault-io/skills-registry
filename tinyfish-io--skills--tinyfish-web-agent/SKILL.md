---
name: tinyfish
description: Use TinyFish web agent to extract/scrape websites, extract data, and automate browser actions using natural language. Use when you need to extract/scrape data from websites, handle bot-protected sites, or automate web tasks. Use when this capability is needed.
metadata:
  author: tinyfish-io
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tinyfish-io) — claim your Tome and manage your conversions.
