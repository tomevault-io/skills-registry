---
name: debugging
description: Systematic 4-phase debugging with root cause investigation. Use when fixing bugs to prevent random fixes. Use when this capability is needed.
metadata:
  author: tmcfarlane
---
...
---
> Source: [tmcfarlane/oh-my-cursor](https://github.com/tmcfarlane/oh-my-cursor) — distributed by [TomeVault](https://tomevault.io).
