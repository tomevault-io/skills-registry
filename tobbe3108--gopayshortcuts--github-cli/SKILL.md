---
name: github-cli
description: Manage repositories, CI/CD workflows, issues, pull requests, and releases using the GitHub CLI. Use when automating GitHub operations, managing repositories via command line, or integrating GitHub workflows into development processes. Use when this capability is needed.
metadata:
  author: tobbe3108
---
