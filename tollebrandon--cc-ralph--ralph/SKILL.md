---
name: ralph
description: Convert PRDs to prd.json format for the Ralph autonomous agent system. Use when you have an existing PRD and need to convert it to Ralph's JSON format, or when asked to create prd.json. Use when this capability is needed.
metadata:
  author: tollebrandon
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tollebrandon) — claim your Tome and manage your conversions.
