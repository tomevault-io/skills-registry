---
name: agent-memory
description: ユーザーが記憶の保存・想起・整理を求めるときに使用する。例: 'remember this', 'save this', 'note this', 'what did we discuss about...', 'check your notes', 'clean up memories' など。価値ある発見を保存すべき場合はプロアクティブに使用する。 Use when this capability is needed.
metadata:
  author: tomatio13
---
