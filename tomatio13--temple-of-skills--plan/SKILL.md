---
name: plan
description: 複雑な開発タスクに対する実行計画を作成する。ユーザーが計画を求める場合や、$CODEX_HOME/plans（デフォルト ~/.codex/plans）内の計画ファイルを保存/検索/読込/更新/削除したい場合に使用する。 Use when this capability is needed.
metadata:
  author: tomatio13
---
