---
name: create-agent
description: Create custom Claude Code subagents. Use when the user wants to create a new agent, add a custom subagent, define specialized agents for tasks like code review, debugging, or testing. Use when this capability is needed.
metadata:
  author: tomdale
---
