---
name: create-command
description: Create new Claude Code slash commands. Use when the user wants to create a new slash command, add a custom command, or automate a workflow with a /command. Use when this capability is needed.
metadata:
  author: tomdale
---
