---
name: create-skill
description: Create new Claude Code skills. Use when the user wants to create a skill, add model-invoked capabilities, or build complex multi-file workflows that Claude can auto-discover. Use when this capability is needed.
metadata:
  author: tomdale
---
