---
name: fix-pr-checks
description: Analyze and fix failing GitHub PR checks for the current branch. Use when CI is failing, builds are broken, tests are red, PR checks show errors, or the user mentions "fix CI", "fix checks", "fix pipeline", "failing tests", or "broken build". Use when this capability is needed.
metadata:
  author: tomdale
---
