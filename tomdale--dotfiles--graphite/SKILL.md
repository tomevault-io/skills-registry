---
name: graphite
description: Manage stacked pull requests using Graphite CLI (gt). Use when creating PRs, working with git branches in a stack, submitting changes for review, syncing branches, or when the user mentions Graphite, stacked PRs, or the gt command. Use when this capability is needed.
metadata:
  author: tomdale
---
