---
name: linear
description: Interact with Linear issue tracker via the linctl CLI. Use when the user mentions Linear, issues, tickets, tasks, sprints, projects, or wants to manage work items. Supports creating, listing, updating, and assigning issues, plus team and project management. Use when this capability is needed.
metadata:
  author: tomdale
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tomdale) — claim your Tome and manage your conversions.
