---
name: vue-component
description: Generate a new Vue 3 SFC component following Flexytime project conventions. Use when creating new components, scaffolding UI elements, or when the user says 'yeni component', 'component olustur', 'create component'. Use when this capability is needed. Use when this capability is needed.
metadata:
  author: tomevault-io
---
