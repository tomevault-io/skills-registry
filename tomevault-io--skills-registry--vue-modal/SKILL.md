---
name: vue-modal
description: Generate a modal dialog component with form validation using PrimeVue Dialog, vee-validate, and Yup. Use when creating modals, forms, edit dialogs, or when the user says 'modal olustur', 'form modal', 'create modal', 'dialog olustur'. Use when this capability is needed. Use when this capability is needed.
metadata:
  author: tomevault-io
---
