---
name: vue-styling
description: Atlas Launcher Vue styling system. Use when editing launcher UI visuals, theming, dark/light behavior, glass surfaces, elevation, backgrounds, or component-level UX polish so changes stay aligned with launcher design language. Use when this capability is needed. Use when this capability is needed.
metadata:
  author: tomevault-io
---
