---
name: usd-editor
description: Guide for modifying USD ASCII (.usda) files, including prims, properties, composition arcs, variants, and transforms. Use when editing or reviewing .usda files by hand. Use when this capability is needed.
metadata:
  author: tomkrikorian
---
