---
name: plan-format
description: This skill should be used when creating plan files, writing Gherkin requirements, or parsing plan file structure. Provides the plan file template and format specifications. Use when this capability is needed.
metadata:
  author: tommymorgan
---
