...
description: Opinionated REST API design guidance for resource naming, HTTP semantics, error formats, pagination, versioning, and more. Use when designing REST APIs during brainstorming or plan creation. Use when this capability is needed.
metadata:
  author: tommymorgan
---
