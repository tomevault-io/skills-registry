---
name: hetzbot-docker
description: Install Docker Engine + Compose plugin on a host. Triggers: install-service sees a skill needs to start a compose stack. Idempotent. Hardens the daemon (no-new-privileges, journald log driver, live-restore). Use when this capability is needed.
metadata:
  author: tomspiegl
---
