---
name: cobrapy
description: Constraints-Based Reconstruction and Analysis for Python. Used for modeling large-scale metabolic networks in microorganisms. Use when this capability is needed.
metadata:
  author: tondevrel
---
