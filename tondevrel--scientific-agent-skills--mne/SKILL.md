---
name: mne
description: Open-source Python package for exploring, visualizing, and analyzing human neurophysiological data including EEG, MEG, sEEG, and ECoG. Use when this capability is needed.
metadata:
  author: tondevrel
---
