---
name: pydicom
description: Python package for working with DICOM files. It allows you to read, modify, and write DICOM data in a Pythonic way. Essential for medical imaging processing, clinical data extraction, and AI in radiology. Use when this capability is needed.
metadata:
  author: tondevrel
---
