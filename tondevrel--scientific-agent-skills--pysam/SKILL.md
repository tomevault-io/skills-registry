---
name: pysam
description: Python module for reading, manipulating and writing genomic alignment formats (SAM/BAM/CRAM) and variant files (VCF/BCF). Wrapper for htslib. Use when this capability is needed.
metadata:
  author: tondevrel
---
