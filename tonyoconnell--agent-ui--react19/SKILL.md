---
name: react19
description: React 19 patterns including Actions, use() hook, transitions, ref as prop, and optimistic updates for the Envelope System Use when this capability is needed.
metadata:
  author: tonyoconnell
---
