---
name: reactflow
description: Build interactive node-based visualizations for envelope chains using ReactFlow with custom nodes, edges, and dark theme Use when this capability is needed.
metadata:
  author: tonyoconnell
---
