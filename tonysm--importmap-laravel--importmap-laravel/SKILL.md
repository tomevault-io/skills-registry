...
description: Work with Importmap Laravel — a replacement for npm/yarn that uses ESM import maps. Pin dependencies, configure pins, optimize for production, and manage the importmap workflow. Use when this capability is needed.
metadata:
  author: tonysm
---
...
---
> Source: [tonysm/importmap-laravel](https://github.com/tonysm/importmap-laravel) — distributed by [TomeVault](https://tomevault.io).
