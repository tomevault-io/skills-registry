...
description: Turn Eloquent models into rich text content attachments (e.g., user mentions, embedded resources) using the AttachableContract and Attachable trait. Use when this capability is needed.
metadata:
  author: tonysm
---
...
---
> Source: [tonysm/rich-text-laravel](https://github.com/tonysm/rich-text-laravel) — distributed by [TomeVault](https://tomevault.io).
