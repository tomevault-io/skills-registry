---
name: canary-setup
description: Interactive setup workflow for configuring the Magnet MCP server to use the canary environment (project-specific, magnet-app directory only). Use when user says "canary setup", "use canary", "test on canary", "configure canary MCP", or "set up canary environment". Use when this capability is needed.
metadata:
  author: toolkit-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/toolkit-ai) — claim your Tome and manage your conversions.
