---
name: local-setup
description: Interactive setup workflow for running the Magnet MCP server locally (project-specific, magnet-app directory only). Use when user says "local setup", "run locally", "test locally", "configure MCP", or "set up local development". Use when this capability is needed.
metadata:
  author: toolkit-ai
---
