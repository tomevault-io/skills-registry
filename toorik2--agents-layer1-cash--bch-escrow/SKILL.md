---
name: bch-escrow
description: Deploy and interact with a CashScript escrow contract for trustless agent-to-agent trades on Bitcoin Cash. Use when this capability is needed.
metadata:
  author: toorik2
---
