...
description: Upgrades a project’s Stylelint version or configuration Use when this capability is needed.
metadata:
  author: torchbox
---
...
---
> Source: [torchbox/django-pattern-library](https://github.com/torchbox/django-pattern-library) — distributed by [TomeVault](https://tomevault.io).
