---
name: pr-create
description: Git 変更分析に基づく自動 PR 作成で効率的な Pull Request ワークフローを実現します。Use when: pr create / pr 作って, 作成 /  Pull Request 作って、作成 など依頼された時。 Use when this capability is needed.
metadata:
  author: tosaka07
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tosaka07) — claim your Tome and manage your conversions.
