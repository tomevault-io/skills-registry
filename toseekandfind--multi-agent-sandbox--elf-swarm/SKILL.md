---
name: swarm
description: Coordinate multi-agent orchestration for complex tasks. Launch parallel and sequential agents, manage dependencies, aggregate results, and orchestrate sophisticated workflows. Use for tasks requiring multiple specialized perspectives or parallel processing. Use when this capability is needed.
metadata:
  author: toseekandfind
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/toseekandfind) — claim your Tome and manage your conversions.
