...
description: React/Next.jsコンポーネントを作成します。Atomic Design階層、TypeScript、Tailwind CSSを使用し、適切なpropsの型定義とアクセシビリティを考慮したコンポーネントを生成します。 Use when this capability is needed.
metadata:
  author: toshi-hm
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/toshi-hm) — claim your Tome and manage your conversions.
