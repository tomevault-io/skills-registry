---
name: docs-search
description: Search and retrieve Toss / Apps-in-Toss documentation using the ax CLI via run-ax.sh. Supports docs, TDS React Native, and TDS Web sources. Use bash to execute run-ax.sh in this skill's directory. Use when this capability is needed.
metadata:
  author: toss
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/toss) — claim your Tome and manage your conversions.
