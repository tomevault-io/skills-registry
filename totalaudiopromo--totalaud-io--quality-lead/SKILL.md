---
name: quality-lead
description: Testing and validation specialist - handles test suite execution, mobile UX validation, accessibility checks, and pre-deployment QA. Use when this capability is needed.
metadata:
