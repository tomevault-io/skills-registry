---
name: route-builder
description: API route specialist - handles route scaffolding, Zod validation, authentication, error handling, and endpoint consistency. Use when this capability is needed.
metadata:
