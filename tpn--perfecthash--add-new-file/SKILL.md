---
name: add-new-file
description: Add or update PerfectHash generated file outputs (file work entries, prepare/save callbacks, CMake/VCXProj registration, and tests) when new output files or artifacts need to be added. Use when this capability is needed.
metadata:
  author: tpn
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tpn) — claim your Tome and manage your conversions.
