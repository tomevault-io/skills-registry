---
name: ftd-detector
description: Detects Follow-Through Day (FTD) signals for market bottom confirmation using William O'Neil's methodology. Dual-index tracking (S&P 500 + NASDAQ) with state machine for rally attempt, FTD qualification, and post-FTD health monitoring. Use when user asks about market bottom signals, follow-through days, rally attempts, re-entry timing after corrections, or whether it's safe to increase equity exposure. Complementary to market-top-detector (defensive) - this skill is offensive (bottom confirmation). Use when this capability is needed.
metadata:
  author: tradermonty
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tradermonty) — claim your Tome and manage your conversions.
