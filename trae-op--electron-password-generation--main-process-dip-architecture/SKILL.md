...
description: Main Process Architecture Guide. Dependency Injection Pattern (DIP). Provides decorators, module patterns, and examples for building modular, testable Electron main process code using dependency injection Use when this capability is needed.
metadata:
  author: trae-op
---
