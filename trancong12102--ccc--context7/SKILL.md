---
name: context7
description: Retrieve current library documentation and code examples from Context7. Use when looking up library APIs, "docs", specific library versions, or "how to use [library]". Prefer over training knowledge for library-specific questions. Do not use for general programming concepts. Use when this capability is needed.
metadata:
