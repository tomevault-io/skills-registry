...
description: Offline lookup for Transloadit Robots and their parameter docs/examples via the `transloadit` CLI. Use to draft or validate `steps` JSON without guessing robot names/params. Use when this capability is needed.
metadata:
  author: transloadit
---
