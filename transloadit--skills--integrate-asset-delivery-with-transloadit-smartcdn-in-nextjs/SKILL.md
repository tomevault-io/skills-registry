...
description: Add Transloadit Smart CDN URL signing to a Next.js App Router project (server-side signing route + optional client demo page). Use when this capability is needed.
metadata:
  author: transloadit
---
