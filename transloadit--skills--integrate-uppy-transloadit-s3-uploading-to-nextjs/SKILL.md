...
description: Add Uppy Dashboard + Transloadit uploads to a Next.js (App Router) app, with server-side signature generation and optional /s3/store export. Use when this capability is needed.
metadata:
  author: transloadit
---
