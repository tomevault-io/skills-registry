...
description: Create a new FastAPI endpoint for the claudeskills REST API Use when this capability is needed.
metadata:
  author: trantdai
---
...
---
> Source: [trantdai/genai](https://github.com/trantdai/genai) — distributed by [TomeVault](https://tomevault.io).
