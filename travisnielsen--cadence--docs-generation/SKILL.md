...
description: Generate documentation from Python code by analyzing source code, extracting signatures, and creating structured reference docs. Use when creating API references or module documentation. Use when this capability is needed.
metadata:
  author: travisnielsen
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/travisnielsen) — claim your Tome and manage your conversions.
