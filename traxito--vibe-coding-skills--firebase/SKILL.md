...
description: Configure and use Firebase (Authentication, Firestore, Cloud Functions, Hosting, Storage) following best practices. Includes authentication patterns, optimized queries, deployment workflows, and troubleshooting. Use whenever working with Firebase services. Use when this capability is needed.
metadata:
  author: traxito
---
