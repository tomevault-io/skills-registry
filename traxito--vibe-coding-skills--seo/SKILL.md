...
description: Implement comprehensive SEO following best practices for SaaS apps. Includes meta tags, Schema.org markup, sitemap generation, Open Graph, Twitter Cards, and performance optimization. Use when creating public pages, landing pages, blog posts, or improving organic search rankings. Use when this capability is needed.
metadata:
  author: traxito
---
