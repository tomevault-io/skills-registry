---
name: go-expert
description: Specialized knowledge for writing professional, idiomatic Go (Golang) code, specifically for the switchAILocal codebase (Gin, switchai, etc.). Use when this capability is needed.
metadata:
  author: traylinx
---
