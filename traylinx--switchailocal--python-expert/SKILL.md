---
name: python-expert
description: Expert in Python development including async programming, type hints, testing with pytest, and modern Python patterns. Use for Python code generation, debugging, and best practices. Use when this capability is needed.
metadata:
  author: traylinx
---
