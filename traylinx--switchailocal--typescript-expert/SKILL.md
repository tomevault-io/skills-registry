...
description: Expert in TypeScript including advanced type system features, generics, utility types, and type-safe patterns. Use for TypeScript-specific questions, type errors, and designing type-safe APIs. Use when this capability is needed.
metadata:
  author: traylinx
---
