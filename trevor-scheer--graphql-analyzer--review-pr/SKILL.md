---
name: review-pr
description: Review pull requests against project standards. Use when reviewing PRs, checking code quality, or providing feedback on changes. Use when this capability is needed.
metadata:
