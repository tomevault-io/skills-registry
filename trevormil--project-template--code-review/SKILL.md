---
name: code-review
description: Compatibility launcher for the code-review agent. Delegates a GitHub/GitLab PR review to Codex: deterministic preflight does recon, then Codex scores six axes into one artifact at .TerMinal/reviews/<pr>/<sha>.md (v2) or .reviews/<pr>/<sha>.md (legacy v1). Use on /code-review or 'review this PR'. Use when this capability is needed.
metadata:
  author: trevormil
---
...
---
> Source: [trevormil/project-template](https://github.com/trevormil/project-template) — distributed by [TomeVault](https://tomevault.io).
