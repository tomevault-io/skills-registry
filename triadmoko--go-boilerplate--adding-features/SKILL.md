...
description: Guide for adding new feature modules following Clean Architecture pattern. Use when creating new features, modules, REST endpoints, or business logic components in this Go project. Use when this capability is needed.
metadata:
  author: triadmoko
---
