---
name: api-endpoints
description: Create REST API endpoints with proper validation, error handling, and Swagger documentation. Use when adding new routes, HTTP handlers, or REST API functionality. Use when this capability is needed.
metadata:
  author: triadmoko
---
