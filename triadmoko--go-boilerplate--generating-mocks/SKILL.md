...
description: Generate mock implementations using mockery for testing. Use when creating mocks, updating mock interfaces, or setting up test doubles. Use when this capability is needed.
metadata:
  author: triadmoko
---
