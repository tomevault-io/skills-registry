...
description: Play the Trifle GM game via the web API. Posts creative G+M word pairs to earn balls. Supports multiple players (GiGi, Tilt) running concurrently as a daemon. Use when this capability is needed.
metadata:
  author: trifle-labs
---
