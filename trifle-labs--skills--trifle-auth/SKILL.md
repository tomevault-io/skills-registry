---
name: trifle-auth
description: Authenticate with the Trifle API using Sign-In with Ethereum (SIWE). Manages wallet-based authentication, JWT token storage, and session management for the Trifle ecosystem. Use when this capability is needed.
metadata:
  author: trifle-labs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/trifle-labs) — claim your Tome and manage your conversions.
