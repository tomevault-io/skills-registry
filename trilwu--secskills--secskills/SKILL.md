...
description: Escalate privileges on Windows systems using service misconfigurations, DLL hijacking, token manipulation, UAC bypasses, registry exploits, and credential dumping. Use when performing Windows post-exploitation or privilege escalation. Use when this capability is needed.
metadata:
  author: trilwu
---
...
---
> Source: [trilwu/secskills](https://github.com/trilwu/secskills) — distributed by [TomeVault](https://tomevault.io).
