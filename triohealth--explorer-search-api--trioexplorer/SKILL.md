---
name: trioexplorer
description: Search clinical notes using the Trioexplorer CLI. Use when the user wants to search patient notes, list cohorts, view search history, or explore the clinical notes database. Use when this capability is needed.
metadata:
  author: triohealth
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/triohealth) — claim your Tome and manage your conversions.
