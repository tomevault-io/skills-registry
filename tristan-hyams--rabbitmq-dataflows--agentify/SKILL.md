---
name: agentify
description: Bootstrap a repo with ML context files (CLAUDE.md, copilot-instructions.md, AGENTS.md) as thin shims pointing to docs/RULES.md and docs/STRUCTURE.md, then review for accuracy. Use when this capability is needed.
metadata:
  author: tristan-hyams
---
...
---
> Source: [tristan-hyams/RabbitMQ.Dataflows](https://github.com/tristan-hyams/RabbitMQ.Dataflows) — distributed by [TomeVault](https://tomevault.io).
