...
description: Create custom node definitions with renderers, ports, external data, and constraints. Use when implementing new node types, custom node appearances, or node-specific behaviors. Use when this capability is needed.
metadata:
  author: trkbt10
---
