...
description: Create and customize inspector panels for node editors. Use when implementing custom inspector tabs, settings panels, node-specific inspectors, or using inspector UI components. Use when this capability is needed.
metadata:
  author: trkbt10
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/trkbt10) — claim your Tome and manage your conversions.
