---
name: macports
description: MacPorts package manager development workflow including Portfile creation, updates, testing, debugging build failures, and port command usage. Use when working with MacPorts ports, Portfiles, port testing, version updates, checksum updates, dependency management, build debugging, or any MacPorts development tasks. Use when this capability is needed.
metadata:
  author: trodemaster
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/trodemaster) — claim your Tome and manage your conversions.
