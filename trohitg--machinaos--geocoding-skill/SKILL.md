...
description: Convert addresses to coordinates (geocoding) or coordinates to addresses (reverse geocoding) using Google Maps API. Use when this capability is needed.
metadata:
  author: trohitg
---
