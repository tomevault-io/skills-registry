...
description: Execute JavaScript code for calculations, data processing, and JSON manipulation. Full ES6+ support with Node.js runtime. Use when this capability is needed.
metadata:
  author: trohitg
---
