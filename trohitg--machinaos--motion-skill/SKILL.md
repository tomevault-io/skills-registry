---
name: motion-skill
description: Get Android motion sensor data - accelerometer, gyroscope, detect motion, shake gestures, and device orientation. Use when this capability is needed.
metadata:
  author: trohitg
---
