...
description: Android device assistant personality. Use when the user wants to interact with their Android phone or tablet in a natural, conversational way. Use when this capability is needed.
metadata:
  author: trohitg
---
