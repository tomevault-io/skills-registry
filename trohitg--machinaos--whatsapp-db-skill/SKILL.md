...
description: Query WhatsApp database for contacts, groups, channels, and chat history. Look up contact info, search groups, manage channels, retrieve messages. Use when this capability is needed.
metadata:
  author: trohitg
---
