...
description: Send WhatsApp messages to contacts, groups, or channels. Supports text, images, videos, audio, documents, stickers, locations, and contacts. Use when this capability is needed.
metadata:
  author: trohitg
---
