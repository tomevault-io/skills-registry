...
description: Git worktree management with the `wt` script for simplified create, list, switch, and delete operations. Includes comprehensive guidance on best practices and troubleshooting. Use when this capability is needed.
metadata:
  author: trounceabout
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/trounceabout) — claim your Tome and manage your conversions.
