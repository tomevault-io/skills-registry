...
description: Use after implementing features - verifies each acceptance criterion with structured testing and posts verification reports to the GitHub issue Use when this capability is needed.
metadata:
  author: troykelly
---
