...
description: Use before any code changes - hard gate ensuring work never happens on main branch, with proper feature branch creation from correct base Use when this capability is needed.
metadata:
  author: troykelly
---
