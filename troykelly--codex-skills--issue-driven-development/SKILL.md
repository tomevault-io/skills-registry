...
description: Use for any development work - the master 13-step coding process that orchestrates all other skills, ensuring GitHub issue tracking, proper branching, TDD, code review, and CI verification Use when this capability is needed.
metadata:
  author: troykelly
---
