...
description: Use before starting ANY work - hard gate ensuring a GitHub issue exists, creating one if needed through user questioning Use when this capability is needed.
metadata:
  author: troykelly
---
