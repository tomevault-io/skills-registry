...
description: Use during all development - no TODOs, no FIXMEs, no "we'll add this later"; do it now or get explicit deferral permission Use when this capability is needed.
metadata:
  author: troykelly
---
