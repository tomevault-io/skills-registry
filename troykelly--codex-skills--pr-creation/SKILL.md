---
name: pr-creation
description: Use after completing implementation - create pull request with complete documentation, proper labels, linked issues, and verification summary Use when this capability is needed.
metadata:
  author: troykelly
---
