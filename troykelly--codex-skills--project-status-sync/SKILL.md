...
description: Use to keep GitHub Project fields synchronized with actual work state - updates status, verification, criteria counts, and other project-specific fields Use when this capability is needed.
metadata:
  author: troykelly
---
