---
name: review-scope
description: Use before code review - determine if change is minor (review new code only) or major (review impacted code too) Use when this capability is needed.
metadata:
  author: troykelly
---
