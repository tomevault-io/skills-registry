---
name: session-start
description: Use at the beginning of every work session - establishes context by checking GitHub project state, reading memory, verifying environment, and orienting before starting work Use when this capability is needed.
metadata:
  author: troykelly
---
