---
name: timescaledb
description: MANDATORY when working with time-series data, hypertables, continuous aggregates, or compression - enforces TimescaleDB 2.24.0 best practices including lightning-fast recompression, UUIDv7 continuous aggregates, and Direct Compress Use when this capability is needed.
metadata:
  author: troykelly
---
