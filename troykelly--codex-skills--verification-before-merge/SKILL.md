...
description: Use before merging PR - final gate ensuring all tests pass, review complete, CI green, and acceptance criteria verified Use when this capability is needed.
metadata:
  author: troykelly
---
