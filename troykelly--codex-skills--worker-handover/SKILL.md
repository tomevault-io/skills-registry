...
description: Defines context handover format when workers hit turn limit. Posts structured handover to GitHub issue comments enabling replacement workers to continue seamlessly. Use when this capability is needed.
metadata:
  author: troykelly
---
