...
description: Reference for creating and maintaining Copilot customization artifacts: agent roles (copilot-instructions.md), skills (SKILL.md), and scoped instructions. Use when scaffolding new agents, adding skills, or modifying agent configurations. Use when this capability is needed.
metadata:
  author: trsdn
---
