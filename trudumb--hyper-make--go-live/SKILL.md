---
name: go-live
description: Pre-flight checks and deployment procedure for live trading. Use when deploying to mainnet, going live with a new asset, or transitioning from paper to live. Covers code parity audit, config validation, first-30-min monitoring, and rollback. Use when this capability is needed.
metadata:
  author: trudumb
---
