---
name: django-pro
description: Expert Django development covering the ORM, Admin interface, Django REST Framework (DRF), and enterprise application patterns. Use when this capability is needed.
metadata:
  author: truongnat
---
