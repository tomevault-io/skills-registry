---
name: fastapi-pro
description: Expert FastAPI development covering async API design, Pydantic validation, Dependency Injection, and high-performance patterns. Use when this capability is needed.
metadata:
  author: truongnat
---
