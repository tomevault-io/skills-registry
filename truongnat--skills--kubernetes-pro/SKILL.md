---
name: kubernetes-pro
description: Expert Kubernetes (K8s) orchestration covering manifests, Helm, Kustomize, security, networking, and cluster management. Use when this capability is needed.
metadata:
  author: truongnat
---
