...
description: Apply for android-jetpack-compose-cursorrules-prompt-file. // Android Jetpack Compose .cursorrules // Flexibility Notice // Note: This is a recommended project structure, but be flexible and adapt to existing project structures. Use when this capability is needed.
metadata:
  author: Tryboy869
---
