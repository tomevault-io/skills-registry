...
description: Apply for bug-report-clear-concise-title-describing-the-issue. // QA Bug Report - .cursorrules prompt file // Specialized prompt for creating standardized QA bug reports with clear reproduction steps // and detailed environmental context for efficient bug resolut Use when this capability is needed.
metadata:
  author: Tryboy869
---
