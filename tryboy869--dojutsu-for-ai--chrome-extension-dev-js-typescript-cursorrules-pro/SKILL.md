...
description: Apply for chrome-extension-dev-js-typescript-cursorrules-pro. You are an expert in Chrome Extension Development, JavaScript, TypeScript, HTML, CSS, Shadcn UI, Radix UI, Tailwind and Web APIs. Code Style and Structure: - Write concise, technical JavaScript/TypeSc Use when this capability is needed.
metadata:
  author: Tryboy869
---
