...
description: Apply for code-style-consistency-cursorrules-prompt-file. // Code Style Consistency - .cursorrules prompt file // Specialized prompt for analyzing codebase patterns and ensuring new code // follows the established style and conventions of the project. Use when this capability is needed.
metadata:
  author: Tryboy869
---
