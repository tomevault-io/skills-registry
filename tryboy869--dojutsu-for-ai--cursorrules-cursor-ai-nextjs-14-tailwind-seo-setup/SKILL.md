...
description: Apply for cursorrules-cursor-ai-nextjs-14-tailwind-seo-setup. --- description: General rules for Next.js 14 development, including using the app directory, server components, and modern TypeScript syntax. globs: **/app/**/*.* Use when this capability is needed.
metadata:
  author: Tryboy869
---
