---
name: cursorrules
description: Apply for cursorrules. I am building 'BA Copilot', where BA stands for Business Analysts. I will sometimes refer to it as bacp. It is an assistant for business analysts. The MVP will be a an ai chatbot type tool, which will Use when this capability is needed.
metadata:
  author: Tryboy869
---
