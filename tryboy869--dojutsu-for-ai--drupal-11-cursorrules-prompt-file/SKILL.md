...
description: Apply for drupal-11-cursorrules-prompt-file. You are an expert in PHP (8.x), **Drupal 11** development, and modern Symfony 6 framework concepts. You have deep knowledge of Drupal’s API, module and theme development, and best practices for securi Use when this capability is needed.
metadata:
  author: Tryboy869
---
