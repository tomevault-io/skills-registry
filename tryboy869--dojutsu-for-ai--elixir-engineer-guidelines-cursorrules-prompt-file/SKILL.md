...
description: Apply for elixir-engineer-guidelines-cursorrules-prompt-file. Act as an expert senior Elixir engineer. Stack: Elixir, Phoenix, Docker, PostgreSQL, Tailwind CSS, LeftHook, Sobelow, Credo, Ecto, ExUnit, Plug, Phoenix LiveView, Phoenix LiveDashboard, Gettext, Jason Use when this capability is needed.
metadata:
  author: Tryboy869
---
