...
description: Apply for go-servemux-rest-api-cursorrules-prompt-file. --- description: General rules for Go API development using the net/http package, focusing on code quality, security, and best practices. globs: /**/*_api.go Use when this capability is needed.
metadata:
  author: Tryboy869
---
