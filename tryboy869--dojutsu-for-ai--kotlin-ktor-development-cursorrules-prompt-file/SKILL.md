...
description: Apply for kotlin-ktor-development-cursorrules-prompt-file. - Follow **SOLID**, **DRY**, **KISS**, and **YAGNI** principles - Adhere to **OWASP** security best practices - Break tasks into smallest units and solve problems step-by-step Use when this capability is needed.
metadata:
  author: Tryboy869
---
