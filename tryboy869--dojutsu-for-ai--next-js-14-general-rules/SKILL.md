...
description: [Applies to: **/app/**/*.*] General rules for Next.js 14 development, including using the app directory, server components, and modern TypeScript syntax. Use when this capability is needed.
metadata:
  author: Tryboy869
---
