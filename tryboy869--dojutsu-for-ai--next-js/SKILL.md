---
name: next-js
description: [Applies to: **/*.{js,jsx,ts,tsx}] This guide defines definitive best practices for Next.js applications, focusing on the `app` directory, Server Components, performance, and maintainability. Follow these rules to build robust, scalable, and performant Next.js projects. Use when this capability is needed.
metadata:
  author: Tryboy869
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/Tryboy869) — claim your Tome and manage your conversions.
