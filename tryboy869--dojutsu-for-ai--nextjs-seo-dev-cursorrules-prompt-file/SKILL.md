...
description: Apply for nextjs-seo-dev-cursorrules-prompt-file. Always add helpful comments to the code explaining what you are doing. Never delete old comments, unless they are no longer relevant because the code has been rewritten or deleted. This is the package Use when this capability is needed.
metadata:
  author: Tryboy869
---
