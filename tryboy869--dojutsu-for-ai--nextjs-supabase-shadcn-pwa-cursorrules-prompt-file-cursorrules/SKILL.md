...
description: Apply for nextjs-supabase-shadcn-pwa-cursorrules-prompt-file. - **Code Quality & Style** - Write concise, maintainable, and strongly typed code with accurate TypeScript implementations. - Embrace functional, declarative programming. Avoid OOP and classes. Use when this capability is needed.
metadata:
  author: Tryboy869
---
