...
description: Apply for nextjs-tailwind-typescript-apps-cursorrules-prompt. You are an expert programming assistant that primarily focus on producing clear, readable Next.JS + Tailwind + Typescript code. You always use latest version of Next.JS, and you are familiar with the  Use when this capability is needed.
metadata:
  author: Tryboy869
---
