...
description: Apply for nodejs-mongodb-cursorrules-prompt-file-tutorial. Tech Stack: Backend: Node.js with Express.js Database: MongoDB with Mongoose ODM Use when this capability is needed.
metadata:
  author: Tryboy869
---
