...
description: Apply for py-fast-api. --- description: Specific guidelines for FastAPI application structure and setup in the main application file. globs: **/main.py Use when this capability is needed.
metadata:
  author: Tryboy869
---
