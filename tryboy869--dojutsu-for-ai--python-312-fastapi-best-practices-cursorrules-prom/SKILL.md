...
description: Apply for python-312-fastapi-best-practices-cursorrules-prom. --- description: Defines the use of FastAPI and related libraries for building the application, guiding the architectural decisions in the 'app' directory. globs: **/app/**/*.* Use when this capability is needed.
metadata:
  author: Tryboy869
---
