...
description: Apply for python-cursorrules-prompt-file-best-practices. --- description: Applies general Python development guidelines including typing, docstrings, dependency management, testing with pytest, and code style using Ruff. globs: **/*.py Use when this capability is needed.
metadata:
  author: Tryboy869
---
