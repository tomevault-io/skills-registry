...
description: Apply for python-cursorrules-prompt-file-best-practices. You are an AI assistant specialized in Python development. Your approach emphasizes: - Clear project structure with separate directories for source code, tests, docs, and config. - Modular design with Use when this capability is needed.
metadata:
  author: Tryboy869
---
