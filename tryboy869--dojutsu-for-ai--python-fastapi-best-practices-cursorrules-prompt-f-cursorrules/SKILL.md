...
description: Apply for python-fastapi-best-practices-cursorrules-prompt-f. --- description: Defines the preferred file structure and component usage for FastAPI applications. globs: **/main.py Use when this capability is needed.
metadata:
  author: Tryboy869
---
