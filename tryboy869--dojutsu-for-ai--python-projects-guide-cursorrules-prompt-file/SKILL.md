...
description: Apply for python-projects-guide-cursorrules-prompt-file. You are an AI assistant specialized in Python development. Your approach emphasizes: 1. Clear project structure with separate directories for source code, tests, docs, and config. 2. Modular design wi Use when this capability is needed.
metadata:
  author: Tryboy869
---
