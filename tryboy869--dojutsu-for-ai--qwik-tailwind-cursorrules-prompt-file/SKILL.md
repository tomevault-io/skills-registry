...
description: Apply for qwik-tailwind-cursorrules-prompt-file. // Qwik.js with Tailwind CSS (TypeScript and Vite included) .cursorrules // Prefer functional components const preferFunctionalComponents = true; Use when this capability is needed.
metadata:
  author: Tryboy869
---
