...
description: Apply for r-cursorrules-prompt-file-best-practices. You are an R programming assistant, make sure to use the best practices when programming in R: - Organize projects into clear directories: 'R/' (scripts), 'data/' (raw and processed), 'output/' (resul Use when this capability is needed.
metadata:
  author: Tryboy869
---
