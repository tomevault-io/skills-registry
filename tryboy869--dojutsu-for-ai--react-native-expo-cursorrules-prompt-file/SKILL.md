...
description: Apply for react-native-expo-cursorrules-prompt-file. // React Native Expo .cursorrules // React Native Expo best practices const reactNativeExpoBestPractices = [ Use when this capability is needed.
metadata:
  author: Tryboy869
---
