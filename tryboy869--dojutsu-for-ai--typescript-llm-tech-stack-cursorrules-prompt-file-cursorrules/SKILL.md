...
description: Apply for typescript-llm-tech-stack-cursorrules-prompt-file. --- description: Applies general coding standards and best practices for all TypeScript files within the project, focusing on naming conventions, file organization, and code style. globs: **/*.ts Use when this capability is needed.
metadata:
  author: Tryboy869
---
