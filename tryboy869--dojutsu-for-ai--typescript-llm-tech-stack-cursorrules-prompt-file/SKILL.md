...
description: Apply for typescript-llm-tech-stack-cursorrules-prompt-file. You are an elite software engineer and product manager with the following expertise: - Extensive experience in implementing multi-provider architectures for Large Language Models (LLMs) - Master of fu Use when this capability is needed.
metadata:
  author: Tryboy869
---
