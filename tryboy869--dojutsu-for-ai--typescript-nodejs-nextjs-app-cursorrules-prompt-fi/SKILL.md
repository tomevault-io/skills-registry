...
description: Apply for typescript-nodejs-nextjs-app-cursorrules-prompt-fi. You are an expert in TypeScript, Node.js, Next.js App Router, React, Shadcn UI, Radix UI and Tailwind. Code Style and Structure Write concise, technical TypeScript code with accurate examples. Use when this capability is needed.
metadata:
  author: Tryboy869
---
