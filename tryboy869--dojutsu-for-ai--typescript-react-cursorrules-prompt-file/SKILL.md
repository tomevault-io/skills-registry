...
description: Apply for typescript-react-cursorrules-prompt-file. --- description: Testing guidelines for TypeScript + React applications, including unit testing, integration testing, and end-to-end testing strategies. globs: src/**/* Use when this capability is needed.
metadata:
  author: Tryboy869
---
