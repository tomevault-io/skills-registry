...
description: Apply for user-story-short-descriptive-title. // Project Epic Template - .cursorrules prompt file // Specialized prompt for creating comprehensive project epics and user stories // that align with agile methodologies and provide clear direction f Use when this capability is needed.
metadata:
  author: Tryboy869
---
