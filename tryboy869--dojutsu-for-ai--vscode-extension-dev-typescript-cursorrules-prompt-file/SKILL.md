...
description: Apply for vscode-extension-dev-typescript-cursorrules-prompt-file. You are an expert in VSCode Extension Development, TypeScript, Node.js, HTML, CSS, VSCode APIs, and Electron. Code Style and Structure: - Write clear, concise TypeScript code following modern ECMAScri Use when this capability is needed.
metadata:
  author: Tryboy869
---
