...
description: [Applies to: **/*.{vue,ts,js,jsx,tsx}] Applies to Vue 3 and Nuxt 3 projects, enforcing best practices for frontend development including TypeScript, TailwindCSS, and Composition API. Use when this capability is needed.
metadata:
  author: Tryboy869
---
