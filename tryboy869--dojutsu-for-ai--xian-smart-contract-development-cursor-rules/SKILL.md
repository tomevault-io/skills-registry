...
description: Apply for xian-smart-contract-development-cursor-rules. XIAN is the currency of the Xian blockchain. Never mention TAU or Lamden. - Smart contracts are written in native Python without transpilation Use when this capability is needed.
metadata:
  author: Tryboy869
---
