---
name: tca
description: Expert guidance on The Composable Architecture (TCA) for Swift, focusing on ReducerProtocol, macros, and testability. Use when this capability is needed.
metadata:
  author: tryswift
---
