---
name: release
description: Review release readiness by checking ChangeLogs and version definitions and then create a git tag for the requested version. Use when asked to release or tag a version (e.g., "Please release 0.2.0", "Please tag 0.2.0") or to verify ChangeLog/version consistency before tagging. Use when this capability is needed.
metadata:
  author: ts-klassen
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ts-klassen) — claim your Tome and manage your conversions.
