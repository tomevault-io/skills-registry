...
description: Contour+kind cluster management (create/delete/setup), run Contour locally against cluster Envoy, development environment setup, custom image builds, debugging, e2e testing Use when this capability is needed.
metadata:
  author: tsaarni
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tsaarni) — claim your Tome and manage your conversions.
