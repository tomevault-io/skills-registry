...
description: Code file content generation guide. Use this skill when you need to create code files that can be previewed via `frago view`. Covers supported languages, theme selection, and best practices. Use when this capability is needed.
metadata:
  author: tsaijamey
---
