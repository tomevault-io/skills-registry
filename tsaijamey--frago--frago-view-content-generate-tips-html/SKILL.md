...
description: HTML/reveal.js content generation guide. Use this skill when you need to create HTML presentations that can be previewed via `frago view`. Covers reveal.js advanced design, CSS techniques, and multi-page collaboration workflow. Use when this capability is needed.
metadata:
  author: tsaijamey
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tsaijamey) — claim your Tome and manage your conversions.
