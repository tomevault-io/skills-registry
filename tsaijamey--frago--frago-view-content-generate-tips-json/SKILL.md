...
description: JSON file content generation guide. Use this skill when you need to create JSON files that can be previewed via `frago view`. Covers formatted display and best practices. Use when this capability is needed.
metadata:
  author: tsaijamey
---
