...
description: Markdown document content generation guide. Use this skill when you need to create Markdown documents that can be previewed via `frago view`. Covers element support, Mermaid charts, and best practices. Use when this capability is needed.
metadata:
  author: tsaijamey
---
