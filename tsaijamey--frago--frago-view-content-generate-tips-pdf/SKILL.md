...
description: PDF file content generation guide. Use this skill when you need to understand how `frago view` previews PDF files. Covers rendering features and limitations. Use when this capability is needed.
metadata:
  author: tsaijamey
---
