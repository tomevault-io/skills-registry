...
description: Concrete event filters/queries to run next (by EventID and fields). Use when this capability is needed.
metadata:
  author: tsale
---
...
---
> Source: [tsale/awesome-dfir-skills](https://github.com/tsale/awesome-dfir-skills) — distributed by [TomeVault](https://tomevault.io).
