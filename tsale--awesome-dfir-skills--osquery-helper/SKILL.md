...
description: Help users write, validate, and troubleshoot osquery SQL queries using provided osquery table schemas as the authoritative source. Use when this capability is needed.
metadata:
  author: tsale
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tsale) — claim your Tome and manage your conversions.
