---
name: intent-layer
description: Authoring guide for building and maintaining an Intent Layer (AGENTS.md/CLAUDE.md intent nodes): progressive disclosure, LCA deduplication, leaf-first updates. Use when this capability is needed.
metadata:
  author: tshu-w
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tshu-w) — claim your Tome and manage your conversions.
