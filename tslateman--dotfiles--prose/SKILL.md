---
name: prose
description: Apply Strunk's writing rules to prose—documentation, commits, error messages, UI text. Clearer, stronger, more professional. Use when this capability is needed.
metadata:
  author: tslateman
---
