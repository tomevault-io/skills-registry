---
name: design
description: Intentional design thinking for interfaces, components, and systems. Use when the user asks to "build a UI", "design a page", "create a component", "make this look good", "design an API", "design a system", or any task where aesthetic or structural design decisions matter. Use when this capability is needed.
metadata:
  author: tslateman
---
