...
description: Comprehensive code review tool for solo engineers. Analyzes code for bugs, security issues, performance problems, and style violations. Triggers on "review", "code review", "PR review", "check my code", "security review", "find bugs". Use when this capability is needed.
metadata:
  author: tsolman
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tsolman) — claim your Tome and manage your conversions.
