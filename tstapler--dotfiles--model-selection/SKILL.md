...
description: Select appropriate Claude model (Opus 4.5, Sonnet, Haiku) for agents, commands, or Task tool invocations based on task complexity, reasoning depth, and cost/speed requirements. Use when this capability is needed.
metadata:
  author: tstapler
---
