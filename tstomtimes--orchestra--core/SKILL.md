---
name: core
description: Core development principles and guidelines covering security, QA, performance, documentation, and coding standards. Used by all agents to ensure consistent quality across the Orchestra system. Use when this capability is needed.
metadata:
  author: tstomtimes
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tstomtimes) — claim your Tome and manage your conversions.
