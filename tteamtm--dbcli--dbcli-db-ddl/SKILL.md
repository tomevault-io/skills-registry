---
name: dbcli-db-ddl
description: description: Execute DDL (Data Definition Language) statements - CREATE, ALTER, DROP tables, indexes, views on 30+ databases using DbCli. CRITICAL - requires mandatory backup before DROP/ALTER operations. Use when user needs to create schema, modify structure, or drop database objects. Use when this capability is needed.
metadata:
  author: tteamtm
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tteamtm) — claim your Tome and manage your conversions.
