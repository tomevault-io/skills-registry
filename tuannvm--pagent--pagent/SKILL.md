---
name: pagent
description: Guide for using pagent - a PRD-to-code orchestration tool. Use when users ask how to use pagent, run agents, create PRDs, or transform requirements into code. Use when this capability is needed.
metadata:
  author: tuannvm
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tuannvm) — claim your Tome and manage your conversions.
