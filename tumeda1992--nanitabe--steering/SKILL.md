---
name: steering
description: Spec-driven plan を steering に落とす。Design合意→Tasklist合意で終了。実装は別コマンド。明示的に指定されたときはもちろん、軽度の修正でない場合（複数ファイルの編集、ステップを持つ修正）にはこのスキルを起動する Use when this capability is needed.
metadata:
  author: tumeda1992
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tumeda1992) — claim your Tome and manage your conversions.
