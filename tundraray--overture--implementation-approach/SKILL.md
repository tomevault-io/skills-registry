...
description: This skill provides implementation strategy selection framework with meta-cognitive approach, verification levels, and integration point definitions. Automatically loaded when planning implementation strategy, selecting development approach, defining verification criteria, or when "vertical slice", "horizontal slice", "verification level", or "implementation strategy" are mentioned. Use when this capability is needed.
metadata:
  author: tundraray
---
