...
description: 9 principles for writing effective rules that maximize LLM execution accuracy. Use when creating or modifying skills, agent prompts, or command instructions. Use when this capability is needed.
metadata:
  author: tundraray
---
