---
name: turix-mac
description: Computer Use Agent (CUA) for macOS automation using TuriX. Use when you need to perform visual tasks on the desktop, such as opening apps, clicking buttons, or navigating UIs that don't have a CLI or API. Use when this capability is needed.
metadata:
  author: TurixAI
---
...
---
> Source: [TurixAI/TuriX-CUA](https://github.com/TurixAI/TuriX-CUA) — distributed by [TomeVault](https://tomevault.io).
