---
name: marketing-team
description: Orchestrate a complete AI-powered marketing team for AI chatbot and voice agent business. Spawn marketing agent swarms for campaigns, content sprints, outbound blitzes, and funnel optimization. Use when you need to execute marketing activities like content creation, SEO, outbound campaigns, CRO audits, sales enablement, or multi-channel launches. Use when this capability is needed.
metadata:
  author: tutafranko-web
---
...
---
> Source: [tutafranko-web/automatska-firma-](https://github.com/tutafranko-web/automatska-firma-) — distributed by [TomeVault](https://tomevault.io).
