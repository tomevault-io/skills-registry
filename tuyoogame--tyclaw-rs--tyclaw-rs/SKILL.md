---
name: unnamed-skill
description: 管理钉钉日程，包括创建/查询/修改日程、管理参与者、查看忙闲状态、预定会议室 Use when this capability is needed.
metadata:
  author: tuyoogame
---
...
---
> Source: [tuyoogame/tyclaw.rs](https://github.com/tuyoogame/tyclaw.rs) — distributed by [TomeVault](https://tomevault.io).
