---
name: screenshot
description: Capture PNG screenshots of dex TUI commands for debugging UI layout issues. Use when iterating on CLI interface code or debugging rendering problems. Use when this capability is needed.
metadata:
  author: tvergho
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tvergho) — claim your Tome and manage your conversions.
