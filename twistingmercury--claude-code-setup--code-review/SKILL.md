---
name: code-review
description: Orchestrates a 3-agent parallel code review combining pattern compliance, Go conventions, and architectural analysis. Use when this capability is needed.
metadata:
