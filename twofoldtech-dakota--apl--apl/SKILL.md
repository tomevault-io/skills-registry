---
name: apl
description: Autonomous Phased Looper - Complete digital experience agent. Handles coding, content, deployment, design, research, analytics, QA, docs, and performance. Use when this capability is needed.
metadata:
