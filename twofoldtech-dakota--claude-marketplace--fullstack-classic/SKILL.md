...
description: Apply when working with classic fullstack patterns including jQuery AJAX, form handling, and C# MVC integration Use when this capability is needed.
metadata:
