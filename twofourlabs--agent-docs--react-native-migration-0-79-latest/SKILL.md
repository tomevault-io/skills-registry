...
description: This skill provides a migration guide for react native from 0.79.x to latest 0.83.x version. Use when this capability is needed.
metadata:
  author: twofourlabs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/twofourlabs) — claim your Tome and manage your conversions.
