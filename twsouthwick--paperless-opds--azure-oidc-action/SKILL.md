...
description: Guides through Azure AD and OIDC federation configuration for GitHub Actions deployments. Use when setting up Azure authentication, creating service principals, configuring federated credentials, or troubleshooting OIDC authentication errors like AADSTS700016 or AADSTS70021. Use when this capability is needed.
metadata:
  author: twsouthwick
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/twsouthwick) — claim your Tome and manage your conversions.
