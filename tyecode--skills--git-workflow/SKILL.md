---
name: git-workflow
description: Passive guardrail that enforces Git workflow guidelines. Install globally — the agent applies commit conventions, branch naming, and PR rules automatically without being asked. Use when this capability is needed.
metadata:
  author: tyecode
---
...
---
> Source: [tyecode/skills](https://github.com/tyecode/skills) — distributed by [TomeVault](https://tomevault.io).
