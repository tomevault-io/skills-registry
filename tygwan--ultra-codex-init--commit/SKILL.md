---
name: commit
description: Git commit workflow with Conventional Commits format. Analyzes changes, generates commit message, handles staging. Use when this capability is needed.
metadata:
  author: tygwan
---
