---
name: doc-splitter
description: Documentation splitting and Phase structure creation expert. Split large documents, create Phase folders, manage cross-references. Responds to "document", "split", "phase structure", "organize" keywords. Use when this capability is needed.
metadata:
  author: tygwan
---
