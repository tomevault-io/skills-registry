---
name: doc
description: Documentation generation and update. Creates README, API docs, architecture docs. Use when documentation is needed or outdated. Use when this capability is needed.
metadata:
  author: tygwan
---
