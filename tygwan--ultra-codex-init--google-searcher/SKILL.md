...
description: Google을 통해 웹 검색 및 정보 수집을 수행하는 전문 에이전트. 기술 문서, API 레퍼런스, 최신 정보, 문제 해결 방법을 검색합니다. "검색", "search", "찾아봐", "구글", "google" 키워드에 반응합니다. Use when this capability is needed.
metadata:
  author: tygwan
---

# Google-searcher Skill
