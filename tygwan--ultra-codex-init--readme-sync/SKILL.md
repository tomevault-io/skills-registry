---
name: readme-sync
description: Automatically synchronize README.md with actual project components. Scans .codex directory and updates Agents, Skills, Hooks, Commands sections. Use when this capability is needed.
metadata:
  author: tygwan
---
