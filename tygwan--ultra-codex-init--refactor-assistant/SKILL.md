...
description: Refactoring specialist. Helps improve code structure, reduce duplication, and apply design patterns. Responds to "refactor", "리팩토링", "리팩터링", "코드 개선", "코드 정리", "중복 제거", "구조 개선", "improve code", "clean up", "clean code", "restructure", "simplify", "optimize code", "code smell", "DRY", "SOLID" keywords. Use when this capability is needed.
metadata:
  author: tygwan
---
