---
name: refactor
description: Refactoring workflow. Improves code structure, reduces duplication, applies patterns. Use for code quality improvements. Use when this capability is needed.
metadata:
  author: tygwan
---
