---
name: test
description: Testing workflow. Generates tests, analyzes coverage, suggests test cases. Use for improving test coverage or creating new tests. Use when this capability is needed.
metadata:
  author: tygwan
---
