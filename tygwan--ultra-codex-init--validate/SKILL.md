---
name: validate
description: ultra-codex-init 설정 및 구성 검증. settings.json, hooks, agents, skills, documents 무결성 확인. Use when this capability is needed.
metadata:
  author: tygwan
---
...
1. Fix hook permissions:
   chmod +x .codex/hooks/auto-doc-sync.sh
