...
description: Grafixアート反復（N回・M並列）を、エージェント直書きで自動実行し、成果物をsketch/agent_loop配下へ保存する。このモードでは計画 md の新規作成は不要とする。 Use when this capability is needed.
metadata:
  author: tyhts0829
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tyhts0829) — claim your Tome and manage your conversions.
