---
name: rules-creator
description: Create or improve AGENTS.md/CLAUDE.md files for AI coding agents. Use when setting up a new project for AI assistance, auditing an existing rules file, or when the user asks about best practices for agent instructions. Use when this capability is needed.
metadata:
  author: tylerbodway
---
