...
description: Implements backend features following Librarian's DDD patterns. Use when adding backend functionality, creating modules, or implementing domain logic in Rust. Provides step-by-step workflows for types.rs → repository.rs → mod.rs → commands.rs pattern. Use when this capability is needed.
metadata:
  author: tylerferrin
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tylerferrin) — claim your Tome and manage your conversions.
