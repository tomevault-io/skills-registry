---
name: ui-components
description: Implement and migrate to shadcn/ui components. Use when working with UI components, replacing native HTML form elements, or when the user asks about shadcn components, Select, Button, Input, or UI consistency. Use when this capability is needed.
metadata:
  author: tylerferrin
---
