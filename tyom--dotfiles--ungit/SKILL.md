---
name: ungit
description: Fetch code from GitHub repositories as LLM-friendly context. Use when needing to reference, analyze, or understand code from a GitHub repo/directory/file. Use when this capability is needed.
metadata:
  author: tyom
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tyom) — claim your Tome and manage your conversions.
