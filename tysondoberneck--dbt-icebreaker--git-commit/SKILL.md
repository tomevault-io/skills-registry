---
name: git-commit
description: Safely commit and push changes to the dbt-icebreaker repository using the tysondoberneck GitHub account. Use when this capability is needed.
metadata:
  author: tysondoberneck
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tysondoberneck) — claim your Tome and manage your conversions.
