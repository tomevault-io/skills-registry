...
description: Maps query single-cell data to reference atlases using scArches transfer learning with scVI and scANVI models. Transfers cell type labels without retraining on combined data. Use when annotating new single-cell datasets using pre-trained reference models. Use when this capability is needed.
metadata:
  author: tywei08
---
...
---
> Source: [tywei08/bioskills-plugin](https://github.com/tywei08/bioskills-plugin) — distributed by [TomeVault](https://tomevault.io).
