---
name: scout
description: Analyze a legacy codebase - maps architecture, identifies patterns (good and bad), finds inconsistencies, and suggests non-breaking migrations. Use when you want to understand or improve a legacy codebase. Use when this capability is needed.
metadata:
  author: tywenk
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/tywenk) — claim your Tome and manage your conversions.
