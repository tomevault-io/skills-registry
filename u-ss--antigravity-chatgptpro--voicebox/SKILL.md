...
description: gpt-oss:20bモーラ演出ディレクター統合・高品質TTS Use when this capability is needed.
metadata:
  author: u-ss
---
...
| 条件 | モード | 参照 |
|:-----|:-------|:-----|
| gpt-oss:20b利用可能（デフォルト） | Standard | `modes/standard.md` |
| gpt-oss:20b不可 or 明示指定 | Fallback | `modes/fallback.md` |
