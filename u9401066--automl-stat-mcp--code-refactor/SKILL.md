---
name: code-refactor
description: Proactively detect and execute code refactoring to maintain DDD architecture and code quality. Use when code is too complex, violates DRY principle, or needs restructuring. Triggers: RF, refactor, 重構, 拆分, split, 模組化, modularize, 太長, cleanup, 簡化, simplify, 整理程式碼. Use when this capability is needed.
metadata:
  author: u9401066
---
