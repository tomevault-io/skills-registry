...
description: Complete feature delivery workflow including testing, documentation, and handoff to ensure features are production-ready. Use when a feature is complete and needs final checks before release. Triggers: DELIVER, 交付, 完成功能, feature done, ship it, 交給用戶, ready to ship, 可以上線, 發布, release, 準備好了. Use when this capability is needed.
metadata:
  author: u9401066
---
