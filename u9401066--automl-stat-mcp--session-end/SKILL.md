---
name: session-end
description: Properly end work session by saving context to Memory Bank and creating handoff documentation for future sessions. Use when finishing work for the day, taking a break, or wrapping up. Triggers: END, 結束, 收工, 下班, 今天到這, 先這樣, bye, done for today, wrap up, 結束工作, 先休息, 我要走了, 掙. Use when this capability is needed.
metadata:
  author: u9401066
---
