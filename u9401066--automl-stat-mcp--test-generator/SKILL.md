---
name: test-generator
description: Generate comprehensive test suites including unit tests, integration tests, E2E tests, and coverage reports. Use when writing tests, improving coverage, or validating functionality. Triggers: TG, test, 測試, 寫測試, coverage, 覆蓋率, pytest, unittest, 驗證, 測試案例, test case. Use when this capability is needed.
metadata:
  author: u9401066
---
