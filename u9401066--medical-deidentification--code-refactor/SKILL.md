---
name: code-refactor
description: Proactively suggest and execute code refactoring to maintain clean architecture. Triggers: refactor, 重構, 優化程式碼, clean up, 整理程式碼. Use when this capability is needed.
metadata:
  author: u9401066
---
