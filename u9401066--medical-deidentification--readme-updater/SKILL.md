---
name: readme-updater
description: Intelligently update README.md to keep it in sync with code changes. Triggers: readme, 更新 README, update readme, 文檔同步. Use when this capability is needed.
metadata:
  author: u9401066
---
