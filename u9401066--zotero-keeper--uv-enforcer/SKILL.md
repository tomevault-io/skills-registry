---
name: uv-enforcer
description: Enforce uv-only package management policy. Reject all pip usage in code, docs, CI. Triggers: UV, uv, pip, package, 套件, 安裝, install, 環境, environment, dependency, 依賴. Use when this capability is needed.
metadata:
  author: u9401066
---
