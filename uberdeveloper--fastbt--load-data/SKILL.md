---
name: load-data
description: Ultra-fast data discovery and loading skill for industrial finance datasets. Handles CSV, JSON, DuckDB, Parquet, and Feather with memory-efficient 2-step discovery and loading. Use when this capability is needed.
metadata:
  author: uberdeveloper
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uberdeveloper) — claim your Tome and manage your conversions.
