---
name: anki-cli
description: Manage Anki flashcards via CLI with structured JSON output. Create, query, review, and organize cards, notes, decks, tags, and notetypes. Supports AnkiConnect and direct SQLite backends. Use when the user mentions Anki, flashcards, spaced repetition, SRS, reviewing cards, or managing decks. Use when this capability is needed.
metadata:
  author: ubermenchh
---
...
---
> Source: [ubermenchh/anki-cli](https://github.com/ubermenchh/anki-cli) — distributed by [TomeVault](https://tomevault.io).
