...
description: Guide the execution of Lightdash Terraform provider acceptance tests, ensuring correct environment setup and targeted test execution. Use when this capability is needed.
metadata:
  author: ubie-oss
---
