...
description: Use when working with a council of Product Owners representing the four key personas (Agent, Bettor, Fan, GM). Use this skill to solicit feature requirements, prioritization, and acceptance criteria.
metadata:
  author: ucalegon206
---
