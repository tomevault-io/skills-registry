...
description: Master of the "Quality Gate." Focuses on Data Integrity, Contract Testing (Scrapers), and the "Automation of Frustration" (Developer DX). Use when this capability is needed.
metadata:
  author: ucalegon206
---
