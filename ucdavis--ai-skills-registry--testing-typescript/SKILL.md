...
description: TypeScript testing with Vitest/Jest: file structure, mocking strategy, async patterns, and coverage targets Use when this capability is needed.
metadata:
  author: ucdavis
---
