...
description: Git変更の論理的分割、Conventional Commitsメッセージ生成、プロジェクト規約検出。大きな変更を意味のある最小単位に分割してコミットする際に使用。 Use when this capability is needed.
metadata:
  author: udus122
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/udus122) — claim your Tome and manage your conversions.
