---
name: claude-dj
description: Run an autonomous network radio DJ session using Strudel live-coded music. Audio is rendered server-side and streamed as MP3 — anyone on the LAN can tune in. Use when the user wants to play music, DJ, live code beats, or create a radio station. Handles the full DJ loop including pattern creation, announcements heard by all listeners, tempo control, and audience requests. Use when this capability is needed.
metadata:
  author: uetuluk
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uetuluk) — claim your Tome and manage your conversions.
