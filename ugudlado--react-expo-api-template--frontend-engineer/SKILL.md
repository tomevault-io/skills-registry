...
description: Expert in web app frontend architecture, React patterns, TypeScript, TanStack Query, Zustand, and component development with strong type safety. Use when building UI components, implementing data fetching, managing state, writing forms, styling with Tailwind, testing React components, or integrating with backend APIs. Use when this capability is needed.
metadata:
  author: ugudlado
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ugudlado) — claim your Tome and manage your conversions.
