...
description: Identify the best UI Potion guide for a requested component, layout, or feature by searching the index and returning relevant JSON guide URLs and human-readable pages. Use when the user is unsure which potion to use or asks for recommendations. Use when this capability is needed.
metadata:
  author: uipotion
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uipotion) — claim your Tome and manage your conversions.
