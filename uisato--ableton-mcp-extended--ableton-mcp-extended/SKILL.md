...
description: Professional songwriting workflow for Ableton: structured intake, production brief, composition/arrangement execution, plugin-aware instrument loading, quick mix, QA, and revision handoff. Use when this capability is needed.
metadata:
  author: uisato
---
...
---
> Source: [uisato/ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended) — distributed by [TomeVault](https://tomevault.io).
