---
name: memcord
description: Privacy-first, self-hosted chat memory for OpenClaw — save and recall conversation history across sessions without any cloud dependency. Use when this capability is needed.
metadata:
  author: ukkit
---
