...
description: コードベース包括的レビュー。6観点（perf/sec/test/arch/cq/docs）を並列サブエージェントで実行し、優先度付きissueファイルをメモリディレクトリに生成。 Use when this capability is needed.
metadata:
  author: ukwhatn
---
...
各観点のレビュー項目・優先度基準の詳細は [references/review-aspects.md](references/review-aspects.md) を参照。
共通テンプレートの `## あなたの担当観点` セクションに、該当観点の内容を挿入すること。
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ukwhatn) — claim your Tome and manage your conversions.
