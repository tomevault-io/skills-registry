---
name: next
description: Next.js framework for building React applications with App Router, Server Components, and optimized performance. Use when working with Next.js apps, routing, data fetching, caching, Server Actions, or building full-stack React applications. Use when this capability is needed.
metadata:
  author: ulpi-io
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ulpi-io) — claim your Tome and manage your conversions.
