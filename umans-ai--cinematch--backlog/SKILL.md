---
name: backlog
description: Backlog workflow management - new, start, done commands for incremental delivery. Supports both admin (main branch) and contributor (feature branch) workflows. Use when this capability is needed.
metadata:
  author: umans-ai
---
