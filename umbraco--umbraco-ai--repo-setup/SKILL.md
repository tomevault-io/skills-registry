---
name: repo-setup
description: Performs initial repository setup including git hooks, demo site creation, and dependency installation. Use when cloning the repository for the first time, onboarding a new developer, or resetting the development environment. Use when this capability is needed.
metadata:
  author: umbraco
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/umbraco) — claim your Tome and manage your conversions.
