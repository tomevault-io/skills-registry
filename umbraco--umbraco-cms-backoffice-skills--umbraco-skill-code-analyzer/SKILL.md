...
description: Analyze code examples in SKILL.md files for correctness using static analysis and TypeScript compilation Use when this capability is needed.
metadata:
  author: umbraco
---
