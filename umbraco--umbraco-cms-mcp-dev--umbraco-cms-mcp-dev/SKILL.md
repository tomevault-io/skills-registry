...
description: Guide for running and debugging this Umbraco MCP server via the CLI. Use when the user wants to list tools, call tools, configure filtering, dry-run, readonly mode, or debug configuration. Use when this capability is needed.
metadata:
  author: umbraco
---
...
---
> Source: [umbraco/Umbraco-CMS-MCP-Dev](https://github.com/umbraco/Umbraco-CMS-MCP-Dev) — distributed by [TomeVault](https://tomevault.io).
