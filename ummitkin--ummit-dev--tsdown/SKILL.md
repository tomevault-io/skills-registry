---
name: tsdown
description: tsdown fast TypeScript library bundler powered by Rolldown and Oxc. Use when bundling TypeScript libraries, configuring entry points, or generating .d.ts declaration files. Use when this capability is needed.
metadata:
  author: ummitkin
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ummitkin) — claim your Tome and manage your conversions.
