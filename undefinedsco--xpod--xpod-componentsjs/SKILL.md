...
description: Xpod Components.js 变量和组件配置专家，处理 CLI 参数、变量解析、组件配置等问题 Use when this capability is needed.
metadata:
  author: undefinedsco
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/undefinedsco) — claim your Tome and manage your conversions.
