---
name: op
description: Manage 1Password secrets. Use when user wants to list, get, or read passwords, OTP codes, API keys, or other secrets from 1Password. Use when this capability is needed.
metadata:
  author: underwear
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/underwear) — claim your Tome and manage your conversions.
