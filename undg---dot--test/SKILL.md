---
name: test
description: Specialized agent for all test-related work (create, update, add tests). Load when writing, modifying, or reviewing tests. Handles test creation, updates, coverage analysis, and best practices for testing across multiple frameworks. Use when this capability is needed.
metadata:
  author: undg
---
