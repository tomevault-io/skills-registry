...
description: Build production-grade UI/UX with React (Next.js, Docusaurus), CSS architecture (Tailwind, Modules, Global), animations, theming, performance optimization, state management, and testing. Use when creating React components, building layouts, refactoring CSS, implementing animations, auditing accessibility, optimizing performance, setting up state management, or writing component tests. Use when this capability is needed.
metadata:
  author: uneezaismail
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uneezaismail) — claim your Tome and manage your conversions.
