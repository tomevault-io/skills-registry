---
name: ros2-standards
description: Authoritative guidelines for writing production-grade ROS 2 (Humble) Python 3.11+ code (leveraging 3.12+ features where compatible) for Physical AI applications. Use when this capability is needed.
metadata:
  author: uneezaismail
---
