...
description: [DEPRECATED] Use add-highlight --tweet instead. Tweets existing highlight without deployment verification. Use when this capability is needed.
metadata:
  author: unfinishablemap
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/unfinishablemap) — claim your Tome and manage your conversions.
