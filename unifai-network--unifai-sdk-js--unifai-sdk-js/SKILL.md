---
name: unifai
description: Use when working with a CLI for searching and invoking services on the UnifAI network. Supports 40+ services across DeFi, token data, social media, web search, news, travel, sports, and utilities.
metadata:
  author: unifai-network
---
...
---
> Source: [unifai-network/unifai-sdk-js](https://github.com/unifai-network/unifai-sdk-js) — distributed by [TomeVault](https://tomevault.io).
