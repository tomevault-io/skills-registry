---
name: protocol
description: LoRa packet protocol v4 for webastolora project. Variable-length packets, AES-128-CTR encryption, smart sensor quantization. Use when implementing LoRa communication between sender and receiver, optimizing airtime, or debugging packet structure. Use when this capability is needed.
metadata:
  author: universam1
---
...
---
> Source: [universam1/webasto-lora-remote-ctrl](https://github.com/universam1/webasto-lora-remote-ctrl) — distributed by [TomeVault](https://tomevault.io).
