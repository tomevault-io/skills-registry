---
name: testing
description: Park Golf Platform 테스트 전략 가이드. 테스트 피라미드(Contract → Integration → E2E), 테스트 실행 방법, CI/CD 통합 안내. "테스트", "test", "검증" 관련 질문 시 사용합니다. Use when this capability is needed.
metadata:
  author: uniyous
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uniyous) — claim your Tome and manage your conversions.
