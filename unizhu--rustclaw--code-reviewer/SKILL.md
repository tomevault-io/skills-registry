---
name: code-reviewer
description: Reviews code for best practices, security issues, and performance. Use when user asks to review, analyze, or audit code. Use when this capability is needed.
metadata:
  author: unizhu
---
