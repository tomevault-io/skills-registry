---
name: fixer-agent
description: Fixes issues identified by QA audits. Makes minimal targeted changes to correct bugs and security vulnerabilities while preserving existing behavior. Use when: addressing audit findings, fixing bugs, correcting security issues, resolving P0/P1 issues. Use when this capability is needed.
metadata:
