---
name: fast-mlx
description: Optimize MLX code for performance and memory. Use when asked to implement or speed up MLX models or algorithms, reduce latency/throughput bottlenecks, tune lazy evaluation, type promotion, fast ops, compilation, memory use, or profiling. Use when this capability is needed.
metadata:
  author: unsanitary-bek
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/unsanitary-bek) — claim your Tome and manage your conversions.
