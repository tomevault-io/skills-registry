---
name: ori-syntax
description: Ori language syntax reference. Use when writing Ori code, checking syntax, understanding types, patterns, or prelude functions. Use when this capability is needed.
metadata:
  author: upstat-io
---
