...
description: This skill should be used when working with "git worktree", "parallel git branches", "worktree merge", "isolated development", or managing multiple branches simultaneously for team-based code generation. Use when this capability is needed.
metadata:
  author: ureca-corp
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ureca-corp) — claim your Tome and manage your conversions.
