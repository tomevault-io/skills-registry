---
name: graphql-module
description: Each module in `src/modules/<name>/` contains: Use when this capability is needed.
metadata:
  author: Urigo
---
...
---
> Source: [Urigo/accounter-fullstack](https://github.com/Urigo/accounter-fullstack) — distributed by [TomeVault](https://tomevault.io).
