---
name: supabase
description: Supabase database management including migrations, RLS policies, seed data, auth configuration, and local development. Database files in api/supabase/. Use when this capability is needed.
metadata:
  author: urjitbhatia
---
