---
name: types
description: TypeScript type generation and synchronization between backend OpenAPI and frontend. Auto-generates types from /openapi.json using openapi-typescript. Critical after any API change. Use when this capability is needed.
metadata:
  author: urjitbhatia
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/urjitbhatia) — claim your Tome and manage your conversions.
