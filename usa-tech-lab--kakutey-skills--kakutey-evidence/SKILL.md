...
description: Upload and search evidence files (receipts, invoices, statements) in the kakutey bookkeeping app. Use when attaching supporting documents to journal entries. Use when this capability is needed.
metadata:
  author: usa-tech-lab
---
