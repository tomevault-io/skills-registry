...
description: Download and set up the kakutey bookkeeping application from GitHub. Run once before first use or after major updates to reinstall dependencies. Use when this capability is needed.
metadata:
  author: usa-tech-lab
---
