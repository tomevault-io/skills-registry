...
description: Stop the running kakutey application by terminating backend (port 8000) and frontend (port 4200) processes. Use when done with bookkeeping operations or before restarting the app. Use when this capability is needed.
metadata:
  author: usa-tech-lab
---
