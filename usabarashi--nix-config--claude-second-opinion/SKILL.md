...
description: For non-Claude agents only (Codex, Gemini). Get an external second opinion from Claude CLI on a decision with uncertain trade-offs or multiple viable options. Claude agents must use gemini-second-opinion instead. Use when this capability is needed.
metadata:
  author: usabarashi
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/usabarashi) — claim your Tome and manage your conversions.
