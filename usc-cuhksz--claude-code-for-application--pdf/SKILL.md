...
|--------|-------------|-------|
| `extract_text.py` | Extract text from PDF | `python extract_text.py <input.pdf> [output.txt]` |
| `extract_form_field_info.py` | Extract form field information | `python extract_form_field_info.py <input.pdf>` |
| `fill_fillable_fields.py` | Fill PDF form fields | `python fill_fillable_fields.py <input.pdf> <data.json> <output.pdf>` |
| `check_fillable_fields.py` | Check if PDF has fillable fields | `python check_fillable_fields.py <input.pdf>` |
