...
description: Helps volunteers set up, update, and troubleshoot the Translation Harness MCP server for Claude Desktop. Use when someone asks how to get started with the translation harness, install or configure it, connect it to Claude Desktop, update it after changes, or fix a problem with it not working. Use when this capability is needed.
metadata:
  author: usdigitalresponse
---
...
---
> Source: [usdigitalresponse/usdr-translation-harness](https://github.com/usdigitalresponse/usdr-translation-harness) — distributed by [TomeVault](https://tomevault.io).
