...
description: Audit npm, pip, and Go dependencies that OpenClaw skills try to install. Checks for known vulnerabilities, typosquatting, Use when this capability is needed.
metadata:
  author: UseAI-pro
---
...
---
> Source: [UseAI-pro/openclaw-skills-security](https://github.com/UseAI-pro/openclaw-skills-security) — distributed by [TomeVault](https://tomevault.io).
