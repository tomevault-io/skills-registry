---
name: plan-revision
description: 规划修订导航。触发：用户通知"analysis-agent已分析完成"或需要plan-agent查看analysis-agent复审结果并修订预定清单时使用；评估analysis-agent分析结果并修订draft-plan.md。 Use when this capability is needed.
metadata:
