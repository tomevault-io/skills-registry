...
description: Construye herramientas Python limpias, eficientes y fáciles de mantener. Sigue principios de diseño modular, tipado estático (Type Hints) y gestión profesional de dependencias. Use when this capability is needed.
metadata:
  author: userlg
---
