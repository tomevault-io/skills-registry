...
description: Integra frontend y backend de forma coherente. Define contratos de API claros, comparte tipos (TypeScript) y maneja estados de servidor eficientemente. Use when this capability is needed.
metadata:
  author: userlg
---
