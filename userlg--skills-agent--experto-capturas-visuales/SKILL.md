...
description: Experto diseñador de imágenes e ilustraciones. Extrae capturas de pantallas (screenshots) atractivas del proyecto, las retoca para estilo (mockups, frames, sombras) y las organiza en alta resolución para portafolios o documentación. Use when this capability is needed.
metadata:
  author: userlg
---
