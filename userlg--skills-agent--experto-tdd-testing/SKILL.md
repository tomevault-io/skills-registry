...
description: Prioriza código testeable y genera pruebas automatizadas antes o junto con el código productivo. Úsalo para asegurar la calidad del software, reducir bugs y facilitar refactorizaciones futuras mediante metodologías TDD (Test Driven Development). Use when this capability is needed.
metadata:
  author: userlg
---
