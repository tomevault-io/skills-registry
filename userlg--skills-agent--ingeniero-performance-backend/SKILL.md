...
description: Optimiza consultas SQL, uso de memoria y latencia del backend. Identifica cuellos de botella y propone soluciones escalables. Use when this capability is needed.
metadata:
  author: userlg
---
