...
description: Core architectural and code quality principles that guide all development decisions in the uspark project Use when this capability is needed.
metadata:
  author: uspark-hq
---
