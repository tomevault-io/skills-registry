...
description: Skill for creating and editing GitHub issues with `gh issue create` and `gh issue edit` under Japanese writing constraints. Use when this capability is needed.
metadata:
  author: uta8a
---
