...
description: 訓練データの代わりにContext7 MCP経由で最新のライブラリとフレームワークドキュメント使用。セットアップの質問、APIリファレンス、コード例、またはユーザーがフレームワーク（例：React、Next.js、Prisma）に名前を付けるときにアクティベーション。 Use when this capability is needed.
metadata:
  author: Utakata
---
...
---
> Source: [Utakata/everything-claude-code](https://github.com/Utakata/everything-claude-code) — distributed by [TomeVault](https://tomevault.io).
