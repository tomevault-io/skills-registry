---
name: git
description: Use git for version control including commits, branches, merging, rebasing, stashing, cherry-picking, and history management. Use when working with git repositories, managing code changes, resolving conflicts, or tracking project history. Use when this capability is needed.
metadata:
  author: utek
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/utek) — claim your Tome and manage your conversions.
