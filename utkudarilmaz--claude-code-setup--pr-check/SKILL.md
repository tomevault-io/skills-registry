---
name: pr-check
description: This skill should be used when the user asks to "review my PR", "check if PR is ready", "run PR checklist", "verify PR quality", "review pull request", or "/pr-check". Reviews test coverage, secrets, error handling, and documentation against a quality checklist. Use when this capability is needed.
metadata:
  author: utkudarilmaz
---
