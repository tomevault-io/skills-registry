...
description: Work with astronomical data using AstroPy for FITS file I/O, coordinate transformations, physical units, precise time handling, catalog cross-matching, photutils photometry, and specutils spectroscopy. Use when this capability is needed.
metadata:
  author: uw-ssec
---
