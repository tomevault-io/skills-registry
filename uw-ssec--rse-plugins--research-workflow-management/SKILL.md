...
description: Structured AI-enabled research workflows for software development. Covers the six-phase workflow (Research, Plan, Iterate Plan, Experiment, Implement, Validate) with templates for each phase. Use when this capability is needed.
metadata:
  author: uw-ssec
---
