...
description: Work with labeled multidimensional arrays for scientific data analysis using Xarray. Covers NetCDF/HDF5/Zarr I/O, Dask integration for large datasets, DataTree, and geospatial raster operations with rioxarray. Use when this capability is needed.
metadata:
  author: uw-ssec
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uw-ssec) — claim your Tome and manage your conversions.
