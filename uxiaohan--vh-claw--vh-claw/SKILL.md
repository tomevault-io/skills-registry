...
description: 小红书笔记写作助手 - 标题优化、emoji策略、话题标签、封面文案、笔记结构 Use when this capability is needed.
metadata:
  author: uxiaohan
---
...
---
> Source: [uxiaohan/vh-claw](https://github.com/uxiaohan/vh-claw) — distributed by [TomeVault](https://tomevault.io).
