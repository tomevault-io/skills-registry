---
name: enterprise-ai-agent-deployment-framework
description: Use when working with a structured framework for planning and rolling out agentic AI across an enterprise, emphasizing workforce enablement, process redesign with human oversight, and scaling into durable product capabilities.
metadata:
  author: uygnoey
---
...
---
> Source: [uygnoey/skills-from-claude-blog](https://github.com/uygnoey/skills-from-claude-blog) — distributed by [TomeVault](https://tomevault.io).
