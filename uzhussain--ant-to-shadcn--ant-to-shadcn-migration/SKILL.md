...
description: Migrate Ant Design UIs to shadcn/ui + Tailwind (React/CRA/Vite → Next.js App Router). Use for: component replacement (no wrappers), Tailwind-first styling, canonical component consolidation, global CSS cleanup, route/layout scaffolding, and migration gotchas. Use when this capability is needed.
metadata:
  author: uzhussain
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/uzhussain) — claim your Tome and manage your conversions.
