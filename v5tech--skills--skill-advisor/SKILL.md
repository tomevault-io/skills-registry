---
name: skill-advisor
description: Search, compare, and install skills via npx skills CLI. Use when user wants to find skills, compare functionality, or install to agents. Avoids --all pitfall, targets Antigravity, Claude Code, Gemini CLI, OpenCode by default. Use when this capability is needed.
metadata:
  author: v5tech
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/v5tech) — claim your Tome and manage your conversions.
