---
name: skill-exporter
description: Generate npx skills add commands to reproduce installed skills. Use when user wants to export, backup, share, or replicate their skills setup on another machine. Use when this capability is needed.
metadata:
  author: v5tech
---
