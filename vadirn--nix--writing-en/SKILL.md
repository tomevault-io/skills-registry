---
name: writing-en
description: Writes and edits English text for clarity and concision. Removes nominalizations, passive voice, filler, and AI patterns. Use when writing documentation, README, commit messages, UI text, reports, emails, or when asked to simplify text, cut fluff, or check for plain language. Use when this capability is needed.
metadata:
  author: vadirn
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vadirn) — claim your Tome and manage your conversions.
