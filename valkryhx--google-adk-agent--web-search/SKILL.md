---
name: web-search
description: Perform web searches and extract content from URLs using the Tavily API. Use this skill to find real-time information, news, or deep-dive into specific web pages. Use when this capability is needed.
metadata:
  author: valkryhx
---
