---
name: codex-review
description: Use Codex CLI to review code changes — uncommitted work, a specific commit, or a range against a base branch. Optionally accepts a focus area for targeted review. Use when this capability is needed.
metadata:
  author: valtteriluomapareto
---
