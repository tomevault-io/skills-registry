---
name: gtr
description: This skill should be used when the user invokes /gtr:* commands to manage git worktrees using git-worktree-runner (gtr). Enables parallel branch development through worktree creation, editor/AI integration, and lifecycle management. Use when this capability is needed.
metadata:
  author: vampik33
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vampik33) — claim your Tome and manage your conversions.
