...
description: Customize or personalize a Claude Code plugin for a specific organization's tools and workflows by replacing placeholders and configuring MCP servers. Use when this capability is needed.
metadata:
