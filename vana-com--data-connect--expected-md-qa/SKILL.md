---
name: expected-md-qa
description: Generate a short expected.md listing what to test in a frontend UI. Use when the user asks for expected.md, QA checklist, or frontend testing instructions. Use when this capability is needed.
metadata:
  author: vana-com
---
