...
description: Comprehensive guidance on setting up npm libraries with package.json, with a preference for ES Modules (ESM). Use when setting up npm packages, configuring ESM, TypeScript packages, or React component libraries. Use when this capability is needed.
metadata:
  author: vana-com
---
...
---
> Source: [vana-com/personal-server](https://github.com/vana-com/personal-server) — distributed by [TomeVault](https://tomevault.io).
