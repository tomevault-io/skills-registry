---
name: powerbi-sql
description: Convert a SQL file to a PowerBI M Sql.Database() query expression. Use when: generating PowerBI query from SQL file; wrapping SQL in Sql.Database(); creating M formula for Power Query; converting .sql to PowerBI; exporting SQL to Power BI data source. Use when this capability is needed.
metadata:
  author: vandyG
---
...
---
> Source: [vandyG/power-bi-agent](https://github.com/vandyG/power-bi-agent) — distributed by [TomeVault](https://tomevault.io).
