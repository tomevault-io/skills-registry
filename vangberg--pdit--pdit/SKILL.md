---
name: pdit
description: Collaborate with users running pdit, an interactive Python editor with inline execution results. Use when user mentions pdit, runs 'uv run pdit', or is doing collaborative Python development where they see live execution output in a browser. Use when this capability is needed.
metadata:
  author: vangberg
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vangberg) — claim your Tome and manage your conversions.
