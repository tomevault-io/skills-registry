---
name: www
description: Work on the Astro website in `www/` for pdit.dev. Use when editing site content, styles, layouts, or components; adding pages or news posts; or running Astro dev/build commands for the website. Use when this capability is needed.
metadata:
  author: vangberg
---
