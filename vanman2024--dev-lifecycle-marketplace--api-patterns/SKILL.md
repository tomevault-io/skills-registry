---
name: api-patterns
description: REST/GraphQL/tRPC API pattern library with validation, error handling, and documentation. Use when creating backend APIs. Use when this capability is needed.
metadata:
  author: vanman2024
---
