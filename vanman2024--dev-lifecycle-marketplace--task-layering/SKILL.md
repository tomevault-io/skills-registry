---
name: task-layering
description: Breaks down specs into complexity-stratified tasks. Use when organizing tasks, assigning work to agents, or when user mentions task layering, task stratification, or parallel task execution. Use when this capability is needed.
metadata:
  author: vanman2024
---
