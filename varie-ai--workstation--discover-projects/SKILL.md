...
description: Scan for new project repos and add them to the Manager's project index. Use when you want to discover repos that aren't yet tracked. Use when this capability is needed.
metadata:
  author: varie-ai
---
