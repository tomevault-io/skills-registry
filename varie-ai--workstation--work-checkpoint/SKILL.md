...
description: Save current work state to persistent checkpoint. Use frequently to track progress, especially after completing steps or before taking breaks. Use when this capability is needed.
metadata:
  author: varie-ai
---
