---
name: work-handover
description: Generate comprehensive handover documentation for session end. Use when wrapping up a session, taking a long break, or handing off to another session. Use when this capability is needed.
metadata:
  author: varie-ai
---
