---
name: work-recover
description: Compare checkpoint state vs actual state and determine true position. Use after crashes, long breaks, or when checkpoint seems stale. Use when this capability is needed.
metadata:
  author: varie-ai
---
