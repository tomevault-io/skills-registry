---
name: work-status
description: Show status of all active tasks across repos. Use when user asks "what's the status", "what am I working on", or to get overview of active work. Use when this capability is needed.
metadata:
  author: varie-ai
---
