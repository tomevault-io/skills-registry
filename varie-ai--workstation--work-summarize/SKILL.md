---
name: work-summarize
description: Provide a summary of current work state at requested detail level. Used by Manager to get session status without loading full context. Use when this capability is needed.
metadata:
  author: varie-ai
---
