...
description: Defines core architectural principles including systems thinking, modular design, future-proofing, and maintenance reduction using shadcn/ui and design system patterns. Use when designing new features, refactoring code, or making architectural decisions. Use when this capability is needed.
metadata:
  author: vassovass
---
