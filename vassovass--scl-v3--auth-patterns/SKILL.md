---
name: auth-patterns
description: Covers Supabase authentication patterns including getUser vs getSession, Web Locks deadlock avoidance, cookie parsing, and session bypass techniques. Use when working with auth flows, encountering auth hangs or timeouts, or implementing login/logout/password-reset. Use when this capability is needed.
metadata:
  author: vassovass
---
