---
name: design-system
description: Defines the theme system using CSS variables, dark/light mode configuration, badge color registry, and UI component patterns. Use when styling components, adding theme tokens, working with colors, or making any visual UI changes. Use when this capability is needed.
metadata:
  author: vassovass
---
