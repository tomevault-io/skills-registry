...
description: Defines Next.js middleware patterns for protected route guards, auth redirects, and URL/searchParams handling. Use when modifying middleware.ts, adding route protection, or implementing auth-based redirects. Use when this capability is needed.
metadata:
  author: vassovass
---
