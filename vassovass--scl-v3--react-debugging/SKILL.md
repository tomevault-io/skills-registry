...
description: Diagnoses React render loops, infinite re-renders, and performance issues in Next.js App Router. Covers useMemo/useCallback pitfalls, useEffect dependency problems, and useSearchParams loops. Use when encountering "Maximum update depth exceeded" errors or suspected render loops. Use when this capability is needed.
metadata:
  author: vassovass
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vassovass) — claim your Tome and manage your conversions.
