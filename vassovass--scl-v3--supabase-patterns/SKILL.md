...
description: Covers Supabase client patterns including MCP server usage, admin client for API routes, RLS policies, auth deadlock prevention, and database migrations. Use when writing database queries, working with MCP tools, or managing Supabase client code. Use when this capability is needed.
metadata:
  author: vassovass
---
