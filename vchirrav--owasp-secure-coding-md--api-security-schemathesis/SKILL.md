...
description: Run Schemathesis for property-based API security testing. Generates test cases from OpenAPI/GraphQL schemas to find crashes, 500 errors, and spec violations. Use when this capability is needed.
metadata:
  author: vchirrav
---
