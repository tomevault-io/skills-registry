...
description: Run Dockle to audit container images against CIS Docker Benchmark and best practices. Checks for running as root, sensitive files, HEALTHCHECK, and more. Use when this capability is needed.
metadata:
  author: vchirrav
---
