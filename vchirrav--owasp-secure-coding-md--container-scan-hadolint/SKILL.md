...
description: Run Hadolint to lint Dockerfiles for best practices and security issues. Validates against Docker and ShellCheck rules. Use when this capability is needed.
metadata:
  author: vchirrav
---
