...
description: Run Nmap for network discovery and security auditing. Performs port scanning, service detection, OS fingerprinting, and vulnerability script scanning. Use when this capability is needed.
metadata:
  author: vchirrav
---
