---
name: sast-brakeman
description: Run Brakeman SAST scans on Ruby on Rails applications. Detects SQL injection, XSS, mass assignment, CSRF, command injection, and other Rails-specific vulnerabilities. Use when this capability is needed.
metadata:
  author: vchirrav
---
