---
name: sast-psalm
description: Run Psalm with taint analysis on PHP code. Detects SQL injection, XSS, command injection, path traversal, and other taint-flow vulnerabilities in PHP applications. Use when this capability is needed.
metadata:
  author: vchirrav
---
