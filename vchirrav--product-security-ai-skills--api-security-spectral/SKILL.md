...
description: Run Spectral to lint OpenAPI and AsyncAPI specs for security issues. Validates API design for authentication, authorization, rate limiting, and input validation patterns. Use when this capability is needed.
metadata:
  author: vchirrav
---
