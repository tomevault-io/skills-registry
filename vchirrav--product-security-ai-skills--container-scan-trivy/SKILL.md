...
description: Run Trivy to scan container images for OS and library vulnerabilities, misconfigurations, and secrets. Comprehensive multi-target security scanner. Use when this capability is needed.
metadata:
  author: vchirrav
---
