...
description: Run MobSF (Mobile Security Framework) for automated static and dynamic analysis of Android and iOS apps. Detects insecure storage, weak crypto, hardcoded secrets, and permission issues. Use when this capability is needed.
metadata:
  author: vchirrav
---
