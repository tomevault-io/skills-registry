---
name: sast-gosec
description: Run gosec SAST scans on Go code. Detects SQL injection, hardcoded credentials, insecure TLS, command injection, and other Go security issues. Use when this capability is needed.
metadata:
  author: vchirrav
---
