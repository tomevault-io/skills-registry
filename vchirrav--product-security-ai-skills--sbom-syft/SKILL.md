---
name: sbom-syft
description: Run Syft to generate Software Bill of Materials (SBOM) from container images and filesystems. Outputs CycloneDX or SPDX formats for supply chain compliance. Use when this capability is needed.
metadata:
  author: vchirrav
---
