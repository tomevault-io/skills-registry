---
name: sca-grype
description: Run Anchore Grype for SCA vulnerability scanning on filesystems and container images. Matches dependencies against multiple vulnerability databases (NVD, GitHub, OS advisories). Use when this capability is needed.
metadata:
  author: vchirrav
---
