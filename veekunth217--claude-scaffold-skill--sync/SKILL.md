---
name: sync
description: Share project memory across devices AND across AI tools (Claude Code, Cursor, Codex, Roo, Cline, Aider, Windsurf) — git-native, no SaaS, no lock-in. Use when this capability is needed.
metadata:
  author: veekunth217
---
