---
name: preview-plan
description: Render implementation plans as navigable HTML with sidebar TOC and progress tracking. Activate automatically when producing or previewing implementation plans, design docs, architecture proposals, migration plans, or any long-form structured plan. Use when this capability is needed.
metadata:
  author: veelenga
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/veelenga) — claim your Tome and manage your conversions.
