---
name: copilot-init
description: Initialize or refresh Copilot guidance for this Windows automation repo. Use when updating bootstrap files, repo-specific instructions, and reusable skills. Use when this capability is needed.
metadata:
  author: Ven0m0
---
...
---
> Source: [Ven0m0/Scripts](https://github.com/Ven0m0/Scripts) — distributed by [TomeVault](https://tomevault.io).
