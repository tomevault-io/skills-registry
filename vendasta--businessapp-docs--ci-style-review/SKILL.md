...
description: CI-specific style review that outputs machine-readable JSON. Used by the Gemini style review workflow and the style-reviewer sub-agent. For the complete style rules, see style-review/SKILL.md. Use when this capability is needed.
metadata:
  author: vendasta
---
