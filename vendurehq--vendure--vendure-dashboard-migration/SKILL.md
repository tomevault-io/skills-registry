...
description: Migrates Vendure Admin UI extensions (legacy Angular-based) to the new React Dashboard. Use when this capability is needed.
metadata:
  author: vendurehq
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vendurehq) — claim your Tome and manage your conversions.
