...
description: Create custom API endpoints and whitelisted methods for Frappe applications. Use when building REST APIs or custom endpoints. Use when this capability is needed.
metadata:
