...
description: Generate fixture files for Frappe test data and master data. Use when creating test fixtures, setup data, or master data for new sites. Use when this capability is needed.
metadata:
