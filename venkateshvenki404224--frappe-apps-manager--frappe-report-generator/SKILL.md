...
description: Generate custom reports, query reports, and script reports for Frappe applications. Use when creating data analysis and reporting features. Use when this capability is needed.
metadata:
