---
name: create-grader
description: Create a multi-layer grader (MultiGraderDefinition) for evaluating an agent given its source code. Use when user wants to build evaluation criteria for an agent. Use when this capability is needed.
metadata:
  author: veris-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/veris-ai) — claim your Tome and manage your conversions.
