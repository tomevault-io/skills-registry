---
name: pipos-specs
description: Applies pipos_fitness specs when editing weekly plan, AI agent, exercises, auth, or QA. Use when working in pipos_fitness, touching API routes, Prisma, or copy; or when the user asks for QA, audits, or spec compliance. Use when this capability is needed.
metadata:
  author: vfbeneitez-cloud
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vfbeneitez-cloud) — claim your Tome and manage your conversions.
