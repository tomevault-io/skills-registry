...
description: Use when working with a skill for generating and maintaining high-quality documentation following established standards (JSON:API, Mermaid ERDs, Positive/Negative testing).
metadata:
  author: vheins
---
