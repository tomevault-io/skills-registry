...
description: Vibecanvas CLI help for mutating canvas state. Use when you need the vibecanvas write help menu for add, patch, move, group, ungroup, and delete commands. Use when this capability is needed.
metadata:
  author: vibecanvas
---
