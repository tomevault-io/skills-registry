---
name: vibefigma
description: Convert Figma designs to production-ready React components with Tailwind CSS. Use when user provides a Figma URL, asks to convert Figma designs to React/code, wants to extract components from Figma, or mentions "vibefigma". Requires a Figma access token (via --token flag, FIGMA_TOKEN env var, or .env file). Use when this capability is needed.
metadata:
  author: vibeflowing-inc
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vibeflowing-inc) — claim your Tome and manage your conversions.
