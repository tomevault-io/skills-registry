---
name: antfarm
description: Multi-agent workflows for OpenClaw. Use when building complex features that benefit from plan → implement → verify → test → review cycles. Use when this capability is needed.
metadata:
  author: vibekit-apps
---
