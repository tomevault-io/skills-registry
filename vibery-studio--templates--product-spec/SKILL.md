---
name: product-spec
description: Convert product briefs, websites, documents into structured product specs. Generates modular markdown files for landing pages, guides, marketing. Use when this capability is needed.
metadata:
