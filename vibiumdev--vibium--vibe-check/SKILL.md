---
name: vibe-check
description: Browser automation for AI agents. Use when the user needs to navigate websites, read page content, fill forms, click elements, take screenshots, or manage browser pages. Use when this capability is needed.
metadata:
  author: vibiumdev
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vibiumdev) — claim your Tome and manage your conversions.
