---
name: smart-commit
description: Generate git commit messages from staged changes using the smart-commit style (emoji-first, imperative, issue key from branch). Trigger when a user invokes /smart-commit or asks for a commit message from a git diff. Use when this capability is needed.
metadata:
  author: vicc
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vicc) — claim your Tome and manage your conversions.
