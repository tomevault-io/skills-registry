---
name: ralph-init
description: Initialize Ralph in the current project. Use after /prd and /ralph to set up the autonomous loop scripts. Triggers on: initialize ralph, setup ralph, ralph init, add ralph to project. Use when this capability is needed.
metadata:
  author: vickaul-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vickaul-ai) — claim your Tome and manage your conversions.
