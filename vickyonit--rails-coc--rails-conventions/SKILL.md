...
description: Follow Rails conventions and best practices when writing Ruby on Rails code. Use when working on Rails projects, creating models, controllers, views, migrations, routes, or any Rails code. Ensures code follows Rails naming conventions, project structure, RESTful patterns, and Rails 7.1+ best practices. Use when this capability is needed.
metadata:
  author: vickyonit
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vickyonit) — claim your Tome and manage your conversions.
