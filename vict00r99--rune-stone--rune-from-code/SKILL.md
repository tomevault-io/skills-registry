---
name: rune-from-code
description: Reverse-engineer a RUNE specification from existing code. Use when adopting RUNE in existing projects or generating a spec from a current implementation. Use when this capability is needed.
metadata:
  author: vict00r99
---
