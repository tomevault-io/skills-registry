...
description: Generate implementations and tests from a single RUNE spec in multiple programming languages. Use when a user needs the same function in several languages with identical behavior and error messages. Use when this capability is needed.
metadata:
  author: vict00r99
---
