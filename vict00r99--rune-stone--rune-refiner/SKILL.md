---
name: rune-refiner
description: Analyze RUNE specifications and suggest improvements. Use when a spec is valid but may have missing tests, uncovered edge cases, ambiguous behavior rules, or incomplete constraints. Use when this capability is needed.
metadata:
  author: vict00r99
---
