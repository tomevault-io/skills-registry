---
name: rune-writer
description: Create RUNE specifications from requirements and implement code from specs. Use when a user wants a RUNE spec (YAML or Markdown) or needs to implement code from an existing spec. Use when this capability is needed.
metadata:
  author: vict00r99
---
