---
name: pptx-posters
description: 使用 HTML/CSS 创建科研海报，并可导出为 PDF 或 PPTX。仅当用户明确要求使用 PowerPoint/PPTX 海报格式时才使用此技能；标准科研海报应优先使用 latex-posters。本技能提供基于现代 Web 的海报设计，支持响应式布局和便捷的可视化整合。 Use when this capability is needed.
metadata:
  author: victory-hugo
---
