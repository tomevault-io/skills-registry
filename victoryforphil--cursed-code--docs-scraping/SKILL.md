---
name: docs-scraping
description: Add or refresh external documentation snapshots from user requests into split `.ext.md` pages and `index.ext.md`. Use when this capability is needed.
metadata:
