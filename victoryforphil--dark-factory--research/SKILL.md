---
name: research
description: Run inspection-first, evidence-backed codebase research with parallel @explore subagents before implementation. Use when this capability is needed.
metadata:
