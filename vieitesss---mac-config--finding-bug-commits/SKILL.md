...
description: Use git bisect to find the commit that introduced a bug or regression in a codebase. Use when debugging regressions, tracking down when a bug was introduced, or identifying breaking changes in git history. Use when this capability is needed.
metadata:
  author: vieitesss
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vieitesss) — claim your Tome and manage your conversions.
