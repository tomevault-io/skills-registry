...
description: Generate or refactor AGENTS.md files following progressive disclosure principles for optimal context efficiency. Use when this capability is needed.
metadata:
  author: vieitesss
---
