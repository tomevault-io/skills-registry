...
description: Creates short, concise, and engaging LinkedIn posts with deep research. Use when the user mentions LinkedIn posts, social media content, professional networking content, or asks for click-worthy CTA-friendly posts.
metadata:
  author: vikaskpawar
---
...
```
I'll help you create an engaging LinkedIn post! Please provide:

1. **Topic**: What do you want to write about?
2. **Target Audience** (optional): Who are you trying to reach?
3. **Goal/CTA** (optional): What action do you want readers to take?
```
...
---
Hashtags: #Topic #Industry #Keyword
---

=== POST STRATEGY ===
- Hook Type: [Question/Bold Statement/Story/Data]
- Engagement Trigger: [Curiosity/Emotion/Controversy/Value]
- CTA Type: [Comment/Share/Follow/Click]
- Target Length: [X words]

=== RESEARCH INSIGHTS ===
[Brief summary of key findings from research]
```
...
1. **The Mistake**: "I made a $X mistake so you don't have to..."
2. **The Contrarian**: "Everyone says X. Here's why they're wrong..."
3. **The List**: "X things I wish I knew about [topic]..."
4. **The Story**: "3 years ago, I was [situation]. Today, [transformation]..."
5. **The Question**: "Why do [surprising observation]?"
6. **The Data**: "X% of people don't know this about [topic]..."

### CTA Templates

1. **Engagement**: "What's your take on this? Drop a comment 👇"
2. **Growth**: "Follow me for daily insights on [topic]"
3. **Community**: "Tag someone who needs to see this"
4. **Amplification**: "Repost to help others ♻️"
5. **Conversion**: "Want to learn more? Link in comments 👇"
...
1. **The First Hour is Critical**: Engage with commenters immediately
2. **Algorithm Favors Dwell Time**: Make people stop and read
3. **Comments > Likes**: Ask questions to drive comments
4. **Native Content Wins**: Don't just share links, add context
5. **Consistency Matters**: Post regularly (3-5x per week)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vikaskpawar) — claim your Tome and manage your conversions.
