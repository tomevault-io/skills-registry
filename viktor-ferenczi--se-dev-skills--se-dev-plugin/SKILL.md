---
name: se-dev-plugin
description: Plugin development for Space Engineers version 1. Search plugin code from PluginHub for examples and patterns. Use when this capability is needed.
metadata:
