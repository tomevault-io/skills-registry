...
description: Python design patterns including KISS, Separation of Concerns, Single Responsibility, and composition over inheritance. Use when making architecture decisions, refactoring code structure, or evaluating when abstractions are appropriate. Use when this capability is needed.
metadata:
  author: vimalkodoth
---
...
# GOOD: Use response schemas (Pydantic v2: model_validate)
@app.get("/users/{id}")
