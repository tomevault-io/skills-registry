...
description: This skill activates when users discuss the example plugin, demonstrating how skills auto-activate based on context. Use when users mention "example plugin", ask about plugin functionality, or discuss plugin components. Use when this capability is needed.
metadata:
  author: vincentor
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vincentor) — claim your Tome and manage your conversions.
