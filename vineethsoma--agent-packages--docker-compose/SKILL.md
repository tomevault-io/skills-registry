---
name: docker-compose
description: Docker Compose management for orchestrating MCP servers and multi-container applications. Use when deploying MCP servers, managing container lifecycles, or configuring service dependencies. Use when this capability is needed.
metadata:
  author: vineethsoma
---
