...
description: Comprehensive Playwright automation testing skill with E2E testing standards, test generation workflows, and browser automation best practices. Use when writing automated browser tests, testing user flows, or performing web application QA. Use when this capability is needed.
metadata:
  author: vineethsoma
---
