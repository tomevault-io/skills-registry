...
description: Systematic post-story retrospective process with automated metrics gathering, structured feedback collection, and Agent Package Manager handoff generation Use when this capability is needed.
metadata:
  author: vineethsoma
---
