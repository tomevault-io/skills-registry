---
name: dagu-rest-api
description: Guide for using the Dagu REST API. Use when programmatically managing workflows, querying execution status, or integrating Dagu with external systems. Use when this capability is needed.
metadata:
  author: vinnie357
---
