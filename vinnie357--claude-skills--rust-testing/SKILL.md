---
name: rust-testing
description: Guide for Rust testing and Cargo usage. Use when writing unit or integration tests, configuring Cargo.toml, or running cargo commands. Use when this capability is needed.
metadata:
  author: vinnie357
---
