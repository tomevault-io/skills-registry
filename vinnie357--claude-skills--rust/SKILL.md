---
name: rust
description: Guide for Rust programming language. Use when writing Rust code, setting up Rust projects, or needing an overview of Rust development workflows. Use when this capability is needed.
metadata:
  author: vinnie357
---
