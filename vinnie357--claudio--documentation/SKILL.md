...
description: Activate when creating comprehensive documentation including README files, API docs, user guides, and developer guides Use when this capability is needed.
metadata:
  author: vinnie357
---
