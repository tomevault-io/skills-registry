---
name: task-breakdown
description: Activate when breaking down implementation plans into detailed task lists with agent contexts, acceptance criteria, and status tracking Use when this capability is needed.
metadata:
  author: vinnie357
---
