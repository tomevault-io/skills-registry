---
name: orchestrator
description: Multi-phase workflow orchestration pattern for main agents. Enables structured planning, delegation to sub-agents, parallel execution, and result aggregation. Use when this capability is needed.
metadata:
  author: vinzenz
---
