...
description: Develop and maintain Convex backend functions including queries, mutations, and actions. Use when working with database operations, authentication, game management, scoring logic, and real-time data updates in the dev-quiz-battle app. Use when this capability is needed.
metadata:
  author: violabg
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/violabg) — claim your Tome and manage your conversions.
