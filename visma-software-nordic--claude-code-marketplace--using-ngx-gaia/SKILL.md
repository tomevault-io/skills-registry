---
name: using-ngx-gaia
description: Provides usage guidance for @vsn-ux/ngx-gaia Angular components (Gaia design system). Use when implementing UI with ga- prefixed elements, GaButtonModule, GaSelectModule, ga-form-field, gaInput directives, or when asking about Gaia components.
metadata:
...
- Elements: `<ga-alert>`, `<ga-button>`, `<ga-select>`
- Directives: `[gaButton]`, `[gaInput]`, `[gaTooltip]`
- Modules: `Ga{Component}Module` (e.g., `GaButtonModule`)
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/visma-software-nordic) — claim your Tome and manage your conversions.
