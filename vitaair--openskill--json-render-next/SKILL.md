...
description: Next.js renderer for json-render that turns JSON specs into full Next.js applications with routes, layouts, SSR, and metadata. Use when working with @json-render/next, building Next.js apps from JSON specs, or creating AI-generated multi-page applications. Use when this capability is needed.
metadata:
  author: vitaair
---
...
---
> Source: [vitaair/openskill](https://github.com/vitaair/openskill) — distributed by [TomeVault](https://tomevault.io).
