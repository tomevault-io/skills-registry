---
name: testing
description: How to run tests, add error tests, update golden files, and report nice errors in Dang. Use when running or writing tests. Use when this capability is needed.
metadata:
  author: vito
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vito) — claim your Tome and manage your conversions.
