...
description: Expert in designing resource-oriented REST APIs using OpenAPI 3.1 specifications. Use when this capability is needed.
metadata:
...
---
> Source: [vivek-viswanat/dev-arsenal](https://github.com/vivek-viswanat/dev-arsenal) — distributed by [TomeVault](https://tomevault.io).
