---
name: cicd-workflows
description: GitHub Actions and CI/CD patterns for Databricks, including automated testing, deployment, and quality gates. Use when this capability is needed.
metadata:
  author: vivekgana
---
