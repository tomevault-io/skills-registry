...
description: Modern deployment with Databricks Asset Bundles (DAB), supporting multi-environment configurations and CI/CD integration. Use when this capability is needed.
metadata:
  author: vivekgana
---
