---
name: clean-code
description: Detects and removes unused code using Periphery. Use when cleaning up dead code, removing unused functions, or maintaining code hygiene. Use when this capability is needed.
metadata:
  author: vjr2005
---
