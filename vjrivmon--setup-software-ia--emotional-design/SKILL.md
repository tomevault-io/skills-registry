...
description:
  Los tres niveles de procesamiento emocional de Don Norman. Use cuando diseñe
  para engagement, satisfacción del usuario, o diferenciación de producto.
metadata:
  author: ux-ui-skills
  version: "1.0"
  category: frameworks
...
Don Norman propone que los usuarios procesan productos en tres niveles: visceral
(apariencia), conductual (uso), y reflexivo (significado). Un buen diseño debe
satisfacer los tres niveles.
...
- https://www.nngroup.com/articles/emotional-design/
