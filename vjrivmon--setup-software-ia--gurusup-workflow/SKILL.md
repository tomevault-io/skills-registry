...
description: Workflow completo de desarrollo Design-First: exploración → clarificación → planificación → implementación autónoma (Ralph Loop). Incluye creación de issues GitHub de alta calidad estilo PRD. Use when this capability is needed.
metadata:
  author: vjrivmon
---
