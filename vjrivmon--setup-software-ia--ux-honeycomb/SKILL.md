...
name: ux-honeycomb
description:
  Framework de Peter Morville con 7 facetas de UX. Use cuando evalúe la
  experiencia completa de un producto o defina criterios de calidad UX.
metadata:
  author: ux-ui-skills
  version: "1.0"
  category: frameworks
...
Framework creado por Peter Morville que define 7 facetas necesarias para una
experiencia de usuario valiosa: Útil, Usable, Deseable, Encontrable, Accesible,
Creíble, y Valioso.
