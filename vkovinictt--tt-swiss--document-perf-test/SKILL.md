...
description: Your goal is to take python script command for a perf test and make an entry to the ~/experiments/perf_tests.jsonl file about the results. Use when this capability is needed.
metadata:
  author: vkovinictt
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vkovinictt) — claim your Tome and manage your conversions.
