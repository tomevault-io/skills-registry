---
name: fontbm
description: This skill should be used when the user asks to generate bitmap fonts, use fontbm, create a font atlas, export a .fnt file, configure font texture, asks about fontbm options or parameters, or wants to run the fontbm command-line utility. Use when this capability is needed.
metadata:
  author: vladimirgamalyan
---
...
---
> Source: [vladimirgamalyan/fontbm](https://github.com/vladimirgamalyan/fontbm) — distributed by [TomeVault](https://tomevault.io).
