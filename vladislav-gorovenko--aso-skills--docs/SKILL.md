---
name: docs
description: Generate app documentation pages (landing page, privacy policy, support, terms of service) for iOS apps. Use when the user asks about creating or updating app docs, legal pages, or marketing pages. Use when this capability is needed.
metadata:
  author: vladislav-gorovenko
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vladislav-gorovenko) — claim your Tome and manage your conversions.
