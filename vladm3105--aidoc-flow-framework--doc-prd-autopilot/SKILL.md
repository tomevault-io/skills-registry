...
description: Automated PRD generation pipeline from BRD documents - analyzes dependencies, validates readiness, generates PRDs, performs final review, and supports parallel execution Use when this capability is needed.
metadata:
  author: vladm3105
---
