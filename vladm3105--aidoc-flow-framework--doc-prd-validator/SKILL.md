...
description: [DEPRECATED] Validate Product Requirements Documents (PRD) against Layer 2 MVP schema standards - USE doc-prd-audit INSTEAD Use when this capability is needed.
metadata:
  author: vladm3105
---
