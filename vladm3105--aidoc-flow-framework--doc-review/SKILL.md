---
name: doc-review
description: Review a single file or all files in a folder for data inconsistencies, reference errors, typos, and unclear terminology using parallel sub-agents Use when this capability is needed.
metadata:
  author: vladm3105
---
