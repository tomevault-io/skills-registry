---
name: doc-sys-fixer
description: Automated fix skill that reads review reports and applies fixes to SYS documents - handles broken links, element IDs, missing files, and iterative improvement Use when this capability is needed.
metadata:
  author: vladm3105
---
...
|------------|-------|------------|
| REV-STR001 | SYS not in nested folder | Create folder, move file, update all links |
| REV-STR002 | SYS folder name doesn't match SYS ID | Rename folder to match |
| REV-STR003 | Monolithic SYS >25KB should be sectioned | Flag for manual review |
