...
description: Automated fix skill that reads review reports and applies fixes to TASKS documents - handles broken links, element IDs, implementation contract issues, and iterative improvement Use when this capability is needed.
metadata:
  author: vladm3105
---
