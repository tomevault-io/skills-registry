...
description: Automated TSPEC generation from SPEC - generates test specifications for UTEST, ITEST, STEST, FTEST with TASKS-Ready scoring Use when this capability is needed.
metadata:
  author: vladm3105
---
...
| `doc-tspec-audit` | Unified validator+reviewer report for fixer handoff | Phase 5: Audit |
