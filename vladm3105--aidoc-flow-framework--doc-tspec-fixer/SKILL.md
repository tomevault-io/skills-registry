...
description: Automated fix skill that reads review reports and applies fixes to TSPEC (Test Specification) documents - handles broken links, element IDs, test case structure issues, and iterative improvement Use when this capability is needed.
metadata:
  author: vladm3105
---
