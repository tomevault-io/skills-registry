...
description: Upgrade vllm-omni NPU model runners (OmniNPUModelRunner, NPUARModelRunner, NPUGenerationModelRunner) to align with the latest vllm-ascend NPUModelRunner while preserving omni-specific logic. Use when this capability is needed.
metadata:
  author: vllm-project
---
...
---
> Source: [vllm-project/vllm-omni](https://github.com/vllm-project/vllm-omni) — distributed by [TomeVault](https://tomevault.io).
