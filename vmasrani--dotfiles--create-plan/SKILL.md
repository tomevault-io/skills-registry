---
name: create-plan
description: Spec-driven development workflow. Interviews the user, writes success criteria, generates tests, researches the codebase, produces a detailed implementation plan, and executes it with subagents. Use when this capability is needed.
metadata:
  author: vmasrani
---
