---
name: polish
description: Transform functional apps into production-grade, professional software. Covers modern UI design systems, keyboard-first navigation, command palettes, view modes, and polished UX patterns. Use when upgrading an MVP to feel like a real product. Use when this capability is needed.
metadata:
  author: vmasrani
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vmasrani) — claim your Tome and manage your conversions.
