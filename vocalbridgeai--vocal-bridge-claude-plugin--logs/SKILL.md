---
name: logs
description: View call logs for the Vocal Bridge voice agent. Can list recent calls or show details of a specific session including transcript. Use when this capability is needed.
metadata:
