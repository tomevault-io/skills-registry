---
name: airtable
description: Rules and patterns for reading/writing Airtable bases via the MCP tool. Load this skill before any Airtable operation to avoid common API errors. Use when this capability is needed.
metadata:
  author: vogon101
---
