---
name: gmail
description: Read and search Gmail emails via CLI. Use when user asks about emails, inbox, or wants to process email content. NEVER create tasks from emails without explicit user confirmation. Use when this capability is needed.
metadata:
  author: vogon101
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vogon101) — claim your Tome and manage your conversions.
