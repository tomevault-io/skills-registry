...
description: Playwright E2E テストコードを生成。test.step で日本語ステップ名を使用し、コメント禁止。E2E テスト作成・Playwright コード生成時に使用。 Use when this capability is needed.
metadata:
  author: voicevox
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/voicevox) — claim your Tome and manage your conversions.
