...
1. **If no feature description is provided:** Ask the user to describe what they want to build before proceeding. Example prompt:
   > "What feature or product would you like to plan? Please describe what you want to build."
2. Once you have the feature description, ask clarifying questions (with lettered options), in batches of up to 5 at a time (ask 5, wait for answers, then ask the next batch if needed).
3. **Always ask about quality gates** (commands that must pass)
4. Generate a **detailed** JSON PRD and save it to the provided path
5. Clarifying questions ends when user enters "end prd"
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/voltable-com) — claim your Tome and manage your conversions.
