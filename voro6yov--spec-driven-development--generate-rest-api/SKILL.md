...
description: Orchestrates end-to-end REST API generation for an aggregate diagram by spawning the rest-api-spec:specs-generator and then rest-api-spec:code-generator agents. Invoke with: /rest-api-spec:generate-rest-api <domain_diagram> Use when this capability is needed.
metadata:
  author: voro6yov
---
