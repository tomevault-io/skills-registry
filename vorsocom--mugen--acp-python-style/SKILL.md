...
description: Apply the formatting and structural conventions used in mugen/core/plugin/acp. Use when creating or modifying Python modules in ACP, or nearby plugin/test code that should match ACP style (for example mugen/core/plugin/audit and ACP-focused tests). Use when this capability is needed.
metadata:
  author: vorsocom
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vorsocom) — claim your Tome and manage your conversions.
