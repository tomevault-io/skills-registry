...
description: Run mugen pre-push quality gates end-to-end. Use when you need a single repeatable check before commit/push that confirms full unit tests pass, full E2E template validations pass, and total coverage remains at 100%. Use when this capability is needed.
metadata:
  author: vorsocom
---
