---
name: mutation-test
description: Introduce an intentional bug in source code to verify a test catches it, then revert the bug. Use when this capability is needed.
metadata:
  author: votingworks
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/votingworks) — claim your Tome and manage your conversions.
