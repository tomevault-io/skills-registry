...
description: Run ML model inference on FiftyOne datasets. Use when running models for detection, classification, segmentation, or embeddings. Discovers available models dynamically from the Zoo, plugin operators, or custom sources — never assumes a fixed model list. Use when this capability is needed.
metadata:
  author: voxel51
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/voxel51) — claim your Tome and manage your conversions.
