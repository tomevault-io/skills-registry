...
description: Generate a Data Lens connector from an external database schema. Use when users want to connect an external data source (PostgreSQL, BigQuery, Databricks, MySQL, etc.) to FiftyOne Data Lens, or when they have a database schema and want to browse/import that data through the FiftyOne App. Use when this capability is needed.
metadata:
  author: voxel51
---
...
---
> Source: [voxel51/fiftyone-skills](https://github.com/voxel51/fiftyone-skills) — distributed by [TomeVault](https://tomevault.io).
