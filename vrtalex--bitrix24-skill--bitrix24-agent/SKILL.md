---
name: bitrix24-agent
description: Design, implement, debug, and harden integrations between AI agents and Bitrix24 REST API (webhooks, OAuth 2.0, scopes, events, batch, limits, and REST 3.0). Use when asked to connect AI assistants/agents to Bitrix24, automate CRM/tasks/chats, process Bitrix24 events, choose an auth model, or resolve Bitrix24 API errors and performance issues. Use when this capability is needed.
metadata:
  author: vrtalex
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vrtalex) — claim your Tome and manage your conversions.
