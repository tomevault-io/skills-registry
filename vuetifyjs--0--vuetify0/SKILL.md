---
name: vuetify0
description: Build with @vuetify/v0 headless composables and components for Vue 3. Use when creating selection state (single, multi, grouped, stepped), form validation, tab/dialog/popover UI, provide/inject context, registries, virtual scrolling, pagination, keyboard shortcuts, resize observers, theming, breakpoints, or SSR-safe browser detection. Triggers on v0, vuetify0, headless components, or WAI-ARIA patterns. Use when this capability is needed.
metadata:
  author: vuetifyjs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vuetifyjs) — claim your Tome and manage your conversions.
