...
description: Automatically merge PR when complete (true/false, default false). If true, merges after all reviews addressed. If false, notifies user for manual merge. Use when this capability is needed.
metadata:
  author: vultuk
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/vultuk) — claim your Tome and manage your conversions.
