---
name: vue-options
description: Vue 3 Options API — data, props, computed, methods, watch, emits, provide/inject, lifecycle hooks, and mixins. Use when the project uses Options API style (Vue 2 legacy or explicit Vue 3 Options API preference). Use when this capability is needed.
metadata:
  author: vuluu2k
---
