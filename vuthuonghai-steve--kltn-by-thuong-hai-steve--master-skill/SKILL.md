---
name: master-skill
description: Orchestrate end-to-end Agent Skill delivery as a standalone workflow with natural-language intent routing, optional /ss commands, session tracking, and deterministic verification. Use when this capability is needed.
metadata:
