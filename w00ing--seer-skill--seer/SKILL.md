---
name: seer
description: Visual feedback capture for any running macOS app window via osascript plus screencapture/ffmpeg screen capture. Use when the user wants UI verification or a fresh screenshot. Use when this capability is needed.
metadata:
  author: w00ing
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/w00ing) — claim your Tome and manage your conversions.
