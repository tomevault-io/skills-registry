...
description: Prepare for contract negotiations with term analysis, BATNA preparation, negotiation playbooks, and comparison frameworks Use when this capability is needed.
metadata:
  author: w95
---
...
**Weak BATNA** (no real alternative): Vendor has all leverage
**Strong BATNA** (multiple options): You have leverage
...
---
> Source: [w95/awesome-claude-corporate-skills](https://github.com/w95/awesome-claude-corporate-skills) — distributed by [TomeVault](https://tomevault.io).
