---
name: skill-improver
description: Improves existing Claude Code skill definitions by evaluating them against official best practices. Use when users want to improve, refine, review, or optimize a skill's quality, description, structure, or workflow. Triggers include "improve this skill", "review skill quality", "make this skill better", "スキルを改善して", "スキルの品質を上げて", "スキルをレビューして", or when skill definitions need refinement. Use when this capability is needed.
metadata:
  author: wadackel
---
