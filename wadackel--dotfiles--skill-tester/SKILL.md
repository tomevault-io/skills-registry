...
For story test scenario format and examples, see [references/test-scenario-format.md](references/test-scenario-format.md).

For validation criteria details, see [references/validation-criteria.md](references/validation-criteria.md).
