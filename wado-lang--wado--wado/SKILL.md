...
description: Profile the native Rust `wado` binary (compile/serve/run) with a sampling profiler to find host-side bottlenecks. Use for native CPU profiling, not guest wasm (see wado-performance for that). Use when this capability is needed.
metadata:
  author: wado-lang
---
...
---
> Source: [wado-lang/wado](https://github.com/wado-lang/wado) — distributed by [TomeVault](https://tomevault.io).
