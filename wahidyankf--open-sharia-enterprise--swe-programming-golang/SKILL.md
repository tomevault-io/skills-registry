...
description: Go coding standards from authoritative docs/explanation/software-engineering/programming-languages/golang/ documentation Use when this capability is needed.
metadata:
  author: wahidyankf
---
