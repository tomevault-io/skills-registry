...
description: AI agent development standards including frontmatter structure, naming conventions, tool access patterns, model selection, and reference documentation structure Use when this capability is needed.
metadata:
  author: wahidyankf
---
...
---
> Source: [wahidyankf/ose-primer](https://github.com/wahidyankf/ose-primer) — distributed by [TomeVault](https://tomevault.io).
