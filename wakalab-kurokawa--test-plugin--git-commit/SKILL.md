---
name: git-commit
description: This skill should be used when the user asks to "/git-commit", "コミット", "commit", "git commit", or needs to create a git commit with Conventional Commits format. Does not push. Use when this capability is needed.
metadata:
  author: wakalab-kurokawa
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wakalab-kurokawa) — claim your Tome and manage your conversions.
