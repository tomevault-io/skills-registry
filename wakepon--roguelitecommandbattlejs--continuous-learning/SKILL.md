...
description: Claude Code セッションから再利用可能なパターンを自動的に抽出し、将来使用するための学習済みスキルとして保存します。 Use when this capability is needed.
metadata:
  author: wakepon
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wakepon) — claim your Tome and manage your conversions.
