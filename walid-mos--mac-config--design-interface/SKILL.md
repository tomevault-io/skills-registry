...
description: Generate multiple radically different interface designs using parallel sub-agents, then compare trade-offs. Based on "Design It Twice" from A Philosophy of Software Design. Use when user wants to design a module interface, API surface, or component contract. Use when this capability is needed.
metadata:
  author: walid-mos
---
...
- Don't implement — this skill is purely about interface shape
