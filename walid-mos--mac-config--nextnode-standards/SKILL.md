...
description: Audit a NextNode/SaaS project against all NextNode standards — produces a compliance report with pass/fail/missing status for every required item. Use when this capability is needed.
metadata:
  author: walid-mos
---
