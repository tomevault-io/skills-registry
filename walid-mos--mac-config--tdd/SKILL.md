---
name: tdd
description: Test-Driven Development workflow using vertical slices and tracer bullets. Use when user wants to build a feature using TDD, or invokes /tdd. Complements the vitest skill (test standards) with the TDD methodology (workflow). Use when this capability is needed.
metadata:
  author: walid-mos
---
...
## Integration with Vitest Skill

This skill defines the **workflow** (how to do TDD). The `vitest` skill defines the **standards** (how to write tests). Both apply simultaneously:

- Use this skill for the RED->GREEN->REFACTOR loop and planning phase
- Use `vitest` standards for assertions, mocking rules, file organization, and anti-patterns
