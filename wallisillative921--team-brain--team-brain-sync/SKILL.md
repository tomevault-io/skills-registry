...
description: Regenerate BRAIN.md and optionally generate .cursorrules and AGENTS.md from team brain entries. Use when user says 'sync', 'regenerate', 'update brain', or '/team-brain sync'. Use when this capability is needed.
metadata:
  author: wallisillative921
---
...
---
> Source: [wallisillative921/team-brain](https://github.com/wallisillative921/team-brain) — distributed by [TomeVault](https://tomevault.io).
