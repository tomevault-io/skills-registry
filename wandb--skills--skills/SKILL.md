---
name: wandb-primary
description: Primary W&B skill for broad or mixed Weights & Biases work: project overviews, W&B runs and artifacts, Weave traces and evaluations, Reports, Signal Builder, and Launch workflows. Use when the task spans multiple W&B surfaces or the user asks generally what is happening in a W&B project. Use when this capability is needed.
metadata:
  author: wandb
---
<!--
...
---
> Source: [wandb/skills](https://github.com/wandb/skills) — distributed by [TomeVault](https://tomevault.io).
