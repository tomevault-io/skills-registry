---
name: recent-work
description: Show recent Claude Code sessions and work history. Use when user says "what have I been working on", "recent work", "what did I do today", or "show recent sessions". Use when this capability is needed.
metadata:
