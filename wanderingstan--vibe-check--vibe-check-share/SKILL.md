...
description: Create a public share link for the current Claude Code session. Use when user says "share session", "share this session", "get share link", "create share link", or "share my work". Use when this capability is needed.
metadata:
