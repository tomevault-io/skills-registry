...
description: Add, update, or audit Supersubset AI context: .github/skills, .github/agents, AGENTS.md, copilot-instructions, docs/status, docs/testing. Use when creating a skill, shrinking bloat, fixing stale cross-references, or aligning agents with orchestration. Use when this capability is needed.
metadata:
  author: wandir-tech
---
...
---
> Source: [wandir-tech/supersubset](https://github.com/wandir-tech/supersubset) — distributed by [TomeVault](https://tomevault.io).
