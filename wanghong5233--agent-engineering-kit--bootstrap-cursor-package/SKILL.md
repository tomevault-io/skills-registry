...
description: Bootstrap or audit a project `.cursor/` engineering package. Use when starting a new repo, asks to 初始化 .cursor / 套用工程经验包 / 复制 cursor 模板, or auditing existing `.cursor/` for missing rules/skills/hooks or project-name leakage. Do NOT use to write a single rule, hook, command, or skill in isolation. Use when this capability is needed.
metadata:
  author: wanghong5233
---
...
---
> Source: [wanghong5233/agent-engineering-kit](https://github.com/wanghong5233/agent-engineering-kit) — distributed by [TomeVault](https://tomevault.io).
