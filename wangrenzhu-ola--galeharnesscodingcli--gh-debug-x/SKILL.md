---
name: ghdebug-x
description: Debug and fix iOS Swift/ObjC bugs with Morph-X blueprint, transform, audit, and memory fingerprinting to reduce template-code repetition risk. Use when this capability is needed.
metadata:
  author: wangrenzhu-ola
---
