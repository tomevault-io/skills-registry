---
name: issue-worktree
description: 从 GitHub Issue 或 Linear Issue 自动创建 Git 分支 + git worktree（含规范化分支名/目录名），用于 GitHub Flow 开发。用户提到“从 issue 创建 worktree/分支/开发目录”、给出 GitHub issue URL/#123/owner/repo#123，或给出 Linear issue URL/ABC-123 时使用；也适用于“为某个 issue 开一个独立工作区/隔离目录”的需求。 Use when this capability is needed.
metadata:
  author: wangyiyang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wangyiyang) — claim your Tome and manage your conversions.
