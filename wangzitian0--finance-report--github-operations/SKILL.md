...
description: GitHub API operations via `gh` CLI — PR reviews, CI debugging, GraphQL mutations. Use when resolving review threads, querying PR status, fetching CI logs, or automating GitHub workflows. Use when this capability is needed.
metadata:
  author: wangzitian0
---
