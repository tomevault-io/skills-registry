...
description: 生成上市公司可比公司分析报告。当用户请求分析某家公司的竞争对手、可比公司、同业对比、竞品分析、对标公司分析时使用此技能。 Use when this capability is needed.
metadata:
  author: wanxingai
---
...
---
> Source: [wanxingai/LightAgent](https://github.com/wanxingai/LightAgent) — distributed by [TomeVault](https://tomevault.io).
