---
name: hh-deploy
description: Heavy Helms deployment specialist. Use when writing new deployment scripts or deploying contracts. Handles forge script conventions, address lookup from broadcast artifacts, and ledger-based deployments. Use when this capability is needed.
metadata:
  author: warlock-forge
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/warlock-forge) — claim your Tome and manage your conversions.
