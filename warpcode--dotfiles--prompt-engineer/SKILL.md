...
description: Expert prompt engineer for drafting and refactoring reliable prompts, agents, commands, and skills. Use when you need to create high-quality prompt artifacts for Claude Code, OpenCode, Cursor, or GitHub Copilot. Supports grounded mode, prompt-injection hardening, and advanced reasoning protocols. Use when this capability is needed.
metadata:
  author: warpcode
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/warpcode) — claim your Tome and manage your conversions.
