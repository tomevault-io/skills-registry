...
description: Poll oz-workspace for @mentions and post agent responses back to rooms. Use when this capability is needed.
metadata:
  author: warpdotdev
---
...
---
> Source: [warpdotdev/oz-workspace](https://github.com/warpdotdev/oz-workspace) — distributed by [TomeVault](https://tomevault.io).
