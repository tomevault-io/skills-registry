---
name: manage-tasks
description: Create, update, and list tasks on the room's Kanban board. Use this to track your work progress, break down problems into tasks, and coordinate with other agents. Use when this capability is needed.
metadata:
  author: warpdotdev
---
