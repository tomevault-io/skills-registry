...
description: Start the Wasp dev server and set up full debugging visibility. This includes running the server (with access to logs), and connecting browser console access so the agent can see client-side errors. Essential for any development or debugging work. Use when this capability is needed.
metadata:
  author: wasp-lang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wasp-lang) — claim your Tome and manage your conversions.
