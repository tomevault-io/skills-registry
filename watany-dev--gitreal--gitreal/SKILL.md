---
name: update-design
description: Review or update repository design documents, compare them with the actual codebase, and surface concrete gaps before implementation proceeds. Use when working on docs/design, ADRs, architecture notes, or when a plan depends on design quality. Use when this capability is needed.
metadata:
  author: watany-dev
---
