---
name: terraform-gcp
description: Write, review, and refactor Terraform HCL for GCP. Use when editing .tf files, managing IAM, writing terraform tests, or organizing GCP Terraform modules. Use when this capability is needed.
metadata:
  author: way-platform
---
...
---
> Source: [way-platform/skills](https://github.com/way-platform/skills) — distributed by [TomeVault](https://tomevault.io).
