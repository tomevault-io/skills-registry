...
description: Multi-agent task orchestration using the spec CLI. Guides agents on claiming tasks, parallel execution, blocking, and coordination. Use when working with multiple agents, claiming tasks, or managing parallel work. Use when this capability is needed.
metadata:
  author: wbeard
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wbeard) — claim your Tome and manage your conversions.
