...
description: Schedule Cursor agent tasks via OpenClaw cron, monitor execution via Cursor's terminal/transcript files, and report results to Telegram or other channels. Use when this capability is needed.
metadata:
  author: wchklaus97
---
