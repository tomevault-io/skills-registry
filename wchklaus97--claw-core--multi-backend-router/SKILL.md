...
description: Smart routing between backends (Cursor Agent, PicoClaw, Claw Core). Automatically selects the best tool for each task type. Use for the developer agent or any multi-capable agent. Use when this capability is needed.
metadata:
  author: wchklaus97
---
