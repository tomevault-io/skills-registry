---
name: team-lead
description: Coordinate an agent team session — break down tasks, assign to teammates, monitor progress, synthesize results. Use when leading a multi-agent collaboration. Use when this capability is needed.
metadata:
  author: wchklaus97
---
