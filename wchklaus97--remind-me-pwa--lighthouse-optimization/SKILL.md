...
description: Optimize web applications to achieve 95%+ Lighthouse scores across all categories. Use when optimizing performance, accessibility, best practices, or SEO for web applications. Use when this capability is needed.
metadata:
  author: wchklaus97
---
