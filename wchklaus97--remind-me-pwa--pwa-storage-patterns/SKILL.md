...
description: Implement data persistence patterns for Progressive Web Apps. Use when working with browser storage APIs, implementing localStorage or IndexedDB, or managing client-side data persistence. Use when this capability is needed.
metadata:
  author: wchklaus97
---
