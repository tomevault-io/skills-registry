---
name: deepwiki
description: Query GitHub repositories to understand external codebases, get real code examples with source code snippets, and program correctly using actual source documentation. Supports Fast, Deep Research, and Codemap investigation modes. Use when this capability is needed.
metadata:
  author: wdabliu
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wdabliu) — claim your Tome and manage your conversions.
