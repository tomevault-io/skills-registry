...
description: Automate repository update handoff by summarizing changes, staging files, committing, and pushing to remote. Use when the user asks to "总结更新并提交", "git add commit push", "自动提交代码", or any request that combines change summary + Git commit/push in one flow. Use when this capability is needed.
metadata:
  author: wdkwdkwdk
---
