---
name: commit
description: Create well-structured git commits following conventional commits format. Use when the user asks to commit changes or when finishing a piece of work. Use when this capability is needed.
metadata:
  author: wdonofrio
---
