...
description: 微信消息桥接 - 在微信中与 Claude Code 聊天。支持文字对话、图片识别、实时进度推送、斜杠命令。 Use when this capability is needed.
metadata:
...
---
> Source: [Wechat-ggGitHub/wechat-claude-code](https://github.com/Wechat-ggGitHub/wechat-claude-code) — distributed by [TomeVault](https://tomevault.io).
