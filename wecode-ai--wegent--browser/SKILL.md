---
name: browser
description: Complete real user web tasks end-to-end via browser-tool, navigate, interact, wait for page state, extract results, and provide evidence when needed. Use when this capability is needed.
metadata:
  author: wecode-ai
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wecode-ai) — claim your Tome and manage your conversions.
