...
description: Convert the current conversation into a reusable system prompt draft with strict structure and quality checks. Use when this capability is needed.
metadata:
  author: wecode-ai
---
