---
name: commit
description: 執行提交前檢查（linting、測試、code review）並建立 git commit。當使用者說「commit」、「提交」、「幫我提交」時使用。 Use when this capability is needed.
metadata:
  author: weihanchen
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/weihanchen) — claim your Tome and manage your conversions.
