...
description: Enrich creator profiles and onchain reputation by aggregating Talent Protocol, Guild.xyz, Basenames, Zora, and DeBank portfolio signals. Use when the user mentions creator discovery/ranking, onchain reputation, Talent API, Guild roles, Basename/ENS data, Zora profiles, or DeBank/portfolio activity. Use when this capability is needed.
metadata:
  author: wenakita
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wenakita) — claim your Tome and manage your conversions.
