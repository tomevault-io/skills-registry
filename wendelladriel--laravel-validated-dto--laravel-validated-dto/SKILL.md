...
description: Guidance for generating, designing, and refactoring ValidatedDTO, SimpleDTO, and ResourceDTO classes in Laravel applications. Use when this capability is needed.
metadata:
...
---
> Source: [WendellAdriel/laravel-validated-dto](https://github.com/WendellAdriel/laravel-validated-dto) — distributed by [TomeVault](https://tomevault.io).
