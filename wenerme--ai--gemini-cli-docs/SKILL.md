...
description: Use when working with Gemini CLI (Google's AI coding agent): CLI commands, authentication, settings, sandbox mode, model selection, keyboard shortcuts, GEMINI.md project instructions, tools (shell, file system, web search, web fetch, MCP servers, memory, todos), hooks, extensions, IDE integration, checkpointing, or troubleshooting Gemini CLI issues.
metadata:
  author: wenerme
---
...
---
> Source: [wenerme/ai](https://github.com/wenerme/ai) — distributed by [TomeVault](https://tomevault.io).
