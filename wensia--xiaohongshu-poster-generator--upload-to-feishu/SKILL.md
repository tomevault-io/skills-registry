...
description: Uploads images to Feishu Bitable attachment fields using a Python script (since lark-mcp does not support file uploads). Use when the user needs to upload generated poster images to Feishu records, batch upload cover and content pages, or update attachment fields. Use when this capability is needed.
metadata:
  author: wensia
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wensia) — claim your Tome and manage your conversions.
