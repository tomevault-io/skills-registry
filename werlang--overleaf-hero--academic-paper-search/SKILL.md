...
description: Search academic literature on the web (Google Scholar, arXiv, Semantic Scholar, IEEE Xplore, etc.), extract abstracts/metadata, rank by relevance (0-100), and optionally download PDFs to papers/ folder. Use when asked to find papers, search literature, discover related work, update bibliography, or when user mentions "recent work on [topic]", "papers from [venue]", or requests literature review assistance. Use when this capability is needed.
metadata:
  author: werlang
---
