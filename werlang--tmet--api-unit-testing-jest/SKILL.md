...
description: Write and maintain TMET Jest + Supertest tests. Use when changing routes, models, helpers, queue logic, file parsing, or API contracts and you need focused coverage under tests/routes, tests/models, tests/helpers, or tests/integration. Use when this capability is needed.
metadata:
  author: werlang
---
...
---
> Source: [werlang/tmet](https://github.com/werlang/tmet) — distributed by [TomeVault](https://tomevault.io).
