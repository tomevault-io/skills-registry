---
name: ios-patterns
description: Padrões iOS modernos: Swift, SwiftUI, MVVM, async/await, Combine, Core Data, SwiftData, Navigation, testes. Use quando implementar features em iOS nativo. Use when this capability is needed.
metadata:
...
---
> Source: [wesleyosantos91/multi-agents](https://github.com/wesleyosantos91/multi-agents) — distributed by [TomeVault](https://tomevault.io).
