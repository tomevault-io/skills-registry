...
description: Register Wix CLI extensions with the app in src/extensions.ts. Use when registering new or existing extensions with the main app builder. Use when this capability is needed.
metadata:
  author: weunica
---
