---
name: webauthx
description: Set up production-ready WebAuthn passkey authentication using webauthx. Use when adding passkey auth, WebAuthn registration, or WebAuthn authentication to an app. Use when this capability is needed.
metadata:
  author: wevm
---
...
---
> Source: [wevm/webauthx](https://github.com/wevm/webauthx) — distributed by [TomeVault](https://tomevault.io).
