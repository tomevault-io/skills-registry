...
description: Dense quick-reference for Apex governor limits, trigger patterns, async processing, DML operations, security enforcement, common errors, and idioms. Table-heavy, optimized for fast lookup during development. Use when this capability is needed.
metadata:
  author: weytani
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/weytani) — claim your Tome and manage your conversions.
