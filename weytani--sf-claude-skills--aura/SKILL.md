...
description: Platform reference for Aura component development — bundle structure, markup, controllers, events, Apex integration, and migration guidance to LWC. Use when this capability is needed.
metadata:
  author: weytani
---
