---
name: slds2
description: Salesforce Lightning Design System (SLDS 2) platform reference — design tokens, grid, utility classes, component blueprints, icons, accessibility, and LWC/Aura usage patterns. Use when this capability is needed.
metadata:
  author: weytani
---
