---
name: redc-useage
description: Multi-cloud red team infrastructure automation. Deploy and manage cloud resources across AWS, Aliyun, Tencent Cloud with Terraform. Includes commands for init, deploy, manage, execute, and cleanup of infrastructure cases. Use when this capability is needed.
metadata:
  author: wgpsec
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wgpsec) — claim your Tome and manage your conversions.
