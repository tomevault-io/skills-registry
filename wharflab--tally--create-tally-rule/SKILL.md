...
description: Implement a new custom `tally/*` Dockerfile lint rule end-to-end (rule code, overlap research, fix coordination, realistic tests/fixtures, snapshots, and docs). Use when a user describes desired behavior for a new tally-specific rule. Use when this capability is needed.
metadata:
  author: wharflab
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wharflab) — claim your Tome and manage your conversions.
