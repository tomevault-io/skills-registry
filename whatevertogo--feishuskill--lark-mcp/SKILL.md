---
name: lark-mcp
description: 飞书/Lark 官方 MCP 集成。支持发送消息、创建群组、操作多维表格（Bitable）、导入/搜索文档、知识库查询。触发词：飞书、Feishu、Lark、多维表格、bitable、飞书文档、飞书群。 Use when this capability is needed.
metadata:
  author: whatevertogo
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/whatevertogo) — claim your Tome and manage your conversions.
