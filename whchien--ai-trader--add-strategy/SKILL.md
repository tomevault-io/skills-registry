---
name: add-strategy
description: Create a new trading strategy for the ai-trader backtesting framework. Handles file creation, registration, docstrings, and backtest scaffolding. Use when this capability is needed.
metadata:
  author: whchien
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/whchien) — claim your Tome and manage your conversions.
