...
description: This skill should be used when the user asks to "learn formily basics", "setup formily", "formily core concepts", "formily getting started", "formily fundamentals", "how to use formily", "formily installation", or "formily form state management". Use when this capability is needed.
metadata:
  author: whinc
---
