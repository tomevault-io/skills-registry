---
name: ng-zorro
description: NG-ZORRO (Ant Design) Angular UI 组件库开发助手，提供超过 70 个企业级 UI 组件的使用指导和代码生成 Use when this capability is needed.
metadata:
  author: whitecloud-save
---
...
---
> Source: [whitecloud-save/whitecloud-client](https://github.com/whitecloud-save/whitecloud-client) — distributed by [TomeVault](https://tomevault.io).
