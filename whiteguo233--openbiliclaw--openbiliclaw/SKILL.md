...
description: Use OpenBiliClaw's adapter CLI to sync account signals, read profile summaries, fetch recommendations, submit feedback, and inspect runtime status. Use when this capability is needed.
metadata:
  author: whiteguo233
---
