---
name: electron-debug
description: 通过 CDP（Chrome DevTools Protocol）将 Playwright 连接到 LiveAutoRecord 的 Electron 应用， Use when this capability is needed.
metadata:
  author: whiteminds
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/whiteminds) — claim your Tome and manage your conversions.
