---
name: react-perf
description: React/Next.js performance optimization guidelines from Vercel Engineering. Use when reviewing performance, optimizing bundles, or fixing waterfalls. Use when this capability is needed.
metadata:
  author: whoabuddy
---
