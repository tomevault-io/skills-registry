...
description: Validate builds, type checks, and linting after code changes. Use proactively before finishing tasks or opening PRs. Use when this capability is needed.
metadata:
  author: whywaita
---
