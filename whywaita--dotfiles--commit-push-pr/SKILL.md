---
name: commit-push-pr
description: Create a git commit, push a branch, and open a Pull Request with gh. Use when asked to commit changes, push to origin, or create PRs, especially when conventional commits and PR templates are required. Use when this capability is needed.
metadata:
  author: whywaita
---
