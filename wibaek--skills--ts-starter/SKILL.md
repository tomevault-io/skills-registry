---
name: ts-starter
description: Configure TypeScript project tooling for existing Node or frontend projects without app scaffolding. Use for TS starter setup, TS lint/format/test setup, Node TypeScript starter, or Vite TypeScript config requests. Use when this capability is needed.
metadata:
  author: wibaek
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wibaek) — claim your Tome and manage your conversions.
