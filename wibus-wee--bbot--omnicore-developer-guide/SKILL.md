...
description: OmniCore architecture and developer guide reference. Use when asked to explain, review, or update OmniCore design philosophy, kernel/adapters/event sourcing, sessions/root paths, compaction and summaries, heartbeat, supervisor or CLI behavior, or to maintain developer-guide.md. Use when this capability is needed.
metadata:
  author: wibus-wee
---
...
- Edit `developer-guide.md` first.
- Copy it to `references/developer-guide.md` to keep this skill current.
