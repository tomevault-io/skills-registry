...
description: Guidelines for Wails 3 GUI frontend development with React and TypeScript. Use when working on frontend/, UI components, or Wails bindings. Use when this capability is needed.
metadata:
  author: wibus-wee
---
