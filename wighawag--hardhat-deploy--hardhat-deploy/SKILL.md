...
description: Comprehensive guide for migrating projects from hardhat-deploy v1 to v2, including dependency updates, configuration restructuring, deploy script conversion, test updates, and troubleshooting Use when this capability is needed.
metadata:
  author: wighawag
---
...
---
> Source: [wighawag/hardhat-deploy](https://github.com/wighawag/hardhat-deploy) — distributed by [TomeVault](https://tomevault.io).
