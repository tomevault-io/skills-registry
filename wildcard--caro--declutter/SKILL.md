---
name: declutter
description: Identify misplaced files and organize project structure following open-source best practices, while delegating refactoring to specialized skills Use when this capability is needed.
metadata:
  author: wildcard
---
