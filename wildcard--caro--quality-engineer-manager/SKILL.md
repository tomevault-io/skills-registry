...
description: Quality Engineer Manager skill for orchestrating release validation, beta testing coordination, feedback analysis, and release sign-off decisions Use when this capability is needed.
metadata:
  author: wildcard
---
