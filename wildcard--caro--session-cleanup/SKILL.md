...
description: Verify debug/dev artifacts are removed before commit. Use at session end to apply 'good boy scout' rule - leave code cleaner than you found it. Use when this capability is needed.
metadata:
  author: wildcard
---
