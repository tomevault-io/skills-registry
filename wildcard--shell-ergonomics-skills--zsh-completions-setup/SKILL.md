...
description: This skill should be used when the user asks to "set up shell completions", "fix zsh completions", "configure tab completion", "add completions for brew/npm/cargo", "troubleshoot missing completions", or mentions fpath, compinit, or Oh My Zsh completion issues. Use when this capability is needed.
metadata:
  author: wildcard
---
...
---
> Source: [wildcard/shell-ergonomics-skills](https://github.com/wildcard/shell-ergonomics-skills) — distributed by [TomeVault](https://tomevault.io).
