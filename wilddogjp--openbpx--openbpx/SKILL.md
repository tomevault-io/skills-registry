...
description: BPX `localization` command skill. Read/query/resolve localization data and edit existing text identities. Use when this capability is needed.
metadata:
  author: wilddogjp
---
...
---
> Source: [wilddogjp/openbpx](https://github.com/wilddogjp/openbpx) — distributed by [TomeVault](https://tomevault.io).
