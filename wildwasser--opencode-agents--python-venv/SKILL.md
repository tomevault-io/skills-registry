---
name: python-venv
description: Manage Python virtual environments and dependencies. Use when setting up projects or installing packages. Use when this capability is needed.
metadata:
  author: wildwasser
---
