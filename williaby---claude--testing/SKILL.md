---
name: testing
description: Automated test generation, review, and execution for pytest-based projects. Auto-activates on keywords test, coverage, pytest, unittest, integration test, e2e, performance, benchmark, security testing. Routes to specialized testing workflows based on user intent. Use when this capability is needed.
metadata:
  author: williaby
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/williaby) — claim your Tome and manage your conversions.
