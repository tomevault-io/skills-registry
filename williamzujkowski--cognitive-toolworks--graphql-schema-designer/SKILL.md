...
description: Design GraphQL schemas with federation, resolvers, dataloaders, n+1 query prevention, and schema stitching patterns Use when this capability is needed.
metadata:
