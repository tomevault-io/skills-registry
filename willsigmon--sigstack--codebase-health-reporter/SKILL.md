...
description: Generate comprehensive health report for Leavn codebase - metrics, technical debt, bugs found/fixed, recommendations for next session Use when this capability is needed.
metadata:
  author: willsigmon
---
