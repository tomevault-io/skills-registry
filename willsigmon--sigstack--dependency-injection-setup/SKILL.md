...
description: Add new services to DIContainer, create protocol-based implementations, set up singletons or factories for Leavn app dependency injection Use when this capability is needed.
metadata:
  author: willsigmon
---
