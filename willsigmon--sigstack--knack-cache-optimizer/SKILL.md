...
description: Caches API results and enforces Knack's 10-requests-per-second rate limit. Critical for dashboard performance and cost reduction. Use when this capability is needed.
metadata:
  author: willsigmon
---
