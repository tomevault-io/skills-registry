...
description: Dynamic filtering, sorting, and query optimization for HTI dashboards and compliance reports. Reduces API payload size and improves dashboard perfo... Use when this capability is needed.
metadata:
  author: willsigmon
---
