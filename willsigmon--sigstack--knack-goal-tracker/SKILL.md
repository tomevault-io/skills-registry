...
description: Tracks HTI's performance against both grant and business development goals in real-time. Provides early warning system for goal attainment risks an... Use when this capability is needed.
metadata:
  author: willsigmon
---
