---
name: knack-reader
description: REST-based access to Knack Objects and Views for data extraction and transformation. Primary skill for reading HTI operational data from Knack data... Use when this capability is needed.
metadata:
  author: willsigmon
---
