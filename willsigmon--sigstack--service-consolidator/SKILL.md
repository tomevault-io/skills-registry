...
description: Find and consolidate duplicate service implementations in Leavn app - analyze variants, choose winner, update call sites, delete duplicates Use when this capability is needed.
metadata:
  author: willsigmon
---
