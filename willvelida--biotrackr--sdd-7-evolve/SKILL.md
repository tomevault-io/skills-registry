---
name: sdd-7-evolve
description: Encode learnings from completed SDD cycles into the agent harness. Use when: a review has been approved and learnings need to be extracted, classified, and encoded into instruction files, copilot-instructions, or AGENTS.md. Use when this capability is needed.
metadata:
  author: willvelida
---
...
---
> Source: [willvelida/biotrackr](https://github.com/willvelida/biotrackr) — distributed by [TomeVault](https://tomevault.io).
