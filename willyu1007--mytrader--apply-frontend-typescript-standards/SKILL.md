...
description: Apply frontend TypeScript standards for safety and maintainability (strict typing, props DTOs, safe utilities, no implicit any). Use when this capability is needed.
metadata:
  author: willyu1007
---
