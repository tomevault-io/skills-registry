...
description: Create a structured dev-docs task bundle (overview/plan/architecture/notes/verification/pitfalls) with clear scope, acceptance criteria, and handoff-ready artifacts; triggers: task docs/dev-docs/handoff/context recovery. Use when this capability is needed.
metadata:
  author: willyu1007
---
