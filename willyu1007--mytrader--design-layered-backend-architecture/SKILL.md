...
description: Design or review a layered backend architecture (routes, controllers, services, repositories) for HTTP APIs and microservices. Use when this capability is needed.
metadata:
  author: willyu1007
---
