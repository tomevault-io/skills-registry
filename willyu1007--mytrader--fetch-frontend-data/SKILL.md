...
description: Fetch and mutate frontend data with a consistent cache strategy (query keys, invalidation, suspense/loading, error handling, optimistic updates). Use when this capability is needed.
metadata:
  author: willyu1007
---
