...
description: Maintain .ai/project/state.json (stage and non-secret config references) via projectctl for consistent automation gates. Use when this capability is needed.
metadata:
  author: willyu1007
---
