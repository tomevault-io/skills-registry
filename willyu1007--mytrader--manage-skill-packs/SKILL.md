...
description: Enable or disable skill packs via skillsctl and re-sync provider wrappers without manually editing the manifest. Use when this capability is needed.
metadata:
  author: willyu1007
---
