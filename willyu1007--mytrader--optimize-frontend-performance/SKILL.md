...
description: Optimize frontend performance through measurement-driven improvements (render optimization, code splitting, caching, virtualization). Use when this capability is needed.
metadata:
  author: willyu1007
---
