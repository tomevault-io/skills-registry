...
description: Apply safe and maintainable backend database patterns (transactions, pagination, soft deletes, query optimization, data consistency). Use when this capability is needed.
metadata:
  author: willyu1007
---
