...
description: Implement or refactor backend HTTP routing and controllers using a layered pattern (routes delegate, controllers validate and call services). Use when this capability is needed.
metadata:
  author: willyu1007
---
