...
description: Instrument backend services with logging, error tracking, metrics, and tracing to diagnose failures and performance issues. Use when this capability is needed.
metadata:
  author: willyu1007
---
