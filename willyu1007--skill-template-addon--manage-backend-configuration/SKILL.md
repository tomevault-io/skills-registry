...
description: Manage backend configuration safely with typed, validated settings and clear separation between defaults and secrets. Use when this capability is needed.
metadata:
  author: willyu1007
---
