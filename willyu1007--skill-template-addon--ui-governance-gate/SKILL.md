...
description: One-command UI governance gate that enforces the data-ui contract + Tailwind B1 and (optionally) orchestrates ESLint/Stylelint/Playwright under the same evidence run directory. Use when this capability is needed.
metadata:
  author: willyu1007
---
