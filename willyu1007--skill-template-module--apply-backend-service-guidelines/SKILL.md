...
description: Apply cross-cutting backend service patterns across routing, services, repositories, validation, configuration, errors, and tests. Use when this capability is needed.
metadata:
  author: willyu1007
---
