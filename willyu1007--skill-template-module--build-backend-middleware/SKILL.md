...
description: Design and implement backend middleware (auth, validation, logging, rate limits, error boundaries) with predictable ordering and behavior. Use when this capability is needed.
metadata:
  author: willyu1007
---
