---
name: ci
description: Enable and operate the CI feature (GitHub Actions / GitLab CI) with repeatable templates, artifact conventions, and opt-in delivery enablement. Use when this capability is needed.
metadata:
  author: willyu1007
---
