...
description: Create or resume a module/integration dev-docs task bundle (00-05) for non-trivial work requiring handoff or context recovery; docs only (no code changes). Use when this capability is needed.
metadata:
  author: willyu1007
---
