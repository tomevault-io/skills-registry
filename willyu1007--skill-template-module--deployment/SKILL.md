---
name: deployment
description: Enable and operate the Deployment feature (ops/deploy conventions + deploy scripts) for multi-environment delivery. Use when this capability is needed.
metadata:
  author: willyu1007
---
