...
description: Execute dependency-aware code refactors (moves, extraction, import rewrites) incrementally with approval gates, rollback points, and continuous verification. Use when this capability is needed.
metadata:
  author: willyu1007
---
