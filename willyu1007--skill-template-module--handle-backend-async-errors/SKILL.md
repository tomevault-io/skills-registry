...
description: Handle async/await and error propagation in backend services with consistent error types, wrappers, and response mapping. Use when this capability is needed.
metadata:
  author: willyu1007
---
