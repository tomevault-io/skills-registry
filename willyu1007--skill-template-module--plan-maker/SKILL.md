---
name: plan-maker
description: Create a goal-aligned macro-level roadmap (module/integration dev-docs) by asking clarifying questions when needed; planning only (no code changes); strong signal words: make plan/roadmap/implementation plan. Use when this capability is needed.
metadata:
  author: willyu1007
---
