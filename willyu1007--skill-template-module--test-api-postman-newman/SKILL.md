...
description: Postman + Newman API automation: collection conventions, deterministic assertions, local/CI execution, and actionable failure summaries. Use when this capability is needed.
metadata:
  author: willyu1007
---
