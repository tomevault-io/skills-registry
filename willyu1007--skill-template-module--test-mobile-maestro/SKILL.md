...
description: Maestro mobile UI automation: YAML flow authoring, stable selectors, local/CI execution, and failure triage with reproducible artifacts. Use when this capability is needed.
metadata:
  author: willyu1007
---
