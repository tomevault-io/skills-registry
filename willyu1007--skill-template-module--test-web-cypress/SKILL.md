...
description: Cypress Web UI E2E automation: bootstrap, author specs, run/debug, and triage failures with consistent artifacts and CI hooks. Use when this capability is needed.
metadata:
  author: willyu1007
---
