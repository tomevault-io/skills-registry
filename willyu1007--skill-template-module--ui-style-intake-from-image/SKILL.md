...
description: Convert a UI screenshot into a Style Profile and a minimal change proposal (prefer new theme tokens) for the data-ui contract system, with a mandatory approval gate for any token/contract changes. Use when this capability is needed.
metadata:
  author: willyu1007
---
