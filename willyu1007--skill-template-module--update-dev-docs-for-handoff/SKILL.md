...
description: Finalize/synchronize a task’s dev-docs for handoff or wrap-up in module/integration scope; docs only (no new code changes). Use when this capability is needed.
metadata:
  author: willyu1007
---
