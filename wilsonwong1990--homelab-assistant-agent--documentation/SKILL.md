---
name: documentation
description: Documentation practices, note-taking strategies, and knowledge management for tracking homelab configurations, changes, and learnings across multiple repositories. Use when this capability is needed.
metadata:
