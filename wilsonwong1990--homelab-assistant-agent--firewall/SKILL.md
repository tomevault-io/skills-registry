---
name: firewall
description: Network security and firewall configuration for homelab environments, covering rule management, VPN setup, traffic isolation, and security best practices for personal infrastructure. Use when this capability is needed.
metadata:
