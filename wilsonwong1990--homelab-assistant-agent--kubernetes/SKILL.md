---
name: kubernetes
description: Upstream Kubernetes expertise for homelab container orchestration (see k3s skill for lightweight installs), focusing on practical cluster management, workload deployment, and storage solutions suitable for personal infrastructure. Use when this capability is needed.
metadata:
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wilsonwong1990) — claim your Tome and manage your conversions.
