---
name: healthcheck
description: Host security hardening and risk-tolerance configuration for SANI deployments. Use when a user asks for security audits, firewall/SSH/update hardening, risk posture, exposure review, SANI cron scheduling for periodic checks, or version status checks on a machine running SANI (laptop, workstation, Pi, VPS). Use when this capability is needed.
metadata:
  author: wimpyvl
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wimpyvl) — claim your Tome and manage your conversions.
