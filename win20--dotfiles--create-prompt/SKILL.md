---
name: create-prompt
description: Rewrite user requests into clear, precise, and complete AI prompts. Use when a user asks to create, convert, or refine a prompt, or to restate a request as a specification for an AI model. Use when this capability is needed.
metadata:
  author: win20
---
