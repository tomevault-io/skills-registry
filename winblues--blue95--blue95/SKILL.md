...
description: Diagnose and fix visual/theming issues in Blue95 (XFCE, Chicago95 GTK theme, icon themes, xfconf defaults) and wire fixes into the build pipeline Use when this capability is needed.
metadata:
  author: winblues
---
...
---
> Source: [winblues/blue95](https://github.com/winblues/blue95) — distributed by [TomeVault](https://tomevault.io).
