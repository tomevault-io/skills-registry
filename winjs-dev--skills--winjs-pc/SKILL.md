---
name: winjs-pc
description: WinJS PC 模板（PC 端 Web）开发指南。包含 Vue 3 配置、Vite 构建、请求封装、路由。适用于：(1) create-win pc 模板创建的项目 (2) 修改 .winrc 配置 (3) 扩展 src/app.js (4) 编写 services 请求 (5) 配置路由与构建 (6) PC 浏览器项目（无 REM/VConsole）。 Use when this capability is needed.
metadata:
  author: winjs-dev
---
