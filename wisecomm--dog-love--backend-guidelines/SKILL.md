...
description: Core architectural rules, coding conventions, and tech stack guidelines for the Dog-Love Backend. Reference this for all backend code changes. Use when this capability is needed.
metadata:
  author: wisecomm
---
