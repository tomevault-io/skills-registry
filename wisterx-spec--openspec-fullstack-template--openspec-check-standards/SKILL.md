...
description: Check code against project development standards. Use when the user wants to verify code follows conventions like server-side pagination, structured logging, etc. Use when this capability is needed.
metadata:
  author: wisterx-spec
---
