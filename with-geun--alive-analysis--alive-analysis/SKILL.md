---
name: alive-analysis
description: Data analysis workflow kit using the ALIVE loop (Ask, Look, Investigate, Voice, Evolve) Use when this capability is needed.
metadata:
  author: with-geun
---
...
Append-only log of methodology decisions. Prevents AI from re-proposing alternatives already evaluated.
...
AI-maintained knowledge base compiled from archived analyses (LLM Wiki concept).
...
---
> Source: [with-geun/alive-analysis](https://github.com/with-geun/alive-analysis) — distributed by [TomeVault](https://tomevault.io).
