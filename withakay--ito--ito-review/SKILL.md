---
name: ito-review
description: Review and validate Ito changes, specs, or implementations. Use when the user wants a quality check, code review, or validation of project artifacts. Use when this capability is needed.
metadata:
  author: withakay
---
