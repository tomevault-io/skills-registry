---
name: coral
description: Query live sources through Coral MCP. Use when the task needs GitHub, Jira, Slack, Linear, Datadog, Sentry, files, or connected data. Use when this capability is needed.
metadata:
  author: withcoral
---
