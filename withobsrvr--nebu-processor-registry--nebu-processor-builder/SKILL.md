...
description: Interactively scaffold production-ready Nebu processors (origin/transform/sink) with proper Go module structure, CLI helpers, and optional registry entries Use when this capability is needed.
metadata:
  author: withobsrvr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/withobsrvr) — claim your Tome and manage your conversions.
