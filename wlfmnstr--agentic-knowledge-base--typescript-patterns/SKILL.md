...
description: TypeScript utility types and type-safe API design patterns. Use when designing type systems, creating utility types, or implementing type-safe patterns. Use when this capability is needed.
metadata:
  author: wlfmnstr
---
