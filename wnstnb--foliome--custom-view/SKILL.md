---
name: custom-view
description: Build a custom dashboard view from a natural language request — query, API, React component, build, deploy Use when this capability is needed.
metadata:
  author: wnstnb
---
...
---
> Source: [wnstnb/foliome](https://github.com/wnstnb/foliome) — distributed by [TomeVault](https://tomevault.io).
