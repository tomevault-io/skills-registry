...
description: Cascading git pre-push hooks for monorepo/workspace dependencies. Auto-pushes dirty dependencies before pushing the main package. Use when setting up git hooks for packages that depend on sibling workspace packages, or when configuring pre-push workflows with dependency chains. Use when this capability is needed.
metadata:
  author: wobyjs
---
...
---
> Source: [wobyjs/woby](https://github.com/wobyjs/woby) — distributed by [TomeVault](https://tomevault.io).
