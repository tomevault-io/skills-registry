---
name: documentation
description: Centralizes Diataxis documentation framework guidance so Claude can write, review, or improve documentation following the four distinct types (tutorials, how-to guides, reference, explanation). Use when this capability is needed.
metadata:
  author: wodsmith
---
