---
name: rust-release
description: Plan and execute Rust release engineering. Use when: publishing a crate, setting up release automation, cross-compiling binaries, configuring cargo-dist, or managing changelogs and SemVer. Use when this capability is needed.
metadata:
  author: woliveiras
---
