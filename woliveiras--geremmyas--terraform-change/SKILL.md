...
description: Plan and review a Terraform infrastructure change safely. Use when: editing Terraform, importing resources, moving resource addresses, reviewing a plan, or deciding whether apply/destroy/state commands are safe. Use when this capability is needed.
metadata:
  author: woliveiras
---
...
---
> Source: [woliveiras/geremmyas](https://github.com/woliveiras/geremmyas) — distributed by [TomeVault](https://tomevault.io).
