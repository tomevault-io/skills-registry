---
name: code-review
description: This skill should be used when the user wants to "review code", "check code quality", "run code review", or needs local code quality verification before git push. Runs lint, typecheck, and code review on changed files. Use when this capability is needed.
metadata:
  author: wonjiko
---
