...
description: This skill should be used when the user wants to "validate a command", "review my command", "check command quality", "audit slash command", or needs evaluation of their Claude Code custom command against best practices. Use when this capability is needed.
metadata:
  author: wonjiko
---
