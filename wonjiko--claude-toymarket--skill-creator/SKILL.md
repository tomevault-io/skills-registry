---
name: skill-creator
description: This skill should be used when the user wants to "create a skill", "add a skill", "make a new skill", "create a command", "add a command", or needs guidance on skill structure for Claude Code plugins. Use when this capability is needed.
metadata:
  author: wonjiko
---
...
사용자가 원하는 skill의:
- 목적과 도메인
- 트리거 조건 (사용자 호출 or 자동 트리거)
- 필요한 지식/워크플로우

불명확하면 질문:
- "이 skill은 어떤 상황에서 활성화되어야 하나요?"
- "사용자가 직접 호출하나요, 아니면 자동 트리거인가요?"
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wonjiko) — claim your Tome and manage your conversions.
