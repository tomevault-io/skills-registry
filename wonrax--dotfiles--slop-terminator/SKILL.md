...
description: Review code changes (diffs) and identify slops, vibecoded artifacts, and low-quality code patterns. Use when reviewing PRs, cleaning up changesets, or eliminating slops including contextual comments, over-abstraction, dead code, style inconsistencies etc. Use when this capability is needed.
metadata:
  author: wonrax
---
