...
description: Guidelines for creating and modifying markdown files in WooCommerce. Use when writing documentation, README files, or any markdown content. Use when this capability is needed.
metadata:
  author: woocommerce
---
