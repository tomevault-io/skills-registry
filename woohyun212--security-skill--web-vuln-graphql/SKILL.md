...
description: GraphQL API security testing including introspection, batching, and authorization bypass Use when this capability is needed.
metadata:
  author: woohyun212
---
...
---
> Source: [woohyun212/security-skill](https://github.com/woohyun212/security-skill) — distributed by [TomeVault](https://tomevault.io).
