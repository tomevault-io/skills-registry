...
description: git diff를 분석하여 설명적인 커밋 메시지를 생성합니다. 사용자가 커밋 메시지 작성이나 스테이징된 변경사항 검토를 요청할 때 사용합니다. Use when this capability is needed.
metadata:
  author: woowacourse-teams
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/woowacourse-teams) — claim your Tome and manage your conversions.
