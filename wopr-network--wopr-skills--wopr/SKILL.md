---
name: wopr
description: Complete WOPR CLI reference for session management, skills, plugins, providers, middleware, cron jobs, security, sandbox isolation, and inter-agent communication. Use when this capability is needed.
metadata:
  author: wopr-network
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wopr-network) — claim your Tome and manage your conversions.
