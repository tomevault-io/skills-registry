...
description: Activates when users start a new novel project - guides them through the seven-step methodology (constitution → specify → clarify → plan → tasks → write → analyze) with gentle prompts and explanations Use when this capability is needed.
metadata:
  author: wordflowlab
---
