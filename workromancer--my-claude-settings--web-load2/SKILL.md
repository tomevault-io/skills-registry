---
name: web-load2
description: Loads and extracts all content from web URLs. Use when the user asks to fetch, load, or retrieve content from a website or URL. Use when this capability is needed.
metadata:
  author: workromancer
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/workromancer) — claim your Tome and manage your conversions.
