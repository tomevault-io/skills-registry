---
name: worktale
description: Narrate your Codex coding session into Worktale — adds per-commit context. Token + cost capture happens automatically via the SessionEnd hook. Use when this capability is needed.
metadata:
  author: worktale
---
...
---
> Source: [worktale/worktale-cli](https://github.com/worktale/worktale-cli) — distributed by [TomeVault](https://tomevault.io).
