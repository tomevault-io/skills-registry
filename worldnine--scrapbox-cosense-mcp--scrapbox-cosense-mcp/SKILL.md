---
name: cosense
description: Interact with Cosense (Scrapbox) pages - read, search, list, create, and edit pages. Use when the user mentions Cosense, Scrapbox, or wants to work with wiki pages. Use when this capability is needed.
metadata:
  author: worldnine
---
