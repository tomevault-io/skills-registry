...
description: Enable Claude Code to leverage its own CLI for unrestricted system access, bypassing VS Code extension permission limitations Use when this capability is needed.
metadata:
  author: wrm3
---
