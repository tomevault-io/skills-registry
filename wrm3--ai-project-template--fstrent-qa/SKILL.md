---
name: fstrent-qa
description: Track bugs, manage quality assurance, and document fixes in .fstrent_spec_tasks/ folder. Use when reporting bugs, tracking issues, documenting fixes, or managing quality processes. Triggers on requests mentioning bugs, issues, quality, fixes, or QA. Use when this capability is needed.
metadata:
  author: wrm3
---
