...
description: Download, transcribe, and analyze YouTube videos using Claude Code's native capabilities. Use when user provides a YouTube URL. Automatically downloads, extracts audio, transcribes with Whisper AI, then Claude Code analyzes directly - no external API key needed! Use when this capability is needed.
metadata:
  author: wrm3
---
