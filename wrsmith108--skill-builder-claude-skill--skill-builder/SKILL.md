---
name: skill-builder
description: Create new Claude Code skills with best practices. Use when user wants to create, extract, or build a new skill. Provides templates and GitHub automation. Trigger phrases include "create a skill", "build a skill", "extract a skill", "new skill", "/skill-builder". Use when this capability is needed.
metadata:
  author: wrsmith108
---
