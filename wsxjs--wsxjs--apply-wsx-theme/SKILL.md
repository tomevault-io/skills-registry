...
description: Apply @wsxjs/wsx-theme (wsx-branding) and clarify design tokens. Use when: add theme package, brand a WSXJS app, unify tokens, design system, light/dark, tokens-host. Use when this capability is needed.
metadata:
  author: wsxjs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wsxjs) — claim your Tome and manage your conversions.
