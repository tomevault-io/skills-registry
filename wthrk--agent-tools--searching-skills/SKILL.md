...
description: Searches the web for Claude Code agent skills and evaluates them. Use when user wants to find, discover, search for, or explore Claude Code skills, agent skills, or SKILL.md files. Use when this capability is needed.
metadata:
  author: wthrk
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wthrk) — claim your Tome and manage your conversions.
