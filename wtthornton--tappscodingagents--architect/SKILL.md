---
name: architect
description: Design system and security architecture. Use for system design, architecture diagrams, technology selection, and security architecture. Use when this capability is needed.
metadata:
  author: wtthornton
---
