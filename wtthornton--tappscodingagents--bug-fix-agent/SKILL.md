---
name: bug-fix-agent
description: Bug Fix Agent - Automated bug fixing with review loopback and auto-commit to main branch. Fixes bugs, tests them, reviews quality, and commits when quality gates pass. Use when this capability is needed.
metadata:
  author: wtthornton
---
