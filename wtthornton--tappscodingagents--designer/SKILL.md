---
name: designer
description: Design API contracts, data models, and UI/UX specifications. Use for API design, data modeling, UI wireframes, and design systems. Use when this capability is needed.
metadata:
  author: wtthornton
---
