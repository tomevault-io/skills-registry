---
name: documenter
description: Write documentation. Use when generating API docs, README files, or updating docstrings. Includes Context7 documentation standards lookup. Use when this capability is needed.
metadata:
  author: wtthornton
---
