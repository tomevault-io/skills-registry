...
description: Generate images using OpenRouter API with Gemini models. Triggers on "generate image", "create image", "draw", "nano banana", "生成图片", "画图", "信息卡片". Use when this capability is needed.
metadata:
  author: wuyuxiangx
---
...
---
> Source: [wuyuxiangx/yux-claude-hub](https://github.com/wuyuxiangx/yux-claude-hub) — distributed by [TomeVault](https://tomevault.io).
