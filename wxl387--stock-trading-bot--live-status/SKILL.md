---
name: live-status
description: Query the trading bot's current status — positions, P&L, stop-losses, agent health, message queue depth Use when this capability is needed.
metadata:
  author: wxl387
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wxl387) — claim your Tome and manage your conversions.
