...
description: Generate form code using element-plus-formkit. Triggered when the user needs to build/create any form, whether from an uploaded image, a description, or any other requirement. Use when this capability is needed.
metadata:
  author: wxsub
---
...
---
> Source: [wxsub/element-plus-formkit](https://github.com/wxsub/element-plus-formkit) — distributed by [TomeVault](https://tomevault.io).
