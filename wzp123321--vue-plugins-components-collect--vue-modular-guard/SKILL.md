...
description: 引导并执行 Vue 代码模块化拆分；在收到新需求或单文件代码臃肿、复用逻辑出现时调用，拆分为业务组件/公共组件、TypeScript 类型文件、hooks。 Use when this capability is needed.
metadata:
  author: wzp123321
---
...
---
> Source: [wzp123321/vue-plugins-components-collect](https://github.com/wzp123321/vue-plugins-components-collect) — distributed by [TomeVault](https://tomevault.io).
