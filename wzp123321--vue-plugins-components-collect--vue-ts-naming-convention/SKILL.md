...
description: 定义 Vue 项目中 TypeScript 类型（Interface/Type）的命名规范。在定义公共类型或业务模型时调用此技能。 Use when this capability is needed.
metadata:
  author: wzp123321
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/wzp123321) — claim your Tome and manage your conversions.
