...
description: Structured hypothesis formulation from observations. Use when you have experimental observations or data and need to formulate testable hypotheses with predictions, propose mechanisms, and design experiments to test them. Follows scientific method framework. For open-ended ideation use scientific-brainstorming; for automated LLM-driven hypothesis testing on datasets use hypogenic. Use when this capability is needed.
metadata:
  author: x-cmd
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/x-cmd) — claim your Tome and manage your conversions.
