...
description: To apply latest code changes to a running Flutter app, trigger hot reload after connecting to the Dart Tooling Daemon. Use when this capability is needed.
metadata:
