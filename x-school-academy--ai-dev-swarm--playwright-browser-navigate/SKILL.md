...
description: open a URL, open a web page, open web browser, or navigate the current page in the web browser to a new URL. Use when this capability is needed.
metadata:
