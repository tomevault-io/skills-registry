...
description: Agent-first workflow and design rails for building X07 programs with the released toolchain (no repo-only dependencies). Canonical execution is via `x07 run`. Use when this capability is needed.
metadata:
  author: x07lang
---
