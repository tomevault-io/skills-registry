---
name: x07-package
description: Manage X07 project dependencies and lockfiles for reproducible builds (lock, publish). Designed for autonomous agents. Use when this capability is needed.
metadata:
  author: x07lang
---
