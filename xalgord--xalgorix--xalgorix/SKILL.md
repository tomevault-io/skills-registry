...
description: Deploy CyberArk Privileged Access Management to discover, vault, rotate, and monitor privileged credentials across Use when this capability is needed.
metadata:
  author: xalgord
---
