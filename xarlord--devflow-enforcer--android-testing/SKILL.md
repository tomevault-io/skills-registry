...
description: Run Android unit and instrumentation tests. Supports JUnit, MockK, Espresso, and Compose UI testing with coverage reporting. Use when this capability is needed.
metadata:
  author: xarlord
---
