---
name: e2e-testing
description: Run end-to-end tests with Playwright or Cypress. Supports cross-browser testing, parallel execution, and detailed reporting. Use when this capability is needed.
metadata:
  author: xarlord
---
