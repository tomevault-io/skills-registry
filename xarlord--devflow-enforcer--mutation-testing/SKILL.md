...
description: Run mutation testing with Stryker to measure test quality. Identifies weak tests that don't catch code mutations. Use when this capability is needed.
metadata:
  author: xarlord
---
