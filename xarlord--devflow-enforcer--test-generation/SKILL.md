...
description: Generate unit tests for untested code using AI. Analyzes code structure and creates comprehensive test cases. Use when this capability is needed.
metadata:
  author: xarlord
---
