---
name: humanize
description: Transform AI-generated text to match user's voice and communication style. Use when drafting messages, emails, documents, or any external communication that should sound like the user wrote it. Use when this capability is needed.
metadata:
