---
name: git-workflow
description: Smart git operations — commit messages, branch management, PR creation with summaries. Use for any git workflow. Use when this capability is needed.
metadata:
  author: xbklairith
---
