...
description: Strict RED-GREEN-REFACTOR enforcement with no exceptions. Use when implementing features or fixing bugs. No production code without a failing test first. Use when this capability is needed.
metadata:
  author: xbklairith
---
