...
If the current project's `.github/copilot-instructions.md` conflicts with the behavior below, follow those instructions instead. This command is opt-in; the user invoked it explicitly.
...
- **.github/copilot-instructions.md overrides** win at every level.
