...
description: 2026-grade Cross-Domain Optimization. Expertise in Interaction to Next Paint (INP), Partial Hydration, UUIDv7 indexing, and AI Token Stewardship. Performance is a feature, not an afterthought. Use when this capability is needed.
metadata:
  author: xenitV1
---
<domain_overview>
