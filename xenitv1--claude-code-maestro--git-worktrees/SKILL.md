---
name: git-worktrees
description: Create isolated git workspaces for feature development. Smart directory selection, safety verification, and cross-platform support (Windows/Unix). Use when this capability is needed.
metadata:
  author: xenitv1
---
<domain_overview>
