...
description: API service operations for isA platform. Check Consul registration, clear stale records, trigger APISIX sync, and test service endpoints. Use when debugging service registration, fixing routing issues, or verifying service health via gateway. Use when this capability is needed.
metadata:
  author: xenoisa
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xenoisa) — claim your Tome and manage your conversions.
