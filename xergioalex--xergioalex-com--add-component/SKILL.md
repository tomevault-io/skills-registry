---
name: add-component
description: Create new Astro or Svelte components with correct patterns. Use proactively when creating new UI components. Use when this capability is needed.
metadata:
  author: xergioalex
---
