---
name: pr-review-lite
description: Quick checklist review of a PR for style, obvious bugs, and missing tests. Use proactively for lightweight PR reviews. Use when this capability is needed.
metadata:
  author: xergioalex
---
