---
name: type-fix
description: Fix TypeScript type errors in 1-3 files (explicit types, prefer no any). Use proactively for TypeScript type issues. Use when this capability is needed.
metadata:
  author: xergioalex
---
