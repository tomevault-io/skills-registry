---
name: write-tests
description: Add or expand unit/integration tests for existing code (when testing is configured). Use proactively when tests need to be added or expanded. Use when this capability is needed.
metadata:
  author: xergioalex
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xergioalex) — claim your Tome and manage your conversions.
