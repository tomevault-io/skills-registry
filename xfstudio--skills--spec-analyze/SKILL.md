---
name: spec-analyze
description: Perform non-destructive cross-artifact consistency and quality analysis across spec.md, plan.md, and tasks.md. Use when user says "/spec-analyze", "analyze the spec", "check consistency" after /spec-tasks to identify issues before implementation. Use when this capability is needed.
metadata:
  author: xfstudio
---
