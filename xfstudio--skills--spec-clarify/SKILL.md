---
name: spec-clarify
description: Identify underspecified areas in a feature spec by asking up to 5 targeted clarification questions and encoding answers into the spec. Use when user says "/spec-clarify", "clarify the spec", or after /spec-specify to reduce ambiguity before /spec-plan. Use when this capability is needed.
metadata:
  author: xfstudio
---
