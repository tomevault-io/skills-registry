---
name: spec-plan
description: Execute implementation planning workflow to generate design artifacts (research.md, data-model.md, contracts/, quickstart.md). Use when user says "/spec-plan", "create a plan", "plan the implementation" after /spec-specify or /spec-clarify. Use when this capability is needed.
metadata:
  author: xfstudio
---
