...
description: Convert tasks.md into GitHub issues with proper dependencies. Use when user says "/spec-taskstoissues", "create GitHub issues", "convert tasks to issues" after /spec-tasks when using GitHub for project management. Use when this capability is needed.
metadata:
  author: xfstudio
---
