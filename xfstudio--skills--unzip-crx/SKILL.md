---
name: unzip-crx
description: Extract Chrome extension (.crx) files. Use when user needs to unzip, extract, or decompress a .crx file. Handles Chrome's special crx headers that standard unzip tools cannot process. Use when this capability is needed.
metadata:
  author: xfstudio
---
