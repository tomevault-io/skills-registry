...
description: Create or update detailed upgrade notes and CHANGELOG entry for a major Hoist Core release. Use when writing documentation for a new major version upgrade. Use when this capability is needed.
metadata:
  author: xh
---
