---
name: xian-node
description: Operate current Xian nodes with xian-tech-cli and xian-stack. Use when joining canonical networks, creating private networks, running validators or service nodes, and inspecting runtime health. Use when this capability is needed.
metadata:
  author: xian-technology
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xian-technology) — claim your Tome and manage your conversions.
