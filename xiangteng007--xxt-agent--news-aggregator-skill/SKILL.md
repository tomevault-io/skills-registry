...
description: Comprehensive news aggregator that fetches, filters, and deeply analyzes real-time content from 8 major sources: Hacker News, GitHub Trending, Product Hunt, 36Kr, Tencent News, WallStreetCN, V2EX, and Weibo. Best for 'daily scans', 'tech news briefings', 'finance updates', and 'deep interpretations' of hot topics. Use when this capability is needed.
metadata:
  author: xiangteng007
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xiangteng007) — claim your Tome and manage your conversions.
