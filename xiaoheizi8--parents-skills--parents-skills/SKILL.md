---
name: create-parents
description: Distill parents into an AI Skill. Import chat history, photos, voice memos, generate Parent Memory + Persona, with continuous evolution. | 把父母蒸馏成 AI Skill，导入聊天记录、照片、语音，生成亲情记忆+人物性格，支持持续进化。 Use when this capability is needed.
metadata:
  author: xiaoheizi8
---
...
---
> Source: [xiaoheizi8/parents-skills](https://github.com/xiaoheizi8/parents-skills) — distributed by [TomeVault](https://tomevault.io).
