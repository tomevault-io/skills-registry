---
name: codeflow-adoption-router
description: Route the current job to the right Codeflow surface without overclaiming hosted, write-capable MCP, or published plugin support. Use when this capability is needed.
metadata:
  author: xiaojiou176-open
---
