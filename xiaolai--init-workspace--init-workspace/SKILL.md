---
name: init-workspace
description: Initialize a workspace with shared AI agent configuration files for Claude Code, Codex CLI, and Gemini CLI, plus full directory structure for all three tools Use when this capability is needed.
metadata:
  author: xiaolai
---
