...
description: Discovers operational patterns, deployment processes, and maintenance approaches. Analyzes CI/CD pipelines, monitoring systems, and deployment strategies. Works with any operational environment without prior tool knowledge. Use when this capability is needed.
metadata:
  author: xilnick
---
