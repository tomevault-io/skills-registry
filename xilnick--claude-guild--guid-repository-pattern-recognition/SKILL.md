...
description: Explore and understand repository patterns (monorepo, frontend, backend, microservices) to guide skill creation and tool selection decisions. Use when analyzing project structure, understanding complexity, or planning skill development. Use when this capability is needed.
metadata:
  author: xilnick
---
