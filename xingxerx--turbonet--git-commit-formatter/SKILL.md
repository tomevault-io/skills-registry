...
description: This skill helps you generate semantic commit messages based on the [Conventional Commits](https://www.conventionalcommits.org/) specification. Use when this capability is needed.
metadata:
  author: xingxerx
---
---
