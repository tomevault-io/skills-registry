---
name: mcp-builder
description: description: Build MCP (Model Context Protocol) servers that give Claude new capabilities. Use when user wants to create an MCP server, add tools to Claude, or integrate external services. Use when this capability is needed.
metadata:
  author: xinxingruji
---
---
...
---
> Source: [xinxingruji/Daemon-Agent](https://github.com/xinxingruji/Daemon-Agent) — distributed by [TomeVault](https://tomevault.io).
