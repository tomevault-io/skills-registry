---
name: plan
description: Architecture and implementation planning for complex tasks. Use when the user asks to plan, design, or architect a feature, or when a task involves 5+ files, multiple systems, or architectural decisions. Also use when the user says "plan this", "how should we implement", or "design the approach". Use when this capability is needed.
metadata:
  author: xjiang77
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xjiang77) — claim your Tome and manage your conversions.
