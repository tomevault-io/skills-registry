---
name: skill-reviewer
description: Review individual skills for quality, best practices, effectiveness, and maintainability. Use when users want to evaluate an existing skill, get feedback on a skill draft, or check a skill against community standards before sharing. Use when this capability is needed.
metadata:
  author: xjiang77
---
