---
name: tdd
description: Test-Driven Development with RED-GREEN-REFACTOR cycle. Use when the user wants to develop with TDD, write tests first, or says "TDD this", "test-driven", or "write failing test first". Enforces the discipline of writing a failing test before any implementation. Use when this capability is needed.
metadata:
  author: xjiang77
---
