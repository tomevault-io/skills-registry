---
name: desktop-kit
description: 将任意 Web App（React/Vue/静态页面）打包为 macOS 桌面客户端（基于 Wails v2） Use when this capability is needed.
metadata:
  author: xkcoding
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xkcoding) — claim your Tome and manage your conversions.
