---
name: keytao-docs
description: 键道输入法文档查询工具。当用户询问概念性问题时调用。使用场景：编码规则、学习方法、安装部署、概念解释。关键词：规则、学习、教程、安装、字根、单字、词组、顶功、简码。从GitHub实时获取最新文档，最多返回3个相关片段。展示格式详见下方。 Use when this capability is needed.
metadata:
  author: xkinput
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xkinput) — claim your Tome and manage your conversions.
