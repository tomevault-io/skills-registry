---
name: authentication
description: Implement authentication with NextAuth v5. Use when adding login/logout, checking sessions, protecting API routes, server actions, or pages. Use when this capability is needed.
metadata:
  author: xmark168
---
