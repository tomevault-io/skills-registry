...
description: Define TypeScript types, interfaces, and type utilities. Use when creating type definitions, DTOs, API response types, or component props. Use when this capability is needed.
metadata:
  author: xmark168
---
