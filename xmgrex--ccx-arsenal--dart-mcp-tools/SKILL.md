---
name: dart-mcp-tools
description: Dart/Flutter MCP tools reference for app lifecycle, hot reload/restart, logging, widget inspection, and code analysis. Use when debugging Flutter applications. Use when this capability is needed.
metadata:
  author: xmgrex
---
