...
description: Language-specific debug logging patterns and best practices. Reference when adding instrumentation for Dart/Flutter, Kotlin/Android, Swift/iOS, or JavaScript/TypeScript applications. Use when this capability is needed.
metadata:
  author: xmgrex
---
...
---
> Source: [xmgrex/ccx-arsenal](https://github.com/xmgrex/ccx-arsenal) — distributed by [TomeVault](https://tomevault.io).
