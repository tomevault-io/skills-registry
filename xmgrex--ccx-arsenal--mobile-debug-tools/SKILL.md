...
description: Cross-platform Mobile-MCP tools for device interaction, screenshots, touch simulation, and UI inspection. Works with iOS Simulator and Android Emulator for any mobile app (Flutter, native, React Native). Use when this capability is needed.
metadata:
  author: xmgrex
---
