---
name: rust-style
description: Rust coding style guide. Apply automatically when writing or modifying Rust code. Enforces for-loops over iterators, let-else for early returns, variable shadowing, newtypes, explicit matching, and minimal comments. Use when this capability is needed.
metadata:
  author: xmkqv
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xmkqv) — claim your Tome and manage your conversions.
