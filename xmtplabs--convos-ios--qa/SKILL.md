---
name: qa
description: Run QA test scenarios for the Convos iOS app. Use when asked to run QA tests, verify app functionality, or execute test scenarios. Use when this capability is needed.
metadata:
  author: xmtplabs
---
