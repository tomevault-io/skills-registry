...
description: Send and receive messages over XMTP using the Convos invite system. Use for real-time user communication, providing status updates during long-running tasks, notifying users of progress, or setting up XMTP messaging channels. Use when this capability is needed.
metadata:
  author: xmtplabs
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xmtplabs) — claim your Tome and manage your conversions.
