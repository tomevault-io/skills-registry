...
description: Verify accessibility (WCAG 2.1 Level AA) of React components. Use when creating UI components, forms, or when the user requests accessibility verification. Use when this capability is needed.
metadata:
  author: xnopre
---
