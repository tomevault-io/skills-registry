---
name: e2e-writer
description: Write E2E tests with Playwright using selector best practices. Use when you need to write end-to-end integration tests, user scenarios, or complete workflows. Use when this capability is needed.
metadata:
  author: xnopre
---
