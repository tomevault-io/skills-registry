---
name: flutter
description: Flutter patterns — widget architecture, state management, Impeller renderer, platform-adaptive design Use when this capability is needed.
metadata:
  author: xoai
---
...
---
> Source: [xoai/sage](https://github.com/xoai/sage) — distributed by [TomeVault](https://tomevault.io).
