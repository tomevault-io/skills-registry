...
description: Audita modelo Power BI (PBIP) e gera relatório priorizado com anti-patterns, score 0-100 e recomendações acionáveis. Use quando o usuário pedir "audita esse modelo", "revisa esse power bi", "tá bem feito?", "manda ver no review", ou apontar uma pasta PBIP pra análise crítica. Use when this capability is needed.
metadata:
  author: xperiun
---
...
---
> Source: [xperiun/claude-code-powerbi-skills](https://github.com/xperiun/claude-code-powerbi-skills) — distributed by [TomeVault](https://tomevault.io).
