...
description: Per-callback HMAC secret returned by the signed event delivery API. Use when this capability is needed.
metadata:
  author: Xquik-dev
---
...
---
> Source: [Xquik-dev/x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) — distributed by [TomeVault](https://tomevault.io).
