---
name: spp-drive
description: Enforce Drive Mode behavior for codex-spp. Use when weekly gate fails or when the user requests coaching-only output without code generation. Use when this capability is needed.
metadata:
  author: xrm07
---
