...
description: Batch all open Dependabot dependency upgrade PRs into a single PR Use when this capability is needed.
metadata:
  author: XRPLF
---
...
1. `mvn clean install`
   - This compiles all modules, runs checkstyle, runs unit tests, and runs integration tests
...
---
> Source: [XRPLF/xrpl4j](https://github.com/XRPLF/xrpl4j) — distributed by [TomeVault](https://tomevault.io).
