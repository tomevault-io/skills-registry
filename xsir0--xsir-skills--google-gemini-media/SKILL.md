...
description: Use the Gemini API (Nano Banana image generation, Veo video, Gemini TTS speech and audio understanding) to deliver end-to-end multimodal media workflows and code templates for "generation + understanding". Use when this capability is needed.
metadata:
  author: xsir0
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xsir0) — claim your Tome and manage your conversions.
