...
description: 后台任务和定时任务管理指南，支持异步执行和定时调度。 Use when this capability is needed.
metadata:
  author: xt765
---
...
---
> Source: [xt765/FinchBot](https://github.com/xt765/FinchBot) — distributed by [TomeVault](https://tomevault.io).
