...
description: Set up a macOS environment for Flutter development Use when this capability is needed.
metadata:
  author: xuelongqy
---
# flutter-macos-setup
...
---
> Source: [xuelongqy/flutter_easy_refresh](https://github.com/xuelongqy/flutter_easy_refresh) — distributed by [TomeVault](https://tomevault.io).
