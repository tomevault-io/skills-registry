...
description: Tool-only paper processing skill with a manual language parameter: supports batch artifact download for many papers or single-paper download, then the model manually reads source/PDF and writes summary.md in the selected language. Use when per-paper comprehension should be model-driven instead of script-generated. Use when this capability is needed.
metadata:
  author: xukp20
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/xukp20) — claim your Tome and manage your conversions.
