...
description: AI generates comprehensive Jest tests automatically for COE TypeScript code, similar to q4test but for general-purpose testing Use when this capability is needed.
metadata:
