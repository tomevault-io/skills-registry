...
description: Deploy applications to cloud environments (Azure, AWS, GCP), manage infrastructure, monitor health, and coordinate the full deployment lifecycle from staging to production Use when this capability is needed.
metadata:
