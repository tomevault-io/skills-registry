...
description: Monitor GitHub Issues, convert them to structured work, triage and label incoming issues, manage issue lifecycle, and detect duplicates Use when this capability is needed.
metadata:
