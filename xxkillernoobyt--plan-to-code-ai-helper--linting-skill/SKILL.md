---
name: linting-skill
description: Automatically fix ESLint errors in modified files, enforce zero warnings for P1 tasks, and maintain code quality standards Use when this capability is needed.
metadata:
