---
name: mcp-tool-skill
description: Integrate MCP (Model Context Protocol) tools during development - use askQuestion for clarifications, reportObservation for logging, and reportTestFailure for issues Use when this capability is needed.
metadata:
