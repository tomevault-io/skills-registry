---
name: task-planning
description: Analyze requirements and decompose complex work into atomic, dependency-aware GitHub Issues with proper priorities, test strategies, and implementation plans Use when this capability is needed.
metadata:
