---
name: testing-skill
description: Run Jest tests with focus on new code coverage >75%, generate coverage reports, and enforce quality gates for task completion Use when this capability is needed.
metadata:
