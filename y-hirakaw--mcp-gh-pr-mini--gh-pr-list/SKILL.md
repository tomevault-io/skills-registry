---
name: gh-pr-list
description: List open pull requests in a GitHub repository. Use when the user wants to see PRs, check open pull requests, or browse PRs. Use when this capability is needed.
metadata:
  author: y-hirakaw
---
