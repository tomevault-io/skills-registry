...
description: Add a review comment to a specific line in a GitHub pull request. Use when the user wants to comment on specific code in a PR diff. Use when this capability is needed.
metadata:
  author: y-hirakaw
---
