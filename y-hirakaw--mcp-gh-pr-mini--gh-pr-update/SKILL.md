---
name: gh-pr-update
description: Update an existing GitHub pull request. Use when the user wants to modify a PR's title, description, state, or base branch. Use when this capability is needed.
metadata:
  author: y-hirakaw
---
