---
name: go-validation
description: Go code validation workflow covering formatting, linting, testing, and security using go fmt, go vet, golangci-lint, go test, and govulncheck. Always use validate.sh script for comprehensive validation. For troubleshooting, see reference/. Use when this capability is needed.
metadata:
  author: y-miyazaki
---
