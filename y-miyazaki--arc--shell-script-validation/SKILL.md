...
description: Shell script validation covering syntax and static analysis. Always use validate.sh script. For troubleshooting, see reference/. Use when this capability is needed.
metadata:
  author: y-miyazaki
---
