...
description: Markdown validation using markdownlint and markdown-link-check. Use for syntax checking, link validation, and formatting verification. Always use the 2-step validation workflow. Individual commands are for debugging only. Use when this capability is needed.
metadata:
  author: y-miyazaki
---
