---
name: codex
description: Run code analysis, reviews, and consultations using Codex CLI (OpenAI). Executes safely in read-only sandbox mode. Use when this capability is needed.
metadata:
  author: y4m3
---
