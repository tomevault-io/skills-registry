---
name: pr-check
description: Check GitHub PRs for conflicts, CI status, and review comments. Use when the user asks to check PR status, review PRs, see open PRs, check for merge conflicts, or asks about PRs needing their review. Use when this capability is needed.
metadata:
  author: y4m3
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/y4m3) — claim your Tome and manage your conversions.
