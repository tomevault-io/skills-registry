---
name: concept-design
description: description: ゲームのコンセプトデザインを言語化するためのスキル。漠然としたアイデアを設計可能な形に変換する。使用タイミング：(1)「ゲームのコンセプトを考えたい」(2)「新しいゲームを作りたい」(3)「アイデアを整理したい」と言われた時。判断・行動・体験を中心に据えた設計言語を生成する。 Use when this capability is needed.
metadata:
  author: yaguma
---
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yaguma) — claim your Tome and manage your conversions.
