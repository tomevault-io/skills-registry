---
name: vercel-debug
description: Investigate Vercel deployment errors using Vercel CLI. Use when user shares a Vercel deployment error, build failure, or deployment URL that needs debugging. Use when this capability is needed.
metadata:
  author: yahsan2
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yahsan2) — claim your Tome and manage your conversions.
