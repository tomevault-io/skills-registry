...
description: Trigger when the user requests a review of frontend files (e.g., `.tsx`, `.ts`, `.js`). Support both pending-change reviews and focused file reviews. Use when this capability is needed.
metadata:
  author: yairbederman
---
