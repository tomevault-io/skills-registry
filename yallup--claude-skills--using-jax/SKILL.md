---
name: using-jax
description: Applies JAX patterns for scientific Python development. Use when working with JAX, distrax, numpyro, blackjax, or scientific computing. Covers vmap, JIT, RNG handling. Use when this capability is needed.
metadata:
  author: yallup
---
