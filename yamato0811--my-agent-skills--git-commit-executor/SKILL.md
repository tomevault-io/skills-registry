...
description: Gitの変更を分析して論理的なコミット単位に分割し、Conventional Commits形式で実際にコミットを実行する。 Use when this capability is needed.
metadata:
  author: yamato0811
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yamato0811) — claim your Tome and manage your conversions.
