...
description: This skill should be used when the user asks about "interview questions", "how to interview", "what to ask candidates", "interview process", "hiring process", "scorecard", "evaluation criteria", "behavioral interview", "technical interview", "culture fit", or discusses assessing candidates or designing interview loops. Use when this capability is needed.
metadata:
  author: yamz8
---
