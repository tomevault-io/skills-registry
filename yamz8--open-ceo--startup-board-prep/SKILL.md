...
description: This skill should be used when the user asks to "prepare for a board meeting", "create a board deck", "draft investor update", "prepare board agenda", "calculate runway", "prepare for investor questions", or mentions board meetings, investor updates, board decks, or quarterly updates for a VC-backed startup. Use when this capability is needed.
metadata:
  author: yamz8
---
