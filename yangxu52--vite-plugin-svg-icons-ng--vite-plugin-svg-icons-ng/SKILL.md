...
description: Workspace skill for the vite-plugin-svg-icons-ng monorepo. Use when you need repository-level facts such as monorepo structure, package ownership, docs or playground boundaries, release scripts, workspace commands, or cross-package validation before changing code, tests, docs, or release flow. Use when this capability is needed.
metadata:
  author: yangxu52
---
...
---
> Source: [yangxu52/vite-plugin-svg-icons-ng](https://github.com/yangxu52/vite-plugin-svg-icons-ng) — distributed by [TomeVault](https://tomevault.io).
