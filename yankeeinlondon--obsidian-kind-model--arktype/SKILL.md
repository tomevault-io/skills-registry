---
name: arktype
description: Expert knowledge for runtime validation in TypeScript using ArkType, a syntax-first validation library with TypeScript-like definitions, JIT compilation for 10x-100x performance over Zod, native recursion support, morphs for data transformation, and Standard Schema compatibility Use when this capability is needed.
metadata:
  author: yankeeinlondon
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yankeeinlondon) — claim your Tome and manage your conversions.
