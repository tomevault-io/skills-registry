---
name: vuejs
description: Expert knowledge for working with VueJS, the preferred frontend framework we use along with Vite as a bundler Use when this capability is needed.
metadata:
