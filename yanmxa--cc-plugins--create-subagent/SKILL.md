...
description: Create a specialized AI subagent with isolated context and custom configuration. Use when user says "create subagent", "create agent", "make an agent", or needs task-specific delegation. Use when this capability is needed.
metadata:
  author: yanmxa
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yanmxa) — claim your Tome and manage your conversions.
