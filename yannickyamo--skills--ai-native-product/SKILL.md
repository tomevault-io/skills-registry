...
description: Build AI-native products with agency-control tradeoffs, calibration loops, and eval strategies. Use when building AI agents, LLM features, or products where AI handles user tasks autonomously. Part of the Modern Product Operating Model collection. Use when this capability is needed.
metadata:
  author: yannickyamo
---
