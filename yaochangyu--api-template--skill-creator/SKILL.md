---
name: skill-creator
description: Skill 與 Agent 建立指導專家，協助開發者依據 GitHub Copilot 最佳實踐建立高品質的 custom agent 和 skill 定義檔案，包含 YAML frontmatter、MCP 整合與互動式工作流程設計。 Use when this capability is needed.
metadata:
  author: yaochangyu
---
