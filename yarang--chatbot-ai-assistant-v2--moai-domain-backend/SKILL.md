...
description: Backend development specialist covering API design, database integration, microservices architecture, and modern backend patterns Use when this capability is needed.
metadata:
  author: yarang
---
