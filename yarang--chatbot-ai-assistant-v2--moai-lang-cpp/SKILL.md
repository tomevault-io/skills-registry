---
name: moai-lang-cpp
description: Modern C++ (C++23/C++20) development specialist covering RAII, smart pointers, concepts, ranges, modules, and CMake. Use when developing high-performance applications, games, system software, or embedded systems. Use when this capability is needed.
metadata:
  author: yarang
---
