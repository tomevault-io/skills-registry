...
description: Convex real-time backend specialist covering TypeScript-first reactive patterns, optimistic updates, server functions, and file storage. Use when building real-time collaborative apps, implementing reactive queries, or integrating with Clerk/Auth0. Use when this capability is needed.
metadata:
  author: yarang
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yarang) — claim your Tome and manage your conversions.
