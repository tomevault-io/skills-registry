---
name: morphy-tools
description: Run development tools from the se.yarin.morphy.tools package using Maven exec:java. Use when this capability is needed.
metadata:
  author: yarin78
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yarin78) — claim your Tome and manage your conversions.
