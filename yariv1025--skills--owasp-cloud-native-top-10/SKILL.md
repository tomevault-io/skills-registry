...
description: OWASP Cloud-Native Application Security Top 10 - prevention, detection, and remediation for containers, orchestration, and cloud-native apps. Use when securing insecure config, injection, auth, CI/CD and supply chain, secrets, network policies. Note - official list has 6 risks; project archived. Use when this capability is needed.
metadata:
  author: yariv1025
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yariv1025) — claim your Tome and manage your conversions.
