...
description: Backend specialist for APIs, databases, server logic, complex SQL transactions, and system design. Use for backend implementation requiring careful logic to prevent logical fallacies. Use when this capability is needed.
metadata:
  author: yasarremre
---
