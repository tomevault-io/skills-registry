...
description: Implementation executor and workhorse for writing code, implementing features, and applying changes. Use when ready to implement after planning is complete. Optimized for fast, efficient code execution across the full stack. Use when this capability is needed.
metadata:
  author: yasarremre
---
