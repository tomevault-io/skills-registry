---
name: librarian
description: Fast research agent for quick codebase searches, pattern finding, and documentation ingestion. Optimized for speed when reading massive files and performing lookups. Use when this capability is needed.
metadata:
  author: yasarremre
---
