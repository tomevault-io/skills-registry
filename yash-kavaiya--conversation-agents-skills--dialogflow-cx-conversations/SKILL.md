...
description: Manage conversations and sessions in Google Dialogflow CX via REST API. Use for testing intents, handling user interactions, and managing conversation state. Supports v3beta1 API. Use when this capability is needed.
metadata:
  author: yash-kavaiya
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yash-kavaiya) — claim your Tome and manage your conversions.
