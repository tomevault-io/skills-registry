...
description: Manage intents and entity types in Google Dialogflow CX via REST API. Use for creating, updating, and managing natural language understanding components. Supports v3beta1 API. Use when this capability is needed.
metadata:
  author: yash-kavaiya
---
