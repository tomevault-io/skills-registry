---
name: commit-helper
description: Git コミットメッセージ作成とPR作成を支援。コミット、プッシュ、プルリクエスト作成の際に使用。 Use when this capability is needed.
metadata:
  author: yasudaproduct
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yasudaproduct) — claim your Tome and manage your conversions.
