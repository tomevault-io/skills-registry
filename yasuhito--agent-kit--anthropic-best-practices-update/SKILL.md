...
description: Run the full Anthropic Best Practices pipeline in order (fetch, normalize, split, extract, translate) using existing skills. Use when asked to update docs/best-practices/claude-md.md in one shot. Use when this capability is needed.
metadata:
  author: yasuhito
---
