...
description: markitdown でドキュメントやファイルを Markdown に変換。PDF、Word (.docx)、PowerPoint (.pptx)、Excel (.xlsx, .xls)、HTML、CSV、JSON、XML、画像（EXIF/OCR 付き）、音声（文字起こし付き）、ZIP アーカイブ、YouTube URL、EPub を Markdown 形式に変換して LLM 処理やテキスト分析に使用。 Use when this capability is needed.
metadata:
  author: yasuhito
---
