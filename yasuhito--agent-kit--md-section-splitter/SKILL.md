...
description: Split normalized Markdown into H2 sections using skills/md-section-splitter/scripts/md_section_splitter.rb, producing per-section files and index metadata. Use when you need deterministic sectionization for extraction or review. Use when this capability is needed.
metadata:
  author: yasuhito
---
