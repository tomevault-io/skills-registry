---
name: generate-ci
description: Interactively generates GitHub Actions CI workflow files based on project language detection. Supports Python, TypeScript/Node.js, and Terraform. Produces best-practice workflows with SHA-pinned actions, minimal GITHUB_TOKEN permissions, full-source coverage reporting, secret scanning, and dependency management automation. Use when this capability is needed.
metadata:
  author: yasuwrldhyper
---
...
---
> Source: [yasuwrldhyper/ai-skills-collection](https://github.com/yasuwrldhyper/ai-skills-collection) — distributed by [TomeVault](https://tomevault.io).
