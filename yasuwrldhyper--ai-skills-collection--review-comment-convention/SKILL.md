...
description: PRレビューコメントの優先度規約（P1–P5 または must/imo/nits/fyi）を対話的に設定し、copilot-instructions.md と CLAUDE.md に書き込む。出力言語（日本語・英語・バイリンガル）も設定可能。 Use when this capability is needed.
metadata:
