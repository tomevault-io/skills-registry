---
name: self-learning
description: Autonomously research any technology, library, framework, or API. Discovers official documentation, extracts key information from authoritative sources, verifies across multiple pages, and generates a reusable Claude skill (SKILL.md) with installation, examples, and best practices. Use when this capability is needed.
metadata:
  author: ychampion
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ychampion) — claim your Tome and manage your conversions.
