...
description: Skip the background memory extractor when the main agent already persisted memory during the same turn to avoid duplicates and race hazards. Use when this capability is needed.
metadata:
  author: ychampion
---
...
---
> Source: [ychampion/cskill-agents](https://github.com/ychampion/cskill-agents) — distributed by [TomeVault](https://tomevault.io).
