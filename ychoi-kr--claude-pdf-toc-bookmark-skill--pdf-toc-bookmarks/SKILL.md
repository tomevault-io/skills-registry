...
description: Extract table of contents from PDF pages visually and create clickable bookmarks. Use when user wants to add bookmarks/navigation to PDFs based on printed table of contents pages, or needs to convert TOC pages to navigable PDF bookmarks. Use when this capability is needed.
metadata:
  author: ychoi-kr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ychoi-kr) — claim your Tome and manage your conversions.
