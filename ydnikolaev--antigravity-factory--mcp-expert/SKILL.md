---
name: mcp-expert
description: Expert on Model Context Protocol (MCP) servers. Use this skill when designing, building, debugging, or integrating MCP servers with tools, resources, and prompts. Use when this capability is needed.
metadata:
  author: ydnikolaev
---
