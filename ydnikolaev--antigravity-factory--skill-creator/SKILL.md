---
name: skill-creator
description: Defines the philosophy and process for creating high-quality Antigravity skills. Use this skill when asked to create a new skill or standardize an existing one. Use when this capability is needed.
metadata:
  author: ydnikolaev
---
