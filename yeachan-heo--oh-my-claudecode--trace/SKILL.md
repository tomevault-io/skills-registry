---
name: trace
description: Evidence-driven tracing lane that orchestrates competing tracer hypotheses in Claude built-in team mode Use when this capability is needed.
metadata:
  author: yeachan-heo
---
