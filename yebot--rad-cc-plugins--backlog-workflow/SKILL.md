...
description: Expert knowledge for working with Backlog.md task management. Use when managing tasks, organizing epics, handling dependencies, or tracking project progress. Automatically applies Backlog.md best practices. Use when this capability is needed.
metadata:
  author: yebot
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yebot) — claim your Tome and manage your conversions.
