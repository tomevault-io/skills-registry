---
name: cli-guide
description: SIMBL CLI command reference and usage guide. Use when working with SIMBL tasks or needing CLI syntax reference. Use when this capability is needed.
metadata:
  author: yebot
---
