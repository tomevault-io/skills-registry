...
description: Best practices for writing SIMBL tasks that Claude can execute with zero context. Use when creating or refining tasks for maximum clarity. Use when this capability is needed.
metadata:
  author: yebot
---
