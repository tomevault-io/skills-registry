...
description: 撰寫 JUnit 5、AssertJ、Mockito 測試，遵循 TDD 開發流程。當需要撰寫單元測試、整合測試、或進行 TDD 開發時使用。適用於所有 Java/Spring Boot 專案。 Use when this capability is needed.
metadata:
  author: yeeder0520
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yeeder0520) — claim your Tome and manage your conversions.
