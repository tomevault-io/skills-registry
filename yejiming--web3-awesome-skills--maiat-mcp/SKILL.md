---
name: maiat-mcp
description: Maiat Trust Score MCP Server — query agent trust scores, token safety verdicts, and reputation data from Claude, GPT, Cursor, Codex, or any MCP-compatible AI tool. Use when this capability is needed.
metadata:
  author: yejiming
---
...
---
> Source: [yejiming/web3-awesome-skills](https://github.com/yejiming/web3-awesome-skills) — distributed by [TomeVault](https://tomevault.io).
