---
name: code-review
description: コードレビュースキル。現在のブランチとリモートオリジンの作成元ブランチとの差分を分析。Use when: コードレビュー、PR前チェック、変更点確認を依頼された時。 Use when this capability is needed.
metadata:
  author: yellow-seed
---
...
自分の変更内容を客観的に確認するセルフレビューは、[self-review/SKILL.md](../self-review/SKILL.md) スキルを使用してください。

code-reviewスキルは、セルフレビューにも使用できますが、self-reviewスキルの方がセルフレビュー専用の詳細なガイドとチェックリストを提供します。
