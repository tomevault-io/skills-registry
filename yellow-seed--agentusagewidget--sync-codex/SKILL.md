---
name: sync-codex
description: Codex環境セットアップスキル。Codex向けのセットアップスクリプト整備とDockerfile相当のインストール手順の移植。Use when: Codex向けのセットアップスクリプトを整えてほしい、Dockerfileの手順をシェル化してほしいと依頼された時。 Use when this capability is needed.
metadata:
  author: yellow-seed
---
