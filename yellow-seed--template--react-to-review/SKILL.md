...
description: PRレビューコメント対応スキル。レビューコメントを取得し、妥当な指摘を修正したうえで各コメントへ対応結果とコミットSHAを返信する。Use when: レビューコメント対応、レビュー指摘の修正、コメント返信の自動化を依頼された時。 Use when this capability is needed.
metadata:
  author: yellow-seed
---
