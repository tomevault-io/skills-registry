---
name: java-developer
description: Expert Java developer for implementing LeetCode problems, data structures, and algorithms. Helps write clean, efficient Java code following best practices for competitive programming and interview preparation. Use when writing or implementing Java solutions. Use when this capability is needed.
metadata:
  author: yennanliu
---
