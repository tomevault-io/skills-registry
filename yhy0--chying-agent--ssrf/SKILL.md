---
name: ssrf
description: 服务端请求伪造漏洞检测与利用。当目标存在 URL 参数、远程文件加载、Webhook、PDF 生成、URL 预览功能时使用。 Use when this capability is needed.
metadata:
  author: yhy0
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yhy0) — claim your Tome and manage your conversions.
