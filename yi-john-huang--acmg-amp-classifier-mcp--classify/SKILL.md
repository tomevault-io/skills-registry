---
name: classify
description: Full ACMG/AMP variant classification workflow. Validates input, gathers evidence, applies rules, and generates classification. Invoked via /classify <variant>. Use when this capability is needed.
metadata:
