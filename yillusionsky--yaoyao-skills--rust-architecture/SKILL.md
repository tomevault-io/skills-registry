...
description: Rust 项目架构规范技能。用于设计、创建或调整 Rust CLI、小工具、library crate、后端服务、复杂应用、workspace crate 拆分、domain/application/ports/adapters 四层边界、错误处理和测试结构。 Use when this capability is needed.
metadata:
  author: yIllusionSky
---
...
---
> Source: [yIllusionSky/yaoyao-skills](https://github.com/yIllusionSky/yaoyao-skills) — distributed by [TomeVault](https://tomevault.io).
