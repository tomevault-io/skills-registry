...
description: Translate Intor locale files from a default locale messages directory while preserving keys, structure, replacements, rich tags, ICU syntax, and file layout. Use when this capability is needed.
metadata:
  author: yiming-liao
---
...
---
> Source: [yiming-liao/intor](https://github.com/yiming-liao/intor) — distributed by [TomeVault](https://tomevault.io).
