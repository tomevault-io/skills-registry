---
name: setup-project
description: Use to generate HOTL adapter files for the current project — creates AGENTS.md, .clinerules, cursor rules, or copilot instructions depending on tools the team uses. Use when this capability is needed.
metadata:
  author: yimwoo
---
...
---
> Source: [yimwoo/hotl-plugin](https://github.com/yimwoo/hotl-plugin) — distributed by [TomeVault](https://tomevault.io).
