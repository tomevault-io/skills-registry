---
name: rootcause
description: Vendor-neutral metrics + logs triage for Kubernetes workloads. Works with whichever backend RootCause is configured to use (GCP Stackdriver today; Prometheus / CloudWatch / Datadog as backends land). Use when this capability is needed.
metadata:
  author: yindia
---
...
---
> Source: [yindia/rootcause](https://github.com/yindia/rootcause) — distributed by [TomeVault](https://tomevault.io).
