...
description: View GitHub PR inline review comments (including bot reviews like devin-ai-integration) and resolve review conversations from the CLI. Use when this capability is needed.
metadata:
