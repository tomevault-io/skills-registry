---
name: github-pr-edit
description: Edit GitHub PR title/body (and optionally comments) reliably on Windows. Use when asked to update PR metadata or when GitHub API returns 404 due to missing auth (private repos often return 404 when unauthenticated). Use when this capability is needed.
metadata:
  author: yiyousiow000814
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yiyousiow000814) — claim your Tome and manage your conversions.
