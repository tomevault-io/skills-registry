---
name: yt-dlp
description: Download YouTube videos, audio, and subtitles/transcripts using yt-dlp. Use when this capability is needed.
metadata:
  author: ykdojo
---
...
---
> Source: [ykdojo/safeclaw](https://github.com/ykdojo/safeclaw) — distributed by [TomeVault](https://tomevault.io).
