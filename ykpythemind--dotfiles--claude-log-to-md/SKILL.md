...
description: Convert Claude Code JSONL conversation logs to readable Markdown. Use when the user wants to export, view, or share a Claude Code session as markdown. Use when this capability is needed.
metadata:
  author: ykpythemind
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ykpythemind) — claim your Tome and manage your conversions.
