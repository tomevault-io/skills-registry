...
description: Select and configure appropriate Azure RBAC roles following the principle of least privilege for secure access control Use when this capability is needed.
metadata:
  author: yldgio
---
