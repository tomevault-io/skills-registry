---
name: mcp-builder
description: Build Model Context Protocol (MCP) servers to extend GitHub Copilot and AI agents with custom tools and data sources Use when this capability is needed.
metadata:
  author: yldgio
---
