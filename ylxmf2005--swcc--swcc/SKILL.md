---
name: zhengyanshi
description: Pre-task brainstorming: explore problem space, identify ambiguities, propose approaches, get user confirmation before formal consultation. Use when you want to think through a task before committing to a plan. Use when this capability is needed.
metadata:
  author: ylxmf2005
---
