...
description: Comprehensive autonomous operation of the Grok AdMaster (Optimus Pryme) AI-powered Amazon PPC/DSP optimization platform. Use this skill to manage campaigns, analyze performance, generate creative content, detect anomalies, optimize bids, and execute AI-driven strategies through direct API and database interactions. Use when this capability is needed.
metadata:
  author: ymehmetdemiroglu-crypto
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ymehmetdemiroglu-crypto) — claim your Tome and manage your conversions.
