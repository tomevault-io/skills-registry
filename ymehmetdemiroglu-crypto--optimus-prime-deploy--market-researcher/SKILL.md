...
description: Conducts market research using Internet search, Amazon product search, and deep AI research analysis. Use this when the user needs information about competitors, product trends, or specific Amazon ASINs. Use when this capability is needed.
metadata:
