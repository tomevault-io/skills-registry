---
name: report-issue
description: Advanced issue reporter that analyzes codebases, identifies root causes, and creates comprehensive issue documentation. Use this skill when users report bugs, request features, or identify technical debt. This skill investigates and documents without implementing fixes. Use when this capability is needed.
metadata:
  author: yngvebn
---
