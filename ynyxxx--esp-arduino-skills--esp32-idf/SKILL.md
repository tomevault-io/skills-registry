---
name: esp32-esp-idf
description: ESP-IDF native framework for ESP32. Covers FreeRTOS, component architecture, driver APIs, and low-level ESP32 development. Use when this capability is needed.
metadata:
  author: ynyxxx
---
