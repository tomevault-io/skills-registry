...
description: Configure LM Studio as embedding provider for GrepAI. Use this skill for local embeddings with a GUI interface. Use when this capability is needed.
metadata:
  author: yoanbernabeu
---
