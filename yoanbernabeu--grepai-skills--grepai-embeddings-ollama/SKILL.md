...
description: Configure Ollama as embedding provider for GrepAI. Use this skill for local, private embedding generation. Use when this capability is needed.
metadata:
  author: yoanbernabeu
---
