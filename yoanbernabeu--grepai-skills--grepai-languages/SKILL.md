...
description: Supported programming languages in GrepAI. Use this skill to understand which languages can be indexed and traced. Use when this capability is needed.
metadata:
  author: yoanbernabeu
---
