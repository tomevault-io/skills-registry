...
description: Reference for all GrepAI MCP tools. Use this skill to understand available MCP tools and their parameters. Use when this capability is needed.
metadata:
  author: yoanbernabeu
---
