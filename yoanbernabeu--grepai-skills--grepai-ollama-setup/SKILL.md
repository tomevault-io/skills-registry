...
description: Install and configure Ollama for local embeddings with GrepAI. Use this skill when setting up private, local embedding generation. Use when this capability is needed.
metadata:
  author: yoanbernabeu
---
