...
description: Get started with GrepAI in 5 minutes. Use this skill for a complete walkthrough from installation to first search. Use when this capability is needed.
metadata:
  author: yoanbernabeu
---
