...
description: Construct precise, internally consistent counterfactual scenarios where Use when this capability is needed.
metadata:
  author: yogsoth-ai
---
...
---
> Source: [yogsoth-ai/de-anthropocentric-research-engine](https://github.com/yogsoth-ai/de-anthropocentric-research-engine) — distributed by [TomeVault](https://tomevault.io).
