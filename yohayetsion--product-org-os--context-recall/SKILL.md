---
name: context-recall
description: Query past decisions, bets, learnings, and documents by topic from the context registry. Activate when: "what did we decide about", "find past decisions", "recall context on", historical context, Use when this capability is needed.
metadata:
  author: yohayetsion
---
