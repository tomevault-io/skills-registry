...
description: Create or update a structured record for a specific individual decision. Activate when: "document this decision", "create decision record", "record the choice we made", formal decision documentation, Use when this capability is needed.
metadata:
  author: yohayetsion
---
