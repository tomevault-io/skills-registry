...
description: Deploy multiple agents simultaneously for parallel execution. Use when facing 2+ independent tasks, 'run in parallel', 'dispatch agents', or needs concurrent task processing without shared Use when this capability is needed.
metadata:
  author: yohayetsion
---
