---
name: prd
description: Create or update a full Product Requirements Document with problem, solution, and acceptance criteria. Activate when: "write a PRD", "product requirements", "document the feature", formal Use when this capability is needed.
metadata:
  author: yohayetsion
---
