---
name: present
description: Convert an existing deliverable document to an HTML slide presentation. Activate when: "make a presentation", "create slides", "convert to slides", document as presentation, present this Do Use when this capability is needed.
metadata:
  author: yohayetsion
---
