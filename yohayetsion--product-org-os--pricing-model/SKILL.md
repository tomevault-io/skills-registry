---
name: pricing-model
description: Design a pricing model with specific tiers, packaging, and feature allocation per plan. Activate when: "design pricing tiers", "pricing model", "package our offering", pricing structure, tier Use when this capability is needed.
metadata:
  author: yohayetsion
---
