---
name: reset-demo
description: Restore demo content for testing, demonstration, or learning purposes. Activate when: "reset demo", "restore examples", demo data for learning, bring back demo content Do NOT activate for: Use when this capability is needed.
metadata:
  author: yohayetsion
---
# Reset Demo Content
