---
name: inbox-write
description: 別エージェントのinboxにメッセージを送信する。agent-to-agent通信の唯一の手段。 Use when this capability is needed.
metadata:
  author: yohey-w
---
...
---
> Source: [yohey-w/multi-agent-shogun](https://github.com/yohey-w/multi-agent-shogun) — distributed by [TomeVault](https://tomevault.io).
