---
name: sdd-architect
description: 新機能の仕様設計を行う（Requirements → Design → Tasks） Use when this capability is needed.
metadata:
  author: yohi
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yohi) — claim your Tome and manage your conversions.
