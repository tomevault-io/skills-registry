...
description: Add custom SVG or PNG costumes to sprites programmatically via the Scratch VM storage API. Enables creating original characters, shapes, or artwork without using the paint editor UI. Use when this capability is needed.
metadata:
  author: yokobond
---
