---
name: new-repo-setup
description: Standardize a new or freshly-scaffolded project repository. Use when the user has created a new project folder (possibly via a generator like `npm create`) and wants to apply consistent tooling, linting, formatting, and AI configuration. Handles both personal projects and Silvermine team projects. Use when this capability is needed.
metadata:
  author: yokuze
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yokuze) — claim your Tome and manage your conversions.
