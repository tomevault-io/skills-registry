...
description: Design and implement React Server Components with Next.js 15 App Router. Master server-first architecture, streaming SSR, Server Actions, React 19 patterns, and modern data fetching for 2025+ development. Use when this capability is needed.
metadata:
  author: yonatangross
---
