...
description: Generate images using Google Gemini Nano Banana (gemini-2.5-flash-image) model. Use when asked to create images, generate visuals, design graphics, or produce artwork for marketing materials like Fiverr gigs, social media, banners, or promotional content. Use when this capability is needed.
metadata:
  author: yonggao
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yonggao) — claim your Tome and manage your conversions.
