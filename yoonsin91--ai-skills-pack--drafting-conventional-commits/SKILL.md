...
description: Draft a Conventional Commits message from either a short summary of changes or by inspecting the local git diff. Use when the user wants a commit message formatted as type(scope): subject, with optional body and footers for breaking changes or issue references. Use when this capability is needed.
metadata:
  author: yoonsin91
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yoonsin91) — claim your Tome and manage your conversions.
