---
name: text-analyzer
description: Comprehensive text analysis coordinator. Execute Python script for multi-aspect text analysis. Use when you need grammar, sentiment, readability, and SEO analysis combined. Use when this capability is needed.
metadata:
