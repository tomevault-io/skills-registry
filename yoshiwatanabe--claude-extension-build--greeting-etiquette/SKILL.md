---
name: greeting-etiquette
description: This skill should be used when the user asks about "how to greet someone", "greeting customs", "say hello", "proper greetings", "greeting etiquette", or discusses appropriate ways to greet people in different contexts. Use when this capability is needed.
metadata:
...
Use formal greetings in business contexts, initial meetings, and when addressing authority figures:
...
**Informal Settings**
Use casual greetings with friends, peers, and in relaxed environments:
...
1. Stand up if seated
2. Make eye contact and smile
3. Offer handshake (if culturally appropriate)
4. State your name clearly
5. Use their name in your greeting
6. Include a brief pleasantry
...
1. Acknowledge the group as a whole first
2. Then greet individuals if time permits
3. Pay respect to highest-ranking person first in formal settings
4. In casual settings, greet those nearest or closest relationships first
5. Use inclusive language ("Hello everyone," "Good morning, team")
...
1. Junior greets senior first
2. Lower rank greets higher rank first
3. Younger greets elder first
4. Guest waits for host to initiate in very formal settings
...
- **`references/cultural-greetings.md`** - Comprehensive guide to greeting customs across 50+ countries
- **`examples/greeting-templates.md`** - Pre-written greeting templates for various situations
