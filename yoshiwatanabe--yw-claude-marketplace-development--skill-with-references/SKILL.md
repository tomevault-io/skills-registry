...
description: Demonstrates how skills can reference external documentation files. Use when you need to load guidelines, best practices, or reference materials on-demand. Use when this capability is needed.
metadata:
