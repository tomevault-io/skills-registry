...
description: Your Claude Code wingman - dispatch coding tasks via tmux for free/work-paid coding while keeping Clawdbot API costs minimal Use when this capability is needed.
metadata:
  author: yossiovadia
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yossiovadia) — claim your Tome and manage your conversions.
