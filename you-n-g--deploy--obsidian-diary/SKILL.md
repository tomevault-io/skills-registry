---
name: obsidian-diary
description: This skill acts as an intelligent secretary for your Obsidian knowledge base. It takes raw content from `Tools/chat/daily summary.md` and put it into the right place, when compiling the content, it follows following steps: Use when this capability is needed.
metadata:
  author: you-n-g
---
