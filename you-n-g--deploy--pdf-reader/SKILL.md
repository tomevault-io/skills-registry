---
name: pdf-reader
description: Reads text content from PDF files. Use when you need to extract text, analyze content, or summarize information from a PDF document. Supports limiting the number of pages read. Use when this capability is needed.
metadata:
  author: you-n-g
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/you-n-g) — claim your Tome and manage your conversions.
