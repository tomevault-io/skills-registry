...
description: 创建具有高设计质量的独特、生产级前端界面。在构建网页或 UI 时使用此技能，以避免生成通用的 AI 廉价审美（AI slop）。 Use when this capability is needed.
metadata:
  author: you-want
---
...
---
> Source: [you-want/mini-cc](https://github.com/you-want/mini-cc) — distributed by [TomeVault](https://tomevault.io).
