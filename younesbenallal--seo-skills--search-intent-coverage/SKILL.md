...
description: Determine what to cover to satisfy search intent by analyzing SERPs (preferred) or extracting competitor pages to Markdown. Use when this capability is needed.
metadata:
