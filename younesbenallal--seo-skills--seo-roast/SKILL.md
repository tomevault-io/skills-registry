---
name: seo-roast
description: Roast a landing page or article from an SEO perspective (technical + on-page + content/intent). Optionally generate a screenshot-rich HTML report. Use when this capability is needed.
metadata:
  author: younesbenallal
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/younesbenallal) — claim your Tome and manage your conversions.
