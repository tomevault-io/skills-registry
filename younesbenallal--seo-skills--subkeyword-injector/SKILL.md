...
description: For a given URL, pull Search Console queries it already ranks for and propose (or apply) content edits to capture more long-tail traffic. Use when this capability is needed.
metadata:
