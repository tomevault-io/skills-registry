---
name: git-commit
description: Create atomic git commits with conventional commit messages. Use when asked to stage changes, run pre-commit checks, split logical changes, and produce clear commit history. Use when this capability is needed.
metadata:
  author: young-hwang
---
