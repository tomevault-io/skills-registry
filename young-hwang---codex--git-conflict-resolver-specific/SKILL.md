...
description: Migrate and run the workflow from Claude command git/conflict-resolver-specific.md. Use when asked to perform tasks matching git-conflict-resolver-specific, for example: You are an expert at resolving Git merge conflicts. $ARGUMENTS Use when this capability is needed.
metadata:
  author: young-hwang
---
