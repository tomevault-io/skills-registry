...
description: Migrate and run the workflow from Claude command gitlab/pr-review.md. Use when asked to perform tasks matching gitlab-pr-review, for example: **PR Link/Number**: $ARGUMENTS Use when this capability is needed.
metadata:
  author: young-hwang
---
