---
name: bash-generator
description: Generate production-ready Bash scripts. Use when creating automation, deployment, CI/CD helper, or system administration shell scripts. Use when this capability is needed.
metadata:
  author: younsl
---
