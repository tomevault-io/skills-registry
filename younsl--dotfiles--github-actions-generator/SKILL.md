...
description: Generate GitHub Actions workflow files. Use when creating or modifying CI/CD pipelines, .github/workflows/ YAML files, or GitHub Actions configurations. Use when this capability is needed.
metadata:
  author: younsl
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/younsl) — claim your Tome and manage your conversions.
