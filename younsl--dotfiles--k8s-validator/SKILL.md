---
name: k8s-validator
description: Validate Kubernetes YAML manifests for correctness, security, and best practices. Use when reviewing or auditing Kubernetes configurations. Use when this capability is needed.
metadata:
  author: younsl
---
