---
name: rust-generator
description: Generate production-ready Rust code. Use when creating Rust applications, CLI tools, libraries, or async services. Use when this capability is needed.
metadata:
  author: younsl
---
