...
description: Extract, transcribe, and translate YouTube video transcripts using the YouTubeTranscript.dev V2 API. Supports captions, ASR audio transcription, batch processing (up to 100 videos), translation to 100+ languages, and multiple output formats. Use when working with YouTube videos, subtitles, captions, or video-to-text conversion. Use when this capability is needed.
metadata:
  author: youtube-transcript-dev
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/youtube-transcript-dev) — claim your Tome and manage your conversions.
