---
name: asc-summary
description: Quick-reference guide for all ASC skills with pitfalls, correct commands, and skill routing. Read this FIRST before any App Store Connect task. Use when this capability is needed.
metadata:
  author: yspreen
---
