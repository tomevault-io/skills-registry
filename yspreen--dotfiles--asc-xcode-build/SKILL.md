...
description: Build, archive, and export iOS/macOS apps with xcodebuild before uploading to App Store Connect. Use when you need to create an IPA or PKG for upload. Use when this capability is needed.
metadata:
  author: yspreen
---
