---
name: butler-flow
description: End-to-end feature workflow: ask for feature, create branch, plan, implement with surgical commits — all through the but CLI. Use when starting any new feature or bug fix. Use when this capability is needed.
metadata:
  author: yspreen
---
