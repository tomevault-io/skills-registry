---
name: searxng
description: Deep web search using the local SearXNG metasearch instance. Use when you need to research a topic, find documentation, look up current events, or gather information from the web. Use when this capability is needed.
metadata:
  author: yspreen
---
