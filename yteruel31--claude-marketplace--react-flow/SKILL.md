---
name: react-flow
description: React Flow documentation tools. Browse, search, and retrieve @xyflow/react docs for node-based UIs, flow editors, custom nodes, custom edges, interactive diagrams. Also covers: reactflow, xyflow, react flow hooks, react flow api. Use when this capability is needed.
metadata:
  author: yteruel31
---
