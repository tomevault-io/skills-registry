---
name: grok-bridge
description: Talk to Grok via Safari automation — CLI tool + REST API. Use when this capability is needed.
metadata:
  author: ythx-101
---
# grok-bridge v3.1.1
...
---
> Source: [ythx-101/grok-bridge](https://github.com/ythx-101/grok-bridge) — distributed by [TomeVault](https://tomevault.io).
