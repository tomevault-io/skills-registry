...
description: Browser automation and E2E testing with Playwright MCP. Use when automating web pages, testing UI, debugging visual issues, or validating user flows. Use when this capability is needed.
metadata:
  author: ytrofr
---
