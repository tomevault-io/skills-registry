...
description: Reference for core project patterns and standards defined in CORE-PATTERNS.md. Use when: (1) implementing any new feature, (2) validating code before commit, (3) onboarding new team members, (4) uncertain about project conventions. Use when this capability is needed.
metadata:
  author: ytrofr
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/ytrofr) — claim your Tome and manage your conversions.
