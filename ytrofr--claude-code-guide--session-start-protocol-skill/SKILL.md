...
description: Initialize Claude Code session following Anthropic best practices for multi-session continuity. Use when: (1) starting any new Claude Code session, (2) resuming work after context compaction, (3) uncertain about current project state. Source: Anthropic Claude 4 Best Practices. Use when this capability is needed.
metadata:
  author: ytrofr
---
