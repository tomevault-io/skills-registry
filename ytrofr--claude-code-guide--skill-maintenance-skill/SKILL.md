...
description: Monthly skill library maintenance with audit scripts and gap detection. Use when auditing skills for 'Use when' patterns, checking activation rates, or maintaining skill quality. Use when this capability is needed.
metadata:
  author: ytrofr
---
