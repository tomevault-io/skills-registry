...
description: Routes to appropriate troubleshooting patterns based on issue category. Use when: (1) encountering connection errors (ECONNREFUSED, timeout, auth failures), (2) debugging integration failures (MCP, API, database), (3) system behavior differs from expectations. Verified: 2025-12-14. Use when this capability is needed.
metadata:
  author: ytrofr
---
