---
name: manage-adr
description: Manage Architecture Decision Records (ADRs) using adr-tools. Use this to initialize, create, list, and link ADRs to document architectural evolution. Use when this capability is needed.
metadata:
  author: yu-iskw
---
...
- Read a specific ADR: `read_file doc/adr/NNNN-title.md`
