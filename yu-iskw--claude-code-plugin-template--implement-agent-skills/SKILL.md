...
description: Implement and maintain Claude Agent Skills with valid SKILL.md frontmatter, focused instructions, and progressive disclosure. Use when this capability is needed.
metadata:
  author: yu-iskw
---
