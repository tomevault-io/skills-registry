...
description: Create and validate Claude sub-agent definitions with correct frontmatter, tool permissions, and delegation boundaries. Use when this capability is needed.
metadata:
  author: yu-iskw
---
