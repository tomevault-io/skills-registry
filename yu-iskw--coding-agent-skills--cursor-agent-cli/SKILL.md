...
description: Executes tasks using the Cursor Agent CLI (`cursor-agent`). Provides structured modes for planning, Q&A, and full automation with safety guardrails. Use when this capability is needed.
metadata:
  author: yu-iskw
---
