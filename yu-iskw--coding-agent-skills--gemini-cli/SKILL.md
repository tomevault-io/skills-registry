---
name: gemini-cli
description: Executes tasks using the Gemini CLI (`gemini`). Automatically determines the safest approval mode (plan, auto_edit, or yolo) based on the task type. Use when this capability is needed.
metadata:
  author: yu-iskw
---
