---
name: readme-sync
description: Synchronizes the list of Agent Skills in the root README.md with the actual skills present in the codebase. Use when this capability is needed.
metadata:
  author: yu-iskw
---
