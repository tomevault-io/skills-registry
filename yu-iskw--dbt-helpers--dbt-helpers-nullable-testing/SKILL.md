...
description: Implement and use Nullable Infrastructure adapters for mock-free testing. Use when writing unit tests for core logic, implementing infrastructure adapters, or setting up test fixtures. Use when this capability is needed.
metadata:
  author: yu-iskw
---
