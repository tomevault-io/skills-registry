---
name: test-and-fix
description: Run unit tests and automatically fix code failures, regression bugs, or test mismatches. Use when tests are failing, after implementing new features, or to repair "broken" tests. Use when this capability is needed.
metadata:
  author: yu-iskw
---
