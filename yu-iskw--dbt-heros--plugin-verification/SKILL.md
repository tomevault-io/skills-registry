...
description: Verify Claude extensions and plugins across hooks, skills, sub-agents, teams, manifest, structure, runtime loading, and CI parity. Use when this capability is needed.
metadata:
  author: yu-iskw
---
