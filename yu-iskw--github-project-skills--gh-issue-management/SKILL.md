...
description: Comprehensive management of GitHub issues, including sub-issue hierarchies. Use to create, update, close, list, search, view, comment on, and manage parent-child relationships between issues in a single skill. Use when this capability is needed.
metadata:
  author: yu-iskw
---
