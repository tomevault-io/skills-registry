...
description: Comprehensive testing suite for GitHub agent skills and subagents. Executes 17 workflows and generates a detailed report. Use when this capability is needed.
metadata:
  author: yu-iskw
---
