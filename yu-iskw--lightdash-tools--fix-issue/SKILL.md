---
name: fix-issue
description: Fix a GitHub issue end-to-end. Use when given an issue number to fix, implementing bug fixes, or addressing reported problems. Use when this capability is needed.
metadata:
  author: yu-iskw
---
