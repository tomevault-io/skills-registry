...
description: Deeply discover and understand the Lightdash API spec (docs, OpenAPI, auth, recipes) so you can implement a custom HTTP client. Use when figuring out Lightdash APIs, HTTP client design, API spec, endpoints, auth, or recipes. Use when this capability is needed.
metadata:
  author: yu-iskw
---
