...
description: Displays the completion status of artifacts for an OpenSpec change. Use to track progress of proposal, specs, design, and tasks. Use when this capability is needed.
metadata:
  author: yu-iskw
---
