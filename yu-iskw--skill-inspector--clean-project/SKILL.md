---
name: clean-project
description: Perform a "hard reset" of the development environment. Use when dependencies are corrupted, lockfiles are out of sync, or environment tools (Trunk/pnpm) are in an inconsistent state. Use when this capability is needed.
metadata:
  author: yu-iskw
---
