---
name: node-upgrade
description: Safely upgrade Node.js dependencies in pnpm workspaces. Use when asked to "upgrade dependencies", "update packages", "check for updates", or fix version mismatches. Use when this capability is needed.
metadata:
  author: yu-iskw
---
