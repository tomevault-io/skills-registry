...
description: Choose and implement the right Claude extension type by comparing hooks, skills, sub-agents, agent teams, and plugin packaging patterns. Use when this capability is needed.
metadata:
  author: yu-iskw
---
