...
description: Implement and validate Claude Code hook configurations and hook scripts for command, prompt, and agent workflows. Use when this capability is needed.
metadata:
  author: yu-iskw
---
