---
name: plan-tasks
description: General-purpose planning skill to break down complex goals into atomic, verifiable units of work. Independent of specific tracking tools. Use when this capability is needed.
metadata:
  author: yu-iskw
---
