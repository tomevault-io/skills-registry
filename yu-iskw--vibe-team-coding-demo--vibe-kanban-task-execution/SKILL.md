...
description: Execute a specific Vibe Kanban task. Handles session start, coding, testing, and completion for single-task focused work. Use when this capability is needed.
metadata:
  author: yu-iskw
---
