---
name: new-endpoint
description: Add a new API endpoint to an existing service with full-stack integration (backend handler + frontend API service + store) Use when this capability is needed.
metadata:
  author: yu-min3
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yu-min3) — claim your Tome and manage your conversions.
