---
name: lua-standard
description: Lua/Neovim coding standards and Neovim structure guide. Use when: writing or reviewing Lua code (*.lua) for Neovim plugins or configuration. Use when this capability is needed.
metadata:
  author: yu-sz
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yu-sz) — claim your Tome and manage your conversions.
