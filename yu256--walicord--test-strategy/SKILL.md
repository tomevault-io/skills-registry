---
name: test-strategy
description: CRITICAL: Use for any testing request (TDD, rstest, fixture, case design, test refactor). Enforces t-wada style: declarative cases, no bool-driven branching in test bodies, and no rstest when it does not improve readability. Use when this capability is needed.
metadata:
  author: yu256
---
# Test Strategy Skill
