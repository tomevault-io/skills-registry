...
description: PRD・機能設計からアーキテクチャ設計書（docs/architecture.md）を作成する。「アーキテクチャ設計して」「技術選定して」「インフラ設計」「システム構成を決めて」「技術スタックを決めて」「非機能要件の設計」などの依頼時に使用。技術選定（理由付き）・レイヤー設計・データ戦略・セキュリティ・スケーラビリティを出力。 Use when this capability is needed.
metadata:
  author: yuch4
---
...
| `references/guide.md` | 技術選定基準・レビュー観点 |
