...
description: Linear、Notion、Stripe風の精密なデザインシステムを適用する。ダッシュボード、管理画面、SaaSインターフェースなどJony Ive級の精密さが必要なUI向け。「ダッシュボードを作って」「管理画面のUI」「UIデザイン原則を適用」「精密なデザイン」などの依頼時に使用。 Use when this capability is needed.
metadata:
  author: yuch4
---
