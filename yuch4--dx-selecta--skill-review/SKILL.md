---
name: skill-review
description: .claude/skills 配下のスキル（各SKILL.md）をレビューして改善提案を出す。name/description妥当性、簡潔さ、progressive disclosure、例の有無、参照の深さ、ツール制限、500行制限などのベストプラクティス観点でチェック。「スキルをレビューして」「skill改善」「スキルを見直して」などの依頼時に使用。 Use when this capability is needed.
metadata:
  author: yuch4
---
