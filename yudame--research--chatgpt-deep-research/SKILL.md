...
description: DEPRECATED - Use gpt-researcher skill instead. This browser automation approach has been replaced with the local GPT-Researcher framework using OpenAI o1. Use when this capability is needed.
metadata:
  author: yudame
---
