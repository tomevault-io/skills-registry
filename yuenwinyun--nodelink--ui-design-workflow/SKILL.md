...
description: Enforces a designer-first workflow for all UI work. Automatically delegates to the designer subagent before building or modifying any React component, then implements based on its recommendations. Use whenever creating, editing, or reviewing UI components. Use when this capability is needed.
metadata:
  author: yuenwinyun
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yuenwinyun) — claim your Tome and manage your conversions.
