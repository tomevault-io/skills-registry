...
description: 自动监控 Claude Code 性能指标，包括操作耗时、失败率、效率评分，并提供语义化洞察 Use when this capability is needed.
metadata:
  author: yufenghui
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yufenghui) — claim your Tome and manage your conversions.
