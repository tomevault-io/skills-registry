---
name: implement-v2
description: Implement v2.0 dynamic dialogue features for Yui Protocol. Use when working on memory hierarchy, consensus system, or facilitator agent. Use when this capability is needed.
metadata:
