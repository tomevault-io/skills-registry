...
description: Create or update NEREID workspace Gemini CLI skills. Use when asked to design, improve, rename, or maintain SKILL.md-based expertise, including extracting reusable session lessons into ./specials/skills. Use when this capability is needed.
metadata:
  author: yuiseki
---
# Skill Creator
