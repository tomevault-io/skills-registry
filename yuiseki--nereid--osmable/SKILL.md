---
name: osmable
description: Use osmable CLI for deterministic OSM workflows (geocode, reverse, aoi, poi, route, isochrone). Trigger for OSM map requests such as parks/shops/stations and Nominatim/Overpass retrieval. Use when this capability is needed.
metadata:
  author: yuiseki
---
# osmable Workflow
