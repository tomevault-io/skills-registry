...
description: Next.js App Routerベースのフロントエンド実装スキル。UIコンポーネント、ページ、レイアウト、フォーム、React Queryフック、i18n対応の実装時に使用。backend/配下は除外。Radix UI + Tailwind CSS v4 + TypeScript + next-intl + React Query v5 + Better-Auth のパターンに従う。 Use when this capability is needed.
metadata:
  author: yuji-sniper
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yuji-sniper) — claim your Tome and manage your conversions.
