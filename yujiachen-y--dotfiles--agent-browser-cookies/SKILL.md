...
description: This skill should be used when exporting, storing, or reapplying agent-browser cookies across sessions, especially for localhost login states. Use when this capability is needed.
metadata:
  author: yujiachen-y
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yujiachen-y) — claim your Tome and manage your conversions.
