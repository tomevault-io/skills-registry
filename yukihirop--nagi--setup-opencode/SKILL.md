---
name: setup-opencode
description: Set up Open Code agent as an alternative to Claude Code. Supports OpenRouter, Gemini, and OpenAI providers. Triggers on "setup opencode", "setup open code", "use opencode", "switch to opencode". Use when this capability is needed.
metadata:
  author: yukihirop
---
...
---
> Source: [yukihirop/nagi](https://github.com/yukihirop/nagi) — distributed by [TomeVault](https://tomevault.io).
