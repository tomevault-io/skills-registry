...
description: 直前の会話に含まれるレビュー結果を精査し、妥当な指摘に対して修正を実施する。 Use when this capability is needed.
metadata:
  author: yuku
---
...
---
> Source: [yuku/config](https://github.com/yuku/config) — distributed by [TomeVault](https://tomevault.io).
