---
name: agent-teams
description: Orchestrate agent teams for parallelizable multi-faceted tasks. Use when work requires inter-agent communication, competing hypotheses, or multi-file parallel implementation. Use when this capability is needed.
metadata:
  author: yulonglin
---
