...
description: Anthropic visual style for plots, diagrams, slides, and web. Use when creating any visual output that should have Anthropic's look-and-feel — matplotlib charts, TikZ diagrams, HTML/CSS, or presentations. Use when this capability is needed.
metadata:
  author: yulonglin
---
