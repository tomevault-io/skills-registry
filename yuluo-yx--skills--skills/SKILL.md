...
description: 用于撰写、改写、润色或审校中文技术文档、产品说明、README、操作手册、知识库文章、发布说明、接口文档和 FAQ。适用于需要统一中文标题层级、段落结构、句式风格、数字写法、标点、引用与文件命名规范的场景，尤其当用户要求“按中文技术文档规范”输出时使用。 Use when this capability is needed.
metadata:
  author: yuluo-yx
---
...
---
> Source: [yuluo-yx/skills](https://github.com/yuluo-yx/skills) — distributed by [TomeVault](https://tomevault.io).
