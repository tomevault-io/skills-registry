---
name: hooks-creator
description: VS Code の Agent hooks（ライフサイクルフック）を設計・作成・レビューする。.github/hooks/*.json、hook、PreToolUse、PostToolUse、SessionStart、Stop、UserPromptSubmit、PreCompact、SubagentStart、SubagentStop、ライフサイクル自動化、セキュリティポリシー、コード品質自動化に言及したときに使用する。 Use when this capability is needed.
metadata:
  author: yuma-722
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yuma-722) — claim your Tome and manage your conversions.
