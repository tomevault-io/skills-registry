---
name: prompt-creator
description: VS Code の prompt files（slash commands / スラッシュコマンド）を設計・作成・レビューする。.prompt.md、.github/prompts、prompt file、slash command、/コマンドに言及したとき、または定型タスクを「/で呼び出せる形」にしたいときに使用する。 Use when this capability is needed.
metadata:
  author: yuma-722
---
