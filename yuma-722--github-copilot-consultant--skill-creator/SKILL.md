---
name: skill-creator
description: Agent Skillsのオープン標準仕様に沿ってSKILL.mdとディレクトリ構成を生成・レビューする。ユーザーがSkillの作成、新規Skill生成、SKILL.mdの書き方、Agent Skillsの設計について質問したときに使用する Use when this capability is needed.
metadata:
  author: yuma-722
---
