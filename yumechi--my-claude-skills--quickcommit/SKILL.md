---
name: quickcommit
description: git status を確認し、問題がなければ add と commit を実行します Use when this capability is needed.
metadata:
  author: yumechi
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yumechi) — claim your Tome and manage your conversions.
