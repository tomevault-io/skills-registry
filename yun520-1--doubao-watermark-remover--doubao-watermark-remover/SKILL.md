...
description: 极致画质豆包 AI 视频水印去除工具，集成 1.5x 超分辨率重建、内容自适应修复和批量处理功能，完美去除"豆包 AI 生成"水印的同时提升视频清晰度。 Use when this capability is needed.
metadata:
  author: yun520-1
---
...
---
> Source: [yun520-1/doubao-watermark-remover](https://github.com/yun520-1/doubao-watermark-remover) — distributed by [TomeVault](https://tomevault.io).
