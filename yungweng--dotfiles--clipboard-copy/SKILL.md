---
name: clipboard-copy
description: Copy text to the system clipboard. Use when user asks to copy something to clipboard, copy to pasteboard, or wants to paste something. Use when this capability is needed.
metadata:
  author: yungweng
---
