---
name: gh-cli
description: GitHub CLI (gh) command reference and usage patterns. Use when working with GitHub from the command line - PRs, issues, repos, workflows, releases, and API calls. Use when this capability is needed.
metadata:
  author: yungweng
---
