...
description: Format text for Slack messages. Use when user wants to share content in Slack, format messages for Slack, or copy text to clipboard for Slack. Converts markdown to Slack-compatible mrkdwn syntax. Use when this capability is needed.
metadata:
  author: yungweng
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yungweng) — claim your Tome and manage your conversions.
