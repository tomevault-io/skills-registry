...
description: origin evolve trace.md execution trace hook pattern proposal knowledge update validated protocol skill files compact trace NOT code_pipeline NOT bootstrap Use when this capability is needed.
metadata:
  author: yunzeforbetter
---
...
---
> Source: [yunzeforbetter/CastFlow](https://github.com/yunzeforbetter/CastFlow) — distributed by [TomeVault](https://tomevault.io).
