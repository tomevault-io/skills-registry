...
description: Scaffolds a new resource (Controller, Service, Repository, Domain, Factory) for the Go REST API project. Use when asked to "create a new resource", "add a new entity", "scaffold a vertical slice" or "generate a new API endpoint". Use when this capability is needed.
metadata:
  author: yurihbm
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yurihbm) — claim your Tome and manage your conversions.
