...
description: 自动定位并获取权威公开数据（优先API/官方批量下载），输出可复现抓取与清洗方案。Invoke when用户需要权威数据、官方统计、API下载或数据源爬取。 Use when this capability is needed.
metadata:
  author: yushui2022
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yushui2022) — claim your Tome and manage your conversions.
