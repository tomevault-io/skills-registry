---
name: xsai-sdk
description: xsAI SDK v0.4.x API reference - extra-small AI SDK with OpenAI-compatible API Use when this capability is needed.
metadata:
  author: yusixian
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yusixian) — claim your Tome and manage your conversions.
