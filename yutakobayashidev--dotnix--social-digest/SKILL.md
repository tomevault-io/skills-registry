---
name: social-digest
description: Fetch today's Discord channel + Mastodon posts via API tokens, summarize to Markdown, and save into an Obsidian vault (Bun script). Use when this capability is needed.
metadata:
