...
description: Set up monitoring for API changes, changelogs, or documentation updates. Useful for tracking breaking changes in services you depend on. Use when this capability is needed.
metadata:
  author: yutori-ai
---
