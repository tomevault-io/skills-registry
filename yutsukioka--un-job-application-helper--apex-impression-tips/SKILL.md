...
description: Provide tone and language recommendations and final review advice to maximize the impression of the candidate’s application materials (Phase 6). Use this skill only when the user asks for impression maximizer tips or when composing the full strategy report. Use when this capability is needed.
metadata:
  author: yutsukioka
---
