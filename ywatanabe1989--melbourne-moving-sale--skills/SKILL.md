...
description: Master index of all available skills for development workflows. Use when needing guidance on which skill to apply or when starting work on any project. Use when this capability is needed.
metadata:
