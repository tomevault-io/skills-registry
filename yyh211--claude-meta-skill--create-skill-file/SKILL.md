...
description: Guides Claude in creating well-structured SKILL.md files following best practices. Provides clear guidelines for naming, structure, and content organization to make skills easy to discover and execute. Use when this capability is needed.
metadata:
  author: yyh211
---
...
---
> Source: [yyh211/claude-meta-skill](https://github.com/yyh211/claude-meta-skill) — distributed by [TomeVault](https://tomevault.io).
