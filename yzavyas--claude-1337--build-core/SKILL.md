---
name: build-core
description: Engineering excellence for builders. Use when: writing code, making technical decisions, refactoring, reviewing, completing implementation work. Use when this capability is needed.
metadata:
  author: yzavyas
---
