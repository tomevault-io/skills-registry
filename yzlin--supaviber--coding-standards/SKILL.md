...
description: Guide for writing clean, maintainable code following industry best practices and design principles like DRY, SOLID, and composition patterns. Use when writing any code to ensure consistency, readability, and long-term maintainability across all programming languages. Use when this capability is needed.
metadata:
  author: yzlin
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/yzlin) — claim your Tome and manage your conversions.
