...
description: 从公域知识萃取方法论并封装为 Skill。通过 NotebookLM Deep Research 搜索优质内容，提炼工作流、原则、模板，自动生成标准化技能。触发词：/note-meta-skill, 从知识创建技能, 知识萃取, 元技能 Use when this capability is needed.
metadata:
  author: z1993
---
