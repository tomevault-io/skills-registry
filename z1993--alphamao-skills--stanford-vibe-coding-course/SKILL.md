...
description: 斯坦福 CS146S "The Modern Software Developer" AI开发课程学习系统。Use when: 用户提到 cs146s, stanford课程, vibe coding, AI开发学习, 或"开始学习"。 Use when this capability is needed.
metadata:
  author: z1993
---
