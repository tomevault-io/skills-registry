...
description: Handle `src/*.egg-info` diffs in Python repos (uv-driven) to avoid committing generated metadata unintentionally. Use when this capability is needed.
metadata:
  author: z3z1ma
---
