...
description: Resolve git merge conflicts in compound-managed LOOM docs (LOOM_CHANGELOG.md, LOOM_ROADMAP.md) without breaking BEGIN/END fences. Use when this capability is needed.
metadata:
  author: z3z1ma
---
