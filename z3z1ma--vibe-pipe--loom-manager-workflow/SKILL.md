...
description: Manage Loom team tickets as a team manager with limited permissions (no git merge/push, no loom team commands). Handle ticket lifecycle: create, update, add notes, track dependencies, identify blockages. Use when this capability is needed.
metadata:
  author: z3z1ma
---
