---
name: tinybird
description: Tinybird Code agent tools and prompts for working with Tinybird projects, datafiles, queries, deployments, and tests. Use when this capability is needed.
metadata:
  author: z4nr34l
---
