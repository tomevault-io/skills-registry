---
name: runtime-remsh
description: Connect to a running Lemon or lemon-gateway BEAM node, run recompile() for hot code reload, and execute Elixir code in that live runtime via IEx remsh or rpc-eval. Use when this capability is needed.
metadata:
  author: z80dev
---
