---
name: zuper-debug
description: Debug Zuper field service integration issues. Use when investigating Zuper API problems, job syncing, scheduling mismatches, or status comparison discrepancies. Use when this capability is needed.
metadata:
  author: zachsrosen
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zachsrosen) — claim your Tome and manage your conversions.
