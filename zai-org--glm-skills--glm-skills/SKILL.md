...
description: Comprehend the given document(s) and write a textual content (paper/article/essay/report/review/post/brief/proposal/plan) according to your requirements using the ZhiPu GLM-V multimodal model. Use when this capability is needed.
metadata:
  author: zai-org
---
...
---
> Source: [zai-org/GLM-skills](https://github.com/zai-org/GLM-skills) — distributed by [TomeVault](https://tomevault.io).
