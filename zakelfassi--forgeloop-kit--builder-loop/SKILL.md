---
name: builder-loop
description: End-to-end closed-loop build flow (brief -> plan -> forge skills -> execute -> validate). Use when you want a repeatable build loop that improves itself by forging reusable skills over time. Use when this capability is needed.
metadata:
  author: zakelfassi
---
