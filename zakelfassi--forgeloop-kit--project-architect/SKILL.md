...
description: Turn a freeform brief into a concrete build plan: requirements, tasks, skill opportunities, runbook, risks, acceptance. Use when asked to plan a feature/project, refine IMPLEMENTATION_PLAN.md, or create a skills blueprint before building. Use when this capability is needed.
metadata:
  author: zakelfassi
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zakelfassi) — claim your Tome and manage your conversions.
