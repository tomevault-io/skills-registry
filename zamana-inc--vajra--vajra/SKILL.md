...
description: Use for Vajra stages that draft category knowledge docs grounded in repo instructions, target schemas, and the closest existing knowledge docs. Use when this capability is needed.
metadata:
  author: zamana-inc
---
...
---
> Source: [zamana-inc/vajra](https://github.com/zamana-inc/vajra) — distributed by [TomeVault](https://tomevault.io).
