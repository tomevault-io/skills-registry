---
name: ant-design
description: Ant Design ecosystem guidance covering antd 6.x, Ant Design Pro 5/ProComponents, and Ant Design X v2 (AI/chat UI). Use when making component/layout decisions, theming/tokens, SSR, routing/access, CRUD patterns, or AI chat UI integrations. Use when this capability is needed.
metadata:
  author: zanaroot
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zanaroot) — claim your Tome and manage your conversions.
