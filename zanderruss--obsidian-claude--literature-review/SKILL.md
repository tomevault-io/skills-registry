...
This skill provides specialized tools for citation verification, result aggregation, and document generation.

> **Compatibility Note:** References to `gget`, `bioservices`, and `datacommons-client` skills in this documentation are not available in this installation. Use WebSearch, WebFetch, or direct API access (via the included Python scripts) as alternatives for database searches.
...
Consider adding diagrams to enhance your literature review:
...
**Note:** Create diagrams manually using tools like draw.io, Mermaid, or your preferred diagramming tool.
