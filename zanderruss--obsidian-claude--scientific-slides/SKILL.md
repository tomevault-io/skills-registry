...
For complex technical diagrams beyond slide visuals:

- Circuit diagrams, chemical structures
- Publication-quality figures
- Diagrams requiring scientific accuracy

**Note:** Create diagrams using BioRender, ChemDraw, draw.io, or other specialized tools.
