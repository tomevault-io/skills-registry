...
description: Triage bug reports by severity, recommend fix order, generate client communication templates, determine whether to charge for fixes, and provide Claude Code prompts to resolve issues quickly. Use when this capability is needed.
metadata:
  author: zanecole10
---
