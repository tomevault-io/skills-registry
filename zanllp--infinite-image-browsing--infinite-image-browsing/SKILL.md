---
name: iib
description: Interact with IIB (Infinite Image Browsing) service for searching, browsing, tagging, and organizing AI-generated images. Use when the user needs to search images by prompt/keyword, manage image tags, organize files into folders, get image generation parameters, or work with an image library. Use when this capability is needed.
metadata:
  author: zanllp
---
...
---
> Source: [zanllp/infinite-image-browsing](https://github.com/zanllp/infinite-image-browsing) — distributed by [TomeVault](https://tomevault.io).
