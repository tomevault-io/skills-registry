---
name: zapier-status
description: Check the health of your Zapier MCP setup. Three modes — health check (dashboard view), audit (find waste and duplicates), diagnose (systematic troubleshooting). Use when asking "is my MCP working?", "check my tools", "audit my setup", "what's broken?", or "zapier status". Use when this capability is needed.
metadata:
  author: zapier
---
...
---
> Source: [zapier/zapier-mcp](https://github.com/zapier/zapier-mcp) — distributed by [TomeVault](https://tomevault.io).
