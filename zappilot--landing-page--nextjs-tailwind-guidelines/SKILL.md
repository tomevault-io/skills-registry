...
description: Next.js 15 + Tailwind CSS development guidelines. Modern patterns including App Router, Server/Client Components, Suspense, lazy loading, file organization, Tailwind CSS styling, performance optimization, and TypeScript best practices. Use when creating components, pages, features, styling, routing, or working with Next.js code. Use when this capability is needed.
metadata:
  author: zappilot
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zappilot) — claim your Tome and manage your conversions.
