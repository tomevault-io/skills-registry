---
name: java-patterns
description: This skill should be used for Java/Spring patterns, dependency injection, streams, Optional, Kotlin, Spring Boot, Maven, Gradle, JVM backend Use when this capability is needed.
metadata:
  author: zate
---
