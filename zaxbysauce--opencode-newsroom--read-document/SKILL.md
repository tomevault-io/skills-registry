---
name: read-document
description: Read and extract text from document files (.docx, .pdf, .xlsx, .pptx, .csv, .rtf, .odt, .epub, .html) into plain text or markdown for editing Use when this capability is needed.
metadata:
  author: zaxbysauce
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zaxbysauce) — claim your Tome and manage your conversions.
