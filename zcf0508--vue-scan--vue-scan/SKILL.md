---
name: vue-scan
description: Vue component render performance monitoring. Captures mount/update events with render time, FPS, and source locations. Provides per-component aggregated summaries for analyzing render frequency, slow components, and frame drops. Use when this capability is needed.
metadata:
  author: zcf0508
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zcf0508) — claim your Tome and manage your conversions.
