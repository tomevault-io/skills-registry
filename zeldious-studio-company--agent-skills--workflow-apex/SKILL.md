---
name: apex
description: Systematic implementation using APEX methodology (Analyze-Plan-Execute-eXamine) with parallel agents, self-validation, and optional adversarial review. Use when implementing features, fixing bugs, or making code changes that benefit from structured workflow. Use when this capability is needed.
metadata:
  author: zeldious-studio-company
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zeldious-studio-company) — claim your Tome and manage your conversions.
