...
description: Analyze and debug backend and database structures without making code changes. Provides a comprehensive report with advice, scoring, recommendations, and future development steps. Use when this capability is needed.
metadata:
  author: zemetia
---
