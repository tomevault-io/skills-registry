...
description: Integrate backend APIs with frontend requirements. Prioritizes frontend needs (data fetching, form submissions, CRUD) and connects them to existing backend logic. Use when the backend is largely ready and the frontend needs to be hooked up to real data and actions. Use when this capability is needed.
metadata:
  author: zemetia
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zemetia) — claim your Tome and manage your conversions.
