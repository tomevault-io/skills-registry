---
name: be-research
description: Research backend best practices, library recommendations, and database entity integration. Use when start researching or planning backend features like payment gateways, auth systems, or complex API integrations. Use when this capability is needed.
metadata:
  author: zemetia
---
