...
description: Traces and documents backend route implementations from endpoint to controller, creating frontend-readable implementation plans. Use when you need to understand or document a backend route's logic, parameters, and authentication for frontend integration. Use when this capability is needed.
metadata:
  author: zemetia
---
