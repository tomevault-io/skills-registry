---
name: testing-apis
description: Test REST API endpoints like a QA expert. Supports Bearer tokens, connectivity checks, and backend database verification via managing-databases skill. Use when this capability is needed.
metadata:
  author: zemetia
---
