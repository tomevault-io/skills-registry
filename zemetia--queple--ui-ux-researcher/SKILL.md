...
description: Research UI/UX from PDF, website, image, or JSON sources and generate design tokens. Use when user wants to extract design styles or research UI/UX. Use when this capability is needed.
metadata:
  author: zemetia
---
