...
description: 翻译在线文章为中文并保存为 Markdown 格式。当用户需要翻译网页文章、博客文章时使用此技能，例如："翻译这篇文章 https://example.com/article"、"把这个 URL 的文章翻译成中文并保存"。 Use when this capability is needed.
metadata:
  author: zephyrwang6
---
