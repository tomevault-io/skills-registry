...
description: Busca documentación oficial de APIs/libraries (version-specific). Usa Context7 o WebFetch para docs reales, no inventa. Use when this capability is needed.
metadata:
  author: zero-rehq
---
