---
name: md2book
description: 将 Markdown 格式的书籍转换为专业排版的 PDF 电子书，支持智能分页、中文完美渲染、精美装帧设计和多种视觉主题 Use when this capability is needed.
metadata:
  author: ZeroxZhang
---
...
---
> Source: [ZeroxZhang/md2book](https://github.com/ZeroxZhang/md2book) — distributed by [TomeVault](https://tomevault.io).
