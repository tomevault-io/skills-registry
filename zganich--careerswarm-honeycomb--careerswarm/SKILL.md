---
name: careerswarm
description: CareerSwarm repo: monitor, code sweeps, debugging, and sync with Cursor. Workspace is this repo; read OPENCLAW.md and CONTEXT/todo before big edits. Use when this capability is needed.
metadata:
  author: zganich
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zganich) — claim your Tome and manage your conversions.
