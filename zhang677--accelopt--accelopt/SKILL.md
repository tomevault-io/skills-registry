---
name: accelopt
description: Optimize a kernel and store the optimization trace in a kernel database Use when this capability is needed.
metadata:
  author: zhang677
---
...
- `templates/` show hand-crafted AccelOpt workflow
