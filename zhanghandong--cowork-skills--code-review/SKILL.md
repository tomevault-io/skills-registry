---
name: code-review
description: CRITICAL: Code review skill using GitHub API. Triggers on: review PR, code review, PR review, pull request review, review changes, check this PR, analyze this PR, review #, 代码审查, 审查 PR Use when this capability is needed.
metadata:
  author: zhanghandong
---
