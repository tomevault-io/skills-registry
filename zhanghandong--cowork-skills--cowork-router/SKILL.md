---
name: cowork-router
description: Meta-router for dynamic skill routing. Use when: cowork, skill management, router generation, Skills.toml, plugin configuration Use when this capability is needed.
metadata:
  author: zhanghandong
---
