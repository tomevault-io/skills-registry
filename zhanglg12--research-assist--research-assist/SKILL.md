...
description: Use when working with a lightweight arXiv literature digest skill for OpenClaw, with Zotero-driven interest profiling, research-map plus Zotero-semantic ranking, agent-enriched digest cards, and non-destructive feedback writeback.
metadata:
  author: zhanglg12
---
...
---
> Source: [zhanglg12/research-assist](https://github.com/zhanglg12/research-assist) — distributed by [TomeVault](https://tomevault.io).
