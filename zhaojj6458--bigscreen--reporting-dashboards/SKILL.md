...
description: This skill should be used when the user asks to \"create report\", \"dashboard\", \"chart\", \"visualization\", \"analytics\", \"scheduled report\", \"export data\", or any ServiceNow reporting and dashboard development. Use when this capability is needed.
metadata:
  author: zhaojj6458
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zhaojj6458) — claim your Tome and manage your conversions.
