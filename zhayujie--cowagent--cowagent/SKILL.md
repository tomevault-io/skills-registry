...
description: Generate or edit images from text prompts. Use when the user asks to create, draw, design, or edit an image, illustration, photo, icon, poster, or any visual content. Use when this capability is needed.
metadata:
  author: zhayujie
---
...
---
> Source: [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) — distributed by [TomeVault](https://tomevault.io).
