---
name: code-review
description: Dispatch a code reviewer subagent to catch issues before they cascade. Use after completing features, fixing complex bugs, or before merging. Use when this capability is needed.
metadata:
  author: zheli
---
...
---
> Source: [zheli/agent-skills](https://github.com/zheli/agent-skills) — distributed by [TomeVault](https://tomevault.io).
