---
name: md-to-zhihu
description: Convert markdown articles to Zhihu (知乎) publishing format and one-click publish articles. Use when the user wants to publish markdown content to Zhihu, convert articles for Zhihu, or mentions 知乎、知乎专栏、知乎发布、发布到知乎. Use when this capability is needed.
metadata:
  author: zhenxuanshi-ship-it
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zhenxuanshi-ship-it) — claim your Tome and manage your conversions.
