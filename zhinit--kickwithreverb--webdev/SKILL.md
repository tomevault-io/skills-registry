---
name: webdev
description: Web development standards - use when working with .ts, .tsx, .js, .jsx, .css, .html files Use when this capability is needed.
metadata:
  author: zhinit
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zhinit) — claim your Tome and manage your conversions.
