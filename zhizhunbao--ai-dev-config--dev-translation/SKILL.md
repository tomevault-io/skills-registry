...
description: IT technical document translation assistant. Use when (1) translating technical articles, documentation, or papers, (2) creating bilingual (Chinese-English) content, (3) ensuring technical term consistency, (4) translating code comments or API docs. Use when this capability is needed.
metadata:
  author: zhizhunbao
---
