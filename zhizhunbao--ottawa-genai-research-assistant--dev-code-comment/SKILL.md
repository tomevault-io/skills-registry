---
name: code-comment
description: English code comment standards for Python and TypeScript. Use when (1) adding comments to code, (2) standardizing comment format, (3) TypeScript/TSX file header comments, (4) Python module docstrings Use when this capability is needed.
metadata:
  author: zhizhunbao
---
