---
name: code-council
description: Multi-backend parallel code review using code-dispatcher. Runs 2-3 AI reviewers simultaneously, then the host agent verifies findings and synthesizes a final report. Use when this capability is needed.
metadata:
  author: zhu-jl18
---
