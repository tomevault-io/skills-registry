...
description: 上传成功的 CDN URL 列表（仅 upload=true 时有值） Use when this capability is needed.
metadata:
  author: zhylq
---
...
---
> Source: [zhylq/yuan-skills](https://github.com/zhylq/yuan-skills) — distributed by [TomeVault](https://tomevault.io).
