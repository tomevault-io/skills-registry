---
name: time
description: Get current date, time, and timezone information. Use for any question involving today's date, current time, day of the week, or when the user references relative dates like 'tomorrow', 'next week', 'this weekend'. Use when this capability is needed.
metadata:
  author: zingozingo
---
