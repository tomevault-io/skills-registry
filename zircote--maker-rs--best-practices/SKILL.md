---
name: best-practices
description: Research and catalog industry standards and frameworks applied to the project with citations, application mapping, and maturity model. Use alongside domain research to ground the project in established practice. Use when this capability is needed.
metadata:
  author: zircote
---
