---
name: project-plan
description: Generate a comprehensive master project plan with executive summary, current state analysis, phased approach, financial ROI, and actionable next steps. Use after domain research is complete. Use when this capability is needed.
metadata:
  author: zircote
---
