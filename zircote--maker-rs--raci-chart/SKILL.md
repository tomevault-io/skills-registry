---
name: raci-chart
description: Create a responsibility assignment matrix mapping all project activities to roles with R/A/C/I designations including ongoing governance. Use after project plan and JIRA structure define activities and roles. Use when this capability is needed.
metadata:
  author: zircote
---
