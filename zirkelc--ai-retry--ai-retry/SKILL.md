---
name: commit
description: Create a git commit with an auto-generated conventional commit message summarizing the changes. Optionally push to remote. Use when this capability is needed.
metadata:
  author: zirkelc
---
