---
name: qqsg-struct
description: 0x100 未知，此类招式会让受击者进入攻击状态 Use when this capability is needed.
metadata:
  author: ziwenhahaha
---
# 技能数据的研究
...
---
> Source: [ziwenhahaha/qqsg_struct](https://github.com/ziwenhahaha/qqsg_struct) — distributed by [TomeVault](https://tomevault.io).
