...
description: Test changes to frontend/static assets served by a long-running server you cannot restart, by locating the actual on-disk serve path and overwriting bundles in place. Use when this capability is needed.
metadata:
  author: ziya-ai
---
...
---
> Source: [ziya-ai/ziya](https://github.com/ziya-ai/ziya) — distributed by [TomeVault](https://tomevault.io).
