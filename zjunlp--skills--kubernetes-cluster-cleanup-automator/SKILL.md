...
description: Identifies and cleans up outdated Kubernetes deployments based on namespace patterns and application version age. Discovers deployments, analyzes release dates from annotations, performs cleanup actions, and notifies stakeholders. Use when this capability is needed.
metadata:
  author: zjunlp
---
# Instructions
