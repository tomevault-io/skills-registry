---
name: rust-errors
description: Rust to TypeScript error handling patterns for Tauri apps. Use when defining Rust errors that will be passed to TypeScript, handling Tauri command errors, or creating discriminated union error types. Use when this capability is needed.
metadata:
  author: zjunlp
---
