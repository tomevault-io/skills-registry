---
name: image-gen
description: AI SDK-based image generation using official OpenAI and Google APIs. Supports text-to-image, reference images, aspect ratios, and quality presets. Use when this capability is needed.
metadata:
  author: zlh-428
---
