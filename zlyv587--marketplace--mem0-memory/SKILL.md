...
description: This skill should be used when the user asks about "memory", "remember this", "what do you know about me", "recall", "forget this", "search memories", "save preference", or when Claude needs guidance on using mem0 tools effectively. Provides best practices for memory storage, retrieval, and organization. Use when this capability is needed.
metadata:
  author: zlyv587
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zlyv587) — claim your Tome and manage your conversions.
