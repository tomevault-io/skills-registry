...
description: CI/CD 自动化 Use when this capability is needed.
metadata:
  author: zmice
---
...
---
> Source: [zmice/zc-qwen-extension](https://github.com/zmice/zc-qwen-extension) — distributed by [TomeVault](https://tomevault.io).
