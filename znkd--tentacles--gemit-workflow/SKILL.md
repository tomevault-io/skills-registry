---
name: gemit-workflow
description: Use when working with a color-coded, AI-enhanced Git workflow assistant that guides users through staging, analyzing, committing, and syncing code with safety checks. Use this when you need a standardized Git workflow.
metadata:
  author: znkd
---
