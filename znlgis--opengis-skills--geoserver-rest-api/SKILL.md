...
description: GeoServer REST API 是 GeoServer 提供的 RESTful 配置接口，允许通过 HTTP 请求以 JSON 或 XML 格式对工作空间、数据存储、图层、样式、图层组、服务设置及安全等资源进行增删改查管理，适用于自动化运维、CI/CD 和 AI 智能体集成场景。 Use when this capability is needed.
metadata:
  author: znlgis
---
...
---
> Source: [znlgis/opengis-skills](https://github.com/znlgis/opengis-skills) — distributed by [TomeVault](https://tomevault.io).
