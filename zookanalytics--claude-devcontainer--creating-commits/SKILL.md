...
description: Use before EVERY git commit - no exceptions. Enforces pre-commit quality checks, atomic commits, and conventional commit format to prevent hook failures and maintain clean history Use when this capability is needed.
metadata:
  author: zookanalytics
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zookanalytics) — claim your Tome and manage your conversions.
