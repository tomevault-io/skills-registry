...
description: Guide for creating a new X-Fidelity archetype configuration. Use when defining project templates, configuring rule sets, or setting up dependency requirements. Use when this capability is needed.
metadata:
  author: zotoio
---
