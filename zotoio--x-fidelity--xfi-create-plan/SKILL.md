...
description: Guide for creating engineering plans through a structured workflow. Use when planning new features, coordinating multi-agent work, or breaking down complex initiatives. Use when this capability is needed.
metadata:
  author: zotoio
---
