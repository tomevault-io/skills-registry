...
description: Guide for executing engineering plans through coordinated subagent work. Use when executing existing plans from knowledge/plans/ directory. Use when this capability is needed.
metadata:
  author: zotoio
---
