...
description: 使用图片/视频生成工具时必读。包含工具参数、非阻塞工作流、任务路由。 Use when this capability is needed.
metadata:
  author: ZS520L
---
...
---
> Source: [ZS520L/HanakoPro](https://github.com/ZS520L/HanakoPro) — distributed by [TomeVault](https://tomevault.io).
