---
name: qka
description: QKA 框架使用技能。当用户需要基于 QKA 框架编写 A 股量化策略、运行回测、 Use when this capability is needed.
metadata:
  author: zsrl
---
---
...
---
> Source: [zsrl/qka](https://github.com/zsrl/qka) — distributed by [TomeVault](https://tomevault.io).
