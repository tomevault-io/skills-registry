...
description: Unified PDF report generator — combines all audit scores into a professional client-ready PDF Use when this capability is needed.
metadata:
...
---
> Source: [zubair-trabzada/ai-agency-claude](https://github.com/zubair-trabzada/ai-agency-claude) — distributed by [TomeVault](https://tomevault.io).
