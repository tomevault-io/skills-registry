...
description: Crypto Fundamental Analysis — evaluates project viability, team quality, technology, adoption metrics, and competitive moat with a composite Fundamental Score (0-100) Use when this capability is needed.
metadata:
...
---
> Source: [zubair-trabzada/ai-crypto-claude](https://github.com/zubair-trabzada/ai-crypto-claude) — distributed by [TomeVault](https://tomevault.io).
