...
description: Neighborhood Analysis — schools, crime, walkability, demographics, amenities, growth trajectory, and natural disaster risk with Neighborhood Score (0-100) Use when this capability is needed.
metadata:
...
---
> Source: [zubair-trabzada/ai-realestate-claude](https://github.com/zubair-trabzada/ai-realestate-claude) — distributed by [TomeVault](https://tomevault.io).
