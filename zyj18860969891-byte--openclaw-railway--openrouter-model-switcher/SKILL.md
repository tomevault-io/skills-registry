...
description: Dynamically switch AI models from multiple providers via environment variables. Supports OpenRouter, Anthropic, OpenAI, DeepSeek, and other OpenAI-compatible APIs without code changes. Use when this capability is needed.
metadata:
  author: zyj18860969891-byte
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zyj18860969891-byte) — claim your Tome and manage your conversions.
