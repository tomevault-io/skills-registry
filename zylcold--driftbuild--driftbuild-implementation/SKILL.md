...
description: Implement, debug, or extend DriftBuild, a Swift LAN remote iOS simulator build system. Use when working on the DriftBuild Swift Package, drift CLI, drift-server, Vapor HTTP API, ArgumentParser commands, Bonjour or UDP discovery, pairing, build queue, xcodebuild invocation, log streaming, artifact packaging, or tests. Use when this capability is needed.
metadata:
  author: zylcold
---
...
---
> Source: [zylcold/DriftBuild](https://github.com/zylcold/DriftBuild) — distributed by [TomeVault](https://tomevault.io).
