...
description: Generate policy-aligned PR summary and changelog text for Building Ledger changes with required scope, security, and test sections. Use when this capability is needed.
metadata:
  author: zz-plant
---
