---
name: tencent-docs-final
description: **Problem Category**: Browser automation for creating and editing Tencent Docs (腾讯文档) online spreadsheets. Use when this capability is needed.
metadata:
  author: zzatpku
---
...
---
> Source: [zzatpku/AgentFactory](https://github.com/zzatpku/AgentFactory) — distributed by [TomeVault](https://tomevault.io).
