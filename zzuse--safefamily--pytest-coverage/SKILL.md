...
description: Generate or extend pytest suites to reach at least 80% total coverage for the repository while excluding src/safe_family/templates/miscellaneous/. Use when asked to add tests, raise coverage, or set up CI coverage gates. Use when this capability is needed.
metadata:
  author: zzuse
---
...
---
> Converted and distributed by [TomeVault](https://tomevault.io/claim/zzuse) — claim your Tome and manage your conversions.
